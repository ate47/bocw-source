...
function private function_6ea199e(var_474d98c7) {
    ...
    if (isdefined(var_474d98c7)) {
        self function_5953bec0(var_474d98c7);
        ...
        if (isdefined(self.var_758eae6.current) && self.var_758eae6.current == self function_43ee4470()) {
            self function_5953bec0(self.var_758eae6.previous);
        }
        self.var_758eae6.previous = undefined;
    } else {
        self function_c98cb594();
    }
...
// Size: 0x5e
function function_5f93219b(*remotename) {
...
// Size: 0x54
function function_e3353cb6(team, text) {
    team = get_team_mapping(team);
...
function function_2fd0ed09(var_f695d653, var_fc366442, *shader, *var_87e158ef, *var_cfeb7a77, *fdelay, *x, *y, var_286a6310 = 1) {
    ...
    if (isdefined(level.var_fd031e6)) {
        return;
    }
...
function function_2a8f4806(var_f695d653, var_fc366442) {
    function_2fd0ed09(var_f695d653, var_fc366442, 0);
}
...
function function_268bdf4f(name, func_init, arg1, arg2, arg3, arg4, arg5, var_dc17ca64 = 1) {
    ...
    ai_hero.is_hero.ai_hero = 1;
    ai_hero.enableterrainik.ai_hero = 1;
...
function function_9d9d132a(n_zone, var_97094ff3 = 1) {
    ...
    /#
        if (gettime() >= n_timeout) {
            printtoprightln("<unknown string>" + rjust(gettime(), 6, "<unknown string>"), (1, 0, 0));
        } else {
            printtoprightln("<unknown string>" + rjust(gettime(), 6, "<unknown string>"), (1, 1, 1));
        }
    #/
}
...
function function_1478233c(var_e601604e) {
    if (isdefined(self.var_acac2f93)) {
        if (isfloat(var_e601604e)) {
            ...
            self stopgestureviewmodel(self.var_acac2f93);
        } else if (function_b72088f(var_e601604e)) {
            self.var_f82e2c3d = gettime() + int((self function_64f4c271(var_e601604e) - 0.2) * 1000);
...
// Size: 0x3e
function function_8c95fc4d(var_9b8a5ad2 = 1) {
    if (var_9b8a5ad2) {
        self.var_35445183 = 1;
    } else {
...
function function_84f75222(str_text_to_show, b_should_blink, str_turn_off_notify, n_display_time) {
    ...
    if (lui_elem namespace_86402e7e::is_open(self)) {
        self hide_hint_text(0);
    }
    lui_elem namespace_86402e7e::open(self);
    lui_elem namespace_86402e7e::function_a16f86c1(self, str_text_to_show);
    wait_network_frame();
    if (b_should_blink) {
        lui_elem namespace_86402e7e::function_64d95cad(self);
    } else {
        lui_elem namespace_86402e7e::function_a981d6b6(self);
    }
...
function function_502198f3(var_67df10fb = 4) {
    ...
    if (!namespace_61e6d095::exists(#"hash_5a8140e735eea0a")) {
        ...
        namespace_61e6d095::function_d3c3e5c3(#"hash_5a8140e735eea0a", [2:#"hash_af16b6b2e499098", 1:#"hash_50dd1fbbd883b24e", 0:#"interactive_map"]);
...
function function_b9dfcfb7(var_67df10fb = 4) {
    ...
    if (!namespace_61e6d095::exists(#"hash_4362296ac2fe0d63")) {
        ...
        namespace_61e6d095::function_d3c3e5c3(#"hash_4362296ac2fe0d63", [2:#"hash_af16b6b2e499098", 1:#"hash_50dd1fbbd883b24e", 0:#"interactive_map"]);
...
function can_see_ai(var_428cf68a, ai, latency, var_593afcc1, var_8230ceac) {
    ...
    var_6ca90d08 = (eyeorigin + var_8544fe8e) * 0.5;
    if (sighttracepassed(frompoint, var_6ca90d08, 1, var_593afcc1, var_8230ceac)) {
        if (entnum >= 0) {
            ai.var_59c5720b[entnum] = 1;
        }
        return 1;
...
// Size: 0x3c
function function_dce0e9b9(prompt = #"use") {
    self namespace_f48ab2e1::remove(prompt);
}
...
// Size: 0xf6
function function_4c106eba(origin, radius = 2000) {
...
// Size: 0x7c
function function_3b6593e4(n_scale, n_time = 0) {
    player = self;
    if (!isplayer(player)) {
        player = getplayers()[0];
    }
    player thread function_466f5224(n_scale, n_time);
}
...
// Size: 0x144
function function_466f5224(n_speed, n_time) {
...
// Size: 0x74
function function_3e29cc9f(n_time = 0) {
    player = self;
    if (!isplayer(player)) {
        player = getplayers()[0];
    }
    player function_3b6593e4(1, n_time);
}
...
function function_27f5f662(var_6aa6a4ac, var_9e5871fd, delay = 4) {
    ...
    while (!flag::get(var_9e5871fd) && var_29a0fa27 < var_6aa6a4ac.size) {
        if (soundexists(var_6aa6a4ac[var_29a0fa27])) {
            if (self != level) {
                self namespace_a635adb1::queue(var_6aa6a4ac[var_29a0fa27]);
            } else {
                self namespace_a635adb1::radio(var_6aa6a4ac[var_29a0fa27]);
            }
        } else {
...
function private function_b7367cc0(parms) {
    if (!is_true(level.var_4032a278)) {
        ...
        #/
        self function_9bc3cd7f(lines[0], lines[1], lines[2]);
    }
}
...
function private function_244408f7(parms) {
    if (!is_true(level.var_4032a278)) {
        ...
        #/
        self function_f11f8038(lines[0], lines[1], lines[2], lines[3]);
    }
}
...
// Size: 0x12a
function function_f11f8038(var_d9823b39, var_be096d26, var_7f1981e0, var_500f33b5) {
    player = getplayers()[0];
    if (!isplayer(player)) {
        return;
    }
...
function function_c76fa9e1(var_42ff3045, var_d47e50e, var_97085828) {
    ...
    switch (player namespace_ee1da81f::function_1c4fb6d4()) {
    case 0:
...
// Size: 0x102
function function_9bc3cd7f(var_fb68995e, var_75afe953, var_7c7241a) {
    player = getplayers()[0];
    if (!isplayer(player)) {
        return;
    }
...
function function_b6f9da41(str_vo) {
    if (isdefined(str_vo) && isstring(str_vo)) {
        if (self != level) {
            self namespace_a635adb1::queue(str_vo);
        } else {
            self namespace_a635adb1::radio(str_vo);
        }
    }
}
...
// Size: 0x44
function function_3d955ac5(b_disable) {
...
// Size: 0x44
function function_1fc26c1e(n_radius) {
    if (function_9d3d451a()) {
