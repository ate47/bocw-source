...
function function_228558fd(var_f2d4fd10 = 0, var_7a646627 = 0) {
    ...
    for (i = 0; i < 99; i++) {
        ...
        if (isdefined(var_65792f8b)) {
            ...
            } else if (is_true(var_65792f8b.issafehouse)) {
                if (var_7a646627) {
                    array::add(var_6bf31125, mapname);
                }
            } else {
...
function function_e3b9f1f5(var_e348e0c6) {
    ...
    ret[var_cd1c0801] = "";
    var_b47752c3 = 0;
    for (i = 0; i < var_e348e0c6.size; i++) {
        c = getsubstr(var_e348e0c6, i, i + 1);
        if (c == "(") {
            var_b47752c3++;
...
// Size: 0x160
function function_6fe3a223(var_e348e0c6) {
    c = getsubstr(var_e348e0c6, 0, 1);
    if (c == "(") {
        c2 = getsubstr(var_e348e0c6, var_e348e0c6.size - 1, var_e348e0c6.size);
        if (c2 != ")") {
            /#
                function_3e8267cc("<unknown string>" + var_e348e0c6);
            #/
        }
        s = getsubstr(var_e348e0c6, 1, var_e348e0c6.size - 1);
    ...
    self.var_672c77b1[self.var_672c77b1.size] = var_e348e0c6;
    return var_e348e0c6;
}
...
// Size: 0x140
function function_4350c864(var_164352d3, var_78c4654) {
    if (!isarray(var_164352d3)) {
        if (isdefined(level.var_c55064fd[var_164352d3]) && (is_true(level.var_c55064fd[var_164352d3].var_9dd617f2) || isinarray(var_78c4654, var_164352d3))) {
            return 0;
        }
        return 1;
...
// Size: 0xb2
function function_375821d8(var_a009ebde) {
    if (scene::function_a4dedc63()) {
        return function_f3c37963(var_a009ebde);
    }
    if (getgametypesetting(#"hash_72a2919d2ac65850")) {
        return function_694aaea7(var_a009ebde);
    }
    if (isdefined(level.var_c55064fd[var_a009ebde])) {
        return level.var_c55064fd[var_a009ebde].next;
    }
...
// Size: 0xe2
function function_694aaea7(var_a009ebde) {
    var_c23e8af7 = [];
    var_c23e8af7[0] = var_a009ebde;
...
// Size: 0xe2
function function_f3c37963(var_a009ebde) {
    var_c23e8af7 = [];
    var_c23e8af7[0] = var_a009ebde;
    while (isdefined(level.var_c55064fd[var_c23e8af7[0]])) {
        if (level.var_c55064fd[var_c23e8af7[0]].next.size) {
...
// Size: 0xc8
function function_116cfcba(var_ea94f865) {
    var_cf8b9535 = "";
    first = 1;
    foreach (skipto in var_ea94f865) {
        if (!first) {
            var_cf8b9535 = var_cf8b9535 + ",";
        }
        first = 0;
        var_cf8b9535 = var_cf8b9535 + skipto;
    }
    return var_cf8b9535;
}
...
function function_5a61e21a(var_7e8557ba) {
    var_4aaf7303 = getdvarstring(#"hash_12134c95f194c7e4");
    ...
    if (isdefined(var_4aaf7303) && var_4aaf7303.size) {
        ...
        var_ea94f865 = strtok(var_4aaf7303, ",");
        return var_ea94f865;
    }
    if (is_true(var_7e8557ba)) {
        var_ea94f865 = tolower(getdvarstring(#"sv_savegameskipto"));
    } else {
        var_ea94f865 = tolower(getskiptos());
    }
    result = strtok(var_ea94f865, ",");
    return result;
}
...
function function_3a4ee594(var_a009ebde) {
    ...
    return level.var_c55064fd[var_a009ebde].var_8a2e8898;
}
...
// Size: 0x34
function function_2bc844d6(var_ea94f865) {
    function_8722a51a(function_116cfcba(var_ea94f865));
}
...
// Size: 0xea
function function_9e3233ed(var_ea94f865) {
    done = 0;
    while (isdefined(var_ea94f865) && var_ea94f865.size && !done) {
        done = 1;
        foreach (skipto in var_ea94f865) {
            if (!isdefined(level.var_c55064fd[skipto])) {
                arrayremovevalue(var_ea94f865, skipto, 0);
                done = 0;
                break;
            }
        }
...
function handle() {
    ...
    var_ea94f865 = function_5a61e21a(1);
    var_4aaf7303 = getdvarstring(#"hash_12134c95f194c7e4");
    if (isdefined(var_4aaf7303) && var_4aaf7303.size) {
    ...
    var_ea94f865 = function_9e3233ed(var_ea94f865);
    /#
        assert(is_true(level.first_frame), "<unknown string>");
    #/
    if (isdefined(level.var_b28c2c3a)) {
        var_ea94f865 = [];
        var_ea94f865[0] = level.var_b28c2c3a;
    }
    level.var_28c22d88 = var_ea94f865;
    ...
    var_65792f8b = function_2717b55f(var_10dbdb82);
...
function function_53c3e1eb() {
    return function_525a83cb(level.var_b28c2c3a);
}
...
function function_90e25b64() {
    ...
    level.var_f5fcf6ed = 1;
    if (isdefined(level.var_ad8acff7)) {
        level [[ level.var_ad8acff7 ]]();
    }
    level thread load::all_players_spawned();
    array::thread_all(getentarray("water", "targetname"), &load::water_think);
    level waittill(#"hash_12059140aabbd521");
}
...
function function_abaeef51(str, var_d5779ab5, var_54e5e046) {
    var_f9ab0152 = strtok(str, var_d5779ab5);
    var_cc407339 = "";
    first = 1;
    foreach (s in var_f9ab0152) {
        if (!first) {
...
// Size: 0x152
function function_16ad9e86(table, var_bf26b910, var_4469951e = "") {
    index = 0;
    row = tablelookuprow(table, index);
    while (isdefined(row)) {
        if (row[0] == var_bf26b910 && row[1] == var_4469951e) {
            skipto = row[2];
            var_672c77b1 = row[3];
            var_89f09f8d = row[4];
            var_89f09f8d = function_abaeef51(var_89f09f8d, "+", ",");
            var_2282ea8e = row[5];
            function_9c003a50(skipto, &function_9e68c55e, var_2282ea8e, undefined, var_672c77b1, var_89f09f8d);
        }
        index++;
        row = tablelookuprow(table, index);
    }
...
function function_da5051ef(objectivename, player) {
    ...
    var_4a8d1677 = player stats::get_stat("PlayerStatsList", #"total_shots", #"statvalue");
    totalhits = player stats::get_stat("PlayerStatsList", #"hits", #"statvalue");
    if (isdefined(var_4a8d1677)) {
        player function_9ef3400f("shots_total", objectiveindex, player.var_62e314f8.shots, var_4a8d1677);
    }
...
function function_7c7195b4(player) {
    ...
    player.var_62e314f8.difficulty = level.var_d2257418;
    var_313c84fd = 0;
    var_d72847a7 = 0;
    var_17cff347 = 0;
    var_1940d7af = 0;
...
function on_player_connect() {
    ...
    if (getdvarint(#"ui_blocksaves", 0) == 0) {
        if (self ishost()) {
            ...
            if (!var_ea1ac9c) {
                self savegame::function_6d003cb9("savegame_score", self function_8338f930("SCORE", rootmapname));
                self savegame::function_6d003cb9("savegame_kills", self function_8338f930("KILLS", rootmapname));
                self savegame::function_6d003cb9("savegame_assists", self function_8338f930("ASSISTS", rootmapname));
                self savegame::function_6d003cb9("savegame_incaps", self function_8338f930("INCAPS", rootmapname));
                self savegame::function_6d003cb9("savegame_revives", self function_8338f930("REVIVES", rootmapname));
                if (sessionmodeisonlinegame()) {
            ...
            if (!isdefined(self savegame::function_2ee66e93("savegame_score"))) {
                self savegame::function_6d003cb9("savegame_score", 0);
            }
            if (!isdefined(self savegame::function_2ee66e93("savegame_kills"))) {
                self savegame::function_6d003cb9("savegame_kills", 0);
            }
            if (!isdefined(self savegame::function_2ee66e93("savegame_assists"))) {
                self savegame::function_6d003cb9("savegame_assists", 0);
            }
            if (!isdefined(self savegame::function_2ee66e93("savegame_incaps"))) {
                self savegame::function_6d003cb9("savegame_incaps", 0);
            }
            if (!isdefined(self savegame::function_2ee66e93("savegame_revives"))) {
                self savegame::function_6d003cb9("savegame_revives", 0);
            }
...
function function_4e3ab877(name, var_28e39919 = 1, player, var_ce580a72) {
    ...
    foreach (var_9eeced56 in level.players) {
        ...
        bb::function_47cb52f6(name, var_9eeced56, "complete");
...
// Size: 0x2f4
function function_51726ac8(objectives, var_f9f06983, player) {
    function_fc434ec9();
    foreach (name in objectives) {
        if (isdefined(level.var_c55064fd[name])) {
            function_60288de7(level.var_c55064fd[name].prev, var_f9f06983, 0, player);
        }
    }
    ...
    function_d037bbec(objectives, var_f9f06983);
    ...
    namespace_643f86fe::function_59e67711(objectives[0]);
    ...
    update_spawn_points(var_f9f06983);
}
...
// Size: 0x440
function function_d037bbec(name, var_f9f06983, var_23522927 = 0) {
    if (isarray(name)) {
        if (var_f9f06983 && name.size > 1) {
        ...
        foreach (element in name) {
            function_d037bbec(element, var_f9f06983, var_23522927);
        }
        if (var_f9f06983 && name.size > 1) {
        ...
        if (isdefined(level.var_c55064fd[name])) {
            if (!is_true(level.var_c55064fd[name].var_9dd617f2)) {
                ...
                if (!getdvarint(#"art_review", 0)) {
                    function_d8ddef0(name, var_f9f06983);
                    level thread function_b7e9926c(name, var_f9f06983, var_23522927);
...
// Size: 0x168
function private function_b7e9926c(name, var_f9f06983, var_23522927) {
    ...
    if (isdefined(var_3d5f0584.var_e5301d70)) {
        level namespace_f49eaa8b::function_a7d79fcb(var_3d5f0584.var_e5301d70, 1);
    }
    function_9ab01465();
    if (var_f9f06983) {
        if (!var_23522927) {
    ...
    if (isdefined(var_3d5f0584.var_2c183249)) {
        [[ var_3d5f0584.var_2c183249 ]](name, var_f9f06983);
    }
}
...
function private function_cdbc8d16(frozen) {
    ...
    if (is_true(frozen)) {
        ...
        self val::function_e681e68e(#"hash_3d2438fcbc75f543");
    }
}
...
// Size: 0x39c
function function_60288de7(name, var_f9f06983, direct, player) {
    if (isarray(name)) {
        foreach (element in name) {
            function_60288de7(element, var_f9f06983, direct, player);
        }
        ...
        if (is_true(level.var_c55064fd[name].var_9dd617f2)) {
            ...
            if (!getdvarint(#"art_review", 0)) {
                if (isdefined(level.var_c55064fd[name].cleanup_func)) {
                    thread [[ level.var_c55064fd[name].cleanup_func ]](name, var_f9f06983, direct, player);
                }
                function_9b847391(name, var_f9f06983, direct, player);
            }
        ...
        if (!is_true(level.var_c55064fd[name].var_a6ddf9d6)) {
            ...
            if (!is_true(level.var_c55064fd[name].looping)) {
                ...
                foreach (element in prev) {
                    function_60288de7(element, var_f9f06983, 0, player);
                }
            }
            if (var_f9f06983 && !var_7d62f656) {
                if (!getdvarint(#"art_review", 0)) {
                    if (isdefined(level.var_c55064fd[name].cleanup_func)) {
                        thread [[ level.var_c55064fd[name].cleanup_func ]](name, var_f9f06983, 0, player);
                    }
                    function_9b847391(name, var_f9f06983, 0, player);
                }
            }
        }
    }
...
function function_455cb6c5(var_83104433) {
    if (isdefined(var_83104433)) {
        ...
        if (var_266acb38 >= 0) {
            var_65792f8b = function_2717b55f(savegame::function_8136eb5a());
...
function function_6914f647() {
    ...
    if (safehouse.size != 0) {
        ...
        if (isdefined(var_4d75d53a) && is_true(var_4d75d53a.var_32a51de2)) {
            var_925d44be = player stats::get_stat(#"hash_1e7fdd28f2a28f78", var_10dbdb82, #"hash_4f37204358803a0f");
        }
        if (!isdefined(var_925d44be) || var_925d44be == 0) {
            var_925d44be = getmaporder();
        }
        for (i = var_925d44be - 1; i >= 0; i--) {
...
function function_1c2dfc20(var_83104433 = function_60ca00f5(), var_585e39fb = function_455cb6c5(var_83104433)) {
    ...
    matchrecordsetleveldifficultyforindex(1, level.var_d2257418);
    ...
    foreach (player in getplayers()) {
        ...
        player savegame::function_6d003cb9("saved_weapon", player._current_weapon.rootweapon.name);
        player savegame::function_6d003cb9("saved_weapon_attachments", util::function_2146bd83(player._current_weapon));
        player savegame::function_6d003cb9("saved_weapondata", player._weapons);
        player savegame::function_6d003cb9("lives", player.lives);
...
// Size: 0x70
function private function_d8ddef0(skipto, *var_f9f06983) {
    level flag::set(var_f9f06983);
    level thread function_4e6fcdc(var_f9f06983);
    /#
        level.var_c2ccaeac = var_f9f06983;
...
// Size: 0x244
function private function_9b847391(skipto, *var_f9f06983, *direct, *player) {
    ...
    if (!is_true(level.var_60233e4f)) {
        var_afd0b2bd = getentarray(player, "script_objective");
        foreach (entity in var_afd0b2bd) {
