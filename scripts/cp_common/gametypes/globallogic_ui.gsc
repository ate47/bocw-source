...
function on_player_spawn() {
    ...
    /#
        assert(isdefined(level.var_d2257418));
    #/
    self clientfield::set_player_uimodel("hudItems.serverDifficulty", level.var_d2257418);
...
function private function_1cb458b4() {
    ...
    while (1) {
        ...
        function_3f278444();
        player = getplayers()[0];
        foreach (alias, var_cab4339b in level.luimenus) {
            if (alias != "InitialBlack") {
                var_5f6d4251 = var_cab4339b.var_779239b4 && !player flag::get(var_cab4339b.var_6fba7045);
                if ([[ var_cab4339b ]]->function_7bfd10e6(player)) {
                    [[ var_cab4339b ]]->close_luielem(player);
                }
                if (var_5f6d4251) {
                    player thread function_5e65cc6f(var_cab4339b);
                }
            }
        }
    }
...
// Size: 0x74
function function_5e65cc6f(var_cab4339b) {
    util::wait_network_frame(2);
    if (!is_true(var_cab4339b.var_779239b4) && !self flag::get(var_cab4339b.var_6fba7045)) {
        [[ var_cab4339b ]]->open_luielem(self);
    }
}
...
function function_760546ce() {
    ...
    namespace_61e6d095::function_15d47899();
    namespace_96850e69::function_15d47899();
    waitframe(1);
    function_3e57e536(1);
    savegame::function_6440b06b(#"hash_e7d26541441cb9d").var_c42c3d = [];
...
function private function_52da41bb(model_name, var_832d6681, var_ec71f60a, var_2226bd51, created) {
    ...
    var_e074d966.var_c42c3d[model_name].name = model_name;
    var_e074d966.var_c42c3d[model_name].value = var_832d6681;
    var_e074d966.var_c42c3d[model_name].global = is_true(var_ec71f60a);
    var_e074d966.var_c42c3d[model_name].var_2226bd51 = is_true(var_2226bd51);
    var_e074d966.var_c42c3d[model_name].created = is_true(var_e074d966.var_c42c3d[model_name].created) || is_true(created);
}
...
function function_2ec075a9(model_name, var_c15ae58d) {
    ...
    if (is_true(var_c15ae58d)) {
        ...
        foreach (val in var_e074d966.var_c42c3d) {
            if (strstartswith(val.name, model_name)) {
                level notify("removing_ui_model_data_" + val.name);
                arrayremoveindex(var_e074d966.var_c42c3d, val.name, 1);
            }
        }
    }
}
...
// Size: 0x2b8
function function_4e49c51d(title = #"", description = #"", var_c7f36d1c = 0, var_92c0faf8, cancel_callback, var_21a58cc0, var_380e2def = #"", var_c9ec8cda = #"") {
...
// Size: 0x1be
function function_8f0a7b3b(var_d9dcce4) {
    ais = getaiteamarray(util::getotherteam(var_d9dcce4.team));
    ais = arraycombine(ais, getaiteamarray(#"team3"), 0, 0);
    foreach (ai in ais) {
        if (issentient(ai)) {
            if (ai attackedrecently(var_d9dcce4, 10)) {
                return 1;
            } else if (ai.enemy === var_d9dcce4 && isdefined(ai.weapon) && ai.weapon.name === "none" && distancesquared(ai.origin, var_d9dcce4.origin) < function_a3f6cdac(240)) {
                return 1;
            }
        }
    }
...
// Size: 0x12c
function function_ff5a6c36(var_d9dcce4) {
    ais = getaiteamarray(util::getotherteam(var_d9dcce4.team));
    ais = arraycombine(ais, getaiteamarray(#"team3"), 0, 0);
    foreach (ai in ais) {
        if (issentient(ai)) {
            if (ai lastknowntime(var_d9dcce4) + 4000 >= gettime()) {
                return 1;
            }
        }
    }
...
// Size: 0x20
function function_b0604e5b(var_d9dcce4) {
    return var_d9dcce4.health < var_d9dcce4.maxhealth;
}
...
function beginclasschoice() {
    ...
    if (!getdvarint(#"hash_16efeb2766b64b92", 0) || var_2bd8b207) {
        ...
        var_b4c4e2f3 = self savegame::function_2ee66e93("playerClass", undefined);
        if (isdefined(var_b4c4e2f3) || var_2bd8b207 || function_ee6b4b2b() || getdvarint(#"migration_soak", 0) == 1 || getdvarint(#"art_review", 0)) {
            self thread spawn_player(var_b4c4e2f3);
            self function_251fa54a();
            return;
        }
    }
...
// Size: 0xfc
function spawn_player(*var_b4c4e2f3) {
...
// Size: 0xf4
function function_3d8fe4dd(var_426fecc3, var_3697223f = undefined, var_715b7ca4 = undefined) {
    if (!isdefined(var_3697223f)) {
        var_3697223f = getdvarint(#"ui_weakpointindicatornear", 1050);
    }
    if (!isdefined(var_715b7ca4)) {
        var_715b7ca4 = getdvarint(#"ui_weakpointindicatormedium", 1900);
    }
    luinotifyevent(#"hash_1fb77fec1c54b437", 5, 1, self getentitynumber(), var_426fecc3, var_3697223f, var_715b7ca4);
...
function function_541212af(var_426fecc3) {
    self notify(#"hash_1fb77fec1c54b437", {#event:"damage", #bone_name:var_426fecc3});
}
...
function function_b03b1c3c(var_426fecc3) {
    self notify(#"hash_1fb77fec1c54b437", {#event:"repulse", #bone_name:var_426fecc3});
}
...
function private function_36e939c(var_4146002e = 1, var_d76d90ac = 0) {
    ...
    if (var_4146002e) {
        ...
        self val::set(#"hash_7b7f5444af189990", "disable_weapons", 1);
        self val::set(#"hash_7b7f5444af189990", "ignoreme", 1);
    }
    waittillframeend();
