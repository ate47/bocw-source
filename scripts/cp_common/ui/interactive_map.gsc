...
function open(var_738a6265, top_left, bottom_right, var_879505e1 = 1, var_ff0f9714 = 1, var_3031d93b, var_3e6ff5b7, var_f754e046, var_7cf4cc67, var_7ec0800f) {
    if (!namespace_61e6d095::exists(#"interactive_map")) {
        ...
        namespace_61e6d095::function_24e5fa63(#"interactive_map", [1:#"hash_3c27402259e4c18e", 0:#"ui_confirm"], 1);
        ...
        if (isdefined(var_f754e046)) {
            namespace_61e6d095::set_width(#"interactive_map", var_f754e046);
        }
        if (isdefined(var_7cf4cc67)) {
            namespace_61e6d095::set_height(#"interactive_map", var_7cf4cc67);
        }
        ...
        var_208e5fc4 = anglestoright(top_left.angles) * -1;
        var_2b6eb4a4 = anglestoforward(top_left.angles);
        var_2a5cff6e = bottom_right.origin - top_left.origin;
        width = vectordot(var_2a5cff6e, var_208e5fc4);
        height = vectordot(var_2a5cff6e, var_2b6eb4a4);
        if (!isdefined(level.interactive_map)) {
            level.interactive_map = {};
        }
        level.interactive_map.var_e1d2ab75 = {#var_2b6eb4a4:var_2b6eb4a4, #var_208e5fc4:var_208e5fc4, #height:height, #width:width, #top_left:top_left.origin};
...
function function_879505e1(var_ff0f9714 = 1, var_509b0860 = #"hash_780067c4596705d7", var_74ac68df = #"hash_71f8107215effa5b") {
    /#
        assert(exists(#"interactive_map"), "<unknown string>");
    #/
    ...
    function_8b43da33();
    function_e4d34e68(0);
    namespace_f48ab2e1::function_e79f51ec(#"cursor");
    level.interactive_map.var_1cd32747 = vectorscale((1, 1, 0), 0.5);
    if (isdefined(level.interactive_map.var_87c49d20)) {
        ...
        level.interactive_map.var_1cd32747 = (vectordot(var_75576067, level.interactive_map.var_e1d2ab75.var_208e5fc4) / level.interactive_map.var_e1d2ab75.width, vectordot(var_75576067, level.interactive_map.var_e1d2ab75.var_2b6eb4a4) / level.interactive_map.var_e1d2ab75.height, 0);
    }
...
// Size: 0x3b6
function function_9e8d4999(title = #"", var_41eca8d5, var_4d9a3f80, object) {
    if (!isdefined(var_41eca8d5)) {
        var_41eca8d5 = [];
    } else if (!isarray(var_41eca8d5)) {
        var_41eca8d5 = array(var_41eca8d5);
    }
    if (!isdefined(var_4d9a3f80)) {
        var_4d9a3f80 = [];
    } else if (!isarray(var_4d9a3f80)) {
        var_4d9a3f80 = array(var_4d9a3f80);
    }
    function_23036faa(#"cursor", "title", title);
    foreach (index, description in var_41eca8d5) {
        function_39d12272(#"cursor", index, "text", description, "descriptionList");
    }
    if (isdefined(level.interactive_map.var_2c15274b.var_41eca8d5)) {
        for (index = var_41eca8d5.size; index < level.interactive_map.var_2c15274b.var_41eca8d5.size; index++) {
            function_dcedf7f(#"cursor", index, "descriptionList");
        }
    }
    var_fadf668d = 0;
    player = getplayers()[0];
    player namespace_f48ab2e1::function_ee7adae5(#"cursor");
    foreach (prompt, var_e1a342bb in var_4d9a3f80) {
        player namespace_f48ab2e1::function_c97a48c7(prompt, var_e1a342bb);
        var_fadf668d = 1;
    }
    if (var_fadf668d) {
        player namespace_f48ab2e1::function_46f198(#"interactive_map", "cursor" + "." + "mapObjects" + "." + #"cursor" + "." + "interactionList");
    }
    level.interactive_map.var_2c15274b = {#object:object, #var_4d9a3f80:var_4d9a3f80, #var_41eca8d5:var_41eca8d5, #title:title};
}
...
function function_8b43da33() {
    ...
    if (isdefined(level.interactive_map.var_2c15274b)) {
        foreach (index, description in level.interactive_map.var_2c15274b.var_41eca8d5) {
            function_dcedf7f(#"cursor", index, "descriptionList");
        }
        getplayers()[0] namespace_f48ab2e1::function_ee7adae5(#"cursor");
...
// Size: 0x444
function add_object(uid, image = #"hash_215b9409f9d7cc36", var_6d62c29c, var_24af7a37, title, scale) {
    ...
    if (!isdefined(var_24af7a37)) {
        var_24af7a37 = self.interactive_map.var_24af7a37;
    }
    if (!isdefined(title)) {
    ...
    self.interactive_map.var_24af7a37 = var_24af7a37;
    ...
    self thread function_9dfe141f(uid, var_6d62c29c, var_24af7a37);
}
...
function function_41d66375(uid, var_29459a31) {
    namespace_61e6d095::function_330981ed(#"interactive_map", "cursor." + "mapObjects" + "." + uid + "." + var_29459a31);
}
...
function function_39d12272(uid, index, name, value, var_29459a31) {
    namespace_61e6d095::function_f2a9266(#"interactive_map", index, name, value, "cursor." + "mapObjects" + "." + uid + "." + var_29459a31);
}
...
function function_dcedf7f(uid, index, var_29459a31) {
    namespace_61e6d095::function_7239e030(#"interactive_map", index, "cursor." + "mapObjects" + "." + uid + "." + var_29459a31);
}
...
function function_6385c805() {
    ...
    self.var_2ac0bdff = (vectordot(var_fe23d888, level.interactive_map.var_e1d2ab75.var_208e5fc4) / level.interactive_map.var_e1d2ab75.width, vectordot(var_fe23d888, level.interactive_map.var_e1d2ab75.var_2b6eb4a4) / level.interactive_map.var_e1d2ab75.height, 0);
...
function function_9bc3d847(event, name, value, var_872a88cd) {
    ...
    self.var_62d718e2[event] = {#var_872a88cd:var_872a88cd, #value:value, #name:name};
}
...
function function_b5c2702b(prompt, var_248cbbcf) {
    ...
    if (!isdefined(var_248cbbcf.groups)) {
        var_248cbbcf.groups.var_248cbbcf = [];
    ...
    var_248cbbcf.var_1df3804c.var_248cbbcf = self;
...
// Size: 0x7c
function private function_db6cb581(uid, var_9f5096b8 = #"hash_21fb68e196ffe610") {
...
// Size: 0x266
function private function_9dfe141f(uid, var_6d62c29c, var_24af7a37 = 0) {
    ...
    while (1) {
        ...
        angles = self.angles;
        if (isentity(self)) {
            pos = pos + rotatepoint(self function_2c662f72(), angles);
        }
        ...
        if (is_true(var_6d62c29c)) {
            function_d0243e5b(uid, "angle", angles[1] + var_24af7a37);
        }
        waitframe(1);
    }
}
...
function private function_75cb287(*var_ff0f9714) {
    ...
    while (1) {
        ...
        level.interactive_map.var_87c49d20 = level.interactive_map.var_e1d2ab75.top_left + level.interactive_map.var_1cd32747[0] * level.interactive_map.var_e1d2ab75.width * level.interactive_map.var_e1d2ab75.var_208e5fc4 + level.interactive_map.var_1cd32747[1] * level.interactive_map.var_e1d2ab75.height * level.interactive_map.var_e1d2ab75.var_2b6eb4a4;
        function_c9099483();
        function_393ad031();
        waitframe(1);
    }
...
function private function_7560d352(object) {
    ...
    if (isdefined(object.var_62d718e2[#"hash_34d2747d17c812f9"])) {
        ...
        if (isdefined(object.interactive_map.uid)) {
            function_d0243e5b(object.interactive_map.uid, object.var_62d718e2[#"hash_34d2747d17c812f9"].name, object.var_62d718e2[#"hash_34d2747d17c812f9"].var_872a88cd);
        } else {
...
function private function_11396e33(object) {
    ...
    if (isdefined(object.var_62d718e2[#"hash_9ca7f8f691003b5"])) {
        ...
        if (isdefined(object.interactive_map.uid)) {
            function_d0243e5b(object.interactive_map.uid, object.var_62d718e2[#"hash_9ca7f8f691003b5"].name, object.var_62d718e2[#"hash_9ca7f8f691003b5"].var_872a88cd);
        } else {
