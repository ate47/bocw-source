...
function player_stats_init() {
    ...
    self globallogic_score::initpersstat(#"hash_518b342965697c8a", 0);
...
function update_players_stats_at_match_end(players) {
    ...
    for (i = 0; i < players.size; i++) {
        ...
        if (level.onlinegame) {
            ...
            player function_d4e0d242("MOST_KILLS_SPECIAL", player.pers[#"hash_518b342965697c8a"]);
            player function_1b763e4("MOST_KILLS_SPECIAL", player.pers[#"hash_518b342965697c8a"]);
...
function set_global_stat(stat_name, value) {
    ...
    /#
        var_ba1fb8c1 = self get_stat(#"playerstatslist", stat_name, #"statvalue");
        println("killed_by_crimson_nosferatu" + self getentitynumber() + "boas_gladiators_killed" + function_9e72a96(stat_name) + "catalysts_killed" + var_ba1fb8c1);
    #/
}
...
function function_a05b3b23(stat_name, value) {
    ...
    /#
        assert(isdefined(level.var_6d87ac05) && isdefined(level.var_6d87ac05.name), "werewolves_killed");
    #/
...
function function_51c1448(stat_name, amount = 1, var_4261ca42, str_weapon_name) {
    ...
    #/
    /#
        assert(ishash(var_4261ca42), "<unknown string>");
    #/
    if (!level.onlinegame || is_true(level.zm_disable_recording_stats)) {
        return;
    }
    ...
    /#
        ...
        if (isdefined(self.entity_num)) {
            println("killed_by_crimson_nosferatu" + self.entity_num + "boas_gladiators_killed" + function_9e72a96(stat_name) + "catalysts_killed" + var_ba1fb8c1);
        } else {
            println("killed_by_crimson_nosferatu" + function_9e72a96(stat_name) + "catalysts_killed" + var_ba1fb8c1);
        }
    #/
}
...
function function_fbce465a(stat_name, amount = 1, var_b68b08b1 = 0) {
    ...
    /#
        var_ba1fb8c1 = self function_e3eb9a8b(stat_name);
        if (isdefined(self.entity_num)) {
            println("killed_by_crimson_nosferatu" + self.entity_num + "boas_gladiators_killed" + function_9e72a96(stat_name) + "catalysts_killed" + var_ba1fb8c1);
        } else {
            println("killed_by_crimson_nosferatu" + function_9e72a96(stat_name) + "catalysts_killed" + var_ba1fb8c1);
...
function function_a6b15f2c(var_d5fa8477, b_value = 1) {
    ...
    /#
        if (function_f94325d3() && !is_true(b_result)) {
            /#
                assertmsg("<unknown string>" + function_9e72a96(var_d5fa8477) + "<unknown string>");
            #/
        }
    #/
}
...
function function_ef7d5199(evictim, weapon) {
    ...
    if (isdefined(evictim.origin) && isdefined(self.origin) && isdefined(weapon.name)) {
        ...
        if (var_40fd58bf >= function_a3f6cdac(60)) {
            var_74e5763 = 4;
        } else if (var_40fd58bf >= function_a3f6cdac(40)) {
            var_74e5763 = 3;
        } else if (var_40fd58bf >= function_a3f6cdac(20)) {
            var_74e5763 = 2;
        } else if (var_40fd58bf >= function_a3f6cdac(10)) {
            var_74e5763 = 1;
        }
    ...
    foreach (player in players) {
        ...
        if (is_true(var_220c56da) && !isbot(player) && isdefined(player.var_78c18942) && player.var_78c18942 > 0 && getdvarint(#"hash_2fd4aa73a8da1e9d", 1)) {
            ...
            if (var_f406f7e3 != "") {
                ...
                player.var_361d484b.player = player.var_361d484b + xpearned;
                ...
                /#
                    println("<unknown string>" + player.name + "<unknown string>" + total_time + "<unknown string>" + var_90f98f51 + "<unknown string>" + xpearned);
                #/
    ...
    if (getdvarint(#"hash_27ff853067d7c38c", 0) && getdvarint(#"zm_active_daily_calling", 0)) {
        /#
            if (getdvar(#"hash_acdd08b365cb62f", 0)) {
                ...
                var_87b499fb = self get_stat(#"hash_18e3320ccf4091e5", #"hash_487f0fce798b3a4b");
                var_8962d9b1 = isdefined(level.var_d479261a) ? level.var_d479261a : 0;
                self set_stat(#"hash_18e3320ccf4091e5", #"hash_487f0fce798b3a4b", var_8962d9b1);
                if (var_87b499fb !== var_8962d9b1) {
                    self set_stat(#"hash_18e3320ccf4091e5", #"progress", 0);
                }
            }
        #/
...
function function_7f377150(s_event_calling_task, n_value = 1) {
    ...
    if (var_e4edaaf0 < s_event_calling_task.var_e226ec4f) {
        if (var_e4edaaf0 + n_value >= s_event_calling_task.var_e226ec4f) {
            ...
            uploadstats(self);
            /#
                println(function_9e72a96(level.var_6ad5a223) + "<unknown string>" + self get_stat(#"hash_3b52e51401f0229c", level.var_6ad5a223, "<unknown string>") + "<unknown string>" + function_9e72a96(s_event_calling_task.var_ad971622));
            #/
        } else {
            /#
...
function function_12b698fa(statname) {
    var_7dfd59c3 = self stats::function_6d50f14b(#"cacloadouts", #"hash_1b24e5b336f5ae8d", statname);
...
function function_1a222bee(params) {
    if (isdefined(params.item.var_a6762160.weapon.statname) && !killstreaks::is_killstreak_weapon(params.item.var_a6762160.weapon)) {
        ...
        case #"frost_blast_3":
        case #"frost_blast_2":
            self stats::function_622feb0d(#"frost_blast", #"hash_7d6781e4032b4aa5", 1);
            break;
        ...
        case #"hash_7b5a77a85b0ffab7":
            self stats::function_622feb0d(#"hash_7b5a77a85b0ffab7", #"hash_7d6781e4032b4aa5", 1);
            break;
        ...
        case #"hash_1d9cb9dbd298acba":
            self stats::function_622feb0d(#"hash_1d9cb9dbd298acba", #"hash_7d6781e4032b4aa5", 1);
            break;
        ...
        case #"hash_164c93cbd0ef1d7":
            self stats::function_622feb0d(#"hash_2d88b4c5217c7e7c", #"hash_7d6781e4032b4aa5", 1);
            break;
        ...
        case #"hash_55569355da0f0f68":
            self stats::function_622feb0d(#"hash_55569355da0f0f68", #"hash_7d6781e4032b4aa5", 1);
            break;
        ...
        case #"hash_7a071f09cf16cbfa":
            self stats::function_622feb0d(#"hash_5d6f444e983b62ca", #"hash_7d6781e4032b4aa5", 1);
            break;
        ...
        case #"hash_3d62bcc92bbcadac":
            self stats::function_622feb0d(#"hash_148e5880a4f4d46f", #"hash_7d6781e4032b4aa5", 1);
            break;
        case #"frag_grenade":
            self stats::function_622feb0d(#"eq_frag_grenade", #"hash_7d6781e4032b4aa5", 1);
            break;
