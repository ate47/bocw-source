...
function function_cf3f5b23() {
    ...
    foreach (item in itemspawnlist.itemlist) {
        ...
        if (isdefined(point.weapon)) {
            ...
            if (isdefined(item.var_7b0c7fe3) && isdefined(item.var_8261a18) && isdefined(item.var_3f8c08e3) && isdefined(var_d1d465fa) && isdefined(item.var_23a1d10f)) {
                level.var_ec04a8a4[var_d1d465fa] = [#"orange":item.var_168e36e8, #"purple":item.var_23a1d10f, #"blue":item.var_7b0c7fe3, #"green":item.var_8261a18, #"white":item.var_3f8c08e3];
            }
        }
    }
    ...
    foreach (item in var_24435603.itemlist) {
        ...
        if (isdefined(point.weapon)) {
            var_d1d465fa = point.weapon.name;
            if (isdefined(item.var_7b0c7fe3) && isdefined(item.var_8261a18) && isdefined(item.var_3f8c08e3) && isdefined(var_d1d465fa) && isdefined(item.var_23a1d10f)) {
                level.var_c1f1b29a[var_d1d465fa] = [#"orange":item.var_168e36e8, #"purple":item.var_23a1d10f, #"blue":item.var_7b0c7fe3, #"green":item.var_8261a18, #"white":item.var_3f8c08e3];
            }
        }
    }
}
    ...
    if (isplayer(self) && isalive(self) && isdefined(point) && isdefined(item)) {
        ...
        if (isdefined(point.var_a6762160.var_a53e9db0)) {
            ...
            if (isdefined(var_a8bccf69) && isdefined(level.var_c1f1b29a)) {
                ...
                var_f70c2a55.hidetime.var_f70c2a55 = 1;
                var_f70c2a55 hide();
                var_f70c2a55.var_864ea466.var_f70c2a55 = 1;
                drop_item = item_drop::drop_item(0, new_weapon, 1, new_weapon.maxammo, point.id, self.origin, self.angles, 1);
                if (!isdefined(drop_item)) {
                    self val::reset(#"hash_55af237178580523", "disable_weapon_cycling");
                    return;
                }
                drop_item.hidetime.drop_item = 1;
                drop_item hide();
                drop_item.var_864ea466.drop_item = 1;
                ...
                var_f70c2a55.hidetime.var_f70c2a55 = 0;
                ...
                if (isdefined(var_ec0c35ac)) {
                    var_ec0c35ac function_9aaa198a(var_5302a1ef, var_a0cc02cf, var_96c71057, var_65cfac4a, var_9460390a, var_604af0c7);
                ...
                drop_item hide();
                drop_item.var_864ea466.drop_item = 1;
                drop_item.var_99628f67.drop_item = 1;
                if (isdefined(clipsize) && isdefined(var_9839b3b1)) {
                ...
                drop_item.hidetime.drop_item = 0;
                dropweapon = self item_inventory::get_current_weapon();
                var_5c695210 = function_9f1cc9a9(dropweapon);
...
function function_30b08f95() {
    ...
    foreach (item in itemspawnlist.itemlist) {
        ...
        if (isdefined(point.weapon)) {
            var_d1d465fa = point.weapon.name;
            if (isdefined(item.var_23a1d10f) && isdefined(item.var_7b0c7fe3) && isdefined(item.var_8261a18) && isdefined(item.var_3f8c08e3) && isdefined(var_a559259f[var_d1d465fa]) && isdefined(var_d1d465fa) && isdefined(item.var_168e36e8)) {
                level.var_29d88fe5[var_d1d465fa] = [#"gold":item.var_168e36e8, #"orange":item.var_23a1d10f, #"purple":item.var_7b0c7fe3, #"blue":item.var_8261a18, #"green":item.var_3f8c08e3, #"white":var_a559259f[var_d1d465fa]];
            }
        }
    }
}
...
function add_zombie_weapon(weapon_name, upgrade_name, is_ee, cost, weaponvo, weaponvoresp, ammo_cost, create_vox, weapon_class, is_wonder_weapon, tier = 0, in_box, element) {
    ...
    struct.hint.struct = #"hash_60606b68e93a29c8";
    struct.cost = cost;
    struct.vox = weaponvo;
    struct.vox_response = weaponvoresp;
    struct.is_wonder_weapon = is_wonder_weapon;
    struct.tier = tier;
    struct.var_9d17fab9.struct = weapon_name + "_item_sr";
    struct.element.struct = isdefined(element) && element != #"" ? element : undefined;
    if (is_true(is_wonder_weapon)) {
        struct.var_51344511.struct = [];
    }
    /#
        println("<unknown string>" + function_9e72a96(weapon_name));
    #/
    struct.is_in_box.struct = level.zombie_include_weapons[weapon];
...
function private function_a2ce802c(list) {
    ...
    foreach (s_item in s_bundle.itemlist) {
        ...
        var_ecce48b5[var_ecce48b5.size] = var_a6762160;
    }
...
function private function_350ee41() {
    ...
    if (isdefined(level.var_ee110db8[#"hash_6cfd80cff9612eb3"])) {
        level.var_f063e70 = level.var_ee110db8[#"hash_6cfd80cff9612eb3"];
    }
...
function function_98776900(item, nosound = 0, var_ac6e9818 = 0, var_d29fef1 = 0) {
    ...
    if (!item_world_util::function_d9648161(item.var_bd027dd9)) {
        /#
            println("<unknown string>" + (isdefined(item.var_a6762160.name) ? item.var_a6762160.name : "<unknown string>"));
        #/
        return;
    }
...
function function_7df0d6b2(item, weapon, weaponoptions, var_e91aba42, var_908f65ca) {
    ...
    if (isdefined(weaponoptions)) {
        item.weaponoptions.item = self item_inventory::function_fc04b237(weapon, item.weaponoptions);
    }
}
...
// Size: 0x16c
function function_b0ab2d41(itemid, var_bd027dd9, var_5302a1ef, var_a0cc02cf, var_96c71057, var_65cfac4a, var_9460390a, var_604af0c7) {
    self endon(#"death");
    ...
    foreach (inventory_item in self.inventory.items) {
        if (inventory_item.id === itemid && inventory_item.var_bd027dd9 === var_bd027dd9) {
            var_a6d31447 = inventory_item;
            break;
        }
    }
    if (isdefined(var_a6d31447)) {
        var_a6d31447 function_9aaa198a(var_5302a1ef, var_a0cc02cf, var_96c71057, var_65cfac4a, var_9460390a, var_604af0c7);
    }
}
...
function function_943eabd9(item_struct, nosound = 1, var_8e917f9b = 0, var_8f608a31 = 0, var_1b46b4cb = undefined, weaponoptions = undefined, var_e91aba42 = undefined, var_908f65ca = undefined) {
    if (isdefined(item_struct)) {
        if (var_8e917f9b || var_8f608a31) {
            item_struct.var_b3546c09.item_struct = 1;
        }
        ...
        if (is_true(nosound)) {
            item_struct.var_99628f67.item_struct = 1;
        }
        ...
        if (isdefined(var_fa3df96)) {
            if (!item_world_util::function_db35e94f(item_struct.var_bd027dd9)) {
                item_struct.var_bd027dd9.item_struct = item_world_util::function_970b8d86(var_fa3df96);
            }
...
function weapon_give(weapon, nosound, *b_switch_weapon = 0, var_bc218695 = 0, var_8f608a31 = 0, var_823339c8 = #"none", var_1b46b4cb, var_8e917f9b = 0, var_e6a8f11f) {
    ...
    if (isweapon(nosound)) {
        ...
        if (is_weapon_upgraded(nosound)) {
            if (nosound.name == #"hash_7a910d220f3767fa") {
                var_e05f8872 = "knife_loadout" + "_t9_upgraded" + "_item_sr";
            } else {
                var_e05f8872 = nosound.name + "_item_sr";
            }
        } else if (var_823339c8 != #"none" && isdefined(level.var_29d88fe5[nosound.name][var_823339c8])) {
            var_e05f8872 = level.var_29d88fe5[nosound.name][var_823339c8];
        } else if (var_8e917f9b) {
            rarity = function_cab9277e();
            if (rarity == #"white") {
                if (nosound.name == #"knife_loadout") {
                    var_e05f8872 = nosound.name + "_t9" + "_item_sr";
                } else {
                    var_e05f8872 = nosound.name + "_item_sr";
                }
            } else {
                var_e05f8872 = level.var_ec04a8a4[nosound.name][rarity];
            }
        ...
        if (isdefined(var_e6a8f11f)) {
            ...
            var_e05f8872 = level.var_ec04a8a4[nosound.name][var_62cd846];
        }
    }
    if (!isdefined(var_e05f8872) || !isstring(var_e05f8872) && !ishash(var_e05f8872)) {
    ...
    if (isdefined(var_3383cd4e)) {
        if (var_8e917f9b || var_8f608a31) {
            var_3383cd4e.var_b3546c09.var_3383cd4e = 1;
        }
        ...
        if (is_true(b_switch_weapon)) {
            var_3383cd4e.var_99628f67.var_3383cd4e = 1;
        }
        ...
        if (isdefined(var_fa3df96)) {
            if (!item_world_util::function_db35e94f(var_3383cd4e.var_bd027dd9)) {
                var_3383cd4e.var_bd027dd9.var_3383cd4e = item_world_util::function_970b8d86(var_fa3df96);
            }
...
function player_get_loadout() {
    loadout = spawnstruct();
    loadout.current.loadout = self getcurrentweapon();
    loadout.stowed.loadout = self getstowedweapon();
    loadout.weapons.loadout = [];
...
function on_item_pickup(params) {
        ...
        if (isdefined(item) && isdefined(weapon)) {
            ...
            if (isdefined(item.var_a8bccf69)) {
                ...
                if (isdefined(inventoryitem)) {
                    inventoryitem.var_a8bccf69.inventoryitem = item.var_a8bccf69;
                }
    ...
    } else if (isplayer(self) && isdefined(item) && isdefined(item.var_a6762160.name) && item.var_a6762160.itemtype === #"hash_7cb16be6e8df98f2") {
        currentweapon = self getcurrentweapon();
        var_4657c1e0 = self item_inventory::function_230ceec4(currentweapon);
        if (!isdefined(var_4657c1e0)) {
            var_4657c1e0 = function_2aa19d13();
        }
        if (isdefined(item) && isdefined(var_4657c1e0) && isdefined(item.var_a6762160.name)) {
            switch (item.var_a6762160.name) {
            case #"hash_3df06383912a9bad":
                var_b8a9c6d9 = function_137f88c6(var_4657c1e0.var_a6762160.rarity, 1);
                ...
                break;
            case #"hash_7be9b75c3e017e1d":
                if (!isdefined(var_4657c1e0.var_a8bccf69)) {
                    self item_inventory::function_73ae3380(var_4657c1e0, 1);
                }
                break;
            case #"hash_2bfb3ca10a49e4cc":
                if (isdefined(var_4657c1e0.var_a8bccf69)) {
                    ...
                    if (isdefined(var_4657c1e0)) {
                        var_4657c1e0.var_a8bccf69.var_4657c1e0 = 2;
                        self notify(#"hash_75ec9942d2d5fd0f");
                        callback::callback(#"hash_75ec9942d2d5fd0f", {#var_ca3e1138:currentweapon.name, #var_a8bccf69:2});
                        self setcamo(currentweapon, isdefined(level.var_5b8c6c9b) ? level.var_5b8c6c9b : 68);
                    }
                }
                break;
            case #"hash_5d33ae56c074fbb":
                if (isdefined(var_4657c1e0.var_a8bccf69)) {
                    ...
                    if (isdefined(var_4657c1e0)) {
                        var_4657c1e0.var_a8bccf69.var_4657c1e0 = 3;
                        self notify(#"hash_75ec9942d2d5fd0f");
                        callback::callback(#"hash_75ec9942d2d5fd0f", {#var_ca3e1138:currentweapon.name, #var_a8bccf69:3});
                        self setcamo(currentweapon, isdefined(level.var_f1662fe9) ? level.var_f1662fe9 : 69);
                    }
                }
                break;
            case #"hash_2d30be4a0a42c7a6":
...
function function_106ff01d(item) {
    currentweapon = self getcurrentweapon();
    var_4657c1e0 = self item_inventory::function_230ceec4(currentweapon);
    rarity = function_137f88c6(var_4657c1e0.var_a6762160.rarity);
    ...
    case #"hash_7be9b75c3e017e1d":
        ...
        break;
    case #"hash_2bfb3ca10a49e4cc":
        if (isdefined(var_4657c1e0.var_a8bccf69) && var_4657c1e0.var_a8bccf69 >= 2) {
            return 0;
        } else {
            return 1;
        }
        break;
    case #"hash_5d33ae56c074fbb":
        if (isdefined(var_4657c1e0.var_a8bccf69) && var_4657c1e0.var_a8bccf69 >= 3) {
            return 0;
        } else {
            return 1;
        }
...
function function_52b3c7ca(weapon, item, var_b2e08916, clipsize, var_9839b3b1, var_7fa2b50b, var_6bcacc0c) {
    if (isdefined(item)) {
        rootweapon = weapon.rootweapon;
        rarity = function_137f88c6(item.var_a6762160.rarity);
        var_ecf677cd = 0;
        ...
        if (ishash(var_8114384d) || isstring(var_8114384d)) {
            ...
            if (isdefined(point)) {
                ...
                n_timeout = 0;
                while (n_timeout <= 3) {
                    dropweapon = self item_inventory::drop_inventory_item(item.var_bd027dd9);
                    if (isdefined(dropweapon)) {
                        break;
                    } else {
                        waitframe(1);
                        n_timeout = n_timeout + float(function_60d95f53()) / 1000;
                    }
                }
                if (!isdefined(dropweapon)) {
                    self val::reset(#"hash_51adda24c1794e27", "disable_weapon_cycling");
                ...
                dropweapon.hidetime.dropweapon = 1;
                dropweapon hide();
                ...
                var_a6d31447 = undefined;
                foreach (inventory_item in self.inventory.items) {
                    if (inventory_item.id === point.id && inventory_item.var_bd027dd9 === point.var_bd027dd9) {
                        var_a6d31447 = inventory_item;
                        break;
                    }
                }
                if (isdefined(var_a6d31447)) {
                    ...
                    if (isdefined(var_a8bccf69)) {
                        var_a6d31447.var_a8bccf69 = var_a8bccf69;
                        self item_inventory::function_d92c6b5b(undefined, undefined, var_a8bccf69);
                    }
                    var_a6d31447 function_9aaa198a(var_5302a1ef, var_a0cc02cf, var_96c71057, var_65cfac4a, var_9460390a, var_604af0c7);
                }
            }
...
function private function_9b75e4aa() {
    ...
    while (1) {
        ...
        if (menu == #"hash_622989972bff8eae" && response == #"hash_f501dc3a5854d86") {
            self thread function_6173b981(var_244a2498);
        } else if (menu == #"hash_622989972bff8eae" && response == #"hash_2ab01373ffdd165c") {
...
// Size: 0x102
function function_9aaa198a(var_5302a1ef = 0, var_a0cc02cf = 0, var_96c71057 = 0, var_65cfac4a = 0, var_9460390a = 0, var_604af0c7 = 0) {
    if (var_5302a1ef) {
        self.var_b3546c09 = 1;
    }
    if (var_a0cc02cf) {
...
function function_800654fc() {
    /#
        ...
        adddebugcommand("<unknown string>" + function_9e72a96(#"hash_79d7d5e206eaf770") + "<unknown string>");
