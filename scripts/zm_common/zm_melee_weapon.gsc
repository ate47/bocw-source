        ...
        if (!zm_utility::is_player_valid(player)) {
            ...
            if (player_has_weapon || player zm_loadout::has_powerup_weapon()) {
                ...
                if (zm_loadout::is_placeable_mine(current_weapon) || zm_equipment::is_equipment(current_weapon)) {
                    wait(0.1);
                } else if (player laststand::player_is_in_laststand() || is_true(player.intermission)) {
                    wait(0.1);
                } else if (isdefined(player.check_override_melee_wallbuy_purchase)) {
                    jumpiffalse(player [[ player.check_override_melee_wallbuy_purchase ]](vo_dialog_id, flourish_weapon, weapon, flourish_fn, self)) LOC_0000041c;
                ...
                } else if (!is_true(level._allow_melee_weapon_switching)) {
