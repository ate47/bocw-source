...
function function_7314957c(player, result) {
    ...
    var_906bdcf3.match_id.var_906bdcf3 = getdemofileid();
    var_906bdcf3.game_variant.var_906bdcf3 = "zm";
    var_906bdcf3.game_mode.var_906bdcf3 = level.gametype;
    ...
    var_811ed119.match_kills.var_811ed119 = player.kills;
    ...
    var_811ed119.match_hits.var_811ed119 = player.shotshit;
    var_811ed119.match_streak.var_811ed119 = player player::function_2abc116("best_kill_streak");
    var_811ed119.match_captures.var_811ed119 = player player::function_2abc116("captures");
    var_811ed119.match_defends.var_811ed119 = player player::function_2abc116("defends");
    var_811ed119.match_headshots.var_811ed119 = player player::function_2abc116("headshots");
    var_811ed119.match_longshots.var_811ed119 = player player::function_2abc116("longshots");
    var_811ed119.prestige_max.var_811ed119 = player player::function_2abc116("plevel");
    var_811ed119.level_max.var_811ed119 = player player::function_2abc116("rank");
    var_a14ea2be = spawnstruct();
    var_a14ea2be.player_gender.var_a14ea2be = isplayer(player) ? player getplayergendertype() : "male";
    ...
    end_match_zm.money.end_match_zm = player.score;
    end_match_zm.zombie_waves.end_match_zm = level.round_number;
    end_match_zm.revives.end_match_zm = player player::function_2abc116("revives");
    end_match_zm.doors.end_match_zm = player player::function_2abc116("doors_purchased");
    end_match_zm.downs.end_match_zm = player player::function_2abc116("downs");
