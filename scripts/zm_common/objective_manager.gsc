...
function function_43529cfe() {
    ...
    namespace_553954de::end_match(0, 0);
}
...
function function_d28e25e7(var_2e19be37) {
    assert(var_2e19be37 <= 32, "<dev string:x93>");
...
function function_b06af8e3(destination, var_2923cf48, category, variant) {
    ...
    callback::callback(#"objective_set", {#objective_instance:instance, #category:category});
    return true;
}
...
function start_objective(instance, activator = undefined) {
    ...
    level callback::callback(#"objective_started", {#instance:instance, #activator:activator});
