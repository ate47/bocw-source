...
class class_2517dc3b {
    ...
    // Checksum 0x80f724d1, Offset: 0x18d0
    // Size: 0x4
    __destructor() {
...
class class_557db8fd {
    ...
    // Namespace class_557db8fd/zm_round_spawning
    // Params 0, eflags: 0x90 class_linked
    // Checksum 0x80f724d1, Offset: 0x1820
    // Size: 0x4
    __destructor() {
...
function function_cc103b38(str_archetype, n_round) {
    ...
    /#
        ...
        add_sorted(level.var_c8d852a1, n_round, 0);
    #/
}
...
function function_b4a8f95a(var_616b394b, n_round, func_start, func_end, var_124f39da, var_84f505b1, b_ignore_cleanup = 1) {
    ...
    /#
        ...
        add_sorted(level.var_a06c0ea0, n_round, 0);
    #/
}
...
function function_43aed0ca(n_round, var_b6a3a1ac = 1) {
    if (isdefined(level.var_45827161) && isdefined(level.var_45827161[n_round])) {
        ...
        /#
            ...
            add_sorted(level.var_a06c0ea0, var_bfda0037, 0);
        #/
        return 1;
    }
    return 0;
...
function function_f6cd912d(var_ef21400 = 0) {
    if (isdefined(level.var_45827161)) {
        ...
        foreach (var_a630f8a4 in level.var_45827161) {
                ...
                foreach (var_c28e5f72 in level.var_50cfb6c2) {
                    foreach (var_e5aaf7f4 in var_c28e5f72) {
                        if (var_e5aaf7f4.n_spawn == var_a6559064) {
                            var_e5aaf7f4.b_spawned.var_e5aaf7f4 = 1;
                        }
                    }
                }
            #/
...
function private function_f3635804() {
    ...
    var_a630f8a4.var_a36c7a7a.var_a630f8a4 = level.round_wait_func;
...
function function_6e064f4c(str_archetype) {
    ...
    if (isinarray(array(#"blight_father", #"brutus", #"gegenees", #"hash_3d92e2c7bea1eee2", #"hash_7c0d83ac1e845ac2"), hash(str_archetype))) {
        var_148cc603 = var_148cc603 * (isdefined(level.var_397ca369) ? level.var_397ca369 : 1);
    } else if (isinarray(array(#"stoker", #"gladiator", #"gladiator_marauder", #"gladiator_destroyer", #"werewolf", #"avogadro", #"hash_9f6bc1960ff4912"), hash(str_archetype))) {
...
function private function_979b03db(var_a630f8a4) {
    ...
    while (1) {
        ...
        if (isdefined(ai)) {
            ai.b_ignore_cleanup.ai = var_a630f8a4.var_dc071360;
...
function function_e84b609c(s_params) {
    ...
    level.var_fa6ba733++;
    /#
        assert(level get("<unknown string>") || level get("<unknown string>"), "<unknown string>");
    #/
    if (isdefined(level.var_89fda7e[#"on_ai_killed"])) {
            ...
            foreach (var_5c61255f in level.var_50cfb6c2) {
                foreach (var_1b5ee8a4 in var_5c61255f) {
                    if (var_1b5ee8a4.n_spawn == var_bcdbf8f) {
                        ...
                        var_1b5ee8a4.b_spawned.var_1b5ee8a4 = 0;
                    }
                }
            }
        #/
...
function private function_d7864087(var_dbce0c44) {
    ...
    foreach (var_75b393f9 in level.var_819e7dfd) {
        ...
        var_75b393f9.var_28ba9034.var_75b393f9 = 0;
    ...
    var_73f63202 = 0;
    foreach (var_75b393f9 in level.var_819e7dfd) {
        var_75b393f9.var_28ba9034.var_75b393f9 = var_c766fbe6[var_75b393f9.var_2ecba2c5];
    ...
    foreach (var_26e567be in var_fe695913) {
...
function private function_3cfb36aa(var_75b393f9, var_dbce0c44) {
    ...
    if (var_75b393f9.var_74f6178a) {
        ...
        var_75b393f9.var_123aa3d9.var_75b393f9 = 0;
    }
}
    ...
    /#
        while (1) {
            ...
            if (level.var_48babc04) {
                ...
                debug2dtext((510, var_c708e6e1, 0), "<unknown string>", (0, 1, 0), 1, (0, 0, 0), 0.8, 1, 2);
                var_c708e6e1 = var_c708e6e1 + 22;
                if (level get(#"disable_special_rounds")) {
                ...
                foreach (n_special_round in level.var_a06c0ea0) {
                    ...
                    if (level get(#"disable_special_rounds") || is_true(var_a630f8a4.b_skipped)) {
                        str_color = (1, 0, 0);
                        ...
                        var_54997ac0 = "<unknown string>" + get_current_zombie_count() + "<unknown string>";
                    } else {
                        str_color = (1, 0, 0);
                    }
                    if (isdefined(var_a630f8a4.var_a51dd114)) {
                    ...
                    debug2dtext((510, var_c708e6e1, 0), str_text, str_color, 1, (0, 0, 0), 0.8, 1, 2);
                    var_c708e6e1 = var_c708e6e1 + 22;
                    if (level.round_number == n_special_round && !level get(#"disable_special_rounds")) {
