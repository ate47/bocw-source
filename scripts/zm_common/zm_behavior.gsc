...
function function_4180f67(entity) {
    entity.var_2d78e306.entity = 0;
    entity.var_b719e78.entity = 1;
    if (is_true(entity.var_4c85ebad)) {
        entity.var_2d78e306.entity = 1;
        return 1;
    }
    if (isdefined(entity.enemy_override)) {
        entity.var_b719e78.entity = 0;
        return 1;
    }
...
function function_754be649(entity) {
    entity.var_85cea06c.entity = 0;
    entity.var_d1bb0ad.entity = 1;
    if (!isdefined(entity.enemy)) {
        entity.var_d1bb0ad.entity = 0;
        return 1;
    }
    ...
    entity.meleedistsq.entity = zombiebehavior::function_997f1224(entity);
    entity.var_5a81324d = undefined;
    entity.var_b3538985.entity = entity.enemy.origin;
    if (isplayer(entity.enemy) || is_true(entity.enemy.var_d003d23c)) {
        if (!is_true(zm_utility::is_classic())) {
            if (namespace_85745671::function_142c3c86(entity.enemy)) {
                entity.var_5a81324d.entity = entity.enemy getvehicleoccupied();
                entity.var_b3538985.entity = namespace_85745671::function_401070dd(entity.var_5a81324d, entity.enemy);
            } else if (isvehicle(entity.enemy getgroundent())) {
                entity.var_5a81324d.entity = entity.enemy getgroundent();
                entity.var_b3538985.entity = isdefined(entity.enemy.last_valid_position) ? entity.enemy.last_valid_position : entity.enemy.origin;
            } else if (isvehicle(entity.enemy getmoverent())) {
                entity.var_5a81324d.entity = entity.enemy getmoverent();
                entity.var_b3538985.entity = isdefined(entity.enemy.last_valid_position) ? entity.enemy.last_valid_position : entity.enemy.origin;
            }
        }
        if (isdefined(entity.var_5a81324d) && isdefined(entity.var_cbc65493)) {
            entity.meleedistsq.entity = entity.meleedistsq * entity.var_cbc65493;
        }
    }
...
function function_fae6123(entity) {
    entity.var_2fe49a8a.entity = 0;
    entity.var_e8e74caf.entity = 1;
    if (isdefined(entity.zombie_poi)) {
        entity.var_e8e74caf.entity = 0;
        return 1;
    }
    if (isdefined(entity.enemy_override)) {
        entity.var_e8e74caf.entity = 0;
    ...
    if (isdefined(entity.var_b3538985) && isdefined(entity.enemy)) {
        ...
        if (distancesquared(entity.origin, entity.var_b3538985) < function_a3f6cdac(40) && (!isplayer(entity.enemy) || !entity.enemy.ignoreme && !entity.enemy isnotarget())) {
            entity.var_2fe49a8a.entity = 1;
            return 1;
        }
...
function function_691fecba(entity) {
    ...
    if (is_true(entity.var_b719e78) && is_true(entity.var_d1bb0ad) && is_true(entity.var_e8e74caf) || is_true(entity.var_2d78e306) || is_true(entity.var_85cea06c) || is_true(entity.var_2fe49a8a)) {
        entity.idletime.entity = gettime();
        entity.var_1b250399.entity = entity.origin;
        return 1;
    }
    return 0;
}
...
function zombiefindflesh(behaviortreeentity) {
    ...
    if (!isdefined(behaviortreeentity.ignore_player)) {
        behaviortreeentity.ignore_player.behaviortreeentity = [];
    }
    behaviortreeentity.goalradius.behaviortreeentity = 30;
    ...
    if (!isdefined(behaviortreeentity.ignore_player) || players.size == 1) {
        ...
        for (i = 0; i < behaviortreeentity.ignore_player.size; i++) {
            if (isdefined(behaviortreeentity.ignore_player[i]) && isdefined(behaviortreeentity.ignore_player[i].ignore_counter) && behaviortreeentity.ignore_player[i].ignore_counter > 3) {
                ...
                behaviortreeentity.ignore_player.behaviortreeentity = arrayremovevalue(behaviortreeentity.ignore_player, behaviortreeentity.ignore_player[i]);
                if (!isdefined(behaviortreeentity.ignore_player)) {
                    behaviortreeentity.ignore_player.behaviortreeentity = [];
                }
                i = 0;
    ...
    if (!isdefined(level.var_4bde8b8f) || ![[ level.var_4bde8b8f ]]()) {
        if (isdefined(zombie_poi)) {
            behaviortreeentity.enemy_override.behaviortreeentity = zombie_poi.poi_ent;
            behaviortreeentity.enemy_override.var_dfa42180 = &zm_utility::function_49f80b6f;
        }
        behaviortreeentity.favoriteenemy.behaviortreeentity = behaviortreeentity.var_93a62fe;
    }
    ...
    if (isdefined(behaviortreeentity.v_zombie_custom_goal_pos) && !var_bd871069) {
        ...
        if (isdefined(behaviortreeentity.n_zombie_custom_goal_radius)) {
            behaviortreeentity.goalradius.behaviortreeentity = behaviortreeentity.n_zombie_custom_goal_radius;
        }
        behaviortreeentity setgoal(goalpos);
        function_9d92b55a(behaviortreeentity);
        ...
        if (self isatgoal() || !isdefined(goalpos)) {
            self clearpath();
            behaviortreeentity.keep_moving.behaviortreeentity = 0;
        }
        function_9d92b55a(behaviortreeentity);
        ...
        if (isdefined(behaviortreeentity.attackable_slot)) {
            if (isdefined(behaviortreeentity.attackable_goal_radius)) {
                behaviortreeentity.goalradius.behaviortreeentity = behaviortreeentity.attackable_goal_radius;
            }
...
function function_f637b05d(behaviortreeentity) {
    ...
    behaviortreeentity.var_93a62fe.behaviortreeentity = zm_utility::get_closest_valid_player(behaviortreeentity.origin, behaviortreeentity.ignore_player);
}
...
function zombieupdategoal() {
    ...
    if (isentity(targetent)) {
        if (!is_true(self.var_1fa24724)) {
            ...
            if (queryresult.data.size > 0) {
                ...
                queryresult.data.queryresult = function_7b8e26b3(queryresult.data, 0, "inClaimedLocation");
                if (queryresult.data.size > 0) {
    ...
    var_75dd804d = function_d6eaf8b0(self.origin - targetpos);
    var_2b8b6d3f = function_a3f6cdac(175);
    shouldrepath = 0;
    if (isdefined(self.var_9e6e6645)) {
        if (isdefined(targetpos)) {
            if (is_true(self.var_4fe4e626)) {
                self.var_4fe4e626 = 0;
                shouldrepath = 1;
            } else if (distancesquared(self.var_9e6e6645, targetpos) > function_a3f6cdac(18)) {
                shouldrepath = 1;
            } else if (var_75dd804d < function_a3f6cdac(72) && (!isdefined(self.nextgoalupdate) || self.nextgoalupdate < gettime())) {
                shouldrepath = 1;
...
function function_77a0b45d(behaviortreeentity) {
    behaviortreeentity.var_98f1f37c.behaviortreeentity = 1;
}
...
function disablepowerups(behaviortreeentity) {
    behaviortreeentity.no_powerups.behaviortreeentity = 1;
}
...
function function_fa2814ae(behaviortreeentity) {
    behaviortreeentity.var_98f1f37c.behaviortreeentity = 0;
}
...
function enablepowerups(behaviortreeentity) {
    behaviortreeentity.no_powerups.behaviortreeentity = 0;
}
...
function function_7531db00(behaviortreeentity) {
    ...
    behaviortreeentity.old_powerups.behaviortreeentity = behaviortreeentity.no_powerups;
...
function function_1329e086(behaviortreeentity) {
    ...
    behaviortreeentity.no_powerups.behaviortreeentity = behaviortreeentity.old_powerups;
...
function private zombiepushedactionterminate(behaviortreeentity) {
    behaviortreeentity collidewithactors(1);
    behaviortreeentity.pushed.behaviortreeentity = 0;
}
...
function zombiestunactionstart(behaviortreeentity, asmstatename) {
    ...
    behaviortreeentity.var_4034a31.behaviortreeentity = gibserverutils::isgibbed(behaviortreeentity, 256) || gibserverutils::isgibbed(behaviortreeentity, 128);
    animationstatenetworkutility::requeststate(behaviortreeentity, asmstatename);
    return 5;
}
...
function zombieshouldattackthroughboardscondition(behaviortreeentity) {
    ...
    players = getplayers();
    attack = 0;
    behaviortreeentity.player_targets.behaviortreeentity = [];
...
function function_b86a1b9d(behaviortreeentity) {
    barricades = [1:behaviortreeentity.first_node, 0:isdefined(behaviortreeentity.var_a5add0c0.var_597f08bf) ? behaviortreeentity.var_a5add0c0.var_597f08bf : undefined];
...
function getchunkservice(behaviortreeentity) {
    ...
    behaviortreeentity.chunk.behaviortreeentity = zm_utility::get_closest_non_destroyed_chunk(behaviortreeentity.origin, behaviortreeentity.first_node, behaviortreeentity.first_node.barrier_chunks);
    if (isdefined(behaviortreeentity.chunk)) {
...
function updatechunkservice(behaviortreeentity) {
    ...
    behaviortreeentity.lastchunk_destroy_time.behaviortreeentity = gettime();
}
...
function updateattackspotservice(behaviortreeentity) {
    ...
    if (isdefined(behaviortreeentity.attacking_spot)) {
        behaviortreeentity.goalradius.behaviortreeentity = 17;
        behaviortreeentity function_a57c34b7(behaviortreeentity.attacking_spot);
        if (zombieisatgoal(behaviortreeentity)) {
            behaviortreeentity.at_entrance_tear_spot.behaviortreeentity = 1;
        }
        return 1;
    }
    return 0;
...
function findnodesservice(behaviortreeentity) {
    node = undefined;
    behaviortreeentity.entrance_nodes.behaviortreeentity = [];
    if (isdefined(behaviortreeentity.find_flesh_struct_string)) {
        ...
        for (i = 0; i < level.barrier_align.size; i++) {
            if (isdefined(level.barrier_align[i].script_string) && level.barrier_align[i].script_string == behaviortreeentity.find_flesh_struct_string) {
                behaviortreeentity.barrier_align.behaviortreeentity = level.barrier_align[i];
            }
        }
        ...
        if (zombieisatentrance(behaviortreeentity)) {
            behaviortreeentity.got_to_entrance.behaviortreeentity = 1;
        }
        return 1;
    }
}
...
function zombieattackableobjectservice(behaviortreeentity) {
    ...
    if (isdefined(behaviortreeentity.var_b238ef38) && !isdefined(behaviortreeentity.attackable)) {
        ...
        behaviortreeentity.attackable.behaviortreeentity = namespace_85745671::get_attackable(behaviortreeentity, 1);
...
function zombiemovetoentranceaction(behaviortreeentity, asmstatename) {
    behaviortreeentity.got_to_entrance.behaviortreeentity = 0;
    animationstatenetworkutility::requeststate(behaviortreeentity, asmstatename);
    return 5;
}
...
function zombiemovetoentranceactionterminate(behaviortreeentity, *asmstatename) {
    if (zombieisatentrance(asmstatename)) {
        asmstatename.got_to_entrance.asmstatename = 1;
    }
    return 4;
}
...
function function_6eb4f847(behaviortreeentity) {
    behaviortreeentity.at_entrance_tear_spot.behaviortreeentity = 0;
    return 1;
}
...
function function_a5a66d65(behaviortreeentity) {
    behaviortreeentity.var_348e5e19.behaviortreeentity = 1;
    return 1;
}
...
function function_ebba4d65(behaviortreeentity) {
    aiutility::keepclaimnode(behaviortreeentity);
    behaviortreeentity.boardattack.behaviortreeentity = 1;
    return 1;
}
...
function function_28b47cc8(behaviortreeentity) {
    aiutility::releaseclaimnode(behaviortreeentity);
    behaviortreeentity.boardattack.behaviortreeentity = 0;
    return 1;
}
...
function zombiemantleaction(behaviortreeentity, asmstatename) {
    behaviortreeentity.clamptonavmesh.behaviortreeentity = 0;
    if (isdefined(behaviortreeentity.attacking_spot_index)) {
        behaviortreeentity.saved_attacking_spot_index.behaviortreeentity = behaviortreeentity.attacking_spot_index;
        behaviortreeentity setblackboardattribute("_board_attack_spot", float(behaviortreeentity.attacking_spot_index));
    }
    behaviortreeentity.var_9ed3cc11.behaviortreeentity = behaviortreeentity function_e827fc0e();
    behaviortreeentity pushplayer(1);
    behaviortreeentity.isinmantleaction.behaviortreeentity = 1;
...
function zombiemantleactionterminate(behaviortreeentity, *asmstatename) {
    asmstatename.clamptonavmesh.asmstatename = 1;
...
function boardtearmocompstart(entity, mocompanim, *mocompanimblendouttime, *mocompanimflag, *mocompduration) {
    ...
    mocompanimflag.pushable.mocompanimflag = 0;
...
function zombieblackholebombpullstart(entity, asmstatename) {
    entity.pulltime.entity = gettime();
    entity.pullorigin.entity = entity.origin;
    animationstatenetworkutility::requeststate(entity, asmstatename);
    zombieupdateblackholebombpullstate(entity);
    if (isdefined(entity.damageorigin)) {
        entity.n_zombie_custom_goal_radius.entity = 8;
        entity.v_zombie_custom_goal_pos.entity = entity.damageorigin;
    }
    return 5;
}
...
function zombieupdateblackholebombpullstate(entity) {
    ...
    if (dist_to_bomb < (isdefined(entity.var_92b78660) ? entity.var_92b78660 : 16384)) {
        entity._black_hole_bomb_collapse_death.entity = 1;
...
function zombieblackholebombpullupdate(entity, *asmstatename) {
    ...
    if (isdefined(asmstatename.damageorigin)) {
        asmstatename.v_zombie_custom_goal_pos.asmstatename = asmstatename.damageorigin;
    }
    if (!is_true(asmstatename.missinglegs) && gettime() - asmstatename.pulltime > 1000) {
        ...
        if (distsq < 144) {
            ...
            asmstatename.cant_move.asmstatename = 1;
            ...
            asmstatename.cant_move.asmstatename = 0;
        }
        asmstatename.pulltime.asmstatename = gettime();
        asmstatename.pullorigin.asmstatename = asmstatename.origin;
    }
    return 5;
}
...
function function_29c1ba76(*einflictor, eattacker, idamage, *idflags, smeansofdeath, weapon, *var_fd90b0bb, *vpoint, *vdir, shitloc, *psoffsettime, *boneindex, *surfacetype) {
    ...
    return {#var_ebcff177:var_ebcff177, #weakpoint:weakpoint, #damage:shitloc};
}
...
function function_4a99b560(entity, enemy) {
    /#
        if (getdvarint(#"hash_2c509ee80b516880", 0)) {
            if (isdefined(enemy)) {
                ...
                if (to_target === (0, 0, 0)) {
                    record3dtext("<unknown string>", entity.origin, 0 ? (0, 1, 0) : (1, 0, 0), "<unknown string>", entity);
                    return 0;
                }
            ...
            var_b295b952 = !isdefined(enemy) || !is_classic() && distance2dsquared(entity.origin, enemy.origin) <= function_a3f6cdac(100);
            ...
            record3dtext("<unknown string>", entity.origin, var_b295b952 ? (0, 1, 0) : (1, 0, 0), "<unknown string>", entity);
            record3dtext("<unknown string>", entity.origin, var_6c2051ca ? (0, 1, 0) : (1, 0, 0), "<unknown string>", entity);
    ...
    var_813d38fa = (0.5 * getdvarfloat(#"bg_lowgravity", 400) * function_a3f6cdac(time) + to_target[2]) / time;
    to_target = vectornormalize((to_target[0], to_target[1], 0)) * 700;
    if (zm_utility::is_survival() && isdefined(entity.current_state) && entity.current_state.name !== #"chase" || zm_utility::is_survival() && distance2dsquared(entity.origin, enemy.origin) <= function_a3f6cdac(100) || !isinarray(enemy.var_f904e440, entity) || !entity function_92dcde87(start_pos, target_pos, (to_target[0], to_target[1], var_813d38fa), time, enemy)) {
        return 0;
    }
    return 1;
}
...
function function_e5f60f55(entity) {
    ...
    if (isinarray(enemy.var_f904e440, entity)) {
        if (!isdefined(entity.var_6ca50f69)) {
            entity.var_6ca50f69.entity = 0;
        }
        if (function_4a99b560(entity, enemy)) {
            entity.var_8c4d3e5d.entity = 1;
            entity.var_6ca50f69.entity = 0;
            entity setgoal(entity.origin);
            entity.var_95d1c014 = undefined;
            entity.keep_moving.entity = 0;
            return;
        }
...
function function_35228e0b(entity) {
    ...
    if (isplayer(entity.enemy) && entity.enemy isinvehicle()) {
        entity.var_6c5c29fb.entity = namespace_85745671::function_401070dd(entity.enemy getvehicleoccupied(), entity.enemy);
    }
}
