...
function private function_ca87f318(localclientnum) {
    ...
    clientdata.var_b9730e2b.clientdata = gettime();
    while (1) {
    ...
    while (1) {
        ...
        if (isdefined(clientdata.inventory.var_f3518190)) {
            if (inventoryitem != clientdata.inventory.var_f3518190.item) {
                ...
                var_f3518190.caststart.var_f3518190 = gettime();
                var_f3518190.castend.var_f3518190 = var_f3518190.caststart + int((isdefined(var_eaae8ced ? var_f3518190.item.var_a6762160.casttime * 0.5 : var_f3518190.item.var_a6762160.casttime) ? var_eaae8ced ? var_f3518190.item.var_a6762160.casttime * 0.5 : var_f3518190.item.var_a6762160.casttime : 0) * 1000);
...
function private function_2ae9881d(localclientnum) {
    ...
    clientdata.var_cb55ac3c.clientdata = gettime();
    while (1) {
        waitresult = undefined;
    ...
    while (1) {
        ...
        foreach (player in players) {
            ...
            for (i = 0; i < var_3ef517e.size; i++) {
                ...
                if (var_95dcc077) {
                    item.itemuimodel.item = createuimodel(consumed.uimodel, "item" + var_cfa0e915.size - 1);
...
function private function_1a99656a(localclientnum, inventoryitem, var_bd027dd9, itemid, count, totalcount, availableaction, var_e35261f6 = 1, var_189fcf49 = 0, var_1204dfe9 = 1) {
    ...
    inventoryitem.var_a6762160.inventoryitem = 32767 == itemid ? undefined : function_b1702735(itemid).var_a6762160;
    inventoryitem.availableaction = availableaction;
    inventoryitem.consumable.inventoryitem = isdefined(inventoryitem.var_a6762160) ? inventoryitem.var_a6762160.consumable : undefined;
    inventoryitem.quickequip.inventoryitem = 0;
    if (var_e35261f6) {
...
function private function_442857e2(localclientnum, var_a6762160) {
    ...
    if (var_a6762160.itemtype !== #"equipment" && var_a6762160.itemtype !== #"hash_3fd3555ae0c9b5c4" && var_a6762160.itemtype !== #"tactical" && var_a6762160.itemtype !== #"generic" && var_a6762160.itemtype !== #"health" && var_a6762160.itemtype !== #"killstreak" && var_a6762160.itemtype !== #"scorestreak" && var_a6762160.itemtype !== #"attachment" && var_a6762160.itemtype !== #"armor_shard") {
        return;
    }
    data = item_world::function_a7e98a1a(localclientnum);
    if (!isdefined(data)) {
    ...
    if (var_a6762160.itemtype == #"armor_shard") {
        ...
        for (index = 0; index < 5; index++) {
            ...
            if (var_6962e967 || var_6d4bb070 || isdefined(inventoryitem.endtime)) {
                ...
                inventoryitem.quickequip.inventoryitem = 1;
                var_6d4bb070 = 1;
            }
            setuimodelvalue(createuimodel(inventoryitem.itemuimodel, "totalCount"), totalcount);
        }
    ...
    if (var_a6762160.itemtype === #"health") {
        ...
        function_2ecc089c(localclientnum, 7, #"equipment", array(#"frag_grenade_wz_item", #"hash_29548403dc2ff36d", #"hash_49b7001ce02a0797", #"cluster_semtex_wz_item", #"hash_732cfbea10210169", #"hash_6174ad2674c82ec3", #"acid_bomb_wz_item", #"molotov_wz_item", #"hash_6d0e3a9a902d2201", #"hash_1223df8e913d431b", #"wraithfire_wz_item", #"hatchet_wz_item", #"hash_73b7240912c1f754", #"hash_49c0448e11cb523c", #"tomahawk_t8_wz_item", #"seeker_mine_wz_item", #"dart_wz_item", #"hawk_wz_item", #"ultimate_turret_wz_item", #"hash_49bb95f2912e68ad", #"hash_3c9430c4ac7d082e", #"hash_6a5294b915f32d32", #"hash_6cd8041bb6cd21b1", #"hash_6a07ccefe7f84985", #"hash_17f8849a56eba20f", #"hash_281638550b45be2a", #"hash_61247be669e9b732", #"hash_2c9b75b17410f2de", #"grapple_wz_item", #"hash_12fde8b0da04d262", #"barricade_wz_item", #"spiked_barrier_wz_item", #"trophy_system_wz_item", #"concertina_wire_wz_item", #"sensor_dart_wz_item", #"supply_pod_wz_item", #"trip_wire_wz_item", #"cymbal_monkey_wz_item", #"homunculus_wz_item", #"vision_pulse_wz_item", #"flare_gun_wz_item", #"wz_snowball", #"wz_waterballoon", #"hash_1ae9ade20084359f"), 2, data.inventory.equipmentitems);
    } else if (var_a6762160.itemtype === #"hash_3fd3555ae0c9b5c4") {
        function_2ecc089c(localclientnum, 12, #"hash_3fd3555ae0c9b5c4", array(#"hash_3f154f45479130ed", #"hash_2c9b75b17410f2de", #"hash_7ea42360bdf2de16", #"hash_649e3a841620150f", #"hash_47954c9090e3f900", #"hash_12f4d7321d9c5005", #"hash_681471b56324b3e"), 2, data.inventory.var_d4de469a);
...
function function_ad4c6116(localclientnum, var_a6762160) {
    ...
    if (var_a6762160.itemtype == #"hash_7cb16be6e8df98f2") {
        return 1;
    }
...
function consume_item(localclientnum, var_bd027dd9) {
    ...
    if (isdefined(consumeditem)) {
        ...
        consumeditem.itemuimodel.consumeditem = createuimodel(data.inventory.consumed.uimodel, "item" + var_cfa0e915.size);
...
function inventory_init(localclientnum) {
    ...
    data.inventory.data = spawnstruct();
...
function function_c6ff0aa2(localclientnum, var_bd027dd9) {
    ...
    if (isdefined(item.endtime)) {
        ...
        if (isdefined(consumeditem)) {
            ...
            consumeditem.endtime.consumeditem = consumeditem.endtime - remaining / var_ee0e9af9.size;
