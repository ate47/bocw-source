...
function private function_938d798a() {
    /#
        str_filename = get_map_name() + "<unknown string>";
...
function private function_cdd9b388() {
    /#
        while (1) {
            ...
            if (!isdefined(level get(#"item_world_initialized"))) {
                continue;
            }
                ...
                if (itemtype == 18) {
                    ...
                    foreach (item in var_f4b807cb) {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            jumpiffalse(isdefined(item.var_a6762160)) LOC_0000175a;
                            sphere(item.origin, radius, color, 1, 0, 10, 20);
                            jumpiffalse(isdefined(item.targetname)) LOC_0000175a;
                            print3d(item.origin + vectorscale((0, 0, 1), 32), function_9e72a96(item.targetname), color, 1, 0.3, 20);
                        case 3:
                        LOC_0000175a:
                ...
                if (itemtype == 17) {
                    ...
                    foreach (item in var_f4b807cb) {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            jumpiffalse(isdefined(item.var_a6762160)) LOC_000026e2;
                            sphere(item.origin, radius, color, 1, 0, 10, 20);
                        case 3:
                        LOC_000026e2:
            ...
            do {
                ...
                foreach (group in var_1d9375fc) {
                    ...
                    foreach (point in spawn_points) {
                        if (getdvarint(#"hash_7ae201bf5aee2017", 0)) {
                        ...
                        } else if (level.players[0] is_player_looking_at(point.origin, 0.6, 0)) {
                            b_failed = 0;
                            var_47748885 = 28;
                            var_c5330f11 = 32;
                            v_color = (1, 0, 1);
                            ...
                            items = function_2e3efdda(point.origin, undefined, 1, var_47748885, -1, 1);
                            if (items.size > 0) {
                                v_color = (0, 1, 0);
                                dynent = undefined;
