...
function function_970d4891(mode) {
    /#
        ...
        foreach (playerbodytype in bodies) {
            ...
            add_devgui("<unknown string>" + body_name + "<unknown string>", "<unknown string>" + "<unknown string>" + "<unknown string>" + body_name);
        }
    #/
}
...
function body_customization_populate(mode, var_ef4940a5) {
    /#
        ...
        foreach (playerbodytype in bodies) {
            ...
            add_debug_command(body_customization_devgui_base + body_name + "<unknown string>" + "<unknown string>" + "<unknown string>" + "<unknown string>" + "<unknown string>" + playerbodytype + "<unknown string>");
...
function add_perk_devgui(name, specialties) {
    /#
        ...
        add_debug_command(perk_devgui_base + perk_name + "<unknown string>" + "<unknown string>" + "<unknown string>" + specialties + "<unknown string>");
    #/
}
...
function function_373068ca(name, postfix) {
    /#
        ...
        add_devgui("<unknown string>" + talentname, cmd);
    #/
}
