...
function private function_7e5905cd(entity) {
    ...
    if (isdefined(entity.var_64099fad) && isdefined(enemy) && distancesquared(entity.origin, enemy.origin) < function_a3f6cdac(entity.var_64099fad)) {
        var_8706203c = 100;
    }
...
function private shoot_bolt_wait(entity) {
    if (!isdefined(function_bd4a79a(entity))) {
        return;
    }
    enemy = function_bd4a79a(entity);
...
function function_a495d71f(entity) {
    ...
    entity.var_78dd7804.entity = function_205c9932(entity);
...
function function_2eb165a4(entity) {
    ...
    if (!isdefined(entity.var_f89ee7ac)) {
        entity.var_f89ee7ac.entity = 1 - var_c5504ae5;
    }
    if (var_5a8e6bf6 <= entity.var_f89ee7ac) {
        entity.var_f89ee7ac.entity = var_5a8e6bf6 - var_c5504ae5;
        return 1;
    }
    if (isdefined(entity.favoriteenemy)) {
        ...
        if (var_bec89360 >= function_a3f6cdac(entity.var_724ec089)) {
            return 1;
        }
    ...
    if (isdefined(entity.attackable) && entity.attackable === target) {
        ...
        if (isdefined(entity.var_42a18a37)) {
            ...
            foreach (test_point in test_points) {
                ...
                if (dist_sq > function_a3f6cdac(entity.var_42a18a37)) {
...
function function_3d3ee1a4(entity, point, enemy) {
    ...
    if (isdefined(enemy)) {
        ...
        if (isdefined(var_94324c7a)) {
            ...
            if (isdefined(entity.favoriteenemy) && distancesquared(var_94324c7a, nextpos) <= function_a3f6cdac(entity.var_946951ef)) {
                /#
    ...
    if (isdefined(nextpos) && distancesquared(entity.origin, nextpos) < function_a3f6cdac(entity.var_168f9987)) {
        return undefined;
    }
...
function function_36f6a838(entity) {
    entity.phase_time.entity = gettime() + entity.var_15aa1ae0;
    entity.var_7fde19e8.entity = gettime();
}
...
function function_b411d93(entity) {
    entity.var_de2d38ae.entity = gettime();
}
...
function function_d58f8483(entity) {
    ...
    if (isdefined(target) && distancesquared(entity.origin, target.origin) <= function_a3f6cdac(entity.var_724ec089) && var_bd4e4e13) {
        /#
        ...
        entity.var_696e2d53.entity = gettime();
        ...
        if (traceresult[#"fraction"] == 1) {
            entity.var_e3b6f14a.entity = 1;
            return 1;
        }
    }
    entity.var_e3b6f14a.entity = 0;
    entity.var_696e2d53.entity = gettime() + randomintrangeinclusive(800, 1000);
    return 0;
}
...
function function_9f3a10a4(entity, mocompanim, *mocompanimblendouttime, *mocompanimflag, *mocompduration) {
    ...
    mocompanimflag.var_78dd7804.mocompanimflag = function_205c9932(mocompanimflag);
    ...
    mocompanimflag.var_d39541c9.mocompanimflag = {#var_c970f455:getnotetracktimes(mocompduration, "phase_end")[0], #var_deb95e3f:getnotetracktimes(mocompduration, "phase_start")[0]};
}
...
function function_7b70bdbe(entity, *mocompanim, *mocompanimblendouttime, *mocompanimflag, *mocompduration) {
    ...
    mocompduration.var_7fde19e8.mocompduration = gettime();
...
function function_9f1d0b0d(entity, position) {
    if (isdefined(entity.var_6ec16f15) && isdefined(entity.var_591c9ab9)) {
        if (distancesquared(position, entity.var_6ec16f15) > function_a3f6cdac(entity.var_591c9ab9)) {
            return 0;
        }
    }
    return 1;
...
function function_1ad43460(entity) {
    ...
    if (isdefined(var_1f1f9cfa.goalpos) && !function_9f1d0b0d(entity, var_1f1f9cfa.goalpos)) {
        return 0;
    }
...
function function_de781d41(entity) {
    if (!isdefined(entity.var_e8a7f45d)) {
        entity.var_e8a7f45d.entity = {#var_a5afe5a1:gettime(), #state:#"hash_24e69bf779de4940"};
    }
