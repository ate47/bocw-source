    ...
    /#
        ...
        while (true) {
            ...
            foreach (trap_prop in var_2a1f535d) {
                ...
                line(trap_prop.origin, trap_prop.origin + vectorscale((0, 0, 1), 900), color);
                if (is_true(trap_prop.pause_trap)) {
                    print3d(trap_prop.origin + vectorscale((0, 0, 1), 48), "<unknown string>", color);
                }
            }
            waitframe(1);
        }
