...
function function_4366bf50(params) {
    ...
    var_45d1a411 = deathmodel.origin;
    var_45d1a411 = var_45d1a411 + forward * var_a20a7474;
    var_45d1a411 = var_45d1a411 + right * var_a460aef2;
    ...
    deathmodel physicslaunch(var_45d1a411, (0, 0, var_9a1e332d));
