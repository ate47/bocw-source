...
function private autoexec __init__system__() {
    system::register(#"custom_class", &function_70a657d8, undefined, undefined, undefined);
}
...
function function_70a657d8() {
    ...
    level.weapon_position[#"hash_4f228e9f675d9e6"] = struct::get("zm_cac_weapon_position_perk_a_cola");
    level.weapon_position[#"hash_2291010e20ed3a49"] = struct::get(#"hash_73f00d5929f25ae6");
    level.weapon_position[#"hash_1e65d66e280c0c78"] = struct::get(#"hash_46bb0b2a02811f0f");
    level.weapon_position[#"hash_6b8e9907746ea17e"] = struct::get(#"hash_30a7e0dd147270f1");
    ...
    level.weapon_position[#"hash_371b88bd6dadd70"] = struct::get("gunsmith_weapon_position");
...
function function_875dd2fe() {
    ...
    foreach (var_45e629a9 in level.var_95471a83) {
        ...
        var_d674ca90 = var_6f6294b.var_e35da898;
        ...
        if (isdefined(frontendmodel)) {
            ...
            if (isdefined(var_d674ca90)) {
                level.var_9d0d6475[frontendmodel][#"hash_3731cdc622acfac6"] = var_d674ca90;
            }
        }
        ...
        if (isdefined(viewmodel)) {
            ...
            if (isdefined(var_d674ca90)) {
                level.var_9d0d6475[viewmodel][#"hash_3731cdc622acfac6"] = var_d674ca90;
            }
        }
    }
}
...
function function_ddce43b3(var_5f654ba8) {
    ...
    var_d674ca90 = level.var_9d0d6475[var_5f654ba8][#"hash_3731cdc622acfac6"];
    if (isdefined(var_d674ca90)) {
        return var_d674ca90;
    }
}
...
function function_1cd1374d(var_1d35315f, var_d4c489c0 = #"primary", var_e81ceea = "", localclientnum, var_85d87aca) {
    ...
    if (var_d4c489c0 == #"hash_371b88bd6dadd70") {
    ...
    } else if (var_d4c489c0 == #"hash_27328f764c0bbb70") {
        s_info = function_add95f58(var_1d35315f);
    } else if (var_d4c489c0 == #"hash_3c9f7fc239586b7d") {
    ...
    case #"specialgrenade":
        ...
        break;
    case #"talent":
        s_location = level.weapon_position[#"hash_4f228e9f675d9e6"];
        break;
    case #"hash_6535e34e6169957e":
        s_location = level.weapon_position[#"hash_1e65d66e280c0c78"];
        break;
    case #"specialty":
        s_location = level.weapon_position[#"hash_2291010e20ed3a49"];
        break;
    case #"hash_503cc7457f49371":
        s_location = level.weapon_position[#"hash_6b8e9907746ea17e"];
        break;
    case #"talent3":
    case #"talent2":
    case #"talent1":
    ...
    case #"bonuscard1":
        ...
        break;
    case #"hash_371b88bd6dadd70":
    case #"hash_27328f764c0bbb70":
    case #"hash_2fda3f64c5caa89e":
    case #"hash_3c9f7fc239586b7d":
        s_location = level.weapon_position[#"hash_371b88bd6dadd70"];
        break;
    ...
    case #"primary":
        ...
        foreach (var_bc94f6f in var_35be18f5) {
            if (!isdefined(var_bc94f6f.var_a4fadd7e)) {
                var_bc94f6f.var_a4fadd7e.var_bc94f6f = var_bc94f6f.origin;
            }
            if (isdefined(var_bc94f6f.targetname)) {
                switch (var_bc94f6f.targetname) {
                case #"hash_2149c57449808531":
                    var_bc94f6f.origin.var_bc94f6f = var_bc94f6f.var_a4fadd7e + s_info.var_a5946026;
                    break;
                case #"hash_474c2ac2e709ea92":
                    var_bc94f6f.origin.var_bc94f6f = var_bc94f6f.var_a4fadd7e + s_info.var_36859b17;
                    break;
                case #"hash_3d81e6e29a7525f5":
                    var_bc94f6f.origin.var_bc94f6f = var_bc94f6f.var_a4fadd7e + s_info.var_a7adf514;
                    break;
                case #"hash_d2eed7f7c5c4e34":
                    var_bc94f6f.origin.var_bc94f6f = var_bc94f6f.var_a4fadd7e + (0, s_info.var_a5946026[1], s_info.var_a5946026[2]);
                    break;
                case #"hash_5e91b75cefba3041":
                    var_bc94f6f.origin.var_bc94f6f = var_bc94f6f.var_a4fadd7e + (0, s_info.var_36859b17[1], s_info.var_36859b17[2]);
                    break;
                }
            }
            if (b_show) {
    ...
    case #"primarygrenade":
        ...
        foreach (var_6f552f36 in var_f33b540a) {
            if (!isdefined(var_6f552f36.var_a4fadd7e)) {
                var_6f552f36.var_a4fadd7e.var_6f552f36 = var_6f552f36.origin;
            }
            if (isdefined(var_6f552f36.targetname)) {
                switch (var_6f552f36.targetname) {
                case #"hash_56b20cc76429691":
                    var_6f552f36.origin.var_6f552f36 = var_6f552f36.var_a4fadd7e + s_info.var_a5946026;
                    break;
                case #"hash_2aa60196f1eab472":
                    var_6f552f36.origin.var_6f552f36 = var_6f552f36.var_a4fadd7e + s_info.var_36859b17;
                    break;
                case #"hash_aa450ddeeb9920d":
                    var_6f552f36.origin.var_6f552f36 = var_6f552f36.var_a4fadd7e + s_info.var_a7adf514;
                    break;
                case #"hash_240bddaaee1ddf14":
                    var_6f552f36.origin.var_6f552f36 = var_6f552f36.var_a4fadd7e + (0, s_info.var_a5946026[1], s_info.var_a5946026[2]);
                    break;
                case #"hash_5013f12a53a51ea1":
                    var_6f552f36.origin.var_6f552f36 = var_6f552f36.var_a4fadd7e + (0, s_info.var_36859b17[1], s_info.var_36859b17[2]);
                    break;
                }
            }
            if (b_show) {
    ...
    case #"secondarygrenade":
        ...
        foreach (var_3878ec49 in var_b74cf891) {
            if (!isdefined(var_3878ec49.var_a4fadd7e)) {
                var_3878ec49.var_a4fadd7e.var_3878ec49 = var_3878ec49.origin;
            }
            if (var_3878ec49.targetname === "shelf_secondary_grenade_middle") {
                var_3878ec49.origin.var_3878ec49 = var_3878ec49.var_a4fadd7e + s_info.var_a7adf514;
            }
            if (b_show) {
                var_3878ec49 show();
            } else {
...
function function_3a0a9f01(localclientnum, s_info, b_show = 0, weapon, var_8a4ba442) {
    ...
    foreach (var_72ff5fa4 in var_d74b0620) {
        if (!isdefined(var_72ff5fa4.var_a4fadd7e)) {
            var_72ff5fa4.var_a4fadd7e.var_72ff5fa4 = var_72ff5fa4.origin;
        }
        if (isdefined(var_72ff5fa4.targetname)) {
            switch (var_72ff5fa4.targetname) {
            case #"hash_78128169d6711a6d":
                var_72ff5fa4.origin.var_72ff5fa4 = var_72ff5fa4.var_a4fadd7e + s_info.var_a5946026;
                break;
            case #"hash_3cbf54f7627b5279":
                var_72ff5fa4.origin.var_72ff5fa4 = var_72ff5fa4.var_a4fadd7e + s_info.var_a7adf514;
                break;
            case #"hash_3ed2a809048aa0e6":
                var_72ff5fa4.origin.var_72ff5fa4 = var_72ff5fa4.var_a4fadd7e + s_info.var_36859b17;
                break;
            case #"hash_1790f06c8159a70":
                var_72ff5fa4.origin.var_72ff5fa4 = var_72ff5fa4.var_a4fadd7e + (0, s_info.var_a5946026[1], s_info.var_a5946026[2]);
                break;
            case #"hash_2bb904253c893cc5":
                var_72ff5fa4.origin.var_72ff5fa4 = var_72ff5fa4.var_a4fadd7e + (0, s_info.var_36859b17[1], s_info.var_36859b17[2]);
                break;
            }
        }
        if (b_show) {
...
function function_60663bf8(var_85d87aca) {
    if (isinarray(array(#"hash_35c80ca3d496436b", #"hash_5223a6478b827ae2", #"hash_2b8196a115a43717", #"hash_3c1acb367fc720b9", #"hash_771ac27519b59ae1"), hash(var_85d87aca))) {
        return #"talent1";
    } else if (isinarray(array(#"hash_1f2871685383c0ce", #"hash_7ba3d840a075bb38", #"hash_27f40b888568660e", #"hash_5b36c90fb9767fbd", #"hash_7141f961caa3e322"), hash(var_85d87aca))) {
        return #"talent2";
    } else if (isinarray(array(#"hash_36f90c4eff587435", #"hash_3a01bee9e73c5940", #"hash_2c45c89bceef41d1", #"hash_32e6e64c0881c14b", #"hash_320186f753bdd5fa"), hash(var_85d87aca))) {
        return #"talent3";
    }
}
...
function function_bfa844a3(localclientnum, var_73cd9b6e) {
    ...
    var_674329bc = array(#"primary", #"secondary", #"primarygrenade", #"secondarygrenade", #"specialgrenade", #"talent1", #"talent2", #"talent3", #"talent4", #"talent5", #"hash_e88faf1dc4ab927", #"bonuscard1", #"hash_c70e59dba98cf81", #"talent", #"hash_6535e34e6169957e", #"specialty", #"hash_503cc7457f49371");
    foreach (var_8a4ba442 in var_674329bc) {
        ...
        if (var_8a4ba442 == #"primary" || var_8a4ba442 == #"secondary") {
            ...
            if (isdefined(var_82e23366.namehash) && (var_8a4ba442 == #"primarygrenade" || var_8a4ba442 == #"secondarygrenade" || sessionmodeiszombiesgame() && var_8a4ba442 === #"specialgrenade")) {
                ...
                if (sessionmodeiszombiesgame() && isinarray(array(#"talent", #"hash_6535e34e6169957e", #"specialty", #"hash_503cc7457f49371"), var_8a4ba442)) {
...
function private function_eeb5c6a3(localclientnum, var_73cd9b6e, var_8a4ba442) {
    ...
    return {#weapon:isdefined(weapon) ? weapon : level.weaponnone, #var_95970e62:var_95970e62, #model_name:model_name};
}
    ...
    if (sessionmodeiszombiesgame()) {
        ...
        if (level.var_da0b979c[#"legendary"][localclientnum] > 0) {
            if (!isdefined(level.var_9543e4da[#"legendary"][localclientnum])) {
                var_d2ee34ea = struct::get(#"hash_51a7a9e3da7b520");
        ...
        if (level.var_da0b979c[#"epic"][localclientnum] > 0) {
            if (!isdefined(level.var_9543e4da[#"epic"][localclientnum])) {
                var_d2ee34ea = struct::get(#"hash_38faa279fc3d8092");
        ...
        if (level.var_da0b979c[#"rare"][localclientnum] > 0) {
            if (!isdefined(level.var_9543e4da[#"rare"][localclientnum])) {
                var_d2ee34ea = struct::get(#"hash_5a8e75d422a9b183");
...
function function_831397a7(localclientnum, var_bfa844a3) {
    ...
    if (var_bfa844a3) {
        ...
        var_c8a42ec = var_c8a42ec < 11 ? var_14bec5d2 : var_c8a42ec;
...
function custom_class_update(localclientnum) {
    ...
    if (base_weapon_slot === #"hash_371b88bd6dadd70") {
    ...
    if (base_weapon_slot !== #"hash_371b88bd6dadd70" && isdefined(level.weapon_script_model[localclientnum][#"hash_371b88bd6dadd70"])) {
        level.weapon_script_model[localclientnum][#"hash_371b88bd6dadd70"] forcedelete();
        if (isdefined(level.preload_weapon_model[localclientnum][#"hash_371b88bd6dadd70"])) {
            level.preload_weapon_model[localclientnum][#"hash_371b88bd6dadd70"] delete();
        }
    ...
    if (base_weapon_slot !== #"hash_27328f764c0bbb70" && isdefined(level.weapon_script_model[localclientnum][#"hash_27328f764c0bbb70"])) {
        level.weapon_script_model[localclientnum][#"hash_27328f764c0bbb70"] forcedelete();
        if (isdefined(level.preload_weapon_model[localclientnum][#"hash_27328f764c0bbb70"])) {
            level.preload_weapon_model[localclientnum][#"hash_27328f764c0bbb70"] delete();
        }
        arrayremovevalue(level.weapon_script_model[localclientnum], undefined, 1);
    }
    if (base_weapon_slot !== #"hash_3c9f7fc239586b7d" && isdefined(level.weapon_script_model[localclientnum][#"hash_3c9f7fc239586b7d"])) {
        level.weapon_script_model[localclientnum][#"hash_3c9f7fc239586b7d"] forcedelete();
        if (isdefined(level.preload_weapon_model[localclientnum][#"hash_3c9f7fc239586b7d"])) {
            level.preload_weapon_model[localclientnum][#"hash_3c9f7fc239586b7d"] delete();
        }
        arrayremovevalue(level.weapon_script_model[localclientnum], undefined, 1);
    }
    if (isdefined(var_f0bf9259)) {
        ...
        } else if (base_weapon_slot === #"hash_27328f764c0bbb70" || base_weapon_slot === #"hash_3c9f7fc239586b7d") {
            function_f87ec9a8(var_e81ceea, var_f0bf9259, 0, base_weapon_slot);
        } else {
...
function function_d39cd2b5(var_8a4ba442 = "", str_weapon, var_cc6c0ec0 = 0, var_f2af4049 = 0, localclientnum) {
    if (var_cc6c0ec0) {
        var_c6abe208 = #"hash_635373352cf7209d";
    } else {
        var_c6abe208 = #"hash_1a1132299c267bca";
    }
...
function function_4983a663(localclientnum, var_8a4ba442) {
    if (var_8a4ba442 === #"hash_c70e59dba98cf81") {
        if (isdefined(level.var_a14cc36b[localclientnum][1].menu_name) && (!isdefined(level.var_a14cc36b[localclientnum][1].state) || level.var_a14cc36b[localclientnum][1].state != #"hash_7ed5154e6c6d5b95")) {
            return 1;
        } else {
            return 0;
        }
...
function function_f87ec9a8(var_e81ceea = "", str_weapon, var_f2af4049 = 0, var_227ba79b = #"") {
    if (!isdefined(level.var_f0a17a7b)) {
        level.var_f0a17a7b = #"hash_4288404fa1dc7b2";
    }
    if (isdefined(level.var_64ee434)) {
        var_b1e821c5 = {#var_dcfaf6c7:0};
        level.var_64ee434 = undefined;
    ...
    if (var_f2af4049 && scene::function_9730988a(level.var_f0a17a7b, "overview")) {
    ...
    } else if (var_227ba79b === #"hash_27328f764c0bbb70" && scene::function_9730988a(level.var_f0a17a7b, "charms")) {
        var_7dae7df8 = "charms";
    } else if (var_227ba79b === #"hash_3c9f7fc239586b7d" && scene::function_9730988a(level.var_f0a17a7b, "stickers")) {
        ...
        case #"muzzle":
            var_7dae7df8 = "muzzle";
            break;
        case #"hash_ece059ad360b651":
            var_7dae7df8 = "barrel";
            break;
        case #"hash_5e03ea7303a7a8c9":
...
function function_d896247b(var_ccf52c44) {
    return var_ccf52c44 == #"primary" || var_ccf52c44 == #"secondary" || var_ccf52c44 == #"hash_371b88bd6dadd70" || var_ccf52c44 == #"hash_2fda3f64c5caa89e" || var_ccf52c44 == #"hash_27328f764c0bbb70" || var_ccf52c44 == #"hash_3c9f7fc239586b7d";
}
...
function function_162e1121(localclientnum, var_ccf52c44, var_571f2574) {
    if (!(var_ccf52c44 == #"primary" || var_ccf52c44 == #"secondary" || var_ccf52c44 == #"hash_371b88bd6dadd70" || var_ccf52c44 == #"hash_27328f764c0bbb70" || var_ccf52c44 == #"hash_2fda3f64c5caa89e")) {
        return;
    }
...
function get_weapon_options(localclientnum, var_ccf52c44) {
    if (var_ccf52c44 == #"primary" || var_ccf52c44 == #"secondary" || var_ccf52c44 == #"hash_371b88bd6dadd70" || var_ccf52c44 == #"hash_27328f764c0bbb70" || var_ccf52c44 == #"hash_3c9f7fc239586b7d" || var_ccf52c44 == #"hash_2fda3f64c5caa89e") {
...
function update_weapon_script_model(localclientnum, newweaponstring, var_f020955, *should_update_weapon_options, is_item_unlocked = 1, xmodel_scale = 1, xmodel_name = #"", var_8a4ba442 = #"primary", var_e81ceea) {
    ...
    if (var_8a4ba442 !== #"hash_3c9f7fc239586b7d") {
        function_975f521b(var_571f2574);
    }
...
function function_5f70d1c8(weapon, var_e81ceea = "") {
    ...
    if (var_e81ceea == "") {
        ...
        var_5ac895fb.origin.var_5ac895fb = var_5ac895fb.origin + var_f3d83915;
        var_5ac895fb.angles.var_5ac895fb = var_5ac895fb.angles + var_dd6869e3;
        var_5ac895fb.scale.var_5ac895fb = isdefined(settings.var_9c241dd8) ? settings.var_9c241dd8 : 1;
        if (isdefined(var_d098ea88)) {
            var_5ac895fb.scale.var_5ac895fb = var_5ac895fb.scale + var_d098ea88;
        }
    } else {
        var_639f35c4 = (0, 0, 0);
        var_31d7e562 = (0, 0, 0);
        ...
        var_5ac895fb.origin.var_5ac895fb = var_5ac895fb.origin + var_639f35c4;
        var_5ac895fb.angles.var_5ac895fb = var_5ac895fb.angles + var_31d7e562;
        var_5ac895fb.scale.var_5ac895fb = isdefined(settings.var_9c241dd8) ? settings.var_9c241dd8 : 1;
        if (isdefined(var_3245d5de)) {
            var_5ac895fb.scale.var_5ac895fb = var_5ac895fb.scale + var_3245d5de;
        }
    }
    var_5ac895fb.var_d9843c11.var_5ac895fb = settings.var_6b6e0c5a;
    var_5ac895fb.var_e9a585d8.var_5ac895fb = settings.var_6b26bcfc;
    return var_5ac895fb;
}
...
function function_3bff05ba(weapon, var_8a4ba442, localclientnum = 0) {
    ...
    var_2cbf4808.origin.var_2cbf4808 = var_2cbf4808.origin + var_f3d83915;
    var_2cbf4808.angles.var_2cbf4808 = var_2cbf4808.angles + var_dd6869e3;
    var_2cbf4808.scale.var_2cbf4808 = isdefined(settings.var_a31af46c) ? settings.var_a31af46c : 1;
    if (isdefined(var_d098ea88)) {
        var_2cbf4808.scale.var_2cbf4808 = var_2cbf4808.scale + var_d098ea88;
    }
    var_2cbf4808.var_697bf2ff.var_2cbf4808 = settings.var_a20b23a4;
    var_2cbf4808.var_d9843c11.var_2cbf4808 = settings.var_6b6e0c5a;
    var_2cbf4808.var_e9a585d8.var_2cbf4808 = settings.var_e7072e63;
    var_2cbf4808.var_c492a06c.var_2cbf4808 = settings.var_8119af8f;
    ...
    if (is_true(var_f617db00)) {
        var_2cbf4808.var_a5946026.var_2cbf4808 = var_7975e84f + (isdefined(settings.var_a29aa4a) ? settings.var_a29aa4a : 0, isdefined(settings.var_fc750ee1) ? settings.var_fc750ee1 : 0, isdefined(settings.var_2ec07377) ? settings.var_2ec07377 : 0);
        var_2cbf4808.var_a7adf514.var_2cbf4808 = var_7975e84f + (isdefined(settings.var_9326937c) ? settings.var_9326937c : 0, isdefined(settings.var_b154cfd8) ? settings.var_b154cfd8 : 0, isdefined(settings.var_db89243c) ? settings.var_db89243c : 0);
        var_2cbf4808.var_36859b17.var_2cbf4808 = var_7975e84f + (isdefined(settings.var_91d3fe8f) ? settings.var_91d3fe8f : 0, isdefined(settings.var_7f0d5902) ? settings.var_7f0d5902 : 0, isdefined(settings.var_2d4fb580) ? settings.var_2d4fb580 : 0);
        if (function_cc770c92(weapon)) {
            if (var_8a4ba442 === #"primary" && function_4dcbc16b(localclientnum, var_8a4ba442, weapon)) {
                var_2cbf4808.origin.var_2cbf4808 = var_2cbf4808.origin + (isdefined(settings.var_ac657f76) ? settings.var_ac657f76 : 0, isdefined(settings.var_e130690b) ? settings.var_e130690b : 0, isdefined(settings.var_87eeb689) ? settings.var_87eeb689 : 0);
                var_2cbf4808.angles.var_2cbf4808 = var_2cbf4808.angles + (isdefined(settings.var_6d848856) ? settings.var_6d848856 : 0, isdefined(settings.var_a13b6fc3) ? settings.var_a13b6fc3 : 0, isdefined(settings.var_8b0e4369) ? settings.var_8b0e4369 : 0);
            }
        } else {
            var_2cbf4808.origin.var_2cbf4808 = var_2cbf4808.origin + (isdefined(settings.var_ac657f76) ? settings.var_ac657f76 : 0, isdefined(settings.var_e130690b) ? settings.var_e130690b : 0, isdefined(settings.var_87eeb689) ? settings.var_87eeb689 : 0);
            var_2cbf4808.angles.var_2cbf4808 = var_2cbf4808.angles + (isdefined(settings.var_6d848856) ? settings.var_6d848856 : 0, isdefined(settings.var_a13b6fc3) ? settings.var_a13b6fc3 : 0, isdefined(settings.var_8b0e4369) ? settings.var_8b0e4369 : 0);
        ...
        var_2cbf4808.var_a5946026.var_2cbf4808 = var_7975e84f + (isdefined(settings.var_b058b27b) ? settings.var_b058b27b : 0, isdefined(settings.var_13c87959) ? settings.var_13c87959 : 0, isdefined(settings.var_229096ed) ? settings.var_229096ed : 0);
        var_2cbf4808.var_a7adf514.var_2cbf4808 = var_7975e84f + (isdefined(settings.var_c287975b) ? settings.var_c287975b : 0, isdefined(settings.var_f0b173ae) ? settings.var_f0b173ae : 0, isdefined(settings.var_9e06ce56) ? settings.var_9e06ce56 : 0);
        var_2cbf4808.var_36859b17.var_2cbf4808 = var_7975e84f + (isdefined(settings.var_d0a96d99) ? settings.var_d0a96d99 : 0, isdefined(settings.var_bd3046a3) ? settings.var_bd3046a3 : 0, isdefined(settings.var_d0766d2f) ? settings.var_d0766d2f : 0);
    }
    return var_2cbf4808;
}
...
function function_fa001ebb(weapon) {
    ...
    var_f3d83915 = (0, 0, 0);
    var_dd6869e3 = (0, 0, 0);
    var_9913fe4a.origin.var_9913fe4a = var_9913fe4a.origin + var_f3d83915;
    var_9913fe4a.angles.var_9913fe4a = var_9913fe4a.angles + var_dd6869e3;
    ...
    var_9913fe4a.scale.var_9913fe4a = isdefined(settings.var_6332d1f5) ? settings.var_6332d1f5 : 1;
    var_9913fe4a.var_d9843c11.var_9913fe4a = settings.var_6b6e0c5a;
    var_9913fe4a.var_e9a585d8.var_9913fe4a = settings.var_eb37013d;
    return var_9913fe4a;
}
...
function function_add95f58(weapon) {
    ...
    var_f3d83915 = (0, 0, 0);
    var_dd6869e3 = (0, 0, 0);
    var_c5f370c1.origin.var_c5f370c1 = var_c5f370c1.origin + var_f3d83915;
    var_c5f370c1.angles.var_c5f370c1 = var_c5f370c1.angles + var_dd6869e3;
    var_c5f370c1.scale.var_c5f370c1 = isdefined(settings.var_db80b7d6) ? settings.var_db80b7d6 : 1;
    var_c5f370c1.var_d9843c11.var_c5f370c1 = settings.var_6b6e0c5a;
    var_c5f370c1.var_e9a585d8.var_c5f370c1 = settings.var_86ceec6b;
    return var_c5f370c1;
}
...
function function_82f74dec(weapon) {
    ...
    var_f3d83915 = (0, 0, 0);
    var_dd6869e3 = (0, 0, 0);
    var_924554cd.origin.var_924554cd = var_924554cd.origin + var_f3d83915;
    var_924554cd.angles.var_924554cd = var_924554cd.angles + var_dd6869e3;
    var_924554cd.scale.var_924554cd = isdefined(settings.var_b37b7688) ? settings.var_b37b7688 : 1;
    var_924554cd.var_d9843c11.var_924554cd = settings.var_6b6e0c5a;
    var_924554cd.var_e9a585d8.var_924554cd = settings.var_aacab320;
    return var_924554cd;
}
...
// Size: 0x1b2
function function_17a3348d(localclientnum, var_8a4ba442, var_c75beecc, s_info = function_ae73f57f(localclientnum, var_8a4ba442, var_e81ceea), var_e81ceea) {
    if (isarray(s_info.var_e9a585d8)) {
        foreach (var_9c7f3b78 in s_info.var_e9a585d8) {
            if (var_c75beecc === var_9c7f3b78.var_8694d12d) {
