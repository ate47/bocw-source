...
function leavemap(hardpointtype) {
    ...
    self ghost();
    if (isdefined(var_f3b82c6d)) {
        var_f3b82c6d thread killstreaks::outro_scaling();
    }
    if (self.var_14494df9 === 1) {
...
function function_f7055dec() {
    ...
    foreach (var_e53a042f in level.var_14fa3231) {
        ...
        foreach (possible_target in possible_targets) {
            if (isdefined(var_e53a042f.var_d3413870) && !(possible_target.killstreaktype === var_e53a042f.var_d3413870 || possible_target.killstreaktype === var_e53a042f.var_4c13f1ac)) {
                continue;
            }
