...
function add_to_notification_queue(menuname, *streakcount, hardpointtype, nonotify, var_af825242) {
    ...
    if (isdefined(var_5b220756)) {
        self function_6bf621ea(#"hash_6a9cb800ad0ef395", 2, self getentitynumber(), var_5b220756);
    }
}
    ...
    if (currentweapon != level.weaponnone && !is_true(level.usingmomentum)) {
        ...
        foreach (carriedweapon in weaponslist) {
            ...
            if (isdefined(var_6ddecf7f)) {
                jumpiffalse(level.killstreaks[var_6ddecf7f].script_bundle.var_301403ee) LOC_00000118;
            } else if (is_killstreak_weapon(carriedweapon)) {
...
function function_aa56f6a0(killstreaktype, isfrominventory) {
    ...
    var_5b220756 = function_a2c375bb(killstreaktype);
    if (isdefined(var_5b220756)) {
        ...
        if (isdefined(self.attackers) && self.attackers.size > 0) {
            ...
            foreach (assister in self.attackers) {
                ...
                if (isdefined(bundle.var_93f7b1ae) && isdefined(self.attackerdamage)) {
                    ...
                    jumpcmp(timepassed < bundle.var_93f7b1ae) LOC_00000380;
                    ...
                    jumpcmp(damagepercent > bundle.var_ebcd245a) LOC_000003d0;
                } else {
                LOC_000003d0:
...
function private init_ride_killstreak_internal(streak, always_allow) {
    if (isdefined(streak)) {
        ...
        var_41b6747e = bundle.var_15b39264;
    ...
    if (isdefined(postfxbundle)) {
        self thread function_cfa9cec5(var_41b6747e);
    } else {
        self thread hud::fade_to_black_for_x_sec(var_41b6747e, var_58330f68, 0.1, 0.1);
    }
    self thread watch_for_remove_remote_weapon();
    var_c3d5a8a9 = undefined;
    var_c3d5a8a9 = self waittilltimeout(var_41b6747e + var_58330f68, #"disconnect", #"death", #"endwatchforremoveremoteweapon");
...
function function_fc82c544(killstreaktype) {
    ...
    if (!sessionmodeiscampaigngame()) {
        if (!sessionmodeiszombiesgame()) {
            stats::function_8fb23f94(function_73b4659(killstreaktype), #"hash_7d6781e4032b4aa5", 1);
        }
...
function function_e24443d0(killstreaktype) {
    var_5b220756 = function_a2c375bb(killstreaktype);
    if (isdefined(var_5b220756)) {
        self function_6bf621ea(#"hash_1d8e470838fb6dd3", 2, self getentitynumber(), var_5b220756);
    }
}
