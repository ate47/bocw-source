...
function function_284b43aa() {
    ...
    while (1) {
        ...
        if (zm_utility::check_point_in_playable_area(waitresult.position)) {
            ...
            var_82545918.var_dd21aec2.var_82545918 = 1 & 16;
...
function function_5adab0a2() {
    var_f429251e = getent("zm_red_arm", "script_noteworthy");
    var_f429251e clientfield::set("" + #"hash_6a198759db0810a6", 1);
    level flag::wait_till("player_got_card");
    var_dae3aab3 = getent("zm_dra_arm", "script_noteworthy");
    var_bc4ce35d = getent(var_dae3aab3.target, "targetname");
    var_bc4ce35d linkto(var_dae3aab3);
    /#
        iprintlnbold("tag_fuse");
    #/
    e_activator = var_f429251e zm_unitrigger::function_fac87205(#"hash_4472d2ff9d015c5e", 48);
    ...
    var_dae3aab3 moveto(var_dae3aab3.origin + vectorscale((0, 1, 0), 15), 2, 0.5, 0.5);
    foreach (player in getplayers()) {
        if (isalive(player) && distancesquared(player.origin, var_dae3aab3.origin) <= 16384) {
            player clientfield::set_to_player("" + #"hash_115529ffa902a895", 1);
        }
    }
    var_dae3aab3 playsound(#"hash_2912845c6136a6b4");
}
...
function function_eb0fb7fc(duration, cooldown) {
    ...
    while (1) {
        ...
        level.var_75a20fe3 = util::spawn_model("tag_origin", var_410e2bb5.origin + (25, -33, 80), var_410e2bb5.angles + vectorscale((0, 1, 0), 90));
...
function function_67144513() {
    ...
    if (isdefined(level.var_8e50d6c1)) {
        ...
        level.var_8e50d6c1 function_cb48cddd();
    }
...
function function_c436fc75() {
    ...
    var_6222618f.var_dd21aec2.var_6222618f = 1 & 16;
...
function function_dc2acb90() {
    ...
    canister.var_dd21aec2.canister = 1 & 16;
    var_56bd59dc = getent("zm_can_dmg", "script_noteworthy");
    var_56bd59dc.var_22cea3da.var_56bd59dc = &function_72c756bc;
    waitresult = undefined;
...
function function_3ca2b2c1(var_fd6475b5, var_743c16e0, var_93bdf906) {
    ...
    while (1) {
        if (!isdefined(var_f2484ed9.mdl_gameobject)) {
            var_f2484ed9.require_look_at.var_f2484ed9 = 1;
        ...
        if (is_true(level.var_e9f6c6da) && !level flag::get("in_dark_side") && !level flag::get("on_mq_step_0_2")) {
            ...
            foreach (var_fd6475b5, var_f2484ed9 in level.var_8dc29179) {
                ...
                if (var_f2484ed9.mdl_gameobject flag::get(#"hash_4d6700553ede7078") || !var_f2484ed9.mdl_gameobject flag::get(#"hash_7a42d508140ae262")) {
                    ...
                    if (!isdefined(var_f2484ed9.var_9463599a)) {
                        var_f2484ed9.var_9463599a.var_f2484ed9 = var_f2484ed9 zm_silver_util::function_3be9e71a();
                    }
                    var_95138a52 = 1;
                }
            }
...
function function_ad3081a9(e_player) {
    if (level flag::get(#"hash_3e765c26047c9f54") || level flag::get("in_exfil_event")) {
        ...
        return 1;
    } else if (is_true(level.var_e9f6c6da) && (self.mdl_gameobject flag::get(#"hash_4d6700553ede7078") || !self.mdl_gameobject flag::get(#"hash_7a42d508140ae262")) && !level flag::get("in_dark_side") && !level flag::get("on_mq_step_0_2") && !e_player usebuttonpressed()) {
...
function function_59642e27(a_ents) {
    ...
    while (1) {
        ...
        if (isplayer(waitresult.attacker) && isdefined(waitresult.weapon) && is_true(waitresult.weapon.isbulletweapon)) {
            ...
            var_ab549ef1.var_dd21aec2.var_ab549ef1 = 1 & 16;
...
function function_91807eb1(e_player) {
    if (!isdefined(level.var_c3accf46) && e_player function_1d89280c()) {
        ...
        return 1;
    } else if (isdefined(level.var_c3accf46) && e_player == level.var_c3accf46) {
...
function function_4d97eda3(e_player) {
    if (!isdefined(level.var_ae002b60) && e_player function_1d89280c()) {
        ...
        return 1;
    } else if (isdefined(level.var_ae002b60) && e_player == level.var_ae002b60) {
        self sethintstringforplayer(e_player, #"hash_4425ec8a1a0dcd32");
        return 1;
    } else {
        return 0;
...
function function_b75d50b5(e_player) {
    if (!isdefined(level.var_42000fd0) && e_player function_1d89280c()) {
        ...
        return 1;
    } else if (isdefined(level.var_42000fd0) && e_player == level.var_42000fd0) {
        self sethintstringforplayer(e_player, #"hash_4425ec8a1a0dcd32");
        return 1;
    } else {
        return 0;
...
function function_8a172c28(e_player) {
    if (!isdefined(level.var_c8a2dc28) && e_player function_1d89280c()) {
        ...
        return 1;
    } else if (isdefined(level.var_c8a2dc28) && e_player == level.var_c8a2dc28) {
        self sethintstringforplayer(e_player, #"hash_4425ec8a1a0dcd32");
        return 1;
    } else {
        return 0;
...
function private function_233ed9b4() {
    /#
        ...
        add_custom_devgui_callback(&function_98af2074);
    #/
}
    ...
    /#
        ...
        case #"hash_1c88a4f3e72d4479":
            ...
            if (isdefined(var_410e2bb5)) {
                var_410e2bb5 play(#"hash_65505ba29fee0a2f", var_410e2bb5);
            }
