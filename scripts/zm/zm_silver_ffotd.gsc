...
function private postinit() {
    ...
    spawncollision("collision_clip_wall_64x64x10", "collider", (241.1, 2104.7, 203.1), vectorscale((0, 1, 0), 45));
    spawncollision("collision_clip_wall_64x64x10", "collider", (267.3, 2074.9, 203.4), vectorscale((0, 1, 0), 45));
    spawncollision("collision_clip_wall_32x32x10", "collider", (732.3, 1850.1, 201.4), vectorscale((0, 1, 0), 90));
