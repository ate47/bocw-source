...
function player_out_of_playable_area_monitor_callback() {
    if (isdefined(self)) {
        if (distance2dsquared(self.origin, (-2159.5, 13415, 115)) <= function_a3f6cdac(96) || distance2dsquared(self.origin, (-1381.1, 13774, 206.4)) <= function_a3f6cdac(96) || distance2dsquared(self.origin, (-2552.5, 11568.4, 56.2)) <= function_a3f6cdac(96)) {
            return 0;
        }
    }
    return 1;
...
function function_452e5ad6() {
    ...
    if (level flag::get(#"hash_299b0e75bff5106f")) {
...
function function_3ba2978d() {
    ...
    level flag::wait_till_all([2:"start_zombie_round_logic", 1:"all_players_spawned", 0:#"hash_443b6a1ea0c4b52b"]);
    wait(1);
...
function function_6f6cc58(e_player) {
    if (isdefined(self) && isdefined(e_player)) {
        if (self.archetype === #"zombie" || self.archetype === #"tormentor") {
            ...
            if (distance2dsquared(self.origin, e_player.origin) < function_a3f6cdac(500)) {
                return 1;
            }
            return 0;
...
function function_d47fe1d8(var_df192c8d) {
    ...
    foreach (zombie in zombies) {
        if (isalive(zombie) && distance2dsquared(zombie.origin, origin) < function_a3f6cdac(100)) {
    ...
    while (1) {
        ...
        case #"heavy":
            foreach (player in a_players) {
                ...
                } else if (player zm_zonemgr::is_player_in_zone(level.var_cef1cab5)) {
                    player function_bc82f900(#"hash_109abe9169de475f");
                }
            }
            break;
        ...
        foreach (zombie in a_zombies) {
            if (isdefined(zombie) && zombie.health > 0) {
                if (zombie istouching(self)) {
                    if (zombie.archetype === #"hash_3d92e2c7bea1eee2") {
                    ...
                    } else if (zombie.archetype === #"hash_7c0d83ac1e845ac2") {
                    ...
                    } else if (!zombie flag::get(#"hash_2cf0b6ebfb6c98f3")) {
                        a_players = function_a1ef346b();
                        foreach (player in a_players) {
                        ...
                        playfxontag(#"hash_76477e9d3b3abaf4", zombie, "J_Spine4");
...
function private function_9feaaed() {
    ...
    if (level flag::get(#"hash_547cc154153f60ee")) {
...
function function_4c86cc5() {
    ...
    zm_sq::function_53d0d99(#"hash_6540714f9d2b59fb", var_49f892f0);
    zm_sq::function_53d0d99(#"hash_6540724f9d2b5bae", var_2aa1d292);
    wait(1);
    ...
    zm_sq::function_53d0d99(#"hash_6540734f9d2b5d61", var_5bad9552);
    wait(1);
    ...
    zm_sq::function_53d0d99(#"hash_6540744f9d2b5f14", var_74d25c9e);
    zm_sq::function_53d0d99(#"hash_6540754f9d2b60c7", var_e3b2d4f9);
    wait(1);
    ...
    zm_sq::function_53d0d99(#"hash_50971d60dd167421", var_7b6eae07);
    ...
    if (isdefined(level.var_3b115519)) {
        while (1) {
            ...
            foreach (player in players) {
                if (player function_4d65f583(level.var_3b115519)) {
...
// Size: 0x10e
function function_4d65f583(var_cb301a2b) {
    self endon(#"death");
    if (zm_utility::is_player_valid(self, 0, 1)) {
        if (isdefined(var_cb301a2b) && var_cb301a2b.size > 0) {
            foreach (volume in var_cb301a2b) {
...
function function_90cffb5b(var_f52c2c29) {
    ...
    foreach (var_8c8031b6 in var_f52c2c29) {
        var_43cd39d4 = struct::get(var_8c8031b6, "targetname");
        if (!isdefined(var_43cd39d4)) {
            continue;
        }
        posonnavmesh = getclosestpointonnavmesh(var_43cd39d4.origin, 64, 16);
        if (!isdefined(posonnavmesh)) {
            continue;
        }
        var_49360d05 = struct::get(var_43cd39d4.target, "targetname");
        ...
        if (isdefined(str_zone) && isdefined(var_5f3b05e8)) {
            ...
            level.var_141e4a5f[var_5f3b05e8][str_zone] = {#var_db90fcba:var_db90fcba, #posonnavmesh:posonnavmesh, #var_43cd39d4:var_43cd39d4};
        }
    }
}
...
function private function_20ad9d07() {
    ...
    while (1) {
        ...
        foreach (zombie in a_ai_zombies) {
            ...
            } else if (distancesquared(zombie.origin, self.origin) < var_ff00218d) {
                var_b8855d07[var_b8855d07.size] = zombie;
            }
        }
            ...
            if (zombie.favoriteenemy === self) {
                if (isdefined(zombie.var_29656770) && zombie.var_29656770.var_990bf66b === var_5f3b05e8) {
                    ...
                    if (isdefined(str_zone) && isdefined(level.var_141e4a5f[var_5f3b05e8][str_zone])) {
                        ...
                        var_43cd39d4 = var_71c80ceb.var_43cd39d4;
                        if (distancesquared(zombie.origin, var_43cd39d4.origin) < max_dist_sq) {
                            /#
...
function function_85dc9b9d() {
    ...
    while (1) {
        ...
        if (waitresult._notify == "goal" && isdefined(self.v_zombie_custom_goal_pos)) {
            if (distancesquared(self.origin, self.v_zombie_custom_goal_pos) < function_a3f6cdac(self.goalradius)) {
                /#
                    println("<unknown string>" + self getentitynumber() + "<unknown string>");
                #/
                break;
...
function function_a56b42c0() {
    if (level.round_number === 10 && !zm_round_spawning::function_fab464c4()) {
        ...
        while (1) {
            ...
            zone_name = array::random(var_c32b93c6);
            if (isdefined(zone_name)) {
                var_9e2396e0 = zm_utility::function_cce73165("mechz_location", #"hash_704a090ff9fcffd0", zone_name);
...
function function_58f27026() {
    /#
        ...
        players = getplayers();
        foreach (player in players) {
            player add_to_player_score(100000);
            player function_afab250a(100000);
            player function_a6d4221f(100000);
        }
...
function function_81acf2cf() {
    /#
        ...
        var_b9deb373 = get_script_bundle_instances("<unknown string>", [1:"<unknown string>", 0:"<unknown string>"]);
        var_f501ee56 = get_script_bundle_instances("<unknown string>", [1:"<unknown string>", 0:"<unknown string>"]);
        var_bc5ea9bc = arraycombine(var_b9deb373, var_f501ee56, 0, 0);
        var_1a4d3aef = get_script_bundle_instances("<unknown string>", [1:"<unknown string>", 0:"<unknown string>"]);
...
function function_1365e765() {
    /#
        level set(#"hash_5503fb2f49e6a242");
...
function function_e6b581e7(var_9ff20235) {
    /#
        ...
        str_weapon_name = random([5:"<unknown string>", 4:"<unknown string>", 3:"<unknown string>", 2:"<unknown string>", 1:"<unknown string>", 0:"<unknown string>"]);
        self function_749d2cfc(hash(str_weapon_name), hash(str_weapon_name + var_7625b6cc), var_27751b99);
        self acquire(self getcurrentweapon());
        ...
        self thread function_29387491(#"hash_47d7a8105237c88");
        self thread function_29387491(#"hash_38c08136902fd553");
        self thread function_29387491(#"hash_210097a75bb6c49a");
    ...
    /#
        ...
        if (isdefined(str_item_name)) {
            ...
            if (isdefined(point.var_a6762160.var_a53e9db0)) {
                ...
                self function_98776900(point, 0, 0, 1);
            }
...
function function_86af79f6() {
    /#
        ...
        self weapon_give(getweapon("<unknown string>"), 1);
    #/
}
...
function run_step(ee, step, var_5ea5c94d) {
    /#
        ...
        self set(step.var_e788cdd7 + "<unknown string>");
...
function private function_30e6bbd6() {
    /#
        level set(#"hash_3f926cd1d573549d");
    #/
}
...
function function_7b342056() {
    /#
        foreach (player in function_a1ef346b()) {
            player weapon_give(getweapon("<unknown string>"), 1);
        }
    #/
}
