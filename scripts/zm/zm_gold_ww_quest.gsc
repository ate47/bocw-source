...
function function_8de4f4ec() {
    ...
    array::thread_all(function_a1ef346b(), &namespace_4abf1500::function_3ad8805e, #"hash_196207efbf3628f2");
    ...
    while (i < 10) {
        ...
        var_9e2396e0 = spawnactor("spawner_bo5_zombie_zm_gold", s_spawn.origin, s_spawn.angles, undefined, 1);
...
function function_a91dc42a() {
    ...
    if (!isdefined(level.var_ba2ab2cf)) {
        ...
        level.var_ba2ab2cf = array(level.var_ba2ab2cf);
    }
    if (!isinarray(level.var_ba2ab2cf, model)) {
        level.var_ba2ab2cf[level.var_ba2ab2cf.size] = model;
    }
    ...
    var_e03eac13.origin.var_e03eac13 = var_e03eac13.origin + vectorscale((0, 0, 1), 40) + var_3d9eca2c * 20;
    var_e03eac13.var_dad14d36 = model;
    var_e03eac13.var_40376d20.var_e03eac13 = struct::get(self.target, "targetname");
}
    ...
    while (1) {
        ...
        if (is_true(self.stub.var_dad14d36.var_e87fbf2f)) {
            if (isdefined(self.stub.var_40376d20)) {
                ...
                var_ab71b599.angles.var_ab71b599 = vectorscale((0, 0, 1), 53);
            }
        }
        if (is_true(self.stub.var_dad14d36.var_58d0878f)) {
            ...
            /#
                iprintlnbold("<unknown string>");
            #/
            array::thread_all(function_a1ef346b(), &namespace_4abf1500::function_3ad8805e, #"hash_4579071a9a00f2b1");
        }
    ...
    if (isplayer(self)) {
        if (isdefined(item.var_a6762160.name)) {
            ...
            case #"hash_a2df964f9390e75":
                ...
                array::thread_all(function_a1ef346b(), &namespace_4abf1500::function_3ad8805e, #"hash_4579051a9a00ef4b");
                level flag::set(#"hash_722723ce1e3aa7d2");
            ...
            case #"hash_a2df664f939095c":
                array::thread_all(function_a1ef346b(), &namespace_4abf1500::function_3ad8805e, #"hash_4579061a9a00f0fe");
                break;
            ...
            case #"hash_a2df464f93905f6":
                array::thread_all(function_a1ef346b(), &namespace_4abf1500::function_3ad8805e, #"hash_4579081a9a00f464");
...
function function_e37a65e1() {
    /#
        ...
        var_e37a65e1 = spawnactor(#"hash_4f87aa2a203d37d0", var_b6246671.origin, var_b6246671.angles, "<unknown string>", 1);
        if (isdefined(var_e37a65e1)) {
            var_e37a65e1 function_d8abfc3d(#"on_ai_damage", &function_fdccaaa8);
        }
    #/
}
...
function function_fdccaaa8(s_params) {
    /#
        ...
        if (self.archetype === #"hash_9f6bc1960ff4912" && str_hit_loc === "<unknown string>") {
