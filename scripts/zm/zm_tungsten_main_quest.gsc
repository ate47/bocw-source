...
function function_799fb043() {
    ...
    foreach (var_98871874 in level.var_3f41835d) {
        ...
        var_98871874.ondamaged.var_98871874 = &namespace_8a08914c::function_b49b76d4;
    }
...
function function_85a47e02() {
    ...
    while (var_4945de3b < var_72e812fd) {
        ...
        if (var_1950bf84 function_85e19b28()) {
            ...
            var_1950bf84.ondamaged.var_1950bf84 = &namespace_8a08914c::function_b49b76d4;
            var_1950bf84.health.var_1950bf84 = 5;
...
function on_item_pickup(params) {
    ...
    case #"item_zmquest_tungsten_mq_quest_part_fuel":
        ...
        array::thread_all(function_a1ef346b(), &namespace_4abf1500::function_3ad8805e, #"zmintel_tungsten_requiem_artifact_4");
        break;
    case #"item_zmquest_tungsten_mq_quest_part_housing":
        ...
        array::thread_all(function_a1ef346b(), &namespace_4abf1500::function_3ad8805e, #"zmintel_tungsten_requiem_artifact_2");
        break;
    case #"item_zmquest_tungsten_mq_quest_part_monitor":
        ...
        array::thread_all(function_a1ef346b(), &namespace_4abf1500::function_3ad8805e, #"zmintel_tungsten_requiem_artifact_3");
        break;
...
function function_9409ac93() {
    ...
    while (self function_e128a831() || self function_b4813488() || is_true(self.var_16735873)) {
        waitframe(1);
    }
}
...
function function_b15240c9(*a_ents) {
    ...
    function_1f97238f(struct::get_array("mq_observation_end_mid_igc"));
    wait(1);
...
function function_d1ac9156() {
    ...
    if (isdefined(ai_abom)) {
        ...
        ai_abom.ignore_enemy_count.ai_abom = 1;
    }
...
function function_8fc5e1ba() {
    var_b7a28022 = struct::get(#"hash_56785ce109cf091c");
...
function function_34f41b72() {
    ...
    level flag::wait_till(#"start_zombie_round_logic");
    for (i = 0; i < 4; i++) {
        level.var_a13ca883[i] = level.a_s_interacts[i] zm_unitrigger::create(&function_af62864b, 64, &function_7468ef6);
...
// Size: 0x16a
function function_af62864b(*player) {
    if (!level flag::get(#"hash_65c0f8b6c42b8159") && level flag::get(#"hash_3683ce7803b13dea") && !level flag::get(self.stub.str_flag)) {
        ...
        return 1;
    } else if (level flag::get(#"hash_65c0f8b6c42b8159")) {
        self sethintstring(#"hash_7079aaada5942259");
        return 1;
    } else if (level flag::get(self.stub.str_flag)) {
...
function function_dbec41cd() {
    ...
    foreach (player in getplayers()) {
        player.var_45ef153.player = 0;
        player.var_1a4a768c.player = 0;
        player.b_activated = undefined;
    }
    ...
    while (1) {
        if (function_e1403814() < n_zombies && !level flag::get(#"hash_54c8d63e66e2f949")) {
            ...
            if (isdefined(ai_zombie) && a_s_spawns[i].script_noteworthy === "custom_spawner_entry crawl") {
                ai_zombie.var_ed454e33.ai_zombie = 1;
            }
            if (isdefined(ai_zombie) && isdefined(a_s_spawns[i].zone_name)) {
                ai_zombie.var_e6ad4793.ai_zombie = 1;
            }
            i++;
...
function function_9c2ad358(n_timer) {
    ...
    var_4fd98c9e = getentarray("fuel_tank_liquid", "targetname");
    foreach (var_fc3c3d4a in var_4fd98c9e) {
        var_fc3c3d4a.var_df0610bd.var_fc3c3d4a = var_fc3c3d4a.origin;
    }
    foreach (var_fc3c3d4a in var_4fd98c9e) {
...
function function_7239291b(v_org, b_in_zone) {
    ...
    foreach (zombie in a_zombies) {
        ...
        if (isalive(zombie) && is_true(zombie.b_clear)) {
            ...
            zombie.deathpoints_already_given.zombie = 1;
            zombie.marked_for_death.zombie = 1;
...
function spawn_gp(player) {
    ...
    if (!isdefined(level.var_ef566585)) {
        ...
        if (isdefined(level.var_ef566585)) {
            ...
            if (zm_utility::is_player_valid(player)) {
            ...
            } else if (isdefined(level.var_ef566585)) {
                ...
                level.var_ef566585 radiusdamage(level.var_ef566585.origin + vectorscale((0, 0, 1), 10), 500, level.zombie_health, int(level.zombie_health * 0.5), level.var_ef566585, "MOD_EXPLOSIVE");
...
function function_5429a020() {
    ...
    var_a001c66d = function_3d102402(#"item_zmquest_tungsten_mq_quest_part_monitor", var_c3136e6e.origin, var_c3136e6e.angles, 0);
    wait(0.1);
...
function function_43b1545e() {
    ...
    foreach (zone in self.a_zones) {
        foreach (node in zone.nodes) {
            ...
            foreach (s_spawn in a_s_spawns) {
                ...
                } else if (s_spawn.script_noteworthy === #"dog_location") {
                    self.a_s_dog[self.a_s_dog.size] = s_spawn;
                } else if (s_spawn.script_noteworthy === #"raz_location") {
                    self.var_2e4e85c5[self.var_2e4e85c5.size] = s_spawn;
                } else if (s_spawn.script_noteworthy === #"hash_2fe3f22c14b70850") {
    ...
    foreach (var_734c3691 in var_75d7aa63) {
        if (var_734c3691.var_df2f9ba4 === self.n_id) {
            ...
            } else if (var_734c3691.script_noteworthy === #"tempest") {
                self.var_4c4255a3[self.var_4c4255a3.size] = var_734c3691;
            } else if (var_734c3691.script_noteworthy === #"tormentor") {
    ...
    foreach (var_b7eee573 in self.var_3758c43e) {
        var_b7eee573.e_owner.var_b7eee573 = self;
    ...
    while (1) {
        if (self.var_80164102 < 12 && self flag::get(#"hash_60b2f597116f5ae") && self flag::get(#"hash_148b5949f208f189")) {
            ...
            if (isdefined(ai_zombie)) {
                ...
                self.var_80164102++;
                ai_zombie.var_3128fb28.ai_zombie = self;
                ...
                ai_zombie.n_id.ai_zombie = self.n_id;
            }
        }
...
function function_e578b3ec() {
    ...
    wait(0.5);
    while (1) {
        var_b8e3924c = function_3d102402(#"item_zmquest_tungsten_mq_quest_part_shard", self.origin + vectorscale((0, 0, 1), 40), vectorscale((1, 0, 0), 90), 0);
        waitframe(1);
        if (isdefined(var_b8e3924c)) {
            var_b8e3924c.n_id.var_b8e3924c = self.n_id;
            var_b8e3924c.script_noteworthy.var_b8e3924c = "crystal_shard";
...
function function_d4808171(var_3128fb28) {
    ...
    if (isdefined(ai_abomination)) {
        ai_abomination.ignore_enemy_count.ai_abomination = 1;
    }
...
function function_47104ac4() {
    ...
    wait(0.5);
    if (isdefined(v_pos)) {
        var_e1622660 = function_3d102402(#"item_zmquest_tungsten_mq_quest_part_catalyzed", v_pos + vectorscale((0, 0, 1), 32), vectorscale((1, 0, 0), 90), 0);
    } else {
        var_e1622660 = function_3d102402(#"item_zmquest_tungsten_mq_quest_part_catalyzed", v_org + vectorscale((0, 0, 1), 32), vectorscale((1, 0, 0), 90), 0);
    }
    util::wait_network_frame();
...
function function_b6f5ae25() {
    ...
    } else if (level.var_1f7f9ebe === 1) {
        array::thread_all(function_a1ef346b(), &namespace_4abf1500::function_3ad8805e, #"zmintel_tungsten_darkaether_artifact_4");
...
function function_65b074ce(*var_1377a1e8) {
    ...
    level.var_90016943 zm_unitrigger::create(&function_d285d2e5, 80, &function_24a32a6d);
}
...
function function_ada90340() {
    ...
    level.var_90016943 val::set("escort", "takedamage", 0);
    ...
    array::thread_all(function_a1ef346b(), &namespace_4abf1500::function_3ad8805e, #"zmintel_tungsten_requiem_artifact_5");
}
...
function function_c02f8acc() {
    ...
    while (1) {
        ...
        if (level.var_90016943.var_a5c9efc1 === 1) {
            n_dist = 250000;
        } else if (level.var_90016943.var_a5c9efc1 === 2) {
            n_dist = 140625;
        } else {
            n_dist = 62500;
        }
        ...
        if (!self.var_f4bd7934 || is_true(self.abnormal_status.emped) || !self.var_fce6b9f4) {
            ...
            if (self.var_fce6b9f4) {
                ...
                level.var_90016943 clientfield::increment("" + #"hash_36fbe21deb0433d8");
            }
...
function function_5732ebe3() {
    ...
    self waittill(#"hash_2e33a6cc74123124");
...
function function_b2897fd3() {
    ...
    while (1) {
        ...
        } else if (var_1105889c <= 0.5 && var_1105889c >= 0.25) {
...
function function_84ddb230() {
    var_b8e3924c = function_3d102402(#"item_zmquest_tungsten_mq_quest_part_refuel", self.origin + vectorscale((0, 0, 1), 32), vectorscale((1, 0, 0), 90), 0);
...
function function_3eb5183() {
    ...
    foreach (var_49af023b in var_7594f81c) {
        ...
        if (isdefined(var_9ff72f0c)) {
            ...
            var_9ff72f0c.targetname.var_9ff72f0c = "phase_wall";
        }
    }
...
function function_fffd60cd(n_index) {
    ...
    if (isdefined(self)) {
        ...
        self setplayerangles(vectorscale((0, 1, 0), 270));
    }
}
    ...
    while (1) {
        ...
        foreach (entity in var_6effa129) {
            ...
            if (isplayer(entity) && (!isalive(entity) || entity scene::is_igc_active())) {
                entity hide_effects();
            } else if (entity istouching(var_a1cc3481) && !is_true(entity.b_ignore_fow_damage) && isdefined(entity.maxhealth)) {
                player = undefined;
                vehicle = undefined;
...
// Size: 0x12a
function function_3d102402(var_e05f8872, v_org, v_ang, var_b17ecef0) {
    ...
    var_eaa939f9.var_dd21aec2.var_eaa939f9 = 1 & 16;
...
function function_be1b951c() {
    ...
    s_door = struct::get("interact_door_town_square");
    var_344a6a1a = array::get_all_closest(s_door.origin, models, undefined, undefined, 1000);
...
function function_b78ba960(a_ents) {
    ...
    level clientfield::set("" + #"hash_7b50097ac4242bc9", 0);
    var_69406530 = a_ents[#"hash_1154b5797e3db10e"];
    if (isdefined(var_69406530)) {
        var_69406530 vehicle::toggle_tread_fx(0);
    }
}
...
function function_c1719fb7(e_player) {
    ...
    e_player.var_f22c83f5.e_player = 1;
    e_player.var_f4e33249.e_player = 1;
    e_player.var_d7bb5e99.e_player = util::spawn_model(#"tag_origin", e_player.origin, e_player.angles);
...
function function_cd7a3de4() {
    /#
        add_debug_command("tank_process_soa");
        add_debug_command("MOD_TRIGGER_HURT");
...
function cmd(cmd) {
    /#
        ...
        case #"hash_390016349056b819":
            function_f2dd8601(#"hash_6deef93cdc13faf2", function_9212ff4d(#"hash_6deef93cdc13faf2", #"hash_2cec5bd1113224f4"));
            iprintlnbold("<unknown string>");
            level thread function_a4c80826(get_array(#"hash_12376e3570660abc"));
            break;
        case #"hash_48a8b88c7ce6ae03":
            level set(#"hash_77e125d6f8b2733e");
            level function_7df6bb60(#"hash_4273532945cef4b0", 1);
            iprintlnbold("<unknown string>");
            break;
        case #"hash_a2d020f3f18130d":
            level set(#"hash_52d565520308890c");
            level function_7df6bb60(#"hash_4273562945cef9c9", 1);
            iprintlnbold("<unknown string>");
            break;
        case #"hash_73a9e3fd790e09ac":
            level set(#"hash_407e12c104cfde25");
            level function_7df6bb60(#"hash_4273552945cef816", 1);
            iprintlnbold("<unknown string>");
            break;
        ...
        case #"hash_60e984dbc694d6d2":
            level.var_1f7f9ebe++;
            level set(#"hash_6702dc6ad4563f02");
            if (!isdefined(level.var_566d0d14)) {
                level.var_566d0d14 = 1;
            }
            level.var_566d0d14++;
            level function_7df6bb60(#"hash_4273532945cef4b0", level.var_566d0d14);
            iprintlnbold("<unknown string>");
            break;
        case #"hash_42adc8078d26599":
            level.var_1f7f9ebe++;
            level set(#"hash_6702da6ad4563b9c");
            if (!isdefined(level.var_566d0d14)) {
                level.var_566d0d14 = 1;
            }
            level.var_566d0d14++;
        ...
        case #"hash_38df87bcd0f3b46f":
            level.var_1f7f9ebe++;
            level set(#"hash_6702dd6ad45640b5");
            if (!isdefined(level.var_566d0d14)) {
                level.var_566d0d14 = 1;
            }
            level.var_566d0d14++;
        ...
        case #"hash_34cbc37fe364c47e":
            ...
            level set(#"hash_6702dd6ad45640b5");
            level set(#"hash_6702da6ad4563b9c");
            level set(#"hash_45d1ea5a016b7916");
            level.var_1f7f9ebe = 3;
            level function_7df6bb60(#"hash_4273532945cef4b0", 4);
            iprintlnbold("<unknown string>");
            break;
        case #"hash_32de2812b8f91f4c":
            level thread function_f2dd8601(#"hash_6deef93cdc13faf2", function_9212ff4d(#"hash_6deef93cdc13faf2", #"hash_2cec5bd1113224f4"));
            level set(#"hash_331ca6d639f4883d");
            level set(#"hash_21844688fcfdffe4");
            level set(#"hash_717f6f193982a127");
            level set(#"hash_45d1ea5a016b7916");
            level thread function_a4c80826(get_array(#"hash_5c81ab439fcc310e"));
            iprintlnbold("<unknown string>");
            break;
