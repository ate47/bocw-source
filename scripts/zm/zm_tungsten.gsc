...
function autoexec opt_in() {
    ...
    namespace_1c7b37c6::item_remover(&item_world_fixup::remove_item, #"hash_54877da1f10e40b5");
}
...
function function_78e3584f(v_position, str_zone_name) {
    ...
    if (isdefined(var_88dc621c)) {
        ...
        var_88dc621c.script_noteworthy.var_88dc621c = "player_volume";
        var_88dc621c.var_5ac5060b.var_88dc621c = 1;
    }
}
...
function function_6f6cc58(e_player) {
    ...
    if (isdefined(self) && isdefined(e_player)) {
        ...
        if (isdefined(self.archetype) && isinarray([6:#"zombie_dog", 5:#"abom", 4:#"avogadro", 3:#"hash_be2e962be17d10e", 2:#"hash_9f6bc1960ff4912", 1:#"tormentor", 0:#"zombie"], self.archetype)) {
...
function private function_289c7852(*n_round) {
    spawner::add_archetype_spawn_function(#"hash_be2e962be17d10e", &function_64ed78df);
    zm_cleanup::function_cdf5a512(#"hash_be2e962be17d10e", &function_5394f283);
...
function private function_9e6f187d(n_round) {
    ...
    zm_round_spawning::function_cc103b38(#"hash_9f6bc1960ff4912", n_round);
...
function function_822214be(*n_round_number) {
    ...
    while (1) {
        ...
        if (zm_round_spawning::function_d0db51fc(#"hash_be2e962be17d10e")) {
            level.var_9c55e25a++;
...
function function_53555fd2() {
    ...
    var_4b2b783e.origin.var_4b2b783e = (6272, 4981, 576);
    var_4b2b783e.radius.var_4b2b783e = 900;
    var_4b2b783e.halfheight.var_4b2b783e = 200;
    str_key = "targetname";
...
function function_9f46dbde() {
    ...
    while (level.var_a4642f0a < var_99963ba3) {
        ...
        var_322f4e77 = getaiarchetypearray(#"hash_be2e962be17d10e");
...
function function_40985978(start_weapon) {
    /#
        ...
        if (getdvarint(#"hash_651f2f99447aa462", 0) || getdvarint(#"hash_fac5f738960a49a", 0)) {
            var_e191cfdc = self getweaponslistprimaries();
            foreach (weapon in var_e191cfdc) {
        ...
        if (is_true(getgametypesetting(#"hash_4b8929fb898a9e80"))) {
            self thread function_29387491(#"hash_3417450e1347185");
        }
...
function function_fc6ae19f() {
    /#
        var_36cb1235 = random([4:"<unknown string>", 3:"<unknown string>", 2:"<unknown string>", 1:"<unknown string>", 0:"<unknown string>"]);
        aat_name = "<unknown string>" + var_36cb1235 + "<unknown string>";
        currentweapon = self get_current_weapon();
        var_4657c1e0 = self function_230ceec4(currentweapon);
        self function_37e9e0cb(var_4657c1e0, currentweapon, aat_name);
    #/
}
...
function function_71a6c3ea() {
    /#
        ...
        level thread function_f2dd8601(#"pap_quest", function_9212ff4d(#"pap_quest", #"hash_42541c1c30ef6ea8"));
        level set("<unknown string>");
        function_2d12df62();
    #/
}
