...
function function_c6de5d3d(b_skipped) {
    ...
    slots = [];
    slots[slots.size] = {#on_navmesh:1, #origin:var_da02bd54.origin};
    var_be8a80d6.is_active.var_be8a80d6 = 1;
    var_be8a80d6.var_b79a8ac7.var_be8a80d6 = {#slots:slots, #var_f019ea1a:200};
    ...
    if (isdefined(level.var_56e22cfa)) {
        level.var_56e22cfa zodcompanionutility::function_fc67b7ed(&function_ce3b7324);
    }
...
function function_7c943428(var_f345d85) {
    ...
    while (1) {
        ...
        if (waitresult.attacker === level.var_56e22cfa && isdefined(level.var_56e22cfa.attackable)) {
            /#
                iprintlnbold("<unknown string>");
            #/
            playfx(#"hash_4752fa601bfee5fb", waitresult.position, anglestoforward(vectorscale((0, 1, 0), 180)), (0, 0, 1));
            var_f345d85.is_active.var_f345d85 = 0;
    ...
    if (isdefined(level.var_56e22cfa)) {
        level.var_56e22cfa zodcompanionutility::function_30df05d5(&function_ce3b7324);
    }
...
function function_3eafd069(entity) {
    ...
    var_e03eac13.origin.var_e03eac13 = var_e03eac13.origin + vectorscale((0, 0, 1), 35);
    var_e03eac13.var_52dbcd71.var_e03eac13 = namespace_8d91c4fb::function_c5fed573([2:#"hash_253b4cd2f1c72a2d", 1:#"hash_253b4bd2f1c7287a", 0:#"hash_253b4ad2f1c726c7"], [2:#"hash_2569b61becd22a49", 1:#"hash_2569b51becd22896", 0:#"hash_2569b41becd226e3"], [2:#"hash_456523933756aaf3", 1:#"hash_456522933756a940", 0:#"hash_456525933756ae59"]);
}
...
function function_bb30710d() {
    ...
    while (1) {
        ...
        if (isplayer(player)) {
            player.var_c6af46f9.player = 1;
            player.var_19f4406e.player = 2;
...
function function_743996c0() {
    ...
    level.var_86f3197e = struct::get(level.var_6a086277.target, "targetname");
    level.var_2a616939 = level.var_86f3197e zm_unitrigger::create(&function_fb9b5ce9, 40, &function_46c3c6ea);
    ...
    var_4d1c70f5.var_2f21f7ff.var_4d1c70f5 = 1;
    var_4d1c70f5.var_a6762160.var_fa988b4b = undefined;
    var_4d1c70f5.amount.var_4d1c70f5 = isdefined(var_2cf93673.clipsize) ? var_2cf93673.clipsize : 25;
    spawncollision(#"collision_clip_32x32x128", "collider", (-4058.5, 9117.75, 420), vectorscale((0, 1, 0), 230));
...
function function_1168e497(b_skipped) {
    ...
    wait(1);
    if (isplayer(who)) {
        var_480bebe7 = who namespace_1e7573ec::function_d0aeb094();
        switch (var_480bebe7) {
        case 0:
            vo = array::random([2:#"hash_6cbf2db34581d6b4", 1:#"hash_1d625335946802e9", 0:#"hash_583c41a2b612380e"]);
            break;
        case 1:
            vo = array::random([2:#"hash_6e1931deb01a0a33", 1:#"hash_3cc99f0f22f1987e", 0:#"hash_c9d1aa3915d39bd"]);
            break;
        case 2:
            vo = array::random([2:#"hash_65b3aabbb42b2dee", 1:#"hash_712e1bc526501323", 0:#"hash_3a3edf25e70502e4"]);
            break;
        }
        who namespace_1e7573ec::function_1340d9d6(vo);
    }
    wait(1);
    var_52dbcd71 = namespace_8d91c4fb::function_c5fed573([2:#"hash_12f581a94e2eceb1", 1:#"hash_12f580a94e2eccfe", 0:#"hash_12f57fa94e2ecb4b"], [2:#"hash_28afd69c1c66c60d", 1:#"hash_28afd59c1c66c45a", 0:#"hash_28afd49c1c66c2a7"], [2:#"hash_6598d3bdcc9664f7", 1:#"hash_6598d2bdcc966344", 0:#"hash_6598d5bdcc96685d"]);
