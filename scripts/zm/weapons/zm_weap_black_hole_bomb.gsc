...
function private autoexec __init__system__() {
    system::register(#"hash_4f25b1a89459b1f8", &function_70a657d8, &postinit, undefined, "zm_weapons");
}
...
function function_54881ba1(watcher) {
    watcher.onspawn.watcher = &function_e38ab081;
}
...
function function_f576c273(var_a495cbed) {
    ...
    var_b0f2c67b = spawn("trigger_radius", var_a495cbed.var_acdc8d71, 0, 64, 70);
    var_a495cbed thread function_c2f76b45(var_b0f2c67b);
    var_a495cbed waittill(#"explode");
    var_b0f2c67b notify(#"hash_5e52043e21f343d7");
    wait(0.1);
    var_b0f2c67b delete();
}
...
function function_7ceb96bf(player, *endon_condition) {
    ...
    endon_condition function_13fce2b({#angles:angles, #origin:origin});
}
...
function function_13fce2b(var_9e4b7aff) {
    ...
    var_33da84db = vectorscale((0, 0, 1), 49);
    var_b2763088 = vectorscale((0, 0, 1), 20);
    var_3334a329 = (0, 0, 0);
    destination = undefined;
    playsoundatposition(#"hash_89afcb430026d5c", self.origin + vectorscale((0, 0, 1), 50));
    if (self getstance() == "prone") {
        destination = var_9e4b7aff.origin + var_33da84db;
    } else if (self getstance() == "crouch") {
        destination = var_9e4b7aff.origin + var_b2763088;
    } else {
    ...
    while (n_currtime <= n_vortex_time) {
        ...
        foreach (ai_zombie in a_ai_zombies) {
            ...
            if (isvehicle(ai_zombie)) {
                ...
                ai_zombie.blockingpain.ai_zombie = 1;
                ...
                case #"normal":
                    if (ai_zombie.archetype === #"zombie_dog") {
                        ...
                        if (!isdefined(ai_zombie.var_56912e22) || time >= ai_zombie.var_56912e22) {
                            ...
                            ai_zombie.var_56912e22.ai_zombie = gettime() + 1000;
                        }
                        break;
                    }
                    ai_zombie.var_db490292.ai_zombie = "blackholebomb_pull_fast";
                    ai_zombie.var_92b78660.ai_zombie = 1024;
