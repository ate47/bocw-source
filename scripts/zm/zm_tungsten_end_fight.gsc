    ...
    while ( !var_90796363 )
    {
        ...
        if ( isplayer( e_attacker ) || var_9b676843 )
        {
            ...
            if ( var_9b676843 )
            {
                ...
                {
                    var_982513ee = 1;
                    level thread function_f83c329c( #"cannon_blocked", 0, 0.5, { #str_id:#"cannon_blocked", #n_time:60 }, 0 );
                }
            }
...
function function_6074ced6()
{
    ...
    level function_f83c329c( #"cannon_failed", 0, 0, { #str_id:#"cannon_failed", #n_time:5 }, 0 );
    wait 0.5;
    level function_f83c329c( #"weakpoint_regen", 1, 0, { #str_id:#"weakpoint_regen", #n_time:60 } );
...
function function_360256d0( str_side, b_play_vo = 1 )
{
    ...
    if ( b_play_vo )
    {
        level thread function_f83c329c( #"ground", 1, 0.5, { #str_id:#"boss_attack", #n_time:30 } );
    }
...
function function_ecf643d2( b_play_vo = 1 )
{
    ...
    if ( b_play_vo )
    {
        var_591caa3e = { #str_id:#"boss_attack", #n_time:30 };
...
function function_cdc05f45( var_973c5c71 = 0, var_bad95e69 = 1 )
{
    ...
    while ( true )
    {
        ...
        else
        {
            ...
            if ( !level.var_75a7d6 flag::get( #"intermission" ) )
            {
                level thread function_f83c329c( #"maxis_move", 0, 0.5, { #str_id:#"maxis_generic", #n_time:5 } );
            }
        }
...
function function_1c6d2370()
{
    ...
    level.var_75a7d6.var_c20e460e.var_8a337eba = 0;
    function_4ba59ffe();
    level thread function_f83c329c( #"cannon_charged", 0, 0, { #str_id:#"cannon_charged", #n_time:30 } );
...
function function_733c1a3f( s_params )
{
    ...
    if ( !level.var_75a7d6 flag::get_any( [ #"defeated", #"intermission", #"boss_talking" ] ) )
    {
        ...
        level thread function_f83c329c( str_vo, 0, 0.5, { #str_id:#"maxis_generic", #n_time:10 }, 0 );
    }
}
...
function function_866fc84d( var_98bf27a1 )
{
    ...
    level thread function_f83c329c( #"cannon_failed", 0, 0.5, { #str_id:#"cannon_failed", #n_time:30 }, 0 );
}
