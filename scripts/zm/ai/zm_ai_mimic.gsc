...
function private autoexec __init__system__() {
    system::register(#"zm_ai_mimic", &function_70a657d8, &postinit, undefined, "zm_destination_manager");
}
...
function function_7c591227(params) {
    ...
    self val::function_e681e68e(#"hash_195d34d606e6ced8");
...
function function_8b6bfa1() {
    ...
    if (mimic_prop_spawn::function_1541ff3a(var_f6e30076, self)) {
        ...
        props = mimic_prop_spawn::function_c928b745(spawn_points, var_f6e30076, self);
...
function function_f826fb47(spawn_loc) {
    if (isdefined(spawn_loc.scriptbundlename)) {
        ...
        return {#var_24af7a37:var_24af7a37, #var_c546004:var_c546004, #var_f866b946:var_641c724f.model};
    }
    return undefined;
}
...
function function_218c4ce8() {
    ...
    var_8e76d54d = [7:{#type:0, #name:#"hash_1f10ab49bdded60b"}, 6:{#type:0, #name:#"hash_512059ba21e9bc93"}, 5:{#type:0, #name:#"hash_7e48d08a5a78d573"}, 4:{#type:0, #name:#"hash_448adaf187bbb953"}, 3:{#type:0, #name:#"hash_6217ef2a3d7d895b"}, 2:{#type:0, #name:#"crafting_table"}, 1:{#type:0, #name:#"hash_629e563c2ebf707a"}, 0:{#type:0, #name:#"ammo_cache"}];
        ...
        foreach (location in var_f5ae494f[0].locations) {
            foreach (info in var_8e76d54d) {
                ...
                foreach (struct in var_283bf51b) {
                    ...
                    struct.var_da70348d.struct = info.type;
    ...
    if (isdefined(level.var_976841f)) {
        foreach (trigger_stub in level.var_976841f) {
            trigger_stub.var_da70348d.trigger_stub = 1;
    ...
    if (isdefined(var_f5ae494f) && var_f5ae494f.size > 0) {
        location = var_f5ae494f[0].locations[#"hash_26a32029178521b0"];
        if (isdefined(location.instances[#"hash_26a32029178521b0"])) {
            instance = location.instances[#"hash_26a32029178521b0"];
            if (isdefined(instance.var_344a6a1a) && isarray(instance.var_344a6a1a)) {
                foreach (var_37180a9f in instance.var_344a6a1a) {
                    var_926eb7ac = {#origin:var_37180a9f.origin, #angles:var_37180a9f.angles, #prop:var_37180a9f, #var_da70348d:2};
    ...
    if (isdefined(vehicles)) {
        foreach (vehicle in vehicles) {
            spawn_struct = {#origin:vehicle.origin, #angles:vehicle.angles, #prop:vehicle, #var_da70348d:3};
...
function function_9542c864(var_e663e7c5) {
    if (!isdefined(var_e663e7c5.zone_name)) {
        ...
        var_e663e7c5.zone_name.var_e663e7c5 = zm_zonemgr::get_zone_from_position(var_994bab50 + vectorscale((0, 0, 1), 15), 1);
    }
...
function function_c4a57e80(var_e9aa3e9c) {
    if (var_e9aa3e9c.targetname === "zombie_vending") {
        return {#activation_func:&mimic_prop_spawn::function_204a610e, #prop:function_b703696e(var_e9aa3e9c, &function_b2b03bc, &function_f7e48831, &function_8afb304d)};
    }
    return undefined;
}
...
function function_b703696e(var_e9aa3e9c, var_374304ac, var_e06892e6, trigger_func) {
    ...
    var_1386d828.var_5faf570.var_1386d828 = var_e9aa3e9c.trigger_func;
