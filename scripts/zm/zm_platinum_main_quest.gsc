...
function function_4b9d2b47() {
    ...
    var_1440b452 = util::spawn_model(#"tag_origin", self.origin - vectorscale((0, 0, 1), 38), self.angles);
    ...
    var_84faf171 = spawncollision(#"collision_clip_sphere_64", "mdl_invulnerable_clip", self.origin + vectorscale((0, 0, 1), 64), self.angles);
    var_4dcd0316 = spawncollision(#"collision_clip_sphere_64", "mdl_invulnerable_clip", self.origin + vectorscale((0, 0, 1), 128), self.angles);
...
function function_933074b6() {
    ...
    var_1440b452 clientfield::set("" + #"hash_41ba39a474a3503f", 2);
    mdl_clip = spawncollision(#"collision_clip_sphere_64", "mdl_invulnerable_clip", var_2316a0ef.origin + vectorscale((0, 0, 1), 32), var_2316a0ef.angles);
    var_2d3dceb6 = util::spawn_model(#"hash_52d954a68e5a2936", (-2951, 14217, -556), vectorscale((0, 1, 0), 90));
    level flag::wait_till(#"hash_64e189de9593e575");
    var_1440b452 clientfield::set("" + #"hash_41ba39a474a3503f", 0);
...
function function_3fead2ea() {
    ...
    self.var_bec42bc3 playloopsound(#"hash_63961c3736b0486");
}
...
function function_336abb75(b_skipped) {
    ...
    if (isdefined(level.var_56e22cfa)) {
        level.var_56e22cfa zodcompanionutility::function_fc67b7ed(&function_f33969bc);
    }
...
function function_4cd9b9c(b_skipped, var_19e802fa) {
    if (b_skipped || var_19e802fa) {
        if (isdefined(level.var_56e22cfa)) {
            level.var_56e22cfa zodcompanionutility::function_30df05d5(&function_f33969bc);
        }
        ...
        if (!level flag::get(#"hash_5be6d6dc058f1402")) {
            ...
            var_dca9b2b5 = getent("hidden_door_clip", "script_noteworthy");
            var_29f6c004 = getent("hidden_door_weapon_clip", "targetname");
            if (isdefined(var_dca9b2b5)) {
                var_dca9b2b5 delete();
            }
        ...
        var_94daffc2 = getent("second_door_damage_proxy", "targetname");
        var_3b1d1169 = getent("lab_second_hidden_door", "targetname");
        if (isdefined(var_94daffc2)) {
            var_94daffc2 delete();
        }
        ...
        level flag::set(#"hash_9e523b0dff32601");
    }
...
function function_9ecd52b9() {
    ...
    while (1) {
        ...
        foreach (player in function_a1ef346b()) {
            ...
            if (isdefined(dis) && dis <= function_a3f6cdac(3000)) {
...
function function_96fa8def() {
    ...
    while (1) {
        ...
        zone = zm_zonemgr::get_zone_from_position(level.var_56e22cfa.origin);
        if (isdefined(zone) && isinarray([1:"zone_sewers_and_escape_tunnel", 0:"zone_sewers_and_escape_tunnel2"], zone)) {
            level thread namespace_8d91c4fb::function_e250a72f(#"hash_18d02fcacab75cf9");
            break;
        }
        wait(3);
    }
...
function function_f33969bc(*params) {
    ...
    var_8841c4a7.is_active.var_8841c4a7 = 1;
    if (dis <= 200) {
        if (isdefined(level.var_56e22cfa)) {
        ...
        wait(0.2);
        do {
            level.var_56e22cfa zodcompanionutility::function_14f3d97b(var_8841c4a7.origin);
            level.var_56e22cfa waittilltimeout(2, #"goal");
            dis = distance(level.var_56e22cfa.origin, var_8841c4a7.origin);
        } while(dis > 64 && isdefined(level.var_56e22cfa));
        if (isdefined(level.var_56e22cfa)) {
            level.var_56e22cfa thread scene::play(#"hash_5fe7340db947aa81", "breakdoor", level.var_56e22cfa);
            level.var_56e22cfa thread namespace_33c196c8::function_dec85954("zber_kvo_cmdint", 1);
        }
        var_8841c4a7.is_active.var_8841c4a7 = 0;
...
function function_4a473c7e() {
    var_94daffc2 = getent("second_door_damage_proxy", "targetname");
    var_94daffc2 thread function_f8702828();
    level thread function_f8d46698();
...
function function_83e02cc3() {
    ...
    var_94daffc2 = getent("second_door_damage_proxy", "targetname");
    while (var_94daffc2.var_e3c067a4 > 0) {
        var_94daffc2.var_e3c067a4--;
        wait(0.1);
    }
}
...
function function_9a82a095() {
    ...
    level namespace_8d91c4fb::function_d137d6a0(#"hash_3314244e71b59b92", #"hash_3779f3fb1a0e80d0", #"hash_5f4fe1fad61c9bf6");
    wait(1);
    level thread function_cc84e369();
...
function function_d53cc258() {
    ...
    namespace_8d91c4fb::function_d137d6a0(#"hash_3314244e71b59b92", #"hash_3779f3fb1a0e80d0", #"hash_5f4fe1fad61c9bf6");
    wait(1);
    level thread function_cc84e369();
}
...
function function_2ca830c2(b_skipped) {
    ...
    level.var_55a99841[#"hash_9f6bc1960ff4912"] = &function_ce39a77b;
    ...
    while (!b_played) {
        foreach (player in function_a1ef346b()) {
            ...
            if (isdefined(dis) && dis <= 500 && level flag::get(#"hash_5c97d613e20f93e4") && player zm_utility::is_player_looking_at(var_bf50c725.origin)) {
                ...
                namespace_8d91c4fb::function_d137d6a0(#"hash_329b2dee7817bd2", #"hash_38bbfbce5e53c710", #"hash_63f8e9ce1d46be36");
                wait(1);
                b_played = 1;
                break;
            }
...
function function_c06ce917() {
    ...
    var_8df86ab8.var_ab2f7bf4.var_8df86ab8 = 3;
    var_8df86ab8.var_9fc2173a.var_8df86ab8 = 0;
    var_8df86ab8.var_4594eb75.var_8df86ab8 = 0;
...
// Size: 0x13c
function function_52513536(var_52dbcd71) {
    level endon(#"end_game", #"hash_7488d04db98e7184");
    if (isdefined(level.var_56e22cfa)) {
        level.var_56e22cfa.var_c0d80964 = 1;
    }
    while (1) {
        ...
        if (isdefined(level.var_56e22cfa) && isdefined(level.var_56e22cfa.leader)) {
            dis = distance2d(level.var_56e22cfa.origin, level.var_56e22cfa.leader.origin);
            if (dis < 300) {
                level namespace_8d91c4fb::function_e250a72f(var_52dbcd71);
                level.var_56e22cfa.var_c0d80964 = 0;
                break;
            }
        }
        wait(3);
...
function function_da3ee2e3(var_c5d57dcc) {
    ...
    if (var_c5d57dcc) {
        ...
        activator.var_3b5a075f.activator = 1;
        waitframe(5);
        if (isdefined(var_5940806d)) {
            var_5940806d delete();
        }
    } else {
        activator.var_6593d715.activator = 1;
        waitframe(5);
        if (isdefined(var_5940806d)) {
            var_5940806d delete();
        }
...
function function_8eb912c5(params) {
    ...
    if (isplayer(attacker) || attacker === level.var_56e22cfa) {
...
function function_6dbba0a7(b_skipped, var_19e802fa) {
    ...
    level.var_55a99841[#"hash_9f6bc1960ff4912"] = undefined;
...
function function_a458fe58() {
    ...
    var_5c880fca.s_canister.var_5c880fca = self;
}
    ...
    while (!b_played) {
        foreach (player in function_a1ef346b()) {
            if (is_true(player.var_3b5a075f)) {
                ...
                if (isdefined(dis) && dis <= function_a3f6cdac(300) && player zm_utility::is_player_looking_at(var_ca33f912.origin)) {
                    level thread namespace_8d91c4fb::function_d137d6a0(#"hash_29c271427905b478", #"hash_4c8152aadcfa6966", #"hash_1d6788395bd8d618");
                    b_played = 1;
                    break;
                }
            }
...
function function_475abfc5() {
    ...
    var_4b7f71f1.var_66bc7a53.var_4b7f71f1 = self;
    level flag::wait_till(#"hash_7488d04db98e7184");
...
function function_e750c105(e_player) {
    if (isplayer(e_player)) {
        if (is_true(self.stub.var_66bc7a53.b_power_off)) {
            self sethintstringforplayer(e_player, #"hash_4d2af9ad659bf308");
            return 1;
        } else if (is_true(self.stub.var_66bc7a53.var_43456ea9) && is_true(self.stub.var_66bc7a53.var_a53d0b46)) {
            self sethintstringforplayer(e_player, #"hash_766c66117e1014d0");
            return 1;
        } else if (level.var_1254ad06 != 0 && !is_true(self.stub.var_66bc7a53.var_a53d0b46) && !is_true(e_player.var_3b5a075f)) {
...
function function_40cc6759() {
    ...
    while (1) {
        ...
        if (level.var_1254ad06 != 0 && !is_true(self.stub.var_66bc7a53.var_a53d0b46)) {
            self.stub.var_66bc7a53.var_a53d0b46 = 1;
            self.stub.var_66bc7a53.var_43456ea9 = 0;
            level.var_1254ad06--;
            level thread function_c080f1c1(self.stub.var_66bc7a53);
        }
        if (!isdefined(player.canister) && is_true(self.stub.var_66bc7a53.var_43456ea9)) {
            self.stub.var_66bc7a53.var_43456ea9 = 0;
            self.stub.var_66bc7a53.var_a53d0b46 = 0;
            self.stub.var_66bc7a53.b_power_off = 1;
            level thread function_1144f1aa(self.stub.var_66bc7a53, player);
        }
    }
}
...
// Size: 0x1d4
function function_c080f1c1(var_66bc7a53) {
    level endon(#"end_game");
    var_2a86179 = struct::get(var_66bc7a53.target, "targetname");
    if (isdefined(var_2a86179)) {
        var_66bc7a53.var_a3e9fe06.var_66bc7a53 = util::spawn_model(#"hash_3023420c57af55eb", var_2a86179.origin, var_2a86179.angles);
        var_66bc7a53.var_a3e9fe06 playsound(#"hash_1f1636f62458cf3c");
        var_66bc7a53.var_a3e9fe06 moveto(var_66bc7a53.var_a3e9fe06.origin + vectorscale((0, 0, -1), 4), 3);
        var_66bc7a53.var_a3e9fe06 playsound(#"hash_2eedbe412ecac84");
        var_66bc7a53.var_4bbcfae9 clientfield::set("" + #"hash_6256b5001ca2ef80", 2);
        var_66bc7a53.var_c3cd747e setmodel(#"hash_25492a4f77d4f1db");
        var_66bc7a53.var_a3e9fe06 waittill(#"movedone");
    }
    var_66bc7a53 thread function_6012c55c();
    /#
...
// Size: 0x220
function function_1144f1aa(var_66bc7a53, player) {
    level endon(#"end_game");
    array::thread_all(getplayers(), &namespace_4abf1500::function_3ad8805e, #"hash_6b9b6d474fbed58d");
    if (isdefined(var_66bc7a53.index)) {
        level zm_ui_inventory::function_7df6bb60(#"hash_2de8d60719124b8" + var_66bc7a53.index, 2);
    }
    player function_927a0091(1);
    if (isdefined(var_66bc7a53.var_a3e9fe06)) {
        var_66bc7a53.var_a3e9fe06 clientfield::set("" + #"hash_6f292901e2fcaeb3", 0);
        var_66bc7a53.var_a3e9fe06 playsound(#"hash_4886352431f9e6e9");
    }
    var_66bc7a53.var_4bbcfae9 clientfield::increment("" + #"hash_5924dea34439fc47");
    var_66bc7a53.var_4bbcfae9 clientfield::set("" + #"hash_6256b5001ca2ef80", 3);
    var_66bc7a53.var_c3cd747e setmodel(#"hash_44623e6053914d8f");
    waitframe(5);
    if (isdefined(var_66bc7a53.var_a3e9fe06)) {
        var_66bc7a53.var_a3e9fe06 delete();
    }
...
// Size: 0x420
function function_1bba593c(canister, var_ff27a24 = 0) {
    level endon(#"end_game", #"hash_7488d04db98e7184");
    ...
    while (1) {
        ...
        if (var_372b6f4.size <= var_afa3e462) {
            var_9e2396e0 = spawn_zombie(#"hash_4f87aa2a203d37d0", self);
            if (isdefined(var_9e2396e0)) {
                var_9e2396e0 thread function_c7afd8f3(canister);
                var_9e2396e0.var_126d7bef.var_9e2396e0 = 1;
                var_9e2396e0.ignore_round_spawn_failsafe.var_9e2396e0 = 1;
                var_9e2396e0.no_powerups.var_9e2396e0 = 1;
                var_9e2396e0.ignore_enemy_count.var_9e2396e0 = 1;
                var_9e2396e0.var_357c108b.var_9e2396e0 = 1;
                var_9e2396e0.var_98f1f37c.var_9e2396e0 = 1;
                var_9e2396e0.completed_emerging_into_playable_area.var_9e2396e0 = 1;
                if (!isdefined(var_372b6f4)) {
                    var_372b6f4 = [];
                } else if (!isarray(var_372b6f4)) {
                    var_372b6f4 = array(var_372b6f4);
                }
                if (!isinarray(var_372b6f4, var_9e2396e0)) {
                    var_372b6f4[var_372b6f4.size] = var_9e2396e0;
                }
            }
        }
        if (var_e66bd02d.size <= var_5b414118) {
            ...
            if (isdefined(s_spawn_loc)) {
                var_9e2396e0 = namespace_abfee9ba::function_71f8127a(s_spawn_loc);
            }
            if (isdefined(var_9e2396e0)) {
                var_9e2396e0 thread function_c7afd8f3(canister);
                var_9e2396e0.var_126d7bef.var_9e2396e0 = 1;
                ...
                if (!isinarray(var_e66bd02d, var_9e2396e0)) {
                    var_e66bd02d[var_e66bd02d.size] = var_9e2396e0;
                }
            }
        }
...
function function_c7afd8f3(canister) {
    ...
    if (!isdefined(canister.var_3a733d30)) {
        canister.var_3a733d30.canister = 0;
    }
...
function function_dc0c0830(player, a_s_spawn_locs) {
    ...
    if (isdefined(var_6cf1afd9)) {
        ...
        } else if (player.var_9c08fce7 != var_6cf1afd9) {
            player.var_9c08fce7 = var_6cf1afd9;
        }
    }
}
...
// Size: 0x12c
function function_28730c04(bool) {
    if (bool) {
...
function function_6012c55c() {
    ...
    while (1) {
        ...
        if (var_d9321608 >= self.var_bcce0aa9) {
            ...
            self.var_a3e9fe06 moveto(self.var_a3e9fe06.origin + vectorscale((0, 0, 1), 4), 3);
...
function function_e8799ac6(entity, var_7bae7a71 = 1024) {
    ...
    foreach (var_ccea7dbf in var_17c7dbe6) {
        if (isalive(var_ccea7dbf)) {
            ...
            var_ccea7dbf.var_d45ca662.var_ccea7dbf = 1;
            var_ccea7dbf.var_98f1f37c.var_ccea7dbf = 1;
...
function function_84041c8c() {
    ...
    b_play_vo = 0;
    while (1) {
        point = function_4ba8fde(#"hash_7292fa4ec7eb97b2");
        ...
        var_d5b4edd7.var_dd21aec2.var_d5b4edd7 = 1 & 16;
        var_d5b4edd7 waittill(#"death");
        if (!b_play_vo) {
            b_play_vo = 1;
            level thread namespace_8d91c4fb::function_d137d6a0(#"hash_7bfd671b90f3911e", #"hash_2c170dd1cd5ca69c", #"hash_68ed9238ee4a3182");
        }
        var_3afef0fd++;
...
function function_927a0091(var_16cee4c4 = 0) {
    ...
    if (isentity(var_16cee4c4)) {
        ...
        canister.var_1474d2ee.canister = gameobjects::get_next_obj_id();
    ...
    if (isdefined(tagname)) {
        canister linkto(self, tagname, (10, 0, 5), vectorscale((1, 0, 0), 270));
    } else {
        canister linkto(self, undefined, (-14, 5, 45), vectorscale((1, 0, 0), 15));
    }
    ...
    if (is_true(canister.var_c5d57dcc)) {
        ...
        canister.var_c5d57dcc.canister = 1;
        ...
        self function_28730c04(1);
        if (!is_true(level.var_10a16ead)) {
            level thread namespace_8d91c4fb::function_d137d6a0(#"hash_46993634718abc05", #"hash_2b464da207069e61", #"hash_62714f511d585e97");
...
function function_3357e2a9(var_6661fde5 = 0) {
    ...
    if (is_true(canister.var_c5d57dcc)) {
        ...
        self.var_3b5a075f = 0;
        canister.var_a1f3366.canister = self.var_8da24ed0;
...
function function_75fd7e0() {
    ...
    if (self.canister.var_a1f3366 >= 6) {
        namespace_1b527536::function_7281de4d(#"hash_42722c5a5596cde2", &function_daec8c25, #"hash_60cb3fd3716d711e", #"hash_1a2e7166e36c7ed1", 1, 6, 1);
    } else {
        namespace_1b527536::function_7281de4d(#"hash_42722c5a5596cde2", &function_daec8c25, #"hash_60cb3fd3716d711e", #"hash_1a2e7166e36c7ed1", 1, 6, 0);
...
function function_9076f34c(player) {
    ...
    if (isdefined(v_point)) {
        v_ground = groundtrace(v_point + vectorscale((0, 0, 1), 40) + vectorscale((0, 0, 1), 8), v_point + vectorscale((0, 0, 1), 40) + vectorscale((0, 0, -1), 100000), 0, self)[#"position"];
    }
    if (!isdefined(v_ground)) {
        v_ground = groundtrace(player.origin + vectorscale((0, 0, 1), 40) + vectorscale((0, 0, 1), 8), player.origin + vectorscale((0, 0, 1), 40) + vectorscale((0, 0, -1), 100000), 0, self)[#"position"];
    }
    wait(0.1);
...
function function_2b855510() {
    ...
    while (1) {
        ...
        if (!var_53044e8e && self buttonbitstate("BUTTON_BIT_ANY_DOWN") || var_53044e8e && self actionslottwobuttonpressed()) {
            if (!self flag::get_any([1:#"hash_1b361b950317ecb5", 0:#"hash_686d5709e1566aa6"])) {
                self function_3357e2a9(1);
            }
        }
    }
...
function function_78368ca1(b_skipped) {
    ...
    level.var_302f1011 = namespace_4abf1500::function_2ba45c94("zmintel_platinum_requiem_document_04", (-7978, 11826, -268.5), (357.5, 277.6, 17.8), 100, 0, 0, undefined, 0);
    ...
    if (isdefined(level.var_56e22cfa)) {
        level.var_56e22cfa zodcompanionutility::function_fc67b7ed(&function_e97a3826);
    }
    level flag::set(#"hash_7632e33ae2122338");
    var_da2fccd7 = struct::get("train_5_trigger_pos", "targetname");
    var_729794bf = var_da2fccd7 zm_unitrigger::create(&function_80602bcb, 64, &function_90dd5ebf);
    var_729794bf.origin.var_729794bf = var_729794bf.origin + vectorscale((0, 0, 1), 10);
    ...
    var_f9b16117.origin.var_f9b16117 = var_f9b16117.origin + vectorscale((0, 0, 1), 10);
    ...
    if (isdefined(level.var_56e22cfa)) {
        level.var_56e22cfa zodcompanionutility::function_30df05d5(&function_e97a3826);
    }
    /#
        iprintlnbold("<unknown string>");
    #/
...
function function_41ae49d5(a_ents) {
    var_3c39b355 = a_ents[#"hash_6ca79b7cf0687f15"];
...
function function_e97a3826(*params) {
    level endon(#"hash_2304a1d24bb8597f");
    var_f86dd72f = struct::get("klaus_stop_train_pos", "targetname");
    ...
    if (istouching(self.origin, var_3c6ab678)) {
        if (!level flag::get(#"hash_75f07aed08b6bb5e")) {
            ...
            wait(0.1);
            if (isdefined(level.var_56e22cfa)) {
                level.var_56e22cfa.var_83562198 = undefined;
                level.var_56e22cfa.attackable = undefined;
                level.var_56e22cfa zodcompanionutility::function_14f3d97b(var_f86dd72f.origin);
                level.var_56e22cfa waittill(#"goal");
                level flag::set(#"hash_6499c1679ecbefef");
                level.var_56e22cfa thread function_7c097c21();
                level.var_56e22cfa thread namespace_33c196c8::function_dec85954("zber_mq4_cmdstp", 1);
                level.var_56e22cfa scene::play(#"hash_267b129167d3488d", "stop_train_5_in", level.var_56e22cfa);
                /#
                    iprintlnbold("<unknown string>");
                #/
                level.var_56e22cfa thread scene::play(#"hash_267b129167d3488d", "stop_train_5_in_idle", level.var_56e22cfa);
            }
        }
    }
}
...
function function_80602bcb(e_player) {
    if (isplayer(e_player)) {
        if (level flag::get_any([1:#"hash_1c8cee37d4ebb24b", 0:#"hash_50aa91e49479ab59"])) {
            return 0;
...
function function_c015b2c1(var_205b8171 = undefined, var_9d372cc4 = 0) {
    ...
    while (!isdefined(level.var_48d07d1f.var_ec0d861e[#"hash_5ee795a6c5087209"])) {
        waitframe(1);
    }
    level.var_48d07d1f.var_ec0d861e[#"hash_5ee795a6c5087209"] thread function_d8d8efb();
    var_ebc5d65 = 0;
    ...
    if (isdefined(level.var_48d07d1f.var_ec0d861e[#"hash_5ee795a6c5087209"])) {
        level.var_48d07d1f.var_ec0d861e[#"hash_5ee795a6c5087209"] playloopsound(#"hash_100719fe800935ce");
    }
    ...
    if (level flag::get(#"hash_6499c1679ecbefef") || var_9d372cc4) {
        ...
        if (isdefined(level.var_56e22cfa)) {
            level.var_56e22cfa animation::stop();
        }
        level.var_4308c048 = #"heavy";
        level.var_48d07d1f.var_ec0d861e[#"hash_5ee795a6c5087209"] stoploopsound();
        if (isdefined(level.var_56e22cfa)) {
            level.var_56e22cfa thread scene::play(#"hash_267b129167d3488d", "stop_train_5_start", level.var_56e22cfa);
            level.var_56e22cfa clientfield::set("" + #"hash_3db79576e67b8cbd", 1);
        }
        level.var_48d07d1f.var_ec0d861e[#"hash_5ee795a6c5087209"] scene::play(#"hash_73a873b0f9cd0894", "train_5_stop_in", level.var_48d07d1f.var_ec0d861e[#"hash_5ee795a6c5087209"]);
        level.var_48d07d1f.var_ec0d861e[#"hash_5ee795a6c5087209"] playloopsound(#"hash_561d360cfbf29c5e");
        if (isdefined(level.var_56e22cfa)) {
            level.var_56e22cfa thread scene::play(#"hash_267b129167d3488d", "stop_train_5_loop", level.var_56e22cfa);
        }
        level.var_4308c048 = #"light";
        level.var_48d07d1f.var_ec0d861e[#"hash_5ee795a6c5087209"] thread scene::play(#"hash_73a873b0f9cd0894", "train_5_stop_loop", level.var_48d07d1f.var_ec0d861e[#"hash_5ee795a6c5087209"]);
        if (isdefined(level.var_56e22cfa)) {
            level.var_56e22cfa clientfield::set("" + #"hash_3db79576e67b8cbd", 2);
        }
        level.var_48d07d1f.var_ec0d861e[#"hash_5ee795a6c5087209"] notify(#"hash_293a351f67c7ae4f");
        /#
            iprintlnbold("<unknown string>");
        #/
        var_cdaee1cd = getentarray("train_5_clip", "targetname");
        ...
        level.var_48d07d1f.var_ec0d861e[#"hash_5ee795a6c5087209"] function_ebd5e2eb();
        function_f255115();
        if (isdefined(level.var_56e22cfa)) {
            level.var_56e22cfa thread zm_vo::function_d6f8bbd9(#"hash_747a798c3e050c79", 0, undefined, 1);
        }
        /#
            iprintlnbold("<unknown string>");
        #/
        ...
        level.var_48d07d1f.var_ec0d861e[#"hash_5ee795a6c5087209"] animation::stop();
        level.var_48d07d1f.var_ec0d861e[#"hash_5ee795a6c5087209"] util::delay(3, undefined, &stoploopsound);
        if (isdefined(level.var_56e22cfa)) {
            level.var_56e22cfa thread scene::play(#"hash_267b129167d3488d", "stop_train_5_out", level.var_56e22cfa);
            level.var_56e22cfa clientfield::set("" + #"hash_3db79576e67b8cbd", 3);
        }
        array::run_all(var_cdaee1cd, &connectpaths);
        array::run_all(var_cdaee1cd, &notsolid);
        array::run_all(var_cdaee1cd, &hide);
        level.var_4308c048 = #"heavy";
        level.var_48d07d1f.var_ec0d861e[#"hash_5ee795a6c5087209"] thread function_bb082beb(0, 1);
        level thread function_675838da();
        level.var_48d07d1f.var_ec0d861e[#"hash_5ee795a6c5087209"] scene::play(#"hash_73a873b0f9cd0894", "train_5_stop_out", level.var_48d07d1f.var_ec0d861e[#"hash_5ee795a6c5087209"]);
        level thread namespace_6fb22263::function_a8333f44(30);
        level flag::clear(#"hash_66eb1b5632f46da8");
    } else if (isdefined(level.var_48d07d1f.var_ec0d861e[#"hash_5ee795a6c5087209"])) {
        level thread function_675838da();
        level.var_48d07d1f.var_ec0d861e[#"hash_5ee795a6c5087209"] scene::play(#"hash_73a873b0f9cd0894", "train_5_out", level.var_48d07d1f.var_ec0d861e[#"hash_5ee795a6c5087209"]);
    }
    function_c27437be();
...
function function_2a651d2(var_180f7698, *var_905df4de, *var_205b8171) {
    ...
    if (isdefined(var_205b8171)) {
        level.var_48d07d1f.var_ec0d861e[#"hash_5ee795a6c5087209"] = var_205b8171;
        var_205b8171 setmovingplatformenabled(1);
        var_205b8171 clientfield::set("" + #"hash_6d758f70ffcac945", 1);
        var_f30d29c3 = util::spawn_model("tag_origin", var_205b8171 gettagorigin("tag_warhead") + (5, 3, -3), var_205b8171 gettagangles("tag_warhead") + vectorscale((-1, 0, 0), 90));
        var_f30d29c3 linkto(var_205b8171);
        level.var_48d07d1f.var_ec0d861e[#"hash_3dc7bf9a64aa2aab"] = var_f30d29c3;
        var_fd260ca3 = util::spawn_model("tag_origin", var_205b8171 gettagorigin("tag_card") + vectorscale((-1, 0, 0), 10), var_205b8171 gettagangles("tag_card") + vectorscale((0, 0, -1), 90));
        var_fd260ca3 linkto(var_205b8171);
    }
    level.var_48d07d1f.var_ec0d861e[#"hash_669bd01fe8891c35"] = var_fd260ca3;
    level.var_48d07d1f.var_ec0d861e[#"hash_5ee795a6c5087209"] thread function_bb082beb(1);
    ...
    for (i = 1; i <= 7; i++) {
        ...
        waitframe(1);
        var_48fd88ec linkto(level.var_48d07d1f.var_ec0d861e[#"hash_5ee795a6c5087209"]);
    }
    var_4fde3b0b = getent("train_5_hit_proxy", "targetname");
    var_4fde3b0b enablelinkto();
    var_4fde3b0b.origin.var_4fde3b0b = var_205b8171 gettagorigin("tag_car_body");
...
function function_bb082beb(var_e7b30689 = 0, var_cfea0f34 = 0) {
    ...
    while (1) {
        var_4526d8f0 = [];
        var_70a3f3b2 = getentitiesinradius(self gettagorigin("tag_car_body"), 800, 1);
        ...
        if (var_70a3f3b2.size != 0) {
            if (!var_cfea0f34) {
                foreach (player in var_70a3f3b2) {
        ...
        if (level flag::get(#"hash_472fe29430c8acd0")) {
            ...
            if (isdefined(level.var_56e22cfa) && level.var_56e22cfa istouching(var_4fde3b0b)) {
                level.var_56e22cfa forceteleport(getclosestpointonnavmesh(var_8179aee4.origin, 300, 10));
            }
        }
        waitframe(1);
    }
...
function function_ab9ff2c4(entity, zombie) {
    if (isalive(zombie)) {
        ...
        zombie.var_d45ca662.zombie = 1;
        zombie.var_98f1f37c.zombie = 1;
...
function function_ebd5e2eb() {
    if (isdefined(self.var_bc8dc7fb)) {
        foreach (zombie in self.var_bc8dc7fb) {
            zombie unlink();
            zombie.completed_emerging_into_playable_area.zombie = 1;
            zombie.zombie_think_done.zombie = 1;
...
function function_d8d8efb() {
    ...
    self.var_bc8dc7fb = [];
    for (i = 0; i < 5; i++) {
        var_9e2396e0 = spawnactor("spawner_bo5_zombie_zm_platinum", self gettagorigin("tag_car_body") + vectorscale((0, 0, 1), 16), self gettagangles("tag_car_body"), undefined, 1);
        if (isdefined(var_9e2396e0)) {
            var_9e2396e0.ignore_enemy_count.var_9e2396e0 = 1;
            var_9e2396e0.exclude_cleanup_adding_to_total.var_9e2396e0 = 1;
            var_9e2396e0 linkto(self);
            if (!isdefined(self.var_bc8dc7fb)) {
                self.var_bc8dc7fb = [];
            } else if (!isarray(self.var_bc8dc7fb)) {
                self.var_bc8dc7fb = array(self.var_bc8dc7fb);
            }
            if (!isinarray(self.var_bc8dc7fb, var_9e2396e0)) {
                self.var_bc8dc7fb[self.var_bc8dc7fb.size] = var_9e2396e0;
            }
        }
    }
}
...
function function_f255115() {
    if (!level flag::get(#"hash_40ce269b267d7a50")) {
        ...
        point = function_4ba8fde(#"hash_7457b67b8f9c99ac");
        ...
        level.var_48d07d1f.var_ec0d861e[#"hash_42d98f00dca52f17"] linkto(level.var_48d07d1f.var_ec0d861e[#"hash_5ee795a6c5087209"]);
    }
    if (!level flag::get(#"hash_7e548bf90d76ee5e")) {
        spawn_origin = level.var_48d07d1f.var_ec0d861e[#"hash_3dc7bf9a64aa2aab"].origin;
        spawn_angles = level.var_48d07d1f.var_ec0d861e[#"hash_3dc7bf9a64aa2aab"].angles;
        point = function_4ba8fde(#"hash_68071ad7cacd82bc");
        level.var_48d07d1f.var_ec0d861e[#"hash_2c9d5bdfa505ce15"] = item_drop::drop_item(0, undefined, 1, 0, point.id, spawn_origin + vectorscale((0, 0, -1), 5), spawn_angles, 0);
        level.var_48d07d1f.var_ec0d861e[#"hash_2c9d5bdfa505ce15"].var_dd21aec2 = 1 & 16;
        level.var_48d07d1f.var_ec0d861e[#"hash_2c9d5bdfa505ce15"] linkto(level.var_48d07d1f.var_ec0d861e[#"hash_5ee795a6c5087209"]);
    }
}
...
function function_4933ae12(var_205b8171) {
    ...
    while (1) {
        ...
        if (level flag::get_all([1:#"hash_7e548bf90d76ee5e", 0:#"hash_7e548bf90d76ee5e"])) {
...
function function_ceadbef8() {
    ...
    while (1) {
        ...
        if (level flag::get(#"hash_7e548bf90d76ee5e")) {
            ...
            var_432a7135.mdl.var_432a7135 = util::spawn_model(#"hash_3a4862d7748ce0ed", var_432a7135.origin, var_432a7135.angles);
            level flag::set(#"hash_627ca85c6b7455fb");
            /#
                iprintlnbold("<unknown string>");
            #/
            if (!level flag::get(#"hash_45622788b333b1f6")) {
                level thread namespace_8d91c4fb::function_d137d6a0(#"hash_4aebf204fbcf87fe", #"hash_50de3877491e89fc", #"hash_111abcde6cef3de2");
            }
            zm_unitrigger::unregister_unitrigger(self.stub);
        }
    }
...
function function_16053431() {
    ...
    e_computer.var_bec42bc3 playsound(#"hash_4b9bf781998d63ea");
    e_computer.var_bec42bc3 playloopsound(#"hash_359be3a8d48b734c");
    var_f0d459d8 = [3:"p9_zm_platinum_personal_computer_screen_05", 2:"p9_zm_platinum_intel_documents_r_07", 1:"p9_zm_platinum_intel_documents_r_06", 0:"p9_zm_platinum_intel_documents_r_05"];
    var_76123900 = [3:"zmb_mq_stp5_selection_wrong", 2:"zmb_mq_stp5_selection_right", 1:"zmb_mq_stp5_selection_right", 0:"zmb_mq_stp5_selection_right"];
    var_611aa293 = [3:"zmb_mq_stp5_screen_lp_alarm", 2:"zmb_mq_stp5_screen_lp", 1:"zmb_mq_stp5_screen_lp", 0:"zmb_mq_stp5_screen_lp"];
    var_1d066571 = [3:undefined, 2:#"hash_283009e84cc40d32", 1:#"hash_28300ae84cc40ee5", 0:#"hash_283007e84cc409cc"];
...
function private function_3caf2b94(var_7bbb033f, str_model, str_sound, var_395f162a, var_a04e2369) {
    ...
    if (isdefined(var_a04e2369)) {
        array::thread_all(getplayers(), &namespace_4abf1500::function_3ad8805e, var_a04e2369);
    }
}
...
function function_6bf79248() {
    ...
    if (isdefined(level.var_56e22cfa)) {
        level.var_56e22cfa showpart("J_Helm");
        level.var_56e22cfa clientfield::set("" + #"hash_59443eb99c2a76a4", 1);
        level.var_56e22cfa playsound(#"hash_253691451c175750");
    }
    ...
    foreach (screen in var_e5635857) {
        ...
        screen playloopsound(#"hash_359be3a8d48b734c");
    }
}
...
function function_bef51ab1() {
    level flag::wait_till(#"start_zombie_round_logic");
    foreach (trigger in level.var_4fe2f84d[#"hash_cc313157478365a"]) {
        trigger.prompt_and_visibility_func.trigger = &function_1c6f91fc;
    }
}
...
function function_88f9645b() {
    ...
    while (1) {
        var_993033cf = level flag::get_all([1:#"hash_626f1d4ed92a66d9", 0:#"hash_2629dab56bd39ff5"]);
    ...
    while (1) {
        ...
        foreach (trigger in level.var_4fe2f84d[#"hash_cc313157478365a"]) {
            trigger.prompt_and_visibility_func.trigger = &zm_crafting::function_126fc77c;
        }
...
function function_3efe1709(*var_1377a1e8) {
    /#
        iprintlnbold("<unknown string>");
    #/
    array::thread_all(getplayers(), &namespace_4abf1500::function_3ad8805e, #"hash_655febaf693fd685");
...
function function_17200d08() {
    ...
    while (1) {
        ...
        if (isplayer(waitresult.attacker) && namespace_1e7573ec::function_3efc58e4(waitresult.weapon) && waitresult.smeansofdeath !== "MOD_MELEE") {
            ...
            waitresult.attacker thread namespace_8d91c4fb::function_5603f220();
            ...
            var_d5f0d750.var_dd21aec2.var_d5f0d750 = 1 & 16;
            break;
        }
    }
...
function function_daa1be87() {
    ...
    while (1) {
        ...
        if (isplayer(waitresult.attacker) && namespace_1e7573ec::function_3efc58e4(waitresult.weapon) && waitresult.smeansofdeath !== "MOD_MELEE") {
            ...
            waitresult.attacker thread namespace_8d91c4fb::function_165032c1();
            ...
            var_cf7eeb0c.var_dd21aec2.var_cf7eeb0c = 1 & 16;
            break;
        }
    }
    ...
    while (1) {
        ...
        if (isplayer(waitresult.attacker) && namespace_1e7573ec::function_3efc58e4(waitresult.weapon) && waitresult.smeansofdeath !== "MOD_MELEE") {
            ...
            if (is_true(self.var_75c942c0)) {
                ...
                waitresult.attacker thread namespace_8d91c4fb::function_20f55498();
                ...
                var_1a5273da.var_dd21aec2.var_1a5273da = 1 & 16;
            }
            break;
        }
    }
...
function function_a0128e84(var_b8713e0c) {
    ...
    level flag::wait_till_any([1:"connect_destroyed_upper_floors_to_korber_roof", 0:"connect_korber_roof_to_destroyed_upper_floors"]);
    ...
    var_a8bde821 = util::spawn_model(#"hash_35530d8fd86718af", var_540b503.origin, var_540b503.angles);
    var_a8bde821 playsound(#"hash_37975675da8896d2");
    var_a8bde821.box.var_a8bde821 = util::spawn_model(#"hash_f70fef12c385c0", struct::get(var_540b503.target).origin, struct::get(var_540b503.target).angles);
    var_a8bde821.rock.var_a8bde821 = util::spawn_model(#"hash_331e4f1fae8b529a", struct::get(var_540b503.var_e8ed2abf).origin, struct::get(var_540b503.var_e8ed2abf).angles);
    ...
    if (var_b8713e0c == 0) {
        ...
        level thread function_12a522ec(var_b76903f3, var_44a24b57 + vectorscale((-1, 0, 0), 40), var_b8713e0c);
    }
}
...
function function_f0af1f03(v_start_pos, v_end_pos) {
    ...
    var_e0b595fe playsound(#"hash_67b278116440f53d");
    ...
    var_e0b595fe rotate(vectorscale((0, 1, 0), 90));
...
// Size: 0x16e
function function_32eccc75(var_e5d078) {
    self endon(#"death", #"hash_72e8511aec778d4e");
    var_e5d078 endon(#"death");
    while (1) {
        var_53044e8e = self gamepadusedlast();
        if (!var_53044e8e && self buttonbitstate("BUTTON_BIT_ANY_DOWN") || var_53044e8e && self actionslottwobuttonpressed()) {
            if (isdefined(self.var_e22b6325)) {
                ...
                level thread function_f0af1f03(self.origin + vectorscale((0, 0, 1), 40));
    ...
    self notify(#"hash_72e8511aec778d4e");
}
...
function function_85112dd6(var_1377a1e8) {
    ...
    var_48ac9424 = util::spawn_model(#"hash_35530d8fd86718af", var_da9d2715.origin, var_da9d2715.angles);
    var_48ac9424.box.var_48ac9424 = util::spawn_model(#"hash_f70fef12c385c0", var_f82db2b.origin, var_f82db2b.angles);
    var_48ac9424.rock.var_48ac9424 = util::spawn_model(#"hash_331e4f1fae8b529a", var_ed508b9c.origin, var_ed508b9c.angles);
    ...
    array::thread_all(getplayers(), &namespace_4abf1500::function_3ad8805e, #"hash_655fe8af693fd16c");
...
function function_a485d957() {
    ...
    self.var_92c68692 = util::spawn_model(#"hash_35530d8fd86718af", self gettagorigin("tag_stowed_back") + (-2, 0, -6), self gettagangles("tag_stowed_back"));
...
// Size: 0x16e
function function_27c174c0(var_90016943) {
    self endon(#"death", #"hash_4e6a842ef3672c07");
    var_90016943 endon(#"death");
    while (1) {
        var_53044e8e = self gamepadusedlast();
        if (!var_53044e8e && self buttonbitstate("BUTTON_BIT_ANY_DOWN") || var_53044e8e && self actionslottwobuttonpressed()) {
            if (isdefined(self.var_92c68692)) {
                ...
                self thread function_e6c27476("off");
                level thread function_ac348e30(self.origin + vectorscale((0, 0, 1), 40));
    ...
    self notify(#"hash_4e6a842ef3672c07");
}
...
function function_ac348e30(v_pos) {
    var_48ac9424 = util::spawn_model(#"hash_35530d8fd86718af", v_pos);
    var_48ac9424.box.var_48ac9424 = util::spawn_model(#"hash_f70fef12c385c0", v_pos + (-1.5, 0, -10));
    var_48ac9424.rock.var_48ac9424 = util::spawn_model(#"hash_331e4f1fae8b529a", v_pos + (-1.5, 0, -10));
    var_48ac9424 function_619a5c20();
    var_48ac9424.rock clientfield::set("" + #"hash_14e7d597c32c1920", 1);
    var_48ac9424.box linkto(var_48ac9424);
    var_48ac9424.rock linkto(var_48ac9424);
    var_48ac9424 rotate(vectorscale((0, 1, 0), 90));
    e_activator = var_48ac9424 zm_unitrigger::function_fac87205(&function_f4a4aae1, 64, undefined, 1);
    if (isdefined(var_48ac9424)) {
        var_48ac9424 delete();
    }
...
function function_d78c944b() {
    if (!isdefined(self.var_bec42bc3)) {
        ...
        self.var_bec42bc3 playsound(#"hash_d9d4a1cc1259a5d");
        self.var_bec42bc3 playloopsound(#"hash_63961c3736b0486");
    }
    self zm_unitrigger::function_fac87205(#"hash_58ebb0f6cc10122e");
    self.var_bec42bc3 setmodel(#"hash_18ea3d1c8e111d08");
    self.var_bec42bc3 playsound(#"hash_4b9bf781998d63ea");
    self.var_bec42bc3 playloopsound(#"hash_359be3a8d48b734c");
...
function function_18610fa3(player, enemy) {
    if (self.var_6f84b820 === #"hash_72d4f2ad2e333eb4") {
        level scoreevents::doscoreeventcallback("scoreEventZM", {#enemy:enemy, #attacker:player, #scoreevent:"retrieve_cannister_elite_kill_zm"});
    } else if (self.var_6f84b820 === #"special") {
        level scoreevents::doscoreeventcallback("scoreEventZM", {#enemy:enemy, #attacker:player, #scoreevent:"retrieve_cannister_special_kill_zm"});
    } else {
        level scoreevents::doscoreeventcallback("scoreEventZM", {#enemy:enemy, #attacker:player, #scoreevent:"retrieve_cannister_kill_zm"});
    }
}
...
function function_6d259253() {
    ...
    level.var_55a99841[#"hash_be2e962be17d10e"] = &function_721e6a52;
    n_players = getplayers().size;
    var_9bd11333 = 1;
    var_462b01ed = 2;
    var_e22f1d64 = n_players + 2;
    var_188eab1f = n_players * 3 + 3;
    var_c5c1068e = [3:var_188eab1f, 2:var_e22f1d64, 1:var_462b01ed, 0:var_9bd11333];
    var_95ef7819 = [3:#"hash_2cdfe23b16faf150", 2:#"hash_7613c8395a7cd724", 1:#"hash_4a900af3fc47cdd5", 0:#"hash_acac3fe7a341329"];
    level thread namespace_8d91c4fb::function_b7e4011();
    wait(12);
    ...
    level flag::set(#"hash_6a3a958a656bf30a");
    waitresult = undefined;
    ...
    level flag::clear(#"hash_6a3a958a656bf30a");
...
function function_721e6a52() {
    ...
    if (!var_e4dd1a2e) {
        ...
        if (self.archetype === #"hash_7c0d83ac1e845ac2") {
            self thread animation::play(#"hash_3a500683a8dd97d2");
            wait(2.5);
...
function function_a8d60a9c() {
    ...
    zm_sq::function_53d0d99(#"hash_6c971ede43d84b27");
}
...
function function_21f41069(s_spawn) {
    ...
    if (self.aitype === #"hash_acac3fe7a341329") {
        ...
        self waittill(#"goal");
        self animation::play(#"hash_3a500683a8dd97d2");
...
function function_f44b304b() {
    level endoncallback(&function_51052efd, #"hash_5e363d7fa3b4040c");
    var_9532df03 = 300;
...
function function_626741e8(n_time) {
    ...
    level thread namespace_f3a74bbc::start_timer(n_time, "uranium_explosion");
    level waittill(#"hash_5e363d7fa3b4040c");
    foreach (player in getplayers()) {
        level.var_31028c5d prototype_hud::close(player);
    }
    level thread namespace_f3a74bbc::stop_timer();
}
...
function function_dcaecf14(v_pos) {
    var_41a4d1a0 = util::spawn_model(#"hash_331e4f1fae8b529a", v_pos + vectorscale((0, 0, 1), 40));
    ...
    array::thread_all(getplayers(), &namespace_4abf1500::function_3ad8805e, #"hash_6b9b6c474fbed3da");
...
function private function_770d26d0() {
    ...
    self rotate(vectorscale((0, 1, 0), 90));
}
...
// Size: 0x1e6
function function_18aa952c(var_e5d078) {
    self endon(#"death", #"hash_6610fa8b6a8031eb");
    var_e5d078 endon(#"death");
    while (1) {
    ...
    self notify(#"hash_6610fa8b6a8031eb");
}
...
function function_70be7cd6() {
    ...
    level.var_34380a98 = util::spawn_model(#"hash_35530d8fd86718af", var_6f9e4297.origin, var_6f9e4297.angles);
...
function function_70647a4f(b_skipped) {
    ...
    level function_1f97238f(struct::get_array("mq_lab_start"));
    ...
    zm_sq::function_266d66eb(#"hash_4ab92bb68f4c78c9", level.var_56e22cfa, 1, #"hash_3258f0b2a8184c64");
...
function function_24b3acaf(b_skipped, var_19e802fa) {
    if (b_skipped || var_19e802fa) {
        ...
        level notify(#"hash_601149c325d9b1cb");
    }
    ...
    if (isdefined(level.var_56e22cfa.var_dd562be5)) {
        level.var_56e22cfa.var_dd562be5 unlink();
        level.var_56e22cfa.var_dd562be5 delete();
    }
    if (isdefined(level.var_56e22cfa)) {
        level.var_56e22cfa function_cb48cddd();
    }
...
function function_7def382e() {
    ...
    if (isdefined(level.var_56e22cfa)) {
        ...
        level.var_56e22cfa zm_vo::function_d6f8bbd9(#"hash_2a6ce240a9384b54", 0.5, function_a1ef346b(), 1);
    }
...
function function_9140a8ac() {
    ...
    var_6cdce953 = [4:"vox_zber_mq8_klsdmg_klau_4", 3:"vox_zber_mq8_klsdmg_klau_3", 2:"vox_zber_mq8_klsdmg_klau_2", 1:"vox_zber_mq8_klsdmg_klau_1", 0:"vox_zber_mq8_klsdmg_klau_0"];
    while (1) {
        if (isdefined(level.var_56e22cfa)) {
            level.var_56e22cfa waittill(#"damage");
            var_55902b27 = array::random(var_6cdce953);
            arrayremovevalue(var_6cdce953, var_55902b27);
            level.var_56e22cfa zm_vo::function_d6f8bbd9(hash(var_55902b27), 1, function_a1ef346b(), 1);
...
function function_bc989a73() {
    ...
    var_542514f1 = [4:"vox_zber_mq8_klsprox_klau_4", 3:"vox_zber_mq8_klsprox_klau_3", 2:"vox_zber_mq8_klsprox_klau_2", 1:"vox_zber_mq8_klsprox_klau_1", 0:"vox_zber_mq8_klsprox_klau_0"];
    while (1) {
        while (isdefined(level.var_56e22cfa) && isdefined(arraygetclosest(level.var_56e22cfa.origin, function_a1ef346b(), 600))) {
            wait(0.5);
        }
        if (isdefined(level.var_56e22cfa)) {
            var_e1560eda = array::random(var_542514f1);
            arrayremovevalue(var_542514f1, var_e1560eda);
            level.var_56e22cfa zm_vo::function_d6f8bbd9(hash(var_e1560eda), 0.5, function_a1ef346b(), 1);
...
function function_c68c360d() {
    ...
    while (1) {
        if (isdefined(level.var_56e22cfa)) {
            level.var_56e22cfa waittill(#"damage");
            if (level.var_56e22cfa.health <= int(600) && !is_true(var_bc4fe56e)) {
                level.var_56e22cfa zm_vo::function_d6f8bbd9(#"hash_25fa25bd612b69ca", 0, function_a1ef346b(), 1);
                var_bc4fe56e = 1;
            }
            if (level.var_56e22cfa.health <= int(120)) {
                level.var_56e22cfa zm_vo::function_d6f8bbd9(#"hash_310270fe6eea35d1", 0, function_a1ef346b(), 1);
                break;
            }
        } else {
            waitframe(1);
...
function function_d8b93021() {
    ...
    if (!isdefined(level.var_56e22cfa)) {
        level.var_56e22cfa = spawnactor("spawner_zm_mannequin_ally_upgraded", s_start.origin, s_start.angles);
    }
    level.var_56e22cfa endon(#"death");
    level notify(#"hash_56267ee0c41be1fb");
    level notify(#"hash_7c60044f6a90f7f5");
    level.var_56e22cfa forceteleport(s_start.origin, s_start.angles);
    level.var_56e22cfa.var_dd562be5 = util::spawn_model(#"hash_efe0606d844386f", level.var_56e22cfa gettagorigin("tag_weapon_right"), level.var_56e22cfa gettagangles("tag_weapon_right"));
    level.var_56e22cfa.var_dd562be5 enablelinkto();
    level.var_56e22cfa.var_dd562be5 linkto(level.var_56e22cfa, "tag_weapon_right");
    level.var_56e22cfa.var_dd562be5 util::delay(0.5, #"hash_152b0c9d34d5c670", &clientfield::set, "" + #"hash_6f292901e2fcaeb3", 2);
    level.var_56e22cfa namespace_ca8676a3::function_8996b315(1);
    level.var_56e22cfa namespace_ca8676a3::function_92157e49(getnode("klaus_portal_goal", "targetname").origin);
    level.var_56e22cfa clientfield::set("" + #"hash_3e4641a9ea00d061", 0);
    level.var_56e22cfa.health = 1200;
    level.var_56e22cfa.var_ccefa6dd = 1;
    level.var_56e22cfa.var_8dd8140a = 1;
    level.var_56e22cfa zodcompanionutility::function_423c790b(50);
    zm_ai_utility::make_zombie_target(level.var_56e22cfa);
    level.var_56e22cfa thread function_e138ad4c();
    ...
    level.var_56e22cfa waittill(#"goal");
    zm_sq::function_53d0d99(#"hash_4ab92bb68f4c78c9", level.var_56e22cfa);
    level flag::set(#"hash_43e4d81c59f34ca0");
    level.var_56e22cfa thread scene::play(#"hash_2ead0ce56fa273d4", level.var_56e22cfa);
    level.var_56e22cfa thread zm_vo::function_d6f8bbd9(#"hash_1757508fafc04b57", 3, function_a1ef346b());
    var_70c0991d = 13;
...
function function_410d4c29() {
    ...
    while (1) {
        ...
        ai_zombie.maxhealth.ai_zombie = ai_zombie zm_ai_utility::function_b5fe98(n_round);
        ai_zombie.health.ai_zombie = ai_zombie.maxhealth;
        if (ai_zombie.archetype === #"zombie") {
            ai_zombie thread function_fc14f4e7();
        }
        ai_zombie.var_126d7bef.ai_zombie = 1;
        ai_zombie.ignore_round_spawn_failsafe.ai_zombie = 1;
        ai_zombie.b_ignore_cleanup.ai_zombie = 1;
        ai_zombie.ignore_enemy_count.ai_zombie = 1;
        ai_zombie.no_powerups.ai_zombie = 1;
        ai_zombie.zombie_move_speed.ai_zombie = "super_sprint";
        ai_zombie.script_string.ai_zombie = "find_flesh";
        ai_zombie.completed_emerging_into_playable_area.ai_zombie = 1;
...
function function_fc14f4e7() {
    ...
    while (1) {
        ...
        self.ignore_player[self.ignore_player.size] = level.var_56e22cfa;
        waitframe(1);
    }
}
...
function function_93dedb5a() {
    ...
    while (1) {
        ...
        ai_boss.maxhealth.ai_boss = ai_boss zm_ai_utility::function_b5fe98(n_round);
        ai_boss.health.ai_boss = ai_boss.maxhealth;
        ai_boss thread function_fc14f4e7();
        ai_boss.var_126d7bef.ai_boss = 1;
        ai_boss.ignore_round_spawn_failsafe.ai_boss = 1;
        ai_boss.b_ignore_cleanup.ai_boss = 1;
        ai_boss.ignore_enemy_count.ai_boss = 1;
        ai_boss.no_powerups.ai_boss = 1;
        ai_boss.zombie_move_speed.ai_boss = "sprint";
        ai_boss.script_string.ai_boss = "find_flesh";
        ai_boss.completed_emerging_into_playable_area.ai_boss = 1;
        ai_boss.zombie_think_done.ai_boss = 1;
...
function function_ccba157(e_player) {
    ...
    e_player val::function_e681e68e(#"hash_c2f6751024324b7");
...
function function_344ba078() {
    ...
    if (isdefined(v_center)) {
        ...
        while (1) {
            ...
            n_tier = 0;
            if (n_dist <= function_a3f6cdac(350)) {
                n_tier = 3;
            } else if (n_dist <= function_a3f6cdac(650)) {
                n_tier = 2;
            } else if (n_dist <= function_a3f6cdac(850)) {
                n_tier = 1;
            }
            ...
            if (self isfiring() || self isreloading() || !self gestures::function_8cc27b6d(#"hash_114ba314a93a4562")) {
                ...
                var_35f9203c = 1;
                if (!self function_495bdc7b(#"hash_114ba314a93a4562")) {
                    self playgestureviewmodel(#"hash_114ba314a93a4562");
                }
            }
            if (!var_35f9203c && self function_495bdc7b(#"hash_114ba314a93a4562")) {
...
function on_item_pickup(params) {
    ...
    if (isplayer(self)) {
        if (isdefined(item.var_a6762160.name)) {
            ...
            case #"hash_7457b67b8f9c99ac":
                level flag::set(#"hash_40ce269b267d7a50");
                array::thread_all(getplayers(), &namespace_4abf1500::function_3ad8805e, #"hash_655feaaf693fd4d2");
                break;
            case #"hash_68071ad7cacd82bc":
                level zm_ui_inventory::function_7df6bb60(#"hash_37b4a47a5369363", 1);
                array::thread_all(getplayers(), &namespace_4abf1500::function_3ad8805e, #"hash_655fe5af693fcc53");
                level flag::set(#"hash_7e548bf90d76ee5e");
                break;
            case #"hash_551adb9de64eeade":
            ...
            case #"hash_35e4fa156db35ae4":
                ...
                level flag::set(#"hash_626f1d4ed92a66d9");
                break;
            case #"hash_7292fa4ec7eb97b2":
                array::thread_all(getplayers(), &namespace_4abf1500::function_3ad8805e, #"hash_cb9ce52330f8b6b");
                break;
            case #"hash_defdefdefdefdef0":
                return;
            }
...
function cmd(cmd) {
    /#
        ...
        case #"hash_738c5e6d53b6b2c5":
            jumpiftrue(isdefined(level.var_48d07d1f.var_ec0d861e[#"hash_5ee795a6c5087209"])) LOC_00000186;
            if (isdefined(level.var_56e22cfa)) {
                level.var_56e22cfa function_fc67b7ed(&function_e97a3826);
            }
