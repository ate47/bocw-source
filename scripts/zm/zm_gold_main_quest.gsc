...
function function_be0bcb78() {
    ...
    if (self zm_stats::get_map_stat(#"main_quest_completed") && !self zm_stats::function_376778d3(#"zmintel_gold_darkaether_artifact_1")) {
        self thread namespace_4abf1500::function_3ad8805e(#"zmintel_gold_darkaether_artifact_1");
    }
}
...
function function_e12506e5() {
    ...
    foreach (var_59481abd in level.var_8986480a) {
        var_59481abd.var_fedd4688.var_59481abd = getent(var_59481abd.target, "targetname");
        var_59481abd.var_f429251e.var_59481abd = getent(var_59481abd.targetname, "script_noteworthy");
        var_59481abd.var_f429251e clientfield::set("" + #"hash_4e18b4bbb52e74bb", 2);
    }
}
...
function function_bd9ebda() {
    ...
    if (isdefined(self)) {
        ...
        var_d9c4a4a7 = struct::get(self.var_f429251e.target, "targetname");
        self.var_9ca67c82 = util::spawn_model(#"hash_59568dab0af5e9db", var_d9c4a4a7.origin, var_d9c4a4a7.angles);
        self.var_9ca67c82 moveto(self.var_9ca67c82.origin + vectorscale((0, 0, -1), 18), 0.4, 0.1, 0.1);
        self.var_9ca67c82 playsound(#"hash_29005ff29a7ee6e6");
        self.var_9ca67c82 waittill(#"movedone");
        self.var_9ca67c82 delete();
        self.var_f429251e clientfield::set("" + #"hash_4e18b4bbb52e74bb", 1);
        wait(1);
        ...
        var_854fb47e.var_dd21aec2.var_854fb47e = 1 & 16;
    }
}
...
function function_9a978ce6() {
    ...
    if (isdefined(var_1e019b9b)) {
        ...
        var_32ec11a3.var_dd21aec2.var_32ec11a3 = 1 & 16;
...
function private function_2d9a6efe() {
    ...
    var_a9b4d006.var_dd21aec2.var_a9b4d006 = 1 & 16;
}
...
function function_b509640() {
    ...
    var_580d9e4f.var_b555f02e.var_580d9e4f = var_f09453ec.script_int;
    level childthread function_b8091725(var_f09453ec);
...
function function_b21632bf(var_7961a37e) {
    ...
    while (1) {
        ...
        var_c511e32c.var_dd21aec2.var_c511e32c = 1 & 16;
...
// Size: 0x19c
function function_aa3414cb(var_9b6351d9, var_753342a3, str_zone_name) {
    level endon(#"end_game", #"hash_b60b8708c801044");
    while (zm_zonemgr::get_players_in_zone(str_zone_name) !== 0) {
        waitframe(1);
    }
    var_b6246671 = array::random(var_9b6351d9);
...
function function_9e39dad3(var_b555f02e) {
    ...
    case 2:
        ...
        var_d19e0f1f.var_78530c1a.var_d19e0f1f = util::spawn_model(#"hash_2d2920b192056678", var_d19e0f1f.origin, var_d19e0f1f.angles);
        var_d19e0f1f.var_78530c1a linkto(var_d19e0f1f);
        var_d19e0f1f.var_82c6c1b8.var_d19e0f1f = util::spawn_model(#"hash_565777717feba8e8", var_d19e0f1f.origin, var_d19e0f1f.angles);
        var_d19e0f1f.var_82c6c1b8 linkto(var_d19e0f1f);
        break;
    case 3:
        var_f09453ec = getent("mdl_mts", "targetname");
        var_f09453ec thread scene::play(#"hash_3d5b1ffba2bf0b8d", "play", var_f09453ec);
        var_f09453ec.var_78530c1a.var_f09453ec = util::spawn_model(#"hash_2d2923b192056b91", var_f09453ec.origin, var_f09453ec.angles);
        var_f09453ec.var_78530c1a linkto(var_f09453ec);
        var_f09453ec.var_82c6c1b8.var_f09453ec = util::spawn_model(#"hash_51c576bf73f00a45", var_f09453ec.origin, var_f09453ec.angles);
        var_f09453ec.var_82c6c1b8 linkto(var_f09453ec);
...
function function_1621782d(var_b555f02e) {
    ...
    case 2:
        ...
        if (isdefined(var_d19e0f1f.var_82c6c1b8)) {
            var_d19e0f1f.var_82c6c1b8 delete();
        }
        break;
    case 3:
        var_f09453ec = getent("mdl_mts", "targetname");
        ...
        if (isdefined(var_f09453ec.var_82c6c1b8)) {
            var_f09453ec.var_82c6c1b8 delete();
        }
        var_535d61f8 = getent("retinal_scan", "targetname");
...
function function_35e13260() {
    ...
    var_580d9e4f.var_b555f02e.var_580d9e4f = var_d19e0f1f.script_int;
...
function function_de84b08d() {
    ...
    foreach (var_c90ca64 in level.var_5868e205) {
        var_c90ca64.mdl.var_c90ca64 = var_c90ca64 util::spawn_model(#"hash_42841f448127f000", var_c90ca64.origin, var_c90ca64.angles);
        var_c90ca64.var_cdeb4ee4.var_c90ca64 = var_c90ca64 util::spawn_model("tag_origin", var_c90ca64.origin, var_c90ca64.angles);
    }
}
...
function function_86a23fd4(b_skipped, var_19e802fa) {
    ...
    array::thread_all(getplayers(), &namespace_4abf1500::function_3ad8805e, #"zmintel_gold_omega_artifact_5");
...
function function_a8df5533() {
    ...
    var_3aea9b8d.var_dd21aec2.var_3aea9b8d = 1 & 16;
}
    ...
    if (isplayer(self)) {
        if (isdefined(item.var_a6762160.name)) {
            ...
            case #"item_zmintel_gold_omega_artifact_5":
                ...
                array::thread_all(function_a1ef346b(), &namespace_4abf1500::function_3ad8805e, #"zmintel_gold_omega_artifact_5");
                level notify(#"hash_5e6fc756a650e960");
                break;
            case #"item_zmintel_gold_omega_artifact_2":
                array::thread_all(function_a1ef346b(), &namespace_4abf1500::function_3ad8805e, #"zmintel_gold_omega_artifact_2");
                level flag::set(#"accesscard_picked_up");
            ...
            case #"item_zmintel_gold_omega_artifact_3":
                ...
                array::thread_all(function_a1ef346b(), &namespace_4abf1500::function_3ad8805e, #"zmintel_gold_omega_artifact_3");
            ...
            case #"item_zmintel_gold_omega_artifact_4":
                self namespace_4abf1500::function_3ad8805e(#"zmintel_gold_omega_artifact_4");
                break;
...
function function_3a3ca419() {
    ...
    if (!isdefined(var_d2ee34ea.mdl)) {
        var_d2ee34ea.mdl.var_d2ee34ea = var_d2ee34ea util::spawn_model(#"hash_42841f448127f000", var_d2ee34ea.origin, var_d2ee34ea.angles);
    }
    ...
    s_trigger.origin.s_trigger = s_trigger.origin + vectorscale((0, 0, 1), 30);
    ...
    if (!isarray(var_d2ee34ea)) {
        ...
        for (i = 0; i < 20; i++) {
            if (!var_4cfcaaf5) {
                ...
                spawn_pos[i].var_cdeb4ee4 clientfield::set("" + #"hash_5db889fa88fbbe02", 2);
                ...
                spawn_pos[i].var_cdeb4ee4 clientfield::set("" + #"hash_5db889fa88fbbe02", 3);
                if (!isdefined(level.var_852bdce8)) {
                    level.var_852bdce8 = [];
                } else if (!isarray(level.var_852bdce8)) {
                    level.var_852bdce8 = array(level.var_852bdce8);
            ...
            s_unitrigger.spawn_pos.s_unitrigger = spawn_pos[i];
            spawn_pos[i].s_unitrigger = s_unitrigger;
        }
    }
    if (level.var_54f26c14 >= 2 && !var_d2ee34ea flag::get(#"hash_34e53728fe25b1e0")) {
        var_d2ee34ea flag::set(#"hash_34e53728fe25b1e0");
        wait(2);
...
function function_eca49808(model) {
    ...
    if (!isdefined(self.var_cdeb4ee4)) {
        self.var_cdeb4ee4 = self util::spawn_model("tag_origin", self.origin, self.angles);
    }
    self.var_cdeb4ee4 clientfield::increment("" + #"hash_a3ff7de846a027f", 1);
    self.mdl solid();
...
// Size: 0x45c
function function_d4ec7e31(var_cb64b46b) {
    if (is_true(var_cb64b46b.mdl.var_551e7e80)) {
        playsoundatposition(#"hash_580d07205ee4fd96", var_cb64b46b.mdl.origin);
        ...
        arrayremovevalue(level.var_852bdce8, var_cb64b46b);
        ...
        foreach (var_27495858 in level.var_f77e46b7) {
            ...
            if (is_true(var_27495858.mdl.var_aa3c8a94)) {
                ...
                if (isdefined(var_aff5d50e)) {
                    ...
                    var_aff5d50e.var_7a5e475.var_aff5d50e = 0;
...
function function_ffb5a78a() {
    ...
    if (isdefined(self.stub.spawn_pos.mdl)) {
        ...
        array::thread_all(getplayers(), &namespace_4abf1500::function_3ad8805e, #"zmintel_gold_darkaether_artifact_1");
        level.var_28c80220++;
    ...
    while (1) {
        ...
        if (level flag::get(#"hash_102797babb455461")) {
            if (self.stub.spawn_pos.script_noteworthy === "zone_armory") {
                ...
                player function_bc82f900(#"zm_gold_interact_rumble_small");
                zm_unitrigger::unregister_unitrigger(self.stub);
            } else if (self.stub.spawn_pos.script_noteworthy === "zone_tents") {
...
// Size: 0x474
function function_6b76cd80(var_cb64b46b) {
    var_cb64b46b.var_4a5787c9.var_cb64b46b = 1;
    if (!var_cb64b46b flag::get(#"hash_4edaa9e538a35497")) {
        level flag::set(#"hash_793eafdc24e3f0eb");
        arrayremovevalue(level.var_852bdce8, var_cb64b46b);
        if (!var_cb64b46b flag::get(#"hash_478be680bb087e19")) {
            var_cb64b46b flag::set(#"hash_478be680bb087e19");
            var_cb64b46b.mdl.var_cb64b46b = var_cb64b46b util::spawn_model(#"hash_42841f448127f000", var_cb64b46b.origin, var_cb64b46b.angles);
            var_cb64b46b.mdl clientfield::set("" + #"hash_5db889fa88fbbe02", 4);
            var_cb64b46b.mdl moveto(var_cb64b46b.origin + vectorscale((0, 0, 1), 30), 1);
            playsoundatposition(#"hash_2eb7e53bbef32adf", var_cb64b46b.origin + vectorscale((0, 0, 1), 30));
            ...
            var_cb64b46b.mdl waittill(#"movedone");
            wait(1);
        ...
        var_cb64b46b.mdl clientfield::set("" + #"hash_3ee70ebc06c36969", 1);
        wait(1);
        level thread function_df33ac59(var_cb64b46b);
    } else {
        zm_unitrigger::unregister_unitrigger(var_cb64b46b.s_unitrigger);
        ...
        level.var_28c80220++;
        arrayremovevalue(level.var_852bdce8, var_cb64b46b);
        playsoundatposition(#"hash_580d07205ee4fd96", var_cb64b46b.mdl.origin + vectorscale((0, 0, 1), 10));
        var_cb64b46b.mdl clientfield::set("" + #"hash_5db889fa88fbbe02", 0);
        var_cb64b46b.mdl ghost();
        var_cb64b46b.mdl thread util::delayed_delete(1);
    }
}
...
// Size: 0x5fa
function function_df33ac59(var_cb64b46b) {
    level endon(#"end_game");
    ...
    var_18ceba08.v_center.var_18ceba08 = var_cb64b46b.origin;
    var_18ceba08.var_ee657f9b.var_18ceba08 = 512;
    ...
    var_cb64b46b.mdl clientfield::set("" + #"hash_3ee70ebc06c36969", 0);
    if (!isdefined(level.var_852bdce8)) {
        level.var_852bdce8 = [];
    } else if (!isarray(level.var_852bdce8)) {
        level.var_852bdce8 = array(level.var_852bdce8);
    }
    if (!isinarray(level.var_852bdce8, var_cb64b46b)) {
        level.var_852bdce8[level.var_852bdce8.size] = var_cb64b46b;
    }
    if (var_18ceba08 flag::get(#"success")) {
        var_cb64b46b flag::set(#"hash_4edaa9e538a35497");
        var_cb64b46b.var_4a5787c9.var_cb64b46b = 0;
    } else {
        var_cb64b46b.mdl clientfield::set("" + #"hash_6ab08e0e1cffcd35", 1);
        level thread function_f36d9845(var_cb64b46b);
        level waittill(#"end_of_round");
        var_cb64b46b.mdl clientfield::set("" + #"hash_6ab08e0e1cffcd35", 0);
        var_cb64b46b notify(#"hash_13939f4d75e88028");
        var_cb64b46b.var_4a5787c9.var_cb64b46b = 0;
    }
}
...
function function_92f65927() {
    ...
    while (1) {
        ...
        if (n_dist <= function_a3f6cdac(2048) && n_dist > function_a3f6cdac(var_18ceba08.var_ee657f9b)) {
...
function function_8365add8(b_skipped) {
    ...
    zm_sq::function_266d66eb(#"hash_70910dcf03846864", var_1f5391d1);
    n_time = 0;
    while (1) {
        a_players = function_a1ef346b();
        var_e8178f0 = 0;
    ...
    zm_sq::function_53d0d99(#"hash_70910dcf03846864", var_1f5391d1);
...
function function_32fba4cd(b_skipped) {
    ...
    /#
        assert(isdefined(level.var_d4dd64b9.group));
    #/
    level clientfield::set("" + #"hash_5c8a1cf9b543c223", level.var_d4dd64b9.group);
...
function function_ee77f553(s_target) {
    ...
    if (!isdefined(satellite_base.fx_tag)) {
        satellite_base.fx_tag.satellite_base = util::spawn_model("tag_origin", var_d2cdcff4.origin, var_d2cdcff4.angles);
    }
    ...
    satellite_base.fx_tag linkto(var_24bedbb);
    var_7b7eb047 = var_24bedbb.angles[1];
    var_7b7eb047 = var_7b7eb047 < 0 ? var_7b7eb047 : var_7b7eb047 + 360;
    var_7b7eb047 = abs(var_7b7eb047 - var_d9080f61);
    var_7b7eb047 = var_7b7eb047 < 180 ? 360 - var_7b7eb047 : var_7b7eb047;
    time = var_7b7eb047 / 5;
    /#
        iprintlnbold(time);
    #/
...
function function_40d9cf7a(current_point, var_3751e731, var_9d16fce2 = 0, var_737cf3ae = undefined) {
    if (!isdefined(current_point)) {
        ...
        while (1) {
            var_a483a577 = array::random(var_3751e731);
            if (var_9d16fce2) {
                if (current_point != var_a483a577 && var_a483a577.var_269ad176 === 1) {
                    current_point = var_a483a577;
                    break;
                }
            } else if (current_point != var_a483a577) {
                dis = distance(current_point.origin, var_a483a577.origin);
...
function function_51001a7b() {
    foreach (control_point in level.var_ef84ff45) {
        zm_sq::function_53d0d99(#"hash_68f4e9062d28524d", control_point);
    }
    level.var_ef84ff45 = [];
}
...
function function_aba92bd4(b_skipped, var_19e802fa) {
    ...
    var_1c8e649 = struct::get("s_tp_console");
    zm_sq::function_53d0d99(#"hash_4acae0c2f9e8da3d", var_1c8e649);
...
function function_c5a09ae3(var_18ceba08) {
    ...
    level.var_b089f503 = level.var_b089f503 + var_2eb22136;
    i = 0;
    while (i < var_2eb22136) {
        s_pos = array::random(a_s_pts);
        if (isdefined(s_pos)) {
...
function function_a8a17d5d() {
    /#
        ...
        var_d2cdcff4 = get("<unknown string>", "<unknown string>");
        if (!isdefined(satellite_base.fx_tag)) {
            satellite_base.fx_tag.satellite_base = spawn_model("<unknown string>", var_d2cdcff4.origin, var_d2cdcff4.angles);
        }
        satellite_base.fx_tag set("<unknown string>" + #"hash_6f292901e2fcaeb3", 0);
        wait(1);
        satellite_base.fx_tag set("<unknown string>" + #"hash_6f292901e2fcaeb3", 1);
    #/
}
