...
// Namespace tkdn_af_chase/cp_takedown_af_chase
// Params 1, eflags: 0x0
...
function function_2ccc781e(var_d3440450, var_50cc0d4f) {
    ...
    var_c3025e74 = array::exclude(var_c3025e74, [level.chase_truck, level.rc_car]);
...
function function_8d9f9fd7() {
    ...
    for (skip_idle = 0; true; skip_idle = 1) {
        ...
        if (var_c3025e74.size > 0) {
            ...
            dot = level.chase_truck math::get_dot_forward(var_c3025e74[0].origin, 1, 1);
            shot = "shoot_right_";
            if (dot > 0.2) {
                shot = "shoot_forward_";
            } else if (dot < -0.2) {
...
function function_40c45b6() {
    self endon(#"death");
    level notify(#"truck_spawned", {#veh:self});
