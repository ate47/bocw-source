...
function function_5b503df2() {
    ...
    /#
        skipto::add_dev("<dev string:x38>", &hub_post_cuba::main, &hub_post_cuba::starting, "<dev string:x57>");
        skipto::add_dev("<dev string:x6a>", &hub_post_cuba::main, &hub_post_cuba::starting, "<dev string:x57>");
        skipto::add_dev("<dev string:x8a>", &hub_post_cuba::main, &hub_post_cuba::starting, "<dev string:x57>");
    #/
}
