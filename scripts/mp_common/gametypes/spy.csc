...
function event_handler[gametype_init] main(*eventstruct) {
    ...
    clientfield::function_5b7d846d("hudItems.spyMatchData.deadPlayerCount", #"spy_global", #"hash_4564cd07c489a395", 1, 5, "int", undefined, 0, 0);
    clientfield::function_5b7d846d("hudItems.spyMatchData.playerAssignedIDCounter", #"spy_global", #"hash_290a3189b0fa7673", 1, 5, "counter", undefined, 0, 0);
    for (i = 1; i <= 25; i++) {
        ...
        clientfield::function_5b7d846d("hudItems.spyMatchData." + i + ".isConnected", #"spy_global", [hash(isdefined(i) ? "" + i : ""), #"hash_3d1196b43432f700"], 1, 1, "int", undefined, 0, 0);
        ...
        clientfield::function_5b7d846d("hudItems.spyMatchData." + i + ".talkInPrivateChannel", #"spy_global", [hash(isdefined(i) ? "" + i : ""), #"hash_692b144aab751bce"], 1, 1, "int", undefined, 0, 0);
        clientfield::function_5b7d846d("hudItems.spyMatchData." + i + ".identityIsKnown", #"spy_global", [hash(isdefined(i) ? "" + i : ""), #"hash_9d33ce88844c17e"], 1, 1, "int", undefined, 0, 0);
        ...
        clientfield::function_5b7d846d("hudItems.spyMatchData." + i + ".isWanted", #"spy_global", [hash(isdefined(i) ? "" + i : ""), #"hash_4ea36fff67aa12de"], 1, 1, "int", undefined, 0, 0);
        clientfield::function_5b7d846d("hudItems.spyMatchData." + i + ".detonations", #"spy_global", [hash(isdefined(i) ? "" + i : ""), #"hash_dcca75fef649c79"], 1, 4, "int", undefined, 0, 0);
    }
