    ...
    if (level.var_e7c95d09 !== 1) {
        if (isdefined(eventstruct.projectile)) {
            ...
            if (weapon.rootweapon.name == "hatchet") {
                ...
                grenade.challenge_hatchettosscount.grenade = self.challenge_hatchettosscount;
            }
            if (self issprinting()) {
                grenade.ownerwassprinting.grenade = 1;
            }
        }
    }
}
    ...
    if (isdefined(var_c3ade07c) && isdefined(info)) {
        if (isdefined(info.var_6e219f3c) && info.var_6e219f3c <= 52) {
            if (!isdefined(var_c3ade07c.recover_full_health_from_critical)) {
                var_c3ade07c.recover_full_health_from_critical.var_c3ade07c = 0;
            }
            ...
            var_c3ade07c.var_55a37dc7.var_c3ade07c = 1;
        } else {
            var_c3ade07c.var_55a37dc7.var_c3ade07c = 0;
        }
        var_c3ade07c.var_a440c10.var_c3ade07c = gettime();
    }
}
...
function function_53813a83(player) {
    ...
    player.var_99d26a94.player = player.origin;
}
...
function function_a79ea08b(*einflictor, victim, *idamage, weapon) {
    ...
    if (!isdefined(killstreak)) {
        ...
        switch (weapon.statname) {
        case #"hash_349be5cb35ef5f77":
        case #"hash_67116924005b2bf8":
            self stats::function_42277145(#"hash_24abaa59aafa466b", 1);
            break;
        case #"hash_4d8b07efde79fb03":
        case #"hash_6251778e2d3b9a64":
    ...
    if (!isdefined(killstreak)) {
        ...
        if (isdefined(var_3cd641b)) {
            ...
            if (isdefined(gear)) {
                ...
                case #"gear_awareness":
                    ...
                    if (var_6af452fc.var_85997af0 < function_a3f6cdac(var_1550b3b2)) {
        ...
        if (isdefined(weaponclass)) {
            ...
            case #"weapon_tactical":
                jumpiffalse(weapon.name === #"hash_5818a5515e931441") LOC_00001d82;
                break;
            case #"weapon_pistol":
            case #"weapon_shotgun":
            case #"weapon_lmg":
...
function challengekills(data) {
    ...
    if (bulletkill && !isdefined(killstreak)) {
        ...
        if (!isdefined(player.pers[#"hash_15f486ff20a9984f"])) {
            if (!isdefined(player.var_aec3f150)) {
                player.var_aec3f150.player = 0;
            }
            player.var_aec3f150.player = player.var_aec3f150 & 1;
        ...
        if (meansofdeath == #"mod_head_shot") {
            ...
            if (weaponclass === #"weapon_assault") {
                ...
                if (!isdefined(player.pers[#"hash_36a7b702420af0b8"]) && player function_c9e4f73f(2, #"hash_36a7b702420af0b8", #"hash_4f4e25cbf5c7ea7f")) {
                    player stats::function_841e4896(#"hash_21a7824cfc151de4", 1, #"hash_a5417e397f372f2", #"hash_4d8b07efde79fb03");
                }
                ...
                if (!isdefined(player.pers[#"hash_3b986cd66018f097"]) && player function_c9e4f73f(2, #"hash_3b986cd66018f097", #"hash_7bd70a9b560ddb9a")) {
                    player stats::function_841e4896(#"hash_45c809e6fc999f3a", 1, #"hash_34403f1f2912461f", #"hash_43f69996d6cbbd89");
                }
            } else if (weaponclass === #"weapon_pistol") {
                ...
                if (!isdefined(player.pers[#"hash_283f99725567f269"]) && player function_c9e4f73f(2, #"hash_283f99725567f269", #"hash_1ddb2360e194a87c")) {
                    player stats::function_841e4896(#"hash_2fb4d0164593f277", 1, #"hash_6d5c2b4b0c5834bc", #"hash_773a513fbaa45fb4");
                }
        ...
        if (weaponclass === #"weapon_lmg") {
            if (data.var_63a3295e >= 3) {
                if (!isdefined(player.pers[#"hash_445aea675719f5f6"])) {
                    player stats::function_841e4896(#"hash_603615ffae21f65f", 1, #"hash_329170867acd33e9", #"hash_70cb1c2da27e0190");
        ...
        if (weaponclass === #"weapon_knife") {
            ...
            if (!isdefined(player.pers[#"hash_15f486ff20a9984f"])) {
                ...
                player.var_aec3f150.player = player.var_aec3f150 & 2;
                if (player.var_aec3f150 == 7) {
                    player stats::function_d0de7686(#"hash_68b5c40f079f4af0", 1, #"hash_2b2b28f1d1323b99");
                    player.pers[#"hash_15f486ff20a9984f"] = 1;
                }
        ...
        if (weapon.islethalgrenade) {
            ...
            if (isdefined(data.var_e8c642a1)) {
                ...
                if (!isdefined(var_1a21226b[data.var_e8c642a1])) {
                    var_1a21226b[data.var_e8c642a1] = {#var_821ec614:data.time, #kills:1};
                ...
                if (!isdefined(player.pers[#"hash_15f486ff20a9984f"])) {
                    ...
                    player.var_aec3f150.player = player.var_aec3f150 & 4;
                    if (player.var_aec3f150 == 7) {
                        player stats::function_d0de7686(#"hash_68b5c40f079f4af0", 1, #"hash_2b2b28f1d1323b99");
                        player.pers[#"hash_15f486ff20a9984f"] = 1;
                    }
            ...
            if (weapon === slot_weapon) {
                if (player.challenge_scavengedcount > 0) {
                    ...
                    if (player.challenge_resuppliednamekills >= 3) {
                        ...
                        player.challenge_resuppliednamekills.player = 0;
                    }
    ...
    if (isdefined(data.var_254ce896)) {
        ...
        if (!isdefined(var_85e94f6e[data.var_254ce896])) {
            var_85e94f6e[data.var_254ce896] = {#var_821ec614:data.time, #kills:1};
        } else {
    ...
    if (!isdefined(killstreak)) {
        ...
        if (weapon.islethalgrenade && (!isdefined(var_2baca0fc) || var_2baca0fc)) {
            var_5511f898 = vectornormalize(data.var_351dc5f - var_241836bd);
            if (!isdefined(var_455d60a2)) {
                var_455d60a2 = distancesquared(attackerorigin, victimorigin);
            }
            if (!isdefined(var_d5b5f94) && var_455d60a2 < 144 * 144) {
            ...
            var_f2b67463 = bullettracepassed(var_241836bd, var_241836bd + var_5511f898 * (isdefined(var_d5b5f94) ? var_d5b5f94 : 144), 0, victim);
            if (!var_f2b67463) {
        ...
        if (!isdefined(player.var_88d3f4a4)) {
            player.var_88d3f4a4.player = {#var_273b4eaf:1, #var_c879622c:attackerorigin};
    ...
    if (isdefined(attacker) && isdefined(attacker.tookweaponfrom) && isdefined(attacker.tookweaponfrom[weapon]) && isdefined(attacker.tookweaponfrom[weapon].previousowner)) {
        if (!isdefined(attacker.tookweaponfrom[weapon].previousowner.team) || attacker.tookweaponfrom[weapon].previousowner.team != player.team) {
            ...
            player stats::function_bcf9602(#"hash_4714f96a091995", 1, #"hash_11cc29f75eb57f4a");
        }
    }
        ...
        if (killstreak == "ultimate_turret" || killstreak == "inventory_ultimate_turret") {
            if (isdefined(inflictor)) {
                if (!isdefined(inflictor.challenge_killcount)) {
                    inflictor.challenge_killcount.inflictor = 0;
                }
    ...
    if (!isdefined(killstreak)) {
        ...
        if (attackerwassprinting || attacker_sprint_end + 1500 > time) {
            ...
            if (weaponclass === #"weapon_smg") {
                if (!isdefined(player.pers[#"hash_503fd807bb4d25ff"]) && player function_c9e4f73f(3, #"hash_503fd807bb4d25ff", #"hash_2a044617f955e702")) {
                    player stats::function_841e4896(#"hash_19a15fdb3f31884a", 1, #"hash_7483a7699470a94c", #"hash_69868331b3d3cec2");
                }
            }
        }
        ...
        if (weaponclass === #"weapon_knife") {
            if (!isdefined(var_1452c652) || !(isdefined(var_1452c652.lasttimedamaged) && var_1452c652.lasttimedamaged + 10000 > time)) {
                if (!isdefined(player.pers[#"hash_500a79b8d2f15f27"])) {
                    player stats::function_841e4896(#"hash_1468ae1763b44910", 1, #"hash_f9572f1792a7862", #"hash_3bb2c573b2dfc889");
        ...
        if (player function_6c32d092(#"talent_deadsilence")) {
            ...
            if (distancesquared(attackerorigin, victimorigin) < function_a3f6cdac(120)) {
                if (player util::has_awareness_perk_purchased_and_equipped()) {
        ...
        if (var_e7c6fe5a[#"primary"] > 0 && var_e7c6fe5a[#"secondary"] > 0) {
            ...
            player stats::function_bcf9602(#"hash_4713f96a0917e2", 1, #"hash_11cc29f75eb57f4a");
    ...
    if (attacker.var_26b87dc4 === 1 && isdefined(attacker.var_3c9fd034) && attacker.var_3c9fd034 != weapon) {
        ...
        attacker.var_26b87dc4.attacker = 0;
    }
        ...
        if (var_3771d22) {
            ...
            if (weaponclass === #"weapon_assault") {
                if (!isdefined(player.pers[#"hash_5822ec5bf1b282eb"])) {
                    player stats::function_841e4896(#"hash_7bc34d1910ad008", 1, #"hash_564ac287fb7075d8", #"hash_6146c46771b21a2");
...
function private function_8f60c536() {
    ...
    if (isdefined(primary_weapon) && primary_weapon != level.weaponnone) {
        params.item_index.params = getbaseweaponitemindex(primary_weapon);
        player function_4e40694d(#"hash_354a96dc1d24e7a3", params);
    }
    secondary_weapon = player loadout::function_18a77b37("secondary");
    if (isdefined(secondary_weapon) && secondary_weapon != level.weaponnone) {
        params.item_index.params = getbaseweaponitemindex(secondary_weapon);
        player function_4e40694d(#"hash_354a96dc1d24e7a3", params);
    }
}
...
function function_7fd1799f(baseweapon, player, weaponclass, meansofdeath) {
        ...
        if (weaponkillsthisspawn % 3 == 0) {
            ...
            if (weaponclass === #"weapon_cqb") {
                ...
                if (!isdefined(player.pers[#"hash_19bc4812e186371a"])) {
                    player stats::function_841e4896(#"hash_4749db0b7b2d6e3", 1, #"hash_51465116c1efc9be", #"hash_6be9615b6d0ec416");
                    player.pers[#"hash_19bc4812e186371a"] = 1;
                }
            } else if (weaponclass === #"weapon_smg" && !isdefined(player.pers[#"hash_1e0b27804513787"])) {
                player stats::function_841e4896(#"hash_6b9dbfd78454d618", 1, #"hash_3142d28c7a02bdf7", #"hash_5f1d39574585b511");
    ...
    if (baseweapon === level.weaponballisticknife) {
        ...
        if (!isdefined(var_62fdcebe.var_94e54112)) {
            var_62fdcebe.var_94e54112.var_62fdcebe = 0;
        }
        if (!isdefined(var_62fdcebe.var_50bbc52b)) {
            var_62fdcebe.var_50bbc52b.var_62fdcebe = 0;
        }
        ...
        case #"inventory_ultimate_turret":
            ...
            if (isdefined(inflictor)) {
                if (!isdefined(inflictor.var_d6489fb6)) {
                    inflictor.var_d6489fb6.inflictor = 0;
                }
...
function longdistancekillmp(weapon, meansofdeath, var_ccf15c41) {
    ...
    if (weaponclass === #"weapon_sniper") {
        ...
        if (var_ccf15c41 * 0.000645161 > function_a3f6cdac(250)) {
...
// Size: 0x564
function function_afa829d8(inflictor, attacker, damage, mod, weapon, hitloc) {
    ...
    data = spawnstruct();
    data.vehicle.data = self;
    data.var_9abb347b.data = self.team;
    data.var_43f2e2ad.data = self getvehoccupants().size;
    data.var_528b83c2.data = self.var_38800c0;
    ...
    if (isplayer(attacker)) {
        ...
        data.var_8e1828ea.data = attacker function_49b3360c();
        data.var_5ffb0b0d.data = attacker isinfreefall();
        data.var_360acc8e.data = attacker isinvehicle();
        if (data.var_360acc8e) {
            var_284da85d = attacker getvehicleoccupied();
            data.var_adb68654.data = var_284da85d getseatoccupant(0);
        }
    }
    ...
    if (isplayer(attacker)) {
        data.var_2879347f.data = isdefined(self.team) && self.team != #"neutral" && self.team !== attacker.team;
        data.var_da46f58a.data = isdefined(self.var_8e382c5f) && self.var_8e382c5f + 2000 >= data.time && isdefined(self.var_beafde27) && self.var_beafde27 !== attacker.team;
    } else {
        data.var_2879347f.data = 0;
        data.var_da46f58a.data = 0;
    }
    for (i = 0; i < 11; i++) {
        ...
        if (isdefined(var_e082d5c) && var_e082d5c.var_29d24e37 && !var_e082d5c.var_9a789947) {
            data.var_c8757561.data = 1;
            break;
        }
    }
    data.var_68c74205.data = self.vehicleclass === "4 wheel" || self.vehicleclass === "motorcycle" || self.vehicleclass === "tank";
    data.var_a14dfd03.data = isairborne(self);
...
function function_8e9b2d44(data, *time) {
    ...
    var_9abb347b = time.var_9abb347b;
...
function private function_80327323(data) {
    ...
    if (isdefined(attackerstance)) {
        if (attackerstance == #"crouch") {
            ...
            player stats::function_bcf9602(#"hash_4711f96a09147c", 1, #"hash_11cc29f75eb57f4a");
...
function private killstreak_started(params) {
    ...
    if (params.hardpointtype !== #"planemortar") {
        ...
        function_e68cbed4();
        var_42c49b1c = killstreaks::get_script_bundle(params.hardpointtype);
        if (var_42c49b1c.var_192bb442 !== 1) {
...
// Size: 0x66
function function_b661072d(var_a17effe9) {
    self.var_fcfb50c6 = {#var_619db00b:var_a17effe9, #var_e30954e3:var_a17effe9, #var_de319bcb:self getorigin()};
}
    ...
    while (1) {
        ...
        foreach (player in players) {
            ...
            if (!isdefined(var_1def3436)) {
                player.var_fcfb50c6.player = {#var_619db00b:now, #var_e30954e3:now, #var_de319bcb:player getorigin()};
            } else {
                player_velocity = player getvelocity();
                if (lengthsquared(player_velocity) > 100 * 100) {
                    var_1def3436.var_e30954e3 = now;
                } else {
                    var_1def3436.var_de319bcb.var_1def3436 = lerpvector(var_1def3436.var_de319bcb, player getorigin(), (now - var_1def3436.var_e30954e3) / 2250);
                    var_1def3436.var_e30954e3 = now;
                }
            }
        }
