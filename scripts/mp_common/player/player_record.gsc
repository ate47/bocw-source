...
function function_96d38b95(result) {
    ...
    var_906bdcf3.session_mode.var_906bdcf3 = currentsessionmode();
    var_906bdcf3.game_type.var_906bdcf3 = hash(level.gametype);
    var_906bdcf3.private_match.var_906bdcf3 = sessionmodeisprivate();
    var_906bdcf3.esports_flag.var_906bdcf3 = level.leaguematch;
    var_906bdcf3.ranked_play_flag.var_906bdcf3 = level.arenamatch;
    var_906bdcf3.game_map.var_906bdcf3 = util::get_map_name();
    var_906bdcf3.player_xuid.var_906bdcf3 = player getxuid(1);
    var_906bdcf3.player_ip.var_906bdcf3 = player getipaddress();
    var_906bdcf3.season_pass_owned.var_906bdcf3 = player hasseasonpass(0);
    var_906bdcf3.dlc_owned.var_906bdcf3 = player getdlcavailable();
    ...
    var_811ed119.match_deaths.var_811ed119 = player.deaths;
    var_811ed119.match_xp = xpearned;
    var_811ed119.match_score.var_811ed119 = player.score;
    var_811ed119.match_streak.var_811ed119 = player.pers[#"best_kill_streak"];
    var_811ed119.match_captures.var_811ed119 = player.pers[#"captures"];
    var_811ed119.match_defends.var_811ed119 = player.pers[#"defends"];
    var_811ed119.match_headshots.var_811ed119 = player.pers[#"headshots"];
    var_811ed119.match_longshots.var_811ed119 = player.pers[#"longshots"];
    var_811ed119.match_objtime.var_811ed119 = player.pers[#"objtime"];
    var_811ed119.match_plants.var_811ed119 = player.pers[#"plants"];
    var_811ed119.match_defuses.var_811ed119 = player.pers[#"defuses"];
    var_811ed119.match_throws.var_811ed119 = player.pers[#"throws"];
    var_811ed119.match_carries.var_811ed119 = player.pers[#"carries"];
    var_811ed119.match_returns.var_811ed119 = player.pers[#"returns"];
    var_811ed119.match_result = resultstr;
    var_811ed119.match_duration.var_811ed119 = int(timeplayed);
    var_811ed119.match_shots = totalmatchshots;
    var_811ed119.match_hits = hitcount;
    var_811ed119.prestige_max.var_811ed119 = player.pers[#"plevel"];
    var_811ed119.level_max.var_811ed119 = player.pers[#"rank"];
    var_811ed119.specialist_kills.var_811ed119 = player.heavyweaponkillcount;
    var_a14ea2be = spawnstruct();
    var_a14ea2be.player_gender.var_a14ea2be = player getplayergendertype(currentsessionmode());
    var_a14ea2be.specialist_used.var_a14ea2be = function_b14806c6(player player_role::get(), currentsessionmode());
    ...
    var_8607894c.var_3cc73d67.var_8607894c = player function_5d23af5b();
    var_8607894c.specialist_head.var_8607894c = player function_44a7328f();
    var_8607894c.specialist_legs.var_8607894c = player function_cde23658();
    var_8607894c.var_ef44bb8b.var_8607894c = player function_92ea4100();
    var_8607894c.specialist_showcase.var_8607894c = showcaseweapon.weapon.name;
