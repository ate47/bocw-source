...
function function_95a5b5c2( obj_type, label, team, origin, player )
{
    if ( sessionmodeismultiplayergame() )
    {
        ...
        if ( isplayer( player ) )
        {
            ...
            player function_678f57c8( #"hash_d424efe4db1dff7", { #gametime:function_f8d53445(), #objtype:obj_type, #label:label, #team:var_cfad67d4, #playerx:origin[ 0 ], #playery:origin[ 1 ], #playerz:origin[ 2 ], #clientid:clientid } );
        }
    }
}
