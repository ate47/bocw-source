...
function function_d9ae19f0(player) {
    if (player.var_9cd2c51d.var_43797ec0.statname === #"hash_364914e1708cb629" && isdefined(player.heal.var_855cc818) && isdefined(player.heal.var_fa57541f)) {
        player function_fd9fb79b(#"hash_4222068ae31bdf3f", player.heal.var_855cc818 - player.heal.var_fa57541f);
    }
}
...
function function_17a92a99(var_1d89ece6) {
    /#
        ...
        function_3f749abc(var_78a6fb52 + "<unknown string>", var_c8d599b5 + "<unknown string>");
        function_3f749abc(var_78a6fb52 + "<unknown string>", var_c8d599b5 + "<unknown string>");
        function_3f749abc(var_78a6fb52 + "<unknown string>", var_c8d599b5 + "<unknown string>");
        function_3f749abc(var_78a6fb52 + "<unknown string>", var_c8d599b5 + "<unknown string>");
        function_3f749abc(var_78a6fb52 + "<unknown string>", var_c8d599b5 + "<unknown string>");
