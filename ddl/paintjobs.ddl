...
#redirect hash_7ea7a0e0a75381e0;

version hash_5bfb210c82191670 {
    // enums ..... 1 (0x1)
    // structs ... 10 (0xa)
    // header bit size .. 1426 (0x592)
    ...
    // root: bitSize: 0x4e2, members: 2

    // offset: 0x0, bitSize: 0x4c2
    weaponpaintjob weaponpaintjob;
    // offset: 0x4c2, bitSize: 0x20(0x4 Byte(s))
    uint version;
};

version hash_4f56d7d703c382e1 {
    // enums ..... 1 (0x1)
    // structs ... 10 (0xa)
    // header bit size .. 1426 (0x592)
    // header byte size . 179 (0xb3)
...
version hash_a7e3f28715ec0606 {
    // enums ..... 1 (0x1)
    // structs ... 10 (0xa)
    // header bit size .. 14746 (0x399a)
    // header byte size . 1844 (0x734)
    ...
    // root: bitSize: 0x38ea, members: 2

    // offset: 0x0, bitSize: 0x38ca
    weaponpaintjob weaponpaintjob;
    // offset: 0x38ca, bitSize: 0x20(0x4 Byte(s))
    uint version;
};
