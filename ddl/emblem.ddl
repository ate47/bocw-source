...
#redirect hash_78957083c74f990;

version hash_9f4834667a776cf7 {
    // enums ..... 1 (0x1)
    // structs ... 10 (0xa)
    // header bit size .. 1448 (0x5a8)
    // header byte size . 181 (0xb5)
    ...
    // root: bitSize: 0x4f8, members: 9

    // offset: 0x0, bitSize: 0x40(0x8 Byte(s))
    uint64 xuid;
    // offset: 0x40, bitSize: 0x20(0x4 Byte(s))
    uint version;
    // offset: 0x60, bitSize: 0x80(0x10 Byte(s))
    string(16) emblemname;
    // offset: 0xe0, bitSize: 0x20(0x4 Byte(s))
    uint createtime;
    // offset: 0x100, bitSize: 0x3b4
    hash_4e00feaf81ba241c emblem;
    // offset: 0x4b4, bitSize: 0x2
    int:2 isused;
    // offset: 0x4b6, bitSize: 0x2
    int:2 readonly;
...
version hash_395291495112d043 {
    // enums ..... 1 (0x1)
    // structs ... 10 (0xa)
    // header bit size .. 14768 (0x39b0)
    // header byte size . 1846 (0x736)
    ...
    // offset: 0xe0, bitSize: 0x20(0x4 Byte(s))
    uint createtime;
    // offset: 0x100, bitSize: 0x37bc
    hash_4e00feaf81ba241c emblem;
    // offset: 0x38bc, bitSize: 0x2
    int:2 isused;
    // offset: 0x38be, bitSize: 0x2
    int:2 readonly;
    // offset: 0x38c0, bitSize: 0x20(0x4 Byte(s))
    uint layercount;
    // offset: 0x38e0, bitSize: 0x20(0x4 Byte(s))
    int sortindex;
};
