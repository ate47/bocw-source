// file .... ddl_5ab0ee3ac4252722

#redirect hash_722dcc058578622f;

version hash_baa7c808a4a30cfc {
    // enums ..... 5 (0x5)
    // structs ... 5 (0x5)
    // header bit size .. 2960 (0xb90)
    // header byte size . 370 (0x172)
    ...
    // root: bitSize: 0xae0, members: 5

    // offset: 0x0, bitSize: 0x540(0xa8 Byte(s))
    match_header match;
    // offset: 0x540, bitSize: 0x380(0x70 Byte(s))
    telemetry_header telemetry;
    // offset: 0x8c0, bitSize: 0xa0(0x14 Byte(s))
    client_header client;
    // offset: 0x960, bitSize: 0x100(0x20 Byte(s))
    string(32) player;
    // offset: 0xa60, bitSize: 0x80(0x10 Byte(s))
