// file .... cp_loadouts.ddl

#redirect hash_673e47c3259ce39d;

version hash_cdb26576b9657e3c {
    // enums ..... 0 (0x0)
    // structs ... 7 (0x7)
    // header bit size .. 6672 (0x1a10)
    // header byte size . 834 (0x342)
    ...
    // root: bitSize: 0x1960, members: 4

    // offset: 0x0, bitSize: 0x20(0x4 Byte(s))
    int loadoutversion;
    // offset: 0x20, bitSize: 0x1938(0x327 Byte(s))
