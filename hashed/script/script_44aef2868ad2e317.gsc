...
#namespace namespace_5f58ebe5;

// Namespace namespace_5f58ebe5/namespace_bd1b12dd
// Params 1, eflags: 0x0
...
function main(var_d3440450, var_50cc0d4f) {
    ...
    if (is_true(var_50cc0d4f)) {
        ...
        level.player thread util::function_5b2f930e(4, #"hash_19f18b248c5f4e17", "[{+actionslot 4;+map}]");
...
function function_337cace2(location) {
    switch (location) {
    case #"office":
        if (level.var_5fc0b631[#"poison_tea"].tracked) {
            level.player thread objectives_ui::show_objectives();
        }
        break;
    case #"data":
        if (level.var_5fc0b631[#"key_reprogram"].tracked) {
            level.player thread objectives_ui::show_objectives();
        }
        break;
    case #"checkpoint":
        if (level.var_5fc0b631[#"making_a_mole"].tracked) {
            level.player thread objectives_ui::show_objectives();
        }
        break;
    case #"interrogation":
        if (level.var_5fc0b631[#"prisoner_persuasion"].tracked) {
            level.player thread objectives_ui::show_objectives();
        }
        break;
    default:
...
function function_399a3c34() {
    ...
    level.player interactive_map::add_object(#"player", #"hash_7441e6173ae21dac", 1, -90);
    if (!isdefined(level.var_dc5a0371)) {
        level.var_dc5a0371 = 0;
    }
    if (isdefined(level.general)) {
        level.general interactive_map::add_object(#"general", #"hash_6d523db388091374", 0);
    }
    ...
    if (corpses.size) {
        for (i = 0; i < corpses.size; i++) {
            ...
            if (!corpses[i] namespace_e77bf565::function_127e0d08()) {
                tags[i] interactive_map::add_object("corpse" + string(i), #"hash_51ac612cdcf787b9", 0);
            }
        }
    }
    var_b33f9bc7 = {#var_4ac77177:0, #var_de6f0004:0, #var_4d98c3ce:#"hash_4bba939c7b77a314", #complete_callback:&interactive_map::function_fabe437a, #var_be77841a:0};
    level.var_a7c109a9 = {#var_4ac77177:0, #var_de6f0004:0, #var_4d98c3ce:#"hash_77bbd9b01cf5911d", #complete_callback:&function_1b3bebea, #var_be77841a:0};
    var_384bed55 = {#var_4ac77177:0, #var_de6f0004:0, #var_4d98c3ce:#"hash_77bbd9b01cf5911d", #complete_callback:&function_eab15e43, #var_be77841a:0};
    level.var_ac82c4c6 = {#var_4ac77177:0, #var_de6f0004:0, #var_4d98c3ce:#"hash_77bbd9b01cf5911d", #complete_callback:&function_5a785465, #var_be77841a:0};
    if (level flag::get("flag_start_finding_ways")) {
        function_10fea201();
        ...
        var_147d40f0 = getentarray("mental_map_poi", "targetname");
        foreach (var_7188b3ba in var_147d40f0) {
            switch (var_7188b3ba.script_noteworthy) {
            case #"camera":
                var_7188b3ba.var_d9b5c896 = #"hash_1f3fb2e195d67274";
                model_name = "cameraRoomState";
                var_7188b3ba.var_94ca2a30 = #"hash_658c76bc4bf5be3e";
                if (level flag::get("flag_tutorial_1")) {
                    var_7188b3ba.var_94ca2a30 = #"hash_658c77bc4bf5bff1";
                }
                if (level flag::get("flag_tutorial_2")) {
                    var_7188b3ba.var_94ca2a30 = #"hash_658c74bc4bf5bad8";
                }
                if (level flag::get("flag_tutorial_3")) {
                    var_7188b3ba.var_94ca2a30 = #"hash_658c75bc4bf5bc8b";
                }
                if (level flag::get("flag_tutorial_4")) {
                    var_7188b3ba.var_94ca2a30 = #"hash_658c7abc4bf5c50a";
                }
                if (!level flag::get("flag_tutorial_map_complete")) {
                    var_7188b3ba interactive_map::function_b5c2702b(#"confirm", var_384bed55);
                }
                var_7188b3ba interactive_map::function_9bc3d847(#"cursor_on", model_name, 0, 1);
                interactive_map::function_59b2a130(var_147d40f0);
                break;
            default:
                break;
            }
...
function function_e59622fc() {
    if (!level flag::get("flag_player_scheduled_meeting") && !level flag::get("flag_has_poison") && !level flag::get("flag_start_charkov_investigation")) {
        level.var_c2269c86 interactive_map::add_object(#"hash_2eefe7d528c193cd", level.var_5fc836e5, 0, undefined);
        level.var_c2269c86.var_d9b5c896 = #"hash_3048014b9f22fee7";
        level.var_c2269c86.var_94ca2a30 = #"hash_2d03a5ac2753abb9";
        return;
    }
    ...
    if (level flag::get("flag_has_poison") && !level flag::get("flag_start_charkov_investigation")) {
        level.var_c2269c86 interactive_map::add_object(#"hash_2eefe7d528c193cd", level.var_5fc836e5, 0, undefined);
        level.var_c2269c86.var_d9b5c896 = #"hash_3048014b9f22fee7";
        level.var_c2269c86.var_94ca2a30 = #"hash_17053318d59f96b9";
        return;
    }
...
function function_6f694325() {
    ...
    interactive_map::remove_object(#"hash_2eefe7d528c193cd");
...
function function_7d2cd5a4() {
    ...
    computer interactive_map::add_object(#"hash_34786aab90a58004", level.var_5fc836e5, 0, undefined);
}
...
function function_b2389c8a() {
    ...
    interactive_map::remove_object(#"hash_34786aab90a58004");
}
...
function function_3b6949e3() {
    ...
    if (level flag::get("flag_poi_records_file") && !level flag::get("flag_show_family_choice")) {
        var_5dd8de28 = struct::get("prisoner_chat", "targetname");
        var_5dd8de28 interactive_map::add_object(#"hash_5ae419835c5428b4", level.var_5fc836e5, 0, undefined);
        var_5dd8de28.var_d9b5c896 = #"hash_6f8f144109d9ede5";
        var_5dd8de28.var_94ca2a30 = #"hash_31b9cc13fef9b4ef";
        return;
    }
...
function function_112ccc00() {
    if (!level flag::get("flag_poi_krav_chat") && !level flag::get("false_intel_printed")) {
        level.var_eede7a6 interactive_map::add_object(#"hash_23daf5d7870650a7", level.var_5fc836e5, 0, undefined);
        return;
    }
    if (!level flag::get("false_intel_printed")) {
    ...
    if (!level flag::get("has_false_intel")) {
        ...
        printer interactive_map::add_object(#"hash_4b4f8cad08d0edf7", level.var_5fc836e5, 0, undefined);
...
function function_9e96f7bb() {
    interactive_map::remove_object(#"hash_23daf5d7870650a7");
    interactive_map::remove_object(#"hash_4b4f8cad08d0edf7");
...
// Size: 0x32
function function_22af6992(*var_248cbbcf) {
...
function function_2930697c() {
    ...
    level.var_5fc836e5 = #"hash_215b9409f9d7cc36";
...
function function_52f0fcb3(var_d3440450) {
    ...
    level.player.var_f467e5b0.enabled[#"hash_4ee54ef61a0301b2"] = 0;
    level.player.var_f467e5b0.enabled[#"body_shield_grenade"] = 0;
...
function function_2388bc70() {
    ...
    level.var_c2269c86 = spawner::simple_spawn_single("kgb_secretary", &function_74ad7322);
}
...
function function_94385b7e() {
    ...
    self waittill(#"hash_39550364a879e1d4");
    self.var_a6ac27c = 1;
    var_59f39012 = anglestoforward(self.angles);
    var_78662e77 = vectornormalize(level.player.origin - self.origin);
...
function function_bf9a3b8d() {
    self endon(#"death");
    self endon(#"hash_39550364a879e1d4");
...
// Size: 0x144
function function_519cff6f(*var_248cbbcf) {
    level.player endon(#"death");
    if (!level flag::get("flag_keycard_acquired")) {
        snd::client_msg(#"hash_75e3c63844a5eb53");
        weapon = getweapon(#"hash_201ae1a63467400c");
...
function function_4c61e92b(*prompt) {
    level.var_753658ee thread dialog_tree::run(level.var_c2269c86);
}
...
function function_2d5aaa39() {
    level.var_c2269c86 thread function_680c8cbe();
}
...
// Size: 0x20
function function_bb965821(*var_248cbbcf) {
...
// Size: 0x20
function function_46844241(*var_248cbbcf) {
...
// Size: 0x74
function function_c0a84859(*var_248cbbcf) {
    level thread function_c9965ab9(1);
...
// Size: 0x54
function function_9c0573b2(*var_248cbbcf) {
...
// Size: 0x24
function function_a1dee806(*var_248cbbcf) {
...
function function_b0e70405(a_ents) {
    ...
    var_58656b1a = a_ents[#"hash_77bc7619566a95b0"];
...
// Size: 0x74
function function_1948ba64(var_344dd6a5, var_260bba21) {
    vo_line = var_344dd6a5;
    if (math::cointoss()) {
        vo_line = var_260bba21;
    }
...
function function_72ad2b01() {
    self waittill(#"death", #"hash_39550364a879e1d4");
...
function function_e1286843() {
    ...
    var_495dfd59 = spawner::simple_spawn_single("krav_goon", &function_862e8bf9);
    var_495dfd59 thread function_3cf5b786("flag_player_swap");
...
// Size: 0x6c
function function_f17f515c(*var_248cbbcf) {
...
// Size: 0x104
function function_a723656a(*var_248cbbcf) {
...
function function_2aa3292b(var_bddef49) {
    ...
    level scene::stop("scene_kgb_secretary_dt");
    var_58656b1a = getent("secretary_pen", "targetname");
    if (isdefined(var_58656b1a)) {
        var_58656b1a delete();
    }
    ...
    var_ed8dd60 = getent("poison_chair_blocker", "targetname");
    var_ed8dd60.origin += (0, 0, -256);
...
// Size: 0xfa
function function_d09d1a07(*var_248cbbcf) {
...
// Size: 0x2c
function function_87e35005(*var_248cbbcf) {
    level flag::set("flag_keycard_acquired");
}
...
// Size: 0x1e4
function function_6789cd2e(*var_248cbbcf) {
    level thread function_c9965ab9(1);
    namespace_e77bf565::function_f6eb250d("cinematicmotion_kgb_computer");
...
// Size: 0x138
function function_c7de39b1(*var_248cbbcf) {
...
// Size: 0xc4
function armory_button(*var_248cbbcf) {
...
function function_5da2f302(a_ents) {
    a_ents[#"hash_7f2c000ee8773ab1"] thread entname::add(#"hash_5adf107d46cc0546", #"axis");
    level.var_1c20e038 = a_ents[#"hash_7f2c000ee8773ab1"];
}
...
function function_ca7fd487(origin) {
    ...
    while (true) {
        ...
        s_result = level.player waittill(#"exit", #"hash_542efe3d2dcb6459");
        namespace_e77bf565::function_f6eb250d();
...
function function_a6dc6fea() {
    ...
    namespace_93648050::function_eb5d0a02(hash("krav_clue_1"), var_f3b47ae, #"hash_617f7cd3a1666c29", 256, undefined, 4);
    var_20f66b24 = getent("periodic_translate_2", "targetname");
    namespace_93648050::function_eb5d0a02(hash("krav_clue_2"), var_20f66b24, #"hash_617f79d3a1666710", 256, undefined, 4);
    var_a5167306 = getent("periodic_translate_3", "targetname");
    namespace_93648050::function_eb5d0a02(hash("krav_clue_3"), var_a5167306, #"hash_617f7ad3a16668c3", 256, undefined, 4);
}
...
function function_940ae8f6() {
    ...
    var_147d40f0 = getentarray("mental_map_poi", "targetname");
    foreach (var_7188b3ba in var_147d40f0) {
        var_7188b3ba interactive_map::function_4b1a5235(#"alt1");
    }
    if (isdefined(level.var_5fc0b631)) {
        keys = getarraykeys(level.var_5fc0b631);
        if (isdefined(keys)) {
            foreach (key in keys) {
...
// Size: 0x42c
function function_1b3bebea(var_248cbbcf) {
    data = var_248cbbcf;
    namespace_353d803e::function_5865b09e();
    location = level.interactive_map.var_2c15274b.object.script_noteworthy;
    if (isdefined(location)) {
    ...
    keys = getarraykeys(level.var_5fc0b631);
    if (!isdefined(level.var_5fc0b631[objective_name])) {
        return;
    }
    foreach (key in keys) {
        if (key == objective_name) {
            if (isdefined(level.var_5fc0b631[key])) {
                level.var_5fc0b631[key].tracked = 1;
            }
            id = objectives::function_285e460(key);
            if (isdefined(id)) {
        ...
        if (isdefined(level.var_5fc0b631[key])) {
            level.var_5fc0b631[key].tracked = 0;
        }
        id = objectives::function_285e460(key);
        if (isdefined(id)) {
            objectives::hide(key);
...
// Size: 0xf4
function function_5a785465(*var_248cbbcf) {
    namespace_353d803e::function_5865b09e();
...
function function_3a103505() {
    var_147d40f0 = getentarray("mental_map_poi", "targetname");
    for (i = 0; i < var_147d40f0.size; i++) {
        var_147d40f0[i] interactive_map::function_4b1a5235(#"confirm");
        switch (var_147d40f0[i].script_noteworthy) {
        case #"charkov_office":
            if (!level.var_5fc0b631[#"poison_tea"].tracked) {
                var_147d40f0[i] interactive_map::function_b5c2702b(#"confirm", level.var_a7c109a9);
            }
            break;
        case #"checkpoint":
            if (!level.var_5fc0b631[#"making_a_mole"].tracked) {
        ...
        case #"informant":
            if (namespace_94c47ce5::function_11b2b847() && !level flag::get("flag_informant_killed")) {
                var_147d40f0[i] interactive_map::function_b5c2702b(#"confirm", level.var_ac82c4c6);
            }
            break;
        default:
            break;
...
function function_eb745490() {
    objective_name = "poison_tea";
    level.var_5fc0b631[objective_name] = spawnstruct();
    level.var_5fc0b631[objective_name].tracked = 0;
...
function function_3657d953(objective_name) {
    level endon(#"flag_keycard_acquired");
    while (!isdefined(level.var_c2269c86)) {
        waitframe(1);
    }
...
function function_aecd702e(objective_name) {
    ...
    loc = struct::get("struct_obj_mule_guard", "targetname");
    objectives::goto(objective_name, loc.origin, undefined, 0);
    if (!level.var_5fc0b631[objective_name].tracked) {
        objectives::hide(objective_name);
    } else {
...
// Size: 0x22c
function function_eab15e43(*var_248cbbcf) {
    if (level flag::get("flag_tutorial_map_complete")) {
        return;
    }
    level flag::set("flag_tutorial_map_complete");
