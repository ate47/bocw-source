...
function private preinit() {
    ...
    foreach (str_type in var_1e935eba) {
        clientfield::register(str_type, "parabolic_mic_volume_scale", 1, 5, "float", &function_aecae07, 1, 0);
    }
...
// Size: 0x7e
function private function_aecae07(*localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwastimejump) {
