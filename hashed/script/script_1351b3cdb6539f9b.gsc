...
function function_c1e6a263() {
    ...
    #/
    self thread function_b0ea272(#"c_t9_usa_hero_adler_civ_amsterdam_body", #"hash_1b0d7f4da45c932e");
        ...
        while (true) {
            foreach (var_86275d63 in level.var_86275d63) {
                if (issubstr(tolower(var_86275d63.str), "<dev string:x28c>")) {
                    var_86275d63 settext(var_86275d63.str + level.var_731c10af.paths[#"hash_45556bb389e5f89d"].count);
                    continue;
                }
                if (issubstr(tolower(var_86275d63.str), "<dev string:x294>")) {
                    var_86275d63 settext(var_86275d63.str + level.var_731c10af.paths[#"hash_3512b8cb7be653a"].count);
                    continue;
                }
                ...
                if (issubstr(tolower(var_86275d63.str), "<dev string:x2b1>")) {
                    var_86275d63 settext(var_86275d63.str + level.var_731c10af.paths[#"hash_2dbc25fd2de2e651"].count);
                    continue;
                }
...
function force_weapon_loadout(area, visit) {
    ...
    case #"hash_45556bb389e5f89d":
        ...
        break;
    case #"hash_3bf8bed3f2ecbb16":
    case #"hash_3bf8c0d3f2ecbe7c":
    case #"hash_3bf8c1d3f2ecc02f":
    case #"hash_3bf8c3d3f2ecc395":
    case #"intro":
        weapon = getweapon(#"hash_32454fc6213eedd6");
        break;
    case #"hash_3512b8cb7be653a":
    case #"hash_60d5058a4ccfaa83":
    case #"hash_60d5068a4ccfac36":
    case #"hash_60d5078a4ccfade9":
    case #"hash_654c7af40c30e244":
    case #"hash_654c7bf40c30e3f7":
    case #"hash_654c7cf40c30e5aa":
...
function function_be6f6790(var_7bd31922, flag) {
    var_4c347a76 = struct::get_array(var_7bd31922, "script_noteworthy");
    foreach (struct in var_4c347a76) {
        wait randomfloatrange(0.5, 1);
        level thread scene::play(struct.targetname, "init");
    }
    var_c116fb71 = getent(var_7bd31922 + "_damage_trigger", "targetname");
    if (isdefined(flag)) {
        util::waittill_any_ents(level, flag, level, "flag_in_end_path", var_c116fb71, "trigger");
    } else {
        util::waittill_any_ents(level, "flag_in_end_path", var_c116fb71, "trigger");
    }
    foreach (struct in var_4c347a76) {
...
function private function_f78628e6() {
    ...
    while (true) {
        ...
        wait 0.5;
        thread namespace_b6fe1dbe::function_ed35c97e();
        self arcade_machine::play();
        self arcade_machine::function_71510186();
        thread namespace_b6fe1dbe::function_9861efff();
