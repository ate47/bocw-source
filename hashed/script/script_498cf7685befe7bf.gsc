...
function function_4a3de7f5(var_57ef78ed) {
    ...
    if (var_57ef78ed != "courtyard") {
        ...
        level.player function_e0c7d69(0);
    ...
    if (var_57ef78ed != "courtyard") {
        ...
        level waittill(#"hash_86d56378f10dd44");
...
// Size: 0x20c
function function_1b38152a(var_5e907852) {
    level waittill(#"hash_b491ea1039553f7");
    level thread scene::play("scene_sge_1010_apr_intro", "Truck_Exit", var_5e907852);
    level waittill(#"hash_45a489d348cab436");
    level thread scene::play("scene_sge_1010_apr_intro", "Truck_Exit2", var_5e907852);
    level waittill(#"hash_45a489d348cab436");
    level thread scene::play("scene_sge_1010_apr_intro", "Truck_Exit3", var_5e907852);
    level waittill(#"hash_45a489d348cab436");
    level thread scene::play("scene_sge_1010_apr_intro", "Truck_Exit4", var_5e907852);
    level waittill(#"hash_45a489d348cab436");
    level thread scene::play("scene_sge_1010_apr_intro", "Truck_Exit5", var_5e907852);
    level waittill(#"hash_45a489d348cab436");
    level thread scene::play("scene_sge_1010_apr_intro", "Truck_Exit6", var_5e907852);
    level waittill(#"hash_45a489d348cab436");
    level thread scene::play("scene_sge_1010_apr_intro", "Truck_Exit7", var_5e907852);
    level waittill(#"hash_45a489d348cab436");
    level thread scene::play("scene_sge_1010_apr_intro", "Truck_Exit8", var_5e907852);
}
...
// Size: 0x54
function scene_sge_6010_int_juggernaut_intro(var_94a8ce16) {
    var_5e907852 = [];
    var_5e907852[#"hash_7dff81d726898790"] = var_94a8ce16;
    level thread scene::play("scene_sge_6010_int_juggernaut_intro", "intro", var_5e907852);
}
...
function function_e969ae51(var_c31a6f62, ai_enemy, var_fa359e06) {
    ...
    var_5e907852 = [];
    var_5e907852[#"hash_2c76c3576b102f5"] = var_c31a6f62;
    var_5e907852[#"actor 1"] = ai_enemy;
    ...
    level scene::play(var_fa359e06, "killed", var_5e907852);
}
...
function function_ab89d5ef(var_c31a6f62, ai_enemy, var_fa359e06) {
    ...
    var_5e907852[#"hash_2c76c3576b102f5"] = var_c31a6f62;
    var_5e907852[#"actor 1"] = ai_enemy;
    level scene::play(var_fa359e06, "idle", var_5e907852);
}
...
function function_beb5d779(var_c31a6f62, ai_enemy, var_fa359e06) {
    ...
    level scene::play(var_fa359e06, "fire", var_5e907852);
    level thread function_ab89d5ef(var_c31a6f62, ai_enemy, var_fa359e06);
}
...
function function_c09d041f(var_c31a6f62, ai_enemy, var_fa359e06) {
    ...
    var_5e907852[#"hash_2c76c3576b102f5"] = var_c31a6f62;
    var_5e907852[#"actor 1"] = ai_enemy;
    level scene::play(var_fa359e06, "exit", var_5e907852);
