...
function private function_4ba28b7e(s_instance) {
    ...
    s_instance.var_85c920d0.s_instance = namespace_8b6a9d79::function_f3d93ee9(s_spawn, #"hash_7c38d5db2819b6f8");
...
function private function_6f4653fd(player) {
    ...
    n_time = 1.2;
    var_ea405096 = function_a3f6cdac(48);
...
function private function_a1ce8017(var_85c920d0) {
    ...
    while (isdefined(var_85c920d0)) {
        ...
        if (!isplayer(s_result.attacker)) {
            var_85c920d0.health.var_85c920d0 = var_85c920d0.health + s_result.amount;
            continue;
        }
        ...
        if (isdefined(var_570564b8)) {
            var_85c920d0.health.var_85c920d0 = var_85c920d0.health - var_570564b8;
        }
        ...
        if (var_85c920d0.health <= 1) {
            ...
            var_ec6368f9 = namespace_58949729::function_257d7203(#"hash_72d4f2ad2e333eb4");
            var_2858caa2 = {#var_738dfc81:3, #angles:var_85c920d0.angles, #origin:var_85c920d0 gettagorigin("j_spineupper")};
            var_2858caa2 thread namespace_65181344::function_fd87c780(var_ec6368f9, 3, 2);
            a_players = function_a1ef346b(undefined, var_2858caa2.origin, 2000);
            foreach (player in a_players) {
                player zm_stats::increment_challenge_stat(#"hash_6108873685067f70");
            }
            waitframe(1);
