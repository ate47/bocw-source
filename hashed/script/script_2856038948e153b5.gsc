...
#namespace namespace_a01bd292;

// Namespace namespace_a01bd292/namespace_17fbbb5
// Params 1, eflags: 0x0
...
function function_9074c842(*params) {
    ...
    var_eabfdd64 = snd::function_9ae4fc6f("vox_cp_rkgb_05100_rms1_youaresurrounde_83", detonate_gas_speaker_org.origin);
}
...
function function_ba2191eb() {
    ...
    wait 1;
    detonate_gas_speaker_org = struct::get("detonate_gas_speaker_org", "targetname");
    var_eabfdd64 = snd::function_9ae4fc6f("vox_cp_rkgb_05100_rms1_dropyourweapons_cf", detonate_gas_speaker_org.origin);
    snd::function_2fdc4fb(var_eabfdd64);
    wait 2;
    detonate_gas_speaker_org = struct::get("detonate_gas_speaker_org", "targetname");
    var_eabfdd64 = snd::function_9ae4fc6f("vox_cp_rkgb_05100_rms1_thisisyourfinal_f1", detonate_gas_speaker_org.origin);
}
...
function function_7fa2d5b9() {
    ...
    level.player val::set(#"hash_4b6a2a3308c1b1e3", "disable_weapon_fire", 1);
    level.player val::set(#"hash_4b6a2a3308c1b1e3", "disable_weapon_reload", 1);
    level.player val::set(#"hash_4b6a2a3308c1b1e3", "disable_weapon_cycling", 1);
    level.player val::set(#"hash_4b6a2a3308c1b1e3", "disable_offhand_weapons", 1);
    level.player val::set(#"hash_4b6a2a3308c1b1e3", "disable_offhand_special", 1);
    level.player val::set(#"hash_4b6a2a3308c1b1e3", "allow_ads", 0);
    wait 0.5;
    ...
    level thread namespace_353d803e::function_e85d8e93();
    wait 2.5;
    wait 1;
    ...
    level.player val::reset_all(#"hash_4b6a2a3308c1b1e3");
}
