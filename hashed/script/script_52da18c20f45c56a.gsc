...
// Size: 0xb4
function function_77af90aa(var_cf230c0, var_8afc2ef3) {
    self detachall();
    if (isdefined(var_cf230c0)) {
        /#
            assert(isdefined(var_8afc2ef3));
        #/
        /#
            assert(var_cf230c0.size == var_8afc2ef3.size);
        #/
        for (i = 0; i < var_cf230c0.size; i++) {
            self attach(var_cf230c0[i], var_8afc2ef3[i], 1);
        }
    }
}
...
function function_e4df1bec(duration) {
    self thread namespace_ca99987f::function_86ac55c5("bg_viewBobAmplitudeStanding", self.var_74c52b3d.var_c9e720e2, duration, "linear");
    self thread namespace_ca99987f::function_86ac55c5("bg_bobMax", self.var_74c52b3d.var_14a70876, duration, "linear");
    self thread namespace_ca99987f::function_86ac55c5("bg_bobTransTime", self.var_74c52b3d.var_945795a5, duration, "linear");
}
...
function function_9123bbf0() {
    self val::function_e681e68e(#"hash_681a4eb9df49482f");
...
function function_2795d678(encumbered, var_165b239b, var_37e68004, allow_ads, var_6a87e928) {
    ...
    if (encumbered) {
        if (!isdefined(player.var_74c52b3d)) {
            ...
            if (var_165b239b) {
                if (var_37e68004) {
                    ...
                    if (isdefined(pistol)) {
                        player.var_74c52b3d.var_e191cfdc = player getweaponslist();
                ...
                if (isdefined(player.var_74c52b3d.var_e191cfdc)) {
                    foreach (weap in player.var_74c52b3d.var_e191cfdc) {
        ...
        if (isdefined(player.var_74c52b3d)) {
            ...
            self namespace_f48ab2e1::function_398ab9eb();
...
function function_eef2dca9(guys) {
    ...
    var_17813638.origin.var_17813638 = self.origin + self getvelocity() * float(function_60d95f53()) / 1000;
    if (!isdefined(guys)) {
        guys = [];
...
// Size: 0x266
function function_b82cae8f(var_eeab05cf, var_5596253c = 1) {
    offset = vectorscale((0, 0, -1), 60);
    player = getplayers()[0];
    if (self.var_47f0a724 === 2) {
        offset = (0, 0, 0);
    }
    if (is_true(var_eeab05cf) && self.var_47f0a724 !== var_eeab05cf) {
        self clientfield::set("link_to_camera", var_eeab05cf);
        self.var_47f0a724 = var_eeab05cf;
    } else if (!is_true(var_eeab05cf) && is_true(self.var_47f0a724)) {
        self clientfield::set("link_to_camera", 0);
        if (is_true(var_5596253c)) {
            origin = player getplayercamerapos();
            angles = player getplayerangles();
            axis = function_237971e2(angles);
...
// Size: 0x316
function function_6cd69890(allowed, forced, gesture, var_dfce6e2d) {
    if (!allowed) {
        ...
        if (is_true(forced) || self.var_15c4009c <= 0) {
            self val::function_e681e68e(#"hash_1759513a118d68fd");
            ...
            if (!function_1c2cb657(self getcurrentweapon())) {
                if (isdefined(gesture)) {
                    ...
                    self thread function_e4d5a38c(self.var_621f8539);
                }
            }
...
function function_b5d8286c(action, var_17813638, var_3c30cb35, anim_name, victim, phase) {
    ...
    foreach (ent in var_3c30cb35) {
        ...
        ent.var_3f4de57b.ent = level.var_f467e5b0.var_dc27586e[ent.animname][var_fc8116b2.anim_name];
...
function function_3f4de57b(var_d1b14335, blendtime = isdefined(level.var_f467e5b0.blend[self.animname][var_d1b14335]) ? level.var_f467e5b0.blend[self.animname][var_d1b14335] : 0.2, var_df65246e = 1) {
    ...
    self endon(#"death", #"hash_29b88049dcac8bb3", #"hash_23e6132220ac0e4d");
    var_b256c7f3 = level.var_f467e5b0.var_dc27586e[self.animname][var_d1b14335];
    /#
        assert(isdefined(var_b256c7f3));
    #/
    self thread animation::play(var_b256c7f3, self.origin, self.angles, 1, blendtime, blendtime);
    self.var_3f4de57b = var_b256c7f3;
    wait(getanimlength(var_b256c7f3));
    self.var_3f4de57b = undefined;
    if (var_df65246e) {
        self clearanim(var_b256c7f3, blendtime);
    }
}
...
function function_d621e6d6(var_eea30707, blendtime) {
    if (isdefined(self.var_d621e6d6) && self.var_d621e6d6 == level.var_f467e5b0.var_dc27586e[self.animname][var_eea30707]) {
        return;
    }
    if (!isdefined(blendtime)) {
    ...
    var_d5bcc254 = level.var_f467e5b0.var_dc27586e[self.animname][var_eea30707];
...
function function_462c34d0(action, var_17813638, anim_name, victim, phase) {
    ...
    if (isdefined(var_b3d30f5f)) {
        ...
        if (isdefined(var_b3d30f5f[1])) {
            result.var_17813638.result = var_b3d30f5f[1];
            result.var_5e5653b2.result = 1;
        }
        result.var_da0c6cb.result = 1;
    }
...
function function_1c2992ed(enabled) {
    ...
    if (var_4f735d6e && !var_49b6c927) {
        ...
        self namespace_ca99987f::function_86ac55c5("bg_aimSpreadScale", 1, 0.2, 0.2, #"sine");
        self function_800493d4(45, 90);
    } else if (!var_4f735d6e && var_49b6c927) {
        self clientfield::set_to_player("fake_ads", 0);
        self namespace_ca99987f::function_86ac55c5("bg_aimSpreadScale", 1, 1, 0.2, #"sine");
        self function_800493d4(90, 260);
    }
}
...
// Size: 0x2c2
function function_c0f7b46e(fullbody, *var_df65246e, var_eeab05cf = 1) {
    /#
        assert(isplayer(self));
    #/
    ...
    self.var_6639d45b function_b82cae8f(var_eeab05cf);
...
// Size: 0x94
function function_464d0412(fullbody, var_4c384fa8, var_df65246e, var_eeab05cf) {
    /#
        assert(isplayer(self));
    #/
    self function_c0f7b46e(fullbody, var_df65246e, var_eeab05cf);
...
function private function_6f3e9127(gesture, target, var_584fcd3e, *blendtime, starttime, var_8021ec1b, stopall) {
    ...
    /#
        assert(function_b72088f(target));
    #/
...
// Size: 0xac
function function_e4d5a38c(gesture, *var_f4367b74, var_8021ec1b) {
    if (!isdefined(var_f4367b74)) {
        return;
    }
    if (isdefined(var_f4367b74) && function_b72088f(var_f4367b74)) {
        self notify(var_f4367b74 + "_stop");
        self stopgestureviewmodel(var_f4367b74, 0, var_8021ec1b);
    } else if (isdefined(var_f4367b74)) {
        /#
            iprintln("39ccfd1ac8ddccb" + var_f4367b74 + "<unknown string>");
        #/
    }
}
...
// Size: 0x4e4
function function_71180c30(var_b0f77e9f) {
    if (!isdefined(self)) {
        return;
    }
    /#
    ...
    #/
    victim = self;
    if (is_true(var_b0f77e9f) && !isdefined(victim.var_419b4b2)) {
        victim flag::set("in_action");
        victim.var_419b4b2.victim = spawnstruct();
        ...
        victim.var_419b4b2.var_bcf995f7 = victim.var_bcf995f7;
        ...
        victim.ignoreme.victim = 1;
        victim.syncedmeleetarget = undefined;
        victim.var_6eed8aea.victim = 0;
        victim.var_bcf995f7.victim = 1;
        victim.diequietly.victim = 1;
        ...
        if (!is_true(victim.var_b87d150b)) {
            victim thread util::magic_bullet_shield();
        }
        victim lookatpos(undefined);
        victim notsolid();
        victim setforcenocull();
        victim.var_e9c62827.victim = 1;
    } else if (isdefined(victim.var_419b4b2)) {
        victim thread function_91639a4c(0);
        victim.ignoreall.victim = victim.var_419b4b2.ignoreall;
        victim.ignoreme.victim = victim.var_419b4b2.ignoreme;
        victim.var_6eed8aea.victim = victim.var_419b4b2.var_6eed8aea;
        victim.var_fb9a2c03 = undefined;
        victim solid();
        victim removeforcenocull();
        victim.var_e9c62827.victim = victim.var_419b4b2.var_e9c62827;
        victim.var_bcf995f7.victim = victim.var_419b4b2.var_bcf995f7;
        victim.diequietly.victim = victim.var_419b4b2.diequietly;
...
function function_1a2a3654() {
    ...
    foreach (weapon in self getweaponslist()) {
        if (weapon !== currentweapon && !function_a06867b0(weapon)) {
            var_b71dd5c4 = self getweaponammoclip(weapon);
            if (!isdefined(result) || var_b71dd5c4 > var_b0e9905e) {
                result = weapon;
                var_b0e9905e = var_b71dd5c4;
            }
        }
    }
    return result;
...
function private function_cc15d11(time) {
    ...
    self val::function_e681e68e(#"hash_1ac08695042a6154");
}
...
function function_29fd0abd() {
    ...
    #/
    var_9463444 = self getcurrentweapon();
    if (!is_true(var_9463444.aimdownsight)) {
        return 0;
    }
