...
function function_30c823be() {
    ...
    if (is_true(self.var_c588eb)) {
        self.var_32309360 = [2:#"hash_3b6d1c08e7c833bc", 1:#"hash_5140769be6e96c4b", 0:#"hash_8536b11dd736e92"];
        self.var_41ab433a = [2:#"hash_5f0763114ded2197", 1:#"hash_5d4fa8ff5ae6d69e", 0:#"hash_3875479bd5ec9589"];
    }
...
function function_2038df41(entity) {
    ...
    var_77f55611 = entity gettagangles("j_head");
    model = util::spawn_model(#"hash_5329fae525fc210", tag_origin, var_77f55611);
    model linkto(entity, "j_head", origin_offset, var_24af7a37);
    model ghost();
    model.parent = entity;
...
function private function_3ee90301() {
    ...
    while (isdefined(self) && isdefined(self.parent)) {
        self.parent flag::wait_till_any([1:#"hash_206c17809d21c1f8", 0:#"hash_6e15049502d1637a"]);
        if (!isdefined(self.parent)) {
            return;
        }
        if (self.parent flag::get_any([1:#"hash_206c17809d21c1f8", 0:#"hash_6e15049502d1637a"])) {
            self notsolid();
        }
        self.parent flag::wait_till_clear_all([1:#"hash_206c17809d21c1f8", 0:#"hash_6e15049502d1637a"]);
        if (!isdefined(self.parent)) {
            return;
        }
        if (!self.parent flag::get_all([1:#"hash_206c17809d21c1f8", 0:#"hash_6e15049502d1637a"])) {
            var_a4b0369c = 0;
...
function function_a1e5b1db(*einflictor, eattacker, idamage, *idflags, smeansofdeath, weapon, *var_fd90b0bb, vpoint, *vdir, shitloc, *psoffsettime, *boneindex, *surfacetype) {
    ...
    if (isdefined(weakpoint) && weakpoint.type === #"weakpoint" && namespace_81245006::function_f29756fe(weakpoint) !== 3) {
        ...
        if (function_a5cc03cf(weakpoint, vdir, vpoint) && !is_true(self.var_c588eb)) {
            ...
            var_8d253a4b = 0.333333 * var_8e455c43;
...
function private function_a5cc03cf(weakpoint, var_31e96b81, *eattacker) {
    var_5f61b252 = 0;
    if (var_31e96b81.type === #"weakpoint" && var_31e96b81.var_292e2bf1 === 1) {
        var_8e455c43 = function_fc845eb6(self);
        var_e5da1214 = 0;
...
function function_bea34373(entity, head_index) {
    ...
    entity.var_3539aa66.entity = gettime();
    entity.var_7ba69527.entity = 1;
...
function function_261709aa(entity, attack, var_1ec63d3d) {
    ...
    if (isdefined(entity.var_95721b4e[attack])) {
        var_b4943dff = entity.var_95721b4e[attack] - gettime();
        var_d916543d = var_b4943dff - var_1ec63d3d;
        function_9de20709(entity, attack, var_d916543d);
        /#
            if (is_true(level.var_bb61089c)) {
                println("<unknown string>" + "<unknown string>" + attack + "<unknown string>" + float(var_d916543d) / 1000);
            }
        #/
    }
}
...
function function_69623844(entity) {
    ...
    if (isdefined(enemy)) {
        ...
        if (var_f08cc1e0 === 2 && distancesquared(enemy.origin, entity.origin) > function_a3f6cdac(600) && !entity cansee(enemy) && key_zmb_ke > int(3 * 1000) * 2) {
            var_f08cc1e0 = var_f08cc1e0 - 1;
        }
    }
    ...
    if (!entity flag::get(#"hash_42f4206825b6195")) {
        ...
        entity.var_37c36f39.entity = gettime();
...
function function_209f64c3(entity, asmstatename) {
    ...
    entity.var_ccd1e8c.entity = gettime();
    function_9de20709(entity, 0, int(20 * 1000));
    entity.var_4f5d39ac.entity = entity getvelocity();
    entity.var_2bd7ca9d.entity = 0;
    entity flag::clear(#"hash_5047ba8da693e1c5");
    entity.var_2976f01f.entity = entity.origin;
...
function function_132c087b(behaviortreeentity, *asmstatename) {
    ...
    /#
        if (getdvarint(#"hash_4e47873b8bfbca14", 0) > 0) {
            var_a03176d8 = trace[#"position"];
            var_7ce15329 = var_cb7d6f5 ? (1, 0, 0) : vectorscale((1, 1, 1), 0.75);
            function_af72dbc5(var_a03176d8, var_b76d460e, var_d7c27d70, asmstatename.angles[1], var_7ce15329);
            recordline(asmstatename.origin + trace_z_offset, var_a03176d8, var_7ce15329);
    ...
    if (var_49bf47e8 * 4 <= var_875531fe) {
        /#
            if (is_true(level.var_bb61089c)) {
                println("<unknown string>" + "<unknown string>" + sqrt(var_49bf47e8));
            }
        #/
        asmstatename.var_2bd7ca9d.asmstatename = 1;
    ...
    if (var_cb7d6f5) {
        ...
        asmstatename.var_2bd7ca9d.asmstatename = 1;
        asmstatename thread flag::set_for_time(2.5, #"hash_5047ba8da693e1c5");
        asmstatename.var_d86b94b3.asmstatename = {#normal:trace[#"normal"], #origin:trace[#"position"]};
        return 4;
    }
    if (!isdefined(var_53b2da60)) {
        /#
    ...
    if (var_49bf47e8 < 25 && gettime() > asmstatename.var_ccd1e8c + var_5ad0c90c) {
        /#
            if (is_true(level.var_bb61089c)) {
                println("<unknown string>" + "<unknown string>");
            }
    ...
    if (!isdefined(asmstatename.var_f1888c9d)) {
        asmstatename.var_f1888c9d.asmstatename = 0;
    }
    if (gettime() > asmstatename.var_f1888c9d) {
        ...
        asmstatename.var_f1888c9d.asmstatename = gettime() + int(var_6ff44b20 * 1000);
        enemy = undefined;
        if (isdefined(level.var_f67b08f5)) {
        ...
        var_7bafb710 = [];
        var_1142e3f3 = 1;
        var_3c08a493 = anglestoforward(asmstatename.angles);
        foreach (player in var_89cc0335) {
            if (isalive(player) && zombie_utility::is_player_valid(player, 1)) {
                if (!function_5020432f(asmstatename, player.origin, var_3c08a493)) {
                    var_1142e3f3 = 0;
                    break;
                }
            }
...
function function_25b49d18(entity, *asmstatename) {
    /#
        asmstatename.var_a8785ea7.asmstatename = 0;
    #/
...
function function_983f6134(entity) {
    if (distancesquared(entity.var_2976f01f, entity.origin) > function_a3f6cdac(100)) {
        return 1;
    }
...
function function_fc02984a(entity) {
    ...
    if (isdefined(enemy)) {
        var_de27dc69 = function_2981bd91(enemy.origin - entity.origin);
        var_6b2e389a = math::angle_dif(int(var_de27dc69), int(entity.angles[1]));
        if (var_6b2e389a > 160) {
            return 1;
        }
    }
...
function function_998c02dd(entity, asmstatename) {
    ...
    entity.var_aa722082.entity = gettime() + int(var_4d93e3bf * 1000);
    return 5;
}
...
function private function_2fe507a5(entity, var_9a4357f2, radius = 48, var_3a5ecec1 = 0) {
    if (!isdefined(entity.var_d2b407f6)) {
        entity.var_d2b407f6.entity = gettime();
    }
...
// Size: 0x1f4
function private function_a768119c(entity, player, var_84423b52) {
    if (!(isdefined(entity) && isdefined(player))) {
        return;
    }
    player playerknockback(1);
    var_3090e649 = vectornormalize(player.origin - var_84423b52);
    var_3090e649 = (var_3090e649[0], var_3090e649[1], 0.1);
    player applyknockback(int(100), var_3090e649);
    ...
    player dodamage(int(damage), var_84423b52, entity, entity, "torso_upper", "MOD_IMPACT");
...
function private function_e3ae0cb7(entity, var_9a4357f2) {
    ...
    foreach (vehicle in var_1378ec51) {
        ...
        var_7215755b = math::function_fe4f9da3(var_9a4357f2, vehicle function_2c662f72() + vehicle.origin, vehicle function_2a98d04f(), vehicle.angles);
        dist_sq = distancesquared(var_7215755b, var_9a4357f2);
        if (dist_sq < function_a3f6cdac(40 * var_9ce867db)) {
...
// Size: 0x1cc
function private function_6ccdd373(entity, vehicle, var_84423b52) {
    if (!(isdefined(entity) && isdefined(vehicle))) {
        return;
    }
    var_3090e649 = vectornormalize(vehicle.origin - var_84423b52);
    var_3090e649 = (var_3090e649[0], var_3090e649[1], 0.1);
    vehicle launchvehicle(var_3090e649 * 100, var_84423b52, 0);
    ...
    vehicle dodamage(int(damage), var_84423b52, entity, entity, undefined, "MOD_IMPACT");
}
...
function function_e75778ab(entity) {
    ...
    if (isdefined(level.var_87bca031)) {
        ...
        if (isdefined(enemy)) {
            ...
            if (var_a889803d > function_a3f6cdac(100)) {
...
function function_cc49b438(entity) {
    ...
    if (isdefined(enemy)) {
        var_a889803d = distance2dsquared(enemy.origin, entity.origin);
        var_ab811a0d = function_a3f6cdac(200);
...
function function_9d242adf(entity) {
    ...
    entity.var_dd3458a6.entity = gettime();
...
function function_a86617d() {
    ...
    foreach (player in nearby_players) {
        if (isdefined(self.var_f6fd2062) && ![[ self.var_f6fd2062 ]](player)) {
            jumpiftrue(is_true(player.var_b895a3ff)) LOC_000001e8;
        } else {
        LOC_000001e8:
            if (!isalive(player)) {
                continue;
    ...
    foreach (attackable in attackables) {
        ...
        attackable dodamage(var_bff5eef3 * 0.5, self.origin, self, self, 0, "MOD_MELEE", 0, self.weapon);
    }
    /#
        if (getdvarint(#"hash_4e47873b8bfbca14", 0) > 0) {
...
function private function_6bafca91(entity, head_index) {
    ...
    entity.var_2d502a2b.entity = gettime();
    if (head_index >= 0) {
...
function function_c0e34ca8(entity, asmstatename) {
    ...
    entity.var_f58807b8.entity = gettime() + var_a1346113;
...
function function_bcf8dd2a(entity, *asmstatename) {
    ...
    if (isdefined(enemy)) {
        ...
        if (var_7befcf25 < function_a3f6cdac(600)) {
...
function function_efb1766(entity, head_index) {
    ...
    if (var_84ed9a13.var_292e2bf1 !== 1) {
        return;
    }
    ...
    if (!isdefined(var_84ed9a13.var_b7fbe51b)) {
        ...
        #/
        var_84ed9a13.var_b7fbe51b.var_84ed9a13 = 0;
    }
    var_84ed9a13.var_2c5a8a86.var_84ed9a13 = var_84ed9a13.var_b7fbe51b;
    var_84ed9a13.var_b7fbe51b.var_84ed9a13 = 20;
    ...
    /#
        if (is_true(level.var_bb61089c)) {
            println("<unknown string>" + "<unknown string>" + head_index + "<unknown string>" + var_84ed9a13.var_b7fbe51b);
        }
    #/
}
...
function function_2c3c388d(entity, head_index) {
    ...
    var_84ed9a13.var_b7fbe51b.var_84ed9a13 = var_84ed9a13.var_2c5a8a86;
...
function private function_29abbe4c(entity) {
    ...
    /#
        if (!var_c81f5b16 !== get(#"hash_67c62575285677e4")) {
            /#
                if (is_true(level.var_bb61089c)) {
            ...
            if (function_17ae1df1(entity, head_index)) {
                ...
                if (isdefined(hit_ent)) {
                    if (isplayer(hit_ent)) {
                        ...
                        if (!var_b5caed86) {
                            ...
                            #/
                            entity.var_54529e1e.entity = gettime();
                            var_8104fad = 8;
                            ...
                            hit_ent.var_e12bf6a3.hit_ent = gettime();
                        }
                    } else if (hit_ent.var_6f84b820 === #"normal") {
                        hit_ent.allowdeath.hit_ent = 1;
                        hit_ent dodamage(hit_ent.health, hit_ent.origin, entity, entity, undefined, "MOD_ELECTROCUTED");
                        var_ab2fdbbc = gettime() + int(2 * 1000);
                        entity.var_16109727.entity = max(var_ab2fdbbc, entity.var_16109727);
                    } else if (hit_ent.var_6f84b820 === #"hash_72d4f2ad2e333eb4" || hit_ent.var_6f84b820 === #"special") {
                        hit_ent ai::stun(1);
                    }
                    hit_ent = isdefined(var_19a16eb0) ? var_19a16eb0 : hit_ent;
                ...
                if (isdefined(trace[#"position"])) {
                    ...
                    foreach (dynent in var_e86a4d9) {
                        ...
                        if (distancesquared(dynent.origin, closest_point) > function_a3f6cdac(var_7ee5d97a)) {
                            continue;
                        }
                        ...
                        if (isdefined(level.var_9fbe660b)) {
                            var_7f45fe8f = [[ level.var_9fbe660b ]](dynent);
                        }
...
function function_5a2447b1(time) {
    ...
    if (isdefined(result.corpse)) {
        result.corpse function_cb48cddd();
...
function function_acb229fd(entity) {
    ...
    if (dist_sq > function_a3f6cdac((util::get_game_type() == #"zsurvival" ? 1300 : 900) - 100) || dist_sq < function_a3f6cdac(300) && !is_true(entity.var_1fa24724)) {
        return 0;
    }
    if (dist_sq > function_a3f6cdac((util::get_game_type() == #"zsurvival" ? 1300 : 900) - 100 - 200)) {
...
function function_59685ed1(entity, asmstatename) {
    ...
    #/
    entity.var_16109727.entity = gettime() + int(var_72e6d5f * 1000);
    entity.var_526dce0b.entity = gettime();
    /#
        if (is_true(entity.var_308a238a)) {
    ...
    /#
        /#
            assert(!entity get(#"hash_67c62575285677e4"), "<unknown string>");
        #/
    #/
    if (!entity flag::get(#"hash_67c62575285677e4")) {
        /#
        ...
        entity.var_ac71e4ab.entity = (0, 0, 0);
        entity thread function_4ac5ff55(entity);
    }
    entity.var_76ae69b0.entity = 0;
    entity.var_67839366.entity = 0;
    return 5;
}
...
function function_58607a4e(behaviortreeentity, *asmstatename) {
    ...
    if (isdefined(enemy)) {
        ...
        asmstatename.var_ac71e4ab.asmstatename = (var_5782852e, var_78b0f832, 0);
        if (!asmstatename cansee(enemy) || abs(var_8b8deb51) > 45) {
            asmstatename.var_76ae69b0.asmstatename = asmstatename.var_76ae69b0 + float(function_60d95f53()) / 1000;
        } else {
            asmstatename.var_76ae69b0.asmstatename = 0;
        }
    }
    if (is_true(asmstatename.var_1fa24724)) {
        var_ab2fdbbc = gettime() + int(1 * 1000);
        asmstatename.var_16109727.asmstatename = max(var_ab2fdbbc, asmstatename.var_16109727);
    }
    if (!isdefined(asmstatename.var_9120e7f0)) {
        asmstatename.var_9120e7f0.asmstatename = var_df839f8e[1];
    }
    if (!isdefined(asmstatename.var_67839366)) {
        asmstatename.var_67839366.asmstatename = 0;
    }
    var_e54e9225 = math::angle_dif(int(asmstatename.var_9120e7f0), int(var_df839f8e[1]));
    if (var_e54e9225 < 5) {
        asmstatename.var_67839366.asmstatename = asmstatename.var_67839366 + float(function_60d95f53()) / 1000;
        asmstatename.var_9120e7f0.asmstatename = var_df839f8e[1];
    } else {
        asmstatename.var_67839366.asmstatename = 0;
    }
...
function private function_86e3dd7b(entity) {
    ...
    if (isdefined(enemy) && distancesquared(enemy.origin, entity.origin) < function_a3f6cdac(300)) {
        return var_c7c3c6f5;
    }
    return int(-1);
}
...
// Size: 0x66
function private function_5020432f(entity, point, var_3c08a493 = anglestoforward(entity.angles)) {
    return vectordot(var_3c08a493, point - entity.origin) < 0;
}
...
function private function_5427626d() {
    /#
        ...
        foreach (abom in aboms) {
            abom.var_a8785ea7.abom = !is_true(abom.var_a8785ea7);
        }
    #/
}
...
function private function_38b446e() {
    /#
        aboms = function_3ecd4ae();
        foreach (abom in aboms) {
            abom.var_c44e9122.abom = !is_true(abom.var_c44e9122);
        }
    #/
}
...
function private function_3da7e651() {
    /#
        aboms = function_3ecd4ae();
        foreach (abom in aboms) {
            abom.var_f5ffa31e.abom = !is_true(abom.var_f5ffa31e);
        }
    #/
}
...
function private function_bf8145a9() {
    /#
        aboms = function_3ecd4ae();
        foreach (abom in aboms) {
            abom.var_308a238a.abom = !is_true(abom.var_308a238a);
        }
    #/
}
...
function private function_dd021803() {
    /#
        aboms = function_3ecd4ae();
        foreach (abom in aboms) {
            abom.var_e76a75b4.abom = !is_true(abom.var_e76a75b4);
        }
    #/
}
    ...
    /#
        ...
        foreach (abom in aboms) {
            if (isdefined(level.var_8f1e0b55)) {
                abom [[ level.var_8f1e0b55 ]](vectorscale((0, 0, 1), 300), getplayers()[0]);
            }
        }
    #/
}
        ...
        while (1) {
            ...
            foreach (abom in aboms) {
                if (getdvarint(#"hash_647193278c68afe1", 0) > 0) {
                    var_127eca1 = [2:"<unknown string>", 1:"<unknown string>", 0:"<unknown string>"];
                    for (i = 0; i < 3; i++) {
                ...
                if (getdvarint(#"hash_1cd4bd84364131fc", 0) > 0) {
                    var_e7bff847 = abom get(#"hash_5c35337a4e15867") ? "<unknown string>" : "<unknown string>";
                    var_190e31e1 = abom get(#"hash_5c35337a4e15867") ? (0, 1, 0) : (1, 0, 0);
                    record3dtext(var_e7bff847, abom.origin + vectorscale((0, 0, 1), 70), var_190e31e1);
                }
            }
