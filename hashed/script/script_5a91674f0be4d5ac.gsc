...
#namespace namespace_e79df797;

// Namespace namespace_e79df797/cp_rus_duga_ambush
// Params 1, eflags: 0x0
...
function combat() {
    ...
    if (isdefined(level.var_deda09e)) {
        ...
        if (level.var_deda09e === "lazar") {
            ...
            level.lazar val::set(#"hash_5cdfba0959eb3c63", "ignoreme", 1);
        } else {
            a_heroes[2].propername = #"hash_a0d642b09afc71a";
            level.park = a_heroes[2];
            level.park val::set(#"hash_5cdfba0959eb3c63", "ignoreme", 1);
        }
    }
...
function function_9ea2e3bb(ents) {
    if (isdefined(ents[#"hash_7dff81d726898790"])) {
        ents[#"hash_7dff81d726898790"] setteam(#"allies");
    }
    if (isdefined(ents[#"hash_7dff84d726898ca9"])) {
        util::magic_bullet_shield(ents[#"hash_7dff84d726898ca9"]);
        ents[#"hash_7dff84d726898ca9"] setteam(#"allies");
        ents[#"hash_7dff84d726898ca9"] colors::set_force_color("o");
        ents[#"hash_7dff84d726898ca9"] thread function_f77073a0("enemy2_goal");
    }
    if (isdefined(ents[#"hash_7dff83d726898af6"])) {
        util::magic_bullet_shield(ents[#"hash_7dff83d726898af6"]);
        ents[#"hash_7dff83d726898af6"] setteam(#"allies");
        ents[#"hash_7dff83d726898af6"] colors::set_force_color("y");
    }
    if (isdefined(ents[#"hash_7dff86d72689900f"])) {
        util::magic_bullet_shield(ents[#"hash_7dff86d72689900f"]);
        ents[#"hash_7dff86d72689900f"] setteam(#"allies");
        ents[#"hash_7dff86d72689900f"] colors::set_force_color("o");
    }
...
function function_d5f016b9() {
    ...
    var_5e907852 = [level.woods, level.mason, level.adler, e_player];
    if (isdefined(level.var_deda09e)) {
        array::add(var_5e907852, level.var_c1881cdd);
    }
    function_1eaaceab(level.var_9a7fa939);
    function_1eaaceab(var_5e907852);
    var_5e907852 = arraycombine(level.var_9a7fa939, var_5e907852);
    ...
    level thread scene::play("scene_duga_ambush", "ambush", var_5e907852);
    ...
    e_player val::reset(#"hash_613ffa0c98c45219", "disable_weapon_fire");
    e_player val::reset_all(#"hash_74901644ca8bb461");
    e_player function_e0c7d69(1);
