...
#namespace namespace_8d91c4fb;

// Namespace namespace_8d91c4fb/namespace_8d91c4fb
...
function private function_838bf43a() {
    ...
    var_336c9e35 = array::random([2:#"hash_72caed16ec4793c3", 1:#"hash_72caee16ec479576", 0:#"hash_72caef16ec479729"]);
...
function function_2a5a3ef4() {
    if (is_true(self.var_c0d80964) && isdefined(level.var_56e22cfa.leader.origin) && distance2d(self.origin, level.var_56e22cfa.leader.origin) < 300) {
        return;
    }
...
function function_b4b07ee0() {
    if (!zm_vo::function_c10c4064(function_a1ef346b()[0])) {
        str_vo_alias = array::random([9:#"hash_1bcf3cf758a0d1e1", 8:#"hash_1bcf3bf758a0d02e", 7:#"hash_1bcf36f758a0c7af", 6:#"hash_1bcf35f758a0c5fc", 5:#"hash_1bcf38f758a0cb15", 4:#"hash_1bcf37f758a0c962", 3:#"hash_1bcf32f758a0c0e3", 2:#"hash_1bcf31f758a0bf30", 1:#"hash_1bcf34f758a0c449", 0:#"hash_1bcf33f758a0c296"]);
        self clientfield::set("" + #"hash_703543ca871a0f75", 2);
...
function function_37c7631f() {
    if (!level flag::get(#"hash_12b8597c686caf6b") && !zm_vo::function_c10c4064(function_a1ef346b()[0])) {
        str_vo_alias = array::random([5:#"hash_236205613957cf49", 4:#"hash_236204613957cd96", 3:#"hash_236207613957d2af", 2:#"hash_236206613957d0fc", 1:#"hash_236209613957d615", 0:#"hash_236208613957d462"]);
        self clientfield::set("" + #"hash_703543ca871a0f75", 2);
        self zm_vo::function_d6f8bbd9(str_vo_alias, 0, undefined, 1);
        if (isdefined(self)) {
            self clientfield::set("" + #"hash_703543ca871a0f75", 1);
...
function function_6a1fe73a() {
    if (math::cointoss(25) && !level flag::get(#"hash_4c4ab309f734048b") && !level flag::get(#"hash_5b98233c3cce07d5") && !level flag::get(#"hash_7ddb901c2b09aeaa") && !zm_vo::function_c10c4064(function_a1ef346b()[0])) {
        ...
        var_e823bd96 = [5:#"hash_3d172df7ccf92c6a", 4:#"hash_3d172ef7ccf92e1d", 3:#"hash_3d1727f7ccf92238", 2:#"hash_3d1728f7ccf923eb", 1:#"hash_3d1729f7ccf9259e", 0:#"hash_3d172af7ccf92751"];
...
function function_63803452() {
    if (math::cointoss(15) && !level flag::get(#"hash_5b98233c3cce07d5") && !level flag::get(#"hash_4c4ab309f734048b") && !level flag::get(#"hash_7ddb901c2b09aeaa") && !zm_vo::function_c10c4064(function_a1ef346b()[0])) {
        ...
        var_e823bd96 = [7:#"hash_15671b0e7f85fc44", 6:#"hash_15671c0e7f85fdf7", 5:#"hash_15671d0e7f85ffaa", 4:#"hash_15671e0e7f86015d", 3:#"hash_1567170e7f85f578", 2:#"hash_1567180e7f85f72b", 1:#"hash_1567190e7f85f8de", 0:#"hash_15671a0e7f85fa91"];
...
function function_c5fed573(var_41117948, var_80e90d4a, var_e9c89033) {
    switch (level.var_114b6e35) {
    case #"hash_5ffe700dd741b544":
        var_52dbcd71 = array::random(var_41117948);
        return var_52dbcd71;
        break;
    case #"hash_185ba0de5a57e721":
        var_52dbcd71 = array::random(var_80e90d4a);
        return var_52dbcd71;
        break;
    case #"hash_1d2cea720eda68b7":
        var_52dbcd71 = array::random(var_e9c89033);
        return var_52dbcd71;
        break;
    }
}
...
function function_b7e4011() {
    ...
    wait(1);
    level flag::wait_till(#"hash_6a3a958a656bf30a");
...
function private function_aa08591f() {
    ...
    if (level flag::get(#"hash_42a794a7ae5f7e22")) {
...
function private function_7608148() {
    level endon(#"end_game", #"hash_1a6711afd0c82794", #"hash_42a794a7ae5f7e22");
    ...
    while (1) {
        ...
        if (isdefined(e_player) && level flag::get(#"hash_279a97271de2b7e1") && distance2dsquared(e_player.origin, level.var_56e22cfa.origin) <= 65536) {
            level.var_56e22cfa zm_vo::function_d6f8bbd9("vox_zber_mq5_ant_hint_klau_0", 0, undefined, 1);
            break;
        }
    }
}
...
function private function_a1c4a0a3() {
    level endon(#"end_game", #"hash_33dc9c7e0eb8e450", #"hash_42a794a7ae5f7e22");
    level flag::wait_till(#"hash_6cbfffe3a19f4f23");
    while (1) {
        waitresult = undefined;
        ...
        if (isdefined(e_player) && level flag::get(#"hash_279a97271de2b7e1") && distance2dsquared(e_player.origin, level.var_56e22cfa.origin) <= 65536) {
            level.var_56e22cfa zm_vo::function_d6f8bbd9("vox_zber_mq5_wrebrd_hint_klau_0", 0, undefined, 1);
            break;
        }
    }
}
...
function private function_c6e4a904() {
    level endon(#"end_game", #"hash_724f7a255c955ed1", #"hash_42a794a7ae5f7e22");
    level flag::wait_till(#"hash_6cbfffe3a19f4f23");
    while (1) {
        waitresult = undefined;
        ...
        if (isdefined(e_player) && level flag::get(#"hash_279a97271de2b7e1") && distance2dsquared(e_player.origin, level.var_56e22cfa.origin) <= 65536) {
            level.var_56e22cfa zm_vo::function_d6f8bbd9("vox_zber_mq5_trns_hint_klau_0", 0, undefined, 1);
            break;
        }
    }
}
...
function private function_3d7931b9() {
    level endon(#"end_game");
    level waittill(#"hash_42a794a7ae5f7e22");
...
function private function_a465a7b3() {
    ...
    if (isdefined(level.var_56e22cfa)) {
        level.var_56e22cfa zm_vo::function_d6f8bbd9("vox_zber_mq5_dsrpt_hint_klau_0", 0, undefined, 1);
    }
}
    ...
    while (1) {
        if (level flag::get(#"hash_6d16c284cbb301d1")) {
            ...
            foreach (player in a_players) {
                ...
                if ((player_zone === "zone_korber_roof" || player_zone === "zone_destroyed_upper_floors2") && isdefined(level.var_56e22cfa) && distance2dsquared(player.origin, level.var_56e22cfa.origin) <= 65536 && !level flag::get(#"hash_7ddb901c2b09aeaa")) {
                    level.var_56e22cfa.var_c0d80964 = 1;
                    level.var_56e22cfa zm_vo::function_d6f8bbd9("vox_zber_mq6_decru92_klau_0", 0, undefined, 1);
...
// Size: 0x13c
function function_e250a72f(str_vo, var_385ce850 = level.var_56e22cfa, var_19e310da = 0) {
    level endon(#"end_game");
...
// Size: 0x23e
function function_5a98963a(var_c860e2f) {
    if (!isdefined(var_c860e2f)) {
        return 0;
    }
    var_db1c83a1 = getentarray("klaus_interact", "script_noteworthy");
    foreach (interact in var_db1c83a1) {
        dist = distance2dsquared(var_c860e2f, interact.origin);
        if (is_true(interact.is_active) && dist <= function_a3f6cdac(200)) {
            return 1;
        }
    }
    foreach (var_67fbb89d in level.var_44ff9e2) {
        dist = distance2dsquared(var_c860e2f, var_67fbb89d.origin);
        if (is_true(interact.is_active) && dist <= 4096) {
            return 1;
        }
    }
    var_96611cee = getent("stop_train_check_volume", "targetname");
    if (istouching(var_c860e2f, var_96611cee)) {
        return 1;
    }
    return 0;
}
