...
function function_efda2d6d() {
    ...
    if (isscriptfunctionptr(level._snd._callbacks[#"hash_212a61da2a09cf0"])) {
        vieworigin = player [[ level._snd._callbacks[#"hash_212a61da2a09cf0"] ]]();
    } else {
...
function function_731299e5() {
    ...
    #/
    fov = undefined;
    if (isscriptfunctionptr(level._snd._callbacks[#"hash_3a54d8132d425de4"])) {
        fov = player [[ level._snd._callbacks[#"hash_3a54d8132d425de4"] ]]();
    } else {
...
// Size: 0xd0
function function_783b69(s, var_14d1af73) {
    s = function_ea2f17d1(s, "");
    var_14d1af73 = function_ea2f17d1(var_14d1af73, "");
    str = "";
    /#
        if (ishash(s)) {
            if (var_14d1af73 != "<unknown string>") {
                str = "<unknown string>";
            }
            s = function_9e72a96(s);
        }
    #/
    str = str + var_14d1af73 + s + var_14d1af73;
    return str;
}
    ...
    while (isdefined(src) && isdefined(target)) {
        ...
        /#
            if (function_95c9af4b() > 0) {
                ...
                if (isfloat(var_9d415208)) {
                    var_597aa60f = var_597aa60f + "<unknown string>" + var_9d415208;
                    if (var_9d415208 > 0) {
...
function private function_afb43113(vector) {
    ...
    var_57531557 = 1 / var_d7a0aa89;
    var_35f90ba = vectorscale(var_35f90ba, var_57531557);
    return var_35f90ba;
}
...
// Size: 0x50
function function_c8caaab4(point, var_16a85d25, radius) {
    dist = distance(point, var_16a85d25);
    if (dist <= radius) {
        return 1;
    }
    return 0;
...
function function_160366e9(centerorigin, dist, var_3c67b910, var_cbf878e6) {
    ...
    var_3c67b910 = var_3c67b910 + 180;
    var_cbf878e6 = var_cbf878e6 + 270;
    var_8b98e431 = centerorigin[0];
    var_7dcdc89b = centerorigin[1];
    var_78163d2c = centerorigin[2];
    var_8b98e431 = var_8b98e431 + dist * sin(var_cbf878e6) * cos(var_3c67b910);
    var_7dcdc89b = var_7dcdc89b + dist * sin(var_cbf878e6) * sin(var_3c67b910);
    var_78163d2c = var_78163d2c + dist * cos(var_cbf878e6);
    position = (var_8b98e431, var_7dcdc89b, var_78163d2c);
    return position;
}
...
function function_95c9af4b() {
    /#
        if (isdefined(level._snd.var_88612b20.var_628ff174)) {
            return level._snd.var_88612b20.var_628ff174;
        }
    #/
    return 0;
}
