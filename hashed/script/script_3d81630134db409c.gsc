...
function function_c3ccbcc8(*str_objective) {
    ...
    level.var_7b4c584e forceteleport(var_b4bb921.origin, var_b4bb921.angles);
}
...
function function_eea0086d(*str_objective, var_50cc0d4f) {
    if (isalive(level.var_7b4c584e)) {
        level.var_7b4c584e delete();
    }
    ...
    if (!level flag::get("flg_fail_cp_proficient_yamantau")) {
        level.player stats::function_dad108fa(#"hash_3802ab82d2041fc9", 1);
    }
...
function function_4e376bb9(var_c5db42b9) {
    ...
    self waittill(#"stealth_combat", #"hash_39550364a879e1d4");
...
function function_4e75b98e(*str_objective, var_50cc0d4f) {
    ...
    level.var_7b4c584e forceteleport(var_a874ccde.origin, var_a874ccde.angles);
    ...
    level.var_7b4c584e setgoal(var_b9e9c95f);
    ...
    level.var_7b4c584e function_9ae1c50();
...
function function_bfc063c6() {
    ...
    level.var_7b4c584e waittill(#"goal");
    level thread scene::play("scene_yam_6010_grp_enter_react", "woods_table_idle", array(level.var_7b4c584e));
}
