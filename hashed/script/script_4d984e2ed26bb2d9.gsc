...
function function_3b57a70e() {
    ...
    level.var_7b4c584e linkto(level.var_17d7d4dc.var_121c5e14);
    level.var_7b4c584e thread scene::play("scene_yam_8020_sra_server_ascent_woods");
    ...
    level.var_7b4c584e thread scene::play("scene_yam_9010_out_heli_outro_woods", level.var_7b4c584e);
}
