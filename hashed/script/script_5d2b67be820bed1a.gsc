...
function function_df9f3034() {
    ...
    level.player thread namespace_78e9b80::function_15eaa2db(undefined, "cp_shared_vietnam_brainwash", "flag_player_approached_flashback_TV", "flag_player_not_in_darkroom", "flashback_tv_lookat", undefined, undefined, #"hash_12bd8292e3e6ebfe");
}
