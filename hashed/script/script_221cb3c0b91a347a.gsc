...
function function_64969e00() {
    ...
    #/
    /#
        assert(var_638ed7d7.var_a1cfeb06.size > 1, "<unknown string>");
    #/
...
function function_c6fdb204(var_15a51335) {
    ...
    #/
    var_15a51335.axis.var_15a51335 = {#right:anglestoright(var_15a51335.angles)};
    var_15a51335.width.var_15a51335 = isdefined(var_15a51335.width) ? var_15a51335.width : 100;
    var_15a51335.height.var_15a51335 = isdefined(var_15a51335.height) ? var_15a51335.height : -1;
    var_bfb91b7c = var_15a51335.axis.right * var_15a51335.width;
    var_15a51335.left.var_15a51335 = var_15a51335.origin - var_bfb91b7c;
    var_15a51335.right.var_15a51335 = var_15a51335.origin + var_bfb91b7c;
    /#
        assert(!isdefined(var_15a51335.index));
    #/
    var_15a51335.index.var_15a51335 = self.nodes.size;
    ...
    if (is_true(var_15a51335.checkpoint)) {
        if (!isdefined(self.var_a1cfeb06)) {
            self.var_a1cfeb06 = [];
        } else if (!isarray(self.var_a1cfeb06)) {
            self.var_a1cfeb06 = array(self.var_a1cfeb06);
        }
        if (!isinarray(self.var_a1cfeb06, var_15a51335)) {
            self.var_a1cfeb06[self.var_a1cfeb06.size] = var_15a51335;
        }
    }
    var_15a51335.state.var_15a51335 = 1;
}
    ...
    /#
        ...
        while (1) {
            if (getdvarint(#"hash_4f9bc320ac30703d", 0)) {
                ...
                n_height = var_15a51335.height < 0 ? var_15a51335.height : 100;
...
function function_e5d9dcfc(var_163bd9fc, var_27e17d47) {
    ...
    var_1ba29af7 = level.var_181464da.var_6d6e20de.var_a1cfeb06;
    ...
    var_1330233 = isdefined(var_163bd9fc.var_8307a35a.var_27972fb8) ? var_163bd9fc.var_8307a35a.var_27972fb8 : 2147483647;
    var_b64408e1 = isdefined(var_27e17d47.var_8307a35a.var_27972fb8) ? var_27e17d47.var_8307a35a.var_27972fb8 : 2147483647;
        ...
        for (i = 0; i < n_total; i++) {
            ...
            /#
                ...
                if (isdefined(var_55935bba)) {
                    ...
                    var_f5eb67b0 = sqrt(var_55935bba.var_27972fb8);
                    var_ba0b397c = "<unknown string>" + var_55935bba.node.index + "<unknown string>" + var_f5eb67b0;
                    var_a2d88df3 = "<unknown string>" + e_vehicle.var_1f06a135;
...
function function_e951ccfe(var_15a51335, n_time) {
    ...
    var_2ddc0533.last_pos.var_2ddc0533 = self.origin;
    var_2ddc0533.var_87324918 = var_a693b30e;
    var_2ddc0533.var_1a4cb070 = var_d2902d22;
    var_2ddc0533.var_27972fb8 = var_328fb11b;
    return var_2ddc0533;
}
...
function function_290d0461(var_ce9da91e) {
    ...
    if (var_ce9da91e.node === var_638ed7d7.var_a1cfeb06[self.var_1f06a135] && var_ce9da91e.var_1a4cb070 < 1600) {
        ...
        level notify(#"hash_4847149e99d2b54", {#var_319d6066:self.var_5b345137, #checkpoint:self.var_1f06a135, #vehicle:self});
        /#
            assert(var_638ed7d7.var_a1cfeb06.size > 1);
        #/
        self.var_1f06a135 = (self.var_1f06a135 + 1) % var_638ed7d7.var_a1cfeb06.size;
...
function private function_dc6e31a(var_836b8ec4) {
    var_57ef78ed = level.var_181464da.var_6d6e20de.var_a1cfeb06[var_836b8ec4];
...
function private function_7e0ee279() {
    ...
    if (isdefined(var_76f90141)) {
        var_c860e2f = var_76f90141.origin;
        s_trace = groundtrace(var_c860e2f + vectorscale((0, 0, 1), 50), var_c860e2f - vectorscale((0, 0, 1), 50), 0, self);
        if (isdefined(s_trace[#"position"])) {
            var_c860e2f = s_trace[#"position"];
        }
        self setbrake(1);
        if (isdefined(self.owner)) {
        ...
        self.origin = var_c860e2f + vectorscale((0, 0, 1), 8);
    ...
    if (state === "hide") {
        ...
        if (!isdefined(level.var_ee263952)) {
            ...
            foreach (var_26f7498 in var_e0a4c144) {
                ...
                mdl_door.script_angles.mdl_door = var_26f7498.script_angles;
                if (!isdefined(level.var_ee263952)) {
                    level.var_ee263952 = [];
...
function function_47bc03e4(e_player) {
    ...
    if (level flag::get(#"hash_7fa3d027663c32a9") && !zm_tungsten::function_1fd1da2b()) {
        ...
        return 1;
    } else if (level flag::get(#"hash_7fa3d027663c32a9") || zm_tungsten::function_1fd1da2b()) {
        self sethintstring(#"hash_4ffd78f80d372e1");
        return 1;
    } else if ((isdefined(self.stub.related_parent.var_4786038c) ? self.stub.related_parent.var_4786038c : 0) < gettime()) {
        self sethintstring("");
        return 0;
    } else if ((isdefined(e_player.var_a3210d75) ? e_player.var_a3210d75 : 0) > 0) {
...
function function_d48d77f2(s_point) {
    ...
    e_vehicle.targetname.e_vehicle = "gp_car";
...
function function_14256a2d() {
    ...
    while (1) {
        ...
        if (waitresult.var_319d6066 === 3 && waitresult.checkpoint === 3) {
...
// Size: 0x1ec
function function_dc71582(var_f0412557) {
    level endon(#"end_game");
    self endon(#"death");
    switch (var_f0412557) {
    case 3:
...
function function_619fdf5f() {
    ...
    foreach (s_pos in var_4db66606) {
        ...
        if (isdefined(point)) {
            ...
            var_4f434a9b.var_a6762160.var_fa988b4b = undefined;
        }
    }
}
...
function function_37f28f2b(*var_a276c861) {
    ...
    var_aebc6824.var_66c5aea4.var_aebc6824 = 1;
    ...
    var_d0426a23.var_52babeb3.var_d0426a23 = getent("e_burger_boy_left_panel", "targetname");
    var_d0426a23.var_d2835a9f.var_d0426a23 = getent("e_burger_boy_right_panel", "targetname");
        ...
        if (isplayer(player) && waitresult.mod === "MOD_EXPLOSIVE" && player namespace_e86ffa8::function_582d36be(5) && isdefined(damage) && damage >= 35) {
            if (is_true(self.var_66c5aea4) && isdefined(var_ca57b8dd)) {
                ...
                if (isdefined(point)) {
                    ...
                    var_6c4a7715.var_dd21aec2.var_6c4a7715 = 1 & 16;
                }
                break;
                ...
                var_2077a964 = function_d040bd9(var_ca57b8dd.origin, 36);
                if (isvec(var_2077a964) && isdefined(var_4d0b3b87)) {
                    n_power = length(var_2077a964 - var_ca57b8dd.origin);
                    var_4e2c4d20 = var_4d0b3b87 zm_utility::fake_physicslaunch(var_2077a964, n_power);
...
function function_8f75cb6a(*var_a276c861) {
    ...
    var_bb9fd562.var_af44ab5f.var_bb9fd562 = util::spawn_model(#"hash_7f311e8d38b7d936", var_bb9fd562.origin, var_bb9fd562.angles);
...
function function_a7236d71() {
    ...
    while (1) {
        foreach (player in getplayers()) {
            ...
            if (isdefined(dis) && dis <= function_a3f6cdac(870)) {
...
function function_ef77607f() {
    ...
    var_d0426a23 = getent("burger_boy", "targetname");
    var_d0426a23.var_57e65c03.var_d0426a23 = 0;
    var_d0426a23.var_97d37415.var_d0426a23 = util::spawn_model(#"hash_5079f3c7d659ff2", var_d0426a23.origin, var_d0426a23.angles);
...
function function_68a91082(target_entity) {
    ...
    foreach (player in function_a1ef346b()) {
        ...
        if (isdefined(dis) && dis > function_a3f6cdac(870 + 500) && !player laststand::player_is_in_laststand() && !player flag::get_any([1:#"hash_1b361b950317ecb5", 0:#"hash_686d5709e1566aa6"])) {
...
function function_21e8e6c8() {
    ...
    self.is_active = 1;
    self.var_b79a8ac7 = {#slots:slots, #var_f019ea1a:1500};
    ...
    #/
    level thread namespace_f3a74bbc::start_timer(120);
...
function function_12f0e19b(var_5a2c0004 = 0, var_5359b8ff = 0, n_spawn_count = undefined) {
    ...
    while (1) {
        ...
        if (var_5a2c0004) {
            ...
            ai_type = function_7d5a9a14();
        }
        if (isdefined(ai_type)) {
            var_ac6fac3 = spawnactor(ai_type, self.origin, self.angles, "burger_boy_zombie", 1);
        }
        if (isdefined(var_ac6fac3)) {
            var_ac6fac3.var_126d7bef.var_ac6fac3 = 1;
            var_ac6fac3.ignore_round_spawn_failsafe.var_ac6fac3 = 1;
            var_ac6fac3.b_ignore_cleanup.var_ac6fac3 = 1;
            var_ac6fac3.ignore_enemy_count.var_ac6fac3 = 1;
            var_ac6fac3.no_powerups.var_ac6fac3 = 1;
            var_ac6fac3 pathmode("move allowed");
            var_ac6fac3.completed_emerging_into_playable_area.var_ac6fac3 = 1;
            var_ac6fac3.zombie_think_done.var_ac6fac3 = 1;
...
function function_aa9da0e() {
    ...
    for (i = 0; i <= var_73a44ab8; i++) {
        ...
        if (isdefined(traceresult[#"position"])) {
            ...
            var_9917b0be = function_d040bd9(var_9917b0be, 50, 15);
        } else {
            waitframe(1);
            continue;
        }
...
function function_7c6752c8() {
    ...
    var_772c2945.var_dd21aec2.var_772c2945 = 1 & 16;
    var_772c2945.var_a6762160.var_fa988b4b = 35;
    ...
    if (is_true(var_2549cdb0)) {
        for (i = 0; i < var_ca0aefec.size; i++) {
            ...
            if (isdefined(s_screen.model)) {
                s_screen.mdl.s_screen = util::spawn_model(s_screen.model, s_screen.origin, s_screen.angles);
...
function function_4d5c7397(*var_a276c861) {
    ...
    var_55c78eeb.mdl.var_55c78eeb = util::spawn_model(#"hash_3962b0086020f11c", var_55c78eeb.origin, var_55c78eeb.angles);
...
function function_f905bbc1(n_num) {
    ...
    for (i = 1; i <= var_3709608a; i++) {
        ...
        if (!isdefined(s_little_girl.var_a1e4509e)) {
            s_little_girl.var_a1e4509e.s_little_girl = util::spawn_model(#"hash_46e513123e9c645f", var_cdbf56b2.origin, var_cdbf56b2.angles);
    ...
    while (1) {
        ...
        if (isdefined(spawn_loc)) {
            ...
            if (is_true(zm_zonemgr::zone_is_enabled(zone)) && is_true(level.zones[zone].is_active) && zm_utility::check_point_in_playable_area(spawn_loc)) {
                ...
                s_spawn_loc.angles.s_spawn_loc = vectortoangles(v_origin - spawn_loc);
                return s_spawn_loc;
            }
        }
        waitframe(1);
