        ...
        if (var_25d1f8b[i].classname == "info_volume" || var_25d1f8b[i].classname == "trigger_box") {
            ...
            foreach (node in var_d6702980) {
                ...
                if (isdefined(dropped[#"point"])) {
                    node.origin.node = dropped[#"point"];
                }
                node.origin.node = getclosestpointonnavmesh(node.origin, 200, 50);
            ...
            volume.var_2dfb472b.volume = [];
            volume.var_8b2a5592.volume = [];
            foreach (node in nodes) {
                floor = max(isdefined(int(node.floor)) ? int(node.floor) : 1, 0);
                while (floor >= volume.var_2dfb472b.size) {
                    volume.var_2dfb472b[volume.var_2dfb472b.size] = [0:undefined];
                }
            }
            ...
            if (isdefined(volume.var_1fa7d27e)) {
                volume.var_1fa7d27e.volume = int(volume.var_1fa7d27e);
            }
...
function function_eea7a68a(entity) {
    entity.enemy_override.entity = namespace_85745671::function_b67c088d();
...
function function_1ca9d31b(entity) {
    ...
    var_21bdf069 = function_a3f6cdac(isdefined(entity.var_c50d964) ? entity.var_c50d964 : entity getpathfindingradius());
    foreach (dynent in var_e86a4d9) {
        ...
        if (var_144ce0a0 || dynent.destructible) {
            ...
            var_7f45fe8f = namespace_85745671::function_5ba8b9d4(entity, var_21bdf069, dynent, bundle, state, var_144ce0a0);
        }
...
function zombieshouldmelee(entity) {
    ...
    var_dc0be666 = abs(entity.origin[2] - test_origin[2]);
    if (var_dc0be666 > (isdefined(entity.var_737e8510) ? entity.var_737e8510 : 64)) {
        return 0;
    }
    if (var_dc0be666 < (isdefined(entity.var_f7f0128b) ? entity.var_f7f0128b : 40)) {
...
function private function_bfc25c77(entity) {
    ...
    if (namespace_85745671::function_f4087909(startnode.var_597f08bf)) {
        entity.var_597f08bf.entity = startnode.var_597f08bf;
        return 1;
    }
    return 0;
}
...
function function_62fb515e(entity) {
    entity.var_62b4721.entity = gettime();
}
...
function private zombiemoveactionstart(entity) {
    ...
    entity.var_16b73748.entity = entity asmgetcurrentdeltaanimation();
    if (isdefined(entity.var_16b73748)) {
        entity.var_cb2a43c0.entity = getmovedelta(entity.var_16b73748) / getanimlength(entity.var_16b73748) * 0.5;
    }
    return 1;
}
...
function private function_7c8e35e8(entity, asmstate) {
    ...
    if (isdefined(entity.var_597f08bf)) {
        entity.var_a476b329.entity = entity.var_597f08bf.angles;
    }
    if (!isdefined(self.traversemantlenode)) {
        entity.var_df840b81.entity = 1;
    } else {
...
function private function_3f71b9c2(entity, *asmstate) {
    ...
    if (asmstate asmgetstatus() == "asm_status_running") {
        asmstate.var_fc781a6f.asmstate = 1;
    }
    return 4;
}
...
function function_8aa7d53(entity, *mocompanim, *mocompanimblendouttime, *mocompanimflag, *mocompduration) {
    ...
    mocompduration.var_910c3b2c.mocompduration = mocompduration.traversemantlenode.origin - vectornormalize(forward) * var_ce870aa5;
    mocompduration.var_910c3b2c.mocompduration = (mocompduration.var_910c3b2c[0], mocompduration.var_910c3b2c[1], mocompduration.traversalstartpos[2]);
...
function zombieupdategoal(goalpos) {
    ...
    if (is_true(self.var_4fe4e626)) {
        self.var_4fe4e626 = 0;
        shouldrepath = 1;
    } else if (!var_61cfbe48 && isdefined(self.var_9e6e6645) && distancesquared(self.var_9e6e6645, goalpos) > function_a3f6cdac(18)) {
        shouldrepath = 1;
        ...
        shouldrepath = 1;
    } else if (var_c7dee8e5 <= function_a3f6cdac(zigzag_activation_distance)) {
        shouldrepath = 1;
...
function function_da10cda3(start_pos, target_pos, entity) {
    ...
    if (!isdefined(var_2bd0375c)) {
        var_fe746d9d = arraygetclosest(start_pos, var_779f1a5a.entrance_nodes);
        var_bc4e29ad = isdefined(var_fe746d9d.floor) ? var_fe746d9d.floor : 1;
    } else {
