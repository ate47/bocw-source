...
function function_70a657d8() {
    ...
    if (level flag::get(#"hash_6d89e1456f61e5ab") || getdvarint(#"hash_c0b5b313ff35979", 0)) {
        if (!var_bc4a7f19) {
            namespace_f3a74bbc::function_b3464a7c(#"mq4", &function_9ad91439, &function_83ac5bc2, #"ee", #"hash_b418b036831ea2a", var_95613111, 3, #"hash_e747f276dd2bc6c");
            var_6e1b5f33 = 1;
        }
    }
    ...
    /#
        if (getdvarint(#"hash_c0b5b313ff35979", 0)) {
            ...
            level set(#"hash_4c9bb7a770c9e973");
            level set(#"hash_6d89e1456f61e5ab");
        }
        if (getdvarint(#"hash_5b906952bed5efee", 0)) {
            level set(#"hash_414ba7eb6d94978d");
            level set(#"hash_16f61b20c3d2c610");
        }
        if (getdvarint(#"hash_27ed0b721aab06a", 0)) {
            level set(#"hash_4b060b9820d4141d");
            level thread function_8375e4a7();
        }
    #/
}
...
function function_7cdcb903(instance) {
    ...
    var_2b357ce9.s_teleport.var_2b357ce9 = struct::get(var_2b357ce9.targetname, "target");
    var_edf7d1ed = 1;
...
function private function_6b9a56f7(var_2b357ce9, var_edf7d1ed, b_timeout = 1, n_radius = 160) {
    ...
    mdl_portal.instance.mdl_portal = var_2b357ce9.parent;
    ...
    trigger.instance.trigger = var_2b357ce9.parent;
    trigger.var_2b357ce9 = var_2b357ce9;
    trigger.mdl_portal = mdl_portal;
    trigger.var_3b53f898.trigger = 6;
    var_2b357ce9.trigger = trigger;
    var_2b357ce9.var_40803981.var_2b357ce9 = 1;
...
function private function_ada90340(var_2b357ce9) {
    ...
    var_90016943 = namespace_8b6a9d79::function_f3d93ee9(var_dce66956, #"hash_30876ea41ba82413");
    var_90016943.angles.var_90016943 = var_90016943.angles + vectorscale((0, -1, 0), 90);
    var_90016943 ghost();
    s_result = undefined;
...
function function_ba2ed0f6(instance) {
    ...
    namespace_8b6a9d79::function_f3d93ee9(var_28bf3706, #"hash_6f4bd8715d49e317", 0, 0);
    var_33c42924 = namespace_8b6a9d79::function_f3d93ee9(var_28bf3706, #"hash_45d5f1151627a0d2", 0, 0);
    ...
    instance.var_1c61fe4b.instance = instance.var_fe2612fe[#"hash_1288cb1c741f9798"][0];
    instance.var_a9ef21d.instance = namespace_8b6a9d79::function_f3d93ee9(instance.var_1c61fe4b, #"hash_20f9a15d3e077602");
...
function private function_f5f14ffe(instance) {
    ...
    namespace_8b6a9d79::function_f3d93ee9(level.var_2c678640, #"hash_7fb5646204aceaf6");
    level flag::wait_till(#"hash_414ba7eb6d94978d");
    ...
    wait(0.2);
    instance.var_af44ab5f.instance = namespace_8b6a9d79::function_f3d93ee9(level.var_2c678640, #"hash_7f311e8d38b7d936");
...
function private function_4cb97b84(eventstruct) {
    ...
    if (!is_true(self.b_activated)) {
        ...
        player thread namespace_3f4c38e1::function_4be8796(self.instance);
        player thread namespace_3f4c38e1::function_d52adbbc(self.instance);
...
function private function_63422d64() {
    ...
    self thread namespace_3f4c38e1::function_1a58f438();
...
function private function_99e393f3(instance) {
    s_orb = array::random(isdefined(instance.var_fe2612fe[#"hash_3df16446745a4852"]) ? instance.var_fe2612fe[#"hash_3df16446745a4852"] : []);
    var_b7eee573 = namespace_8b6a9d79::function_f3d93ee9(s_orb, #"hash_53079af25eecf35b");
    ...
    while (!level flag::get(#"hash_4b060b9820d4141d")) {
        ...
        if (s_result._notify === "damage") {
            ...
            var_b7eee573.var_b8477436.var_b7eee573 = 0;
            var_63ef2885 = undefined;
            var_d297efab = (0, 0, 0);
                ...
                if (abs(var_b45fc900) > 45) {
                    if (var_853a6020 > 2500) {
                        ...
                        if (var_5848577a.size == 0) {
                            ...
                            if (isdefined(var_9f3b9a91)) {
                                var_b7eee573.var_8d1c63ac.var_b7eee573 = var_9f3b9a91.origin;
                            } else {
                                var_b7eee573.var_8d1c63ac.var_b7eee573 = var_b7eee573.origin;
                            }
                        }
                    } else {
            ...
            if (var_9f3b9a91.script_noteworthy === #"hash_5872000773b81e") {
                ...
                if (level flag::get(#"hash_1d1fe20ab0d24d9e")) {
                    return;
                } else if (!level flag::get(#"hash_b1eeb838255a28b")) {
...
function private function_74b6fb1(var_1c4dd56d) {
    ...
    trigger.target.trigger = var_1c4dd56d.targetname;
    trigger waittill(#"trigger_look");
    trigger function_cb48cddd();
    n_line = randomintrangeinclusive(1, 3);
...
function private function_e7a0cf81(instance) {
    ...
    var_7a312ce5.origin.var_7a312ce5 = level.var_c39a4b8f gettagorigin("tag_cage_attach");
    var_7a312ce5.angles.var_7a312ce5 = level.var_c39a4b8f gettagangles("tag_cage_attach");
...
function private function_6f51b8ea(eventstruct) {
    ...
    player thread namespace_3f4c38e1::function_1a58f438();
    player function_bc82f900("zm_interact_rumble");
...
function function_9ad91439(instance) {
    ...
    instance.var_fb224b3b.instance = namespace_8b6a9d79::function_f3d93ee9(var_b8c8ab67, #"hash_20f9a15d3e077602");
    waitframe(1);
