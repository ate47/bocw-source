...
function function_6732b1b(*item) {
    if (function_3efc58e4(self namespace_a0d533d1::function_2b83d3ff(self item_inventory::function_2e711614(17 + 1)))) {
        return 1;
    } else if (function_3efc58e4(self namespace_a0d533d1::function_2b83d3ff(self item_inventory::function_2e711614(17 + 1 + 8 + 1)))) {
        return 1;
    } else if (function_3efc58e4(self namespace_a0d533d1::function_2b83d3ff(self item_inventory::function_2e711614(17 + 1 + 8 + 1 + 8 + 1)))) {
        return 1;
    } else {
        return 0;
    }
...
function function_f2346f03(*watcher, *player) {
    ...
    for (i = 0; i < 4; i++) {
        radiusdamage(var_f2afae05 + (randomfloatrange(-15, 15), randomfloatrange(-15, 15), randomfloatrange(-15, 15)), var_ce734d05, n_damage_max, var_e781159f, attacker, "MOD_EXPLOSIVE", weapon);
        wait(0.1);
    }
}
...
function on_item_pickup(params) {
    ...
    if (isplayer(self)) {
        if (isdefined(item.var_a6762160.weapon) && function_3efc58e4(item.var_a6762160.weapon)) {
            ...
            } else if (function_98e73a50(item.var_a6762160.weapon) && isdefined(self.var_23178d00)) {
                goto LOC_0000037a;
            } else {
...
function function_1340d9d6(vo_line) {
    ...
    var_288ea807 = float(max(isdefined(soundgetplaybacktime(vo_line)) ? soundgetplaybacktime(vo_line) : 500, 500)) / 1000;
    if (var_288ea807 > 0) {
...
function function_e518b5f8(var_accb4770) {
    ...
    while (1) {
        ...
        self clientfield::set_to_player("" + #"hash_713a0ba5968a3bde", 0);
        var_accb4770 thread scene::stop(#"hash_658647939375d560");
...
function function_6406aefd(player, weapon) {
    ...
    while (isdefined(self)) {
        ...
        do {
            ...
            var_ddd89fe0 = var_59cce13c - self.var_c3467a5d * trace_distance;
...
function function_c57b04f7(player) {
    ...
    while (isdefined(self) && isdefined(player) && player flag::get("blazer_beam_extending")) {
        ...
        self.var_c3467a5d = anglestoforward(self.angles);
