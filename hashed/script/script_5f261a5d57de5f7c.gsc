...
// Params 1, eflags: 0x0
// Checksum 0xc6ac5c0e, Offset: 0x88
// Size: 0x47a
...
// Namespace namespace_e86ffa8/namespace_e86ffa8
// Params 1, eflags: 0x0
// Checksum 0x8365d4cc, Offset: 0x510
// Size: 0x482
...
// Namespace namespace_e86ffa8/namespace_e86ffa8
// Params 1, eflags: 0x0
// Checksum 0xb83f4432, Offset: 0x9a0
// Size: 0x1f4
...
// Namespace namespace_e86ffa8/namespace_e86ffa8
// Params 1, eflags: 0x0
// Checksum 0x77d08c82, Offset: 0xba0
// Size: 0x184
function function_30a8ed81(n_level = 0) {
    if (self function_6c32d092(#"hash_2cb9513f0cf67fe7")) {
        ...
        return true;
    } else if (self function_6c32d092(#"talent_mulekick") && n_level == 0) {
        return true;
    }
    return false;
}
...
// Namespace namespace_e86ffa8/namespace_e86ffa8
// Params 1, eflags: 0x0
// Checksum 0x3f3539f7, Offset: 0xd30
// Size: 0x184
function function_cb561923(n_level = 0) {
    if (self function_6c32d092(#"hash_7082a9127deb8f95")) {
        ...
        return true;
    } else if (self function_6c32d092(#"talent_deathperception") && n_level == 0) {
        return true;
    }
    return false;
}
...
// Namespace namespace_e86ffa8/namespace_e86ffa8
// Params 1, eflags: 0x0
// Checksum 0xf0dbe418, Offset: 0xec0
// Size: 0x184
function function_582d36be(n_level = 0) {
    if (self function_6c32d092(#"hash_332be40e760e69a1")) {
        ...
        return true;
    } else if (self function_6c32d092(#"talent_phdslider") && n_level == 0) {
        return true;
    }
    return false;
}
...
// Namespace namespace_e86ffa8/namespace_e86ffa8
// Params 1, eflags: 0x0
// Checksum 0x74b05513, Offset: 0x1050
// Size: 0x184
...
// Namespace namespace_e86ffa8/namespace_e86ffa8
// Params 1, eflags: 0x0
// Checksum 0xd7397c7b, Offset: 0x11e0
// Size: 0x184
function function_8923370c(n_level = 0) {
    if (self function_6c32d092(#"hash_504b3df717f88c4e")) {
        ...
        return true;
    } else if (self function_6c32d092(#"talent_quickrevive") && n_level == 0) {
        return true;
    }
    return false;
}
...
// Namespace namespace_e86ffa8/namespace_e86ffa8
// Params 1, eflags: 0x0
// Checksum 0x105e9fdf, Offset: 0x1370
// Size: 0x184
function function_efb6dedf(n_level = 0) {
    if (self function_6c32d092(#"hash_520b59b0216b70be")) {
        ...
        return true;
    } else if (self function_6c32d092(#"talent_speedcola") && n_level == 0) {
        return true;
    }
    return false;
}
...
// Namespace namespace_e86ffa8/namespace_e86ffa8
// Params 1, eflags: 0x0
// Checksum 0x14e6bb3, Offset: 0x1500
// Size: 0x184
function function_7bf30775(n_level = 0) {
    if (self function_6c32d092(#"hash_1f95b08e4a49d87e")) {
        ...
        return true;
    } else if (self function_6c32d092(#"talent_deadshot") && n_level == 0) {
        return true;
    }
    return false;
}
...
// Namespace namespace_e86ffa8/namespace_e86ffa8
// Params 1, eflags: 0x0
// Checksum 0x7de8480e, Offset: 0x1690
// Size: 0x184
function function_3623f9d1(n_level = 0) {
    if (self function_6c32d092(#"hash_17ccbeee64daa727")) {
        ...
        return true;
    } else if (self function_6c32d092(#"talent_staminup") && n_level == 0) {
        return true;
    }
    return false;
}
...
// Namespace namespace_e86ffa8/namespace_e86ffa8
// Params 1, eflags: 0x0
// Checksum 0xa6cbaded, Offset: 0x1820
// Size: 0x184
...
// Namespace namespace_e86ffa8/namespace_e86ffa8
// Params 1, eflags: 0x0
// Checksum 0x3aafa2c2, Offset: 0x19b0
// Size: 0x184
