...
function function_716ff5d8(var_57ef78ed) {
    ...
    a_ents[#"hash_7dff81d726898790"] = a_enemies[0];
    a_ents[#"hash_7dff86d72689900f"] = a_enemies[1];
    a_ents[#"hash_7dff86d72689900f"].var_c681e4c1 = 1;
...
// Size: 0x64
function function_392f938c(var_bc2b55eb) {
    self endon(#"death");
...
function function_986b3cba(var_afde181b, var_82527dbb) {
    level endon(#"hash_c8fb081649b6e5f");
...
function function_cca11e21() {
    ...
    a_ents[#"hash_7dff81d726898790"] = var_3d261bd8[0];
    a_ents[#"hash_7dff84d726898ca9"] = var_3d261bd8[1];
...
function function_ccfa368() {
    ...
    var_5e907852[#"actor 1"] = level.var_dc8e763c;
    level thread scene::play("scene_rev_2020_fir_landmine_death", "init", var_5e907852);
    ...
    level thread scene::play("scene_rev_2020_fir_landmine_death", "start", var_5e907852);
...
function function_c54af28a() {
    ...
    var_34d58d57 hide();
    s_scene scene::init();
    s_scene.scene_ents[#"hash_700317227822abe3"] thread function_d46f031f(["gut"], "hastings");
    s_scene.scene_ents[#"hash_700318227822ad96"] thread function_d46f031f(["shoulder", "head"], "scientist");
    s_scene.scene_ents[#"hash_700319227822af49"] thread function_d46f031f(["shoulder", "head"], "scientist");
    s_scene.scene_ents[#"perseus"] disableaimassist();
    s_scene.scene_ents[#"hash_700317227822abe3"] setmodel("c_t9_cub_civ_male_scientist_body1");
    level flag::wait_till("flg_VIP_spotted_in_cctv");
...
function function_23334bfb() {
    ...
    var_93193d3a = struct::get("tag_align_rev_skyhook");
    var_60a25e22 = getcorpsearray(var_93193d3a.origin, 256);
