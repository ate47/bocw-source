...
function private function_7d76b3ac(local_client_num) {
    ...
    if (isdefined(self.target)) {
        data.var_afb7f7ec.data = getentarray(local_client_num, self.target, "targetname");
    }
    if (isdefined(self.var_9a3478b5) && !isdefined(level.var_8a1c2b55.var_35043dcc[self.var_9a3478b5])) {
        var_4edf0398 = spawnstruct();
        var_4edf0398.var_1e4697f4.var_4edf0398 = getentarray(local_client_num, self.var_9a3478b5, "targetname");
...
function private function_8f050823() {
    ...
    if ((isdefined(var_2cc6e886.var_d85a87b) ? var_2cc6e886.var_d85a87b : 0) > 0) {
        ...
        while (data.var_78e64a1a > var_2cc6e886.var_3efc3a35 || data.var_33c88c75.size > 0) {
            data.var_78e64a1a.data = data.var_78e64a1a - var_2cc6e886.var_d85a87b / 60 * 0.016 * data.var_33c88c75.size;
...
// Size: 0x101c
function private function_2138c62(local_client_num, var_1e5d913d, var_5479bede, var_b33be77) {
    ...
    if (!isplayer(var_5479bede.attacker) || var_5479bede.mod != "MOD_PISTOL_BULLET" && var_5479bede.mod != "MOD_RIFLE_BULLET" && var_5479bede.mod != "MOD_PROJECTILE") {
        /#
            if (getdvarint(#"hash_312f96d76ca3d249", 0)) {
    ...
    if (data.var_33c88c75.size < (isdefined(var_2cc6e886.var_9d47943c) ? var_2cc6e886.var_9d47943c : 1) && level.var_8a1c2b55.var_f782e821[var_1e5d913d].size < (isdefined(var_2cc6e886.var_404a7d1) ? var_2cc6e886.var_404a7d1 : 1)) {
        ...
        if (var_2cc6e886.min_angle > 0 || var_2cc6e886.max_angle < 180) {
            angle = acos(vectordot(var_5479bede.direction, (0, 0, 1)));
        ...
        if (var_6175aa99 && isdefined(self.var_9a3478b5)) {
            ...
            position = var_4edf0398.var_4ecc769d + rotatepoint((var_5479bede.position - self.origin) / self.scale, var_4edf0398.var_5fabbca1 - self.angles);
        ...
        if (var_6175aa99 && var_2d85b8d) {
            ...
            if ((isdefined(var_2cc6e886.var_f9ac1f46) ? var_2cc6e886.var_f9ac1f46 : 0) > 0) {
                ...
                /#
                    if (getdvarint(#"hash_168747d9fbaa6a48", 0)) {
                        iprintlnbold(acos(vectordot(var_5479bede.direction, forward)));
                    }
                #/
            }
            effect_id = playfx(local_client_num, var_2cc6e886.effect, var_5479bede.position, forward);
            ...
            var_d017fb86 = "augmented_impact_fx_" + var_5479bede.var_7c5043e3;
            self thread function_479d351(local_client_num, var_2cc6e886.var_4c1b2300, var_2cc6e886.loop_sound, var_2cc6e886.end_sound, var_5479bede.position, lifetime, var_2cc6e886.var_d560194f, var_d017fb86);
            if (lifetime > 0) {
                self thread function_a4507e23(local_client_num, effect_id, var_1e5d913d, lifetime, var_5479bede, var_d017fb86);
                if (isdefined(var_2cc6e886.end_effect) && isdefined(var_2cc6e886.var_4241f357)) {
                    self thread function_9dce67f(local_client_num, var_2cc6e886.end_effect, var_2cc6e886.var_4241f357, isdefined(var_2cc6e886.var_3ee57e0e) ? var_2cc6e886.var_3ee57e0e : 0, var_5479bede.position, forward, var_d017fb86);
                }
            }
            if (is_true(self.var_90dafe5)) {
                self notify(#"hash_49d7b379138ff899", {#forward:forward, #position:var_5479bede.position});
            }
...
// Size: 0x10c
function private function_a4507e23(local_client_num, effect_id, var_1e5d913d, lifetime, var_5479bede, var_d017fb86) {
...
// Size: 0x1a4
function private function_479d351(local_client_num, var_4c1b2300, loop_sound, end_sound, position, lifetime, fade_time, var_d017fb86) {
    if ((isdefined(var_4c1b2300) ? var_4c1b2300 : "") != "") {
        self playsound(local_client_num, var_4c1b2300, position);
    }
