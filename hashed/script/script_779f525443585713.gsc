...
function function_ae19bb1f() {
    ...
    level waittill(#"hash_13cd3f957dba05f2");
...
// Size: 0xf64
function function_575ad786(var_c79d614f, var_1355e69b, endon_flag, var_4b179f26 = 2, var_9531ed02 = 4) {
    level.player endon(#"death");
...
function function_c257b422(a_ents) {
    ...
    var_b63a2363 = a_ents[#"hash_110f5a406d2a4c8e"];
    var_6c6006 = a_ents[#"hash_6321012cb8c6dd17"];
    var_b63a2363 endon(#"death", #"delete");
    var_6c6006 endon(#"death", #"delete");
    var_b63a2363 waittill(#"hash_6f629dc582906c2e");
    while (true) {
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09205_rmc3_spartakkickedyo_89");
        wait randomfloatrange(0.5, 1.5);
        var_6c6006 dialogue::queue("vox_cp_rkgb_09205_rmc2_giveitarestwhat_de");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09205_rmc3_bettingonthewro_d9");
        wait randomfloatrange(0.5, 1.5);
        var_6c6006 dialogue::queue("vox_cp_rkgb_09205_rmc2_oksuregavrilovi_22");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09205_rmc3_ohyesthoseweret_16");
        wait randomfloatrange(0.5, 1.5);
...
function function_382a2785(a_ents) {
    level endon(#"kgb_aslt_elev_down_completed");
    var_b63a2363 = a_ents[#"hash_4ba3bc1ed054dcbb"];
    var_6c6006 = a_ents[#"hash_6e83c9503d67b052"];
    var_b63a2363 endon(#"death", #"delete");
    var_6c6006 endon(#"death", #"delete");
    var_b63a2363 thread function_3aa52402();
    ...
    while (true) {
        ...
        var_b63a2363 function_1e9f3294("vox_cp_rkgb_09210_rmc1_isthismanbritis_8b");
        wait randomfloatrange(0.5, 1.5);
        var_6c6006 dialogue::queue("vox_cp_rkgb_09210_rmc3_britishfromwhat_9c");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 function_1e9f3294("vox_cp_rkgb_09210_rmc1_thatsanimportan_37");
        wait randomfloatrange(0.5, 1.5);
        var_6c6006 dialogue::queue("vox_cp_rkgb_09210_rmc3_okwherewerewe_11");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 function_1e9f3294("vox_cp_rkgb_09210_rmc1_andwiththatiwou_8f");
        var_6c6006 dialogue::queue("vox_cp_rkgb_09210_rmc3_holdonisntparty_e1");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 function_1e9f3294("vox_cp_rkgb_09210_rmc1_imnotsurethatan_83");
        wait randomfloatrange(0.5, 1.5);
        var_6c6006 dialogue::queue("vox_cp_rkgb_09210_rmc3_fineletsjustgow_e5");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 function_1e9f3294("vox_cp_rkgb_09210_rmc1_the2ndofmaysir_49");
        wait randomfloatrange(0.5, 1.5);
        var_6c6006 dialogue::queue("vox_cp_rkgb_09210_rmc3_ofcoursethe2ndo_9e");
        var_b63a2363 function_1e9f3294("vox_cp_rkgb_09210_rmc1_incidentsir_04");
        wait randomfloatrange(0.5, 1.5);
        var_6c6006 dialogue::queue("vox_cp_rkgb_09210_rmc3_doyoureallyneed_d9");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 function_1e9f3294("vox_cp_rkgb_09210_rmc1_nosir_85");
        wait randomfloatrange(0.5, 1.5);
        var_6c6006 dialogue::queue("vox_cp_rkgb_09210_rmc3_imsorrythiswhol_0f");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 function_1e9f3294("vox_cp_rkgb_09210_rmc1_understoodsir_ef");
...
function function_8fc8f7c6(a_ents) {
    ...
    function_d47c1165();
    while (true) {
        var_b63a2363 dialogue::queue(array::random(var_4a608bb7));
...
function function_9b3f6c1e(a_ents) {
    ...
    while (true) {
        ...
        if (isdefined(var_4f3a9c97._scene_object._o_scene._e_root.targetname) && issubstr(var_4f3a9c97._scene_object._o_scene._e_root.targetname, "atrium")) {
            ...
            wait randomfloatrange(0.5, 1.5);
            var_b63a2363 dialogue::queue("vox_cp_rkgb_09240_rmc1_yesitsquitebrea_a6");
            wait randomfloatrange(0.5, 1.5);
            var_4f3a9c97 dialogue::queue("vox_cp_rkgb_09240_rfc1_thearchitecture_01");
            var_b63a2363 dialogue::queue("vox_cp_rkgb_09240_rmc1_laughtheysayyou_fd");
            wait randomfloatrange(0.5, 1.5);
            var_4f3a9c97 dialogue::queue("vox_cp_rkgb_09240_rfc1_sergeitheycanpr_24");
            var_b63a2363 dialogue::queue("vox_cp_rkgb_09240_rmc1_lightlaughyesso_a4");
        } else {
            var_b63a2363 dialogue::queue("vox_cp_rkgb_09320_rmc4_lastnightwefina_e9");
            wait randomfloatrange(0.5, 1.5);
            var_4f3a9c97 dialogue::queue("vox_cp_rkgb_09320_rfc2_youwenttoolomou_af");
            wait randomfloatrange(0.5, 1.5);
            var_b63a2363 dialogue::queue("vox_cp_rkgb_09320_rmc4_tellthemeveryth_41");
            wait randomfloatrange(0.5, 1.5);
            var_4f3a9c97 dialogue::queue("vox_cp_rkgb_09320_rfc2_thestroganoffis_84");
            wait randomfloatrange(0.5, 1.5);
            var_b63a2363 dialogue::queue("vox_cp_rkgb_09320_rmc4_haveyoueverbeen_a8");
            var_4f3a9c97 dialogue::queue("vox_cp_rkgb_09320_rfc2_dontsayitiateth_77");
            wait randomfloatrange(0.5, 1.5);
            var_b63a2363 dialogue::queue("vox_cp_rkgb_09320_rmc4_ohirinaiwasjust_53");
        }
...
function function_9feb02eb(a_ents, str_shot) {
    ...
    if (str_shot == "start_loop") {
        trigger = spawn("trigger_radius", var_b63a2363.origin, 0, 128, 64);
    } else if (str_shot == "transition_to_table" || str_shot == "table_loop") {
        trigger = spawn("trigger_radius", chair.origin, 0, 128, 64);
    }
    var_b63a2363.trigger = trigger;
    var_b63a2363 callback::function_d8abfc3d(#"on_ai_killed", &function_dc6db93b);
    var_b63a2363 callback::function_d8abfc3d(#"on_entity_deleted", &function_dc6db93b);
    trigger waittill(#"trigger");
    if (isdefined(var_b63a2363.trigger)) {
        var_b63a2363.trigger delete();
    }
    while (true) {
        ...
        if (str_shot == "start_loop") {
            var_b63a2363 dialogue::queue("vox_cp_rkgb_09250_rmc2_comeonidonthave_e6");
            wait randomfloatrange(0.5, 1.5);
            var_b63a2363 dialogue::queue("vox_cp_rkgb_09250_rmc2_loudsigh_d0");
        } else if (str_shot == "transition_to_table" || str_shot == "table_loop") {
            var_b63a2363 function_1e9f3294("vox_cp_rkgb_09250_rmc3_itellthecoffeem_78");
            wait randomfloatrange(0.5, 1.5);
            var_b63a2363 function_1e9f3294("vox_cp_rkgb_09250_rmc3_cheapchemicalim_27");
            wait randomfloatrange(0.5, 1.5);
            var_b63a2363 function_1e9f3294("vox_cp_rkgb_09250_rmc3_unacceptable_f5");
            wait randomfloatrange(0.5, 1.5);
            var_b63a2363 function_1e9f3294("vox_cp_rkgb_09250_rmc3_imputtinginacom_12");
        }
...
function function_26300964(a_ents) {
    ...
    while (true) {
        ...
        var_b63a2363 function_1e9f3294("vox_cp_rkgb_09252_rmc2_icantbelievethe_76");
        wait randomfloatrange(0.5, 1.5);
        var_4f3a9c97 function_1e9f3294("vox_cp_rkgb_09252_rfc1_idontmindititdo_80");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 function_1e9f3294("vox_cp_rkgb_09252_rmc2_withenoughsugar_0c");
        wait randomfloatrange(0.5, 1.5);
        var_4f3a9c97 function_1e9f3294("vox_cp_rkgb_09252_rfc1_ialwaysthoughti_4f");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 function_1e9f3294("vox_cp_rkgb_09252_rmc2_whyisthat_44");
        wait randomfloatrange(0.5, 1.5);
        var_4f3a9c97 function_1e9f3294("vox_cp_rkgb_09252_rfc1_imeanwhodoesntw_44");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 function_1e9f3294("vox_cp_rkgb_09252_rmc2_cannotsayihavee_c2");
        wait randomfloatrange(0.5, 1.5);
        var_4f3a9c97 function_1e9f3294("vox_cp_rkgb_09252_rfc1_andprobablyalit_dc");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 function_1e9f3294("vox_cp_rkgb_09252_rmc2_dontyouworkinle_47");
        wait randomfloatrange(0.5, 1.5);
        var_4f3a9c97 function_1e9f3294("vox_cp_rkgb_09252_rfc1_yes_5f");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 function_1e9f3294("vox_cp_rkgb_09252_rmc2_thatcanbeexciti_ee");
        wait randomfloatrange(0.5, 1.5);
...
function function_a7b81626(a_ents) {
    ...
    while (true) {
        ...
        var_b63a2363 function_1e9f3294("vox_cp_rkgb_09254_rmc3_iamprettysurehe_f4");
        wait randomfloatrange(0.5, 1.5);
        var_4f3a9c97 function_1e9f3294("vox_cp_rkgb_09254_rfc2_whatgaveitaway_65");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 function_1e9f3294("vox_cp_rkgb_09254_rmc3_besidesthebagsu_63");
        wait randomfloatrange(0.5, 1.5);
        var_4f3a9c97 function_1e9f3294("vox_cp_rkgb_09254_rfc2_arentyouasnoop_70");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 function_1e9f3294("vox_cp_rkgb_09254_rmc3_iamjustlookingo_7f");
        wait randomfloatrange(0.5, 1.5);
        var_4f3a9c97 function_1e9f3294("vox_cp_rkgb_09254_rfc2_itisabusytimefo_0e");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 function_1e9f3294("vox_cp_rkgb_09254_rmc3_idontthinkhisas_87");
        wait randomfloatrange(0.5, 1.5);
        var_4f3a9c97 function_1e9f3294("vox_cp_rkgb_09254_rfc2_yeahthatguyispr_0d");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 function_1e9f3294("vox_cp_rkgb_09254_rmc3_thatdoesntsurpr_f6");
        wait randomfloatrange(0.5, 1.5);
        var_4f3a9c97 function_1e9f3294("vox_cp_rkgb_09254_rfc2_icantbelievehes_29");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 function_1e9f3294("vox_cp_rkgb_09254_rmc3_youmighthaveapo_6b");
...
function function_6b4f4409(a_ents) {
    ...
    var_b63a2363 = a_ents[#"hash_65ce105def67e4a1"];
    var_4f3a9c97 endon(#"death", #"delete");
    var_b63a2363 endon(#"death", #"delete");
    if (!isdefined(level.var_a88fc2c9)) {
        trigger_struct = struct::get("scene_kgb_ambient_mailroom_triggerstruct", "targetname");
    ...
    while (true) {
        ...
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09260_rmc1_comeonewaillpic_b3");
        wait randomfloatrange(0.5, 1.5);
        var_4f3a9c97 dialogue::queue("vox_cp_rkgb_09260_rfc1_wouldntyouknowi_c4");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09260_rmc1_nikoyoutwoneedt_44");
        var_4f3a9c97 dialogue::queue("vox_cp_rkgb_09260_rfc1_laughohyeswellg_27");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09260_rmc1_ewaimanintellig_71");
        wait randomfloatrange(0.5, 1.5);
        var_4f3a9c97 dialogue::queue("vox_cp_rkgb_09260_rfc1_unrivaledpersis_4e");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09260_rmc1_thenitson_18");
        wait randomfloatrange(0.5, 1.5);
...
function function_45eaefef(a_ents) {
    ...
    while (true) {
        ...
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09265_rfc1_ifwehadwalkedli_6b");
        wait randomfloatrange(0.5, 1.5);
...
function function_5c2bc4eb(a_ents) {
    ...
    var_6c6006 endon(#"death", #"delete");
    waitframe(1);
    trigger = spawn("trigger_radius", var_b63a2363.origin, 0, level.var_9aa07a0, level.var_30b3395f);
    var_b63a2363.trigger = trigger;
    var_b63a2363 callback::function_d8abfc3d(#"on_ai_killed", &function_dc6db93b);
    var_b63a2363 callback::function_d8abfc3d(#"on_entity_deleted", &function_dc6db93b);
    trigger waittill(#"trigger");
    ...
    while (true) {
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09270_rms4_heyvasilydidthe_d4");
        wait randomfloatrange(0.5, 1.5);
        var_6c6006 dialogue::queue("vox_cp_rkgb_09270_rms1_nonotyetithinkh_59");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09270_rms4_kravchenkosound_f3");
        wait randomfloatrange(0.5, 1.5);
        var_6c6006 dialogue::queue("vox_cp_rkgb_09270_rms1_everyonesbeenon_95");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09270_rms4_thatwouldbesome_c7");
        wait randomfloatrange(0.5, 1.5);
...
function function_b31d08b0(a_ents) {
    ...
    var_b63a2363 = a_ents[#"hash_318b8cfa118b1fa1"];
    var_6c6006 = a_ents[#"hash_318b8bfa118b1dee"];
    script_struct = struct::get("scene_kgb_ambient_atrium_talk_bench_triggerstruct");
    var_b63a2363 endon(#"death", #"delete");
    var_6c6006 endon(#"death", #"delete");
    if (isdefined(var_b63a2363)) {
        if (isdefined(var_b63a2363.model) && var_b63a2363.model != "c_t9_ger_civ_male_urban_body6") {
            var_b63a2363 setmodel("c_t9_ger_civ_male_urban_body6");
        }
        waitframe(1);
        if (!var_b63a2363 isattached("c_t9_ger_civ_male_head02")) {
            var_b63a2363 detach(var_b63a2363.head);
            var_b63a2363 attach("c_t9_ger_civ_male_head02");
        }
    }
    if (isdefined(var_6c6006)) {
        if (isdefined(var_b63a2363.model) && var_b63a2363.model != "c_t9_ger_civ_male_urban_body8") {
    ...
    while (true) {
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09275_rmc4_haveyoueverbeen_42");
        wait randomfloatrange(0.5, 1.5);
        var_6c6006 dialogue::queue("vox_cp_rkgb_09275_rmc3_yeahonatripwith_11");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09275_rmc4_ahfundidyougett_d9");
        wait randomfloatrange(0.5, 1.5);
        var_6c6006 dialogue::queue("vox_cp_rkgb_09275_rmc3_weswamquiteabit_16");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09275_rmc4_ihearthepolesha_9a");
        ...
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09275_rmc4_yeponlyofficial_24");
        wait randomfloatrange(0.5, 1.5);
...
function function_792c3bbe(a_ents) {
    ...
    var_b63a2363 = a_ents[#"hash_318b89fa118b1a88"];
    ...
    if (isdefined(var_b63a2363)) {
        if (isdefined(var_b63a2363.model) && var_b63a2363.model != "c_t9_ger_civ_male_urban_body1") {
            var_b63a2363 setmodel("c_t9_ger_civ_male_urban_body1");
        }
        waitframe(1);
        if (!var_b63a2363 isattached("c_t9_ger_civ_male_head01")) {
            var_b63a2363 detach(var_b63a2363.head);
            var_b63a2363 attach("c_t9_ger_civ_male_head01");
        }
    }
    waitframe(1);
    trigger = spawn("trigger_radius", script_struct.origin, 0, script_struct.radius, script_struct.height);
    ...
    while (true) {
        ...
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09280_rmc2_imheretopickupo_41");
        wait randomfloatrange(0.5, 1.5);
        var_4f3a9c97 dialogue::queue("vox_cp_rkgb_09280_rfc2_andyournamesare_cd");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09280_rmc2_yurisuslovandre_dc");
        wait randomfloatrange(0.5, 1.5);
        var_4f3a9c97 dialogue::queue("vox_cp_rkgb_09280_rfc2_letmeseeahyesyo_02");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09280_rmc2_yescomrade_66");
        wait randomfloatrange(0.5, 1.5);
        var_4f3a9c97 dialogue::queue("vox_cp_rkgb_09280_rfc2_underordersfrom_a3");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09280_rmc2_thatscorrect_3f");
        wait randomfloatrange(0.5, 1.5);
        var_4f3a9c97 dialogue::queue("vox_cp_rkgb_09280_rfc2_illputyourpaper_4d");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09280_rmc2_thankyoucomrade_a8");
        wait randomfloatrange(level.var_4ce95d22, level.var_bb9797b9);
    }
}
...
function function_a44bd33e(a_ents, str_shot) {
    ...
    while (true) {
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09285_rmc2_okweshouldbeabl_af");
        wait randomfloatrange(0.5, 1.5);
        var_f5b94aac dialogue::queue("vox_cp_rkgb_09285_rmc4_greatdowehavean_a7");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09285_rmc2_henrykcukierdau_7c");
        wait randomfloatrange(0.5, 1.5);
        var_6c6006 dialogue::queue("vox_cp_rkgb_09285_rmc3_okperfectdestin_42");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09285_rmc2_yescomradelenin_e7");
        wait randomfloatrange(0.5, 1.5);
...
function function_858c98d(a_ents) {
    ...
    var_b63a2363 = a_ents[#"hash_338d1396aeba7252"];
    var_4f3a9c97 endon(#"death", #"delete");
    var_b63a2363 endon(#"death", #"delete");
    if (!isdefined(level.var_a88fc2c9)) {
        trigger_struct = struct::get("scene_kgb_ambient_mailroom_triggerstruct", "targetname");
    ...
    while (true) {
        ...
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09290_rmc1_withcomradeusti_89");
        wait randomfloatrange(0.5, 1.5);
        var_4f3a9c97 dialogue::queue("vox_cp_rkgb_09290_rfc2_couldyourepeaty_9e");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09290_rmc1_valentinutkin_9a");
        wait randomfloatrange(0.5, 1.5);
        var_4f3a9c97 dialogue::queue("vox_cp_rkgb_09290_rfc2_department_53");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09290_rmc1_gdrbureau_8f");
        wait randomfloatrange(0.5, 1.5);
        var_4f3a9c97 dialogue::queue("vox_cp_rkgb_09290_rfc2_andyourbusiness_8e");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09290_rmc1_idrathernotsayr_16");
        wait randomfloatrange(0.5, 1.5);
        var_4f3a9c97 dialogue::queue("vox_cp_rkgb_09290_rfc2_thingsareabitun_4e");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09290_rmc1_thatsfine_ef");
...
function function_6bd39879(a_ents) {
    ...
    var_b63a2363 = a_ents[#"hash_36441969acaf17cf"];
    var_4f3a9c97 endon(#"death", #"delete");
    var_b63a2363 endon(#"death", #"delete");
    if (isdefined(var_b63a2363)) {
        if (isdefined(var_b63a2363.model) && var_b63a2363.model != "c_t9_ger_civ_male_urban_body1") {
    ...
    while (true) {
        ...
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09295_rmc3_yesthatstrueiwa_d3");
        wait randomfloatrange(0.5, 1.5);
        var_4f3a9c97 dialogue::queue("vox_cp_rkgb_09295_rfc1_strictsecurityp_68");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09295_rmc3_yescomradeimawa_95");
        wait randomfloatrange(0.5, 1.5);
        var_4f3a9c97 dialogue::queue("vox_cp_rkgb_09295_rfc1_doyouadmittorai_ff");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09295_rmc3_idocomrade_71");
        wait randomfloatrange(0.5, 1.5);
        var_4f3a9c97 dialogue::queue("vox_cp_rkgb_09295_rfc1_andyoualsoadmit_38");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09295_rmc3_yesthatseemstob_82");
        wait randomfloatrange(0.5, 1.5);
        var_4f3a9c97 dialogue::queue("vox_cp_rkgb_09295_rfc1_pleasereportwit_1e");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09295_rmc3_areyouseriousid_6e");
...
function function_ae1c1004(a_ents) {
    ...
    var_b63a2363 = a_ents[#"hash_5b5c01597811fdb4"];
    var_4f3a9c97 endon(#"death", #"delete");
    var_b63a2363 endon(#"death", #"delete");
    if (isdefined(var_4f3a9c97)) {
    ...
    waitframe(1);
    trigger = spawn("trigger_radius", var_b63a2363.origin, 0, 96, level.var_30b3395f);
    var_b63a2363.trigger = trigger;
    var_b63a2363 callback::function_d8abfc3d(#"on_ai_killed", &function_dc6db93b);
    var_b63a2363 callback::function_d8abfc3d(#"on_entity_deleted", &function_dc6db93b);
    trigger waittill(#"trigger");
    ...
    while (true) {
        ...
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09300_rmc1_tryholdingthepo_52");
        wait randomfloatrange(0.5, 1.5);
        var_4f3a9c97 dialogue::queue("vox_cp_rkgb_09300_rfc1_okaysighareyous_d7");
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09300_rmc1_laughohgoodluck_ee");
        wait randomfloatrange(0.5, 1.5);
        var_4f3a9c97 dialogue::queue("vox_cp_rkgb_09300_rfc1_icandream_f2");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09300_rmc1_indeed_77");
        wait randomfloatrange(level.var_4ce95d22, level.var_bb9797b9);
    }
}
...
function function_838eb65b(a_ents) {
    level endon(#"kgb_aslt_elev_down_completed");
    var_b63a2363 = a_ents[#"hash_466e7d5eb78abd77"];
    ...
    while (true) {
        ...
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09305_rmc1_iwentelkhunting_c6");
        wait randomfloatrange(0.5, 1.5);
        var_6c6006 dialogue::queue("vox_cp_rkgb_09305_rmc4_thatright_0e");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09305_rmc1_hebuiltasmokeho_db");
        wait randomfloatrange(0.5, 1.5);
        var_6c6006 dialogue::queue("vox_cp_rkgb_09305_rmc4_imnotafanofhunt_43");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09305_rmc1_igetitlookatitt_4c");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09305_rmc1_ifishootoneelki_0f");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09305_rmc1_didyouknowthata_8f");
        wait randomfloatrange(0.5, 1.5);
        var_6c6006 dialogue::queue("vox_cp_rkgb_09305_rmc4_evseiilearnsome_18");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09305_rmc1_haveyouevergrow_cf");
...
function function_dedcb768(a_ents) {
    ...
    while (true) {
        ...
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09310_rmc2_itsfartoohotinh_12");
        wait randomfloatrange(0.5, 1.5);
        var_4f3a9c97 dialogue::queue("vox_cp_rkgb_09310_rfc2_thatsbecausewej_42");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09310_rmc2_iheartheyhavead_dd");
        wait randomfloatrange(0.5, 1.5);
        var_4f3a9c97 dialogue::queue("vox_cp_rkgb_09310_rfc2_shushstepanyouk_e9");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09310_rmc2_alliwantisaradi_31");
        wait randomfloatrange(0.5, 1.5);
...
function function_ac04ad89(a_ents) {
    ...
    var_6c6006 endon(#"death", #"delete");
    if (isdefined(var_b63a2363)) {
        if (isdefined(var_b63a2363.model) && var_b63a2363.model != "c_t9_ger_civ_male_urban_body7b") {
            var_b63a2363 setmodel("c_t9_ger_civ_male_urban_body7b");
        }
        waitframe(1);
        if (!var_b63a2363 isattached("c_t9_ger_civ_male_head06")) {
            var_b63a2363 detach(var_b63a2363.head);
            var_b63a2363 attach("c_t9_ger_civ_male_head06");
        }
    }
    if (isdefined(var_6c6006)) {
...
function function_aebfcfbf(a_ents) {
    ...
    while (true) {
        wait 0.5;
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09325_rmc1_idontknowyourqu_5b");
        wait randomfloatrange(0.5, 1.5);
        var_6c6006 dialogue::queue("vox_cp_rkgb_09325_rmc3_areyousurewecan_ee");
        wait randomfloatrange(level.var_4ce95d22, level.var_bb9797b9);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09325_rmc1_andthisisasfara_94");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09325_rmc1_evenifsecretary_26");
        wait randomfloatrange(0.5, 1.5);
        var_6c6006 dialogue::queue("vox_cp_rkgb_09325_rmc3_doeshecomehereo_7b");
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09325_rmc1_laughnever_b0");
        wait randomfloatrange(0.5, 1.5);
...
function function_acddd6ae(a_ents) {
    ...
    var_b63a2363 = a_ents[#"hash_2d3d6c83fbf60ddb"];
    guard endon(#"death", #"delete");
    var_b63a2363 endon(#"death", #"delete");
    waitframe(1);
    trigger = spawn("trigger_radius", var_b63a2363.origin, 0, level.var_9aa07a0, level.var_30b3395f * 2);
    var_b63a2363.trigger = trigger;
    var_b63a2363 callback::function_d8abfc3d(#"on_ai_killed", &function_dc6db93b);
    var_b63a2363 callback::function_d8abfc3d(#"on_entity_deleted", &function_dc6db93b);
    trigger waittill(#"trigger");
    ...
    while (true) {
        ...
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09330_rmc1_newmexico_dd");
        wait randomfloatrange(0.5, 1.5);
        guard dialogue::queue("vox_cp_rkgb_09330_rmc3_sorryimusthavem_fc");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09330_rmc1_technicallyiwil_ed");
        wait randomfloatrange(0.5, 1.5);
        guard dialogue::queue("vox_cp_rkgb_09330_rmc3_willthatbeachal_d3");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09330_rmc1_crossingoverita_d4");
        ...
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09330_rmc1_theyhaventevent_d1");
        wait randomfloatrange(0.5, 1.5);
        guard dialogue::queue("vox_cp_rkgb_09330_rmc3_wellimenviousih_30");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09330_rmc1_iwillinmexicoci_cb");
        wait randomfloatrange(level.var_4ce95d22, level.var_bb9797b9);
    }
}
...
function function_9aeb9e94(a_ents) {
    level endon(#"kgb_aslt_elev_down_completed");
    var_b63a2363 = a_ents[#"hash_2b3d34c3eeb09572"];
    ...
    while (true) {
        ...
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09335_rms2_howitsnotlikeyo_7e");
        wait randomfloatrange(0.5, 1.5);
        var_f5b94aac dialogue::queue("vox_cp_rkgb_09335_rms4_nobutmaybewells_e3");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09335_rms2_iguessitiskindo_fb");
        wait randomfloatrange(0.5, 1.5);
        var_6c6006 dialogue::queue("vox_cp_rkgb_09335_rms3_itsdefinitelyha_be");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09335_rms2_younevergetanyt_0c");
        ...
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09335_rms2_suremaybehellpr_d4");
        var_b63a2363 thread dialogue::queue("vox_cp_rkgb_09335_rms2_laugh_62");
...
function function_28b6b100(a_ents) {
    ...
    while (true) {
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09345_rmc2_areyoukiddingih_d1");
        wait randomfloatrange(0.5, 1.5);
        var_6c6006 dialogue::queue("vox_cp_rkgb_09345_rmc3_ithinknowisthet_9e");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09345_rmc2_waitarewetalkin_81");
        wait randomfloatrange(0.5, 1.5);
        var_6c6006 dialogue::queue("vox_cp_rkgb_09345_rmc3_imjustsayingtak_66");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09345_rmc2_wellmywifecerta_ed");
        wait randomfloatrange(0.5, 1.5);
...
function function_c2d37011(a_ents) {
    ...
    var_b63a2363 waittill(#"hash_6f629dc582906c2e");
    while (true) {
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09350_rmc1_viktordidyouhea_16");
        wait randomfloatrange(0.5, 1.5);
        var_6c6006 dialogue::queue("vox_cp_rkgb_09350_rmc2_hearaboutititsm_f8");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09350_rmc1_wonderfulaftera_00");
        wait randomfloatrange(0.5, 1.5);
        var_6c6006 dialogue::queue("vox_cp_rkgb_09350_rmc2_imamanofmyword_93");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09350_rmc1_imgoingtogoturn_80");
        wait randomfloatrange(0.5, 1.5);
        var_6c6006 dialogue::queue("vox_cp_rkgb_09350_rmc2_notatall_ad");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09350_rmc1_canigetyoualast_e2");
        wait randomfloatrange(0.5, 1.5);
        var_6c6006 dialogue::queue("vox_cp_rkgb_09350_rmc2_ivealreadyeaten_6d");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09350_rmc1_alrightwellitwa_eb");
        wait randomfloatrange(0.5, 1.5);
...
function function_18206d92(a_ents) {
    ...
    while (true) {
        ...
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09355_rmc1_youmeantheonewh_cd");
        wait randomfloatrange(0.5, 1.5);
        var_f5b94aac dialogue::queue("vox_cp_rkgb_09355_rmc3_youmeanmaid_24");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09355_rmc1_noimeanthebutle_50");
        wait randomfloatrange(0.5, 1.5);
        ...
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09355_rmc1_soundshilarious_9a");
        wait randomfloatrange(0.5, 1.5);
...
function function_cebe3d1b(a_ents) {
    level endon(#"kgb_aslt_elev_down_completed");
    var_b63a2363 = a_ents[#"hash_4bc9d223eb723333"];
    ...
    while (true) {
        ...
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09360_rms2_mountyamantau_b2");
        wait randomfloatrange(0.5, 1.5);
        ...
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09360_rms2_fascinatingidid_86");
        wait randomfloatrange(0.5, 1.5);
...
function function_65dea10(a_ents) {
    level endon(#"kgb_aslt_elev_down_completed");
    soldier = a_ents[#"hash_7f2c000ee8773ab1"];
    var_b4fc88b3 = a_ents[#"hash_7f2bfd0ee8773598"];
    var_b63a2363 = a_ents[#"hash_700317227822abe3"];
    ...
    while (true) {
        ...
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09365_rmc1_idrovehourstoge_2f");
        wait randomfloatrange(0.5, 1.5);
        var_b4fc88b3 dialogue::queue("vox_cp_rkgb_09365_rms4_thatsnotourprob_25");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09365_rmc1_iknowitisntbuti_0a");
        wait randomfloatrange(0.5, 1.5);
        soldier dialogue::queue("vox_cp_rkgb_09365_rms3_citizenwecantju_79");
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09365_rmc1_iwastoldtoshowu_a0");
        wait randomfloatrange(0.5, 1.5);
        soldier dialogue::queue("vox_cp_rkgb_09365_rms3_citizen_04");
        wait randomfloatrange(0.5, 1.5);
        soldier dialogue::queue("vox_cp_rkgb_09365_rms3_citizenitisnotu_8c");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09365_rmc1_reallywhatwillh_c2");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09365_rmc1_whatwillhappen_47");
        wait randomfloatrange(0.5, 1.5);
        ...
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09365_rmc1_noiwanttospeakt_1c");
        wait randomfloatrange(0.5, 1.5);
        soldier dialogue::queue("vox_cp_rkgb_09365_rms3_dontforceustodr_ab");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09365_rmc1_thisisoutrageou_23");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09365_rmc1_iwastoldihadtod_f2");
        wait randomfloatrange(0.5, 1.5);
...
function function_dfbd6bbc(a_ents) {
    ...
    var_b63a2363 = a_ents[var_78beab00];
    var_b63a2363 endon(#"death", #"delete");
    var_b63a2363 thread function_3aa52402();
    ...
    waitframe(1);
    trigger = spawn("trigger_radius", var_b63a2363.origin, 0, 128, level.var_30b3395f);
    var_b63a2363.trigger = trigger;
    var_b63a2363 callback::function_d8abfc3d(#"on_ai_killed", &function_dc6db93b);
    var_b63a2363 callback::function_d8abfc3d(#"on_entity_deleted", &function_dc6db93b);
    trigger waittill(#"trigger");
    ...
    while (true) {
        var_b63a2363 function_1e9f3294(array::random(var_abff3bef));
        wait randomfloatrange(10, 20);
    }
}
...
function function_8fcab530(a_ents) {
    ...
    while (true) {
        ...
        case 1:
            var_b63a2363 dialogue::queue("vox_cp_rkgb_09395_rmc2_hums_0e");
            break;
        case 2:
            var_b63a2363 dialogue::queue("vox_cp_rkgb_09395_rmc2_hums_0e_1");
            break;
        case 3:
            var_b63a2363 dialogue::queue("vox_cp_rkgb_09395_rmc2_justdonttouchth_53");
            break;
        case 4:
            var_b63a2363 dialogue::queue("vox_cp_rkgb_09395_rmc2_theybringtheirk_d7");
            break;
        }
        wait randomfloatrange(level.var_4ce95d22, level.var_bb9797b9);
    }
...
function function_a5bc671a(a_ents) {
    level endon(#"kgb_aslt_elev_down_completed");
    var_b63a2363 = a_ents[#"hash_700317227822abe3"];
    var_6c6006 = a_ents[#"hash_700318227822ad96"];
    var_b63a2363 endon(#"death", #"delete");
    var_6c6006 endon(#"death", #"delete");
    if (isdefined(self) && isdefined(self.targetname) && self.targetname == "data_murder_investigation") {
        if (isdefined(a_ents[#"hash_700319227822af49"]) && !isdefined(level.var_9ba3920f)) {
            level.var_9ba3920f = a_ents[#"hash_700319227822af49"];
    ...
    while (true) {
        if (isdefined(var_b63a2363._scene_object._o_scene._e_root.targetname) && issubstr(var_b63a2363._scene_object._o_scene._e_root.targetname, "camera")) {
            var_b63a2363 dialogue::queue("vox_cp_rkgb_09400_rms1_howcouldthishav_a5");
            wait randomfloatrange(0.5, 1.5);
            var_6c6006 dialogue::queue("vox_cp_rkgb_09400_rms2_thismustberelat_96");
        } else if (isdefined(var_b63a2363._scene_object._o_scene._e_root.targetname) && issubstr(var_b63a2363._scene_object._o_scene._e_root.targetname, "records")) {
            if (math::cointoss()) {
                var_b63a2363 dialogue::queue("vox_cp_rkgb_09400_rms1_whowouldhavekil_31");
            } else {
                var_6c6006 dialogue::queue("vox_cp_rkgb_09400_rms2_wehavenofootage_e0");
                wait randomfloatrange(0.5, 1.5);
                var_b63a2363 dialogue::queue("vox_cp_rkgb_09400_rms1_watchyourback_c5");
            }
        } else if (isdefined(var_b63a2363._scene_object._o_scene._e_root.targetname) && issubstr(var_b63a2363._scene_object._o_scene._e_root.targetname, "server")) {
            if (math::cointoss()) {
                var_6c6006 dialogue::queue("vox_cp_rkgb_09400_rms2_whatisgoingonar_ae");
                wait randomfloatrange(0.5, 1.5);
                var_b63a2363 dialogue::queue("vox_cp_rkgb_09400_rms1_loudsigh_d0");
            } else {
                var_b63a2363 dialogue::queue("vox_cp_rkgb_09400_rms1_dudnikiwasjustt_8e");
                wait randomfloatrange(0.5, 1.5);
                var_6c6006 dialogue::queue("vox_cp_rkgb_09400_rms2_haskravchenkohe_30");
            }
        } else if (isdefined(var_b63a2363._scene_object._o_scene._e_root.targetname) && issubstr(var_b63a2363._scene_object._o_scene._e_root.targetname, "data")) {
            var_6c6006 dialogue::queue("vox_cp_rkgb_09400_rms2_glebovhadnoenem_dd");
            wait randomfloatrange(0.5, 1.5);
            var_b63a2363 dialogue::queue("vox_cp_rkgb_09400_rms1_hopefullyhedied_52");
            wait randomfloatrange(0.5, 1.5);
...
function function_75c06a2f(a_ents) {
    level endon(#"kgb_aslt_elev_down_completed");
    var_b63a2363 = a_ents[#"hash_564e9bf9aa88538f"];
    var_6c6006 = a_ents[#"hash_564e9cf9aa885542"];
    var_b63a2363 endon(#"death", #"delete");
    var_6c6006 endon(#"death", #"delete");
    var_b63a2363 waittill(#"hash_6f629dc582906c2e");
    var_b63a2363 dialogue::queue("vox_cp_rkgb_09405_rmc4_fyodordoyouhave_f3");
    wait randomfloatrange(0.5, 1.5);
    var_6c6006 dialogue::queue("vox_cp_rkgb_09405_rmc3_ofcoursenotitwa_8f");
    wait randomfloatrange(0.5, 1.5);
    var_b63a2363 dialogue::queue("vox_cp_rkgb_09405_rmc4_annoyedgroan_76");
}
...
function function_789de3e1(a_ents) {
    ...
    var_b63a2363 = a_ents[#"hash_5e382a0b608737da"];
    ...
    while (true) {
        if (isdefined(guard._scene_object._o_scene._e_root.targetname) && issubstr(guard._scene_object._o_scene._e_root.targetname, "lobby")) {
            var_b63a2363 dialogue::queue("vox_cp_rkgb_09410_rmc3_thisisridiculou_af");
            wait randomfloatrange(0.5, 1.5);
            guard dialogue::queue("vox_cp_rkgb_09410_rms1_wecanthaveanyon_e3");
            wait randomfloatrange(0.5, 1.5);
            var_b63a2363 dialogue::queue("vox_cp_rkgb_09410_rmc3_idontknowanythi_4b");
            wait randomfloatrange(0.5, 1.5);
            var_cd0ea04d dialogue::queue("vox_cp_rkgb_09410_rms4_yesalottobeconc_b8");
            wait randomfloatrange(0.5, 1.5);
            var_b63a2363 dialogue::queue("vox_cp_rkgb_09410_rmc3_imsorryillletyo_8d");
        } else {
            guard dialogue::queue("vox_cp_rkgb_09415_rms2_itsgoingtotakea_c5");
            wait randomfloatrange(0.5, 1.5);
            var_b63a2363 dialogue::queue("vox_cp_rkgb_09415_rmc1_whatisgoingonov_61");
            wait randomfloatrange(0.5, 1.5);
            guard dialogue::queue("vox_cp_rkgb_09415_rms2_justletusaskthe_be");
            wait randomfloatrange(0.5, 1.5);
            var_b63a2363 dialogue::queue("vox_cp_rkgb_09415_rmc1_iwishiknewwhatw_65");
            wait randomfloatrange(0.5, 1.5);
            var_cd0ea04d dialogue::queue("vox_cp_rkgb_09415_rms3_didyouhaveaprio_ca");
            wait randomfloatrange(0.5, 1.5);
            var_b63a2363 dialogue::queue("vox_cp_rkgb_09415_rmc1_huh_64");
        }
        wait randomfloatrange(level.var_4ce95d22, level.var_bb9797b9);
    }
}
...
function function_8dcdb8c9(a_ents) {
    ...
    var_b63a2363 = a_ents[#"hash_2b50d92ebdd550d7"];
    ...
    while (true) {
        if (isdefined(guard._scene_object._o_scene._e_root.targetname) && issubstr(guard._scene_object._o_scene._e_root.targetname, "lobby")) {
            var_b63a2363 dialogue::queue("vox_cp_rkgb_09420_rmc1_ourmeetingwassc_fb");
            wait randomfloatrange(0.5, 1.5);
            ...
            wait randomfloatrange(0.5, 1.5);
            var_b63a2363 dialogue::queue("vox_cp_rkgb_09420_rmc1_areyougoingtote_57");
            wait randomfloatrange(0.5, 1.5);
            var_cd0ea04d dialogue::queue("vox_cp_rkgb_09420_rms3_andwhowasityour_67");
        } else {
            var_b63a2363 dialogue::queue("vox_cp_rkgb_09420_rmc2_wellthisisnew_1f");
            wait randomfloatrange(0.5, 1.5);
            ...
            wait randomfloatrange(0.5, 1.5);
            var_b63a2363 dialogue::queue("vox_cp_rkgb_09420_rmc2_mybusinessiwork_c2");
            wait randomfloatrange(0.5, 1.5);
            var_4f3a9c97 dialogue::queue("vox_cp_rkgb_09420_rfc2_sorryhejusthate_1e");
            wait randomfloatrange(0.5, 1.5);
            var_b63a2363 dialogue::queue("vox_cp_rkgb_09420_rmc2_itsnotlikewehav_98");
            wait randomfloatrange(0.5, 1.5);
...
function function_c2e8e3e2(a_ents) {
    ...
    var_b63a2363 = a_ents[#"hash_75cd1b9fa8049707"];
    ...
    while (true) {
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09425_rmc1_hesimplyaskedfo_6d");
        wait randomfloatrange(0.5, 1.5);
        guard dialogue::queue("vox_cp_rkgb_09425_rms3_areyousure_b3");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09425_rmc1_amisure_bf");
        wait randomfloatrange(0.5, 1.5);
        guard dialogue::queue("vox_cp_rkgb_09425_rms3_whatareyoudoing_d9");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09425_rmc1_nothingwhat_f8");
        wait randomfloatrange(0.5, 1.5);
...
function function_b8bc6f25(a_ents) {
    ...
    var_b63a2363 = a_ents[#"hash_76167e0ae2eaea8b"];
    ...
    while (true) {
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09430_rmc3_iwaswaitingtome_d4");
        wait randomfloatrange(0.5, 1.5);
        guard dialogue::queue("vox_cp_rkgb_09430_rms2_andshenevercame_e5");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09430_rmc3_noimeanyesitsth_e8");
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09430_rmc3_ijustwanttogoho_f9");
        wait randomfloatrange(0.5, 1.5);
        ...
        wait randomfloatrange(0.5, 1.5);
        var_b63a2363 dialogue::queue("vox_cp_rkgb_09430_rmc3_icantjustgoonre_b9");
        wait randomfloatrange(0.5, 1.5);
...
function function_645c6620(a_ents) {
    ...
    var_502e747d endon(#"death", #"delete");
    waitframe(1);
    thread function_fe077ca7(var_7198a076, var_502e747d);
    ...
    while (true) {
        ...
        wait randomfloatrange(0.5, 1.5);
        var_502e747d dialogue::queue("vox_cp_rkgb_09430_krav_idontknowwhatto_14");
        wait randomfloatrange(0.5, 1.5);
        var_7198a076 dialogue::queue("vox_cp_rkgb_09430_zakh_charkovandbelik_2c");
        wait randomfloatrange(0.5, 1.5);
        var_502e747d dialogue::queue("vox_cp_rkgb_09430_krav_theydo_bb");
        wait randomfloatrange(0.5, 1.5);
        var_502e747d dialogue::queue("vox_cp_rkgb_09430_krav_imstilltryingto_d5");
        wait randomfloatrange(0.5, 1.5);
        var_7198a076 dialogue::queue("vox_cp_rkgb_09430_zakh_findbelikoviwan_54");
        wait randomfloatrange(0.5, 1.5);
        var_502e747d dialogue::queue("vox_cp_rkgb_09430_krav_accordingtochar_40");
        wait randomfloatrange(level.var_4ce95d22, level.var_bb9797b9);
    }
}
...
// Size: 0x344
function function_fe077ca7(var_7198a076, var_502e747d) {
    level.player endon(#"death");
    var_7198a076 endon(#"death", #"delete");
    level endon(#"kgb_aslt_elev_down_completed");
    ...
    var_502e747d ai::look_at(level.player, 0, undefined, 600, 0, undefined, 1);
    var_7198a076 thread dialogue::function_47b06180();
    var_502e747d thread dialogue::function_47b06180();
    level notify(#"hash_184a766cab2b78a7");
    if (math::cointoss()) {
        var_502e747d dialogue::queue("vox_cp_rkgb_09430_krav_waitamoment_f4", undefined, 1);
    } else {
        var_7198a076 dialogue::queue("vox_cp_rkgb_09430_zakh_holdon_b2", undefined, 1);
    }
    wait randomfloatrange(1.5, 2.5);
    if (math::cointoss()) {
        var_502e747d dialogue::queue("vox_cp_rkgb_09430_krav_doyouseesomethi_86");
    } else {
        var_7198a076 dialogue::queue("vox_cp_rkgb_09430_zakh_canihelpyou_00");
    }
    wait randomfloatrange(1.5, 2.5);
    if (math::cointoss()) {
        var_502e747d dialogue::queue("vox_cp_rkgb_09430_krav_iwouldgetmoving_7a");
        return;
    }
...
function function_3aa52402() {
    ...
    while (true) {
        self waittill(#"hash_4a0fbc56973e3025");
        self flag::set(flag);
