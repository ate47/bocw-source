...
function private function_f2a2832d(*player, msg) {
    ...
    case #"hash_4fef8a23b1544f54":
        ...
        wait 3;
        snd::function_964c3a03(voice, 0.01, 3);
        wait 2;
        snd::stop(voice, 0.1);
        break;
...
function function_5c29b8ba() {
    ...
    while (true) {
        ...
        if (player istouching(self)) {
            ...
            if (isdefined(grass)) {
                snd::function_db78159d(grass, var_5d54552c);
            }
...
function function_488e467() {
    ...
    snd::function_db78159d(var_477fac82, 0.251);
    level waittill(#"rat_tunnels_throb_medium");
    snd::function_db78159d(var_477fac82, 0.501, 1);
    snd::function_964c3a03(var_477fac82, 1.07, 1);
    level waittill(#"rat_tunnels_throb_high");
    snd::function_db78159d(var_477fac82, 1, 3);
    snd::function_964c3a03(var_477fac82, 1.15, 3);
    level waittill(#"rat_tunnels_ambience_fade_out");
    snd::stop(var_477fac82, 3);
    snd::function_964c3a03(var_477fac82, 0.9, 3);
}
...
function pre_injection_hallway_sfx() {
    ...
    snd::function_db78159d(var_9e4626e9, 0);
    snd::function_db78159d(var_ea09dcad, 0);
    level.var_46b963df = "forward";
    reversed = 0;
    level waittill(#"mkultra_sound_on");
    snd::play("evt_hallway_mkultra_injection");
    snd::function_db78159d(var_ea09dcad, 1, 3);
    ...
    snd::function_db78159d(heartbeat, 0);
    snd::function_964c3a03(heartbeat, 0.5);
    waitframe(1);
    snd::function_db78159d(heartbeat, 1, 6);
    snd::function_964c3a03(heartbeat, 1, 10);
    ...
    while (level.var_7454541e == 1) {
        ...
        snd::function_964c3a03(var_ea09dcad, pitch, time, "easeinout");
        wait time;
        drop -= 5e-05;
    }
    var_8f1ace57 = pitch;
    ...
    while (true) {
        ...
        snd::function_964c3a03(var_ea09dcad, var_8f1ace57);
        snd::function_964c3a03(var_9e4626e9, var_8f1ace57);
        if (level.var_46b963df == "backward") {
            snd::function_db78159d(var_ea09dcad, 0, 0.05);
            snd::function_db78159d(var_9e4626e9, var_5d54552c, 0);
        }
        if (level.var_46b963df == "forward") {
            snd::function_db78159d(var_ea09dcad, var_5d54552c, 0);
            snd::function_db78159d(var_9e4626e9, 0, 0.05);
        }
        waitframe(1);
    }
}
...
function function_cc22752b(start_point) {
    while (true) {
        players = snd::function_da785aa8();
        player = players[0];
        org_player = player snd::function_efda2d6d();
...
function function_500b7ed1(vol, pitch) {
    ...
    snd::function_db78159d(beat, vol);
    snd::function_964c3a03(beat, pitch);
    players = snd::function_da785aa8();
    player = players[0];
    var_16f8cca9 = player getlocalclientnumber();
...
function function_3a0734a4(heartbeat) {
    ...
    snd::function_964c3a03(heartbeat, 0.5, 14);
...
function function_c635eb23() {
    ...
    while (running == 1) {
        ...
        if (level.var_ad3afa08 == 0) {
            ...
            time = 10;
            snd::function_db78159d(amb, 0.398, time);
        } else if (level.var_c635eb23 == 2) {
            time = 10;
            snd::function_db78159d(amb, 0.501, time);
        } else if (level.var_c635eb23 == 3) {
            time = 5;
            snd::function_db78159d(amb, 1, time);
        } else if (level.var_c635eb23 == 4) {
            time = 1;
            snd::function_db78159d(amb, 0.5, time);
            snd::function_964c3a03(amb, 3, time);
        }
        wait time;
    }
    if (isdefined(amb)) {
...
function function_26ec9e99(org_start, org_end, alias) {
    ...
    while (isplayer(player)) {
        ...
        if (distance(org_player, org) < 50 && org != org_start && org != org_end) {
            ...
            if (level.var_dc404c80 == 0) {
                snd::function_db78159d(amb, var_5d54552c);
            } else {
                snd::function_db78159d(amb, 0, 1);
            }
            snd::function_964c3a03(amb, var_8f1ace57);
        }
        waitframe(1);
    }
}
    ...
    while (isplayer(player)) {
        ...
        if (distance(org_player, org) < 50 && org != org_start && org != org_end) {
            ...
            if (isdefined(var_1dda358a)) {
                snd::function_db78159d(var_1dda358a, var_5d54552c);
                snd::function_964c3a03(var_1dda358a, var_8f1ace57);
            }
            if (isdefined(var_38356c94)) {
                snd::function_db78159d(var_38356c94, var_5d54552c);
                snd::function_964c3a03(var_38356c94, var_8f1ace57);
            }
...
function function_670b73d1() {
    ...
    if (level.var_cf6581e7 == 0) {
        ...
        snd::function_db78159d(level.var_e7abcaa4, 0);
    }
    if (isdefined(level.var_bfcd020d) && isdefined(level.var_e7abcaa4) && level.var_cf6581e7 == 1) {
        if (level.var_4b36b09 == "start") {
            snd::function_db78159d(level.var_bfcd020d, 1);
            snd::function_db78159d(level.var_e7abcaa4, 0);
            snd::function_964c3a03(level.var_bfcd020d, 1);
            snd::function_964c3a03(level.var_e7abcaa4, 1);
            return;
        }
        if (level.var_4b36b09 == "low") {
            snd::function_db78159d(level.var_bfcd020d, 0);
            snd::function_db78159d(level.var_e7abcaa4, 1);
            snd::function_964c3a03(level.var_bfcd020d, 1);
            snd::function_964c3a03(level.var_e7abcaa4, 1);
            return;
        }
        if (level.var_4b36b09 == "mid") {
            snd::function_db78159d(level.var_bfcd020d, 1);
            snd::function_db78159d(level.var_e7abcaa4, 1);
            snd::function_964c3a03(level.var_bfcd020d, 1.25);
            snd::function_964c3a03(level.var_e7abcaa4, 1.25);
            return;
        }
        if (level.var_4b36b09 == "high") {
            snd::function_db78159d(level.var_bfcd020d, 1);
            snd::function_db78159d(level.var_e7abcaa4, 1);
            snd::function_964c3a03(level.var_bfcd020d, 1.5);
            snd::function_964c3a03(level.var_e7abcaa4, 1.5);
        }
    }
}
...
function function_b5ac929c(entity, threshold, timeout) {
    ...
    move = 0;
    for (time = 0; move == 0 || time >= timeout; time += 0.01) {
    ...
    while (true) {
        ...
        if (vol > peak) {
            ...
            if (var_819cb54 == 1 && vol > var_9a7e5a7e) {
                var_3a987e10 = distance(player.origin, var_188f29f5);
                var_e560d39e = distance(player.origin, var_9d2fe6d6);
                if (var_3a987e10 < 1500 || var_e560d39e < 2000) {
        ...
        /#
        #/
        snd::function_db78159d(var_cd204b54, var_5d54552c);
        snd::function_db78159d(var_bb5627c0, var_5d54552c);
        snd::function_db78159d(var_b5ac1c6c, var_5d54552c);
        snd::function_db78159d(var_6d856785, var_5d54552c);
        snd::function_db78159d(var_977ebb77, var_5d54552c);
        snd::function_db78159d(var_6d4a670b, var_5d54552c);
        snd::function_db78159d(var_72a32f4b, var_5d54552c);
        snd::function_db78159d(var_c0624acc, var_5d54552c);
        snd::function_db78159d(var_ce0c6620, var_5d54552c);
        snd::function_db78159d(var_e40557d, var_5d54552c);
        snd::function_db78159d(battle, var_5d54552c);
        snd::function_db78159d(var_eb52d24e, var_5d54552c);
        waitframe(1);
    }
}
...
// Size: 0x44
function function_30054301(var_afe43979, player, org_start, org_end) {
    var_afe43979 thread function_2fc1b3a7(var_afe43979, player, org_start, org_end);
}
...
// Size: 0x104
function private function_2fc1b3a7(var_afe43979, player, org_start, org_end) {
    var_afe43979 notify(#"hash_20f2dfe33da3f037");
    var_afe43979 endon(#"hash_20f2dfe33da3f037");
    players = snd::function_da785aa8();
    player = players[0];
    player endon(#"death");
    while (isplayer(player) && snd::function_a6779cbd(var_afe43979)) {
        org_player = player snd::function_efda2d6d();
        org = pointonsegmentnearesttopoint(org_start, org_end, org_player);
...
// Size: 0x48
function function_ff8cbed3(var_afe43979) {
    if (!isdefined(var_afe43979) || function_3132f113(var_afe43979)) {
        return;
    }
    var_afe43979 notify(#"hash_20f2dfe33da3f037");
}
