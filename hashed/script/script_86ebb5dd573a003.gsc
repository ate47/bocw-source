...
function function_e4fcb32e() {
    ...
    if (isdefined(self.anim_door)) {
        ...
        var_eb4c120a = self.anim_door.angles;
        if (var_eb4c120a != self.anim_door.original_angles) {
            delta_angles = self.anim_door.original_angles - var_eb4c120a;
...
function function_262b28d4(is_civ, scenedef) {
    ...
    if (!level flag::get("alley_2_stealth_was_broken")) {
        if (is_true(is_civ)) {
            ...
            waitresult = self waittill(#"stop_vignette_scene", #"hash_39550364a879e1d4", #"stealth_combat", #"stealth_investigate", #"damage", #"death", #"set_alert_level");
        }
    } else {
        wait 2;
    }
...
function function_ca7fdd25(color) {
    ...
    if (color == "brown") {
        self setmodel(#"hash_78384bd882169e55");
        return;
    }
    if (color == "green") {
        self setmodel(#"hash_60a57b4334181ca4");
        return;
    }
    if (color == "maroon") {
...
// Size: 0xd8
function function_ede3f327(var_1be62bdc) {
...
// Size: 0x148
function function_d0551a1b(var_e418f02f, var_9661c188, delay_min, delay_max) {
    var_b29c8b6b = getent(var_e418f02f, "targetname");
    var_3e1bc9cc = var_b29c8b6b ai::function_18c4ff86("axis", "human");
    goalvolume = getent(var_9661c188, "targetname");
    foreach (var_2cf628d4 in var_3e1bc9cc) {
        var_2cf628d4 thread function_3817d3c4(delay_min, delay_max, goalvolume);
    }
...
function private function_1f24a0cc(on) {
    ...
    level notify(#"hash_65141e7615120b1a");
}
...
function private function_82f7d1ba() {
    level endon(#"hash_65141e7615120b1a");
