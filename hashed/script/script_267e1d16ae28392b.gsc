...
// Size: 0x204
function function_cc2216e2(var_7607ad3) {
    var_b0abc67b = [];
    ...
    foreach (msn in var_cf1f3586) {
        if (!var_7607ad3 stats::get_stat(#"mapdata", msn, #"complete")) {
            continue;
        }
        highestdifficulty = var_7607ad3 stats::get_stat(#"mapdata", msn, #"highestdifficulty");
...
// Size: 0x7c
function function_8b531812(var_7607ad3, evictim) {
    if (isdefined(evictim.var_e2f6147a) && evictim.var_e2f6147a == var_7607ad3 && evictim.team !== #"allies") {
        var_7607ad3 function_659819fa(#"hash_1f0a3ec94eff5513");
    }
}
...
// Size: 0x5c
function function_6e3f345f(var_7607ad3) {
    var_71c7cc3a = var_7607ad3 getmeleechaincount();
    if (2 <= var_71c7cc3a) {
        var_7607ad3 function_659819fa(#"hash_42303e6214910391");
    }
}
