...
function function_83dd8b4() {
    ...
    level thread namespace_8a404420::function_abbfce09(var_f43dffab);
...
function function_982e9ab() {
    level.var_7b4c584e val::set(#"hash_7582767c1785e448", "ignoreme", 1);
    level.var_7b4c584e val::set(#"hash_7582767c1785e448", "ignoreall", 1);
    wait 3;
    level.var_7b4c584e val::set(#"hash_7582767c1785e448", "ignoreme", 0);
    level.var_7b4c584e val::set(#"hash_7582767c1785e448", "ignoreall", 0);
}
...
function function_5e8fd656() {
    level flag::wait_till("flg_excavation_alpha_crane_rotate");
    level thread breadcrumb::function_61037c6c(#"hash_43946f5e4586fc64");
...
function function_c0f9e627() {
    ...
    wait 3;
    if (!is_true(level.var_7b4c584e.istalking)) {
...
// Size: 0x20c
function function_794d84a9(var_2ec9696a, var_8dea88af, var_5886965f, var_8a12da56, var_779361c7 = 0, var_3e5a4606 = 0) {
    self endon(#"death");
    if (var_779361c7 == 1) {
    ...
    if (isdefined(var_2ec9696a) && isdefined(var_8dea88af)) {
        if (var_779361c7 == 1) {
            ...
            level flag::wait_till_any(array(var_2ec9696a, var_5886965f));
        } else {
    ...
    if (isdefined(var_5886965f) && isdefined(var_8a12da56)) {
        level flag::wait_till(var_5886965f);
        self cleargoalvolume();
...
function function_ab15a34c(*str_objective) {
    ...
    level.var_7b4c584e forceteleport(var_3c499539.origin, var_3c499539.angles);
...
function function_4ef657c() {
    ...
    while (!level flag::get("flg_excavation_delta_zipline_used")) {
        ...
        if (s_notify.var_14af458a == "zipline_excavation_5") {
            ...
            wait var_46f5bd8b;
            wait 1;
            level.var_7b4c584e forceteleport(negotiation_node_zipline_5_begin.origin, negotiation_node_zipline_5_begin.angles);
...
function function_4a1a74fe(*str_objective) {
    ...
    level.var_7b4c584e forceteleport(var_532adac5.origin, var_532adac5.angles);
...
function function_32d9a51b() {
    ...
    level.var_7b4c584e hms_util::dialogue("(Radio) Approaching your AO, Woods. You've pissed off a lot of people down there.", 1, undefined, "Dimitri");
    level.var_7b4c584e hms_util::dialogue("Like I wasn't aware!");
    level flag::wait_till("flg_excavation_charlie_approach");
    level.var_7b4c584e hms_util::dialogue("How about you give us a fuckin' hand, Dimitri!");
    level flag::wait_till_any(var_b58a047);
    level.var_7b4c584e hms_util::dialogue("(Radio ) Da! Covering your flank!", 1, undefined, "Dimitri");
}
