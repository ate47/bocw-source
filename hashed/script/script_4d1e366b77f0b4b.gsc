...
function private function_e96e00cc() {
    /#
        if (isarchetypeloaded(#"hash_7c0d83ac1e845ac2")) {
            ...
            add_custom_devgui_callback(&function_15677aa0);
            function_1d9f7b18();
        }
    #/
}
    ...
    /#
        ...
        case #"hash_794aad9f189f1889":
            ...
            if (isdefined(var_380c580a) && var_380c580a.data.size > 0) {
                s_spot.origin.s_spot = var_380c580a.data[0].origin;
            } else {
                s_spot.origin.s_spot = player.origin;
            }
            s_spot.angles.s_spot = (0, player.angles[1] - 180, 0);
            spawner = #"hash_455ec8cc0d1ed4a4";
            if (cmd == "<unknown string>") {
                spawner = #"hash_5471f6916965b2d2";
            } else if (cmd == "<unknown string>") {
                spawner = #"hash_12db1a8b34aa7918";
            } else if (cmd == "<unknown string>") {
                function_f045e7c(s_spot, 0);
                break;
            }
            var_6a9dfa7b = spawnactor(spawner, s_spot.origin, s_spot.angles);
            if (isdefined(var_6a9dfa7b)) {
                var_6a9dfa7b forceteleport(s_spot.origin);
            }
            break;
        case #"hash_7168487d1ca40ace":
            var_84e505 = getaiarchetypearray(#"hash_7c0d83ac1e845ac2");
            foreach (var_6a9dfa7b in var_84e505) {
                var_6a9dfa7b thread function_735ef74d();
            }
            break;
        case #"hash_56fe56d42aeaae84":
            var_84e505 = getaiarchetypearray(#"hash_7c0d83ac1e845ac2");
            foreach (var_6a9dfa7b in var_84e505) {
                if (isalive(var_6a9dfa7b)) {
                    var_6a9dfa7b function_bf898e7e(!var_6a9dfa7b function_b37b32b9());
                }
            }
            break;
        case #"hash_6c5505a13bdeb727":
            ...
            foreach (var_6a9dfa7b in var_84e505) {
                if (isalive(var_6a9dfa7b)) {
                    if (!isdefined(var_6a9dfa7b.var_9fde8624) || var_6a9dfa7b function_ba878b50() || var_6a9dfa7b.var_9fde8624 === #"hash_5605f3a585b3ef9f") {
                        var_6a9dfa7b function_af554aaf(!is_true(var_6a9dfa7b.var_53bac70d));
                    }
                }
            }
            break;
        case #"hash_359a6fc8ff117087":
            ...
            foreach (var_6a9dfa7b in var_84e505) {
                if (isalive(var_6a9dfa7b)) {
                    if (!isdefined(var_6a9dfa7b.var_9fde8624) || var_6a9dfa7b function_3758a4e7() || var_6a9dfa7b.var_9fde8624 === #"hash_5605f3a585b3ef9f") {
                        var_6a9dfa7b function_16a8babd(!is_true(var_6a9dfa7b.var_22b8f534));
                    }
                }
            }
            break;
        case #"hash_24ad0cbc87557614":
            ...
            foreach (var_6a9dfa7b in var_84e505) {
                if (isalive(var_6a9dfa7b)) {
                    var_6a9dfa7b.ai.var_bb06b848 = !var_6a9dfa7b.ai.var_bb06b848;
                }
            }
            break;
        case #"hash_2359be32da56aa21":
            var_84e505 = getaiarchetypearray(#"hash_7c0d83ac1e845ac2");
            var_ee2b2561 = undefined;
            var_7d80a94d = undefined;
            foreach (var_6a9dfa7b in var_84e505) {
                if (!isdefined(var_6a9dfa7b.var_9fde8624) || var_6a9dfa7b.var_9fde8624 === #"hash_5605f3a585b3ef9f") {
                    continue;
                }
                if (var_6a9dfa7b function_ba878b50() && !isdefined(var_ee2b2561)) {
                    var_ee2b2561 = var_6a9dfa7b;
                } else if (var_6a9dfa7b function_3758a4e7() && !isdefined(var_7d80a94d)) {
                    var_7d80a94d = var_6a9dfa7b;
                }
                if (isdefined(var_ee2b2561) && isdefined(var_7d80a94d)) {
                    level thread function_67a0e9a2([1:var_7d80a94d, 0:var_ee2b2561], var_ee2b2561);
                    break;
                }
            }
            break;
...
function spawn_single(b_force_spawn, var_eb3a8721 = 0, *var_bc66d64b) {
    ...
    if (isdefined(level.var_9d098364)) {
        ...
        spawner_name = #"hash_455ec8cc0d1ed4a4";
    }
...
function function_f0811059() {
    ...
    while (count < 10) {
        ...
        } else if (level.zm_loc_types[#"hash_7d70de92d56468a1"].size > 0) {
...
function function_99c14949() {
    ...
    if (isdefined(level.var_2a8acd42)) {
        ...
        s_spawn_locs = level.zm_loc_types[#"hash_7d70de92d56468a1"];
    }
    var_69681a59 = [];
...
function private get_enemy() {
    ...
    } else if (isentity(self.attackable)) {
...
function private function_fe1e617c(entity) {
    if (isalive(entity)) {
        ...
        entity.var_f0d59f6d.entity = entity.var_f0d59f6d + 1;
        entity.variant_type.entity = 0;
        if (is_true(entity.ai.var_de17c5a5)) {
            entity.variant_type.entity = 2;
...
function private function_3aa93442(entity) {
    ...
    while (count < 3) {
        ...
        if (function_b860fc37(enemy)) {
            ...
            target_origin = target_origin + velocity * var_b98d779c;
...
function private function_829cfcc8(entity) {
    ...
    if (!isdefined(enemy) || !function_b860fc37(enemy)) {
        ...
        if (zm_utility::is_classic() && !isdefined(entity.var_cc1c538e)) {
            entity.var_cc1c538e.entity = entity zm_cleanup::get_escape_position();
        }
...
function private function_45fabe41(entity) {
    ...
    entity.ai.var_5dc77566 = 0;
    entity.var_f0d59f6d.entity = 0;
    entity.var_f8bb81c1 = undefined;
    entity.variant_type.entity = 0;
    if (is_true(entity.ai.var_de17c5a5)) {
        entity.variant_type.entity = 3;
        entity.ai.var_de17c5a5 = undefined;
    }
...
function private function_ac56fb75() {
    ...
    if (isdefined(var_33867b8b) && isdefined(var_863c0d4d)) {
        var_33867b8b.var_e293f8ac.var_33867b8b = [];
        if (!isdefined(var_33867b8b.var_e293f8ac)) {
            var_33867b8b.var_e293f8ac.var_33867b8b = [];
        } else if (!isarray(var_33867b8b.var_e293f8ac)) {
            var_33867b8b.var_e293f8ac.var_33867b8b = array(var_33867b8b.var_e293f8ac);
        }
        if (!isinarray(var_33867b8b.var_e293f8ac, var_863c0d4d)) {
            var_33867b8b.var_e293f8ac[var_33867b8b.var_e293f8ac.size] = var_863c0d4d;
        }
        var_863c0d4d.var_e293f8ac.var_863c0d4d = [];
        if (!isdefined(var_863c0d4d.var_e293f8ac)) {
            var_863c0d4d.var_e293f8ac.var_863c0d4d = [];
        } else if (!isarray(var_863c0d4d.var_e293f8ac)) {
            var_863c0d4d.var_e293f8ac.var_863c0d4d = array(var_863c0d4d.var_e293f8ac);
        }
        if (!isinarray(var_863c0d4d.var_e293f8ac, var_33867b8b)) {
            var_863c0d4d.var_e293f8ac[var_863c0d4d.var_e293f8ac.size] = var_33867b8b;
        }
        var_33867b8b.var_24f0cbe0.var_33867b8b = self function_7f0363e8(1);
        var_863c0d4d.var_24f0cbe0.var_863c0d4d = self function_7f0363e8(1);
    }
    if (isdefined(self.var_9d59692c)) {
        self [[ self.var_9d59692c ]](var_33867b8b, var_863c0d4d);
    }
    /#
        var_97edc82 = isdefined(var_33867b8b) ? "<unknown string>" + var_33867b8b getentitynumber() + "<unknown string>" + health : "<unknown string>";
        function_ee21651d(var_97edc82);
        var_97edc82 = isdefined(var_863c0d4d) ? "<unknown string>" + var_863c0d4d getentitynumber() + "<unknown string>" + health : "<unknown string>";
        function_ee21651d(var_97edc82);
    #/
    self function_bf898e7e(0);
    ...
    waitframe(1);
    self notify(#"hash_1164e7fab4c30c91");
...
function private function_eafb4701(aitype, location, health, var_188c5348, var_c0bfa8c2) {
    ...
    entity notify(#"hash_57cb7b473056de06", {#var_c0bfa8c2:var_c0bfa8c2, #var_188c5348:var_188c5348, #angles:angles, #origin:location.origin});
    entity.maxhealth = health;
    entity.health = health;
    entity setmaxhealth(health);
    entity.ignore_enemy_count.entity = 1;
    return entity;
}
...
// Size: 0x26
function private function_9cd04ab6(var_7b98fd50) {
    self.var_a0a8f386 = 1;
    self.var_42fce69b = var_7b98fd50;
}
...
function private function_9cc1ebd1() {
    return is_true(self.var_a0a8f386) && !isalive(self.var_42fce69b);
}
...
function private function_3c494a14() {
    ...
    self animcustom(&function_a4b84f9a, &function_6eb93507, "split_intro_run", "split_intro_end");
}
...
function function_a4b84f9a() {
    ...
    if (isdefined(var_74ee8be8)) {
        var_74ee8be8 = var_74ee8be8 * getanimlength(self.var_3a51c5dc);
    } else {
        var_74ee8be8 = 0;
    }
    wait(var_74ee8be8);
...
function private function_3108de07(var_fde10e1d) {
    ...
    var_d9ca447f = isdefined(rightposition) && distancesquared(startposition, rightposition) + 1 >= function_a3f6cdac(var_fde10e1d) && bullettracepassed(startposition + (0, 0, 30), rightposition + (0, 0, 30) + var_f62bfdc0 * self getpathfindingradius(), 0, self);
    ...
    var_290edef9 = isdefined(leftposition) && distancesquared(startposition, leftposition) + 1 >= function_a3f6cdac(var_fde10e1d) && bullettracepassed(startposition + (0, 0, 30), leftposition + (0, 0, 30) - var_f62bfdc0 * self getpathfindingradius(), 0, self);
...
function private function_51fb171c() {
    ...
    var_3521085c = function_a3f6cdac(var_9762dbfe);
    foreach (ent in ents) {
...
function function_7cac529b(behaviortreeentity) {
    ...
    if (isdefined(enemy) && function_b860fc37(enemy)) {
        ...
        var_5eb7ad1f = behaviortreeentity can_see_enemy();
        return behaviortreeentity function_3e6b7dd4(enemy, var_eab3f54a, var_5eb7ad1f);
...
// Size: 0x5d6
function private function_3e6b7dd4(enemy, var_eab3f54a, var_5eb7ad1f) {
    radiussqr = function_a3f6cdac(self getpathfindingradius());
    if (!isdefined(enemy)) {
        self clearpath();
        return 0;
    }
    ...
    if (!isdefined(goal)) {
        ...
        goal = function_d040bd9(enemy.origin, var_515f97cf, 30);
    }
    if (isdefined(goal)) {
        var_57e5ec79 = distancesquared(enemy.origin, goal);
        var_600ef3ea = var_57e5ec79 > 1024;
        if (is_true(var_600ef3ea) && is_true(var_5eb7ad1f) && isplayer(enemy) && isdefined(self.var_2d5cbb7[enemy getentitynumber()])) {
...
// Size: 0x7e
function private function_a788e366(var_eab3f54a, var_5eb7ad1f) {
...
function private function_850378bc(behaviortreeentity) {
    if (behaviortreeentity isatgoal()) {
        behaviortreeentity.ignore_find_flesh.behaviortreeentity = 0;
...
function private function_2a30b3a3(n_duration) {
    self endon(#"hash_362dfacc3f97bf98", #"hash_39f4b987812e1540", #"death", #"hash_29b88049dcac8bb3");
    function_c01f9453();
    wait(n_duration);
    self.ai.var_a49798e7 = 0;
...
function private function_aed09e18(var_2fa3c4c9, location) {
    ...
    if (isdefined(location)) {
        ...
        var_6a9dfa7b = spawnactor(#"spawner_zm_steiner_f", location.origin, location.angles);
        if (isdefined(var_6a9dfa7b)) {
            ...
            var_6a9dfa7b.ignore_find_flesh.var_6a9dfa7b = 1;
            ...
            var_6a9dfa7b function_bf898e7e(0);
            var_6a9dfa7b function_af554aaf(0);
            var_6a9dfa7b function_16a8babd(0);
            var_6a9dfa7b.ignore_player.var_6a9dfa7b = getplayers();
        }
    }
...
function function_f045e7c(location, var_c406df14) {
    ...
    if (isdefined(var_6a9dfa7b)) {
        ...
        var_6a9dfa7b.ignoreall.var_6a9dfa7b = 1;
        var_6a9dfa7b.ignore_find_flesh.var_6a9dfa7b = 1;
        var_6a9dfa7b.ignoreme.var_6a9dfa7b = 0;
        var_6a9dfa7b.ignore_nuke.var_6a9dfa7b = 1;
        var_6a9dfa7b.ignore_all_poi.var_6a9dfa7b = 1;
        var_6a9dfa7b.instakill_func.var_6a9dfa7b = &zm_powerups::function_16c2586a;
        var_6a9dfa7b.var_d003d23c.var_6a9dfa7b = 1;
        var_6a9dfa7b.takedamage.var_6a9dfa7b = 1;
        var_6a9dfa7b.var_8d1d18aa.var_6a9dfa7b = 0;
        var_6a9dfa7b.ai.var_a29f9a91 = var_c406df14;
        var_6a9dfa7b.variant_type.var_6a9dfa7b = 0;
        var_6a9dfa7b function_bf898e7e(0);
        var_6a9dfa7b function_af554aaf(0);
        var_6a9dfa7b function_16a8babd(0);
...
function function_bbb547de(dist) {
    /#
        ...
        foreach (var_6a9dfa7b in var_ddb534a3) {
            fwd = vectorscale(vectornormalize(anglestoforward(var_6a9dfa7b.angles)), dist);
            eye = var_6a9dfa7b.origin + vectorscale((0, 0, 1), 80);
            trace = bullettrace(eye, eye + fwd, 0, undefined);
            var_380c580a = positionquery_source_navigation(trace[#"position"], 128, 256, 128, 20);
            point = var_6a9dfa7b.origin;
            if (isdefined(var_380c580a) && var_380c580a.data.size > 0) {
                point = var_380c580a.data[0].origin;
            }
            goal = getclosestpointonnavmesh(point);
            if (isdefined(goal)) {
                var_6a9dfa7b thread function_7e855c12(goal);
            }
        }
    #/
}
...
function function_32af84be(target) {
    /#
        var_ddb534a3 = function_46d99f6b();
        foreach (var_6a9dfa7b in var_ddb534a3) {
            var_6a9dfa7b thread function_c6579189(target);
        }
    #/
}
