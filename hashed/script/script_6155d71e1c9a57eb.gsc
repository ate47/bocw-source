...
function function_28f119be()
{
    ...
    while ( true )
    {
        ...
        {
            self notify( #"change_underscore", { #var_9c1ed9ea:"survival_underscore_active" } );
        }
        else if ( var_d300714c.var_8cebd3a9 && !var_3ac2b3dc && self.var_edc6d524 === "" )
        {
            self notify( #"change_underscore", { #var_9c1ed9ea:"survival_underscore" } );
        }
        else if ( !var_d300714c.var_8cebd3a9 && !var_3ac2b3dc && self.var_edc6d524 != "survival_underscore" )
        {
            ...
            {
                self notify( #"change_underscore", { #var_9c1ed9ea:"" } );
            }
        }
        else if ( !var_d300714c.var_8cebd3a9 && !var_3ac2b3dc && self.var_edc6d524 != "" )
        {
