...
function private function_2d47ee1e(var_6ed927a6, var_caba78c2, waittime, var_ef5e1b44, var_d6388d1 = 0, vehicletype = undefined) {
    ...
    var_ef5e1b44.var_7f40d76c.var_ef5e1b44 = 1;
    ...
    var_ef5e1b44.heightoffset.var_ef5e1b44 = var_ef5e1b44.heightoffset + 600;
}
...
function start(supplydrops = 1, minwaittime = 20, var_fe6b2eab = 20) {
    ...
    for (var_f2cf27c4 = 0; 1; var_f2cf27c4++) {
        ...
        var_ef5e1b44.var_7f40d76c.var_ef5e1b44 = 0;
        var_ef5e1b44.heightoffset.var_ef5e1b44 = 0;
    ...
    while (var_b77770ba < var_4b43f3d) {
        ...
        if (isdefined(var_9fb224d1) && var_9fb224d1.size > 0) {
            if (isint(var_69cea650)) {
                var_aff86dc2 = function_a3f6cdac(var_69cea650);
                var_dedb993c = 0;
