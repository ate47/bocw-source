...
function function_4e0c00e9() {
    ...
    level.var_3dc80578 = util::spawn_model(#"hash_728bb8531360608d", level.fuse_box gettagorigin("tag_fuse_01"), level.fuse_box gettagangles("tag_fuse_01"));
...
function function_f021f2da() {
    ...
    var_78afc843 = util::spawn_model(#"hash_728bb8531360608d", level.fuse_box gettagorigin("tag_fuse_02"), level.fuse_box gettagangles("tag_fuse_02"));
