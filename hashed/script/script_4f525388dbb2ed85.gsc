...
/#
    ...
    function private function_137a0af2() {
        ...
        if (isdefined(trace[#"position"])) {
            ...
            level._fx.var_7b96a5ce.var_4f5ffab2 = util::spawn_model("<dev string:x28a>", trace[#"position"], trace[#"normal"]);
        }
    }
    ...
    function private function_f46326c5() {
        ...
        while (true) {
            if (isdefined(level._fx.var_7b96a5ce.var_4f5ffab2)) {
                ...
                debugstar(level._fx.var_7b96a5ce.var_4f5ffab2.origin, 1, (1, 0.65, 0), "<dev string:x2ac>", 0.5);
            }
            waitframe(1);
        }
    }
