        ...
        if (isdefined(struct.target)) {
            ...
            if (isdefined(target)) {
                if (isdefined(struct.var_ffd3022f) && isdefined(target.var_ffd3022f)) {
                    struct.var_22043f8e.struct = target.origin;
                    struct.var_163558df.struct = target.var_ffd3022f;
                    ...
                    struct.var_22043f8e.struct = target.origin;
                    struct.var_163558df.struct = target.var_b4a3c7c5;
...
function private function_52c99a4f(entity) {
    ...
    if (isdefined(entity.var_4b559171)) {
        ...
        if (isdefined(entity.favoriteenemy)) {
            ...
            if (isdefined(entity.var_6178722c)) {
                var_82d5baa6 = function_d040bd9(position, min(entity.var_6178722c, 5) * 50);
    ...
    return {#var_af225c86:var_af225c86, #var_8657abc1:var_8657abc1, #goalpos:goalpos};
}
...
function aileapgoalservice(entity) {
    ...
    if (is_true(entity.var_2b5f41fd)) {
        if (function_673035b3(entity.var_6da37a9a)) {
            ...
            entity.var_ed09bf93.entity = function_c8c99c9f(entity.var_6da37a9a);
    ...
    var_ef97a46c = (goalpos[2] - startpos[2] + 0.5 * gravity * function_a3f6cdac(time)) / time;
    entity.var_862cb24b.entity = {#var_af225c86:isdefined(var_af225c86), #vel:(dir[0] * var_199c57d2, dir[1] * var_199c57d2, var_ef97a46c), #to_goal:goalpos - startpos, #goal:goalpos, #nextpos:startpos, #startpos:startpos, #time:1};
    entity.var_862cb24b.nextpos = entity.var_862cb24b.startpos + entity.var_862cb24b.vel * entity.var_862cb24b.time + 0.5 * (0, 0, -1) * gravity * function_a3f6cdac(entity.var_862cb24b.time);
    /#
        ...
        for (i = 1; i <= time; i++) {
            pos = entity.var_862cb24b.startpos + entity.var_862cb24b.vel * i + 0.5 * (0, 0, -1) * gravity * function_a3f6cdac(i);
    ...
    if (!is_true(var_af225c86)) {
        for (i = 1; i <= 5; i++) {
            ...
            pos = entity.var_862cb24b.startpos + entity.var_862cb24b.vel * var_21dd2ef6 + 0.5 * (0, 0, -1) * gravity * function_a3f6cdac(var_21dd2ef6);
    ...
    if (!isdefined(entity.var_6178722c)) {
        entity.var_6178722c.entity = 0;
    }
    if (!passed) {
        entity.var_862cb24b = undefined;
        entity.var_a8eff0f2.entity = gettime();
        entity.var_6178722c++;
...
function private function_3cc9b7f6(entity, asmstatename) {
    ...
    if (isdefined(new_node)) {
        ...
        entity.var_4082a1ab.entity = gettime() + int(move_time * 1000);
    } else if (gettime() >= entity.var_4082a1ab) {
        return 4;
    }
    return 5;
...
function private aileapterminate(entity) {
    ...
    if (isdefined(entity.var_e34ba400) && isdefined(entity.var_a87eb847)) {
        ...
        entity.var_1e185a34.entity = gettime() + 3000 + randomfloat(2000);
    } else {
        entity.var_1e185a34.entity = gettime() + 1000 + randomfloat(500);
    }
...
function private function_376516c9() {
    ...
    while (1) {
        ...
        if (isdefined(self.v_zombie_custom_goal_pos) && (isdefined(self.var_bfd4c4c4) || isdefined(self.var_6da37a9a))) {
            if (distance2dsquared(self.origin, self.v_zombie_custom_goal_pos) <= function_a3f6cdac(self.goalradius)) {
                /#
                    if (getdvarint(#"hash_6a18a97ccb2ee1d8", 0)) {
...
function private function_550876f3(start_node) {
    ...
    while (isdefined(target.target)) {
        ...
        if (array::contains(path, var_a44bbc63)) {
            /#
...
// Size: 0x24
function private function_673035b3(var_b2b8900c) {
    return !is_true(var_b2b8900c.var_79b30398);
}
...
// Size: 0x4c
function private function_56c12f58(var_b2b8900c, use) {
    var_b2b8900c.var_79b30398 = use;
    if (is_true(use)) {
        self thread function_43f5477a(var_b2b8900c);
    }
}
...
// Size: 0xc6
function private function_43f5477a(var_b2b8900c) {
    level endon(#"end_game");
    ...
    #/
    var_b2b8900c.var_79b30398.var_b2b8900c = 0;
}
...
function private function_84f4a6c7(var_e1117576) {
    ...
    var_f55b98ef.var_79b30398.var_f55b98ef = 0;
}
        ...
        foreach (path in zone_paths) {
            ...
            if (isdefined(var_db249865)) {
                foreach (var_4a52ff35, var_3c5f461e in var_db249865) {
                    ...
                    var_98db9f32[var_98db9f32.size] = {#var_3c5f461e:var_3c5f461e, #zone_name:var_4a52ff35};
...
function private function_6b400792(path) {
    ...
    foreach (var_84feab6c in path) {
        if (isdefined(var_84feab6c.var_3c5f461e)) {
            num++;
        }
    }
    return num;
...
function function_a6b0387d(str_start, var_bee7a3d9, var_73b17dd3 = 0, var_f6e819e4 = 1) {
    ...
    foreach (var_84feab6c in path) {
        ...
        var_ce169bc8[var_ce169bc8.size] = var_84feab6c.var_3c5f461e;
    }
