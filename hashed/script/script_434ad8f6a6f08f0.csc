...
function private _objective(objective) {
    ...
    case #"ambush":
        break;
    case #"hash_23cd2f040f7f43fc":
        thread function_85ebb65();
        break;
    case #"hash_2776c9171cd391dd":
        break;
...
function snipercam() {
    while (true) {
        ...
        params = level waittill(#"hash_15798afdb00a8f94");
...
function function_cd797f90() {
    ...
    snd::function_db78159d(var_7de9bf5e, 0);
    snd::function_db78159d(var_7de9bf5e, 1, 9, "linear");
    function_5ea2c6e3("cp_mute_amb", 0);
    level waittill(#"hash_5cc6be68301e650c");
    function_ed62c9c2("cp_mute_amb", 5);
    snd::function_db78159d(var_7de9bf5e, 0, 15, "linear");
    wait 15;
