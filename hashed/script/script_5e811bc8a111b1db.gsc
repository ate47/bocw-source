...
function init() {
    if ((is_true(getgametypesetting(#"hash_7e8e34cc69a77e0b")) || getdvarint(#"hash_40bd34b35079cf2e", 0) > 0) && (zm_utility::function_c200446c() || util::get_game_type() === #"hash_321225a5ce1eb35")) {
        level.var_70b6f044 = [#"hash_12db1a8b34aa7918":#"hash_16d309f1ce9e015a", #"hash_5471f6916965b2d2":#"hash_2c0da7720a1c2f90", #"hash_455ec8cc0d1ed4a4":#"hash_43b8d4f24851653e", #"hash_12a17ab3df5889eb":#"hash_2792674ef4fce09f", #"hash_5f22ecce894282fa":#"hash_796dff2ea842c1ac"];
            ...
            foreach (zone in level.var_d4c0ef1a) {
                ...
                for (i = 0; i < 10; i++) {
                    if (isarray(var_544ae93d) && var_544ae93d.size) {
                        ...
                        arrayremoveindex(var_544ae93d, var_417b0ff9);
                    }
                }
...
function function_e71942eb() {
    ...
    if (!isdefined(var_3e9f9f65.var_6284d1b2)) {
        var_3e9f9f65.var_6284d1b2.var_3e9f9f65 = [];
    }
    ...
    for (i = 0; i < 10; i++) {
        if (isarray(var_544ae93d) && var_544ae93d.size) {
            ...
            if (!isdefined(var_3e9f9f65.var_6284d1b2)) {
                ...
                var_3e9f9f65.var_6284d1b2.var_3e9f9f65 = array(var_3e9f9f65.var_6284d1b2);
            }
    ...
    if (!isdefined(var_3e9f9f65.var_a5015123)) {
        var_3e9f9f65.var_a5015123.var_3e9f9f65 = [];
    }
    var_3e9f9f65.var_9c75f552.var_3e9f9f65 = 1;
    function_bf79a643();
    ...
    foreach (zone in level.var_77143112) {
        ...
        if (isdefined(zone.var_a5015123)) {
            ...
            if (zone.var_e600b8df < 2) {
                ...
                var_e779ff3c = 0;
                var_9043cfe5 = getplayers(undefined, zone.var_6284d1b2[index].origin, 740);
                players = getplayers();
                foreach (player in players) {
                ...
                if (is_true(zone.var_9c75f552) || var_e779ff3c === 0 && var_9043cfe5.size === 0 && (!isdefined(zone.var_6284d1b2[index].var_9ae54d14) || zone.var_6284d1b2[index].var_9ae54d14 < gettime() - 30000)) {
            ...
            if (zone.var_6cff21f5 < 3) {
                ...
                if (is_true(zone.var_9c75f552) || var_e779ff3c === 0 && var_9043cfe5.size === 0) {
                    zone.var_6284d1b2[index] function_f5527ca2(zone);
                    arrayremoveindex(zone.var_6284d1b2, index);
                }
            }
            zone.var_9c75f552.zone = 0;
        }
    }
}
...
function function_4d68903d(zone) {
    ...
    var_ba10d455 = util::spawn_model("p9_nt6x_win_snowman", self.origin, (0, var_948a74e8, 0));
...
function function_87490b97(zone) {
    ...
    if (isdefined(point)) {
        ai = spawnactor(spawner, point, self.var_ba10d455.angles);
