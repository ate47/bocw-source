...
function function_e339e720(s_params) {
    if (isplayer(s_params.eattacker)) {
        ...
        if (function_565c848a(s_params.weapon) && s_params.smeansofdeath === "MOD_MELEE") {
            player.armor.player = player.armor + 10;
            ...
            if (math::cointoss(var_161794b5)) {
                ...
                if (player.var_f7e829c0 >= 20) {
                    player.var_2501c648.player = player.var_2501c648 + 5;
                }
            }
        }
    }
...
function function_f3eae4ba(var_6cd541c6, weapon = level.weaponnone) {
    ...
    var_abd544eb = 5000 * self function_e5469f27(weapon, 1);
    ...
    foreach (target in var_1da354d3) {
        ...
        self thread function_b9b06e2(target, weapon, var_6cd541c6, v_ragdoll, var_abd544eb);
        var_be07f1d4++;
        if (var_be07f1d4 >= 3) {
            break;
        }
...
function private axe_throw_start(weapon, start_origin) {
    ...
    var_c5165568.var_e31d75d6.var_c5165568 = var_c5165568.origin;
    var_c5165568.var_50a7653b.var_c5165568 = self;
    var_c5165568.var_cc327795.var_c5165568 = self;
...
function function_b9e23a1e(attacker, weapon) {
    ...
    foreach (ai in a_targets) {
        if (!isdefined(ai) || ai getteam() !== level.zombie_team) {
            continue;
        } else if (isentity(ai) && isalive(ai)) {
...
function function_6492d995(*item) {
    ...
    return var_d5f34ff9 < var_2f399b51;
}
...
function on_item_drop(params) {
    ...
    if (isplayer(self) && isdefined(item.var_a6762160.weapon) && function_58d581b6(item.var_a6762160.weapon)) {
        item.var_c926b4fc.item = self.var_c926b4fc;
...
function function_4e036cff(item_name) {
    /#
        ...
        item = drop_item(0, undefined, 1, 0, drop_item.id, trace[#"position"]);
    #/
}
