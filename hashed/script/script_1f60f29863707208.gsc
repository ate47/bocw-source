...
function function_bb5d646a(localclientnum, *oldval, *newval, *bnewent, *binitialsnap, *fieldname, *bwasdemojump) {
    ...
    e_fx.var_94450cf4.e_fx = e_fx playloopsound(#"hash_1cefc6f663a17a63");
    var_f0029f2 = struct::get_array("harvesting_unit", "targetname");
    var_49408e95 = arraygetclosest(self.origin, var_f0029f2);
    util::playfxontag(bwasdemojump, #"hash_61e3c7a179d7cdfb", e_fx, "tag_origin");
    e_fx moveto(e_fx.origin + vectorscale((0, 0, 1), 40), 0.8);
    wait(0.75);
    n_time = distance(e_fx.origin, var_49408e95.origin) / 400;
    e_fx moveto(var_49408e95.origin + vectorscale((0, 0, 1), 32), n_time);
...
function function_1cd2646f(localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwasdemojump) {
    if (bwasdemojump) {
        ...
        if (self isplayer()) {
            self.var_726a59ef = playfxoncamera(fieldname, #"hash_20e2c4240d945676", (0, 0, 0), (1, 0, 0), (0, 0, 1));
            self postfx::playpostfxbundle(#"hash_75fe7a4dbc759253");
            self.var_51dd9721 = #"hash_75fe7a4dbc759253";
            if (!isdefined(self.var_fbd5f7c8)) {
                self.var_fbd5f7c8 = util::playfxontag(fieldname, #"hash_4fd736083a266936", self, "tag_stowed_back");
            }
...
function function_eb8ccdd(localclientnum, *oldval, *newval, *bnewent, *binitialsnap, *fieldname, *bwasdemojump) {
    playfx(bwasdemojump, #"hash_21de711a73de2b60", self.origin, vectorscale((1, 0, 0), 180));
...
function function_5907109e(localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwasdemojump) {
    ...
    } else if (isdefined(self.var_89711106)) {
...
function function_a342165a(localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwasdemojump) {
    ...
    } else if (isdefined(self.trail_fx)) {
...
function function_5cf50136(localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwasdemojump) {
    if (bwasdemojump == 1) {
        ...
        var_9f3ab0a1.fx.var_9f3ab0a1 = playfx(fieldname, #"hash_3426faf35f3452fe", var_9f3ab0a1.origin, anglestoforward(var_9f3ab0a1.angles), (0, 0, 1));
    } else if (isdefined(var_9f3ab0a1.fx)) {
...
function function_b7b588dd(localclientnum, *oldval, *newval, *bnewent, *binitialsnap, *fieldname, *bwasdemojump) {
    var_9f3ab0a1 = struct::get("hidden_door_fx_pos", "targetname");
    var_9f3ab0a1.fx.var_9f3ab0a1 = playfx(bwasdemojump, #"hash_1d44bbada6bc060f", var_9f3ab0a1.origin, anglestoforward(var_9f3ab0a1.angles), (0, 0, 1));
}
...
function function_60886116(localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwastimejump) {
    if (bwastimejump == 1) {
        self.var_3e3964d7 = playfx(fieldname, #"hash_7fde4896c77b40b9", self.origin, anglestoup(self.angles));
        ...
        wait(2.5);
        self.var_ae8b25ed = playfx(fieldname, #"hash_6e639d06fdd098bc", self.origin, anglestoforward(self.angles), anglestoup(self.angles));
    } else {
        self.var_1c6eb712 = playfx(fieldname, #"hash_19835c3bc870def", self.origin, anglestoforward(self.angles), anglestoup(self.angles));
...
function function_f7c615a4(localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwastimejump) {
    ...
    } else if (isarray(self.var_c03e08db) && self.var_c03e08db.size != 0) {
...
function function_6d56f7a8(localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwastimejump) {
    if (bwastimejump == 1) {
        ...
        var_3b1d1169.rob.var_3b1d1169 = #"hash_7f1bc2146f524d7c";
        var_3b1d1169.reveal.var_3b1d1169 = 1;
        var_3b1d1169.brightness.var_3b1d1169 = 0;
...
function function_6774a2f2(localclientnum, *oldval, *newval, *bnewent, *binitialsnap, *fieldname, *bwastimejump) {
    ...
    if (isdefined(var_3b1d1169.brightness)) {
        var_3b1d1169.brightness.var_3b1d1169 = var_3b1d1169.brightness + 0.025;
        if (var_3b1d1169.brightness < 0) {
            var_3b1d1169.brightness.var_3b1d1169 = 0;
        } else if (var_3b1d1169.brightness > 1) {
            var_3b1d1169.brightness.var_3b1d1169 = 1;
        }
        var_3b1d1169 function_78233d29(var_3b1d1169.rob, "", #"brightness", var_3b1d1169.brightness);
        var_3b1d1169 function_78233d29(var_3b1d1169.rob, "", #"tint", var_3b1d1169.brightness);
    }
    if (!is_true(var_3b1d1169.var_d280dacf) && !is_true(var_3b1d1169.var_3bfeafe1)) {
        var_3b1d1169.var_d280dacf.var_3b1d1169 = 1;
...
function function_a28ff742(localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwastimejump) {
    ...
    if (bwastimejump == 1) {
        ...
        var_3b1d1169 = getent(fieldname, "lab_second_hidden_door", "targetname");
        var_3b1d1169.var_3bfeafe1.var_3b1d1169 = 1;
        if (is_true(var_3b1d1169.var_d280dacf)) {
            soundstoploopemitter("zmb_mq_stp1_door_burn_lp", (-2739, 14319, -320));
            var_3b1d1169.var_d280dacf.var_3b1d1169 = 0;
        }
        playsound(fieldname, #"hash_18233b644512c916", (-2739, 14319, -320));
        while (var_3b1d1169.reveal > 0) {
            var_3b1d1169.reveal.var_3b1d1169 = var_3b1d1169.reveal - 0.05;
            var_3b1d1169.brightness.var_3b1d1169 = var_3b1d1169.brightness - 0.05;
            wait(0.1);
            if (var_3b1d1169.reveal < 0) {
                var_3b1d1169.reveal.var_3b1d1169 = 0;
...
function function_296ed7c6(localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwastimejump) {
    ...
    if (bwastimejump == 1) {
        ...
        while (var_3b1d1169.brightness > 0) {
            var_3b1d1169.brightness.var_3b1d1169 = var_3b1d1169.brightness - 0.01;
            wait(0.02);
            if (var_3b1d1169.brightness < 0) {
                var_3b1d1169.brightness.var_3b1d1169 = 0;
            } else if (var_3b1d1169.brightness > 1) {
...
function function_9b69f640(localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwastimejump) {
    ...
    if (bwastimejump == 1) {
        ...
        level.var_22850ca8.var_c96a48c3 setmodel(#"tag_origin");
...
function function_850f10bc(localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwastimejump) {
    ...
    if (bwastimejump == 1) {
        ...
        level.var_22850ca8.var_c96a48c3 = util::spawn_model(fieldname, #"tag_origin", level.var_22850ca8.origin, level.var_22850ca8.angles);
...
function function_cdc867b2(localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwastimejump) {
    ...
    if (bwastimejump) {
        if (!isdefined(self.var_bb6d69f0)) {
            self.var_bb6d69f0 = playfx(fieldname, #"hash_6e639d06fdd098bc", self.origin, anglestoforward(self.angles), anglestoup(self.angles));
        }
    } else {
        if (isdefined(self.var_bb6d69f0)) {
        ...
        var_4776f2b8 = playfx(fieldname, #"hash_19835c3bc870def", self.origin, anglestoforward(self.angles), anglestoup(self.angles));
...
function function_f15a1018(localclientnum, *oldval, *newval, *bnewent, *binitialsnap, *fieldname, *bwastimejump) {
    ...
    playfx(bwastimejump, #"hash_2c43a6476d6c84c4", self.origin + vectorscale((0, 0, 1), 32), anglestoforward(self.angles), anglestoup(self.angles));
...
function function_f471577a(localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwastimejump) {
    ...
    self util::waittill_dobj(fieldname);
    if (bwastimejump == 1) {
        self.var_27b51434 = util::playfxontag(fieldname, #"hash_44a4730c3ce4de8f", self, "tag_origin");
...
function function_691412b4(localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwastimejump) {
    ...
    self util::waittill_dobj(fieldname);
    if (bwastimejump == 1) {
        self.var_942f8233 = util::playfxontag(fieldname, #"hash_1f14417633f91368", self, "tag_origin");
...
function function_3b63dde3(localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwastimejump) {
    ...
    } else if (isdefined(self.var_98606953)) {
...
function function_faeec0f5(localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwastimejump) {
    if (bwastimejump == 1 || bwastimejump == 2 || bwastimejump == 3) {
        ...
        s_canister.mdl.s_canister = util::spawn_model(fieldname, #"hash_20b0b418dac9dca1", s_canister.origin, s_canister.angles);
        switch (bwastimejump) {
        case 1:
    ...
    if (bwastimejump == 7) {
        var_e8a5ef56 = struct::get("nuke_warhead", "targetname");
        var_e8a5ef56.mdl.var_e8a5ef56 = util::spawn_model(fieldname, #"hash_3b8343c4b360376f", var_e8a5ef56.origin, var_e8a5ef56.angles);
        var_e8a5ef56.mdl.origin = (-2737.5, 14414, -539.5);
        var_324a4a44 = struct::get("nuke_warhead_riser", "targetname");
        var_324a4a44.mdl.var_324a4a44 = util::spawn_model(fieldname, #"hash_33b9cfeab1d8bc73", var_e8a5ef56.mdl gettagorigin("tag_center") + vectorscale((0, 0, -1), 5), var_e8a5ef56.angles);
        ...
        for (i = 1; i < 4; i++) {
            ...
            s_canister.mdl.s_canister = util::spawn_model(fieldname, #"hash_3023420c57af55eb", var_e8a5ef56.mdl gettagorigin(tag) + vectorscale((0, 0, -1), 8), s_canister.angles);
        }
    }
}
...
function function_cd21fa0f(localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwastimejump) {
    if (bwastimejump == 1 || bwastimejump == 2 || bwastimejump == 3) {
        ...
        s_canister = function_83257eca(bwastimejump);
        var_e8a5ef56 = struct::get("nuke_warhead", "targetname");
        s_canister.var_358ffe83.s_canister = playfx(fieldname, #"hash_79325355eac1745d", var_e8a5ef56.mdl gettagorigin(tag), anglestoforward(s_canister.angles), anglestoup(s_canister.angles));
    }
}
...
function function_67e36b2b(localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwastimejump) {
    if (bwastimejump == 1 || bwastimejump == 2 || bwastimejump == 3) {
        ...
        var_e8a5ef56 = struct::get("nuke_warhead", "targetname");
        if (isdefined(var_e8a5ef56.mdl)) {
            s_canister.mdl.s_canister = util::spawn_model(fieldname, #"hash_20b0b418dac9dca1", var_e8a5ef56.mdl gettagorigin(tag), s_canister.angles);
...
function function_62492e2(*localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwasdemojump) {
    ...
    case 2:
        ...
        break;
    case 3:
        forcestreamxmodel(#"hash_6525c79193f10c32");
        stopforcestreamingxmodel(#"hash_18ea3f1c8e11206e");
        break;
    case 4:
        forcestreamxmodel(#"hash_6525c69193f10a7f");
        stopforcestreamingxmodel(#"hash_6525c79193f10c32");
        break;
    case 5:
        forcestreamxmodel(#"hash_6525c59193f108cc");
        stopforcestreamingxmodel(#"hash_6525c69193f10a7f");
        break;
    case 6:
        forcestreamxmodel(#"hash_18ea401c8e112221");
        stopforcestreamingxmodel(#"hash_6525c59193f108cc");
        break;
    case 7:
        forcestreamxmodel(#"hash_18ea3d1c8e111d08");
        forcestreamxmodel(#"hash_18ea3e1c8e111ebb");
        stopforcestreamingxmodel(#"hash_18ea401c8e112221");
        break;
    case 0:
