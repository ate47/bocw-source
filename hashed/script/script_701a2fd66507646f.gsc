...
function radio_broadcast( params, num_entries = 10 )
{
    ...
    var_28ddca2c = [];
    var_28ddca2c[ var_28ddca2c.size ] = { #var_a34b4160:var_9487875.anagrams[ var_e9ef7dab ].var_d0354c50, #code:var_2d96435a, #vox:var_9487875.anagrams[ var_e9ef7dab ].var_21d92d5d };
    var_28ddca2c[ var_28ddca2c.size ] = { #var_a34b4160:var_9487875.anagrams[ var_bf871b87 ].var_d0354c50, #code:code, #vox:var_9487875.anagrams[ var_bf871b87 ].var_21d92d5d };
            ...
            if ( is_true( var_3d79eff5 ) )
            {
                ...
                if ( is_true( authenticate ) )
                {
                    ...
                    if ( ret._notify == #"ui_confirm" )
                    {
                        ...
                        result = player waittillmatch( { #menu:#"ScriptedHudWidgetMenu", #response:#"authentication" }, #"menuresponse" );
...
function private function_7cfb600()
{
    ...
    self waittillmatch( { #menu:#"ScriptedHudWidgetMenu", #response:#"hash_260e4568c570b4ba" }, #"menuresponse" );
