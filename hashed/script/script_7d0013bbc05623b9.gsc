...
function private autoexec __init__system__() {
    system::register(#"hash_66147563df41a98", &preload, undefined, undefined, undefined);
}
...
function private preload() {
    level.var_f48ab2e1[#"use"] = {#notify_string:"trigger", #var_9a98e590:&function_ab46a161, #var_92bb1cb1:&function_99bb5bbe, #var_558e395a:#"hash_5797cba717dc64d5"};
    level.var_f48ab2e1[#"hash_794885d9482cb75e"] = {#notify_string:"trigger", #var_9a98e590:&function_ab46a161, #var_92bb1cb1:&function_99bb5bbe, #var_558e395a:#"hash_5797cba717dc64d5", #var_4daadf88:#"hash_100ec99123fe5092"};
    level.var_f48ab2e1[#"melee"] = {#notify_string:"damage", #var_9a98e590:&function_ab46a161, #var_92bb1cb1:&function_99bb5bbe, #var_558e395a:#"hash_18d0a7d5aff08dd8"};
    level.var_f48ab2e1[#"hash_3c5c65155dfb1731"] = {#notify_string:"grab", #var_9a98e590:&function_ab46a161, #var_92bb1cb1:&function_99bb5bbe, #var_558e395a:#"hash_18d0a7d5aff08dd8", #var_4daadf88:#"hash_2d1efe88663d0c48"};
    level.var_f48ab2e1[#"attack"] = {#notify_string:"attack", #var_9a98e590:&function_ab46a161, #var_92bb1cb1:&function_99bb5bbe, #var_558e395a:#"hash_3c124085ee45de36"};
    level.var_f48ab2e1[#"reload"] = {#notify_string:"reload", #var_9a98e590:&function_ab46a161, #var_92bb1cb1:&function_99bb5bbe, #var_558e395a:#"hash_27324f18b09b7a6d"};
    level.var_f48ab2e1[#"hash_7f544678d77c8bf5"] = {#notify_string:"frag", #var_9a98e590:&function_ab46a161, #var_92bb1cb1:&function_99bb5bbe, #var_558e395a:#"hash_c7de853806860ce"};
    level.var_f48ab2e1[#"stance"] = {#var_b753c5a5:"BUTTON_BIT_ANY_DOWN", #notify_string:"stance", #var_9a98e590:&function_ab46a161, #var_92bb1cb1:&function_99bb5bbe, #var_558e395a:#"hash_34ccc944003048fe"};
    level.var_f48ab2e1[#"weapnext"] = {#notify_string:"weapnext", #var_9a98e590:&function_ab46a161, #var_92bb1cb1:&function_99bb5bbe, #var_558e395a:#"hash_4b3f0bed118eaaf1"};
    level.var_f48ab2e1[#"ads"] = {#notify_string:"aim", #var_9a98e590:&function_ab46a161, #var_92bb1cb1:&function_99bb5bbe, #var_558e395a:#"hash_41f7ff5095b74d02"};
    level.var_f48ab2e1[#"hash_400c7c122bc26dec"] = {#notify_string:"attack", #var_9a98e590:&function_ab46a161, #var_92bb1cb1:&function_99bb5bbe, #var_558e395a:#"hash_6a2aef10bb120a0d"};
    level.var_f48ab2e1[#"hash_12d2aa208a2a76af"] = {#var_e4c7b05f:#"hash_7179662091387b23", #notify_string:"select", #var_9a98e590:&function_ab46a161, #var_92bb1cb1:&function_eee54dd8, #var_558e395a:#"hash_686cc531969c8555"};
    level.var_f48ab2e1[#"cancel"] = {#var_e4c7b05f:#"hash_2eb2f3b39714ea5f", #notify_string:"cancel", #var_9a98e590:&function_ab46a161, #var_92bb1cb1:&function_eee54dd8, #var_558e395a:#"hash_2ac0a4c8c1d0c8d"};
    level.var_f48ab2e1[#"alt1"] = {#var_b35ba5c:"MOUSE2", #var_a4594058:7, #var_e4c7b05f:#"hash_7179672091387cd6", #notify_string:"alt1", #var_9a98e590:&function_ab46a161, #var_92bb1cb1:&function_eee54dd8, #var_558e395a:#"hash_1fb4a5c9d34c7339"};
    level.var_f48ab2e1[#"alt2"] = {#var_b35ba5c:"MOUSE3", #var_a4594058:8, #var_e4c7b05f:#"hash_7179682091387e89", #notify_string:"alt2", #var_9a98e590:&function_ab46a161, #var_92bb1cb1:&function_eee54dd8, #var_558e395a:#"hash_7b5f7a069d7cd3a"};
    level.var_a8ea96e8 = [];
...
// Size: 0x84
function register(prompt, var_92bb1cb1, var_558e395a, notify_string, var_9a98e590) {
    level.var_f48ab2e1[prompt] = {#notify_string:notify_string, #var_9a98e590:var_9a98e590, #var_92bb1cb1:var_92bb1cb1, #var_558e395a:var_558e395a};
}
...
function create(prompt = #"use", var_4d98c3ce, complete_callback, var_531201f1, notify_string, offset, tag, var_754bedbb, var_de6f0004, var_4ac77177, var_71b9f0c0, var_87c991f3, var_5e83875a, var_8ce60046, var_9a27c4ee, var_be77841a, flags, var_c9643122) {
    var_248cbbcf = {#var_c9643122:var_c9643122, #flags:flags, #var_be77841a:var_be77841a, #var_9a27c4ee:var_9a27c4ee, #var_8ce60046:var_8ce60046, #var_5e83875a:var_5e83875a, #var_87c991f3:var_87c991f3, #var_71b9f0c0:var_71b9f0c0, #var_4ac77177:var_4ac77177, #var_de6f0004:var_de6f0004, #var_754bedbb:var_754bedbb, #tag:tag, #offset:offset, #notify_string:notify_string, #var_531201f1:var_531201f1, #complete_callback:complete_callback, #var_4d98c3ce:var_4d98c3ce};
...
function function_c97a48c7(prompt, var_248cbbcf) {
    ...
    #/
    /#
        assert(isdefined(level.var_f48ab2e1[prompt]), "<unknown string>");
    #/
    /#
    ...
    if (!isdefined(self.var_3e95b88f.var_f48ab2e1)) {
        self.var_3e95b88f.var_f48ab2e1 = [];
    }
    ...
    var_248cbbcf.state.var_248cbbcf = 0;
    ...
    if (isdefined(var_248cbbcf.groups) && !isarray(var_248cbbcf.groups)) {
        var_248cbbcf.groups.var_248cbbcf = array(var_248cbbcf.groups);
    }
    self.var_3e95b88f.var_f48ab2e1[prompt] = function_2e532eed(var_248cbbcf);
    self.var_3e95b88f.var_f48ab2e1[prompt].priority = priority;
    self.var_3e95b88f.var_f48ab2e1[prompt].flags = 0;
    if (isdefined(var_248cbbcf.flags)) {
        foreach (flag in var_248cbbcf.flags) {
            self.var_3e95b88f.var_f48ab2e1[prompt].flags = self.var_3e95b88f.var_f48ab2e1[prompt].flags & 1 << flag;
        }
    }
    if (isdefined(var_248cbbcf.image)) {
        self.var_3e95b88f.image = var_248cbbcf.image;
        self.var_3e95b88f.var_f48ab2e1[prompt].image = undefined;
    }
    self function_a4cf2cde({#var_51f93e19:var_248cbbcf.var_51f93e19, #var_754bedbb:var_248cbbcf.var_754bedbb, #tag:var_248cbbcf.tag, #offset:var_248cbbcf.offset});
...
function function_46df0bc7(prompt, priority) {
    ...
    /#
        /#
            assert(isdefined(self.var_3e95b88f.var_f48ab2e1[prompt]), "<unknown string>" + function_9e72a96(prompt) + "<unknown string>");
        #/
    #/
...
function function_263320e2(prompt, var_4d98c3ce) {
    ...
    /#
        ...
        #/
    #/
    if (self.var_3e95b88f.var_f48ab2e1[prompt].var_4d98c3ce === var_4d98c3ce) {
        return;
    }
    self.var_3e95b88f.var_f48ab2e1[prompt].var_4d98c3ce = var_4d98c3ce;
    uid = self.var_3e95b88f.uid;
...
function function_75d5e526(prompt, complete_callback) {
    ...
    /#
        ...
        #/
    #/
    self.var_3e95b88f.var_f48ab2e1[prompt].complete_callback = complete_callback;
}
...
function function_a4a9acfc(prompt, var_531201f1) {
    ...
    /#
        ...
        #/
    #/
    self.var_3e95b88f.var_f48ab2e1[prompt].var_531201f1 = var_531201f1;
}
...
function function_cd2391cb(prompt, notify_string) {
    ...
    /#
        ...
        #/
    #/
    self.var_3e95b88f.var_f48ab2e1[prompt].notify_string = notify_string;
}
...
function set_offset(offset, tag, var_754bedbb, var_51f93e19) {
    self function_a4cf2cde({#var_51f93e19:var_51f93e19, #var_754bedbb:var_754bedbb, #tag:tag, #offset:offset});
}
...
function function_816ddada(prompt, var_1df3804c) {
    self.var_3e95b88f.var_f48ab2e1[prompt].var_1df3804c = var_1df3804c;
}
...
function function_44d7831a(prompt, flags, var_cca4e0db = 0) {
    if (var_cca4e0db) {
        self.var_3e95b88f.var_f48ab2e1[prompt].flags = self.var_3e95b88f.var_f48ab2e1[prompt].flags & flags;
    } else {
        if (!isdefined(flags)) {
            flags = [];
    ...
    uid = self.var_3e95b88f.uid;
    if (isdefined(uid) && namespace_61e6d095::function_cd59371c(uid, self.var_3e95b88f.var_294a441e[prompt], self.var_3e95b88f.var_db58523e) && !is_true(self.var_3e95b88f.var_f48ab2e1[prompt].var_f945ce95)) {
        namespace_61e6d095::function_9bc1d2f1(uid, self.var_3e95b88f.var_294a441e[prompt], self.var_3e95b88f.var_f48ab2e1[prompt].flags, 1);
    }
}
...
function function_4b556f63(prompt, flags, var_cca4e0db = 0) {
    if (var_cca4e0db) {
        ...
        foreach (flag in flags) {
            self.var_3e95b88f.var_f48ab2e1[prompt].flags = self.var_3e95b88f.var_f48ab2e1[prompt].flags & ~flag;
        }
    }
    uid = self.var_3e95b88f.uid;
    if (isdefined(uid) && namespace_61e6d095::function_cd59371c(uid, self.var_3e95b88f.var_294a441e[prompt], self.var_3e95b88f.var_db58523e) && !is_true(self.var_3e95b88f.var_f48ab2e1[prompt].var_f945ce95)) {
...
function function_d03d79d6(prompt, var_de6f0004) {
    ...
    /#
        ...
        #/
    #/
    self.var_3e95b88f.var_f48ab2e1[prompt].var_de6f0004 = var_de6f0004;
    if (self.var_3e95b88f.var_f48ab2e1[prompt].var_de6f0004 === 0.25) {
        self.var_3e95b88f.var_f48ab2e1[prompt].var_de6f0004 = undefined;
    }
}
...
function function_8f5eb0a6(prompt, var_4ac77177) {
    ...
    /#
        ...
        #/
    #/
    self.var_3e95b88f.var_f48ab2e1[prompt].var_4ac77177 = var_4ac77177;
    if (self.var_3e95b88f.var_f48ab2e1[prompt].var_4ac77177 === 0.1) {
        self.var_3e95b88f.var_f48ab2e1[prompt].var_4ac77177 = undefined;
    }
}
...
function function_5fe46a16(prompt, var_71b9f0c0) {
    ...
    /#
        ...
        #/
    #/
    self.var_3e95b88f.var_f48ab2e1[prompt].var_71b9f0c0 = var_71b9f0c0;
    if (self.var_3e95b88f.var_f48ab2e1[prompt].var_71b9f0c0 === 240) {
        self.var_3e95b88f.var_f48ab2e1[prompt].var_71b9f0c0 = undefined;
    }
}
...
function function_cf884581(prompt, var_79a4cbfc) {
    ...
    /#
        ...
        #/
    #/
    self.var_3e95b88f.var_f48ab2e1[prompt].var_9c89c587 = var_79a4cbfc;
    if (self.var_3e95b88f.var_f48ab2e1[prompt].var_9c89c587 === 0) {
        self.var_3e95b88f.var_f48ab2e1[prompt].var_9c89c587 = undefined;
    }
}
...
function function_5698d1c9(prompt, var_5f57572a) {
    ...
    /#
        ...
        #/
    #/
    self.var_3e95b88f.var_f48ab2e1[prompt].var_f17a78a7 = var_5f57572a;
    if (self.var_3e95b88f.var_f48ab2e1[prompt].var_f17a78a7 === 180) {
        self.var_3e95b88f.var_f48ab2e1[prompt].var_f17a78a7 = undefined;
    }
}
...
function function_68782902(prompt, var_87c991f3) {
    ...
    /#
        ...
        #/
    #/
    self.var_3e95b88f.var_f48ab2e1[prompt].var_87c991f3 = var_87c991f3;
    if (self.var_3e95b88f.var_f48ab2e1[prompt].var_87c991f3 === 85) {
        self.var_3e95b88f.var_f48ab2e1[prompt].var_87c991f3 = undefined;
    }
}
...
function function_2557566(prompt, var_7faab93d) {
    ...
    /#
        ...
        #/
    #/
    self.var_3e95b88f.var_f48ab2e1[prompt].var_7faab93d = var_7faab93d;
    if (self.var_3e95b88f.var_f48ab2e1[prompt].var_7faab93d === 1) {
        self.var_3e95b88f.var_f48ab2e1[prompt].var_7faab93d = undefined;
    }
}
...
function function_b95d71cd(prompt, var_5e83875a) {
    ...
    /#
        ...
        #/
    #/
    self.var_3e95b88f.var_f48ab2e1[prompt].var_5e83875a = var_5e83875a;
    if (self.var_3e95b88f.var_f48ab2e1[prompt].var_5e83875a === 30) {
        self.var_3e95b88f.var_f48ab2e1[prompt].var_5e83875a = undefined;
    }
}
...
function function_1a5e1da6(prompt, var_3c8a8153, var_c8a53909) {
    ...
    /#
        ...
        #/
    #/
    self.var_3e95b88f.var_f48ab2e1[prompt].var_3c8a8153 = var_3c8a8153;
    self.var_3e95b88f.var_f48ab2e1[prompt].var_88ceabd = var_c8a53909;
}
...
function function_4cb5d3a1(prompt, var_8ce60046) {
    ...
    /#
        ...
        #/
    #/
    self.var_3e95b88f.var_f48ab2e1[prompt].var_8ce60046 = var_8ce60046;
    if (self.var_3e95b88f.var_f48ab2e1[prompt].var_8ce60046 === 1) {
        self.var_3e95b88f.var_f48ab2e1[prompt].var_8ce60046 = undefined;
    }
}
...
function function_dcf99fad(prompt, var_9a27c4ee, ignore_ent) {
    ...
    /#
        ...
        #/
    #/
    self.var_3e95b88f.var_f48ab2e1[prompt].var_9a27c4ee = var_9a27c4ee;
    self.var_3e95b88f.var_f48ab2e1[prompt].var_1e4cbecf = ignore_ent;
    if (self.var_3e95b88f.var_f48ab2e1[prompt].var_9a27c4ee === 1) {
        self.var_3e95b88f.var_f48ab2e1[prompt].var_9a27c4ee = undefined;
    }
}
...
function function_2bd2431a(prompt, var_be77841a) {
    ...
    /#
        ...
        #/
    #/
    self.var_3e95b88f.var_f48ab2e1[prompt].var_be77841a = var_be77841a;
    if (self.var_3e95b88f.var_f48ab2e1[prompt].var_be77841a === 1) {
        self.var_3e95b88f.var_f48ab2e1[prompt].var_be77841a = undefined;
    }
}
...
function function_3171730f(prompt, groups) {
    ...
    self.var_3e95b88f.var_f48ab2e1[prompt].groups = groups;
}
...
function function_2e6d74f5(prompt, pause) {
    ...
    /#
        ...
        #/
    #/
    self.var_3e95b88f.var_f48ab2e1[prompt].var_f14d06ca = pause;
}
...
function remove(prompt, immediate) {
    if (isdefined(self.var_3e95b88f) && isdefined(self.var_3e95b88f.var_f48ab2e1[prompt]) && !is_true(self.var_3e95b88f.var_f48ab2e1[prompt].var_f945ce95)) {
        ...
        self.var_3e95b88f.var_f48ab2e1[prompt].var_f945ce95 = 1;
...
function private function_660c618b(prompt, immediate) {
    self endon(#"hash_102132947e81e47f", "prompt_added_" + prompt, #"death");
    if (!is_true(immediate)) {
        waittillframeend();
    }
    if (isdefined(self.var_3e95b88f) && isdefined(self.var_3e95b88f.var_f48ab2e1[prompt])) {
        arrayremoveindex(self.var_3e95b88f.var_f48ab2e1, prompt, 1);
        arrayremoveindex(self.var_3e95b88f.var_294a441e, prompt, 1);
        player = getplayers()[0];
        if (player.var_b3c804a4[prompt] === self) {
            player.var_b3c804a4[prompt] = undefined;
        }
        if (self.var_3e95b88f.var_f48ab2e1.size == 0) {
            if (isdefined(self.var_3e95b88f.uid)) {
            ...
            self notify(#"hash_102132947e81e47f");
        }
    }
}
    ...
    if (isdefined(self.var_3e95b88f)) {
        ...
        if (isentity(self)) {
            if (isdefined(self.var_3e95b88f.tag)) {
                ...
                var_393b6e18 = self function_b9ab269e() + vectorscale((0, 0, 1), 6);
            } else if (is_true(self.var_3e95b88f.var_754bedbb)) {
                var_393b6e18 = var_393b6e18 + rotatepoint(self function_2c662f72(), self.angles);
            }
        }
    ...
    if (self != player) {
        ...
        /#
            if (level.var_a48f9f79[#"hash_3cdd945161669bf5"] >= 0) {
                var_6a1bdfa6 = level.var_a48f9f79[#"hash_3cdd945161669bf5"] > 0;
            }
        #/
        if (var_6a1bdfa6) {
...
function private function_99bb5bbe(var_248cbbcf) {
    if (!var_248cbbcf.player gamepadusedlast() && isdefined(level.var_f48ab2e1[var_248cbbcf.prompt].var_b753c5a5)) {
        return var_248cbbcf.player buttonbitstate(level.var_f48ab2e1[var_248cbbcf.prompt].var_b753c5a5);
    }
...
function private function_eee54dd8(var_248cbbcf) {
    ...
    case #"hash_defdefdefdefdef0":
        ...
        if (var_248cbbcf.player gamepadusedlast()) {
            /#
                /#
                    assert(isdefined(level.var_f48ab2e1[var_248cbbcf.prompt].var_a4594058), "<unknown string>" + function_9e72a96(var_248cbbcf.prompt));
                #/
            #/
            var_d75b2384 = function_90d058e8(#"buttons");
            model = getuimodel(var_d75b2384, string(level.var_f48ab2e1[var_248cbbcf.prompt].var_a4594058));
            /#
                /#
                    assert(isdefined(model), "<unknown string>" + level.var_f48ab2e1[var_248cbbcf.prompt].var_a4594058 + "<unknown string>" + function_9e72a96(var_248cbbcf.prompt));
                #/
            #/
        } else {
            /#
                /#
                    assert(isdefined(level.var_f48ab2e1[var_248cbbcf.prompt].var_b35ba5c), "<unknown string>" + function_9e72a96(var_248cbbcf.prompt));
                #/
            #/
            var_31a34837 = function_90d058e8(#"hash_48b37823078b5999");
            model = getuimodel(var_31a34837, level.var_f48ab2e1[var_248cbbcf.prompt].var_b35ba5c);
            /#
                /#
                    assert(isdefined(model), "<unknown string>" + level.var_f48ab2e1[var_248cbbcf.prompt].var_b35ba5c + "<unknown string>" + function_9e72a96(var_248cbbcf.prompt));
                #/
            #/
        }
...
function private function_cd5cbae1(player) {
    player endon(#"death");
    self endon(#"hash_102132947e81e47f");
...
function private function_7d76b3ac() {
    self endon(#"death", #"hash_102132947e81e47f");
    level endon(#"hash_298d88a0977193a7");
    player = getplayers()[0];
...
function private function_e8006b47() {
    self endon(#"death", #"hash_102132947e81e47f", #"hash_17cbfac9e551855a");
    level endon(#"hash_298d88a0977193a7");
    player = getplayers()[0];
    if (self != player) {
        player endon(#"death");
    ...
    while (self.var_3e95b88f.var_98fa5077) {
        ...
        foreach (prompt, var_62bce5b6 in self.var_3e95b88f.var_f48ab2e1) {
            ...
            var_62bce5b6.old_state.var_62bce5b6 = var_62bce5b6.state;
            var_3be3393e = 1;
            if (self function_d626d354(prompt, player, dist - 12)) {
                ...
                if (function_12186571(prompt, var_62bce5b6, player, dist, var_393b6e18, var_5e83875a)) {
                    ...
                    var_3be3393e = !var_a33acc5d.var_9ad09916;
                    ...
                    if (var_62bce5b6.flags & 2) {
                        var_62bce5b6.state.var_62bce5b6 = 4;
                    } else {
                        var_62bce5b6.state.var_62bce5b6 = 0;
                    }
                }
            } else if (var_62bce5b6.state != 3) {
                if (var_62bce5b6.state == 0 || var_62bce5b6.state == 4) {
            ...
            if (var_62bce5b6.old_state != var_62bce5b6.state) {
                self function_f4bf235a(uid, prompt, self.var_3e95b88f.var_f48ab2e1[prompt].state);
            }
        }
        if (var_e24c19de) {
            state = 3;
        ...
        var_43151364 = 1;
        /#
            if (level.var_a48f9f79[#"hash_6958ea0555e58a17"] != "<unknown string>" && isdefined(level.var_b649495c[level.var_a48f9f79[#"hash_6958ea0555e58a17"]])) {
            ...
            if (level.var_a48f9f79[#"hash_729ecfd573b86aee"] != -1) {
                var_43151364 = level.var_a48f9f79[#"hash_729ecfd573b86aee"];
            }
        #/
        alpha = 1;
        if (var_b48ce78 > var_3714e9ea) {
            var_203de47b = math::clamp((var_b48ce78 - dist) / (var_b48ce78 - var_3714e9ea), 0, 1);
            if (var_4ca73085 == #"power" || var_4ca73085 == #"hash_66948f68af1a4b68" || var_4ca73085 == #"hash_2de1684e2167ada4") {
                alpha = [[ level.var_b649495c[var_4ca73085] ]](var_81f357d7, var_43151364, var_203de47b, ease_in, ease_out, var_249ae409);
            } else {
                alpha = [[ level.var_b649495c[var_4ca73085] ]](var_81f357d7, var_43151364, var_203de47b, ease_in, ease_out);
            }
        ...
        if (var_6dbb4310 != var_4921a894) {
            ...
            self notify(#"hash_5ede0284920c4c56", {#var_65198261:var_4921a894});
        }
        if (self flag::get(#"hash_305ce4d5b74a637a") != var_b6a8b668) {
            if (var_b6a8b668) {
                ...
                player val::function_e681e68e(#"hash_599ec0eee77657ef");
...
function private function_6b2492cb(prompt, var_62bce5b6, player) {
    ...
    var_62bce5b6.state.var_62bce5b6 = 1;
    lower = 0;
    hud = self.var_3e95b88f.hud;
    /#
        if (level.var_a48f9f79[#"hash_464a6e9e035a826e"] > 0) {
    ...
    var_9ad09916 = 0;
    if (self [[ level.var_f48ab2e1[prompt].var_92bb1cb1 ]]({#player:player, #var_62bce5b6:var_62bce5b6, #prompt:prompt}) && !is_true(var_62bce5b6.var_5a8a10f2)) {
        self function_fcef5f5b(prompt, var_62bce5b6, player);
        var_9ad09916 = 1;
    }
    return {#var_4921a894:hud && !lower, #var_b6a8b668:lower, #var_9ad09916:var_9ad09916};
}
...
function private function_fcef5f5b(prompt, var_62bce5b6, player) {
    if (is_true(var_62bce5b6.var_f14d06ca)) {
        if (isdefined(var_62bce5b6.var_c570a6f9)) {
            var_62bce5b6.var_c570a6f9.var_62bce5b6 = var_62bce5b6.var_c570a6f9 + float(function_60d95f53()) / 1000;
        }
    } else {
        var_62bce5b6.var_5a8a10f2 = undefined;
        if (!isdefined(var_62bce5b6.var_c570a6f9)) {
            var_62bce5b6.var_c570a6f9.var_62bce5b6 = gettime();
        }
        ...
        if (function_2af9819b(prompt, var_62bce5b6, player)) {
            var_62bce5b6.state.var_62bce5b6 = 2;
...
function private function_2af9819b(prompt, var_62bce5b6, player) {
    ...
    return !player gamepadusedlast() && !player function_5c0f244() && !var_c9643122 && var_de6f0004 <= level.var_503dffcb[#"hash_4a567986e10dacb0"] && var_ab23834f;
}
...
function private function_efb98d80(prompt, var_62bce5b6, player) {
    ...
    if (isdefined(level.var_f48ab2e1[prompt].notify_string)) {
        var_1df3804c notify(level.var_f48ab2e1[prompt].notify_string, {#prompt:prompt, #activator:player});
    }
    ...
    if (!is_true(var_62bce5b6.var_f945ce95)) {
        var_62bce5b6.state.var_62bce5b6 = 3;
        ...
        if (isdefined(var_62bce5b6.var_be77841a) ? var_62bce5b6.var_be77841a : 1) {
            ...
            var_62bce5b6.var_5a8a10f2.var_62bce5b6 = 1;
...
function private function_f4bf235a(uid, prompt, state) {
    if (is_true(self.var_3e95b88f.var_f48ab2e1[prompt].var_f945ce95)) {
        return;
    }
    if (isdefined(self.var_3e95b88f.var_f48ab2e1[prompt])) {
        self.var_3e95b88f.var_f48ab2e1[prompt].state = state;
    }
    self notify(#"hash_4de92efaa3e2025e", {#state:state, #prompt:prompt});
    if (isdefined(self.var_3e95b88f.var_f48ab2e1[prompt].var_67eb3347)) {
        self thread [[ self.var_3e95b88f.var_f48ab2e1[prompt].var_67eb3347 ]]({#state:state, #prompt:prompt});
    }
...
function private function_9309081b(uid, prompt) {
    if (isdefined(self.var_3e95b88f.var_f48ab2e1[prompt].var_c570a6f9)) {
        self.var_3e95b88f.var_f48ab2e1[prompt].var_5a8a10f2 = undefined;
        self.var_3e95b88f.var_f48ab2e1[prompt].var_c570a6f9 = undefined;
        var_de6f0004 = isdefined(self.var_3e95b88f.var_f48ab2e1[prompt].var_de6f0004) ? self.var_3e95b88f.var_f48ab2e1[prompt].var_de6f0004 : 0.25;
...
function private function_ab46a161(prompt, var_62bce5b6) {
    ...
    player = getplayers()[0];
    player endon(#"death");
    var_ed769620 = player gamepadusedlast();
    var_1ea21098 = undefined;
    var_34fc0bda = undefined;
    uid = var_62bce5b6.uid;
    while (isdefined(var_62bce5b6.uid)) {
        is_disabled = isdefined(var_62bce5b6.var_f48ab2e1[prompt].state) && (var_62bce5b6.var_f48ab2e1[prompt].state == 0 || var_62bce5b6.var_f48ab2e1[prompt].state == 4);
        if (self [[ level.var_f48ab2e1[prompt].var_92bb1cb1 ]]({#player:player, #var_62bce5b6:var_62bce5b6, #prompt:prompt}) && (is_true(var_62bce5b6.var_f48ab2e1[prompt].var_f14d06ca) || is_disabled)) {
            self function_2e6d74f5(prompt, 1);
        } else {
            self function_2e6d74f5(prompt, 0);
        }
        var_57f18593 = var_ed769620 != player gamepadusedlast();
        if (var_57f18593) {
            var_ed769620 = !var_ed769620;
            player val::function_e681e68e(uid);
        }
        var_dc231c8e = 1;
        var_7a529262 = var_62bce5b6.var_f48ab2e1[prompt].var_8cff8c16;
        if (isdefined(var_7a529262)) {
            var_dc231c8e = self [[ var_7a529262 ]]({#player:player, #var_62bce5b6:var_62bce5b6, #prompt:prompt});
        }
...
function private function_a6104953() {
    ...
    if (hud) {
        ...
        if (!is_true(self.var_3e95b88f.var_a5ce465f) && !isplayer(self) && (!isactor(self) || isdefined(self.var_3e95b88f.var_f48ab2e1[#"use"]))) {
...
function private function_263b3850(uid, prompt, player) {
    if (!namespace_61e6d095::function_cd59371c(uid, self.var_3e95b88f.var_294a441e[prompt], self.var_3e95b88f.var_db58523e) && !is_true(self.var_3e95b88f.var_f48ab2e1[prompt].var_f945ce95)) {
        var_7125b341 = 0;
        if (isdefined(self.var_3e95b88f.var_f48ab2e1[prompt].var_4d98c3ce)) {
            namespace_61e6d095::function_f2a9266(uid, self.var_3e95b88f.var_294a441e[prompt], "text", self.var_3e95b88f.var_f48ab2e1[prompt].var_4d98c3ce, self.var_3e95b88f.var_db58523e);
            var_7125b341 = 1;
        }
        if (isdefined(level.var_f48ab2e1[prompt].var_558e395a)) {
            if (isdefined(level.var_f48ab2e1[prompt].var_e4c7b05f)) {
                self thread function_93551c9a(uid, prompt);
            } else {
                namespace_61e6d095::function_f2a9266(uid, self.var_3e95b88f.var_294a441e[prompt], "button_text", level.var_f48ab2e1[prompt].var_558e395a, self.var_3e95b88f.var_db58523e);
            }
            var_7125b341 = 1;
        }
        if (isdefined(level.var_f48ab2e1[prompt].var_4daadf88)) {
            namespace_61e6d095::function_f2a9266(uid, self.var_3e95b88f.var_294a441e[prompt], "button_action", level.var_f48ab2e1[prompt].var_4daadf88, self.var_3e95b88f.var_db58523e);
            var_7125b341 = 1;
        }
        var_2625ed95 = int((isdefined(self.var_3e95b88f.var_f48ab2e1[prompt].var_de6f0004) ? self.var_3e95b88f.var_f48ab2e1[prompt].var_de6f0004 : 0.25) * 1000);
        if (var_2625ed95 <= 0 || function_2af9819b(prompt, self.var_3e95b88f.var_f48ab2e1[prompt], player)) {
        ...
        if (var_7125b341) {
            namespace_61e6d095::function_f2a9266(uid, self.var_3e95b88f.var_294a441e[prompt], "state", self.var_3e95b88f.var_f48ab2e1[prompt].state, self.var_3e95b88f.var_db58523e);
        }
        if (isdefined(self.var_3e95b88f.var_f48ab2e1[prompt].var_67eb3347)) {
            self thread [[ self.var_3e95b88f.var_f48ab2e1[prompt].var_67eb3347 ]]({#state:self.var_3e95b88f.var_f48ab2e1[prompt].state, #prompt:prompt});
        }
        flags = self.var_3e95b88f.var_f48ab2e1[prompt].flags;
        /#
            if (level.var_a48f9f79[#"hash_464a6e9e035a826e"] == 2) {
                flags = flags & ~1;
            } else if (level.var_a48f9f79[#"hash_464a6e9e035a826e"] == 3) {
        ...
        if (isdefined(level.var_f48ab2e1[prompt].var_9a98e590)) {
            self thread [[ level.var_f48ab2e1[prompt].var_9a98e590 ]](prompt, self.var_3e95b88f);
        }
    }
}
...
function private function_93551c9a(uid, prompt) {
    ...
    player endon(#"death");
    var_ed769620 = player gamepadusedlast();
    var_558e395a[0] = level.var_f48ab2e1[prompt].var_e4c7b05f;
    var_558e395a[1] = level.var_f48ab2e1[prompt].var_558e395a;
    namespace_61e6d095::function_f2a9266(uid, self.var_3e95b88f.var_294a441e[prompt], "button_text", var_558e395a[var_ed769620], self.var_3e95b88f.var_db58523e);
    while (1) {
        waitframe(1);
        if (var_ed769620 != player gamepadusedlast()) {
            var_ed769620 = !var_ed769620;
            namespace_61e6d095::function_f2a9266(uid, self.var_3e95b88f.var_294a441e[prompt], "button_text", var_558e395a[var_ed769620], self.var_3e95b88f.var_db58523e);
        }
    }
...
function private function_17533001(uid) {
    self endoncallback(&function_74f42405, #"death", #"hash_102132947e81e47f", #"hash_7d3af7cbbc793b23");
    level endon(#"hash_298d88a0977193a7");
    ...
    while (1) {
        ...
        } else if (isdefined(self.var_3e95b88f.var_43c33448)) {
