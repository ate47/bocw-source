...
function init(instance) {
    instance.var_42dcbe3d.instance = instance.var_fe2612fe[#"hash_38e22f5ceb9065c"];
    instance.var_559503f1.instance = instance.var_fe2612fe[#"spawn_pt"];
    if (isdefined(instance.var_fe2612fe[#"base"][0])) {
        instance.mdl_base.instance = namespace_8b6a9d79::function_f3d93ee9(instance.var_fe2612fe[#"base"][0], instance.var_fe2612fe[#"base"][0].model, 1);
    ...
    for (i = 0; i < instance.var_42dcbe3d.size; i++) {
        ...
        var_954ec1b6.var_526e7ad6.var_954ec1b6 = util::spawn_model(#"hash_2eb7d391abf00e32", v_start, instance.var_42dcbe3d[i].angles);
        var_954ec1b6.var_cef46557.var_954ec1b6 = util::spawn_model(#"hash_18c5ca275bc790a1", v_start, instance.var_42dcbe3d[i].angles);
        ...
        var_954ec1b6.var_cef46557.var_848c555f = v_org;
        var_954ec1b6.n_id.var_954ec1b6 = instance.var_42dcbe3d[i].script_int;
        var_954ec1b6.targetname.var_954ec1b6 = "drop_pod";
        var_954ec1b6.var_559503f1.var_954ec1b6 = [];
        var_954ec1b6.var_eff5bd11.var_954ec1b6 = [];
        var_954ec1b6.n_active.var_954ec1b6 = 0;
        ...
        var_954ec1b6.n_total.var_954ec1b6 = 0;
        var_954ec1b6.n_kills.var_954ec1b6 = 0;
        ...
        var_954ec1b6.var_86a21346.var_954ec1b6 = &function_79417d24;
    }
    instance.var_7a9e6505.instance = 1;
    instance.var_5b071610.instance = 0;
    instance.var_4fff464f.instance = 0;
    instance.var_f63c851c.instance = 0;
    instance.var_bf189694.instance = getentarray("drop_pod", "targetname");
...
function function_79417d24(*einflictor, eattacker, idamage, *idflags, *smeansofdeath, *weapon, *var_fd90b0bb, *vpoint, *vdir, *shitloc, *psoffsettime, *iboneindex, *imodelindex) {
    if (isdefined(iboneindex) && isplayer(iboneindex)) {
        ...
        if (isdefined(self) && !is_true(self.is_damaged) && isdefined(level.var_7d45d0d4.activeobjective)) {
            self thread function_814c0e69(level.var_7d45d0d4.activeobjective);
        }
...
function function_738f5215() {
    ...
    while (!var_35dfb407) {
        ...
        foreach (player in a_players) {
            if (distance2dsquared(player.origin, self.var_4a416ea9.origin) <= 2250000) {
...
function function_dc79011b(instance) {
    ...
    while (1) {
        foreach (zombie in function_a38db454(self.origin, self.var_75833abc)) {
            if ((zombie.aitype === #"hash_1aff4b71635bda08" || zombie.archetype === #"zombie" || zombie.aitype === #"hash_63cd2e85e68901a0") && !isdefined(zombie.var_aa967222)) {
                zombie.e_marker.zombie = util::spawn_model("tag_origin", zombie gettagorigin("J_Spine4"));
...
function function_60b78908(instance) {
    ...
    while (1) {
        if (distance2dsquared(self.origin, self.var_5ea363c.origin) > function_a3f6cdac(self.var_5ea363c.var_75833abc) || is_true(self.var_5ea363c.var_71973b22)) {
    ...
    while (1) {
        foreach (player in a_players) {
            if (zm_utility::is_player_valid(player)) {
                ...
                if (n_distsq <= function_a3f6cdac(50) && is_true(self.var_e52440b6)) {
                ...
                if (n_distsq <= function_a3f6cdac(700)) {
                    if (!isdefined(player.var_aef8b7b4)) {
                        player.var_aef8b7b4.player = 1;
...
function function_f11f6b22(instance) {
    ...
    self endon(#"death", #"landed");
    while (1) {
        if (self.var_cef46557.origin[2] <= self.var_848c555f[2] + 800 && !is_true(self.var_9fd4020b)) {
            self.var_9fd4020b = 1;
            self thread function_7ac4b826(instance);
            self thread function_232a7f41(instance);
            self notify(#"arriving");
        } else if (self.var_cef46557.origin[2] <= self.var_848c555f[2] + 60 && !is_true(self.var_3c11dc55)) {
            self.var_3c11dc55 = 1;
...
function function_7ac4b826(instance) {
    ...
    while (1) {
        if (self.var_cef46557.origin[2] <= self.var_848c555f[2] + 82) {
            self.var_e52440b6 = 1;
            self notify(#"landing");
        }
        wait(0.1);
...
function function_f919d221(instance) {
    ...
    playrumbleonposition(#"sr_transmitter_impact", self.var_848c555f);
    self thread function_4663acbd(instance);
    self.var_cef46557 thread scene::play(#"hash_27df32fc9b6d07e0", "Shot 1", self.var_cef46557);
    self.var_cef46557 waittilltimeout(20, #"hash_2e4185df060d1884");
    self notify(#"landed");
...
function function_4663acbd(instance) {
    ...
    self.var_cef46557 playrumblelooponentity(#"hash_59a754b959fadac7");
    wait(5);
    self thread function_f11f6b22(instance);
    self waittill(#"landed");
    self.var_cef46557 stoprumble(#"hash_59a754b959fadac7");
}
...
function function_75eea0d2(instance) {
    self endon(#"hash_406847e765224adc", #"death", #"cleared");
    instance endon(#"objective_ended", #"hash_8202877a3aadac8");
    self.var_2c27b95c = 0;
    instance.var_e514f2.instance = 0;
    self waittill(#"ready");
    ...
    while (1) {
        ...
        if (self.var_2c27b95c >= 0.85 && !self.var_90627599) {
            ...
            if (instance.var_e514f2 > 1) {
                instance.var_237b170c.instance = self.n_id;
    ...
    while (1) {
        ...
        if (self.var_210e22a1 || is_true(self.b_forced)) {
            ...
            if (!instance.var_5b071610) {
                instance.var_5b071610.instance = 1;
            }
            foreach (player in getplayers()) {
...
function function_ddb668e6() {
    ...
    var_1fabc58c = [];
    var_559503f1 = self.var_fe2612fe[#"hash_6d3ff59b5d73d444"];
...
function function_4c664c70(instance) {
    ...
    self.b_attacked = 1;
    instance.var_155bbc44.instance = 0;
    ...
    while (1) {
        ...
        if (self.n_active <= n_active) {
            ...
            if (isdefined(ai_zombie)) {
                ...
                ai_zombie.var_ce72b8cb.ai_zombie = self;
...
function function_bf606a73(instance) {
    ...
    while (1) {
        ...
        if (isdefined(self.var_ce72b8cb) && isalive(player) && distance2dsquared(self.origin, player.origin) <= distance2dsquared(self.origin, self.var_ce72b8cb.origin) && distance2dsquared(self.var_ce72b8cb.origin, player.origin) <= function_a3f6cdac(1000)) {
            self.var_ff290a61 = player;
            awareness::function_c241ef9a(self, player, 6);
            wait(5);
        } else if (!isdefined(self.var_b238ef38) && isdefined(self.var_ce72b8cb) && !is_true(self.var_ce72b8cb.var_210e22a1) && isdefined(instance) && is_true(instance.var_f63c851c)) {
            self.var_ff290a61 = player;
            awareness::function_c241ef9a(self, player, 6);
            wait(5);
        } else {
...
function function_2631fff1() {
    ...
    case 6:
        ...
        break;
    case 7:
        var_6017f33e = namespace_679a22ba::function_ca209564(#"hash_6492aecee5b15b45");
        break;
    case #"hash_defdefdefdefdef0":
        var_6017f33e = namespace_679a22ba::function_ca209564(#"hash_6492afcee5b15cf8");
        break;
    }
    return var_6017f33e;
}
...
function function_88a7c00a(instance) {
    ...
    if (isdefined(ai_spawned)) {
        ...
        ai_spawned.b_ignore_cleanup.ai_spawned = 1;
        return ai_spawned;
    }
}
...
function function_5efbdd83(instance) {
    ...
    if (!isdefined(instance.var_f059ae2a)) {
        instance.var_f059ae2a.instance = 1;
    ...
    self.var_526e7ad6 thread scene::play(#"hash_54b16c2f17d788a9", "drain", self.var_526e7ad6);
    wait(2);
    ...
    var_2858caa2 = {#var_738dfc81:1, #angles:self.angles + vectorscale((0, 1, 0), 90), #origin:self.origin + vectorscale((0, 0, 1), 40)};
    if (math::cointoss(33)) {
        if (isdefined(var_2858caa2)) {
            item = self function_97379a52(var_2858caa2);
        }
    } else {
        items = var_2858caa2 namespace_65181344::function_fd87c780(#"hash_4ae2b9d3ef0babe9", 1, 0);
        if (isdefined(items) && isdefined(items[0])) {
            item = items[0];
            items[0].var_dd21aec2 = 16;
            items[0] thread function_5ebfd8cc();
            item.var_99498378.item = 1;
        }
    }
    instance.var_f63c851c++;
    if (instance.var_f63c851c > 1 && !instance.var_4fff464f) {
        instance.var_4fff464f.instance = 1;
    ...
    if (isdefined(item)) {
        ...
        if (isdefined(item) && instance.targetname === "objective_black_sea_secure") {
            if (self.n_id === 0) {
                item.origin.item = item.origin + (3, -2, 0);
            }
            item.angles.item = self.angles;
        }
...
function function_b5770dda(instance, var_c2323ea4) {
    ...
    self.var_b79a8ac7 = {#slots:slots, #var_f019ea1a:2000};
...
function function_b70e2a37() {
    self waittill(#"death", #"destroyed", #"hash_406847e765224adc");
...
function function_7cfc417a(instance) {
    ...
    if (!instance.success) {
        ...
        self notify(#"hash_406847e765224adc");
    }
}
...
function function_1ee78771(instance) {
    instance endon(#"objective_ended", #"hash_8202877a3aadac8");
    self endon(#"hash_406847e765224adc");
...
function function_fb9dff2f(instance, activator) {
    if (isplayer(activator)) {
        instance.n_timeout.instance = function_36585ff1();
...
function function_782f0d1f() {
    var_cdce8e6f = self.var_fe2612fe[#"hash_5819d8571ea7c838"][0];
