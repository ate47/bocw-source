...
function private function_727338d1(var_7d32de2) {
    ...
    #/
    var_3140b529 = vectorprojection(var_e5b7c28e - var_38c235fa, var_38609e65);
    if (lengthsquared(var_3140b529) > function_a3f6cdac(40)) {
        return;
    }
