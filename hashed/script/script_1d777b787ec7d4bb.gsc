...
function function_d81240c3() {
    ...
    zm_sq::function_53d0d99(#"hash_8602209567f541c");
    zm_sq::function_53d0d99(#"hash_3e7926c5aefe4406");
...
function function_ef4139d1() {
    ...
    foreach (control_point_pos in level.var_cc43b632) {
        if (isdefined(control_point_pos)) {
            control_point_pos.var_547f9dd5.control_point_pos = [];
            control_point_pos.var_56d2adea.control_point_pos = 0;
            control_point_pos.var_269ad176.control_point_pos = 0;
            ...
            foreach (target_pos in var_1baed918) {
                if (target_pos.script_noteworthy === "satellite_pos") {
                    if (!isdefined(control_point_pos.var_547f9dd5)) {
                        ...
                        control_point_pos.var_547f9dd5.control_point_pos = array(control_point_pos.var_547f9dd5);
                    }
            ...
            control_point_pos.var_cdeb4ee4.control_point_pos = util::spawn_model("tag_origin", control_point_pos.origin, control_point_pos.angles);
...
function function_b7c45db1(control_point, e_player) {
    ...
    control_point.var_93623c13.control_point = control_point util::spawn_model(#"hash_7cf020c84a283dd7", control_point.origin, control_point.angles);
    control_point.var_93623c13 thread function_6ed4e713();
    control_point.var_4e953b00.control_point = 1;
    level flag::set(#"hash_647ab45ea0e2deb9" + control_point.script_int);
    level.var_2912d8c5++;
    if (level.var_2912d8c5 < 3) {
        control_point.var_cdeb4ee4 zm_vo::function_d6f8bbd9(#"hash_15658e0da81868ac", 0, undefined, 1);
    } else {
        ...
        control_point.var_cdeb4ee4 zm_vo::function_d6f8bbd9(#"hash_15658e0da81868ac", 0, undefined, 1);
        control_point.var_cdeb4ee4 zm_vo::function_d6f8bbd9(#"hash_513b5b11b067f41e", 0, undefined, 1);
    ...
    foreach (var_9673500d in struct::get_array(control_point.target, "targetname")) {
        if (var_9673500d.script_noteworthy === "objective_pos") {
            zm_sq::function_53d0d99(#"hash_520d09b88a205eac", var_9673500d);
        }
    }
    /#
...
function function_7df47abd() {
    ...
    if (level.var_2645bbc0 === 1) {
        zm_sq::function_53d0d99(#"hash_69cca9825b7edc33");
    }
...
function function_752dbea1(var_d9e04bad = #"low") {
    ...
    if (var_d9e04bad == #"hash_81d3d1917793b59") {
...
function function_9112b94e(ai_zombie) {
    ...
    if (isdefined(ai_zombie.var_6d81bf5c)) {
        ai_zombie.var_126d7bef.ai_zombie = ai_zombie.var_6d81bf5c;
        ai_zombie.var_6d81bf5c = undefined;
    }
    if (isdefined(ai_zombie.var_c8a896e3)) {
        ai_zombie.ignore_round_spawn_failsafe.ai_zombie = ai_zombie.var_c8a896e3;
        ai_zombie.var_c8a896e3 = undefined;
    }
    if (isdefined(ai_zombie.var_4e219048)) {
        ai_zombie.b_ignore_cleanup.ai_zombie = ai_zombie.var_4e219048;
...
function function_1ef4bcd6(var_14a22ccd = 0) {
    ...
    if (self.var_269ad176 !== 2) {
        self.var_cdeb4ee4 clientfield::set("" + #"hash_48cdaba6cfee3ee8", 1);
        self thread function_c1bde2a0();
    }
    self.var_cdeb4ee4 clientfield::set("" + #"hash_4824b5ad2c6adfcf", 0);
    self.var_cdeb4ee4 clientfield::set("" + #"hash_33fa936b763918a", 0);
    level.var_34bcb139 = [];
    if (!var_14a22ccd) {
    ...
    if (!var_14a22ccd) {
        ...
        while (i < var_8c10e30b) {
            ...
            if (isdefined(satellite.mdl) && !is_true(satellite.mdl.is_active)) {
                ...
                if (isdefined(slots) && slots.size > 0) {
                    ...
                    satellite.mdl.var_b79a8ac7 = {#slots:slots, #var_f019ea1a:1024};
        ...
        if (isdefined(var_af9beb09) && !is_true(var_af9beb09.is_active)) {
            ...
            if (isdefined(slots) && slots.size > 0) {
                var_af9beb09.is_active.var_af9beb09 = 1;
                var_af9beb09.var_b79a8ac7.var_af9beb09 = {#slots:slots, #var_f019ea1a:1024};
    ...
    while (var_f5a1c26a < var_10ff40e4) {
        ...
        if (isdefined(var_135c0555) && isdefined(self.var_547f9dd5)) {
            ...
            if (var_c2b976ac.dis <= 600) {
                var_135c0555.var_923bed7a.var_135c0555 = var_c2b976ac.entity;
...
function function_30f8cfb4(satellite, zone_index, var_14a22ccd = 0) {
    ...
    while (1) {
        ...
        if (!isplayer(result.attacker)) {
            level notify("damage" + zone_index, {#var_e3276b1e:satellite.mdl, #amount:result.amount});
...
function function_bc369205(var_14a22ccd = 0, var_17f8efd5 = 0, var_d219813c = 0) {
    ...
    while (1) {
        ...
        if (!self.var_16ad7e31 && self.var_2b239c6f >= 2000) {
            self.var_16ad7e31 = 1;
            self.var_cdeb4ee4 clientfield::set("" + #"hash_4824b5ad2c6adfcf", 1);
        }
        if (!self.var_ff770ca && self.var_2b239c6f >= 3000) {
            self.var_ff770ca = 1;
            self.var_cdeb4ee4 clientfield::set("" + #"hash_33fa936b763918a", 1);
        }
    }
}
...
function function_21a9e71b(success, var_14a22ccd, *var_d219813c = 0) {
    ...
    if (!var_d219813c && isdefined(level.var_6fad6ea9)) {
        ...
        self.var_cdeb4ee4 clientfield::set("" + #"hash_48cdaba6cfee3ee8", 0);
    }
    if (is_true(var_14a22ccd)) {
        namespace_b7a7e548::function_947330e6(self, #"power_on");
        self.var_269ad176 = 2;
        if (!var_d219813c) {
            self thread function_752dbea1(#"hash_81d3d1917793b59");
            ...
            self.var_cdeb4ee4 clientfield::set("" + #"hash_221e597b28199323", 1);
        ...
        self.var_cdeb4ee4 clientfield::set("" + #"hash_221e597b28199323", 0);
...
function function_2ecb6786() {
    /#
        foreach (control_point in level.var_cc43b632) {
            control_point.var_3dacb34d.control_point = 1;
        }
        iprintlnbold("<unknown string>");
    #/
}
...
function function_b2d9913a() {
    /#
        foreach (control_point in level.var_cc43b632) {
            if (isdefined(control_point.var_cdeb4ee4)) {
                control_point.var_cdeb4ee4 set("<unknown string>" + #"hash_221e597b28199323", 0);
                control_point.var_cdeb4ee4 set("<unknown string>" + #"hash_48cdaba6cfee3ee8", 1);
            }
            satellites = get_array(control_point.target, "<unknown string>");
            foreach (satellite in satellites) {
                if (isdefined(satellite.mdl)) {
                    satellite.mdl set("<unknown string>" + #"hash_20b22d2242b107cc", 0);
                    satellite.mdl set("<unknown string>" + #"hash_4cf52ac8c941f331", 1);
                }
            }
        }
    #/
...
function function_c4d7b0f0() {
    /#
        foreach (control_point in level.var_cc43b632) {
            if (isdefined(control_point.var_cdeb4ee4)) {
                control_point.var_cdeb4ee4 set("<unknown string>" + #"hash_48cdaba6cfee3ee8", 0);
                control_point.var_cdeb4ee4 set("<unknown string>" + #"hash_221e597b28199323", 1);
            }
            satellites = get_array(control_point.target, "<unknown string>");
            foreach (satellite in satellites) {
                if (isdefined(satellite.mdl)) {
                    satellite.mdl set("<unknown string>" + #"hash_4cf52ac8c941f331", 0);
                    satellite.mdl set("<unknown string>" + #"hash_20b22d2242b107cc", 1);
                }
            }
        }
    #/
