...
function function_847bd54f() {
    ...
    var_13f6cf20.var_2151803f = var_13f6cf20 getlightintensity();
    foreach (light in var_f5b792a2) {
        light.var_2151803f = light getlightintensity();
    }
    var_6799f665.var_2151803f = var_6799f665 getlightintensity();
    while (true) {
        ...
        if (isdefined(light.var_2151803f)) {
            var_13f6cf20 setlightintensity(var_13f6cf20.var_2151803f);
        }
        foreach (light in var_f5b792a2) {
            if (isdefined(light.var_2151803f)) {
                light setlightintensity(light.var_2151803f);
        ...
        if (isdefined(light.var_2151803f)) {
            var_6799f665 setlightintensity(var_6799f665.var_2151803f);
        }
    }
}
...
function function_d5cab286(a_ents) {
    var_ee5b6b46 = a_ents[#"hash_475ee55621b83ca0"];
    var_e864861d = getent("apt_mailbox_door", "targetname");
    var_e864861d linkto(var_ee5b6b46, "j_prop_1", (0, 0, 0), (0, 0, 0));
}
