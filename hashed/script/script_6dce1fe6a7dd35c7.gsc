...
class class_9f07f58e {
    ...
    // Checksum 0x80f724d1, Offset: 0x3150
    // Size: 0x4
    __destructor() {
...
function function_afc62ca5() {
    ...
    self.var_9d9575a4 = 0;
    self.goalradius = 56;
    self.meleedistsq = function_a3f6cdac(92);
    self.var_ccb2e201 = 0;
    self.var_f46fbf3f = 1;
...
function private function_4014790a(entity) {
    ...
    entity.var_b7ba7211.entity = gettime() + int(entity ai::function_9139c839().var_bd87ef4d * 1000);
...
function private function_4b392ea3(entity) {
    ...
    if (isdefined(var_34529779) && var_34529779.size) {
        foreach (var_462d3042 in var_34529779) {
            if (isdefined(var_462d3042.data.pos) && distancesquared(var_462d3042.data.pos, entity.origin) <= function_a3f6cdac(800)) {
                return 0;
            }
        }
    }
...
function private function_a5c42011(entity) {
    ...
    if (function_4b392ea3(entity)) {
        if (isdefined(pathgoalpos)) {
            ...
            if (currentstance == "upright" && distsq > function_a3f6cdac(entity ai::function_9139c839().var_ed83d6e9)) {
                desiredstance = "quad";
                self allowpitchangle(1);
                self setpitchorient();
            } else if (currentstance == "quad" && distsq < function_a3f6cdac(entity ai::function_9139c839().var_e5f93adc)) {
        ...
        var_462d3042.pos.var_462d3042 = entity.origin;
...
function private function_9e901f61(entity) {
    ...
    if (isdefined(entity.enemy)) {
        ...
        if (distancesq < function_a3f6cdac(entity ai::function_9139c839().var_2a25aee8)) {
            return 0;
        }
        if (distancesq > function_a3f6cdac(entity ai::function_9139c839().chargemeleedist)) {
            return 0;
        }
...
function private werewolfleapattack(entity) {
    ...
    foreach (zombie in zombies) {
        ...
        zombie.knockdown_type.zombie = "knockdown_stun";
    }
...
function private function_7ad7aa7d(entity, mocompanim, *mocompanimblendouttime, *mocompanimflag, *mocompduration) {
    ...
    mocompanimflag.takedamage.mocompanimflag = 0;
...
function function_8b63ee0e(entity, mocompanim, *mocompanimblendouttime, *mocompanimflag, *mocompduration) {
    ...
    if (isdefined(mocompanimflag.enemy) && !mocompanimflag.var_cd8354e0.adjustmentstarted && mocompanimflag.var_cd8354e0.var_425c4c8b && var_e72a224a >= mocompanimflag.var_cd8354e0.var_98bc84b7) {
        ...
        } else if (var_cf699df5 > var_65cbfb52 && var_776ddabf >= function_a3f6cdac(mocompanimflag ai::function_9139c839().var_d781a7cc)) {
            mocompanimflag.var_cd8354e0.var_425c4c8b = 0;
        } else if (var_776ddabf >= function_a3f6cdac(mocompanimflag ai::function_9139c839().var_e49498dc)) {
            mocompanimflag.var_cd8354e0.var_425c4c8b = 0;
        }
        if (var_535d098c) {
...
function function_76968111(entity, *mocompanim, *mocompanimblendouttime, *mocompanimflag, *mocompduration) {
    mocompduration.takedamage.mocompduration = 1;
...
function private function_f8912291(entity) {
    entity.var_48baa747.entity = 1;
    entity.summon_wolves = undefined;
    entity.var_1a60ad62.entity = gettime() + entity ai::function_9139c839().var_fe050356;
    entity.blockingpain.entity = 1;
