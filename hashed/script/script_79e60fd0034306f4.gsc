...
function function_3eeef9bb() {
    level.park waittill(#"hash_3f38248a0114fffc");
    if (!level flag::get("kill_greta")) {
...
function function_ad178f3f() {
    ...
    objectives::goto(#"hash_3c603f8c6db5e6d9", var_f8d522f5);
    level flag::wait_till("flag_warehouse_combat_vo");
    id = objectives::function_285e460(#"hash_3c603f8c6db5e6d9", var_f8d522f5);
    ...
    objectives::remove(#"hash_3c603f8c6db5e6d9", var_f8d522f5);
}
...
// Size: 0x76
function function_cfbae19c(var_28c216f0, disable_flag, var_216b7881) {
    if (isdefined(disable_flag)) {
        level endon(disable_flag);
    }
    level flag::wait_till(var_28c216f0);
    var_897f3268 = spawner::simple_spawn(var_216b7881, &function_73b1f5c7);
}
...
function function_6b148d96() {
    ...
    player = getplayers()[0];
    var_b29c8b6b = getent("warehouse_outro_player_check_vol", "targetname");
    level flag::wait_till("warehouse_outro_volkov_attack_start");
    while (true) {
        if (player istouching(var_b29c8b6b)) {
            level flag::set("warehouse_outro_volkov_attack");
            continue;
        }
        waitframe(1);
...
function function_5b10af6b() {
    ...
    while (!flag::get("warehouse_combat_over")) {
        var_982e50da = spawner::get_ai_group_ai("warehouse_enemies");
        if (var_982e50da.size >= 16) {
            foreach (e_ent in var_982e50da) {
