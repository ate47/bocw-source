...
function function_c4504c49( spawn_loc, var_75f9ae2d )
{
    ...
    if ( !isdefined( bundle ) )
    {
        return { #prop_name:#"barrel_rust_01_green", #pos_offset:( 0, 0, 0 ), #angle_offset:( 0, 0, 0 ), #rattle_sound:"amb_rattle_barrel" };
    }
...
function function_da3be96b( type, handler, validator )
{
    ...
    level.var_6939ebc1[ type ] = { #handler:handler, #validator:validator };
}
...
{
    self.var_2e8a136f = 0;
    self notify( #"hash_1e8aabc2641542e", { #activator:player_activator } );
}
