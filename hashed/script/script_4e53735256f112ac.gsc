...
function private function_70a657d8() {
    ...
    clientfield::register_clientuimodel("hud_items.ammoCooldowns.fieldUpgrade", #"hash_6f4b11a0bee9b73d", [1:#"fieldupgrade", 0:#"hash_2f126bd99a74de8b"], 1, 5, "float", undefined, 0, 0);
