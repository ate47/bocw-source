...
function function_9ff740ab(a_ents) {
    ...
    mdl_door linkto(a_ents[#"hash_3b0df9ba06207b4b"], "j_prop_1", (0, 0, 0), (0, 0, 0));
}
...
function function_a8b99b8d() {
    ...
    self waittill(#"hash_21fd7da15956bbba");
...
function function_77b94778() {
    self endon(#"hash_21fd7da15956bbba");
...
function function_48695888() {
    ...
    foreach (train in var_116e3c5f) {
        if (isdefined(train.var_8bc03d56)) {
            train.var_8bc03d56 delete();
        }
