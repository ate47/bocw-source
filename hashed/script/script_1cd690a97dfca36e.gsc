...
function play(soundalias, targets) {
    var_317c7400 = level._snd.var_d37e94ca;
    var_afe43979 = function_2639b80c(var_317c7400, soundalias, targets);
    return var_afe43979;
}
...
// Size: 0x138
function function_2a2f26d4(var_afe43979, var_59e3c08a, notifystring, var_24ea4e17) {
    if (function_81fac19d(!isdefined(var_afe43979), "snd_stop_on_ent_notify with undefined soundObject")) {
        return;
    }
    if (function_81fac19d(!isentity(var_59e3c08a), "snd_stop_on_ent_notify notifyEntity is not an entity")) {
        return;
    }
    ...
    foreach (var_d7ba9fdf in function_f218bff5(var_afe43979)) {
        var_59e3c08a thread function_7b540bad(var_d7ba9fdf, var_59e3c08a, notifystring, var_24ea4e17);
    }
}
...
function function_a6779cbd(var_afe43979) {
    if (isdefined(var_afe43979) && isdefined(var_afe43979.var_317c7400)) {
        return 1;
    }
    return 0;
}
...
function function_33560b93(targets) {
    ...
    foreach (target in function_f218bff5(targets)) {
        ...
        } else if (isdefined(target.var_a415b6d6)) {
...
function function_8f5dfd03(soundalias, targets) {
    ...
    if (isarray(soundalias)) {
        foreach (alias in soundalias) {
            var_7a316e2[var_7a316e2.size] = tolower(alias);
        }
    } else if (isstring(soundalias)) {
        var_7a316e2 = [0:tolower(soundalias)];
    }
    /#
        assert(isarray(var_7a316e2), "speed");
    #/
    var_2b6903e6 = function_33560b93(targets);
    var_68303cc7 = [];
    foreach (var_d7ba9fdf in var_2b6903e6) {
...
function function_880857eb(var_932dabe2) {
    ...
    if (!isdefined(level._snd.var_2c3e0fc7)) {
        level._snd.var_2c3e0fc7 = level.var_2c3e0fc7;
        level._snd.var_f0386daf = level.var_f0386daf;
        level._snd.var_11a13546 = level.var_11a13546;
        level._snd.var_2861a322 = level.animation.callbacks[#"hash_73f041a2a6b96ce1"];
    }
    if (var_932dabe2) {
        level.var_2c3e0fc7 = &function_b7609ab;
        level.var_f0386daf = &function_e94a63b7;
        level.var_11a13546 = &function_95d9f208;
        level.animation.callbacks[#"hash_73f041a2a6b96ce1"] = &function_e9b666c7;
    } else {
        level.var_2c3e0fc7 = level._snd.var_2c3e0fc7;
        level.var_f0386daf = level._snd.var_f0386daf;
        level.var_11a13546 = level._snd.var_11a13546;
        level.animation.callbacks[#"hash_73f041a2a6b96ce1"] = level._snd.var_2861a322;
    }
}
...
// Size: 0x82
function function_db78159d(var_afe43979, volume, var_3e12323c, curve, callbackfunc) {
    if (isdefined(level._snd._callbacks[#"hash_54be783edee16780"])) {
        [[ level._snd._callbacks[#"hash_54be783edee16780"] ]](var_afe43979, volume, var_3e12323c, curve, callbackfunc);
    }
}
...
// Size: 0x82
function function_964c3a03(var_afe43979, pitch, var_3e12323c, curve, callbackfunc) {
    if (isdefined(level._snd._callbacks[#"hash_2e4f12f2aa75ce4a"])) {
        [[ level._snd._callbacks[#"hash_2e4f12f2aa75ce4a"] ]](var_afe43979, pitch, var_3e12323c, curve, callbackfunc);
    }
}
...
function get_type(var_afe43979) {
    if (isdefined(var_afe43979.var_317c7400)) {
        return var_afe43979.var_317c7400;
    }
    return "";
}
...
// Size: 0x148
function function_d14c9339(var_317c7400) {
    ...
    /#
        assert(isdefined(var_db943b21), "<unknown string>" + var_317c7400);
    #/
    return var_db943b21;
}
...
function private function_e12570db() {
    var_db943b21 = self.var_317c7400;
...
function private function_9a3d9ff2(var_7483db1c) {
    ...
    if (isarray(var_7483db1c)) {
        ...
        for (i = 0; i < keys.size; i++) {
            ...
            if (function_90a7316b(key) && i < var_7c64d318) {
                delaytime = key;
            }
            if (function_90a7316b(key) && i > var_7c64d318) {
                var_6d232fb3 = key;
...
// Size: 0xa0a
function private function_2639b80c(var_317c7400, soundalias, var_9ab0e73a) {
    ...
    #/
    var_317c7400 = function_ea2f17d1(var_317c7400, level._snd.var_d37e94ca);
    var_2b6903e6 = [];
    targets = [];
    ...
    #/
    islooping = function_d8f86d06(soundalias);
    ...
    LOC_00000704:
        ...
        if (isdefined(var_afe43979) && function_a6779cbd(var_afe43979)) {
            ...
            if (var_6d232fb3 > 0) {
                if (var_317c7400 == #"hash_72d0c119f969b755" && isdefined(var_605838f4)) {
...
function private function_f937a6f7(var_afe43979, var_24ea4e17) {
    ...
    if (function_81fac19d(!isdefined(var_afe43979.var_317c7400), "snd_stop with unknown type")) {
        return;
    }
    /#
        assert(isdefined(level._snd.var_d37e94ca), "<unknown string>");
    ...
    #/
    /#
        assert(isdefined(var_afe43979.var_317c7400), "<unknown string>");
    #/
    if (var_afe43979.var_317c7400 == #"hash_193a10998478444d") {
        var_afe43979 notify(#"hash_57df777459b5086");
        var_afe43979.var_317c7400 = undefined;
    ...
    var_317c7400 = var_afe43979.var_317c7400;
    soundalias = var_afe43979.soundalias;
    if (isdefined(soundalias) && function_d8f86d06(var_afe43979.soundalias) && !isdefined(var_24ea4e17)) {
...
// Size: 0x6c
function private function_7b540bad(var_afe43979, var_59e3c08a, notifystring, var_24ea4e17) {
    var_afe43979 endon(#"death");
    var_59e3c08a waittill(#"death", notifystring);
...
function private function_cdc85ae5(var_4be7fc38) {
    ...
    if (function_90a7316b(var_4be7fc38) && var_4be7fc38 != 0) {
...
function private function_1ce48d0f(target, dist, var_3c67b910, var_cbf878e6, rotation) {
    ...
    #/
    /#
        assert(function_90a7316b(dist), "<unknown string>");
    #/
    /#
        assert(function_90a7316b(var_3c67b910), "<unknown string>");
    #/
    /#
        assert(function_90a7316b(rotation), "<unknown string>");
    #/
    /#
    ...
    while (isentity(self) && isdefined(target) && isdefined(target.origin)) {
        ...
        var_3c67b910 = var_3c67b910 + var_ea6c6b8e;
        wait(movetime);
    }
}
...
// Size: 0x1b0
function private function_d1e7d514(var_5f9d291a) {
    iss = isstruct(var_5f9d291a);
    var_7e461444 = isdefined(var_5f9d291a.var_317c7400);
    var_30a139 = var_5f9d291a.var_317c7400 == #"hash_193a10998478444d";
    var_69bd016 = iss && var_7e461444 && var_30a139;
    if (function_81fac19d(var_69bd016 == 0, "snd emitter stop not an emitter")) {
        return;
    }
    /#
        assert(isdefined(var_5f9d291a.soundkey), "<unknown string>");
    #/
    /#
    ...
    #/
    level._snd.var_90a7c764[var_5f9d291a.soundkey] = undefined;
    var_5f9d291a notify(#"hash_57df777459b5086");
    var_5f9d291a.var_317c7400 = undefined;
    var_5f9d291a.soundalias = undefined;
    var_5f9d291a.var_90c86b97 = undefined;
    var_5f9d291a.origin = undefined;
    var_5f9d291a.angles = undefined;
    var_5f9d291a = undefined;
}
...
function private function_dcc0344(soundalias, target, var_8fc5ff4a, var_6c6d0c21, var_4be7fc38, var_ad8975b4) {
    ...
    if (isarray(var_8fc5ff4a) && var_8fc5ff4a.size >= 4) {
        ...
        wait(spawntime);
        var_50a76fc3 = function_5eb4c6d(target);
        position = function_160366e9(var_50a76fc3, dist, var_3c67b910, var_cbf878e6);
...
// Size: 0x47a
function function_5f9d291a(soundalias, target, spawntime, var_6c6d0c21, rotation, var_cbf878e6) {
    var_bf0efd8 = [];
    targets = target;
    islooping = function_d8f86d06(soundalias);
    ...
    foreach (t in targets) {
        ...
        isv = isvec(t);
        if (var_381a9100 || isv) {
            var_5f9d291a = spawnstruct();
            var_5f9d291a.var_317c7400.var_5f9d291a = #"hash_193a10998478444d";
            var_5f9d291a.soundalias = soundalias;
            var_5f9d291a.spawntime = spawntime;
            var_5f9d291a.var_6c6d0c21 = var_6c6d0c21;
            var_5f9d291a.rotation = rotation;
            var_5f9d291a.var_cbf878e6 = var_cbf878e6;
            level._snd.var_9e1f6b3e = int(level._snd.var_9e1f6b3e + 1);
            var_5f9d291a.soundkey.var_5f9d291a = "" + level._snd.var_9e1f6b3e;
            level._snd.var_90a7c764[var_5f9d291a.soundkey] = var_5f9d291a;
            if (var_381a9100) {
                var_5f9d291a.var_90c86b97 = t;
            }
            if (isv) {
                var_5f9d291a.origin = t;
                var_5f9d291a.angles.var_5f9d291a = (0, 0, 0);
            }
            var_5f9d291a thread function_dcc0344(soundalias, t, spawntime, var_6c6d0c21, rotation, var_cbf878e6);
            var_bf0efd8[var_bf0efd8.size] = var_5f9d291a;
        } else {
            function_81fac19d(var_381a9100 == 0 && isv == 0, "snd_emitter target '" + t + "' was not an entity or vector.");
        }
    }
    function_81fac19d(var_bf0efd8.size == 0, "snd_emitter resulted in zero emitter targets");
    return function_31bcd153(var_bf0efd8);
}
...
function private function_e94a63b7(alias, tag, ends_on_death, var_50bba55f, *var_82ea274f) {
    ...
    /#
        if (isdefined(level.var_ca328321) && self == level.var_ca328321) {
...
function private function_95d9f208(notetrack) {
    ...
    if (prefix == "vo_") {
        alias = getsubstr(notetrack, 3);
        if (isdefined(self.var_d3a936c9)) {
            self thread [[ self.var_d3a936c9 ]](alias, "j_head", 1);
        } else {
            self thread function_e94a63b7(alias, "j_head", 1, alias);
        }
        return 1;
    }
    if (isdefined(level._snd.var_11a13546)) {
        return self [[ level._snd.var_11a13546 ]](notetrack);
    }
    return 0;
}
...
function function_b918d683(inval, curve) {
    ...
    for (i = 0; i < lut.size; i++) {
        ...
        if (inval >= var_a1c4b722 && inval <= var_aa208db) {
            var_ffc8189f = inval - var_a1c4b722;
    ...
    while (function_3132f113(self) == 0 && isdefined(self.var_3dc056c0) && self.var_3dc056c0.size > 0) {
        ...
        foreach (p in self.var_3dc056c0) {
            ...
            if (isdefined(p.var_b90f380f)) {
                ...
                #/
                p.var_e9082dc0.p = self [[ p.var_b90f380f ]](p.userdata);
                /#
...
function function_c0e3d9aa(*userdata) {
    ...
    #/
    now = gettime();
    if (isdefined(self.var_436b7e8) && self.var_436b7e8 == now) {
        /#
            assert(isdefined(self.var_55cb19ba));
        #/
        return self.var_55cb19ba;
    }
    if (isdefined(self.var_aa9069f1) == 0) {
        self.var_aa9069f1 = self.origin;
    }
    if (isentity(self)) {
        self.var_55cb19ba = 0.0166667 * self getvelocity();
    } else {
        self.var_55cb19ba = self.origin - self.var_aa9069f1;
    }
    self.var_436b7e8 = now;
    self.var_aa9069f1 = self.origin;
    return self.var_55cb19ba;
}
...
function function_8764d0b2(*userdata) {
    ...
    /#
        if (function_95c9af4b() >= 2) {
            ...
            function_ac033c46(var_38f9ec40, self.origin + var_8764e9e6, -1 * var_c75cd11f, "<unknown string>", debugcolor, var_7afd95ae, (0, 0, 0), var_74500ef, (1, 1, 1), var_74500ef, var_5383e446);
        }
    #/
...
function private function_cebd7215(var_67f427c4, var_99e65ecf, var_358f1599) {
    var_67f427c4.snd.var_67f427c4 = play(var_67f427c4.soundalias, var_67f427c4.target);
...
function private function_ebe7010d(target, soundalias, var_5c76982f, var_4da05e4e) {
    ...
    ent.var_1ab997d2.ent = function_ea2f17d1(ent.var_1ab997d2, array());
...
function function_d6d4a5d8(var_86bf21bc, var_72585589, var_c5abb52c, var_538ddc9c, var_683a408d, var_d03e56e8, var_2982cf88) {
    ...
    /#
        assert(function_90a7316b(var_c5abb52c));
    #/
    /#
        assert(function_90a7316b(var_d03e56e8));
    #/
    /#
        assert(function_90a7316b(var_ec47cb08));
    #/
    var_452d5766 = var_86bf21bc - var_538ddc9c;
    var_48ff4b02 = length(var_452d5766);
    var_2c6a3dcc = 0;
    var_3619eb04 = 0;
    if (var_c5abb52c > 0 && var_72585589 != (0, 0, 0)) {
        var_2c6a3dcc = vectordot(var_72585589, var_452d5766) / var_48ff4b02;
        var_2c6a3dcc = var_2c6a3dcc * var_c5abb52c;
    }
    if (var_d03e56e8 > 0 && var_683a408d != (0, 0, 0)) {
        var_3619eb04 = vectordot(var_683a408d, var_452d5766) / var_48ff4b02;
        var_3619eb04 = var_3619eb04 * var_d03e56e8;
    }
    dopplerscale = (var_ec47cb08 - var_2c6a3dcc) / (var_ec47cb08 - var_3619eb04);
    return [2:var_3619eb04, 1:var_2c6a3dcc, 0:dopplerscale];
}
...
function private function_344f3a4a(var_e9082dc0, userdata) {
    ...
    if (isdefined(self.var_9dad7949.pitchscale)) {
        dopplerscale = dopplerscale * self.var_9dad7949.pitchscale;
    }
...
// Size: 0x20c
function private function_787f558e(player, dopplerscale, pitchscale, var_a47261d3) {
    /#
    ...
    if (isdefined(player.var_9dad7949) == 0) {
        player.var_9dad7949.player = spawnstruct();
    }
    if (var_a47261d3 > 0) {
...
function doppler(var_afe43979, player, dopplerscale, pitchscale, var_a47261d3) {
    ...
    foreach (var_d7ba9fdf in function_f218bff5(var_afe43979)) {
        var_d7ba9fdf thread function_787f558e(player, dopplerscale, pitchscale, var_a47261d3);
    }
}
...
function function_bdd32fcc() {
    var_ea94f865 = getskiptos();
    /#
        assert(isstring(var_ea94f865));
    #/
    var_ea94f865 = tolower(var_ea94f865);
    var_ea94f865 = strtok(var_ea94f865, ",");
    skipto = "";
    if (isarray(var_ea94f865)) {
        if (var_ea94f865.size >= 1) {
            skipto = var_ea94f865[0] + "";
        }
    } else if (isstring(var_ea94f865)) {
        skipto = var_ea94f865;
    }
    return skipto;
}
...
function private function_637f9a70(callback, var_7d665d77) {
    ...
    while (1) {
        ...
        if (var_7d665d77 || !var_7d665d77 && !isdefined(objectives[skipto])) {
...
// Size: 0x34
function function_623fb3ae(callback, var_7d665d77) {
...
function private function_78013c7e(callback) {
    ...
    while (1) {
        ...
        if (istouching) {
            player.var_a1d98d00.player = function_ea2f17d1(player.var_a1d98d00, var_524d6318);
            /#
                /#
            ...
            var_cecadbd0 = isdefined(player.var_9a8a4923.var_76d306a7) && isdefined(trigger.var_76d306a7);
            var_a4243a33 = var_cecadbd0 && int(player.var_9a8a4923.var_76d306a7) <= int(trigger.var_76d306a7);
            ...
            if (player.var_9a8a4923 == trigger) {
                ...
                if (var_cecadbd0) {
                    ...
                    for (i = player.var_a1d98d00.size - 1; i > 0; i--) {
                        ...
                        if (isdefined(var_c41f0300.var_76d306a7)) {
                            var_271728fd = int(var_c41f0300.var_76d306a7);
...
function function_645c2f9b(player, element) {
    var_7df41f60 = function_e3a36342(player);
    if (function_81fac19d(!var_7df41f60, "snd: set_element invalid player")) {
        return;
    }
    ...
    if (var_a2dc2648) {
        player.var_c0ee07ef.player = "**** custom ****";
    } else if (var_8314d62) {
    ...
    if (var_7df41f60 && isarray(player.var_c6206b8b)) {
    ...
    /#
        assert(var_a718b5db);
    #/
    player.var_c6206b8b.player = array();
    foreach (e in elements) {
        ...
        rotation = e[4];
        var_cbf878e6 = e[5];
        var_804d5d55 = function_5f9d291a(alias, target, spawntime, var_6c6d0c21, rotation, var_cbf878e6);
    ...
    while (function_e3a36342(player) && function_a6779cbd(var_afe43979)) {
        ...
        /#
            if (function_95c9af4b() > 1) {
                ...
                line(var_887e31c1 - var_e760c89c * 24, var_887e31c1 + var_e760c89c * 24, var_9b68d40d, 1, 0, 1);
            }
        #/
        waitframe(1);
    }
