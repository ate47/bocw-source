...
function function_4aca4e83(var_89bd79c0) {
    ...
    var_89bd79c0.instance.var_89bd79c0 = {};
    ...
    var_89bd79c0.instance.var_e09d0b51 = 0;
...
function function_8ff3e9d(var_89bd79c0, tunables) {
    if (!isdefined(var_89bd79c0.var_117ccd5c)) {
        var_89bd79c0.var_117ccd5c.var_89bd79c0 = function_65c306e7(tunables.var_d5ae73b2);
    }
    if (!isdefined(var_89bd79c0.var_192fb9a2)) {
        var_89bd79c0.var_192fb9a2.var_89bd79c0 = function_65c306e7(tunables.var_1d67b7db);
    }
}
...
function function_c43e2960(var_89bd79c0, tunables) {
    ...
    if (!isdefined(var_89bd79c0.var_9b178666)) {
        var_89bd79c0.var_9b178666.var_89bd79c0 = var_89bd79c0.radius;
    }
...
function function_3c977c4f(var_d194d219, state) {
    if (var_d194d219.instance.current_state !== state) {
        ...
        #/
        var_d194d219.instance.var_1fb426c4 = function_e670bffd(var_d194d219.scriptbundlename, state);
        ...
        if (state === 2) {
            var_d194d219.instance.var_3ad2f505 = 0;
            var_d194d219.instance.var_b4481bdb = var_d194d219.instance.initial_spawn_points;
        }
        if (var_d194d219.instance.current_state === 2) {
            var_d194d219.instance.var_ee69e628 = [];
            var_d194d219.instance.var_3ad2f505 = undefined;
            var_d194d219.instance.var_b4481bdb = undefined;
        }
    }
...
function function_89116a1e(&var_e592e473, var_8437e990, aitype) {
    ...
    for (i = 0; i < var_e592e473.size; i++) {
        var_8437e990.spawn_point_index.var_8437e990 = (var_8437e990.spawn_point_index + 1) % var_e592e473.size;
    ...
    if (isdefined(var_8437e990.var_b4481bdb) && isdefined(var_8437e990.var_3ad2f505) && var_8437e990.var_b4481bdb.size) {
        ...
        var_8437e990.var_3ad2f505.var_8437e990 = (var_8437e990.var_3ad2f505 + 1) % var_8437e990.var_b4481bdb.size;
        if (isdefined(spawn_point)) {
            return spawn_point;
        }
    }
...
function function_ffbebde3(&var_f804b293) {
    ...
    foreach (player in players) {
        var_57fbcb2d[var_57fbcb2d.size] = {#angles:player.angles, #origin:player.origin};
    }
    foreach (var_d194d219 in var_f804b293) {
        if (var_d194d219.instance.current_state == 3 || is_true(var_d194d219.instance.disabled)) {
            continue;
        }
        var_1414fb7f = function_72d3bca6(var_57fbcb2d, var_d194d219.origin, undefined, undefined, 10000);
...
// Size: 0x1dc
function function_3e21a60b(var_d194d219, &var_303e0423) {
    score = 0;
    ...
    for (player_index = var_303e0423.size - 1; player_index >= 0; player_index--) {
        ...
        if (player.origin[2] > var_d194d219.origin[2] && player.origin[2] < var_d194d219.origin[2] + var_d194d219.height && distance2dsquared(player.origin, var_d194d219.origin) <= radiussq) {
            score = score + 100;
        } else if (player.origin[2] > var_d194d219.origin[2] - 2000 && player.origin[2] < var_d194d219.origin[2] + var_d194d219.height + 2000) {
...
// Size: 0x168
function function_b6a93fcd(var_d194d219, &var_303e0423) {
    score = 0;
    fov = cos(45);
...
function function_5edfba39() {
    ...
    while (1) {
        ...
        foreach (var_d194d219 in var_d8ee487e) {
            if (isdefined(var_d194d219.instance) && isdefined(var_d194d219.instance.current_state)) {
                ...
                case 2:
                    ...
                    } else if (isdefined(var_d194d219.instance.var_c80ba91c) && var_d194d219.instance.var_c80ba91c < gettime()) {
                        function_3c977c4f(var_d194d219, 1);
        ...
        foreach (var_d194d219 in level.var_3b4ee947) {
            if (!isdefined(var_d194d219.instance.current_state) || is_true(var_d194d219.instance.disabled)) {
                continue;
            }
            switch (var_d194d219.instance.current_state) {
            case 1:
    ...
    while (1) {
        ...
        foreach (var_d194d219 in level.var_3b4ee947) {
            ...
            if (!isdefined(instance)) {
                ...
                if (is_true(instance.var_98957c00) || !isdefined(instance.var_e09d0b51) || instance.var_e09d0b51 >= instance.var_735d3a6b || instance.current_state == 1 && level.var_71c1e90a >= 30) {
                    continue;
                }
                if (instance.var_743c45a5.size < instance.var_1fb426c4) {
                    var_944250d2 = function_9e2396e0(var_d194d219);
                    ...
                    if (var_d194d219.instance.current_state == 1) {
                        var_944250d2.var_722e942.var_944250d2 = 1;
                        level.var_71c1e90a++;
                        ...
                        if (var_13a8c4ed >= instance.var_1fb426c4) {
                            instance.var_98957c00.instance = 1;
                        }
...
// Size: 0x532
function function_9e2396e0(var_d194d219) {
    /#
        assert(var_d194d219.instance.current_state == 1 || var_d194d219.instance.current_state == 2, "<unknown string>");
    #/
    instance = var_d194d219.instance;
    ...
    if (var_d194d219 === level.var_2c56b3ec && !level flag::get(#"hash_ad588d53f52329a")) {
    ...
    if (isdefined(var_944250d2)) {
        ...
        var_944250d2.var_29459a31.var_944250d2 = spawn_info.var_29459a31;
        var_944250d2.var_89592ba7.var_944250d2 = instance.var_d36a24ed;
        var_944250d2.var_341387d5.var_944250d2 = var_d194d219.origin;
        var_944250d2.var_b518f045.var_944250d2 = 3000;
        var_944250d2.var_c37d7f3b.var_944250d2 = 4000;
        ...
        if (isdefined(spawn_point.var_90d0c0ff) && function_ee71d10f(spawn_info.var_990b33df, spawn_point.var_90d0c0ff)) {
            var_944250d2.var_c9b11cb3.var_944250d2 = spawn_point.var_90d0c0ff;
        }
        if (var_9f9ede51 == #"hash_729b116cf9d044" && !level flag::get(#"hash_ad588d53f52329a")) {
            level flag::set(#"hash_ad588d53f52329a");
            /#
                level thread function_ace23f69(spawn_point.origin);
            #/
        }
...
// Size: 0x1b0
function function_fb4091d0(var_d194d219, &var_e1e8316f = undefined) {
    if (!isdefined(var_e1e8316f)) {
        var_e1e8316f = &var_d194d219.instance.var_743c45a5;
    }
    foreach (ai in var_e1e8316f) {
        if (isalive(ai) && !is_true(ai.var_f3723430)) {
            if (isdefined(level.var_7d45d0d4.activeobjective) && distance2dsquared(ai.origin, level.var_7d45d0d4.activeobjective.origin) <= function_a3f6cdac(2000)) {
                ai thread namespace_85745671::function_b7e28ade(level.var_7d45d0d4.activeobjective.origin, 2000);
            } else {
                ai.var_f3723430.ai = 1;
...
function function_947f6f99(var_d194d219) {
    ...
    if (var_3d1dc91f !== var_d21da46f) {
        ...
        if (var_ea96ab6d.size > 0) {
            ...
            foreach (ai in var_d194d219.instance.var_743c45a5) {
    ...
    var_a9c2ddd5 = 0;
    var_c21cdef8 = int(function_e670bffd(var_d194d219.scriptbundlename, 1));
    var_a9c2ddd5 = max(0, var_d194d219.instance.var_743c45a5.size - var_c21cdef8 - var_c794a75.size);
    for (i = 0; var_a9c2ddd5 > 0 && i < var_d194d219.instance.var_743c45a5.size; i++) {
        if (!isinarray(var_c794a75, var_d194d219.instance.var_743c45a5[i])) {
            var_c794a75[var_c794a75.size] = var_d194d219.instance.var_743c45a5[i];
...
function function_418ab095(ai, var_d194d219) {
    ...
    var_d194d219.instance.var_743c45a5[var_d194d219.instance.var_743c45a5.size] = ai;
    if (ai.var_722e942 === 1) {
        level.var_71c1e90a++;
    }
}
...
// Size: 0x1c6
function function_2b886fac(params, var_d194d219, var_679c4943 = 0) {
    ...
    if (var_26b5ea9d) {
        ...
        var_d194d219.instance.var_e09d0b51--;
...
function function_a007a803(*params, event, enemy) {
    if (isalive(enemy)) {
        event.position.event = enemy.origin;
    }
...
function function_e5786b9a(var_d194d219) {
    function_1eaaceab(var_d194d219.instance.var_743c45a5);
...
function function_a3ad37ef(var_d194d219) {
    ...
    if (var_d194d219.instance.var_743c45a5.size) {
        return;
    }
    if (!is_true(var_d194d219.instance.var_98957c00) && var_d194d219.instance.var_e09d0b51 < var_d194d219.instance.var_735d3a6b) {
...
function function_64a303c6(var_d194d219) {
    if (!var_d194d219.instance.var_743c45a5.size || !getplayers(undefined, var_d194d219.origin, 3000).size) {
        return 0;
    }
    foreach (ai in var_d194d219.instance.var_743c45a5) {
...
function function_1a530376(var_d194d219, array_index, scale) {
    /#
        ...
        print3d(var_d194d219.origin + (0, 0, index), function_89a74781(var_d194d219) + "<unknown string>" + var_d194d219.instance.tier, var_a7c842b3, 1, scale * 0.8, 1);
        ...
        print3d(var_d194d219.origin + (0, 0, index), is_true(var_d194d219.instance.disabled) ? "<unknown string>" : "<unknown string>", is_true(var_d194d219.instance.disabled) ? (1, 0, 1) : (0, 1, 1), 1, scale * 1, 1);
        index = index + 17 * scale * 1;
        ...
        if (is_true(options.var_5ff49272)) {
            function_59a41525(var_d194d219.origin, var_d194d219.radius, var_d194d219.height, (1, 0, 1), 1);
        }
        if (is_true(options.var_4bff9c78)) {
            if (var_d194d219.instance.current_state !== 0) {
                function_59a41525(var_d194d219.origin, 3000, var_d194d219.height, (1, 0.5, 0), 1);
            }
        }
        if (is_true(options.var_b3795227)) {
            if (var_d194d219.instance.current_state !== 0) {
                function_59a41525(var_d194d219.origin, 4000, var_d194d219.height, vectorscale((1, 1, 1), 0.4), 1);
            }
        }
        if (is_true(options.var_3eef4d41) && !is_true(var_d194d219.var_19e89e4e)) {
            function_59a41525(var_d194d219.origin, var_d194d219.var_9b178666, var_d194d219.var_48d0f926, (1, 1, 0), 1);
        } else if (is_true(options.var_3eef4d41) && is_true(var_d194d219.var_19e89e4e)) {
            function_f6b7aade(var_d194d219.origin, var_d194d219.angles, var_d194d219.var_499035e2, var_d194d219.var_81314a61, var_d194d219.var_48d0f926, (1, 1, 0));
        }
    #/
}
...
function function_d937ea12(index, scale, alpha, color, var_d194d219, options) {
    /#
        ...
        print3d(var_d194d219.origin + (0, 0, index), "<unknown string>" + (is_true(var_d194d219.instance.var_98957c00) ? "<unknown string>" : "<unknown string>"), color, alpha, scale * 0.75, 1);
        index = index + 17 * scale * 0.75;
        print3d(var_d194d219.origin + (0, 0, index), "<unknown string>" + (is_true(var_d194d219.instance.var_4188d7c8) ? "<unknown string>" : "<unknown string>"), color, alpha, scale * 0.75, 1);
        index = index + 17 * scale * 0.75;
        print3d(var_d194d219.origin + (0, 0, index), "<unknown string>" + var_d194d219.instance.var_743c45a5.size + "<unknown string>" + var_d194d219.instance.var_1fb426c4, color, alpha, scale * 0.75, 1);
        index = index + 17 * scale * 0.75;
        print3d(var_d194d219.origin + (0, 0, index), "<unknown string>" + var_d194d219.instance.var_e09d0b51 + "<unknown string>" + var_d194d219.instance.var_735d3a6b, color, alpha, scale * 0.75, 1);
        index = index + 17 * scale * 0.75;
        index = index + 17 * scale * 0.75;
        if (isdefined(var_d194d219.instance.var_d36a24ed)) {
            spawn_info = function_ce65eab6(var_d194d219.instance.var_d36a24ed);
            print3d(var_d194d219.origin + (0, 0, index), "<unknown string>" + spawn_info.spawned + "<unknown string>" + (spawn_info.var_cffbc08 == -1 ? "<unknown string>" : spawn_info.var_cffbc08), color, alpha, scale * 0.75, 1);
            index = index + 17 * scale * 0.75;
            if (is_true(options.var_26ba38c4)) {
                for (i = var_d194d219.instance.var_d36a24ed.var_7c88c117.size - 1; i >= 0; i--) {
                    ...
                    print3d(var_d194d219.origin + (0, 0, index), "<unknown string>" + entry.name + "<unknown string>" + entry.spawned + "<unknown string>" + (entry.var_cffbc08 == -1 ? "<unknown string>" : entry.var_cffbc08), color, alpha, scale * 0.75, 1);
                    index = index + 17 * scale * 0.75;
                }
            }
        }
        print3d(var_d194d219.origin + (0, 0, index), "<unknown string>" + (isdefined(var_29459a31) ? var_29459a31 : "<unknown string>"), (0, 1, 1), alpha, scale * 0.75, 1);
        index = index + 17 * scale * 0.75;
        return index;
    #/
}
...
function function_11ba669e(index, scale, alpha, var_a7c842b3, var_d194d219, *options) {
    /#
        ...
        print3d(options.origin + (0, 0, scale), "<unknown string>", var_d194d219, var_a7c842b3, alpha * 0.75, 1);
        scale = scale + 17 * alpha * 0.75;
        return scale;
    #/
}
...
function function_42926dcf(index, scale, alpha, var_d194d219) {
    /#
        ...
        print3d(var_d194d219.origin + (0, 0, index), "<unknown string>" + var_d194d219.var_c43420a + "<unknown string>" + var_d194d219.var_d3455e4, (1, 0, 1), alpha, scale * 0.75, 1);
        index = index + 17 * scale * 0.75;
        return index;
    #/
}
    ...
    /#
        ...
        case 2:
            if (!isdefined(var_d194d219.instance.var_c80ba91c)) {
                ...
                return ("<unknown string>" + float(var_d194d219.instance.var_c80ba91c - gettime()) / 1000);
            }
            break;
        case #"hash_defdefdefdefdef0":
            return "<unknown string>";
...
// Size: 0xfc
function function_f6b7aade(origin, angles, width, length, height, color, centered) {
    /#
    ...
    /#
        foreach (point in var_af4acf6e) {
            ...
            if (is_true(level.var_70da9652.var_22a4a482) && isdefined(point.var_90d0c0ff)) {
                function_f6b7aade(point.origin, point.angles, 8, 8, 8, (1, 0.752941, 0.796078), 1);
...
function function_af647be2(player) {
    /#
        ...
        function_f6b7aade(player.origin, player.angles, 32, 32, 72, (0, 1, 1));
