...
function event_handler[level_init] main(*eventstruct) {
    ...
    namespace_f3a74bbc::function_b3464a7c(#"hash_68d86d0667a9989b", &init, &function_44ae8976, #"hash_68d86d0667a9989b", #"hash_449cd1c65196f3a8", #"hash_70343e0c02c9f7b9", 7, #"hash_ed63c368c1fca8f");
...
function init(instance) {
    instance.var_53ba65b.instance = [];
    instance.var_344a6a1a.instance = [];
    foreach (s_instance in instance.var_fe2612fe[#"hash_68d86d0667a9989b"]) {
        s_instance.s_start.s_instance = s_instance.var_fe2612fe[#"hash_55beda67733e86c0"][0];
        s_instance.var_5ea363c.s_instance = namespace_8b6a9d79::function_f3d93ee9(s_instance, #"hash_572ef2c74e1d80ef");
        ...
        if (isdefined(s_instance.var_fe2612fe[#"hash_7e2234980528a279"])) {
            s_instance.var_1ac40948.s_instance = namespace_8b6a9d79::function_f3d93ee9(s_instance.var_fe2612fe[#"hash_7e2234980528a279"][0], #"hash_2dc80625b5b6627a", 1);
        }
        if (isdefined(s_instance.var_fe2612fe[#"hash_6c270f0e2716312b"])) {
            s_instance.var_5ea363c.var_7be19157 = namespace_8b6a9d79::function_f3d93ee9(s_instance.var_fe2612fe[#"hash_6c270f0e2716312b"][0], #"tag_origin", 1);
        }
        for (i = 0; i < 2; i++) {
            ...
            var_57e77903.n_id = i;
            var_57e77903.n_index.var_57e77903 = var_9ed85498.script_int;
            instance.var_53ba65b[i] = var_57e77903;
            instance.var_344a6a1a[instance.var_344a6a1a.size] = var_57e77903;
            var_57e77903.var_e16d0db5.var_57e77903 = namespace_8b6a9d79::function_f3d93ee9(var_9ed85498, #"hash_35f0729ec291b85b", 1);
            var_57e77903.var_e16d0db5.targetname = "retrieval_case";
            var_57e77903 thread function_6acbc957(instance);
        }
    }
    instance.var_1ac40948.instance = s_instance.var_1ac40948;
    instance.var_4d0b3b87.instance = s_instance.var_fe2612fe[#"hash_41ae283ea203de66"][0];
    instance.var_5ea363c.instance = s_instance.var_5ea363c;
    instance.var_734a26a4.instance = s_instance.var_fe2612fe[#"hash_28b58e644a932211"][0];
    instance.var_9a67455.instance = s_instance.var_fe2612fe[#"hash_99db954262ad107"];
    instance.var_b69e83ca.instance = s_instance.var_fe2612fe[#"hash_3a45264baef61335"];
    instance.var_ba44fadd.instance = s_instance.var_fe2612fe[#"hash_78b9734c21337ad9"];
    instance.a_s_pts.instance = arraycombine(instance.var_9a67455, instance.var_b69e83ca);
    instance.var_559503f1.instance = arraycombine(instance.a_s_pts, instance.var_ba44fadd);
    ...
    instance.n_zombies.instance = 0;
    if (instance.targetname === "objective_black_sea_retrieval") {
        instance.a_vols.instance = getentarray("vol_ship", "targetname");
    }
...
function vo_end() {
    ...
    wait(0.5);
    self notify(#"hash_4086ed486f346f93");
...
function function_6cbbd741(instance) {
    ...
    while (1) {
        foreach (player in getplayers()) {
            if (isalive(player)) {
                if (distance2dsquared(self.origin, player.origin) <= function_a3f6cdac(1000) && !isdefined(player.var_b1f1cfee)) {
                    player.var_b1f1cfee.player = 1;
...
function function_4be8796(instance) {
    ...
    if (isdefined(self.var_67aa3392) && !is_true(self.var_67aa3392.var_a325551c)) {
        ...
        namespace_1b527536::function_7281de4d(var_e05f8872, &function_94e78240, str_weapon, str_icon, 1, 6, 1);
    } else {
        var_5b5d9768 = isdefined(self.var_67aa3392.var_5b5d9768) ? self.var_67aa3392.var_5b5d9768 : 0;
        if (var_5b5d9768 >= 6) {
            namespace_1b527536::function_7281de4d(var_e05f8872, &function_94e78240, str_weapon, str_icon, 1, 6, 1);
        } else {
            namespace_1b527536::function_7281de4d(var_e05f8872, &function_94e78240, str_weapon, str_icon, 1, 6, 0);
...
function function_e1c4e1c2(ai_zombie) {
    if (isdefined(ai_zombie)) {
        ...
        } else if (ai_zombie.var_6f84b820 === #"special" || ai_zombie.var_6f84b820 === #"hash_72d4f2ad2e333eb4") {
            ai_zombie ai::stun(2);
        }
    }
}
...
function function_912eedf3(zombie) {
    ...
    if (isalive(zombie)) {
        ...
        if (namespace_7589cf5c::function_82e262cf(zombie.aitype)) {
            ...
            if (self flag::get(#"hash_35735a804a34da04")) {
                level scoreevents::doscoreeventcallback("scoreEventSR", {#enemy:zombie, #attacker:self, #scoreevent:"outbreak_mq_aether_bunny_kill_zm"});
            } else {
...
function function_320199e9() {
    ...
    } else if (isdefined(self.e_attacker) && isalive(self) && isdefined(n_dmg)) {
        if (self.e_attacker flag::get(#"hash_35735a804a34da04")) {
            if (self.var_6f84b820 === #"hash_72d4f2ad2e333eb4") {
                level scoreevents::doscoreeventcallback("scoreEventSR", {#enemy:self, #attacker:self.e_attacker, #scoreevent:"outbreak_mq_aether_bunny_elite_kill_zm"});
            } else if (self.var_6f84b820 === #"special") {
                level scoreevents::doscoreeventcallback("scoreEventSR", {#enemy:self, #attacker:self.e_attacker, #scoreevent:"outbreak_mq_aether_bunny_special_kill_zm"});
            }
        }
...
function function_eae9567f() {
    ...
    if (isdefined(self.var_1ac40948)) {
        ...
        self.var_1ac40948 scene::play(#"hash_3c1f6bee53f6bcc", "Shot 1", self.var_1ac40948);
    }
    self waittill(#"hash_3630518d6dc9aeda");
    wait(0.25);
    if (isdefined(self.var_1ac40948)) {
        self.var_1ac40948 playrumblelooponentity(#"hash_1903f70fddbadc53");
        self.var_1ac40948 scene::play(#"hash_3c1f6bee53f6bcc", "Shot 2", self.var_1ac40948);
    ...
    if (self.success) {
        ...
        if (isdefined(self.var_1ac40948)) {
            ...
            self.var_1ac40948 thread scene::play(#"hash_3c1f6bee53f6bcc", "Shot 4", self.var_1ac40948);
        }
        wait(4.5);
...
function function_2ea1510(var_7be19157) {
    ...
    while (1) {
        foreach (player in getplayers()) {
            if (isalive(player) && is_true(player.var_28107825)) {
                if (distance2dsquared(var_7be19157.origin, player.origin) <= function_a3f6cdac(300)) {
                    b_open_door = 1;
                }
            }
        }
    ...
    self.var_1ac40948 scene::play(#"hash_3c1f6bee53f6bcc", "Shot 3", self.var_1ac40948);
}
...
function function_d3122380(instance) {
    instance endon(#"objective_ended");
    instance thread namespace_f3a74bbc::start_timer(300, "retrieval");
...
function function_c8bfd10b(*str_team, e_player, b_result) {
    ...
    if (b_result) {
        ...
        if (isdefined(e_player)) {
            ...
            e_player.var_28107825.e_player = 0;
            e_player.var_4cd303ca.e_player = 1;
        ...
        s_pt = array::random(level.var_7d45d0d4.activeobjective.var_9a67455);
    } else if (isdefined(e_player) && is_true(e_player.var_28107825)) {
...
function function_f4562137(instance) {
    ...
    while (1) {
        foreach (player in getplayers()) {
            ...
            } else if (is_true(player.var_28107825)) {
...
function monitor_timer(instance) {
    ...
    while (1) {
        ...
        if (!var_42f3b393) {
            var_42f3b393 = 1;
            instance.var_5ff65676.instance = 1;
    ...
    if (isdefined(players) && players.size > 0) {
        instance.var_7a9e6505.instance = 1;
    }
    instance.var_5ff65676.instance = 0;
    namespace_f3a74bbc::objective_ended(instance, 0);
}
...
function function_6acbc957(instance) {
    ...
    self.var_3aee78d5 = spawn("trigger_radius_use", self.origin + vectorscale((0, 0, 1), 8), 0, 96, 96, 1);
            ...
            if (isdefined(s_spawnpt)) {
                ...
                if (isalive(ai_spawned)) {
                    ...
                    if (namespace_7589cf5c::function_82e262cf(ai_spawned.aitype)) {
                        instance.var_38c710c3.instance = float(gettime()) / 1000;
...
function function_b3791df9(*instance) {
    if (isdefined(level.var_7d45d0d4.activeobjective.n_zombies) && level.var_7d45d0d4.activeobjective.n_zombies > 0) {
        level.var_7d45d0d4.activeobjective.n_zombies--;
    }
}
        ...
        if (isdefined(s_pt)) {
            ...
            if (isdefined(ai_spawned)) {
                ...
                if (isalive(ai_spawned)) {
                    ...
                    ai_spawned.var_b4e37a30.ai_spawned = 1;
                    ai_spawned thread function_bf606a73();
                }
            }
        }
    ...
    while (1) {
        for (i = 0; i < n_spawns; i++) {
            ...
            if (isdefined(var_559503f1[i])) {
                ...
                if (isdefined(ai_spawned)) {
                    ai_spawned.var_a950813d.ai_spawned = 1;
                    ai_spawned.var_40e7d5fb.ai_spawned = &function_ec4c64fd;
                    if (namespace_7589cf5c::function_82e262cf(ai_spawned.aitype)) {
                        instance.var_38c710c3.instance = float(gettime()) / 1000;
                        instance.var_2133c784++;
                        instance.var_b803db9c++;
...
function function_20ab9060(instance) {
    ...
    while (1) {
        ...
        if (isdefined(e_activator) && isplayer(e_activator) && !is_true(e_activator.var_28107825) && !is_true(self.b_pickedup)) {
            ...
            player.var_28107825.player = 1;
            player.var_67aa3392.player = self;
            waitframe(1);
...
function function_40285fbe(instance) {
    ...
    self endon(#"disconnect", #"player_downed", #"hash_6d2d12b8afe43c8e");
    while (1) {
        if (distance2dsquared(instance.var_fe2612fe[#"hash_68d86d0667a9989b"][0].var_5ea363c.origin, self.origin) < function_a3f6cdac(100) && is_true(self.var_28107825)) {
...
function function_bd0bc40b(b_enabled) {
    if (b_enabled) {
        self val::set(#"hash_d4c54199ace78fb", "allow_jump", 0);
        self val::set(#"hash_d4c54199ace78fb", "allow_sprint", 0);
        self val::set(#"hash_d4c54199ace78fb", "allow_crouch", 0);
        self val::set(#"hash_d4c54199ace78fb", "allow_prone", 0);
        self setstance("stand");
        self thread function_e5c230e5();
    } else {
        self val::reset(#"hash_d4c54199ace78fb", "allow_jump");
        self val::reset(#"hash_d4c54199ace78fb", "allow_sprint");
        self val::reset(#"hash_d4c54199ace78fb", "allow_crouch");
        self val::reset(#"hash_d4c54199ace78fb", "allow_prone");
        self val::reset(#"hash_d4c54199ace78fb", "move_speed_scale");
...
function private function_e5c230e5() {
    ...
    if (getplayers().size < 2) {
        if (self namespace_e86ffa8::function_3623f9d1(0)) {
            self val::set(#"hash_d4c54199ace78fb", "move_speed_scale", 0.9);
        } else {
            self val::set(#"hash_d4c54199ace78fb", "move_speed_scale", 0.8);
        }
    } else if (self namespace_e86ffa8::function_3623f9d1(0)) {
        self val::set(#"hash_d4c54199ace78fb", "move_speed_scale", 0.85);
    } else {
        self val::set(#"hash_d4c54199ace78fb", "move_speed_scale", 0.7);
    }
}
...
function function_ec4c64fd(*goalpos) {
    ...
    if (isdefined(enemy)) {
        ...
        if (dist_sq > function_a3f6cdac(500)) {
            self.var_9b6bfdb7 = int(4 * 1000);
        }
        if (dist_sq > function_a3f6cdac(1000)) {
            self.var_7a6bf645 = 0;
            var_dc0be666 = abs(self.origin[2] - enemy.origin[2]);
            if (var_dc0be666 > 100) {
...
function function_fd68cae4() {
    if (self.archetype == #"zombie") {
        ...
        } else if (isdefined(self.var_b4e37a30) && level.var_b48509f9 > 4) {
...
function function_2d670ab2(instance) {
    instance endon(#"objective_ended");
    self endon(#"installed", #"hash_792ba50e25030040");
    while (1) {
        if (self.origin[2] < instance.origin[2] - 10000 && isdefined(self.e_owner) && !self.e_owner clientfield::get("phase_rift_player_fx")) {
            ...
            self notify(#"hash_792ba50e25030040");
        }
        wait(0.5);
    }
}
...
function function_eb9a0f67() {
    ...
    self endon(#"death");
    waitframe(1);
    if (self.vehicletype === #"hash_27e6a43b40abcdb") {
...
function function_6fd7f323() {
    ...
    if (!isdefined(v_ground)) {
        ...
        v_ground = groundtrace(v_pos + (10, 10, 50), v_pos + vectorscale((0, 0, -1), 15000), 1, self.e_owner)[#"position"];
    }
...
function function_44ae8976(instance, activator) {
    if (isplayer(activator)) {
        ...
        if (instance.targetname === #"hash_17f3ee07ca053ac8" || instance.targetname === #"hash_3b93357ae8f9a4e5" || instance.targetname === #"hash_c03d28393d74ee5" || instance.targetname === #"hash_1f8de1a22943c599" || instance.targetname === #"hash_20b26d60b0dab3a5" || instance.targetname === #"hash_2260053cb1b7c638" || instance.targetname === #"hash_b422045138dab00") {
        ...
        instance.n_max_zombies.instance = function_d583b222();
        wait(6);
        foreach (player in getplayers()) {
...
function function_9732fce6(v_position, v_angles, n_index) {
    ...
    e_canister.var_dd21aec2.e_canister = 1 & 16;
    return e_canister;
}
