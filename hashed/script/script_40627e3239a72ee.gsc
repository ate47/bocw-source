...
function function_8707f5e6(a_ents) {
    var_385ce850 = a_ents[#"hash_5efbc4a59aaed545"];
...
function function_32bed98f() {
    ...
    if (isdefined(var_44ff9e2) && var_44ff9e2.size != 0) {
        ...
        while (i < 2) {
            ...
            if (!is_true(var_fa962a4a.var_b7bf4ddb)) {
                var_fa962a4a.var_b7bf4ddb.var_fa962a4a = 1;
    ...
    if (isdefined(level.var_56e22cfa)) {
        level.var_56e22cfa zodcompanionutility::function_fc67b7ed(&function_954b2553);
    }
}
...
function function_8dc68d9c() {
    ...
    #/
    var_8c403460.var_67fbb89d.var_8c403460 = self;
...
function function_b546cde6(b_skipped) {
    ...
    var_10972b21.var_b9c671f.var_10972b21 = 1;
    var_9039575a = getent("klaus_upgrade_station", "targetname");
    var_9039575a.is_active.var_9039575a = 1;
    ...
    foreach (target_pos in var_1baed918) {
        ...
        if (target_pos.script_noteworthy == "screen_pos") {
            if (!isdefined(var_9039575a.var_2409a5e6)) {
                var_9039575a.var_2409a5e6.var_9039575a = [];
            } else if (!isarray(var_9039575a.var_2409a5e6)) {
                var_9039575a.var_2409a5e6.var_9039575a = array(var_9039575a.var_2409a5e6);
            }
    ...
    level flag::wait_till(#"hash_720384d338d58cf4");
    if (isdefined(level.var_56e22cfa)) {
        level.var_56e22cfa zodcompanionutility::function_fc67b7ed(&function_f0be2da6);
    }
...
function function_4675ef4e() {
    ...
    foreach (var_2551a4be in var_9039575a.var_2409a5e6) {
        var_2551a4be.mdl.var_2551a4be = util::spawn_model(#"hash_7879420ed766f842", var_9039575a gettagorigin("monitor_02_jnt"), var_9039575a gettagangles("monitor_02_jnt"));
        ...
        var_2551a4be.var_429cef67.var_2551a4be = util::spawn_model(#"hash_78793e0ed766f176", var_9039575a gettagorigin("monitor_01_jnt"), var_9039575a gettagangles("monitor_01_jnt"));
...
function function_47a1b8() {
    ...
    self.scriptmodel moveto(self.scriptmodel.origin + vectorscale((0, 0, -1), 30), 3);
...
// Size: 0x182
function function_e92a9ffd(params) {
    item = params.item;
    if (isplayer(self)) {
...
function function_c490ff56(params) {
    ...
    if (!isdefined(attacker.var_e941964e)) {
        attacker.var_e941964e.attacker = 0;
    }
...
function function_cefdd0d2() {
    ...
    if (level flag::get(#"hash_5503fb2f49e6a242")) {
        var_52dbcd71 = namespace_8d91c4fb::function_c5fed573([2:#"hash_73d5094f57c50194", 1:#"hash_2baee4267b0056b1", 0:#"hash_30f9f5fd3af0134a"], [2:#"hash_3cd3a276d7493ccb", 1:#"hash_21cafd0f13677a7a", 0:#"hash_6f9876f2c7047631"], [2:#"hash_4e0da8bc8fe2f61a", 1:#"hash_38f141943f84ad97", 0:#"hash_5bd603446f578b68"]);
        level zm_vo::function_7622cb70(var_52dbcd71);
    }
}
...
function function_54e9a43b(b_skipped, var_19e802fa) {
    if (b_skipped || var_19e802fa) {
        if (level flag::get(#"hash_720384d338d58cf4") && isdefined(level.var_56e22cfa)) {
            ...
            if (isdefined(level.var_56e22cfa.current_scene) && level.var_56e22cfa.current_scene == #"hash_e667b7bb5057190") {
...
function function_f0be2da6() {
    ...
    dis = distancesquared(level.var_56e22cfa.origin, var_9039575a.origin);
    if (dis <= function_a3f6cdac(200)) {
        if (!level flag::get(#"hash_2fea433a677a8531")) {
            return;
        }
        if (!level flag::get(#"hash_73b91a4076d8a5fd")) {
            level thread namespace_8d91c4fb::function_e250a72f(#"hash_73d461413df9b3af");
            return;
        }
        ...
        if (is_true(var_5a7117fb)) {
            ...
            level.var_56e22cfa scene::play(#"hash_423ce4528e7aaf1f", "upgrade_intro_" + level.var_7c745515, level.var_56e22cfa);
            level.var_56e22cfa thread scene::play(#"hash_423ce4528e7aaf1f", "upgrade_idle_" + level.var_7c745515, level.var_56e22cfa);
            ...
            if (!level flag::get(#"hash_30bd3fb769cba5e7")) {
                ...
                level.var_56e22cfa thread scene::play(#"hash_423ce4528e7aaf1f", "upgrade_loop_" + level.var_7c745515, level.var_56e22cfa);
                var_9039575a thread scene::play(#"hash_a4fed5bd30bd26b", "play1", var_9039575a);
                if (!is_true(level.var_3944a299)) {
                    level thread namespace_8d91c4fb::function_e250a72f(#"hash_1a1fbf7523691c89");
                ...
                level thread namespace_8d91c4fb::function_e250a72f(#"hash_604bbdfbecc2aa6a");
                level thread function_e243a545();
            } else {
                level.var_56e22cfa animation::stop();
                level.var_56e22cfa scene::play(#"hash_423ce4528e7aaf1f", "upgrade_outro_" + level.var_7c745515, level.var_56e22cfa);
                level flag::clear(#"hash_66eb1b5632f46da8");
                level.var_56e22cfa zodcompanionutility::function_633d6f7b();
                level.var_459ddb9c = 0;
                level.var_56e22cfa.var_fc6edf64 = 0;
                /#
                    iprintlnbold("<unknown string>");
                #/
            }
...
function function_d780da65() {
    ...
    wait(30);
    if (is_true(level.var_459ddb9c) && isdefined(level.var_56e22cfa)) {
        level.var_56e22cfa zodcompanionutility::function_633d6f7b();
        level.var_459ddb9c = 0;
        level.var_56e22cfa.var_fc6edf64 = 0;
        level.var_56e22cfa animation::stop();
...
function function_f26e6dd8() {
    ...
    var_9039575a.is_active.var_9039575a = 1;
    var_9039575a.var_b79a8ac7.var_9039575a = {#slots:slots, #var_f019ea1a:1500};
    level.attackables[level.attackables.size] = var_9039575a;
    var_9039575a.var_6332d14f.var_9039575a = spawn("trigger_damage", var_9039575a.origin + vectorscale((0, 0, 1), 20), 0, 64, 128);
    /#
        box(var_9039575a.origin + vectorscale((0, 0, 1), 20), (-32, -32, -64), (32, 32, 64), var_9039575a.angles, (1, 0, 0), 1, 0, 20000);
    #/
    level thread namespace_f3a74bbc::start_timer(60, "defend");
    var_9039575a thread function_4ffd09e4();
    var_9039575a thread function_b20e6cff();
    var_9039575a thread function_12f0e19b();
    zm_sq::function_266d66eb(#"hash_7a3926f32c4410eb", level.var_56e22cfa, 1, #"hash_3258f0b2a8184c64");
    if (isdefined(level.var_56e22cfa)) {
        level.var_56e22cfa clientfield::set("" + #"hash_3e4641a9ea00d061", 1);
    }
...
function function_4ffd09e4() {
    ...
    while (1) {
        ...
        if (!isplayer(result.attacker)) {
            ...
            if (var_f15d2e26 <= 0) {
                ...
                if (isdefined(level.var_56e22cfa)) {
                    level.var_56e22cfa.owner = undefined;
                    level.var_56e22cfa zodcompanionutility::function_34179e9a();
                }
                level.var_459ddb9c = 0;
                /#
                ...
                if (isdefined(level.var_56e22cfa)) {
                    zm_sq::function_53d0d99(#"hash_7a3926f32c4410eb", level.var_56e22cfa);
                    level.var_56e22cfa clientfield::set("" + #"hash_3e4641a9ea00d061", 0);
                }
                if (!is_true(level.var_3d8dc38a)) {
                    level thread namespace_8d91c4fb::function_e250a72f(#"hash_4d2fb45ce767e63b");
    ...
    self.var_6332d14f function_cb48cddd();
}
...
function function_b20e6cff() {
    ...
    level flag::clear(#"hash_7541a4f6c1968c49");
    if (isdefined(level.var_56e22cfa)) {
        origin = level.var_56e22cfa.origin;
        angles = level.var_56e22cfa.angles;
    } else {
        origin = self.origin;
        angles = self.angles;
    }
    ...
    wait(0.5);
    if (isdefined(level.var_56e22cfa)) {
        level.var_56e22cfa clientfield::set("" + #"hash_703543ca871a0f75", 0);
    }
    util::wait_network_frame();
    var_55033b92 show();
    var_55033b92 clientfield::set("" + #"hash_703543ca871a0f75", 1);
    if (isdefined(level.var_56e22cfa)) {
        level.var_56e22cfa hide();
    }
    wait(0.5);
    level thread namespace_1fc8f2e3::function_e8799ac6(self, 512);
    self scene::stop(#"hash_a4fed5bd30bd26b");
    level util::delay(1, "end_game", &namespace_8d91c4fb::function_e250a72f, #"hash_2b45e84695664cf0", var_55033b92);
    ...
    #/
    level.var_459ddb9c = 0;
    if (isdefined(level.var_56e22cfa.leader)) {
    ...
    if (isdefined(self.var_d42830e6)) {
        ...
        foreach (ai in self.var_d42830e6) {
            if (isdefined(ai.var_9664814c)) {
                ai.b_ignore_cleanup.ai = ai.var_9664814c;
            }
        }
    }
}
...
function function_2a26db52(var_c7498e44) {
    ...
    while (1) {
        ...
        if (self.var_d42830e6.size < var_c7498e44) {
            var_9e2396e0 = zm_utility::function_cce73165("tempest_location", "spawner_bo5_soa", zone_name);
            if (isdefined(var_9e2396e0)) {
                ...
                var_9e2396e0.var_9664814c.var_9e2396e0 = is_true(var_9e2396e0.b_ignore_cleanup);
                var_9e2396e0.b_ignore_cleanup.var_9e2396e0 = 1;
                if (!isdefined(self.var_d42830e6)) {
                    self.var_d42830e6 = [];
                } else if (!isarray(self.var_d42830e6)) {
                    self.var_d42830e6 = array(self.var_d42830e6);
                }
                if (!isinarray(self.var_d42830e6, var_9e2396e0)) {
                    self.var_d42830e6[self.var_d42830e6.size] = var_9e2396e0;
                }
...
function function_a07758b0(var_c7498e44) {
    ...
    while (1) {
        ...
        if (self.var_d42830e6.size < var_c7498e44) {
            ...
            var_9e2396e0 = zombie_utility::spawn_zombie(level.zombie_spawners[0], undefined, var_958f8634);
            if (isdefined(var_9e2396e0)) {
                var_9e2396e0.ignore_enemy_count.var_9e2396e0 = 1;
                var_9e2396e0.exclude_cleanup_adding_to_total.var_9e2396e0 = 1;
                var_9e2396e0.var_9664814c.var_9e2396e0 = is_true(var_9e2396e0.b_ignore_cleanup);
...
function function_954b2553() {
    ...
    foreach (var_fa962a4a in level.var_44ff9e2) {
        ...
        if (dis <= 64 && is_true(var_fa962a4a.is_active)) {
            if (!level flag::get(#"hash_75f07aed08b6bb5e") && is_true(level.var_fca351b8) && isdefined(level.var_56e22cfa)) {
                level.var_56e22cfa thread namespace_33c196c8::function_dec85954("zber_kvo_cmdint", 1);
            }
            if (level flag::get(#"hash_75f07aed08b6bb5e") && is_true(level.var_527966ee) && isdefined(level.var_56e22cfa)) {
                level.var_56e22cfa thread namespace_33c196c8::function_dec85954("zber_kvo_cmdint", 1);
            }
...
function function_52da09c5() {
    ...
    while (1) {
        ...
        if (isdefined(waitresult.attacker.archetype) && waitresult.attacker.archetype == #"zod_companion" && waitresult.mod === "MOD_MELEE") {
            if (isdefined(level.var_56e22cfa.attackable)) {
                /#
                    iprintlnbold("<unknown string>");
                #/
                playsoundatposition(#"hash_3a464371e80d6623", self.origin);
                namespace_85745671::function_2b925fa5(level.var_56e22cfa);
                ...
                if (!level flag::get(#"hash_75f07aed08b6bb5e")) {
                    ...
                    if (!is_true(level.var_fca351b8)) {
                        level thread namespace_8d91c4fb::function_e250a72f(#"hash_545f39f603f1d9a6", level.var_56e22cfa, 1);
                        level.var_fca351b8 = 1;
                    }
                    continue;
                }
                if (!is_true(level.var_527966ee)) {
                    level thread namespace_8d91c4fb::function_e250a72f(#"hash_6905fdcce2110659", level.var_56e22cfa, 1);
...
function function_7d8f4a5b() {
    ...
    while (!level flag::get(#"hash_6ee0214c0ffd7fd5")) {
        if (isdefined(level.var_56e22cfa)) {
            dis = distance(level.var_56e22cfa.origin, var_9039575a.origin);
...
function function_9d903a8e(index) {
    ...
    case 2:
        if (isdefined(level.var_56e22cfa)) {
            level.var_56e22cfa setmodel(#"hash_7735285cc1c952f5");
            level.var_56e22cfa clientfield::increment("" + #"hash_3d52751d686c4865", 1);
        }
        var_5fca83f = array::random([2:#"hash_5f245035b254c7b3", 1:#"hash_5f245135b254c966", 0:#"hash_5f245235b254cb19"]);
        level thread namespace_8d91c4fb::function_e250a72f(var_5fca83f);
        var_6c7ad44a = zm_vo::function_f577c17d(var_5fca83f);
        wait(var_6c7ad44a);
        break;
    case 3:
        if (isdefined(level.var_56e22cfa)) {
            level.var_56e22cfa setmodel(#"hash_40911bda0b473087");
            level.var_56e22cfa clientfield::increment("" + #"hash_3d52751d686c4865", 1);
        }
        var_5fca83f = array::random([2:#"hash_2f069b32ad079865", 1:#"hash_2f069832ad07934c", 0:#"hash_2f069932ad0794ff"]);
        level thread namespace_8d91c4fb::function_e250a72f(var_5fca83f);
        var_6c7ad44a = zm_vo::function_f577c17d(var_5fca83f);
        wait(var_6c7ad44a);
        break;
...
function function_e243a545() {
    ...
    if (isdefined(level.var_56e22cfa)) {
        level.var_56e22cfa animation::stop();
        if (!isdefined(level.var_56e22cfa.var_553d761a)) {
            level.var_56e22cfa.var_553d761a = 1;
        }
        switch (level.var_56e22cfa.var_553d761a) {
        case 1:
            level.var_56e22cfa setmodel(#"hash_47a239d0808fb616");
            level.var_56e22cfa clientfield::increment("" + #"hash_3d52751d686c4865", 1);
            level.var_56e22cfa.var_553d761a = 2;
            break;
        case 2:
            level.var_56e22cfa setmodel(#"hash_504743f1aedb0f41");
            level.var_56e22cfa clientfield::increment("" + #"hash_3d52751d686c4865", 1);
            level.var_56e22cfa.var_553d761a = 3;
            break;
        case 3:
            level.var_56e22cfa setmodel(#"hash_7735285cc1c952f5");
            level.var_56e22cfa clientfield::increment("" + #"hash_3d52751d686c4865", 1);
            level.var_56e22cfa.var_553d761a = 4;
            break;
        case 4:
            level.var_56e22cfa setmodel(#"hash_40911bda0b473087");
            level.var_56e22cfa clientfield::increment("" + #"hash_3d52751d686c4865", 1);
