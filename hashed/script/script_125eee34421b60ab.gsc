...
// Namespace namespace_b619101e/namespace_8df47e95
// Params 0, eflags: 0x1
// Checksum 0x8607ea88, Offset: 0xb60
// Size: 0x18c
function autoexec init() {
    function_c7bb75d5();
    spawner::add_archetype_spawn_function(#"hash_9f6bc1960ff4912", &function_fd79187b);
    spawner::add_archetype_spawn_function(#"hash_9f6bc1960ff4912", &namespace_eb2895::function_3113cf8f);
    spawner::function_89a2cd87(#"hash_9f6bc1960ff4912", &namespace_eb2895::function_ac64daa7);
    ...
    level.var_92e56a0f[#"hash_9f6bc1960ff4912"] = &namespace_eb2895::function_4c13b4e7;
}
...
function private function_f5cc7052(entity) {
    ...
    if (is_true(entity.var_10552fac) && !is_true(entity.var_72d96058)) {
        return 1;
    }
    return 0;
}
...
function private function_1c1bebef(entity) {
    ...
    target = function_bd4a79a(entity);
    if (!isdefined(target)) {
        return 0;
    }
    if (!is_true(entity.var_5c09e990)) {
...
function private function_46545247(entity, *asmstate) {
    if (isdefined(asmstate.var_417905cf) && isdefined(asmstate.var_3059ea5f) && is_true(asmstate.var_3059ea5f.var_2b605d6f) && asmstate.var_417905cf <= asmstate.var_3059ea5f.var_f4c2aef8) {
        asmstate.var_6d2f7ac8.asmstate = 1;
        return 4;
    }
...
function private function_20e100b4(entity, mocompanim, *mocompanimblendouttime, *mocompanimflag, *mocompduration) {
    ...
    if (is_true(mocompanimflag.var_1fa24724)) {
        target = function_bd4a79a(mocompanimflag);
    ...
    mocompanimflag.var_3059ea5f.mocompanimflag = {#var_eea3c0a6:getnotetracktimes(mocompduration, "raz_vulnerable_end")[0], #var_a0a74f78:getnotetracktimes(mocompduration, "raz_vulnerable_start")[0], #var_f4c2aef8:var_85c30cab, #var_2b605d6f:0};
}
...
function private function_67e66d54(entity) {
    ...
    entity.var_af9cbc1c.entity = gettime() + 3000;
}
...
function private function_4860f26d(var_ad2d46ff, var_e6e4425) {
    ...
    var_36dbf72a.var_90d59738.var_36dbf72a = 0;
    var_36dbf72a.var_a45c4e6.var_36dbf72a = self;
    ...
    var_36dbf72a.var_d4d27cb6.var_36dbf72a = 0;
...
function private function_8e224906(var_ad2d46ff) {
    ...
    while (isdefined(var_36dbf72a)) {
        if (!isdefined(var_ad2d46ff) || var_36dbf72a.var_90d59738 >= max_trail_iterations) {
            ...
            var_36dbf72a.var_90d59738.var_36dbf72a = var_36dbf72a.var_90d59738 + 1;
        }
        wait(0.1);
    }
}
...
function private function_f95c27a2(target) {
    ...
    while (isdefined(self)) {
        if (isdefined(target)) {
            ...
            self.var_d4d27cb6 = self.var_d4d27cb6 + 1;
...
function private function_ddf221f2(delay) {
    ...
    if (isdefined(self)) {
        ...
        if (isdefined(var_a45c4e6) && is_true(level.var_21b0396e)) {
            var_a45c4e6.var_af9cbc1c.var_a45c4e6 = gettime();
        }
        if (isdefined(self)) {
            self delete();
        }
...
// Namespace namespace_eb2895/namespace_8df47e95
// Params 0, eflags: 0x4
...
function private function_85b9ec36(inflictor, attacker, damage, *dflags, mod, weapon, *var_fd90b0bb, point, *dir, hitloc, *offsettime, boneindex, *modelindex) {
    ...
    if (entity flag::get("kill_hvt_teleporting")) {
        ...
        entity.var_6936b30b.entity = {#var_ebcff177:4, #weakpoint:weakpoint};
        return 0;
    }
    var_a70572a9 = 0.4;
    ...
    if (!isdefined(entity.var_a55d2294) && !is_true(entity.var_72d96058)) {
        entity.var_a55d2294.entity = gettime() + 60000;
    }
    var_ebcff177 = 1;
    ...
    self.var_6936b30b = {#var_ebcff177:var_ebcff177, #weakpoint:weakpoint};
    var_d58c98fd = 0;
    ...
    if (weakpoint.type === #"weakpoint") {
        ...
        if (namespace_81245006::function_f29756fe(weakpoint) === 1 && isdefined(weakpoint.var_f371ebb0)) {
            ...
            if (weakpoint.var_f371ebb0 == "right_arm_armor") {
                ...
                entity.var_417905cf.entity = weakpoint.health;
            } else {
...
function function_30df6d2b(entity) {
    ...
    entity.var_5ed30918.entity = gettime();
}
...
function function_afcd63e1(attacker, damage, point, damage_weapon, mod, inflictor) {
    entity = self;
    entity.var_417905cf.entity = 0;
    entity.var_5c09e990.entity = 0;
    entity.var_a55d2294 = undefined;
    entity.var_6f97029e.entity = 1;
    ...
    if (isdefined(damage)) {
        ...
        if (var_8b859118 >= self.health) {
            level scoreevents::doscoreeventcallback("scoreEventZM", {#scoreevent:"mangler_arm_cannon_kill_zm", #attacker:attacker});
        }
