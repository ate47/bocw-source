...
function function_f311bd4c(ai_zone, var_ee6563f8 = 1) {
    ...
    if (var_ee6563f8) {
        ...
        waitresult.attacker.waitresult = function_a1ef346b()[0];
    }
    ...
    if (isplayer(waitresult.attacker)) {
        ...
        var_b25650ab.origin.var_b25650ab = self.origin;
        var_b25650ab.archetype.var_b25650ab = self.archetype;
        if (isdefined(self.var_e575a1bb)) {
            var_b25650ab.var_e575a1bb.var_b25650ab = self.var_e575a1bb;
        }
        if (isdefined(self.var_40c895b9)) {
            var_b25650ab.var_40c895b9.var_b25650ab = self.var_40c895b9;
        }
        if (isdefined(self.var_e154425f)) {
            var_b25650ab.var_e154425f.var_b25650ab = self.var_e154425f;
        }
        if (isdefined(self.var_4f53e075)) {
            var_b25650ab.var_4f53e075.var_b25650ab = self.var_4f53e075;
        }
        if (isdefined(var_a98b31aa) || is_true(self.var_54f8158e)) {
            ...
            if (isdefined(self.var_2cee3556)) {
                var_b25650ab.var_2cee3556.var_b25650ab = self.var_2cee3556;
...
function private function_ebf83b77(origin, entity, var_c83b605b, var_da1bc9fc, max_range, attackable) {
    ...
    /#
        recordline(var_c83b605b, var_c83b605b + var_b042e906, (0, 0, 1), "<unknown string>");
...
function get_attackable_slot(entity) {
    ...
    if (is_true(strteleportst.on_navmesh)) {
        ...
        if (isdefined(var_acdc8d71)) {
            ...
            entity.var_b238ef38.entity = {#position:var_acdc8d71, #slot:strteleportst};
            return 1;
        }
    } else if (isdefined(strteleportst)) {
        strteleportst.entity = entity;
        entity.var_b238ef38.entity = {#position:strteleportst.origin, #slot:strteleportst};
        return 1;
    }
    return 0;
}
...
function clear_slots() {
    ...
    foreach (slot in self.var_b79a8ac7.slots) {
        ...
        } else if (is_true(slot.entity.missinglegs)) {
            slot.entity = undefined;
        }
    }
}
        ...
        if (isdefined(var_41c9f1a0) && var_41c9f1a0.size == 1) {
            foreach (var_41235e94 in var_41c9f1a0) {
                ...
                if (var_41235e94.type === #"mantle") {
                    if (var_b5e9434 && isdefined(var_41235e94.targetname)) {
                        var_6bf8a539 = getnodearray(var_41235e94.targetname, "target");
                        if (isdefined(var_6bf8a539) && var_6bf8a539.size == 1) {
                            return var_6bf8a539[0];
                        }
                    } else if (isdefined(var_41235e94.target)) {
                        var_6bf8a539 = getnodearray(var_41235e94.target, "targetname");
                        if (isdefined(var_6bf8a539) && var_6bf8a539.size == 1) {
                            return var_6bf8a539[0];
                        }
                    }
...
function function_b0dc6ff2(var_45e5ae09) {
    ...
    foreach (node in nodes) {
        ...
        if (isdefined(var_8d594927)) {
            var_8d594927.origin.var_8d594927 = var_59476739.origin;
            is_touching = 0;
            ...
            jumpiftrue(is_touching) LOC_00000274;
        } else {
        LOC_00000274:
...
function function_71578099() {
    ...
    foreach (node in nodes) {
        ...
        } else if (isdefined(node.var_597f08bf)) {
            linktraversal(node);
...
function function_1ede0cd3(var_521b1043, var_59476739, var_be10591b) {
    ...
    foreach (node in var_76648d30) {
        ...
        if (!isdefined(node.var_74785dff)) {
            node.var_74785dff.node = node.cost_modifier;
        }
        node.var_3e7103ff.node = isdefined(var_be10591b) ? var_be10591b : 1;
    }
    ...
    var_59476739.var_993e9bb0.var_59476739 = 1;
...
function function_a63a9610(*params) {
    ...
    foreach (node in self.var_fa527c6d) {
        ...
        node.cost_modifier.node = node.var_74785dff;
    }
}
...
function function_aa894590(*params) {
    ...
    foreach (node in self.var_fa527c6d) {
        ...
        node.cost_modifier.node = node.var_3e7103ff;
    }
}
...
function event_handler[event_9673dc9a] function_3981d015(eventstruct) {
    ...
    if (isdefined(eventstruct.ent.target) && eventstruct.ent.target != "") {
        ...
        if (isdefined(traversal_start_node)) {
            ...
            } else if (isdefined(getgametypesetting(#"hash_2d40f1434ed94a2b")) ? getgametypesetting(#"hash_2d40f1434ed94a2b") : 0) {
...
function function_d9a69cf2(origin, forward) {
    ...
    foreach (ent in var_8e1582ca) {
        if (!isdefined(forward) || vectordot(origin - ent.origin, forward) < 0) {
            ...
            ent.knockdown_type.ent = "knockdown_shoved";
        }
    }
}
...
function function_401070dd(vehicle, enemy = self.favoriteenemy) {
    ...
    if (var_65374bf9 > function_a3f6cdac(300)) {
...
function function_13d991c7(vehicle) {
    if (abs(vehicle getspeed()) > 100) {
        vehicle.var_30206623.vehicle = [3:[], 2:[], 1:[], 0:[]];
        return;
    }
    if (!isdefined(vehicle.var_a5b3bf1)) {
        vehicle.var_a5b3bf1.vehicle = vehicle.origin;
    }
    ...
    if (!isdefined(vehicle.var_74193f59)) {
        vehicle.var_74193f59.vehicle = -1;
    }
    if (gettime() > vehicle.var_74193f59) {
        vehicle.var_74193f59.vehicle = gettime() + 1000;
        for (list_index = 0; list_index < vehicle.var_30206623.size; list_index++) {
            function_1eaaceab(vehicle.var_30206623[list_index]);
        }
        vehicle.attack_spots = undefined;
    }
    if (distancesquared(vehicle.var_a5b3bf1, vehicle.origin) > function_a3f6cdac(var_d556ca21) || !isdefined(vehicle.attack_spots)) {
        vehicle.var_a5b3bf1.vehicle = vehicle.origin;
        ...
        vehicle.var_cef3270f.vehicle = [];
        vehicle.attack_spots.vehicle = [];
        vehicle.var_d9381ace.vehicle = [3:[], 2:[], 1:[], 0:[]];
        occupants = vehicle getvehoccupants();
        foreach (occupant in occupants) {
            var_3140b529 = vectorprojection(vehicle.origin - occupant.origin, var_35bc98c);
            var_c090ff87 = lengthsquared(var_3140b529);
            var_4e5e0fc4 = (occupant.origin[0], occupant.origin[1], vehicle.origin[2]) + var_3140b529;
            var_bc4c0533 = [1:var_4e5e0fc4 - var_35bc98c, 0:var_4e5e0fc4 + var_35bc98c];
            if (var_c090ff87 < function_a3f6cdac(var_11560bb5)) {
                if (var_c090ff87 > 2) {
        ...
        while (xx <= 1) {
            ...
            for (var_b93b4a7b = 0; var_b93b4a7b < var_e74e4ad9; var_b93b4a7b++) {
        ...
        while (yy <= 1) {
            ...
            for (var_b93b4a7b = 0; var_b93b4a7b < var_98185c02; var_b93b4a7b++) {
...
function private function_3c2e73c7(vehicle, spot, side, var_5c331674) {
    ...
    if (isdefined(var_4103e33e) && distancesquared(var_4103e33e.origin, spot) < function_a3f6cdac(30)) {
        return;
    }
    ...
    if (!isdefined(vehicle.attack_spots)) {
        ...
        vehicle.attack_spots.vehicle = array(vehicle.attack_spots);
    }
    ...
    if (is_true(var_5c331674)) {
        if (!isdefined(vehicle.var_cef3270f)) {
            ...
            vehicle.var_cef3270f.vehicle = array(vehicle.var_cef3270f);
        }
...
function private function_758df15d(vehicle, position) {
    ...
    var_a0a475e3 = function_5ea39be1(vehicle);
...
function private function_5ea39be1(vehicle) {
    ...
    return vehicle function_2a98d04f();
}
...
function custom_melee_fire() {
    ...
    if (isdefined(hitent) && hitent.team !== self.team) {
        ...
        if (abs(z_dist) < 24) {
            ...
            if (dist_sq < function_a3f6cdac(64)) {
...
function function_95c99579(player = self.enemy, var_5f5d262c = 0) {
    ...
    if (is_true(var_5f5d262c) && distancesquared(self getcentroid(), player geteye()) > function_a3f6cdac(self.meleeweapon.aimeleerange)) {
        return;
    }
...
function function_924c0c6f(attackable) {
    ...
    if (isdefined(var_8b4a973a)) {
        ...
        } else if (is_true(self.var_d003d23c)) {
            damage = int(145);
...
function function_68cc8bce(params) {
    ...
    turret.var_b79a8ac7.turret = {#slots:slots, #var_f019ea1a:500};
    turret.var_ba721a2c.turret = 20;
    if (!isdefined(level.attackables)) {
        level.attackables = [];
    }
    turret.is_active.turret = 1;
...
function function_cf065988(params) {
    ...
    cover.var_b79a8ac7.cover = {#slots:slots};
    cover.var_ba721a2c.cover = 1;
    cover.var_d83d7db3.cover = 100;
    if (!isdefined(level.attackables)) {
        level.attackables = [];
    }
...
function function_e441487e(vehicle) {
    var_496cfa10 = vehicle.origin + vehicle function_2c662f72();
    var_847f0ab4 = 15;
    var_f7ee0c3f = self getpathfindingradius() + var_847f0ab4;
                ...
                if (isalive(self) && !is_true(self.var_490b950e)) {
                    ...
                    if (isdefined(var_80730518)) {
                        ...
                        if (isdefined(v_forward) && !isdefined(var_80730518.b_launched)) {
                            var_80730518.b_launched.var_80730518 = 1;
                        ...
                        var_e95c8751 = params.idamage / (isdefined(self.maxhealth) ? self.maxhealth : 1);
                        if (var_e95c8751 >= 0.01 || self.var_6f84b820 === #"boss") {
                            if (var_e95c8751 > 2.4 || var_b35e868f) {
...
function function_dbf5bfd3(victim, damage) {
    ...
    var_496cfa10 = self.origin + self function_2c662f72();
...
function function_117ab176(victim) {
    ...
    victim.var_4ac8985e.victim = current_time + getdvarfloat(#"hash_6180fc224acfa00f", 250);
    ...
    victim.var_331c8e1b.victim = abs(anglestoup(self.angles)[2]);
    victim.var_b98d64dc.victim = self getvelocity()[2];
    victim.var_d8481de.victim = self.var_586465e4;
    /#
...
function function_3cfa8bfe(str_model, v_offset, v_ang, n_forward, n_scale) {
    ...
    if (isdefined(var_6d29abb0)) {
        wait(0.1);
        var_6d29abb0.health.var_6d29abb0 = int(self.health * 0.4);
...
function function_4c48a301(dynent) {
    ...
    if (var_144ce0a0 || dynent.destructible) {
        ...
        var_7f45fe8f = !is_true(bundle.dynentstates[state].var_b7401b42);
    }
    return var_7f45fe8f;
}
...
function function_9d3ad056(var_7ecdee63, v_origin, v_angles, str_name, var_c427317f = 1, var_1028910 = #"hash_5d96e8e3ed203968") {
    ...
    if (isdefined(ai_spawned)) {
        if (str_name === "kill_hvt_ai") {
            ai_spawned.var_c9b11cb3.ai_spawned = #"hash_1f92e0fae04824cd";
        ...
        if (isdefined(str_name) && !isinarray(level.var_d0c8ad06, hash(str_name))) {
            ai_spawned.var_921627ad.ai_spawned = 1;
        }
        if (ai_spawned.aitype === #"spawner_bo5_mimic" || ai_spawned.aitype === #"hash_4a900af3fc47cdd5") {
            ai_spawned.var_43c4bc66.ai_spawned = 1;
        }
        ai_spawned.var_a2f87939.ai_spawned = 3;
        return ai_spawned;
    }
}
...
function function_a31a41e8(entity, attackable) {
    ...
    if (!isdefined(attackable.var_76d60097)) {
        attackable.var_76d60097.attackable = [];
...
function function_744beb04(entity) {
    ...
    if (entity.team !== level.zombie_team || isdefined(entity.var_ff290a61) || isdefined(entity.enemy_override) || isdefined(entity.var_b238ef38) && !isdefined(entity.attackable)) {
        ...
        entity.attackable.entity = get_attackable(entity, 1, entity.var_c11b8a5a);
    }
}
...
function function_6b273d22(origin, var_1faf023a, outer_radius, inner_radius, var_b28b1642) {
    ...
    traceresult = physicstraceex(var_4323e3c9, var_acc2199d, vectorscale((-1, -1, 0), 15), (15, 15, 72));
    var_d1a33279 = traceresult[#"position"];
...
// Size: 0x222
function function_e4791424(origin, var_79d43d2f, height, outer_radius, inner_radius = 0, var_f0ee0fcd = 0, var_362d6269 = 1, var_632ad0e5 = 1) {
    level endon(#"game_ended");
    if (!isdefined(origin)) {
        return [];
    }
        ...
        while (!isdefined(var_a7a99675) && var_8b63a38e < 5) {
            ...
            if (isdefined(var_a7a99675)) {
                if (var_f0ee0fcd) {
                    ...
                    spawn_points[spawn_points.size] = {#angles:(0, var_6f386fda[1], 0), #origin:var_a7a99675};
                }
            } else {
                var_8b63a38e++;
            }
...
function function_5ba8b9d4(entity, var_21bdf069, dynent, var_f3fec032, dynentstate, var_144ce0a0) {
    ...
    if (function_d6eaf8b0(point - entity.origin) < var_21bdf069 && (entity.origin[2] <= dynent.origin[2] && var_6b2e7c97[2] >= dynent.origin[2] || entity.origin[2] <= dynent.var_34e210ee.var_b4daf97e && var_6b2e7c97[2] >= dynent.var_34e210ee.var_b4daf97e || entity.origin[2] >= dynent.origin[2] && var_6b2e7c97[2] <= dynent.var_34e210ee.var_b4daf97e)) {
        return 1;
    }
    return 0;
}
...
function function_dce54c8d(player, radius) {
    ...
    foreach (dynent in var_e86a4d9) {
        ...
        if (var_144ce0a0 || dynent.destructible) {
            ...
            var_f8ca59a8 = getentitiesinradius(dynent.var_34e210ee.center, dynent.var_34e210ee.var_48ff4b02 + 32, 15);
            if (!var_f8ca59a8.size) {
                continue;
            }
            bundle = isdefined(dynent.bundle) ? dynent.bundle : zm_utility::function_b42da08a(dynent);
            foreach (ai in var_f8ca59a8) {
                var_7f45fe8f = function_5ba8b9d4(ai, function_a3f6cdac(isdefined(ai.var_c50d964) ? ai.var_c50d964 : ai getpathfindingradius()), dynent, bundle, state, var_144ce0a0);
                if (var_7f45fe8f) {
                    entity = ai;
                    break;
                }
...
function function_844c8b88(dynent) {
    ...
    if (var_8c2f83ef[0] < var_8c2f83ef[1]) {
        ...
        var_d3ddd16e = dynent.origin + var_f712cb3c * -1 * var_cc87c802[1];
        var_8d59f800 = var_f712cb3c * var_8c2f83ef[1] / 2;
        /#
            recordstar(var_d3ddd16e, (0, 1, 0), "<unknown string>");
        #/
        end_point = var_d3ddd16e + var_8d59f800;
        start_point = var_d3ddd16e - var_8d59f800;
    } else {
        var_71dfc5d4 = anglestoforward(dynent.angles);
        var_8d59f800 = var_71dfc5d4 * var_8c2f83ef[0] / 2;
        var_d3ddd16e = dynent.origin + var_71dfc5d4 * var_cc87c802[0];
        /#
            recordstar(var_d3ddd16e, (1, 0.5, 0), "<unknown string>");
        #/
        end_point = var_d3ddd16e + var_8d59f800;
        start_point = var_d3ddd16e - var_8d59f800;
    }
    ...
    #/
    dynent.var_34e210ee.dynent = {#var_b4daf97e:dynent.origin[2] + var_8c2f83ef[2], #end_point:end_point, #start_point:start_point, #var_48ff4b02:max(var_8c2f83ef[2] / 4, distance(end_point, start_point)) / 2, #center:var_d3ddd16e + (0, 0, var_8c2f83ef[2] / 4)};
}
...
function function_ae04fa3e(origin, angles, targetname) {
    ...
    if (isdefined(ai_spawned)) {
        ai_spawned.var_c9b11cb3.ai_spawned = #"hash_5d96e8e3ed203968";
        ai_spawned thread function_2089690e();
        ai_spawned pathmode("move allowed");
        ai_spawned.completed_emerging_into_playable_area.ai_spawned = 1;
        ai_spawned.zombie_think_done.ai_spawned = 1;
    }
    return ai_spawned;
}
