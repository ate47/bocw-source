...
function event_handler[level_init] main(*eventstruct) {
    namespace_f3a74bbc::function_b3464a7c(#"hash_5afb912664f336f", undefined, &function_3b4a24e2, #"hash_5afb912664f336f", #"hash_550113857d521cf0", #"hash_7d1368d8d487beed", 4, #"hash_248bfcefe7e51481", &function_39eec401);
...
function function_3b4a24e2(instance) {
    ...
    if (!isdefined(var_3ec7083c.radius)) {
        var_3ec7083c.radius.var_3ec7083c = 2000;
    }
    if (!isdefined(var_3ec7083c.height)) {
        var_3ec7083c.height.var_3ec7083c = 500;
    }
    var_3ec7083c.radius.var_3ec7083c = int(var_3ec7083c.radius);
    var_3ec7083c.height.var_3ec7083c = int(var_3ec7083c.height);
    if (isdefined(level.var_26ed6a07)) {
        var_3ec7083c.radius.var_3ec7083c = level.var_26ed6a07;
    }
    if (isdefined(level.var_c86f12d4)) {
        var_3ec7083c.height.var_3ec7083c = level.var_c86f12d4;
    }
...
function private function_aee71618(var_3ec7083c) {
    ...
    s_interact.origin.s_interact = var_3ec7083c.origin;
    if (is_true(level.var_9cf56dcc)) {
        n_trigger_radius = 3000;
    } else {
        n_trigger_radius = 450;
    }
    level.var_fdcaf3a6.trigger = namespace_8b6a9d79::function_214737c7(s_interact, &function_39f35c4e, #"hash_1192710f818f1e47", undefined, n_trigger_radius, 400, undefined, (0, 0, 0));
...
function private function_3eef60e4(helicopter) {
    ...
    #/
    helicopter.rope.helicopter = util::spawn_anim_model(#"hash_508e38dfaf48d104", helicopter.origin);
    /#
        assert(isdefined(helicopter.rope));
    #/
...
function function_1913632(helicopter) {
    ...
    var_8e875f24.useweapon.var_8e875f24 = getweapon(#"hash_52ea38778c7d2fb3");
    var_8e875f24.var_dddda5d8.var_8e875f24 = 1;
    var_8e875f24.dontlinkplayertotrigger.var_8e875f24 = 1;
...
function function_7c255771() {
    var_3a8b4ddf = level.var_774aa859;
...
// Size: 0x694
function function_93ef48b(var_774aa859, helicopter) {
    if (!isdefined(var_774aa859) || !isalive(var_774aa859) || !isdefined(helicopter) || !isdefined(self)) {
        return;
    }
    helicopter endon(#"death");
    var_774aa859 val::set(#"hash_5afb912664f336f", "show_hud", 0);
    var_774aa859 dontinterpolate();
    var_774aa859 val::set(#"hash_5afb912664f336f", "disable_weapon_fire", 1);
    var_774aa859 val::set(#"hash_5afb912664f336f", "takedamage", 0);
    var_774aa859 val::set(#"hash_5afb912664f336f", "freezecontrols", 1);
    var_774aa859.oobdisabled.var_774aa859 = 1;
    var_867f5d0 = spawn("script_model", var_774aa859.origin);
    var_867f5d0.angles.var_867f5d0 = var_774aa859 getplayerangles();
    var_867f5d0 dontinterpolate();
    var_774aa859 playerlinkto(var_867f5d0, undefined, 0, 0, 0, 0, 0);
    var_2bf4050a = 0.6;
    var_d892ba80 = helicopter.rope gettagorigin("carabiner_jnt") + vectorscale((0, 0, 1), 825);
    var_de324c05 = 5;
    var_867f5d0 function_3b897a2(var_774aa859, var_d892ba80, var_de324c05, var_2bf4050a);
    waittillframeend();
    if (!isdefined(var_774aa859) || !isalive(var_774aa859) || !isdefined(var_867f5d0)) {
        return;
    }
    ...
    var_867f5d0.angles.var_867f5d0 = var_774aa859 getplayerangles();
    var_690d7869 = helicopter.angles[1] - 90;
    var_867f5d0 thread function_d914539a(var_690d7869);
    while (isdefined(var_867f5d0) && isalive(var_774aa859) && var_867f5d0.origin[2] < var_a080de98 && isdefined(helicopter.rope)) {
        var_443bf2ea = var_774aa859 gettagorigin("j_spineupper");
        var_70f8d8e1 = var_774aa859.origin - var_443bf2ea + var_de324c05 * anglestoforward(var_774aa859.angles);
        var_867f5d0.origin.var_867f5d0 = helicopter.rope gettagorigin("carabiner_jnt") + var_70f8d8e1 + vectorscale((0, 0, 1), 825);
        waitframe(1);
    }
    if (!isdefined(var_774aa859) || !isalive(var_774aa859) || !isdefined(var_867f5d0)) {
        return;
    ...
    var_774aa859 startcameratween(lerptime, 0, 0);
    var_774aa859 animation::play(#"hash_2021a3a93fd63eef", var_a3476af7, var_eb72be15, 1, 0, 0, lerptime, undefined, undefined, 1);
    waitframe(1);
    var_774aa859 val::set(#"hash_5afb912664f336f", "disable_weapon_fire", 0);
    helicopter usevehicle(var_774aa859, 2);
    var_9f3ffdb3 = 1;
    if (var_774aa859 hasweapon(level.var_fdcaf3a6.useweapon)) {
        var_774aa859 takeweapon(level.var_fdcaf3a6.useweapon);
    }
    ...
    var_774aa859 function_9e79b1b7();
}
...
// Size: 0x12e
function function_3b897a2(var_774aa859, var_d892ba80, var_10890b28, movetime) {
    self endon(#"death");
    endtime = gettime() + int(movetime * 1000);
    while (isdefined(self) && isalive(var_774aa859) && gettime() < endtime) {
        var_443bf2ea = var_774aa859 gettagorigin("j_spineupper");
        var_70f8d8e1 = var_774aa859.origin - var_443bf2ea + var_10890b28 * anglestoforward(var_774aa859.angles);
...
// Size: 0x1ac
function function_d914539a(var_690d7869) {
    self endon(#"death");
    var_ecaa456b = 1.9;
    var_9546359 = min(-75, self.angles[0]);
    var_64165cee = 0.6;
    var_44cf825 = math::clamp(var_64165cee / var_ecaa456b, 0, 1);
    var_bc4bc17d = anglelerp(self.angles[1], var_690d7869, var_44cf825);
    ...
    var_cbb558d8 = (var_3c4cc94a, var_690d7869, 0);
...
function function_17afb20e(b_success = 0) {
    ...
    /#
        if (getdvarint(#"hash_33b0be96bf3cd69a", 0) && level get(#"hash_23a3320be9d9bcbb")) {
...
function function_839b3d5a(var_48236d2c) {
    ...
    if (!is_true(level.var_921e6e85)) {
        level thread namespace_f3a74bbc::start_timer(n_time, "exfil");
        level thread function_c504b2d1();
        level thread function_8fcb0a(n_time);
    }
    var_48236d2c.var_4cdbc624.var_48236d2c = spawn("trigger_radius", var_48236d2c.origin - (0, 0, var_48236d2c.height), 0, var_48236d2c.radius, var_48236d2c.height * 2);
    if (zm_utility::is_classic()) {
        var_652c0aa1 = 0;
        while (!var_652c0aa1) {
            foreach (player in getplayers()) {
...
function function_31125f54() {
    ...
    if (b_success) {
        ...
        if (isdefined(level.var_8bb7479c)) {
            ...
            s_scene = spawnstruct();
            s_scene.origin.s_scene = level.var_117d5f10.origin;
            s_scene.angles.s_scene = level.var_117d5f10.angles;
            ...
            foreach (s_scene in a_s_scenes) {
                ...
                if (isdefined(str_scene) && isinarray(array(#"hash_5505d04b48e43a18", #"hash_58a2d842cde3bfdf"), str_scene)) {
        ...
        if (isdefined(level.var_72a3d8bc)) {
            ...
            foreach (s_scene in a_s_scenes) {
                str_scene = hash(s_scene.scriptbundlename);
                if (isdefined(str_scene) && isinarray(array(#"hash_50ba0a10051780b3", #"hash_7615f90f10ebb540"), str_scene)) {
    ...
    namespace_f3a74bbc::objective_ended(level.var_fdcaf3a6, b_success);
}
...
function function_a7394b94(b_success) {
    ...
    } else if (isdefined(level.var_f9d84559)) {
...
function onbeginuse(player) {
    ...
    var_19fee601 = isdefined(self.helicopter.rope) ? self.helicopter.rope gettagorigin("carabiner_jnt") + vectorscale((0, 0, 1), 825) : self.origin;
    var_690d7869 = function_2981bd91(var_19fee601 - player getplayercamerapos());
    var_8eef4f81 = absangleclamp180(playerangles[0] - var_a35cd71);
    var_9756b1d4 = absangleclamp180(playerangles[1] - var_690d7869);
    var_f4f58cca = 0.25;
    var_bd70ec3f = 0.75;
    ...
    level.var_a5030fa0 rotateto((var_a35cd71, var_690d7869, 0), var_7e42472f, var_7e42472f * 0.25, var_7e42472f * 0.25);
    level.var_774aa859 = player;
}
...
function onenduse(*team, player, success) {
    if (isdefined(level.var_a5030fa0)) {
        player unlink();
        if (success) {
            level.var_a5030fa0 function_cb48cddd();
...
function function_64df57fc(v_spawn, var_ca838126) {
    ...
    if (zm_utility::is_classic()) {
        ...
        if (is_true(level.var_7b24e6e4) && self === level.var_3c5bdfe7) {
            ...
            var_10ed23ba = level.var_fdcaf3a6.var_fe2612fe[#"smoke"][0];
    ...
    while (var_2eb61c8a.size && n_ai_count < var_ca838126) {
        ...
        if (var_4bf95f4c.var_990b33df == #"hash_1aff4b71635bda08" && getaiarchetypearray(#"avogadro").size > getplayers().size) {
            var_4bf95f4c.var_990b33df.var_4bf95f4c = #"hash_7cba8a05511ceedf";
        }
...
function function_4b115eba(struct) {
    if (!isdefined(struct.radius)) {
        struct.radius.struct = 1024;
    }
    if (!isdefined(struct.height)) {
        struct.height.struct = 256;
    }
    if (!isdefined(struct.var_9b178666)) {
        struct.var_9b178666.struct = 256;
    }
    if (!isdefined(struct.var_48d0f926)) {
        struct.var_48d0f926.struct = 64;
    }
    struct.radius.struct = int(struct.radius);
    struct.height.struct = int(struct.height);
    struct.var_9b178666.struct = int(struct.var_9b178666);
    struct.var_48d0f926.struct = int(struct.var_48d0f926);
...
function function_9feae843(var_fda8dff8) {
    ...
    level.var_fdcaf3a6.var_1961f29a = namespace_1481f2b::register();
    ...
    var_d6c33c06 = level.var_fdcaf3a6.var_fe2612fe[#"hash_67801799a6276af4"][0];
    ...
    foreach (s_spawn in var_bf2dd48a) {
        ...
        s_spawn.var_8789040f.s_spawn = 1;
        n++;
    }
    var_f39e9df9 = level.var_fdcaf3a6.var_fe2612fe[#"hash_436071c5a44303f3"][0];
    ...
    var_9cc58c14 = zm_utility::is_classic() || level.var_15d17eb2 !== 4 ? 0 : 1;
    i = 0;
    ...
    while (n_ai_count < var_560dcc36 && a_s_points.size) {
        ...
        if (var_9cc58c14 && var_4bf95f4c.var_29459a31 == #"hash_39b2df3c1e9f4a1") {
            var_82706add = array::random(array(#"hash_455ec8cc0d1ed4a4", #"hash_704a090ff9fcffd0"));
            b_force_spawn = 1;
            var_e532fd36 = 1;
        } else {
        ...
        if (is_true(s_spawn_point.var_8789040f) && (var_82706add == #"hash_455ec8cc0d1ed4a4" || var_82706add == #"hash_704a090ff9fcffd0" || var_82706add == #"hash_4f87aa2a203d37d0")) {
        ...
        if (isdefined(ai)) {
            ...
            b_force_spawn = 0;
            if (zm_utility::is_classic()) {
                if (ai.aitype == #"hash_455ec8cc0d1ed4a4") {
                    level.var_560dcc36 = level.var_560dcc36 + 2;
                    n_ai_count = n_ai_count + 2;
                }
                ai.var_126d7bef.ai = 1;
                ai.ignore_round_spawn_failsafe.ai = 1;
                ai.ignore_enemy_count.ai = 1;
                ai.b_ignore_cleanup.ai = 1;
                ai.var_d2e2380c.ai = s_spawn_point.origin;
                ai thread function_9e722b25("sprint");
                ai callback::function_dfd4b1a0(&function_98a1d2ef);
            }
            ai callback::function_d8abfc3d(#"on_ai_killed", &function_9974f649);
...
function function_5dd89100() {
    level flag::wait_till(#"hash_786370dfc67cac0e");
    if (level flag::get(#"exfil_cleared")) {
        return;
    }
    var_10ed23ba = level.var_fdcaf3a6.var_fe2612fe[#"smoke"][0];
    if (!isdefined(var_10ed23ba)) {
        var_10ed23ba = level.var_fdcaf3a6.var_fe2612fe[#"hash_216188a7e7b381a6"][0];
    }
...
function private function_a99586e3(b_show, n_remaining) {
    ...
    if (b_show) {
        if (!level.var_fdcaf3a6.var_1961f29a namespace_1481f2b::is_open(self)) {
            level.var_fdcaf3a6.var_1961f29a namespace_1481f2b::open(self, 1);
            waitframe(1);
            if (!isclass(level.var_fdcaf3a6.var_1961f29a) || !isplayer(self)) {
                return;
            }
            level.var_fdcaf3a6.var_1961f29a namespace_1481f2b::function_5d4dff63(self, n_remaining);
            level.var_fdcaf3a6.var_1961f29a namespace_1481f2b::set_x(self, int(10));
            level.var_fdcaf3a6.var_1961f29a namespace_1481f2b::set_y(self, int(26.6667));
            level.var_fdcaf3a6.var_1961f29a namespace_1481f2b::set_green(self, 1);
            level.var_fdcaf3a6.var_1961f29a namespace_1481f2b::set_blue(self, 1);
            level.var_fdcaf3a6.var_1961f29a namespace_1481f2b::set_red(self, 1);
            level.var_fdcaf3a6.var_1961f29a namespace_1481f2b::set_alpha(self, 0.75);
            level.var_fdcaf3a6.var_1961f29a namespace_1481f2b::set_horizontal_alignment(self, 1);
        } else {
            level.var_fdcaf3a6.var_1961f29a namespace_1481f2b::function_5d4dff63(self, n_remaining);
        }
    } else if (level.var_fdcaf3a6.var_1961f29a namespace_1481f2b::is_open(self)) {
        if (n_remaining === 0) {
            level.var_fdcaf3a6.var_1961f29a thread function_ac6aac5d(3, self);
            self function_3a488e53(1, 0);
        } else {
            level.var_fdcaf3a6.var_1961f29a namespace_1481f2b::close(self);
        }
    }
}
...
function private function_ac6aac5d(n_delay = 3, player) {
    wait(n_delay);
    if (isclass(self) && isplayer(player) && self namespace_1481f2b::is_open(player)) {
        self namespace_1481f2b::close(player);
    }
}
...
function function_7c05a985(destination) {
    ...
    if (!is_false(getgametypesetting(#"hash_7d1368d8d487beed")) || getdvarint(#"hash_33b0be96bf3cd69a", 0)) {
        var_fba4d9ea = function_5a957da0(destination);
        if (isdefined(var_fba4d9ea)) {
            namespace_8b6a9d79::function_20d7e9c7(var_fba4d9ea);
        }
        s_result = undefined;
...
function function_5a957da0(destination) {
    ...
    foreach (location in destination.locations) {
        ...
        foreach (instance in instances) {
            if (instance.var_b588b063 === #"hash_5afb912664f336f" && !is_true(instance.var_ea25c617)) {
    ...
    var_fba4d9ea = array::random(var_1dc01e72);
    if (!isdefined(var_fba4d9ea)) {
        var_fba4d9ea = var_60bfdf49;
    }
    return var_fba4d9ea;
}
...
function private function_39eec401(instance) {
    script = namespace_8b6a9d79::function_85255d0f(instance.var_b588b063);
    ...
    if (s_result._notify === #"hash_3e765c26047c9f54" || getdvarint(#"hash_33b0be96bf3cd69a", 0)) {
        namespace_f3a74bbc::function_3e365c4f(instance);
        if (isdefined(level.var_b2fde059)) {
            [[ level.var_b2fde059 ]](script.var_331b7cc3, instance.var_fe2612fe[#"hash_216188a7e7b381a6"][0].origin, instance);
        } else {
            namespace_f3a74bbc::function_9751c453(script.var_331b7cc3, instance.var_fe2612fe[#"hash_216188a7e7b381a6"][0].origin, instance);
        }
...
function function_5a22584f() {
    ...
    var_6afa034c = namespace_8b6a9d79::function_f3d93ee9(s_beacon, #"hash_615f17c2d8b69f96");
    ...
    while (1) {
        ...
        var_f354b9b2.dontlinkplayertotrigger.var_f354b9b2 = 1;
        var_f354b9b2.keepweapon.var_f354b9b2 = 1;
...
function onuse(player) {
    if (getgametypesetting(#"hash_704e4a94667cfe72")) {
        var_8e862768 = namespace_af5c1c0c::function_c65468ef(player, 1, #"hash_37a354c147ec32f0");
        if (!var_8e862768) {
            return;
        }
    }
...
function function_992dc59a() {
    namespace_af5c1c0c::function_3728d19b();
...
function on_ai_spawned() {
    ...
    switch (self.aitype) {
    case #"hash_12db1a8b34aa7918":
    case #"hash_5471f6916965b2d2":
        self.var_126d7bef = 1;
