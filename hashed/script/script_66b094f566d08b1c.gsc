...
function function_70a657d8() {
    ...
    /#
        ...
        if (getdvarint(#"hash_81a1e1ebb5f0bb0", 0)) {
            function_c484a9be(#"hash_48a412c1da6da338", 1);
        }
        if (getdvarint(#"hash_2fd6e98488cda073", 0)) {
            function_c484a9be(#"hash_569773895b461123", 1);
        }
        if (getdvarint(#"hash_c378501c97939f0", 0)) {
            function_c484a9be(#"hash_62df6469a6590d1c", 1);
        }
    ...
    namespace_8b6a9d79::function_b3464a7c(#"hash_1bbab84e45ad6ff", &function_3d415834);
    namespace_8b6a9d79::function_b3464a7c(#"hash_1f5e56ff4b3c50e2", &function_abb99222);
    namespace_8b6a9d79::function_b3464a7c(#"hash_59760e5c71e67b3f", &function_90b2fdc5);
    if (level flag::get(#"hash_24ee328d248f88de")) {
        namespace_f3a74bbc::function_b3464a7c(#"reveal", &function_7c583c30, &function_b6b9b6e6, #"ee", #"hash_b418b036831ea2a", #"hash_4fed85baf6c05ff1", 13, #"hash_4d343086d19c79e");
    }
    if (util::get_map_name() === "wz_forest") {
        level.var_a1e775a6[#"hash_5e28b761acc3ee26"][#"hash_750e6afed3998ca5"] = 1;
...
function function_3d415834(s_instance) {
    ...
    if (!level flag::get(#"hash_5d9bfa8fc70231e4") && !level flag::get(#"hash_3b46a8a050e7823e") && zm_utility::function_e3025ca5() >= 3 && !level flag::get(#"hash_4c9bb7a770c9e973")) {
        ...
        level thread namespace_e7ab676d::function_602f1c7e(s_instance);
        s_instance flag::wait_till("first_ambush_complete");
        var_628c4a3a = s_instance.var_628c4a3a;
        if (!isdefined(var_628c4a3a)) {
            return;
        }
        var_628c4a3a endon(#"death");
        var_628c4a3a thread zm_vo::function_d6f8bbd9(#"hash_2702967d33f4dadc", 1);
        ...
        case 1:
            var_628c4a3a zm_vo::function_d6f8bbd9(#"hash_6cb5ce936e173b1");
            wait(0.5);
            var_628c4a3a thread zm_vo::function_d6f8bbd9(#"hash_6cb5be936e171fe");
            break;
        case 2:
            var_628c4a3a zm_vo::function_d6f8bbd9(#"hash_10af694bf1804f26");
            wait(0.5);
            var_628c4a3a thread zm_vo::function_d6f8bbd9(#"hash_10af6a4bf18050d9");
            break;
        case 3:
            var_628c4a3a zm_vo::function_d6f8bbd9(#"hash_4fd9990138176447");
            wait(0.5);
            var_628c4a3a thread zm_vo::function_d6f8bbd9(#"hash_4fd9980138176294");
            break;
        }
    }
}
...
function function_719a87d4(s_params) {
    if (isplayer(self) && s_params.item.var_a6762160.name === #"hash_3e8182a0db7c62bd") {
        ...
        if (!level flag::get(#"hash_5d9bfa8fc70231e4")) {
            ...
            array::thread_all(getplayers(), &namespace_4abf1500::function_3ad8805e, #"hash_79d180cff88d66f7");
        }
    }
}
...
function function_57099652(*machine, *trigger) {
    ...
    if (!level flag::get(#"hash_5d9bfa8fc70231e4")) {
        ...
        level flag::set(#"hash_3b46a8a050e7823e");
        namespace_cf6efd05::function_c484a9be(#"hash_48a412c1da6da338", 1);
        for (i = 1; i < level.var_7d45d0d4.var_dc858a58.list.size; i++) {
            n_index = (level.var_7d45d0d4.var_dc858a58.index + i) % level.var_7d45d0d4.var_dc858a58.list.size;
            var_d6e8a7d6 = level.var_7d45d0d4.var_dc858a58.list[n_index];
        ...
        var_6afa034c = level.var_1ea1d494.scriptmodel;
        if (isdefined(var_6afa034c)) {
            var_6afa034c showpart("screen_calling_jnt");
...
function function_a9c9d2c9() {
    ...
    if (isdefined(var_6afa034c)) {
        var_6afa034c hidepart("screen_respond_jnt");
        var_6afa034c hidepart("screen_calling_jnt");
    }
}
...
function function_abb99222(s_instance) {
    ...
    foreach (var_e24a3dff in var_db9e2dd) {
        var_77cb4212 = namespace_8b6a9d79::function_f3d93ee9(var_e24a3dff, #"hash_2313390b260dd0bc", 0, 1);
        var_77cb4212.targetname.var_77cb4212 = "sr_ee_hulk_wild_thing";
        ...
        var_77cb4212.health.var_77cb4212 = 1;
    ...
    if (level flag::get(#"hash_3b46a8a050e7823e")) {
        ...
        foreach (var_4684f38d in var_2cc0d452) {
            ...
            var_bdba6915 = namespace_8b6a9d79::function_f3d93ee9(var_255f195e, #"hash_4265395ebd93303", 0, 0);
...
function function_33a937d1() {
    ...
    playsoundatposition(var_8f2bdcca, self.origin + vectorscale((0, 0, 1), 15));
    s_spawn = {#scriptmodel:self, #var_738dfc81:1, #angles:self.angles, #origin:self.origin};
...
function function_910ec836(s_params) {
    level endon(#"end_game");
    if (isplayer(self) && s_params.item.var_a6762160.name === #"hash_3e8173a0db7c4940") {
        callback::remove_callback(#"on_item_pickup", &function_910ec836);
        level flag::set(#"hash_12917a709be032ad");
        namespace_cf6efd05::function_c484a9be(#"hash_569773895b461123", 1);
        array::thread_all(getplayers(), &namespace_4abf1500::function_3ad8805e, #"hash_79d175cff88d5446");
        wait(1);
        switch (randomintrangeinclusive(1, 3)) {
        case 1:
...
function function_90b2fdc5(s_instance) {
    ...
    if (!level flag::get(#"hash_5d9bfa8fc70231e4") && level flag::get(#"hash_3b46a8a050e7823e") && !level flag::get(#"hash_24ee328d248f88de")) {
        ...
        s_rotate = s_instance.var_fe2612fe[#"rotate"][0];
        var_34f6451 = namespace_8b6a9d79::function_f3d93ee9(s_rotate, #"hash_57ffaf2f98a015ed");
        s_instance.var_34f6451 = var_34f6451;
        a_ents[#"hash_57fac357c7a82475"] = var_34f6451;
        var_34f6451 thread scene::play(#"hash_1adf1ed4ae576a63", "idle", a_ents);
        var_1cce6548 = isdefined(s_instance.var_fe2612fe[#"boost"]) ? s_instance.var_fe2612fe[#"boost"] : [];
        foreach (var_c968f2b7 in var_1cce6548) {
            namespace_8b6a9d79::function_f3d93ee9(var_c968f2b7, var_c968f2b7.model, 0, 0);
        }
        var_6ced8323 = s_instance.var_fe2612fe[#"display"][0];
        if (isdefined(var_6ced8323)) {
            var_7bbc6dd2 = namespace_8b6a9d79::function_f3d93ee9(var_6ced8323, #"hash_54b3253078e7d64f", 0, 0);
        ...
        foreach (s_blocker in a_s_blockers) {
            ...
            if (isdefined(str_model)) {
                mdl_clip = namespace_8b6a9d79::function_f3d93ee9(s_blocker, str_model, 1, 0);
        ...
        s_instance.var_838a2bd4.s_instance = 1;
        if (!isdefined(s_rotate.radius)) {
            s_rotate.radius.s_rotate = 128;
        }
        var_7aad4d7d = namespace_8b6a9d79::function_214737c7(s_rotate, &function_2474dfef, #"hash_4e99b18ff2ed2824");
...
function function_547ad6c7() {
    ...
    while (1) {
        ...
        if (isdefined(var_a1823f64)) {
            s_rotate = var_a1823f64.var_fe2612fe[#"rotate"][0];
    ...
    while (isdefined(s_rotate)) {
        if (distancesquared(self.origin, s_rotate.origin) <= function_a3f6cdac(256)) {
            if (!var_b7153b99) {
...
function function_3e5ee10c(s_instance, var_7aad4d7d) {
    ...
    if (!isdefined(s_instance.var_a13c1d4e)) {
        s_instance.var_a13c1d4e.s_instance = 0;
    }
    s_target = s_instance.var_fe2612fe[#"target"][0];
    if (!s_instance flag::get(#"hash_15691707aa357dfb")) {
        ...
        s_instance.mdl_target.s_instance = util::spawn_model(#"hash_413e6d8ec7666d41", v_origin, s_target.angles);
        ...
        a_ents[#"hash_57fac357c7a82475"] = var_34f6451;
        var_34f6451 scene::play(#"hash_1adf1ed4ae576a63", "advance_slide", a_ents);
        switch (var_838a2bd4) {
        case 1:
        ...
        if (var_838a2bd4 === 2 && !s_instance flag::get(#"hash_3e846c6fa4ba5194")) {
            ...
            array::thread_all(getplayers(), &namespace_4abf1500::function_3ad8805e, #"hash_4d8f76e48605627");
        }
...
function function_339079ec(s_instance) {
    ...
    if (!isdefined(mdl_fx)) {
        s_fx = s_instance.var_fe2612fe[#"fx"][0];
        if (isdefined(s_fx)) {
            mdl_fx = namespace_8b6a9d79::function_f3d93ee9(s_fx, #"tag_origin", 0, 0);
            playfxontag(#"hash_31b9905217e0bfe3", mdl_fx, "tag_origin");
            s_instance.mdl_fx = mdl_fx;
        }
    } else {
        mdl_fx.origin.mdl_fx = mdl_fx.origin + (0, 0, 2048);
    }
}
...
function function_7c583c30(s_instance) {
    ...
    var_d638e9df = s_instance.var_fe2612fe[#"hash_2efd4d191d95cde0"][0];
    s_instance.var_4cd68fa1.s_instance = namespace_8b6a9d79::function_f3d93ee9(var_d638e9df, #"collision_clip_wall_128x128x10", 0, 0);
    s_instance.var_4cd68fa1 notsolid();
    s_instance.var_4cd68fa1 ghost();
    /#
        if (getdvarint(#"hash_4fdce3a28f1397f2", 0)) {
            function_368a7cde();
            level delay(1, undefined, &function_9ad5aeb1, 0, 0, 1, 0);
            var_a8795e51 = s_instance.var_fe2612fe[#"debug"][0];
            var_cc88afe6 = var_a8795e51.var_fe2612fe[#"hash_6217ef2a3d7d895b"][0];
            function_744f2a2(var_cc88afe6, #"hash_6217ef2a3d7d895b", #"hash_6e47d6576612543c", #"hash_4af85251966549b8", #"hash_3eac5ec7a888ddfb", 0, &function_472f16d8);
            s_pap = var_a8795e51.var_fe2612fe[#"hash_448adaf187bbb953"][0];
            function_e0069640(s_pap);
            var_93696db0 = var_a8795e51.var_fe2612fe[#"hash_629e563c2ebf707a"][0];
            function_93a99046(var_93696db0);
            var_5cacd3c8 = var_a8795e51.var_fe2612fe[#"crafting_table"][0];
            function_db05041b(var_5cacd3c8, #"hash_1e1b751abcb0c5b6", &function_e3ad9f54);
            foreach (s_chest in isdefined(var_a8795e51.var_fe2612fe[#"chest"]) ? var_a8795e51.var_fe2612fe[#"chest"] : []) {
                s_chest.scriptmodel.s_chest = function_f3d93ee9(s_chest, #"hash_401a47741ffd646f", 1);
                s_chest.var_422ae63e.s_chest = #"hash_473df02427c669ff";
                s_chest.scriptmodel set("tag_light_red_03", 1);
                trigger = function_214737c7(s_chest, &function_e59605e3, #"hash_75724e383d531b42", undefined, 96, undefined, undefined, vectorscale((0, 0, 1), 16));
                trigger.struct = s_chest;
                trigger.var_cc1fb2d0.trigger = #"hash_628aa59cb422c20a";
                s_chest.var_738dfc81.s_chest = 4;
                s_chest.scriptmodel.trigger = trigger;
            }
            on_spawned(&function_a6006269);
            foreach (e_player in function_a1ef346b()) {
                e_player thread function_a6006269();
            }
            if (getdvarint(#"hash_4fdce3a28f1397f2", 0) >= 2) {
                s_instance.var_6c9943b1 = undefined;
                s_instance set(#"hash_70b6311d703afa2e");
                s_instance.var_4272a188 triggerenable(0);
                s_instance.var_4272a188.origin = s_instance.var_4272a188.origin - vectorscale((0, 0, 1), 2048);
                var_6bc2752 = s_instance.var_fe2612fe[#"hash_3b9643f64fe044bf"][0];
                objective_setposition(s_instance.var_e55c8b4e, var_6bc2752.origin);
                var_6bc2752.mdl_fx.var_6bc2752 = function_f3d93ee9(var_6bc2752, #"tag_origin");
                ...
                var_6bc2752.var_1490cdb5.var_6bc2752 = function_214737c7(var_6bc2752, &function_fd8dcbe8, #"hash_d5017e9a504063f");
    ...
    a_s_blockers = arraycopy(isdefined(s_instance.var_fe2612fe[#"blocker"]) ? s_instance.var_fe2612fe[#"blocker"] : []);
    s_exit = s_instance.var_fe2612fe[#"exit"][0];
    s_move = s_exit.var_fe2612fe[#"move"][0];
    ...
    foreach (s_blocker in a_s_blockers) {
        if (isdefined(s_blocker.model)) {
            ...
            if (isdefined(str_model)) {
                s_blocker.mdl_blocker.s_blocker = util::spawn_model(str_model, s_blocker.origin, s_blocker.angles);
                s_blocker.mdl_blocker disconnectpaths();
            }
        }
        if (!is_true(s_blocker.var_974d1fda)) {
            s_blocker.radius.s_blocker = float(isdefined(s_blocker.radius) ? s_blocker.radius : 60);
    ...
    var_2151fb35 = getentarray("battery_stair_exit_doors", "targetname");
    ...
    a_s_locations = level.var_7d45d0d4.var_49978223.locations;
    ...
    var_8424facf = s_instance.var_fe2612fe[#"hash_5eb2dab937ae128c"][0];
    while (1) {
...
function function_a0930644(s_instance) {
    ...
    var_bc256b43 = namespace_8b6a9d79::function_214737c7(var_8424facf, &function_6256ed77, #"hash_4d343086d19c79e");
    var_bc256b43.s_instance = s_instance;
    s_instance.var_ca4ed51d.s_instance = getent(var_8424facf.targetname, "target");
...
function function_4afbaee8() {
    ...
    var_ca4ed51d = level.var_a05ab6.var_ca4ed51d;
    while (!isdefined(var_ca4ed51d)) {
        waitframe(1);
        var_ca4ed51d = level.var_a05ab6.var_ca4ed51d;
    }
...
function function_f541a25f(s_instance) {
    level endon(#"end_game");
    var_d15706ed = s_instance.var_fe2612fe[#"hash_1b764530c070424a"][0];
    var_5f698d8a = isdefined(var_d15706ed.var_fe2612fe[#"hash_3affa4bad8c2ea58"]) ? var_d15706ed.var_fe2612fe[#"hash_3affa4bad8c2ea58"] : [];
    foreach (var_3f3f0752 in var_5f698d8a) {
        ...
        var_3f3f0752.a_s_spawns.var_3f3f0752 = s_result.data;
    }
    a_s_spawns = [];
    var_c5bb8329 = 0;
    while (!var_c5bb8329 && a_s_spawns.size < 32) {
        ...
        foreach (var_3f3f0752 in var_5f698d8a) {
            ...
            if (a_s_spawns.size <= 0) {
                ...
                if (var_3f3f0752 flag::get(#"hash_5c1c3d7c0b97a35e") || var_3f3f0752.a_s_spawns.size <= 0) {
                    var_3f3f0752 flag::set(#"hash_5c1c3d7c0b97a35e");
                } else {
                ...
                if (a_s_spawns.size < 32) {
                    var_c5bb8329 = 1;
                    foreach (var_3f3f0752 in var_5f698d8a) {
                        if (!var_3f3f0752 flag::get(#"hash_5c1c3d7c0b97a35e")) {
                            var_c5bb8329 = 0;
                            break;
                        }
                    }
                    ...
                    foreach (var_929141c6 in var_cb605fad) {
                        if (var_929141c6 === #"ee") {
                            if (isdefined(var_5207017.trigger)) {
                                var_5207017.trigger function_cb48cddd();
                            }
...
function function_b6b9b6e6(s_instance, e_player) {
    ...
    /#
        if (getdvarint(#"hash_4fdce3a28f1397f2", 0)) {
            ...
            if (isdefined(var_f3527953)) {
                function_bc5a54a8(var_f3527953.objectiveid);
            ...
            var_9e622804 = getent("aether_bolt_loop", "J_SpineLower_ribcage");
            if (isdefined(var_9e622804)) {
                function_bc5a54a8(var_9e622804.objectiveid);
                if (isdefined(var_9e622804.trigger)) {
                    var_9e622804.trigger delete();
                }
                var_9e622804 stop(1);
                if (isdefined(var_9e622804)) {
                    var_9e622804 delete();
            ...
            if (isdefined(var_185c6200)) {
                function_bc5a54a8(var_185c6200.objectiveid);
                if (isdefined(var_185c6200.trigger)) {
                    var_185c6200.trigger delete();
                }
                var_185c6200 set("<unknown string>" + #"hash_7dfc37315a4eff0", 0);
                var_185c6200 stop(1);
                if (isdefined(var_185c6200)) {
                    var_185c6200 thread delayed_delete(1);
                }
            }
            var_44aa636e = getent("<unknown string>", "J_SpineLower_ribcage");
            if (isdefined(var_44aa636e)) {
                function_bc5a54a8(var_44aa636e.objectiveid);
            ...
            foreach (s_chest in isdefined(var_a8795e51.var_fe2612fe[#"chest"]) ? var_a8795e51.var_fe2612fe[#"chest"] : []) {
                if (isdefined(s_chest.scriptmodel)) {
                    ...
                    s_chest.scriptmodel set("<unknown string>", 0);
                    s_chest.scriptmodel stop();
                    s_chest.scriptmodel thread delayed_delete(1);
                }
            }
        }
    #/
    level thread function_232a7f41(s_instance);
    ...
    var_3e1b52d5 = namespace_8b6a9d79::function_214737c7(s_lock, &function_a998b7a0, #"hash_52da8aeb6366964");
    var_3e1b52d5.s_instance = s_instance;
    var_f67ecd64 = namespace_8b6a9d79::function_f3d93ee9(s_lock, #"hash_51b155104fbf49b4", 0, 1);
    var_3e1b52d5.var_f67ecd64 = var_f67ecd64;
    var_f67ecd64 setscale(1);
    ...
    if (isdefined(var_234f6dad)) {
        ...
        if (isdefined(var_4ddbdbc3)) {
            var_4ddbdbc3 fx::play(#"hash_1cfdf032d66c0b66", var_4ddbdbc3.origin, var_4ddbdbc3.angles, #"hash_39217b78c4c579e0", 1);
        }
    ...
    wait(6);
    level thread zm_utility::function_9ad5aeb1(0, 0, 1, 0);
    var_a6d869eb = s_instance.var_fe2612fe[#"spawns"][0];
    ...
    if (!var_2d52e927) {
        ...
        foreach (e_player in getplayers()) {
            e_player.var_f4e33249.e_player = 1;
        }
    ...
    var_e6bc63a1 = isdefined(s_instance.var_fe2612fe[#"hash_52047b55dabccd4d"]) ? s_instance.var_fe2612fe[#"hash_52047b55dabccd4d"] : [];
    ...
    foreach (e_player in getplayers()) {
        ...
        e_player val::function_e681e68e(#"hash_220f72cafd2c6d4e");
    ...
    var_b4488d57 = s_instance.var_fe2612fe[#"hash_67e69d5e4a29c2bc"][0];
...
// Size: 0xe6
function function_232a7f41(s_instance) {
    level endon(#"end_game");
...
function function_78e620d(var_facb5099) {
    ...
    var_facb5099 clientfield::increment("" + #"hash_4974f4e39e6933fb");
    wait(1.9);
    var_facb5099 delete();
}
...
function function_dac9401e(var_234f6dad, var_4ddbdbc3) {
    ...
    if (isdefined(var_4ddbdbc3)) {
        var_4ddbdbc3 notify(#"hash_39217b78c4c579e0");
    }
    wait(2);
...
function function_dcb31940(s_instance, var_72aa02d6) {
    ...
    var_72aa02d6.var_de4a9f7a.var_72aa02d6 = 32;
    var_72aa02d6.a_ai_spawned[#"all"] = [];
    var_72aa02d6.a_s_points.var_72aa02d6 = [];
    var_72aa02d6.var_9bb9c9e4.var_72aa02d6 = 1;
    var_72aa02d6.var_cf0e49b5.var_72aa02d6 = 1;
    var_72aa02d6.var_566f9a11.var_72aa02d6 = 1250;
    var_72aa02d6.var_3c08dad2.var_72aa02d6 = 240;
    a_s_spawns = isdefined(var_72aa02d6.var_fe2612fe[#"spawn"]) ? var_72aa02d6.var_fe2612fe[#"spawn"] : [];
    foreach (s_spawn in a_s_spawns) {
        if (isstring(s_spawn.script_noteworthy) || ishash(s_spawn.script_noteworthy)) {
            if (!isdefined(s_spawn.var_1167c93b)) {
                s_spawn.var_1167c93b.s_spawn = 10;
            }
            s_spawn.var_1167c93b.s_spawn = int(s_spawn.var_1167c93b);
            if (!isdefined(s_spawn.var_48d0f926)) {
                s_spawn.var_48d0f926.s_spawn = 16;
            }
            s_spawn.var_48d0f926.s_spawn = float(s_spawn.var_48d0f926);
            if (!isdefined(s_spawn.radius)) {
                s_spawn.radius.s_spawn = 512;
            }
            s_spawn.radius.s_spawn = float(s_spawn.radius);
            if (!isdefined(s_spawn.inner_radius)) {
                s_spawn.inner_radius.s_spawn = 0;
            }
            s_spawn.inner_radius.s_spawn = float(s_spawn.inner_radius);
            if (!isdefined(s_spawn.ai_list)) {
                s_spawn.ai_list.s_spawn = #"hash_3d83273ceba16922";
            }
            s_spawn.ai_list.s_spawn = hash(s_spawn.ai_list);
            ...
            while (1) {
                a_s_points = namespace_85745671::function_e4791424(s_spawn.origin, s_spawn.var_1167c93b, s_spawn.var_48d0f926, s_spawn.radius, s_spawn.inner_radius);
            ...
            s_spawn.var_b5afe436.s_spawn = arraycopy(s_spawn.a_s_points);
            var_72aa02d6.a_s_points.var_72aa02d6 = arraycombine(var_72aa02d6.a_s_points, a_s_points);
            if (i + 1 < a_s_spawns.size) {
                waitframe(1);
            }
        }
    }
    var_72aa02d6.var_b5afe436.var_72aa02d6 = arraycopy(var_72aa02d6.a_s_points);
    ...
    if (!s_instance flag::get(#"hash_63d2c6d7441b2a9d")) {
        ...
        level thread function_c2a64e82(var_72aa02d6, #"hash_6d7a3f8353eb02fa", 6, #"hash_548eb59c00a7f6b0", 0, undefined, #"hash_18069beca0746715");
...
// Size: 0x770
function function_c2a64e82(var_72aa02d6, str_script_noteworthy, n_to_spawn = 0, var_ecec4136, b_respawn = 1, var_1610e59, var_d2301c77) {
    var_72aa02d6 endon(#"hash_48ede6eb3d3e0d03");
    if (isdefined(var_ecec4136)) {
        if (!isdefined(var_ecec4136)) {
            var_ecec4136 = [];
        } else if (!isarray(var_ecec4136)) {
            var_ecec4136 = array(var_ecec4136);
        }
        function_2699787c(var_72aa02d6, var_ecec4136);
    }
        ...
        if (isvec(s_point.origin)) {
            ...
            if (isvec(v_point)) {
                ...
                if (isdefined(var_7ecdee63)) {
                    ...
                    ai_zombie.var_4a44f930.ai_zombie = 1;
                    if (b_respawn) {
                        ai_zombie.var_43b32a98.ai_zombie = {#var_ecec4136:var_ecec4136, #str_script_noteworthy:str_script_noteworthy, #var_72aa02d6:var_72aa02d6};
...
function function_34bc84a1() {
    ...
    var_ecec4136 = self.var_43b32a98.var_ecec4136;
    if (isdefined(str_script_noteworthy) && isdefined(var_72aa02d6) && isdefined(var_ecec4136)) {
        level thread function_c4b8f0b5(var_72aa02d6, str_script_noteworthy, 1, var_ecec4136);
    }
}
...
// Size: 0x768
function function_c4b8f0b5(var_72aa02d6, str_script_noteworthy, n_spawns, var_ecec4136) {
    var_72aa02d6 endon(#"hash_48ede6eb3d3e0d03");
    ...
    var_8ecac684 = [];
    foreach (str_vol in var_ecec4136) {
    ...
    while (var_8ecac684.size > 0 && n_spawned < n_spawns) {
        n_chance = 50;
        var_e67eda13 = [1:300, 0:120];
        foreach (var_6d732cee in var_8ecac684) {
            if (function_5d499771(var_6d732cee)) {
                n_chance = 25;
                var_e67eda13 = [1:15, 0:5];
                break;
            }
        }
...
function function_a998b7a0(*s_params) {
    s_instance = self.s_instance;
    var_f67ecd64 = self.var_f67ecd64;
    if (isdefined(s_instance) && isdefined(var_f67ecd64)) {
        self triggerenable(0);
...
function function_35f83dc7(s_instance) {
    level endon(#"end_game");
    foreach (var_e145744b in isdefined(s_instance.var_fe2612fe[#"hash_6873efb1dfa0ebea"]) ? s_instance.var_fe2612fe[#"hash_6873efb1dfa0ebea"] : []) {
        var_e145744b.script_noteworthy.var_e145744b = "sr_ee_hulk_ammo";
    }
    ...
    var_cc88afe6 = s_instance.var_fe2612fe[#"hash_6217ef2a3d7d895b"][0];
    ...
    s_pap = s_instance.var_fe2612fe[#"hash_448adaf187bbb953"][0];
    ...
    var_93696db0 = s_instance.var_fe2612fe[#"hash_629e563c2ebf707a"][0];
    ...
    var_5cacd3c8 = s_instance.var_fe2612fe[#"crafting_table"][0];
                    ...
                    if (var_72aa02d6.a_ai_spawned[#"all"].size + 1 <= var_72aa02d6.var_de4a9f7a) {
                        ...
                        if (a_s_points.size > 0) {
                            ...
                            foreach (var_b24e337d in a_e_players) {
                                ...
                                var_e9e718bb = [];
                                foreach (s_option in a_s_options) {
                                    if (!isalive(e_player) || !isalive(var_b24e337d)) {
                                        var_e9e718bb = [];
                                        break;
                                    } else {
                                        if (distancesquared(s_option.origin, var_b24e337d.origin) <= function_a3f6cdac(var_72aa02d6.var_566f9a11)) {
                            ...
                            if (isalive(e_player) && a_s_options.size > 0) {
                                ...
                                foreach (var_f70b5c64 in var_ff3398c2) {
                                    if (!isalive(e_player)) {
                                        break;
                                    } else {
                                ...
                                if (isalive(e_player) && isvec(s_point.origin)) {
                                    var_6017f33e = namespace_679a22ba::function_ca209564(#"hash_1321156edea9acb6");
                                    var_7ecdee63 = var_6017f33e.var_990b33df;
                                    if (isdefined(var_7ecdee63)) {
                                        b_skip = 0;
                                        switch (var_7ecdee63) {
...
function function_7196f878() {
    ...
    if (isdefined(var_72aa02d6) && isdefined(s_point)) {
        ...
        n_time_left = var_72aa02d6.var_3c08dad2;
        while (n_time_left > 0) {
            s_waitresult = undefined;
            ...
            n_time_left = var_72aa02d6.var_3c08dad2 - (gettime() - var_8fc81e63) / 1000;
        }
...
function function_f9e72253() {
    ...
    var_72aa02d6.var_9bb9c9e4.var_72aa02d6 = 0.1;
    var_72aa02d6.var_566f9a11.var_72aa02d6 = 256;
    var_72aa02d6.var_3c08dad2.var_72aa02d6 = 15;
...
function function_78176be2() {
    ...
    self endon(#"death");
    self thread namespace_3f4c38e1::function_bf606a73();
}
...
function function_a988ea3e(s_instance) {
    s_instance.var_d674188d.s_instance = 0;
    ...
    var_5fa08c4c = isdefined(s_instance.var_fe2612fe[#"hash_7ad62b620b43fb92"]) ? s_instance.var_fe2612fe[#"hash_7ad62b620b43fb92"] : [];
    var_5fa08c4c = array::randomize(var_5fa08c4c);
    var_86095997 = [2:"tag_light_green_03", 1:"tag_light_green_02", 0:"tag_light_green_01"];
    var_3b3db690 = [2:"tag_light_red_03", 1:"tag_light_red_02", 0:"tag_light_red_01"];
    foreach (var_870db21a in var_5fa08c4c) {
        var_870db21a scene::init(#"hash_71e8399da1146c2d");
    ...
    wait(1);
    zm_sq::function_53d0d99(#"launch");
    zm_sq::function_266d66eb(#"hash_b418b036831ea2a", undefined, 0, #"hash_395f08b8fee17ae2", #"hash_7ad62b620b43fb92");
    while (!s_instance flag::get(#"hash_773bece3d13b68c6")) {
        ...
        s_instance.var_26830295.s_instance = 0;
        foreach (var_870db21a in var_5fa08c4c) {
            level thread function_ac90ef3b(s_instance, var_870db21a, i);
        }
        s_instance flag::wait_till_any([2:#"hash_773bece3d13b68c6", 1:#"hash_7d9d7effbda78197", 0:#"hash_67b34d86559a5e01"]);
        ...
        foreach (var_870db21a in var_5fa08c4c) {
            ...
            if (isdefined(var_446227c5)) {
                ...
                var_446227c5 function_cb48cddd();
            }
            var_e686af5f = var_870db21a.var_e686af5f;
            if (isdefined(var_e686af5f)) {
                var_e686af5f hidepart("tag_panel_key");
            }
            var_870db21a thread scene::play(#"hash_71e8399da1146c2d", "Shot 3");
        }
        function_f9e72253();
    ...
    zm_sq::function_53d0d99(#"hash_7ad62b620b43fb92");
}
    ...
    if (isdefined(str_key) && isdefined(s_instance)) {
        ...
        if (isdefined(var_72aa02d6)) {
            if (var_b1b3134b && s_instance.var_d674188d <= 0) {
                array::thread_all(getplayers(), &namespace_4abf1500::function_3ad8805e, #"hash_5b016d32d32756dc");
            }
            s_instance.var_d674188d++;
            var_72aa02d6 flag::set(#"hash_5497ada40bcd89dc");
            switch (s_instance.var_d674188d) {
            case 1:
                var_725cd9 = #"hash_3e23b75b1db9f2ae";
                break;
            case 2:
                var_725cd9 = #"hash_3e23b65b1db9f0fb";
                break;
            case 3:
                var_725cd9 = #"hash_3e23b55b1db9ef48";
                break;
            }
            if (isdefined(var_725cd9)) {
                level zm_sq::function_53d0d99(#"launch");
                level zm_sq::function_266d66eb(#"hash_b418b036831ea2a", undefined, 0, var_725cd9, #"launch");
            }
...
function function_40a5c1ad(s_instance) {
    var_72aa02d6 = s_instance.var_fe2612fe[#"hash_387f36c6f1c7201c"][0];
    ...
    if (isdefined(var_6ae3683f)) {
        var_72aa02d6.var_6ae3683f.var_72aa02d6 = util::spawn_model(#"hash_f93e1bf903e219b", var_6ae3683f.origin, var_6ae3683f.angles);
        var_6ae3683f delete();
        var_6ae3683f = var_72aa02d6.var_6ae3683f;
        var_6ae3683f.targetname.var_6ae3683f = "sr_ee_hulk_interest_fake";
        var_6ae3683f clientfield::set("" + #"hash_627fe6d726003b48", 1);
        var_6ae3683f function_619a5c20();
        var_6ae3683f thread scene::play(#"hash_784b53e0aaf6208d", "open", var_6ae3683f);
        ...
        var_6ae3683f scene::play(#"hash_784b53e0aaf6208d", "close", var_6ae3683f);
        var_6ae3683f stoploopsound();
        var_6ae3683f thread scene::play(#"hash_784b53e0aaf6208d", "shake", var_6ae3683f);
        ...
        point = function_4ba8fde(#"hash_5f4926e10db4922e");
        while (1) {
        ...
        var_c5124824.var_a84740ef.var_c5124824 = #"hash_387f36c6f1c7201c";
...
function function_93c5804e(var_72aa02d6, var_6ae3683f, var_c5124824) {
    ...
    var_72aa02d6 endon(#"hash_2539c648612d35ae");
    var_6ae3683f endon(#"death");
    var_6ae3683f val::set(#"hash_c1e17f10ed69973", "takedamage", 1);
    var_6ae3683f val::set(#"hash_c1e17f10ed69973", "allowdeath", 0);
    var_6ae3683f.health.var_6ae3683f = 1;
    while (1) {
        s_waitresult = undefined;
...
function function_1b3d1df9(var_72aa02d6, var_6ae3683f, var_c5124824) {
    if (!(isdefined(var_72aa02d6) && isdefined(var_6ae3683f)) || var_72aa02d6 flag::get(#"hash_2539c648612d35ae")) {
        return;
    }
    var_6ae3683f endon(#"death");
    var_72aa02d6 flag::set(#"hash_2539c648612d35ae");
    ...
    s_target = var_72aa02d6.var_99d7ebd5.var_fe2612fe[#"target"][0];
    if (isdefined(s_target) && isdefined(var_c5124824) && !ispointonnavmesh(var_6ae3683f.origin)) {
        ...
        if (isdefined(var_c5124824)) {
            ...
            var_c5124824.angles.var_c5124824 = (0, 0, 0);
        }
    }
}
...
function function_bc7dee45(s_instance, var_72aa02d6) {
    level endon(#"end_game");
    s_entry = {#item_name:#"hash_475c979a61c2afd8", #weapon_name:#"hash_2f22ef3b917ab0ac"};
    ...
    zm_perk_tombstone::function_7c589e7("tactical", #"hash_475c979a61c2afd8");
    weaponobjects::function_e6400478(#"hash_2f22ef3b917ab0ac", &function_376c3727, 1);
    var_7c00d5f4 = var_72aa02d6.var_fe2612fe[#"hash_c1e17f10ed69973"][0];
    var_41e9e0ba = namespace_8b6a9d79::function_f3d93ee9(var_7c00d5f4, #"hash_7b7cbb4eb2fd70e3", 0, 1);
    var_41e9e0ba.targetname.var_41e9e0ba = "sr_ee_hulk_interest";
    var_41e9e0ba clientfield::set("" + #"hash_627fe6d726003b48", 1);
    var_8df4fc4e = namespace_8b6a9d79::function_214737c7(var_7c00d5f4, &function_d65012f6, #"", undefined, 96);
    e_player = undefined;
    e_player = var_72aa02d6 waittill(#"hash_3179b6b06c73aeb");
    function_d8d0ca33(e_player);
    e_player thread namespace_1cc7b406::give_item(#"hash_475c979a61c2afd8");
    e_player function_bc82f900(#"hash_2319b62ab7b6b281");
    playsoundatposition(#"hash_2305a52eb0e9c5ae", var_41e9e0ba.origin);
    var_8df4fc4e delete();
    var_41e9e0ba delete();
    callback::on_item_pickup(&function_a003c2ad);
    array::thread_all(getplayers(), &namespace_4abf1500::function_3ad8805e, #"hash_5b017432d32762c1");
    wait(1);
...
function function_376c3727(s_watcher) {
    s_watcher.onspawn.s_watcher = &function_5394c6a7;
    s_watcher.onspawnretrievetriggers.s_watcher = &function_29c51453;
    s_watcher.ondamage.s_watcher = &function_29c51453;
    s_watcher.deleteonplayerspawn.s_watcher = 0;
    s_watcher.altdetonate.s_watcher = 1;
    s_watcher.var_e7ebbd38.s_watcher = &function_400e3e08;
}
...
function function_5394c6a7(*s_watcher, e_player) {
    ...
    if (isdefined(var_72aa02d6)) {
        ...
        var_72aa02d6.var_5894923f.var_72aa02d6 = self;
        ...
        var_be3a4990 = var_72aa02d6.var_be3a4990;
        if (!b_respawn) {
            var_72aa02d6.var_6ae3683f.var_72aa02d6 = util::spawn_model(#"hash_7b7cbb4eb2fd70e3", self.origin, self.angles);
            var_6ae3683f = var_72aa02d6.var_6ae3683f;
            var_6ae3683f.targetname.var_6ae3683f = "sr_ee_hulk_interest";
            var_6ae3683f clientfield::set("" + #"hash_627fe6d726003b48", 1);
            var_6ae3683f function_619a5c20();
...
function function_9aad773d(var_72aa02d6) {
    ...
    if (isdefined(var_5894923f)) {
        var_5894923f.var_864ea466.var_5894923f = 1;
...
function function_fb7ad62d(var_72aa02d6, var_6ae3683f, e_owner, n_delay = 0) {
    if (var_72aa02d6 flag::get(#"hash_28522ce8e79d8979")) {
        return;
    }
    var_72aa02d6 flag::set(#"hash_28522ce8e79d8979");
    level thread function_9aad773d(var_72aa02d6);
    function_122c5ee8(var_72aa02d6.var_d4455638);
    if (n_delay > 0) {
        wait(n_delay);
    ...
    if (isdefined(var_6ae3683f)) {
        ...
        var_6ae3683f function_cb48cddd();
    }
    var_72aa02d6 flag::wait_till_clear(#"hash_77426f69e3593d52");
    if (var_eddf0fe0 && isalive(e_owner)) {
        e_owner thread namespace_1cc7b406::give_item(#"hash_475c979a61c2afd8");
        e_owner function_bc82f900(#"hash_2319b62ab7b6b281");
    } else {
        point = function_4ba8fde(#"hash_475c979a61c2afd8");
        while (1) {
    ...
    var_72aa02d6 flag::clear(#"hash_28522ce8e79d8979");
}
...
function function_d0029986(var_72aa02d6, var_6ae3683f) {
    ...
    while (isdefined(var_6ae3683f)) {
        ...
        var_6ae3683f.angles.var_6ae3683f = var_6ae3683f.angles + (n_x, n_y, n_z);
        wait(0.1);
        var_6ae3683f.angles.var_6ae3683f = var_6ae3683f.angles - (n_x, n_y, n_z);
        wait(0.1);
    }
...
function function_400e3e08(*s_watcher) {
    var_72aa02d6 = level.var_df1e52ea;
    if (!isdefined(var_72aa02d6) || !var_72aa02d6 flag::get(#"hash_1c2f1b70dc486a32") || var_72aa02d6 flag::get_any([1:#"captured", 0:#"capturing"])) {
        return;
    }
    var_72aa02d6.var_d86e9c27.var_72aa02d6 = self;
...
function function_8d69e386(s_params) {
    if (s_params.item.var_a6762160.name === #"hash_475c979a61c2afd8") {
        function_d632f221(self);
    }
}
...
function function_a003c2ad(s_params) {
    ...
    self endon(#"death");
    var_72aa02d6 = level.var_df1e52ea;
    if (isdefined(var_72aa02d6) && isplayer(self) && s_params.item.var_a6762160.name === #"hash_475c979a61c2afd8") {
        function_122c5ee8(var_72aa02d6.var_d4455638);
...
function function_89e9be54(var_72aa02d6) {
    ...
    var_72aa02d6.var_be3a4990.var_72aa02d6 = util::spawn_model(#"hash_ffa046503bd02bb", vectorscale((0, 0, -1), 2048));
    var_be3a4990 = var_72aa02d6.var_be3a4990;
    var_be3a4990 hide();
    var_72aa02d6 flag::set(#"hash_4179f8deedc16aa6");
    var_3b1f8c3c = isdefined(var_72aa02d6.var_fe2612fe[#"hash_2657f4cc0d89eb6b"]) ? var_72aa02d6.var_fe2612fe[#"hash_2657f4cc0d89eb6b"] : [];
    ...
    while (1) {
        ...
        var_be3a4990.origin.var_be3a4990 = var_2c8c8f6d.origin;
        var_be3a4990.angles.var_be3a4990 = var_2c8c8f6d.angles;
        var_be3a4990 scene::stop();
        var_be3a4990 thread scene::play(#"hash_2dc577a7afb42228", "idle_02", var_be3a4990);
        ...
        if (isdefined(var_72aa02d6.var_dd7192a0)) {
            var_72aa02d6.var_dd7192a0 function_cb48cddd();
        }
        var_72aa02d6 flag::clear(#"hash_1c2f1b70dc486a32");
        ...
        if (var_72aa02d6 flag::get(#"shot")) {
            if (!var_72aa02d6 flag::get(#"hash_3b21c39f27324de2")) {
                var_72aa02d6 flag::set(#"hash_3b21c39f27324de2");
...
function function_52cca084(var_72aa02d6, var_2c8c8f6d, var_f1a01024 = 1) {
    ...
    level endon(#"end_game");
    var_72aa02d6 endon(#"hash_7b1b704f28df93c", #"hash_509179c663e9dec5", #"hash_1c2f1b70dc486a32");
    while (1) {
        var_72aa02d6.var_dd7192a0.var_72aa02d6 = spawncollision(#"hash_54ae3ca6346eae5f", "sr_ee_hulk_business_shoot", var_2c8c8f6d.origin, var_2c8c8f6d.angles);
        if (isdefined(var_72aa02d6.var_dd7192a0)) {
            break;
        }
        waitframe(1);
    ...
    var_dd7192a0.health.var_dd7192a0 = 1;
    while (1) {
        s_waitresult = undefined;
...
function function_c8680ef4(var_72aa02d6, var_be3a4990) {
    ...
    while (1) {
        ...
        var_72aa02d6 flag::clear(#"hash_4179f8deedc16aa6");
...
function function_9d647395(var_72aa02d6, var_be3a4990) {
    level endon(#"end_game");
    var_72aa02d6 endon(#"hash_4179f8deedc16aa6", #"hash_7b1b704f28df93c", #"hash_509179c663e9dec5", #"capturing");
    while (1) {
...
function function_235903f1(var_72aa02d6, var_be3a4990) {
    level endon(#"end_game");
    var_72aa02d6 endon(#"hash_4179f8deedc16aa6", #"hash_7b1b704f28df93c", #"capturing");
    while (1) {
        var_6ae3683f = var_72aa02d6.var_6ae3683f;
        while (!isdefined(var_6ae3683f)) {
            wait(1);
        ...
        if (var_72aa02d6 flag::get(#"hash_28522ce8e79d8979") || distance2dsquared(var_6ae3683f.origin, var_be3a4990.origin) > 65536 || distancesquared(var_6ae3683f.origin, var_be3a4990.origin) > 1048576) {
            while (var_72aa02d6.var_6ae3683f === var_6ae3683f) {
                wait(1);
            }
        } else {
            while (isdefined(var_6ae3683f) && !var_72aa02d6 flag::get(#"hash_28522ce8e79d8979")) {
                wait(3);
                if (!isdefined(var_6ae3683f) || var_72aa02d6 flag::get(#"hash_28522ce8e79d8979") || function_a1ef346b(undefined, var_6ae3683f.origin, 800).size <= 0) {
                    break;
                }
            }
            if (isdefined(var_6ae3683f) && !var_72aa02d6 flag::get(#"hash_28522ce8e79d8979")) {
                break;
            }
        }
    }
    var_72aa02d6 notify(#"hash_509179c663e9dec5");
    ...
    var_be3a4990 scene::stop();
    var_be3a4990 thread scene::play(#"hash_2dc577a7afb42228", "idle_01", var_be3a4990);
    ...
    while (!var_72aa02d6 flag::get(#"shot") && isdefined(var_6ae3683f) && !var_72aa02d6 flag::get(#"hash_28522ce8e79d8979") && function_a1ef346b(undefined, var_be3a4990.origin, 512).size <= 0) {
        waitframe(1);
    }
    if (isdefined(var_6ae3683f)) {
...
function function_c0e4c7fd(var_72aa02d6, str_suffix) {
    ...
    level endon(#"end_game");
    var_72aa02d6 endon(#"hash_7b1b704f28df93c", #"hash_509179c663e9dec5", #"capturing");
...
function function_4004453a(s_instance) {
    var_72aa02d6 = s_instance.var_fe2612fe[#"hash_1b764530c070424a"][0];
    level.var_11aeb779 = var_72aa02d6;
    s_instance flag::wait_till(#"hash_2d8528c8de39ead6");
    var_9fe8c6e9 = var_72aa02d6.var_fe2612fe[#"hash_1c9d6566f515a8d9"][0];
    point = function_4ba8fde(#"hash_5f4926e10db4922e");
    while (1) {
    ...
    var_dcdd09f2.var_a84740ef.var_dcdd09f2 = #"hash_3a303dbe20c8dc5e";
    var_dcdd09f2 ghost();
    ...
    var_72aa02d6.var_ee8ba96b.var_72aa02d6 = new throttle();
...
function function_e1e48820(var_72aa02d6) {
    ...
    a_props = [5:[1:44, 0:#"hash_4fe609f6bf03cb34"], 4:[1:0, 0:#"hash_524977d3bd147dc5"], 3:[1:13, 0:#"hash_506059b05eec63b5"], 2:[1:0, 0:#"hash_46fe557f2085d01d"], 1:[1:0, 0:#"p8_wz_skt_potted_plant_palm_square"], 0:[1:0, 0:#"hash_9033118463aa6a0"]];
    ...
    foreach (var_3f3f0752 in var_72aa02d6.var_5f698d8a) {
        ...
        if (!isdefined(var_72aa02d6.var_7c4ee138)) {
            var_72aa02d6.var_7c4ee138.var_72aa02d6 = [];
        } else if (!isarray(var_72aa02d6.var_7c4ee138)) {
            var_72aa02d6.var_7c4ee138.var_72aa02d6 = array(var_72aa02d6.var_7c4ee138);
        }
        ...
        if (isdefined(var_94a3a9c3) && isdefined(var_70cd2597)) {
            ...
            while (1) {
                mdl_prop.var_76e714be.mdl_prop = spawncollision(var_94a3a9c3, "sr_ee_hulk_eggshell_impact", var_5ecd510, v_angles);
...
function function_f9d3c90b(var_72aa02d6, mdl_prop) {
    ...
    if (isdefined(mdl_prop.var_76e714be)) {
        mdl_prop.var_76e714be function_cb48cddd();
    }
    ...
    ai_mimic.var_98f1f37c.ai_mimic = 1;
    ai_mimic.no_powerups.ai_mimic = 1;
...
function function_462478c5(var_72aa02d6, mdl_prop) {
    ...
    var_76e714be.health.var_76e714be = 1;
    while (1) {
        s_waitresult = undefined;
...
function function_cf0fb035(var_72aa02d6, ai_mimic, var_9fe8c6e9, e_player) {
    if (isalive(ai_mimic)) {
        ai_mimic.var_43c4bc66.ai_mimic = 1;
        ai_mimic.var_98f1f37c.ai_mimic = 1;
        ai_mimic.no_powerups.ai_mimic = 1;
    ...
    var_c5124824 playloopsound(#"hash_6979a0759dfa9cb3");
    var_c5124824.var_a84740ef.var_c5124824 = #"hash_1b764530c070424a";
    wait(1);
...
function function_f23a642e(s_instance) {
    var_72aa02d6 = s_instance.var_fe2612fe[#"hash_645bdb2b2ae769ef"][0];
    level.var_76978879 = var_72aa02d6;
    showmiscmodels("mdl_sr_ee_hulk_bio");
    var_758436f2 = var_72aa02d6.var_fe2612fe[#"harvester"][0];
    var_758436f2 scene::init(#"hash_2651ad878bcd1698");
    var_72aa02d6.var_b3fb5814.var_72aa02d6 = var_758436f2.scene_ents[#"prop 1"];
    var_b3fb5814 = var_72aa02d6.var_b3fb5814;
    var_b3fb5814.targetname.var_b3fb5814 = "retrieval_case";
    var_b3fb5814 function_619a5c20();
    var_b3fb5814 hidepart("p9_sur_console_control_01_canister_jnt", "", 1);
    var_72aa02d6.var_57e77903.var_72aa02d6 = util::spawn_model(#"hash_5f27ef95924c1c11", var_b3fb5814 gettagorigin("p9_sur_console_control_01_canister_jnt"), var_b3fb5814 gettagangles("p9_sur_console_control_01_canister_jnt"));
    var_57e77903 = var_72aa02d6.var_57e77903;
    var_57e77903 linkto(var_b3fb5814, "p9_sur_console_control_01_canister_jnt");
    var_57e77903.targetname.var_57e77903 = "retrieval_component";
    s_instance flag::wait_till(#"hash_2d8528c8de39ead6");
    var_72aa02d6.var_7b89742f.var_72aa02d6 = [3:#"hash_3c0c34f3b4b010ac", 2:#"hash_3c0c33f3b4b00ef9", 1:#"hash_3c0c32f3b4b00d46", 0:#"hash_3c0c31f3b4b00b93"];
    var_72aa02d6.var_410f8136.var_72aa02d6 = [2:#"hash_1f8bcd4811f504fe", 1:#"hash_1f8bce4811f506b1", 0:#"hash_1f8bcb4811f50198"];
    var_72aa02d6.var_500b8b0e.var_72aa02d6 = 0;
    callback::on_item_pickup(&function_1c632454);
    var_72aa02d6.var_57294bb7.var_72aa02d6 = new throttle();
    [[ var_72aa02d6.var_57294bb7 ]]->initialize(1, float(function_60d95f53()) / 1000);
    foreach (var_eef0aa31 in isdefined(var_72aa02d6.var_fe2612fe[#"chunk"]) ? var_72aa02d6.var_fe2612fe[#"chunk"] : []) {
    ...
    var_76380b53 = [];
    foreach (var_86cb7d9d in isdefined(var_72aa02d6.var_fe2612fe[#"hash_1e44c1b277401c68"]) ? var_72aa02d6.var_fe2612fe[#"hash_1e44c1b277401c68"] : []) {
        ...
        if (isdefined(var_8c420570)) {
            ...
            mdl_body.var_a0d60ae6.mdl_body = 1;
            ...
            s_key = var_86cb7d9d.var_fe2612fe[#"key"][0];
            if (isdefined(s_key)) {
    ...
    var_bb5d660 = [];
    foreach (var_8b24e6f6 in isdefined(var_72aa02d6.var_fe2612fe[#"hash_7902df85ef85a95e"]) ? var_72aa02d6.var_fe2612fe[#"hash_7902df85ef85a95e"] : []) {
    ...
    var_1b32f535 = namespace_8b6a9d79::function_214737c7(var_758436f2, &function_3e1d8ff2, #"hash_110f0b36c2354f6b", undefined, 96, 128);
    e_player = undefined;
    ...
    var_758436f2 scene::play(#"hash_2651ad878bcd1698");
    var_72aa02d6.var_8cd815ff.var_72aa02d6 = isdefined(var_72aa02d6.var_fe2612fe[#"attack"]) ? var_72aa02d6.var_fe2612fe[#"attack"] : [];
    if (!isdefined(var_72aa02d6.var_8cd815ff)) {
        var_72aa02d6.var_8cd815ff.var_72aa02d6 = [];
    } else if (!isarray(var_72aa02d6.var_8cd815ff)) {
        var_72aa02d6.var_8cd815ff.var_72aa02d6 = array(var_72aa02d6.var_8cd815ff);
    }
    var_72aa02d6.var_8cd815ff[var_72aa02d6.var_8cd815ff.size] = var_72aa02d6.var_fe2612fe[#"hash_1a3f74e8ce5e3516"][0];
    var_72aa02d6.var_6ac71323.var_72aa02d6 = arraycopy(var_72aa02d6.var_8cd815ff);
    var_72aa02d6.var_2e66fa35.var_72aa02d6 = 10;
    while (!var_72aa02d6 flag::get(#"hash_5497ada40bcd89dc")) {
        ...
        var_72aa02d6.var_1edd9ca5.var_72aa02d6 = 0;
        var_72aa02d6.var_7f8115b4.var_72aa02d6 = 3;
        var_72aa02d6.var_13c74181.var_72aa02d6 = [];
        level thread function_6f1cb9c7(var_72aa02d6, var_57e77903, var_b3fb5814);
        var_c4da9e10 = namespace_8b6a9d79::function_214737c7(var_758436f2, &function_6f4eb6d, #"", undefined, 96);
        ...
        playfxontag(#"hash_307f5336775791b2", mdl_fx, "tag_origin");
        ...
        mdl_fx delete();
        var_3c5d6dd8 = var_b3fb5814.origin + vectorscale((0, 0, 1), 32);
        playfx(#"hash_21de711a73de2b60", var_3c5d6dd8, vectorscale((1, 0, 0), 180));
        ...
        var_b3fb5814 thread namespace_3f4c38e1::function_62801b2f();
        function_42cf5b78();
        wait(3);
        var_57e77903 playloopsound(#"hash_3432d05cab6568b1");
        var_57e77903 setmodel(#"hash_7705d4f7da40daeb");
        var_57e77903 fx::play(#"hash_78ccda06d1fbc32d", var_57e77903.origin, var_57e77903.angles, #"hash_ffb63905e695382", 1, "tag_origin");
        function_b9462694(1, var_72aa02d6, var_57e77903, var_b3fb5814);
        var_a168912c = namespace_8b6a9d79::function_214737c7(var_758436f2, &function_e424e2c2, #"hash_c90fb1f338973f7", undefined, 96);
        e_player = undefined;
        ...
        var_72aa02d6 flag::wait_till_any([1:#"hash_34afd8621dc9a226", 0:#"hash_5497ada40bcd89dc"]);
        if (!var_72aa02d6 flag::get(#"hash_5497ada40bcd89dc")) {
            ...
            var_57e77903.origin.var_57e77903 = var_b3fb5814 gettagorigin("p9_sur_console_control_01_canister_jnt");
            var_57e77903.angles.var_57e77903 = var_b3fb5814 gettagangles("p9_sur_console_control_01_canister_jnt");
...
function function_1c632454(s_params) {
    var_72aa02d6 = level.var_76978879;
    if (s_params.item.var_a6762160.name === #"hash_7042f7f32793baf1" && isdefined(var_72aa02d6.var_500b8b0e)) {
        var_72aa02d6.var_500b8b0e++;
        if (!var_72aa02d6 flag::get(#"hash_7819a87bca8c3e53")) {
            var_72aa02d6 flag::set(#"hash_7819a87bca8c3e53");
            array::thread_all(getplayers(), &namespace_4abf1500::function_3ad8805e, #"hash_7fab85a989fd158");
            wait(1);
...
function function_bd97d87e(var_72aa02d6, var_eef0aa31) {
    ...
    while (!var_72aa02d6 flag::get(#"hash_5497ada40bcd89dc")) {
        ...
        s_target = var_eef0aa31.var_fe2612fe[#"target"][0];
        ...
        if (!var_56f340c4 || var_72aa02d6 flag::get(#"hash_5497ada40bcd89dc")) {
            ...
            var_e8b254f5 = {#var_738dfc81:1, #angles:v_angles, #origin:v_origin};
            while (1) {
            ...
            point = function_4ba8fde(#"hash_7042f7f32793baf1");
            while (1) {
        ...
        if (isdefined(s_target)) {
            ...
            wait(var_fd6264f6);
            if (isdefined(var_f3c7bdd)) {
                var_f3c7bdd.origin.var_f3c7bdd = s_target.origin;
            }
        }
        if (var_56f340c4) {
...
function function_855284ee(var_72aa02d6, mdl_body, s_key) {
    ...
    var_c5124824.var_a84740ef.var_c5124824 = #"hash_645bdb2b2ae769ef";
    var_c5124824.origin.var_c5124824 = s_key.origin;
    var_c5124824.angles.var_c5124824 = s_key.angles;
    ...
    foreach (e_player in function_a1ef346b()) {
        if (!isdefined(var_c5124824.var_699c6bfb)) {
            var_c5124824.var_699c6bfb.var_c5124824 = [];
        } else if (!isarray(var_c5124824.var_699c6bfb)) {
            var_c5124824.var_699c6bfb.var_c5124824 = array(var_c5124824.var_699c6bfb);
        }
...
function function_6f1cb9c7(var_72aa02d6, var_57e77903, var_b3fb5814) {
    ...
    for (var_5d3eb138 = 0; var_5d3eb138 < 5; var_5d3eb138++) {
        for (n_row = 0; n_row < 4; n_row++) {
            ...
            if (n_row == 3) {
                var_8a4df751 = var_8a4df751 + randomfloatrange(-0.5, 0);
            } else if (n_row == 1) {
                var_8a4df751 = var_8a4df751 + randomfloat(1);
            } else {
                var_8a4df751 = var_8a4df751 + randomfloatrange(-0.5, 1);
            }
            var_56527466 = v_center + v_up * var_8a4df751;
            n_offset = randomfloatrange(1.8, 2.5);
            switch (var_5d3eb138) {
            case 1:
                var_56527466 = var_56527466 + v_forward * n_offset;
                break;
            case 2:
                var_56527466 = var_56527466 - v_forward * n_offset;
                break;
            case 3:
                var_56527466 = var_56527466 + v_right * n_offset;
                break;
            case 4:
                var_56527466 = var_56527466 - v_right * n_offset;
                break;
    ...
    var_2e69c597 = arraysortclosest(var_2e69c597, v_center + vectorscale((0, 0, 1), 8));
    var_32ef70a6 = [];
    b_up = math::cointoss();
    var_290cd1dd = 0;
    while (var_2e69c597.size > 0) {
...
function function_72e54417(var_72aa02d6, var_eef0aa31, b_up) {
    ...
    var_3128fb28 = util::spawn_model(#"hash_54162eaf6dc466b9", var_eef0aa31.origin);
    if (!isdefined(var_72aa02d6.var_13c74181)) {
        var_72aa02d6.var_13c74181.var_72aa02d6 = [];
    } else if (!isarray(var_72aa02d6.var_13c74181)) {
        var_72aa02d6.var_13c74181.var_72aa02d6 = array(var_72aa02d6.var_13c74181);
    }
    var_72aa02d6.var_13c74181[var_72aa02d6.var_13c74181.size] = var_3128fb28;
    var_3128fb28 setscale(0.2);
    v_dir = (0, 0, 1);
    if (!b_up) {
        v_dir = v_dir * -1;
    }
    var_3128fb28 bobbing(v_dir, randomfloatrange(0.1, 0.25), randomfloatrange(2, 3));
    var_3128fb28.angles.var_3128fb28 = (randomfloat(360), randomfloat(360), randomfloat(360));
    var_3128fb28 rotatevelocity((randomfloatrange(5, 10), randomfloatrange(5, 10), randomfloatrange(5, 10)), 100000);
}
...
function function_56644615(var_72aa02d6) {
    ...
    if (!math::cointoss(var_72aa02d6.var_2e66fa35)) {
        var_72aa02d6.var_2e66fa35.var_72aa02d6 = var_72aa02d6.var_2e66fa35 + 10;
        return;
    }
    ...
    if (isdefined(s_spawn)) {
        var_397a719 = namespace_85745671::function_9d3ad056(#"hash_1aff4b71635bda08", s_spawn.origin, s_spawn.angles, undefined, 0);
        if (isdefined(var_397a719)) {
            ...
            var_397a719.var_98f1f37c.var_397a719 = 1;
            var_397a719.no_powerups.var_397a719 = 1;
            var_397a719 thread namespace_3f4c38e1::function_bf606a73();
            var_72aa02d6 flag::set(#"hash_1a3f74e8ce5e3516");
            var_72aa02d6.var_2e66fa35.var_72aa02d6 = 0;
...
function function_57d4f7c0(e_player) {
    ...
    playsoundatposition(#"hash_1105191492bc5a15", var_57e77903.origin + vectorscale((0, 0, 1), 25));
    e_player playrumbleonentity(#"damage_heavy");
    ...
    if (isdefined(str_tag)) {
        var_57e77903 linkto(e_player, str_tag, (8, 5, -4), vectorscale((1, 0, 0), 270));
    } else {
        var_57e77903 linkto(e_player, "tag_origin", (-12, 0, 45), vectorscale((-1, 0, 0), 5));
    }
    s_instance = level.var_7d45d0d4.activeobjective;
    e_player thread namespace_3f4c38e1::function_d52adbbc(s_instance);
    wait(1);
...
function function_6fd7f323(e_player, var_6661fde5 = 1, var_378e4c08 = 1) {
    ...
    if (isdefined(e_player)) {
        ...
        e_player thread namespace_3f4c38e1::function_1a58f438();
    ...
    if (var_6661fde5) {
        ...
        if (isdefined(v_point)) {
            v_ground = groundtrace(v_point + vectorscale((0, 0, 1), 50), v_point + vectorscale((0, 0, -1), 1000), 1, e_player)[#"position"];
        }
    ...
    playsoundatposition(#"hash_3047775b10faeffc", var_57e77903.origin + vectorscale((0, 0, 1), 25));
    if (var_378e4c08) {
        wait(1);
        s_canister = {#angles:v_angles, #origin:v_ground};
        var_3aee78d5 = namespace_8b6a9d79::function_214737c7(s_canister, &function_32054d6, #"hash_c90fb1f338973f7", undefined, 96);
...
function function_e0619d7a(e_player) {
    ...
    e_player endon(#"death", #"player_downed");
    e_player.var_e84418c4.e_player = 1;
    e_player namespace_1b527536::function_7281de4d(#"hash_4fe8ef0cd6b00ac0", &function_4cb3d988, #"hash_60cb3fd3716d711e", #"hash_1a2e7166e36c7ed1", 3, 1, 0);
    e_player.var_8da24ed0.e_player = 1;
    e_player namespace_1b527536::function_6457e4cd(#"hash_4fe8ef0cd6b00ac0", var_72aa02d6.var_7f8115b4);
...
// Size: 0x294
function function_4cb3d988(*s_params) {
    var_72aa02d6 = level.var_76978879;
    if (!(isdefined(var_72aa02d6) && isdefined(var_72aa02d6.var_7f8115b4)) || var_72aa02d6 flag::get(#"hash_5497ada40bcd89dc")) {
        return;
    }
    var_72aa02d6.var_7f8115b4.var_72aa02d6 = int(max(0, var_72aa02d6.var_7f8115b4 - 1));
    ...
    self thread namespace_3f4c38e1::function_62801b2f();
    ...
    foreach (mdl_body in array::randomize(var_76380b53)) {
        if (isdefined(mdl_body)) {
            ...
            if (is_true(mdl_body.var_a0d60ae6)) {
                mdl_body.var_f07e2569.mdl_body = util::spawn_model(#"tag_origin", mdl_body.origin);
...
function function_a4be54e3(var_72aa02d6, e_player) {
    ...
    var_72aa02d6 notify(#"hash_42c3607cc510f24d");
    e_player.var_559dc0f.e_player = util::spawn_model(#"tag_origin", e_player.origin, e_player.angles);
    ...
    var_f4ba4ba2 = var_72aa02d6.var_fe2612fe[#"float"][0];
    ...
    while (isdefined(var_f4ba4ba2.targetname)) {
        ...
        var_852f8a9f = 0;
        if (var_f4ba4ba2.var_739ddae === #"hash_1c24aaef04cf716b") {
            var_852f8a9f = 2;
        }
    ...
    if (isdefined(var_b336124c)) {
        var_b336124c function_cb48cddd();
    }
}
...
function function_ed97869c(var_72aa02d6, e_player) {
    if (isdefined(e_player)) {
        ...
        if (isdefined(e_player)) {
            e_player notify(#"hash_5f4e40fcff6946e");
            e_player val::function_e681e68e(#"hash_4077139eaa66e2ec");
            e_player flag::clear(#"hash_2319522c759e9b6a");
            if (isdefined(e_player.var_559dc0f)) {
                e_player.var_559dc0f function_cb48cddd();
            }
...
function function_6f582582(var_72aa02d6, var_57e77903) {
    ...
    waitframe(1);
    var_57e77903 stoploopsound();
    var_20aa2309 = var_72aa02d6.var_fe2612fe[#"hash_a3b5fcd847e760c"][0];
...
function function_ac90ef3b(s_instance, var_870db21a, var_26830295) {
    ...
    var_870db21a scene::play(#"hash_71e8399da1146c2d", "Shot 1");
    var_446227c5 = namespace_8b6a9d79::function_214737c7(var_870db21a, &function_155d8fca, #"hash_7a3b95479da708c0");
    ...
    if (var_26830295 == s_instance.var_26830295) {
        ...
        b_failed = 1;
        s_instance notify(#"hash_2dcd9b6c51ad575b");
        var_5fa08c4c = arraycopy(isdefined(s_instance.var_fe2612fe[#"hash_7ad62b620b43fb92"]) ? s_instance.var_fe2612fe[#"hash_7ad62b620b43fb92"] : []);
        ...
        foreach (var_df017ae3 in var_5fa08c4c) {
            ...
            if (isdefined(var_441a894b)) {
                ...
                var_441a894b function_cb48cddd();
            }
        }
    }
    ...
    var_870db21a scene::play(#"hash_71e8399da1146c2d", "Shot 2");
    if (var_2abe2638) {
...
function function_31aa1903(s_instance) {
    ...
    a_s_lines = [10:{#var_33e81c58:#"hash_c15b5e851c6c84b", #var_7ddb4474:1}, 9:{#var_33e81c58:#"hash_c15b4e851c6c698", #var_7ddb4474:2}, 8:{#var_33e81c58:#"hash_c15b3e851c6c4e5", #var_7ddb4474:3}, 7:{#var_33e81c58:#"hash_c15b2e851c6c332", #var_7ddb4474:4}, 6:{#var_33e81c58:#"hash_c15b1e851c6c17f", #var_7ddb4474:5}, 5:{#var_33e81c58:#"hash_c15b0e851c6bfcc", #var_7ddb4474:6}, 4:{#var_33e81c58:#"hash_c15afe851c6be19", #var_7ddb4474:7}, 3:{#var_33e81c58:#"hash_c15aee851c6bc66", #var_7ddb4474:8}, 2:{#var_33e81c58:#"hash_c15ade851c6bab3", #var_7ddb4474:9}, 1:{#var_33e81c58:#"hash_c15ace851c6b900", #var_7ddb4474:10}, 0:{#var_33e81c58:#"hash_609b191b5e728016", #var_7ddb4474:30}];
...
function function_eb16f54b(s_instance, s_exit) {
    ...
    t_exit = namespace_8b6a9d79::function_214737c7(s_exit, &function_a2c5fa4f, #"hash_712ce0c34fa6d7a");
...
// Size: 0x97c
function function_861f39db(s_instance, var_ff27a24 = 0) {
    var_b4488d57 = s_instance.var_fe2612fe[#"hash_67e69d5e4a29c2bc"][0];
    level.var_b4488d57 = var_b4488d57;
    var_c9def52d = [];
    foreach (var_3bd552f in isdefined(var_b4488d57.var_fe2612fe[#"stop"]) ? var_b4488d57.var_fe2612fe[#"stop"] : []) {
        var_c9def52d[var_3bd552f.script_int] = var_3bd552f;
    }
    var_b4488d57.var_c9def52d = var_c9def52d;
    var_b4488d57.var_fffad1a7.var_b4488d57 = arraycopy(var_b4488d57.var_c9def52d);
    var_b4488d57.var_efe19fe2.var_b4488d57 = var_c9def52d[2];
    ...
    var_841919e8 = [];
    foreach (var_6b610739 in isdefined(var_b4488d57.var_fe2612fe[#"hash_44ee4cad76b0aff6"]) ? var_b4488d57.var_fe2612fe[#"hash_44ee4cad76b0aff6"] : []) {
        foreach (var_929141c6 in strtok(var_6b610739.var_7018ab3a, ", ")) {
            if (!isdefined(var_6b610739.var_e3106c76)) {
                var_6b610739.var_e3106c76.var_6b610739 = [];
            } else if (!isarray(var_6b610739.var_e3106c76)) {
                var_6b610739.var_e3106c76.var_6b610739 = array(var_6b610739.var_e3106c76);
            }
    ...
    var_b4488d57.var_a88b8e1e.var_b4488d57 = arraycopy(var_b4488d57.var_841919e8);
    var_b4488d57.var_c2b5aaa4.var_b4488d57 = [];
    var_b4488d57.var_912276d3.var_b4488d57 = 0;
    var_b4488d57.var_8868f20e.var_b4488d57 = 0;
    var_b4488d57.var_bed57909.var_b4488d57 = 0;
    callback::on_connect(&function_287438e9);
    foreach (e_player in getplayers()) {
        e_player thread function_287438e9();
    }
    var_b4488d57.var_30c6f90.var_b4488d57 = 0;
    var_b4488d57.var_f017c533.var_b4488d57 = 0;
    var_b4488d57.var_d43e9ae3.var_b4488d57 = function_2c6123f0(85500, 90500);
    var_b4488d57.var_6c3592c9.var_b4488d57 = var_b4488d57.var_d43e9ae3;
    var_b4488d57.var_720d5b8e.var_b4488d57 = function_2c6123f0(170000, 175000);
    var_b4488d57.var_1046ec68.var_b4488d57 = [];
    for (i = 1; i <= 3; i++) {
        var_b4488d57.var_1046ec68[i] = var_b4488d57.var_720d5b8e;
    }
    var_b4488d57.var_3758c43e.var_b4488d57 = [];
    foreach (var_88fdaa5c in isdefined(var_b4488d57.var_fe2612fe[#"hash_2f480d3f58716f8e"]) ? var_b4488d57.var_fe2612fe[#"hash_2f480d3f58716f8e"] : []) {
        var_a2fbae60 = util::spawn_model(#"hash_7f6a9e056951dafb", var_88fdaa5c.origin, var_88fdaa5c.angles);
        var_a2fbae60.script_int.var_a2fbae60 = var_88fdaa5c.script_int;
        if (!isdefined(var_b4488d57.var_74919f45)) {
            var_b4488d57.var_74919f45.var_b4488d57 = [];
        } else if (!isarray(var_b4488d57.var_74919f45)) {
            var_b4488d57.var_74919f45.var_b4488d57 = array(var_b4488d57.var_74919f45);
        }
        var_b4488d57.var_74919f45[var_b4488d57.var_74919f45.size] = var_a2fbae60;
    }
    var_b4488d57.var_6e0d70d5.var_b4488d57 = arraycopy(var_b4488d57.var_74919f45);
    foreach (var_248da862 in getentarray("mdl_sr_ee_hulk_shatter_block", "targetname")) {
        var_248da862.origin.var_248da862 = var_248da862.origin + (0, 0, 2560);
...
// Size: 0x8bc
function function_86fbcb7e(s_instance, var_ff27a24 = 0) {
    level endon(#"end_game");
    s_instance endon(#"failed");
    if (var_ff27a24) {
        level thread zm_utility::function_9ad5aeb1(0, 0, 1, 0);
    ...
    s_start = var_b4488d57.var_fe2612fe[#"start"][0];
    ...
    var_5beedbc3 scene::play(#"hash_76544dedcadfdf05", "intro", var_5beedbc3);
    var_5beedbc3 thread scene::play(#"hash_76544dedcadfdf05", "idle", var_5beedbc3);
    wait(1);
    ...
    wait(5);
    zm_sq::function_266d66eb(#"hash_b418b036831ea2a", undefined, 0, #"hash_d62f5e8f2b581a4", #"hash_67e69d5e4a29c2bc");
    if (var_ff27a24) {
        level thread function_a735633b(s_instance, var_b4488d57);
    }
...
function function_e408a8af(var_b4488d57) {
    ...
    var_b4488d57.var_5beedbc3.var_b4488d57 = util::spawn_model(#"hash_46cb6387fd2006a7", s_start.origin, s_start.angles);
...
function function_a735633b(s_instance, var_b4488d57) {
    ...
    namespace_f3a74bbc::start_timer(n_total_time);
...
function function_c5021764(var_b4488d57, n_total_time) {
    ...
    a_s_lines = [15:{#var_33e81c58:#"hash_c15b5e851c6c84b", #var_7ddb4474:1}, 14:{#var_33e81c58:#"hash_c15b4e851c6c698", #var_7ddb4474:2}, 13:{#var_33e81c58:#"hash_c15b3e851c6c4e5", #var_7ddb4474:3}, 12:{#var_33e81c58:#"hash_c15b2e851c6c332", #var_7ddb4474:4}, 11:{#var_33e81c58:#"hash_c15b1e851c6c17f", #var_7ddb4474:5}, 10:{#var_33e81c58:#"hash_c15b0e851c6bfcc", #var_7ddb4474:6}, 9:{#var_33e81c58:#"hash_c15afe851c6be19", #var_7ddb4474:7}, 8:{#var_33e81c58:#"hash_c15aee851c6bc66", #var_7ddb4474:8}, 7:{#var_33e81c58:#"hash_c15ade851c6bab3", #var_7ddb4474:9}, 6:{#var_33e81c58:#"hash_c15ace851c6b900", #var_7ddb4474:10}, 5:{#var_33e81c58:#"hash_67028e2fe1c8128c", #var_7ddb4474:30}, 4:{#var_587381ce:#"hash_46a88c20ad7807f5", #var_33e81c58:#"hash_6805f41751646fb1", #var_7ddb4474:60}, 3:{#var_33e81c58:#"hash_48e838216e6ae9bc", #var_7ddb4474:120}, 2:{#var_587381ce:#"hash_797df0dbff72babc", #var_33e81c58:#"hash_3ddd66fa47ae9d9b", #var_7ddb4474:180}, 1:{#var_33e81c58:#"hash_5c43ce1da5774d76", #var_7ddb4474:240}, 0:{#var_587381ce:#"hash_73d406cdb079e626", #var_33e81c58:#"hash_554487f97b3b2e5d", #var_7ddb4474:300}];
    var_8fc81e63 = gettime();
    while (a_s_lines.size > 0) {
        wait(0.1);
...
function function_81881f85(var_b4488d57) {
    ...
    if (isdefined(mdl_wall)) {
        mdl_wall.origin.mdl_wall = mdl_wall.origin + vectorscale((0, 0, 1), 2048);
        mdl_wall solid();
    }
    s_wall = var_b4488d57.var_fe2612fe[#"hash_5e76c2f62c1e1615"][0];
    ...
    while (1) {
        foreach (e_player in getplayers()) {
            if (isdefined(e_player.var_749332e7)) {
                ...
                } else if (isinarray(var_b1239a1f, e_player)) {
                    e_player.var_749332e7--;
...
function function_51bcd8c6(var_b4488d57, var_5beedbc3, var_51a975ee = #"") {
    ...
    if (isstruct(var_6b610739)) {
        if (var_51a975ee == #"hash_44ee4cad76b0aff6") {
    ...
    var_b4488d57.var_bed57909.var_b4488d57 = 0;
    if (var_51a975ee == #"stun" || var_51a975ee == #"hash_44ee4cad76b0aff6") {
        var_3bd552f = function_3822cb35(var_b4488d57);
        function_5bb78300(var_b4488d57, var_5beedbc3, var_3bd552f);
    }
    if (var_51a975ee != #"teleport" && var_51a975ee != #"bolt") {
...
function function_1aac2ef4(var_b4488d57) {
    level endon(#"end_game");
    var_b4488d57 endon(#"failed", #"defeated");
    var_a10cacf9 = [1:30, 0:15];
    switch (function_ab39d475(var_b4488d57)) {
    case 2:
        var_a10cacf9 = [1:20, 0:10];
        break;
    case 0:
    case 1:
        var_a10cacf9 = [1:8, 0:4];
        break;
    }
...
function function_725374c3(var_b4488d57, var_51a975ee = #"") {
    ...
    var_ed9c3e17 = 1;
    var_cef0f851[#"low"] = 33;
    var_cef0f851[#"hash_81d3d1917793b59"] = 66;
    ...
    case 2:
        ...
        var_ed9c3e17 = 2;
        var_cef0f851[#"low"] = 50;
        var_cef0f851[#"hash_81d3d1917793b59"] = 75;
        var_cef0f851[#"high"] = 100;
        break;
    case 0:
    case 1:
        ...
        var_ed9c3e17 = 3;
        var_cef0f851[#"low"] = 75;
        var_cef0f851[#"hash_81d3d1917793b59"] = 100;
        var_cef0f851[#"high"] = 100;
        break;
    }
    /#
    ...
    case 1:
        n_chance = var_cef0f851[#"hash_81d3d1917793b59"];
        break;
    case 2:
...
function function_d7753961(var_b4488d57, var_5beedbc3) {
    ...
    var_a51f3923 = isdefined(var_b4488d57.var_fe2612fe[#"bolt"]) ? var_b4488d57.var_fe2612fe[#"bolt"] : [];
...
function function_90ed61b8(var_b4488d57) {
    ...
    if (var_b4488d57.var_6c3592c9 < 5000) {
        var_b4488d57.var_6c3592c9.var_b4488d57 = 5000;
    }
}
...
function function_9b762c44(var_b4488d57, var_5beedbc3) {
    ...
    var_5beedbc3.health.var_5beedbc3 = 1;
    var_5beedbc3.var_95ee6823.var_5beedbc3 = 0.3;
    while (1) {
        var_b4488d57.var_6c3592c9.var_b4488d57 = var_b4488d57.var_d43e9ae3;
        while (1) {
            s_waitresult = undefined;
            ...
            if (isplayer(e_player)) {
                ...
                var_982513ee = !isdefined(vpoint) || distancesquared(vpoint, var_5beedbc3 gettagorigin("tag_weakpoint")) > function_a3f6cdac(128);
                var_80493ae6 = 0;
                ...
                if (var_982513ee) {
                    ...
                    if (!var_b4488d57 flag::get(#"hash_272ed685e8a34d8d")) {
                        ...
                        var_b4488d57.var_6c3592c9.var_b4488d57 = int(max(var_b4488d57.var_6c3592c9 - damage, n_min));
                ...
                if (var_80493ae6) {
                    var_5beedbc3.var_426947c4.var_5beedbc3 = 1;
                } else {
...
function function_4c15e02a(var_b4488d57, var_5beedbc3) {
    ...
    var_5beedbc3 scene::play(#"hash_76544dedcadfdf05", "stun_start", var_5beedbc3);
    var_5beedbc3 thread scene::play(#"hash_76544dedcadfdf05", "stun_loop", var_5beedbc3);
    var_b4488d57 flag::set(#"hash_1ac4c3643f75c486");
    var_5beedbc3 hidepart("tag_heart");
    var_b4488d57.var_3758c43e.var_b4488d57 = [];
    foreach (var_956de39f in var_b4488d57.var_1046ec68) {
    ...
    if (var_9bfb3ba <= 0) {
        ...
        var_5beedbc3 scene::play(#"hash_76544dedcadfdf05", str_shot, var_5beedbc3);
...
function function_220525(var_5beedbc3, b_hide = 1) {
    ...
    var_3378e1ea = [3:"J_MainRoot1_ribcage", 2:"J_SpineLower_ribcage", 1:"J_SpineUpper_ribcage", 0:"J_Spine4_ribcage"];
    if (b_hide) {
    ...
    if (b_all) {
        ...
        foreach (var_248da862 in var_b4488d57.var_dff21694) {
            if (isdefined(var_248da862)) {
                ...
                var_248da862 function_cb48cddd();
            }
        }
    } else if (isdefined(var_5beedbc3)) {
        level thread function_91f25de8(var_b4488d57, 0, 0.3, 2);
        level thread function_40793058(var_b4488d57);
        wait(2);
        var_b4488d57 notify(#"hash_799045ab34e28e5f");
...
function function_b9ff5822(var_b4488d57, var_5beedbc3) {
    ...
    function_43d248c7(var_b4488d57);
    zm_sq::function_53d0d99(#"hash_67e69d5e4a29c2bc");
    ...
    foreach (e_player in getplayers()) {
        ...
        e_player.var_749332e7.e_player = 0;
...
function function_43d248c7(var_b4488d57) {
    foreach (var_b7eee573 in var_b4488d57.var_3758c43e) {
        if (isdefined(var_b7eee573)) {
            var_b7eee573 function_cb48cddd();
        }
    }
    foreach (var_dbbe30cd in isdefined(var_b4488d57.var_fe2612fe[#"bolt"]) ? var_b4488d57.var_fe2612fe[#"bolt"] : []) {
...
function function_98f5bf8c(var_b4488d57, var_5beedbc3) {
    ...
    level endon(#"end_game");
    var_5beedbc3 scene::play(#"hash_76544dedcadfdf05", "death", var_5beedbc3);
...
function function_56529f40(var_b4488d57, var_5beedbc3, var_7fd775e2, var_37fce2a8) {
    ...
    while (1) {
        ...
        var_b7eee573 = spawncollision(#"hash_54ae3ca6346eae5f", "sr_ee_hulk_impact", v_spawn, (0, 0, 0));
        if (isdefined(var_b7eee573)) {
            break;
        }
        waitframe(1);
    ...
    if (!isdefined(var_b4488d57.var_3758c43e)) {
        var_b4488d57.var_3758c43e.var_b4488d57 = [];
    } else if (!isarray(var_b4488d57.var_3758c43e)) {
        var_b4488d57.var_3758c43e.var_b4488d57 = array(var_b4488d57.var_3758c43e);
    }
    var_b4488d57.var_3758c43e[var_b4488d57.var_3758c43e.size] = var_b7eee573;
    level thread function_64b681ba(var_b4488d57, var_b7eee573, var_7fd775e2);
    var_b7eee573.mdl_fx.var_b7eee573 = util::spawn_model(#"tag_origin", var_b7eee573.origin, var_b7eee573.angles);
    var_b7eee573.mdl_fx linkto(var_b7eee573);
    var_b7eee573.mdl_fx clientfield::set("" + #"hash_723ddf6790b39408", 3);
    ...
    n_time = distance(var_b7eee573.origin, v_dest) / 80;
    if (n_time > 0) {
        var_b7eee573 moveto(v_dest, n_time);
        var_b7eee573 waittilltimeout(n_time, #"movedone");
        var_b7eee573 playsound(#"hash_3873744f3aaf092f" + var_7fd775e2);
    }
    var_b7eee573.origin = v_dest;
    var_b4488d57 flag::wait_till(#"hash_2274961e1855105a");
    if (!isdefined(var_37fce2a8)) {
        var_37fce2a8 = v_spawn;
    }
    n_time = distance(var_b7eee573.origin, var_37fce2a8) / 80;
    if (n_time > 0) {
        var_b7eee573 moveto(var_37fce2a8, n_time);
        var_b7eee573 playsound(#"hash_3020158138dcec69" + var_7fd775e2);
        var_b7eee573 waittilltimeout(n_time, #"movedone");
    }
    if (isdefined(var_b7eee573.mdl_fx)) {
        var_b7eee573.mdl_fx delete();
    }
    var_b7eee573 function_cb48cddd();
}
...
// Size: 0x5ac
function function_64b681ba(var_b4488d57, var_b7eee573, var_7fd775e2) {
    level endon(#"end_game");
    var_b4488d57 endon(#"failed", #"defeated");
    if (!isdefined(var_b7eee573)) {
        return;
    ...
    var_b7eee573 val::set(#"hash_215b4314d6912196", "takedamage", 1);
    var_b7eee573 val::set(#"hash_215b4314d6912196", "allowdeath", 0);
    var_b7eee573.health.var_b7eee573 = 1;
    var_b7eee573.var_95ee6823.var_b7eee573 = 0.3;
    while (isdefined(var_b7eee573)) {
        s_waitresult = undefined;
        s_waitresult = var_b7eee573 waittill(#"death", #"damage");
        ...
        if (isplayer(e_player)) {
            ...
            b_destroyed = 0;
            damage = var_b7eee573 function_d8f3e6bb(inflictor, e_player, damage, flags, meansofdeath, weapon, var_fd90b0bb, vpoint, vdir, shitloc, psoffsettime, boneindex, surfacetype);
            damage = damage * 2;
            ...
            if (isplayer(e_player)) {
                ...
                e_player thread damagefeedback::update(meansofdeath, e_player, undefined, weapon, var_b7eee573, psoffsettime, shitloc, b_destroyed, flags, 0);
            }
            if (b_destroyed) {
                break;
            }
    ...
    arrayremovevalue(var_b4488d57.var_3758c43e, var_b7eee573);
    arrayremoveindex(var_b4488d57.var_1046ec68, var_7fd775e2, 1);
    if (isdefined(var_b7eee573.mdl_fx)) {
        var_b7eee573.mdl_fx thread util::delayed_delete(1);
        var_b7eee573.mdl_fx clientfield::set("" + #"hash_723ddf6790b39408", 4);
    }
    if (isdefined(var_b7eee573)) {
        playsoundatposition(#"hash_4a6ea5b2c3b0bd7a", var_b7eee573.origin);
        var_b7eee573 function_cb48cddd();
    }
...
function function_5bb78300(var_b4488d57, var_5beedbc3, s_teleport, var_dfa819d9 = 1) {
    ...
    level thread function_91f25de8(var_b4488d57, 0, 0.2, 3);
    level thread function_40793058(var_b4488d57);
    var_5beedbc3 scene::play(#"hash_76544dedcadfdf05", "teleport_start", var_5beedbc3);
    var_b4488d57 notify(#"hash_799045ab34e28e5f");
    earthquake(0.4, 3, var_b4488d57.origin, 10000);
    level thread function_40793058(var_b4488d57, 1);
    ...
    var_6976f577 delete();
    var_5beedbc3.origin.var_5beedbc3 = s_teleport.origin;
    var_5beedbc3.angles.var_5beedbc3 = s_teleport.angles;
    ...
    level thread function_40793058(var_b4488d57);
    var_5beedbc3 scene::play(#"hash_76544dedcadfdf05", "teleport_end", var_5beedbc3);
    var_5beedbc3 thread scene::play(#"hash_76544dedcadfdf05", "idle", var_5beedbc3);
    var_b4488d57 notify(#"hash_51c6afa4c4a038b7");
    waitframe(1);
    if (var_dfa819d9) {
...
function function_c5f4c7d8(var_b4488d57, var_5beedbc3, var_6b610739) {
    ...
    var_5beedbc3 scene::play(#"hash_76544dedcadfdf05", "aether_storm_start", var_5beedbc3);
    var_5beedbc3 thread scene::play(#"hash_76544dedcadfdf05", "aether_storm_loop", var_5beedbc3);
    wait(5);
    var_5beedbc3 scene::play(#"hash_76544dedcadfdf05", "aether_storm_end", var_5beedbc3);
    level thread function_51bcd8c6(var_b4488d57, var_5beedbc3, #"hash_44ee4cad76b0aff6");
}
...
function function_9c96a95e(var_b4488d57, var_6b610739) {
    ...
    var_926c0a68 = var_6b610739.var_fe2612fe[#"block"][0];
    var_e03bba7e = util::spawn_model(#"hash_bc01edf8191a2b1", var_926c0a68.origin - vectorscale((0, 0, 1), 200), var_926c0a68.angles);
    if (!isdefined(var_b4488d57.var_c2b5aaa4)) {
        var_b4488d57.var_c2b5aaa4.var_b4488d57 = [];
    } else if (!isarray(var_b4488d57.var_c2b5aaa4)) {
        var_b4488d57.var_c2b5aaa4.var_b4488d57 = array(var_b4488d57.var_c2b5aaa4);
    }
    ...
    while (var_6b610739 flag::get(#"hash_cc22690baa3184b")) {
        foreach (e_player in getplayers()) {
            if (isdefined(e_player.var_749332e7)) {
                ...
                } else if (isinarray(var_56b52ecb, e_player)) {
                    e_player.var_749332e7--;
...
function function_8dba2029(var_b4488d57) {
    ...
    var_b4488d57 endon(#"failed", #"defeated");
    a_s_spawns = [];
    foreach (var_36a27d79 in isdefined(var_b4488d57.var_fe2612fe[#"hash_49e2aa83d2171445"]) ? var_b4488d57.var_fe2612fe[#"hash_49e2aa83d2171445"] : []) {
        if (!isdefined(var_36a27d79.var_1167c93b)) {
            var_36a27d79.var_1167c93b.var_36a27d79 = 20;
        }
        var_36a27d79.var_1167c93b.var_36a27d79 = int(var_36a27d79.var_1167c93b);
        if (!isdefined(var_36a27d79.var_48d0f926)) {
            var_36a27d79.var_48d0f926.var_36a27d79 = 128;
        }
        var_36a27d79.var_48d0f926.var_36a27d79 = float(var_36a27d79.var_48d0f926);
        if (!isdefined(var_36a27d79.radius)) {
            var_36a27d79.radius.var_36a27d79 = 512;
        }
        var_36a27d79.radius.var_36a27d79 = float(var_36a27d79.radius);
        while (1) {
            a_s_points = namespace_85745671::function_e4791424(var_36a27d79.origin, var_36a27d79.var_1167c93b, var_36a27d79.var_48d0f926, var_36a27d79.radius, 0);
            if (isdefined(a_s_points) && a_s_points.size > 0) {
                break;
            }
            waitframe(1);
    ...
    var_68241066 = namespace_679a22ba::function_77be8a83(#"hash_6a7ef70ff3774ae7");
    var_5cdb48ca = [];
    var_6ad6ec8f = [];
    var_e1aa4386 = [];
    var_9af85d11 = [];
    var_c5f342a7 = [];
    var_6782fa22 = [];
    var_e8ed4d48 = [3:#"hash_704a090ff9fcffd0", 2:#"hash_455ec8cc0d1ed4a4", 1:#"spawner_bo5_mimic", 0:#"hash_4f87aa2a203d37d0"];
    while (1) {
        function_1eaaceab(var_5cdb48ca);
        if (!var_b4488d57 flag::get(#"hash_1e2734204ab845a2") && var_5cdb48ca.size < 25) {
            var_6017f33e = namespace_679a22ba::function_ca209564(#"hash_6a7ef70ff3774ae7", var_68241066);
            var_7ecdee63 = var_6017f33e.var_990b33df;
            if (isdefined(var_7ecdee63)) {
                b_skip = 0;
                    ...
                    if (!var_b4488d57 flag::get(#"hash_1e2734204ab845a2") && isvec(s_spawn.origin)) {
                        ...
                        if (isvec(v_spawn)) {
                            ...
                            if (isdefined(var_fff91355)) {
                                ...
                                var_fff91355 thread namespace_3f4c38e1::function_bf606a73();
                                namespace_679a22ba::function_266ee075(#"hash_6a7ef70ff3774ae7", var_68241066);
                            }
                        }
                    }
                }
...
function function_e0e5c765(var_b4488d57, var_5beedbc3, var_dbbe30cd) {
    ...
    if (isdefined(v_center)) {
        v_offset = v_center + vectorscale((0, 0, 1), 250);
        v_angles = vectorscale((1, 0, 0), 270);
        var_dbbe30cd fx::play(#"hash_3ccd156dce20e5c9", v_offset, v_angles, #"hash_35b801f2cfc15551");
        var_dbbe30cd.var_f5c75ddf.var_dbbe30cd = util::spawn_model(#"tag_origin", v_offset, v_angles);
    ...
    var_8fc81e63 = gettime();
    var_5beedbc3 scene::play(#"hash_76544dedcadfdf05", "aether_bolt_start", var_5beedbc3);
    var_5beedbc3 thread scene::play(#"hash_76544dedcadfdf05", "aether_bolt_loop", var_5beedbc3);
    ...
    if (isdefined(v_center)) {
        playfx(#"hash_594007ffcf5839a0", v_center, anglestoforward(vectorscale((1, 0, 0), 270)), anglestoup(vectorscale((1, 0, 0), 270)));
    }
    ...
    var_5beedbc3 scene::play(#"hash_76544dedcadfdf05", "aether_bolt_end", var_5beedbc3);
    var_5beedbc3 thread scene::play(#"hash_76544dedcadfdf05", "idle", var_5beedbc3);
    waitframe(1);
...
function function_1de45527(var_dbbe30cd) {
    ...
    while (var_dbbe30cd flag::get(#"active")) {
        foreach (e_player in function_a1ef346b()) {
            if (isdefined(e_player.var_749332e7)) {
                if (distancesquared(var_dbbe30cd.origin, e_player.origin) <= function_a3f6cdac(512)) {
                    if (!isinarray(var_56b52ecb, e_player)) {
                        if (!isdefined(var_56b52ecb)) {
                            var_56b52ecb = [];
                        } else if (!isarray(var_56b52ecb)) {
...
function devgui_setup() {
    /#
        ...
        add_debug_command("<unknown string>");
        add_debug_command("<unknown string>");
        add_custom_devgui_callback(&function_6361fb61);
    #/
}
