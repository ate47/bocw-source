...
function function_e1e48820(var_72aa02d6) {
    ...
    a_props = [[#"p8_wmd_chair_folding_clean", 0], [#"p8_wz_skt_potted_plant_palm_square", 0], [#"hash_46fe557f2085d01d", 0], [#"p8_jpn_ashtray_tall", 13], [#"hash_524977d3bd147dc5", 0], [#"hash_4fe609f6bf03cb34", 44]];
...
function function_b9462694(var_949add22 = 1, var_72aa02d6, var_57e77903, var_b3fb5814) {
    ...
    if (!var_949add22) {
        var_57e77903 notify(#"chunks_deleted");
...
function field_upgrade_fired(*s_params) {
    ...
    if (isdefined(var_72aa02d6.var_57e77903)) {
        var_72aa02d6.var_57e77903 clientfield::increment("" + #"canister_shockwave");
    }
...
function function_155d8fca(s_params) {
    ...
    if (isdefined(var_870db21a) && zm_utility::is_player_valid(e_player)) {
        self triggerenable(0);
        var_870db21a notify(#"key_inserted", {#e_player:e_player});
        self deletedelay();
    }
}
