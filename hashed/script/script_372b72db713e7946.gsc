...
function function_7df588f1() {
    ...
    foreach (ai in a_ai) {
        ...
        if (isdefined(ai.script_noteworthy)) {
            ...
            case #"hash_23079f57841fe21":
                var_e37ea03f = ai;
                var_f1a8db84 = vh;
                break;
            case #"hash_23076f57841f908":
                var_8933ebaf = ai;
                var_71c65bbd = vh;
                break;
            case #"hash_23077f57841fabb":
                var_79c24ccc = ai;
                var_8300fe32 = vh;
                break;
            default:
...
function function_74bcaf79(var_e37ea03f, var_8933ebaf, var_79c24ccc, var_f1a8db84, var_71c65bbd, var_8300fe32) {
    ...
    level.player val::reset(#"hash_39c4c88b6bb3d93a", "takedamage");
}
...
function function_544c7da1(ai, vh) {
    ...
    wait 1;
    level.player val::set(#"hash_39c4c88b6bb3d93a", "takedamage", 1);
    function_f17eac00(var_b341094, vh);
    level.player val::set(#"hash_39c4c88b6bb3d93a", "takedamage", 0);
...
// Size: 0xbc
function function_f17eac00(var_b341094, e_source) {
    level.player dodamage(1, e_source.origin);
    level.player.health++;
    if (level.player.health > var_b341094) {
        level.player.health -= var_b341094;
        return;
    }
...
function function_86531f64() {
    ...
    level notify(#"hash_c6721cede67351a");
}
