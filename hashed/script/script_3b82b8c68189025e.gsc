...
function function_b8031554(ai_actor, *struct, scene, shot) {
    if (isdefined(struct) && isdefined(scene) && isdefined(shot)) {
        ...
        pos_info.origin = var_96866f7f.origin;
        pos_info.angles = var_96866f7f gettagangles("tag_origin");
        pos_info.var_38d4ed7 = var_96866f7f gettagorigin("j_head");
        var_96866f7f delete();
        return pos_info;
    }
    return undefined;
...
function function_cfa96cee(dialog_tree, anim_struct, timer, kill_notify = "dialog_wait_cancel", use_dist = 80, display_dist = 200, use_angles = 0, use_offset = (6, 0, 0), var_5bab29d8 = 0) {
    ...
    var_c93a00f2 = #"OBJECTIVES/TALK_TO";
    self util::create_cursor_hint(tagname, use_offset, var_c93a00f2, use_dist, undefined, undefined, undefined, display_dist, use_angles);
    self prompts::function_92127496(1);
    self prompts::function_1a5e1da6(#"use", 1);
    msg = self waittill(#"trigger", #"death", #"hash_15ec42f1846ef9d0", #"deleted", kill_notify);
    ...
    foreach (ent in scene_ents) {
        ...
        if (isdefined(ent._scene_object._str_current_anim)) {
            ...
            if (abs(curr_time - var_4fd94186.var_bd15dadd) > 0.025) {
                /#
                    iprintln("<dev string:xba>" + abs(curr_time - var_4fd94186.var_bd15dadd));
                #/
                continue;
            }
            ...
            if (notetracks.size) {
                foreach (notetrack in notetracks) {
                    if (notetrack[5] == #"vox") {
                        ent.stop_sound = 1;
                        if (notetrack[3] > curr_time && notetrack[3] * anim_len < var_4fd94186.skipt) {
                            ...
                            var_4fd94186.var_30468601 = check_time / anim_len;
                            var_4fd94186.var_4fc15872 = notetrack[3] * anim_len;
                            /#
...
function private function_98927b7b(parent_id, option_text, ai_vo, ai_anim, var_a0ee58ce, end_dialog = 0, set_flag, var_a16c9b3f, var_9ddc06f5, selected_func, func_parameter, skip_func, important = 0, var_84fa2307, var_c275310d, var_50f9a62 = 1) {
    ...
    option.var_8fece7d7 = option_text;
    option.vo_npc = ai_vo;
...
function private function_985e8e32(index) {
    ...
    choice_string = "^S " + var_4ef47508 + " ^E";
...
function private function_8b61aa4c(var_d9d52a9d, ai_actor, var_cf6d95c9 = 4) {
    ...
    if (selected.var_70b35161 < 0) {
        level thread function_310d2602(var_8447108b, ai_actor, 1);
        return selected.var_70b35161;
    }
    level thread function_310d2602(var_8447108b, ai_actor);
...
// Size: 0x104
function private function_cde38026(old_indices, new_indices, var_8447108b) {
...
// Size: 0xfc
function private function_310d2602(var_8447108b, ai_actor, quick_clear = 0) {
    if (!quick_clear) {
