...
function private autoexec __init__system__() {
    system::register(#"hash_5f19cd68b4607f52", &function_70a657d8, undefined, &function_5700f119, #"hash_f81b9dea74f0ee");
}
...
function function_2394df30(s_params) {
    ...
    if (self.archetype === #"hash_da8fcc11dab30f") {
    ...
    var_2858caa2 = {#var_738dfc81:20, #angles:var_3ecf13fe, #origin:var_4aeae769};
    var_5bb8af3f = var_2858caa2 namespace_65181344::function_fd87c780(var_ec6368f9, 20, 2);
        ...
        if (var_8be3ada4 && var_311d223d) {
            ...
            if (var_5bb8af3f.size <= 0) {
                if (math::cointoss(var_515ea3b6)) {
                    ...
                    var_2858caa2 = {#var_738dfc81:10, #angles:var_3ecf13fe, #origin:var_4aeae769};
                    var_5bb8af3f = var_2858caa2 namespace_65181344::function_fd87c780(list, 1, 2);
                }
            }
    ...
    /#
        if (is_true(getdvarint(#"hash_4f6649cba9e849a9"))) {
            ...
            item = drop_item(0, undefined, 1, 0, item_drop.id, var_2858caa2.origin, var_2858caa2.angles, 2);
        }
    #/
    if (isdefined(level.var_b20199e0)) {
        a_items = var_2858caa2 [[ level.var_b20199e0 ]](var_2e6f77db);
        if (isarray(a_items)) {
            var_5bb8af3f = arraycombine(var_5bb8af3f, a_items, 0, 0);
        }
    }
...
function function_4ec9fc99(struct, var_cc1fb2d0, var_3a053962, str_scene, var_dae71351, var_3f3c5683 = 1, var_eed348ab = 0) {
    struct.scriptmodel.struct = namespace_8b6a9d79::function_f3d93ee9(struct, var_3a053962, 1);
    ...
    if (var_eed348ab) {
        ...
        if (isdefined(struct.var_a4fadd7e)) {
            if (abs(struct.scriptmodel.origin[2] - struct.var_a4fadd7e[2]) > 80 || s_waitresult._notify === #"timeout") {
                if (isdefined(struct.scriptmodel)) {
                    struct.scriptmodel function_cb48cddd();
                }
                return;
            }
        }
    ...
    trigger.targetname.trigger = "explore_chest_trigger";
...
function function_25979f32(struct, var_93fe96a6, s_instance) {
    ...
    if (!isdefined(struct.var_31919730)) {
        struct.var_31919730.struct = #"hash_401a47741ffd646f";
    }
    if (!isdefined(struct.var_dae71351)) {
        struct.var_dae71351.struct = 3;
    }
    struct.scriptmodel.struct = namespace_8b6a9d79::function_f3d93ee9(struct, struct.var_31919730, 1);
    ...
    trigger = namespace_8b6a9d79::function_214737c7(struct, &function_8665f666, #"hash_4703982104472957", undefined, 60, 24, undefined, forward);
    trigger.struct = struct;
    trigger.var_cc1fb2d0.trigger = struct.var_cc1fb2d0;
    struct.scriptmodel.trigger = trigger;
    if (struct.var_31919730 === #"hash_401a47741ffd646f") {
        trigger sethintstring("SURVIVAL/SUPPLY_DROP_OPEN");
    } else if (struct.var_31919730 === "p9_fxanim_zm_gp_chest_01_lrg_low_xmodel") {
        trigger sethintstring("SCRIPT/SR_LOOT_HINT_LARGE");
    } else if (struct.var_31919730 === "p9_fxanim_zm_gp_chest_01_med_low_xmodel") {
        trigger sethintstring("SCRIPT/SR_LOOT_HINT_MEDIUM");
    ...
    if (is_true(var_93fe96a6)) {
        struct.var_e234ef47.struct = zm_utility::function_f5a222a8(#"hash_15752913c15d86ff", struct.scriptmodel);
    }
        ...
        foreach (player in getplayers()) {
            ...
            if (!isinarray(player.var_4ee86e15, self) && distancesquared(player.origin, self.origin) < 1562500) {
                ...
                if (!isdefined(player.var_4ee86e15)) {
                    ...
                    player.var_4ee86e15.player = array(player.var_4ee86e15);
                }
...
function function_f82f361c(struct, var_cc1fb2d0, var_98d110e6 = 1, var_5b57dd9 = 0, v_offset = (0, 0, 0), var_e2856109 = 0) {
    ...
    var_a28d0d8c = scriptmodel.origin;
    if (var_5b57dd9) {
        var_a28d0d8c = struct.origin;
    }
    if (!isdefined(var_a28d0d8c)) {
        return;
    }
    var_a28d0d8c = var_a28d0d8c + v_offset;
                ...
                if (randomint(100) > var_e472e403 || getdvarint(#"hash_731bacd49b186d10", 0)) {
                    ...
                    if (isdefined(var_37180a9f)) {
                        ...
                        if (!isdefined(instance.var_344a6a1a)) {
                            ...
                            instance.var_344a6a1a.instance = array(instance.var_344a6a1a);
                        }
                        ...
                        /#
                            var_37180a9f.targetname.var_37180a9f = "<unknown string>";
                        #/
...
function function_8265e656(var_37180a9f) {
    ...
    while (isdefined(var_37180a9f) && var_37180a9f.health > 0) {
        ...
        if (isplayer(s_result.attacker) && isalive(s_result.attacker)) {
            ...
            var_37180a9f.health.var_37180a9f = 1;
            continue;
        }
        var_481d523f = 0;
...
function function_8ef626e3(var_cc1fb2d0) {
    ...
    var_7580ce3e.origin.var_7580ce3e = var_7580ce3e.origin + var_dddebb5c;
