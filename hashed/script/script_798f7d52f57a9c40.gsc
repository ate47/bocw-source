...
#namespace namespace_18f7e99e;

// Namespace namespace_18f7e99e/namespace_968becd2
// Params 1, eflags: 0x0
...
function main(var_d3440450, var_50cc0d4f) {
    ...
    if (is_true(var_50cc0d4f)) {
        ...
        level thread namespace_e7286d97::function_bfe40bf0();
...
function close_vault() {
    level flag::wait_till("close_vault");
    level thread namespace_e7286d97::function_bfe40bf0(1);
...
function function_93564051() {
    ...
    var_eabfdd64 = snd::function_9ae4fc6f("vox_cp_rkgb_04100_rms2_thedoorsaretoot_86", vault_breach_guys_audio_org.origin);
    snd::function_2fdc4fb(var_eabfdd64);
    var_eabfdd64 = snd::function_9ae4fc6f("vox_cp_rkgb_04100_rms1_usethetorchcutt_3a", vault_breach_guys_audio_org.origin);
    snd::function_2fdc4fb(var_eabfdd64);
    wait 2;
