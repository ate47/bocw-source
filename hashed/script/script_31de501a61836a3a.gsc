...
function event_handler[level_init] main(*eventstruct) {
    ...
    namespace_f3a74bbc::function_b3464a7c(#"payload_escort", &init, &function_d137dbd4, #"payload", #"hash_6df9aea076cea4ba", #"hash_4ddf1b97bee2b93", 6, #"hash_7cd75fcb4650df62");
...
function init(instance) {
    ...
    foreach (s_instance in instance.var_fe2612fe[#"payload"]) {
        if (isdefined(s_instance.var_fe2612fe[#"truck"])) {
            s_instance.var_738e322b.s_instance = namespace_8b6a9d79::function_f3d93ee9(s_instance.var_fe2612fe[#"truck"][0], #"hash_476204ed994318f", 1);
        }
        wait(0.1);
        s_instance.var_b8ca9d7.s_instance = spawnvehicle(#"hash_d069dee6a0076c8", s_instance.origin, s_instance.angles, "vehicle_payload", 0, undefined, "sensor");
    ...
    instance.var_1ac40948.instance = s_instance.var_738e322b;
    instance.var_b8ca9d7.instance = s_instance.var_b8ca9d7;
    ...
    instance.var_1cd294c7.instance = util::spawn_model("tag_origin", instance.var_b8ca9d7 gettagorigin("tag_cage_attach"), instance.var_b8ca9d7 gettagangles("tag_cage_attach"));
    ...
    if (isdefined(s_instance.var_fe2612fe[#"rift"])) {
        instance.var_d4f4d124.instance = s_instance.var_fe2612fe[#"rift"];
    }
    if (isdefined(instance.var_fe2612fe[#"hash_441da645c3f27eea"])) {
        instance thread function_9bf6c44a();
    }
    if (isdefined(instance.var_fe2612fe[#"hash_17213ba6ef802c84"])) {
        instance.var_f2af10b2.instance = util::spawn_model(instance.var_fe2612fe[#"hash_17213ba6ef802c84"][0].model, instance.var_fe2612fe[#"hash_17213ba6ef802c84"][0].origin, instance.var_fe2612fe[#"hash_17213ba6ef802c84"][0].angles);
        waitframe(1);
        if (isdefined(instance.var_f2af10b2)) {
            instance.var_f2af10b2 ghost();
        }
    }
    if (isdefined(instance.var_fe2612fe[#"hash_53295f8e563380a6"])) {
        var_3608e7a6 = instance.var_fe2612fe[#"hash_53295f8e563380a6"][0];
        instance.var_f2065b9e.instance = util::spawn_model(var_3608e7a6.model, var_3608e7a6.origin, var_3608e7a6.angles);
        waitframe(1);
...
function on_player_spawned() {
    if (level.var_7d45d0d4.activeobjective.var_b588b063 === "payload_escort") {
        ...
        var_b8ca9d7 = level.var_7d45d0d4.activeobjective.var_b8ca9d7;
...
function function_eb76d765() {
    ...
    if (isdefined(var_43123efe) && isdefined(self.var_b8ca9d7)) {
        ...
        var_43123efe.v_ang.var_43123efe = var_3b25dd0c[2];
        var_43123efe.v_offset.var_43123efe = var_3b25dd0c[3];
...
function function_dc378d61() {
    ...
    if (math::cointoss()) {
        ...
        if (isdefined(var_43123efe)) {
            var_43123efe.var_5c6f6051.var_43123efe = 80;
        ...
        if (isdefined(var_43123efe)) {
            ...
            var_43123efe.health.var_43123efe = 5;
            var_43123efe.var_2d1326e.var_43123efe = 1;
            v_offset = v_org;
...
function function_83e5a141() {
    ...
    if (isdefined(self.var_fe2612fe[#"hash_5615a127abad1354"])) {
        self.var_bce10cdf = namespace_8b6a9d79::function_f3d93ee9(self.var_fe2612fe[#"hash_5615a127abad1354"][0], #"hash_6a83a06a639fcc6b", 1);
...
function function_d137dbd4(instance, activator) {
    if (isplayer(activator)) {
        ...
        instance.var_74ec00fb.instance = 0;
        instance.n_zombies_max.instance = function_23ab0822();
        foreach (player in getplayers()) {
...
function function_27033bf7(instance) {
    ...
    nd_start.var_d5ebc20b.nd_start = getvehiclenode(nd_start.script_string, "targetname");
...
function function_7d3ebd69(instance) {
    ...
    if (isdefined(var_7ecdee63)) {
        var_e4c6e64a = namespace_85745671::function_9d3ad056(var_7ecdee63, var_3955def4, v_ang, "payload_zombie");
    } else {
    ...
    if (isdefined(var_e4c6e64a)) {
        var_e4c6e64a.var_a950813d.var_e4c6e64a = 1;
...
function function_899e4373(var_661691aa) {
    ...
    case 1:
    case 2:
        var_de82b392 = [0:#"hash_4f87aa2a203d37d0"];
        break;
    case 3:
    case 4:
        var_de82b392 = [2:#"hash_63cd2e85e68901a0", 1:#"hash_1aff4b71635bda08", 0:#"hash_4f87aa2a203d37d0"];
        break;
    case 5:
        var_de82b392 = [3:#"hash_455ec8cc0d1ed4a4", 2:#"hash_63cd2e85e68901a0", 1:#"hash_1aff4b71635bda08", 0:#"hash_4f87aa2a203d37d0"];
        break;
    case #"hash_defdefdefdefdef0":
        var_de82b392 = [5:#"spawner_bo5_abom", 4:#"hash_455ec8cc0d1ed4a4", 3:#"hash_704a090ff9fcffd0", 2:#"hash_63cd2e85e68901a0", 1:#"hash_1aff4b71635bda08", 0:#"hash_4f87aa2a203d37d0"];
        break;
    }
...
function function_b3791df9(*instance) {
    if (isdefined(level.var_7d45d0d4.activeobjective) && level.var_7d45d0d4.activeobjective.var_74ec00fb) {
        level.var_7d45d0d4.activeobjective.var_74ec00fb--;
    }
}
...
function function_22281e97(instance, n_players, var_559503f1) {
    ...
    instance endon(#"objective_ended");
    var_de82b392 = [];
    instance.var_e00b0988.instance = min(randomintrangeinclusive(n_players + level.var_b48509f9, n_players + level.var_b48509f9 * 2), 6);
    if (math::cointoss()) {
...
function function_77c42a22(instance) {
    ...
    for (i = 0; i < n_total; i++) {
        ...
        if (isdefined(ai_spawned)) {
            ...
            ai_spawned.var_8046dccf.ai_spawned = 1;
            ai_spawned thread function_bf606a73(self, instance);
            n_spawned++;
...
function function_9b6490c4(instance) {
    ...
    instance.n_active.instance = function_dae1a57b();
    instance.n_spawned.instance = 0;
    while (1) {
        level flag::wait_till("spawn_zombies");
...
function zombie_death_watcher(*params) {
    if (self.aitype === #"hash_7a8b592728eec95d" && !is_true(self.b_exploded)) {
        self.b_exploded = 1;
        if (isdefined(level.var_7d45d0d4.activeobjective.var_b8ca9d7)) {
            if (isdefined(self) && distance2dsquared(self.origin, level.var_7d45d0d4.activeobjective.var_b8ca9d7.origin) <= function_a3f6cdac(200)) {
                n_dmg = 50;
                level.var_7d45d0d4.activeobjective.var_b8ca9d7 dodamage(n_dmg, level.var_7d45d0d4.activeobjective.var_b8ca9d7.origin, self, undefined, undefined, "MOD_EXPLOSIVE");
            }
        }
    }
...
function function_785ea4f4(instance) {
    ...
    if (isdefined(self.var_43123efe)) {
        ...
        if (is_true(self.var_43123efe.var_2d1326e)) {
            ...
            self.var_43123efe function_cb48cddd();
        } else {
...
function function_6ae999c2(instance) {
    ...
    while (1) {
        ...
        foreach (player in a_players) {
            if (distancesquared(self.origin, player.origin) <= function_a3f6cdac(350) && !player laststand::player_is_in_laststand()) {
        ...
        if (isdefined(instance.var_f16db373)) {
            if (distance2dsquared(instance.var_f16db373.origin, self.origin) <= function_a3f6cdac(300)) {
                self.var_f4bd7934 = 1;
            }
        }
        if (isdefined(self.mdl_portal)) {
            if (distance2dsquared(self.mdl_portal.origin, self.origin) <= function_a3f6cdac(300) && !self.var_ee53f643) {
                self.var_f4bd7934 = 1;
            }
        }
...
function function_fa1230e0(instance) {
    ...
    self.var_b79a8ac7 = {#slots:slots, #var_f019ea1a:1000};
...
function function_3ef1d58a(instance, n_path) {
    if (instance.variant === "payload_noteleport") {
        var_cdce8e6f = instance.var_fe2612fe[#"hash_fc6148f0765e54b" + n_path][0];
    } else if (instance.variant === "payload_teleport") {
        var_cdce8e6f = instance.var_fe2612fe[#"hash_87cb4370bdebb2a" + n_path][0];
    }
...
function payload_teleport(instance) {
    ...
    while (1) {
        ...
        self.var_b591d382 = 1;
        self setbrake(1);
        self namespace_f3a74bbc::function_811514c3();
        if (isdefined(self.currentnode.script_string)) {
            ...
            var_b5ec4cd3.var_d5ebc20b.var_b5ec4cd3 = getvehiclenode(var_b5ec4cd3.script_string, "targetname");
            ...
            while (1) {
                ...
                if (!self.var_c57af231) {
                    self.var_c57af231 = 1;
                    while (!is_true(self.var_f4bd7934)) {
                        waitframe(1);
                    }
                    wait(0.5);
        ...
        foreach (player in getplayers()) {
            if (isalive(player)) {
                if (distance2dsquared(self.origin, player.origin) <= function_a3f6cdac(120) && !is_true(player.var_d23362c)) {
                    ...
                    player function_bc82f900("damage_heavy");
                    player.var_d23362c.player = 1;
                } else if (distance2dsquared(self.origin, player.origin) <= function_a3f6cdac(150) && !is_true(player.var_d23362c)) {
                    player dodamage(10, self.origin, self, self, undefined, "MOD_DEATH_CIRCLE");
                    player clientfield::set_to_player("" + #"hash_19f93b2cb70ea2c5", 1);
                    player function_bc82f900("damage_heavy");
                    player.var_d23362c.player = 1;
                } else if (distance2dsquared(self.origin, player.origin) <= function_a3f6cdac(180) && !is_true(player.var_d23362c)) {
                    player dodamage(5, self.origin, self, self, undefined, "MOD_DEATH_CIRCLE");
                    player clientfield::set_to_player("" + #"hash_19f93b2cb70ea2c5", 1);
                    player function_bc82f900("damage_light");
                    player.var_d23362c.player = 1;
                } else if (is_true(player.var_d23362c)) {
                    player.var_d23362c.player = 0;
                    player clientfield::set_to_player("" + #"hash_19f93b2cb70ea2c5", 0);
                }
            }
...
function function_42fbf5d9(instance, var_f00d1e) {
    ...
    n_dist = distance(self.var_a0bd9710.origin, var_f00d1e.origin);
    n_time = n_dist / 600;
    self.var_a0bd9710 moveto(var_f00d1e.origin + vectorscale((0, 0, 1), 40), n_time);
...
function function_4ebec20d(var_f00d1e) {
    self endon(#"death");
    if (!isdefined(self.var_cb43e7ed)) {
        self.var_cb43e7ed = util::spawn_model("tag_origin", var_f00d1e.origin, vectorscale((0, 1, 0), 90));
...
function function_6c09e96b(instance, n_time) {
    ...
    instance thread namespace_f3a74bbc::start_timer(n_time, "payload");
}
...
function function_1b4b0c63(var_b8ca9d7) {
    ...
    if (distance2dsquared(var_b8ca9d7.origin, self.origin) < function_a3f6cdac(70)) {
        gibserverutils::annihilate(self);
        if (isalive(self)) {
