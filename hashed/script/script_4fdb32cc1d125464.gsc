...
#namespace namespace_7d6f213d;

// Namespace namespace_7d6f213d/namespace_803268d1
// Params 1, eflags: 0x0
...
function function_b735db01() {
    ...
    level.adler thread function_aba34b0e();
...
function function_d883a464() {
    ...
    level.inside_man thread function_aba34b0e();
...
function infinite_ammo() {
    ...
    while (true) {
        ...
        for (i = 0; i < weapons.size; i++) {
            weapon = weapons[i];
            n_clip_size = level.player function_b7f1fd2c(weapon);
