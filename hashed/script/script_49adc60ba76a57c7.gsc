...
function function_295c9975() {
    ...
    self.var_473fb012 = 0;
    self.var_5212ce3 = namespace_ec06fe4a::function_b5731057("trigger_radius", self.origin, 2, 90, 60);
    if (isdefined(self.var_5212ce3)) {
        self.var_5212ce3 enablelinkto();
        self.var_5212ce3 thread namespace_ec06fe4a::function_d55f042c(self, "death");
        self.var_5212ce3 thread function_538a00bb(self);
        self.var_5212ce3 linkto(self, "tag_origin", vectorscale((0, 0, 1), 30));
    }
}
...
function function_67525edc(dustball) {
    ...
    foreach (target in enemies) {
        if (isplayer(target)) {
            ...
            if (distsq <= function_a3f6cdac(150)) {
...
function elephantstartdeath(elephant) {
    if (is_true(elephant.var_4be88248)) {
        return;
    }
    ...
    elephant.skipdeath.elephant = 1;
    elephant.diedinscriptedanim.elephant = 1;
    elephant.entrailsmodel.elephant = namespace_ec06fe4a::function_e22ae9b3(elephant.origin);
    ...
    elephant.var_4be88248.elephant = 1;
...
function private function_df15eebf(entity) {
    ...
    /#
        level thread function_5af86e1d(origin, 200, 5, (1, 0, 0));
    #/
    enemies = function_f6f34851(self.team);
    foreach (target in enemies) {
    ...
    if (entity.var_470f7225.size < 6 && randomint(100) < 25) {
        ...
        if (isdefined(ai)) {
            if (!isdefined(entity.var_470f7225)) {
                ...
                entity.var_470f7225.entity = array(entity.var_470f7225);
            }
            entity.var_470f7225[entity.var_470f7225.size] = ai;
        }
    }
    /#
        level thread function_5af86e1d(var_dc9ec224, 200, 5, (1, 0, 1));
    #/
...
function private function_1d65bc12(enemy, elephant, var_60e4c6b7 = 1) {
    ...
    if (distancesquared(enemy.origin, elephant.origin) > function_a3f6cdac(250)) {
        return 0;
    }
...
function function_cd472d5(entity) {
    ...
    if (distancesquared(entity.favoriteenemy.origin, entity.origin) < function_a3f6cdac(200)) {
        return 0;
    }
    fov = cos(30);
...
function function_ce8fe2b0(entity, var_ab9f62ef) {
    ...
    if (isdefined(closestpointonnavmesh)) {
        ...
        if (isdefined(dustball)) {
            dustball.var_6353e3f1.dustball = 1;
        ...
        /#
            recordsphere(var_6629fd0d, 15, (0, 0, 0), "<unknown string>");
        #/
    }
    wait(0.5);
    targets = getplayers();
...
function function_69faa74(entity) {
    ...
    if (distancesquared(entity.favoriteenemy.origin, entity.origin) < function_a3f6cdac(256)) {
        return 0;
    }
    fov = 60;
    if (!util::within_fov(entity.origin, entity.angles, entity.favoriteenemy.origin, fov)) {
...
function function_2bfd3841(entity) {
    ...
    var_51955401.enemy.var_51955401 = entity.favoriteenemy;
    entity.var_f6ea2286.entity = entity.favoriteenemy.origin;
...
function private elephantshouldmelee(entity) {
    ...
    if (disttoenemysq <= function_a3f6cdac(200) && abs(yawtoenemy) < 30) {
        return 1;
    }
    return 0;
}
    ...
    if (isdefined(entity.favoriteenemy)) {
        if (distance(entity.var_a6bdfeb8, entity.favoriteenemy.origin) > 6000) {
            if (distance(entity.var_a6bdfeb8, entity.origin) > 1000) {
                ...
                entity.var_473fb012.entity = 1;
            } else if (entity.health < entity.maxhealth) {
                entity.health.entity = entity.maxhealth;
            }
        } else {
            entity.ai.var_ea8d826a = 0;
            entity.var_473fb012.entity = 0;
        }
    }
...
function private function_f2c697c7(entity) {
    ...
    entity.ai.var_a504b9a3.var_190509f3 = function_a3f6cdac(250);
    entity.ai.var_a504b9a3.var_f84fafb2 = function_a3f6cdac(400);
    return 1;
}
...
function private function_5dee26ed(entity) {
    if (!isdefined(entity.var_261ff182)) {
        entity.var_261ff182.entity = entity.origin;
        entity.var_7ab66e6a.entity = gettime() + 2000;
