...
function private function_293c5838(var_87ee1a5d) {
    ...
    if (isstruct(loadouts) && isarray(loadouts.defaultloadouts) && loadouts.defaultloadouts.size > 0) {
        var_ccc75ba7 = randomint(loadouts.defaultloadouts.size);
        self function_6692a2a5(var_87ee1a5d, loadouts.defaultloadouts[var_ccc75ba7], loadouts.killstreaks);
    }
}
...
// Size: 0x6c
function private function_cbd58d72(var_87ee1a5d, var_31a03cfe, extragrenade, var_632ae174) {
    ...
    self [[ var_632ae174 ]](var_87ee1a5d, var_31a03cfe, extragrenade);
}
...
function private function_5d3cc643(var_87ee1a5d, var_3b0cd6f4) {
    self function_b4a1d42a(var_87ee1a5d);
    var_89003f51 = spawnstruct();
    bonuscards = function_20d254c4(var_3b0cd6f4.bonuscards, 6, #"hash_6400e1885e5d8aba");
    self function_73e20080(var_87ee1a5d, bonuscards, 1, var_89003f51);
    ...
    var_bc1ac364 = 5;
    if (is_true(var_89003f51.var_e22b188d)) {
        var_bc1ac364 = 8;
    }
    var_81b9e082 = 0;
    if (is_true(var_89003f51.var_c38351d8)) {
    ...
    self function_4426827d(var_87ee1a5d, var_414c7d4d, var_89003f51.var_1c89585f, &function_9a75f033);
    ...
    self function_4426827d(var_87ee1a5d, var_137939d4, 0, &function_493daf47);
    ...
    if (is_true(var_89003f51.var_65dd1449)) {
    ...
    } else if (is_true(var_89003f51.extraperks)) {
...
// Size: 0x2a0
function private function_fccfb0af(var_87ee1a5d, &var_19546df5, var_38e0e278, count, var_c2575532, var_1b426c77) {
...
// Size: 0xb0
function private function_73e20080(var_87ee1a5d, &var_44518c47, count, var_89003f51) {
    var_b8a59e38 = 0;
    while (var_b8a59e38 < count && var_44518c47.size > 0) {
        ...
        if (self function_f9b438ba(var_87ee1a5d, bonuscard, var_b8a59e38)) {
            var_b8a59e38++;
            function_13aa0d3(bonuscard, var_89003f51);
        }
    }
}
    ...
    /#
        ...
        while (1) {
            ...
            foreach (bot in bots) {
                ...
                var_8bd600a2 = var_3342d7a5[bot.team];
                if (!isdefined(var_8bd600a2)) {
                    var_8bd600a2 = [];
                    var_3342d7a5[bot.team] = var_8bd600a2;
                }
                ...
                if (isdefined(var_4deb6126)) {
                    for (i = 1; i <= var_4deb6126; i++) {
                        ...
                        if (!isdefined(var_8bd600a2[var_bed036f1][itemname])) {
                            var_8bd600a2[var_bed036f1][itemname] = 0;
                        }
                        var_8bd600a2[var_bed036f1][itemname]++;
                    }
                } else {
                    itemname = bot function_b958b70d(0, slot);
                    if (!isdefined(var_8bd600a2[slot][itemname])) {
                        var_8bd600a2[slot][itemname] = 0;
                    }
                    var_8bd600a2[slot][itemname]++;
                }
            }
            x = 30;
            foreach (team, var_8bd600a2 in var_3342d7a5) {
                ...
                y = y + 22;
                x = x + 20;
                foreach (slot, var_1f96cb8e in var_8bd600a2) {
