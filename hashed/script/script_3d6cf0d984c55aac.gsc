...
function function_d64a7119() {
    ...
    self waittill(#"hash_4a9c32153e908538");
    self.var_4d9b2bc3 = 1;
...
function function_60a583d8(str_objective, *var_50cc0d4f) {
    ...
    var_5e907852 = [level.woods, level.mason];
    if (isdefined(level.var_deda09e)) {
    ...
    var_5e907852 = arraycombine(var_5e907852, var_3e3877e9);
    var_5e907852[var_5e907852.size] = getplayers()[0];
    level thread scene::play("scene_duga_intro", "introCam", var_5e907852);
    level thread scene::play("scene_duga_intro_adler", "introCam", [level.adler]);
    level waittill(#"hash_4eb1d6bbf8be77fc");
    level thread scene::play("scene_duga_intro", "dt_enter", var_5e907852);
