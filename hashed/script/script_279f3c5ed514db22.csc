...
function private _objective(objective) {
    ...
    case #"infil":
        break;
    case #"hash_58782b355bcc3a9c":
        break;
    case #"hash_6156cf479c0f6f08":
        break;
    case #"hash_1cdb5cadb1e2b408":
        break;
    case #"graveyard":
        break;
    case #"hash_7433baf853004942":
        break;
    case #"hash_24e0b490649a9faf":
        break;
    case #"no_game":
        break;
    default:
...
function function_befba10a() {
    ...
    snd::function_b4de7637("interior", interior);
    snd::function_b4de7637("interior_cave", "interior");
}
