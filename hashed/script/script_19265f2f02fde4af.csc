...
function private function_2138c62(local_client_num, var_1e5d913d, damage_data, var_b33be77) {
    if (level.var_8a1c2b55.var_6a01400c >= 50) {
        /#
            if (getdvarint(#"hash_312f96d76ca3d249", 0)) {
                println("<dev string:xc2>" + var_1e5d913d + "<dev string:xf1>" + self.origin[0] + "<dev string:x9a>" + self.origin[1] + "<dev string:x9a>" + self.origin[2]);
            }
        #/
        return;
    }
        ...
        /#
            if (getdvarint(#"hash_312f96d76ca3d249", 0)) {
                if (!isplayer(damage_data.attacker)) {
                    println("<dev string:xfa>" + damage_data.attacker + "<dev string:x122>" + var_1e5d913d + "<dev string:xf1>" + self.origin[0] + "<dev string:x9a>" + self.origin[1] + "<dev string:x9a>" + self.origin[2]);
                    return;
                }
                println("<dev string:x137>" + damage_data.mod + "<dev string:x162>" + var_1e5d913d + "<dev string:xf1>" + self.origin[0] + "<dev string:x9a>" + self.origin[1] + "<dev string:x9a>" + self.origin[2]);
            }
        #/
        return;
    }
    ...
    if ((isdefined(var_2cc6e886.effect) ? var_2cc6e886.effect : "") == "") {
        /#
            if (getdvarint(#"hash_312f96d76ca3d249", 0)) {
                println("<dev string:x1c3>" + var_1e5d913d + "<dev string:xf1>" + self.origin[0] + "<dev string:x9a>" + self.origin[1] + "<dev string:x9a>" + self.origin[2]);
            }
        #/
        return;
    }
    ...
    if (data.var_33c88c75.size < (isdefined(var_2cc6e886.var_9d47943c) ? var_2cc6e886.var_9d47943c : 1) && level.var_8a1c2b55.var_f782e821[var_1e5d913d].size < (isdefined(var_2cc6e886.var_404a7d1) ? var_2cc6e886.var_404a7d1 : 1)) {
        ...
        foreach (var_b935e60d in var_b33be77) {
            ...
            if (!var_caa96e8a) {
                /#
                    if (getdvarint(#"hash_312f96d76ca3d249", 0)) {
                        println("<dev string:x1fb>" + dist + "<dev string:x237>" + var_1e5d913d + "<dev string:xf1>" + self.origin[0] + "<dev string:x9a>" + self.origin[1] + "<dev string:x9a>" + self.origin[2]);
                    }
                #/
        ...
        if (!var_7670388f) {
            /#
                if (getdvarint(#"hash_312f96d76ca3d249", 0)) {
                    println("<dev string:x23f>" + angle + "<dev string:x237>" + var_1e5d913d + "<dev string:xf1>" + self.origin[0] + "<dev string:x9a>" + self.origin[1] + "<dev string:x9a>" + self.origin[2]);
                }
            #/
            self function_2138c62(local_client_num, var_2cc6e886.var_fff670ab, damage_data, var_b33be77);
            return;
    ...
    /#
        if (getdvarint(#"hash_312f96d76ca3d249", 0)) {
            println("<dev string:x279>" + var_1e5d913d + "<dev string:xf1>" + self.origin[0] + "<dev string:x9a>" + self.origin[1] + "<dev string:x9a>" + self.origin[2]);
        }
    #/
    self function_2138c62(local_client_num, var_2cc6e886.var_fff670ab, damage_data, var_b33be77);
}
