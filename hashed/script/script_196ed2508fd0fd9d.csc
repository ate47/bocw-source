...
function event_handler[event_cc819519] function_686b88aa(*eventstruct) {
    ...
    level thread function_b4de7637();
...
function private _objective(objective) {
    ...
    case #"ghost_station":
        break;
    case #"hash_4ecd5f2af6e783ec":
        thread function_1d10f78a();
        break;
    case #"wall":
        break;
    case #"hash_4410298832f3b72e":
        break;
    case #"hash_4f5c4dd8e884633e":
    ...
    case #"hash_7c9605c7fc0bc113":
        break;
    case #"hash_7c9604c7fc0bbf60":
        break;
    case #"hash_5e641576941fbcb":
        break;
    case #"hash_49963566a5819e26":
        break;
...
function private _trigger(player, trigger, *var_ec80d14b) {
    ...
    case #"hash_3b879280dd0810a7":
        snd::function_645c2f9b(trigger, "ghost_station");
...
function private function_f2a2832d(*player, msg) {
    ...
    case #"hash_56ddea8ab25198a":
        ...
        break;
    case #"hash_209a9d6d81ba3a00":
        level notify(#"hash_209a9d6d81ba3a00");
        break;
    case #"hash_1803ae4099a2053":
        level notify(#"hash_1803ae4099a2053");
        break;
    ...
    case #"hash_6ba35d4654d272bb":
        thread function_9be3f816();
        break;
    case #"duck_ghost_station":
        thread duck_ghost_station();
        break;
    case #"hash_225109244d25775c":
        level notify(#"hash_225109244d25775c");
        break;
    case #"hash_6c4907a1cdd20f4e":
        break;
    ...
    case #"hash_41e362c76ad6bdb7":
        ...
        thread function_6c4ab3c5();
        break;
    case #"hash_769a83dab4c363e6":
        thread function_b21fcb00();
        break;
...
function function_b4de7637() {
    ...
    snd::function_b4de7637("ghost_station", ghost_station);
}
...
/#
    ...
    function function_570acc94(door, pos, angle, var_9528975d, var_695f85a3) {
        ...
        debugframes = 1;
        var_8764e9e6 = (0, 0, 0 - 1 * var_c75cd11f);
        snd::function_ac033c46(debugtext, pos + var_8764e9e6, 0.25 * var_c75cd11f, "<dev string:xc5>", debugcolor, var_7afd95ae, (0, 0, 0), var_74500ef, (1, 1, 1), var_74500ef, debugframes);
    }
    ...
    function function_8cdd2834() {
        ...
        self endon(#"death");
        while (true) {
            player = snd::function_2b2b83dc()[0];
            debuglevel = snd::function_95c9af4b();
            if (debuglevel >= 2 && snd::function_e3a36342(player)) {
                playervieworg = player snd::function_efda2d6d();
                playerangles = player snd::function_3d31768f();
                playerforward = anglestoforward(playerangles);
                playerfov = player snd::function_731299e5();
...
function function_ab91c6bd(max_angle, var_172ec4a2, center, var_56dde451, var_edbba9) {
    ...
    while (isdefined(door)) {
        ...
        var_9528975d = snd::function_a0a15145(angle, 0, max_angle, 0, 1);
        ...
        if (snd::function_a6779cbd(var_c5cdd961)) {
            if (var_695f85a3 >= 0.01) {
                snd::function_db78159d(var_c5cdd961, var_695f85a3, 0.05);
            } else {
            ...
            for (i = 0; i < var_edbba9.size; i++) {
                ...
                if (snd::function_a6779cbd(var_60e98817[i])) {
                    if (var_9528975d >= 0.01) {
                        snd::function_db78159d(var_60e98817[i], var_9528975d, 0.05);
                        continue;
                    }
...
// Size: 0xb0
function function_5c579972(var_ea431faf, vol, time) {
    foreach (snd in snd::function_f218bff5(var_ea431faf)) {
        snd::function_db78159d(snd, vol, time);
    }
}
...
function private function_c56d39dc() {
    ...
    level waittill(#"hash_1803ae4099a2053");
...
function function_87b5665d() {
    ...
    var_a206411d = 9;
    snd::function_db78159d(var_ca51e68c, snd::function_359f7bac(-7), var_a206411d);
    snd::function_db78159d(var_72f53060, snd::function_359f7bac(-10), var_a206411d);
    level waittill(#"hash_209a9d6d81ba3a00");
    wait 6;
    var_4a6d4f6 = snd::play([1, "emt_train_intro_slowdown_brakes"], (-8425, 8603, -122));
    snd::function_964c3a03(var_ca51e68c, snd::function_d8b24901(-24), 20);
    snd::function_964c3a03(var_72f53060, snd::function_d8b24901(-4), 20);
    snd::function_964c3a03(var_916fc49b, snd::function_d8b24901(-6), 20);
    snd::function_964c3a03(var_811a23f0, snd::function_d8b24901(-6), 20);
    snd::function_964c3a03(var_d5e1b4de, snd::function_d8b24901(-6), 20);
    snd::function_964c3a03(var_577a69e9, snd::function_d8b24901(-6), 20);
    snd::function_964c3a03(var_ef941a1e, snd::function_d8b24901(-6), 20);
    snd::function_964c3a03(var_ee5a8f04, snd::function_d8b24901(-6), 20);
    snd::function_964c3a03(var_1c996b81, snd::function_d8b24901(-6), 20);
...
function function_a6b9fbbd() {
    ...
    snd::function_db78159d(level.var_bf81dcc6, 0.3, 0.5);
...
function function_876b47e1(alias, time_min, time_max) {
    ...
    player endon(#"death");
    while (true) {
        playerview = player snd::function_efda2d6d();
...
function function_1a1fd87a() {
    ...
    level waittill(#"hash_225109244d25775c");
...
function function_9be3f816() {
    ...
    while (self.var_cbb87055 == 1) {
        ...
        scale = snd::function_a0a15145(dist, 0, 1300, 1, 0);
...
// Size: 0x104
function function_b21fcb00() {
    players = snd::function_da785aa8();
    player = players[0];
    var_b21fcb00 = snd::play([0, "amb_stk_police_build_up_lp", 20], (-1069, 9690, 60));
    snd::function_39dae8d8(var_b21fcb00, player, (-1069, 9690, 60), (-1078, 10173, 60));
    level waittill(#"hash_7c97bbd19494725c");
    snd::stop(var_b21fcb00, 5);
    wait 5;
    snd::function_ee110bf(var_b21fcb00);
}
...
function function_7d3ac608() {
    var_f00722ae = snd::play("veh_street_searched_lp_01", (-2493, 9458, 58));
    var_c3acc9ea = snd::play("veh_street_searched_lp_02", (-1967, 11722, 75));
    level flag::wait_till("snd_bar_started");
    snd::stop(var_f00722ae, 0.5);
    snd::stop(var_c3acc9ea, 0.5);
}
...
// Size: 0x11c
function function_6c4ab3c5() {
    snd = snd::play("amb_stk_police_build_up_bar_door_lp", (-1902, 9880, 90));
    snd::function_db78159d(snd, 0);
    wait 2;
    snd::function_db78159d(snd, 1, 1.5);
    wait 2;
    snd::function_db78159d(snd, 0.2, 1.5);
    wait 14;
    snd::function_db78159d(snd, 1, 1.5);
    wait 5;
    snd::function_db78159d(snd, 0.2, 1.5);
...
function function_6bd221d6() {
    ...
    var_c8ff805c = snd::play("amb_police_siren_intro", (-1376, 8118, 128));
    var_c8ff805c moveto((-787, 8113, 134), 1.5);
