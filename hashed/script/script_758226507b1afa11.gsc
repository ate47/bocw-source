        ...
        /#
            ...
            if (debuglevel >= 2 && snd::function_e3a36342(player)) {
                ...
                foreach (door_ent in var_17f47c08) {
                    ...
                    snd::function_ac033c46("<dev string:x4e>" + name, pos + (0, 0, -0.75 * var_c75cd11f * 24), 0.25 * var_c75cd11f, "<dev string:xcb>", (1, 1, 1), 1, (0, 0, 0), 0.9, (1, 1, 1), 0.9, 1);
                    snd::function_81183b3(pos, 12, door_ent.angles);
                }
            }
        #/
        waitframe(1);
...
function function_c26120ff(ent) {
    ...
    prefix = "male";
    head = ent.head;
    var_9805f0e = [#"hash_43efd33ef59eacf3", #"c_t9_eng_hero_park_head", #"c_t9_ger_civ_female_contact_head", #"c_t9_ger_civ_female_head01", #"c_t9_ger_civ_female_head01_hair_bld", #"c_t9_ger_civ_female_head01_attch_hair_a", #"c_t9_ger_civ_female_head02", #"hash_20281390aba2c662", #"hash_11f2d15844256b6f", #"hash_518b3394f8d89e00", #"c_t9_ger_civ_female_head03", #"hash_6e92bcee188ac06f", #"c_t9_ger_civ_female_head04", #"c_t9_ger_civ_female_head05", #"hash_46aa07eb539badad", #"c_t9_ger_civ_female_head06", #"hash_355a32fcc4ef0816", #"hash_185c7f215f3caad1", #"c_t9_ger_civ_female_target_edda_head_attch_hair_a", #"hash_10907c2b90e2ab7e", #"c_t9_net_civ_female_urban_waitress_head1_b", #"hash_1c835537e4613884"];
...
function function_cc419f00() {
    ...
    snd::client_msg(#"hash_1803ae4099a2053");
...
function function_81b3f069(volume) {
    ...
    while (!level flag::get("flag_phone_receiver_picked_up")) {
        ...
        snd::function_db78159d(level.var_9d6e61f8, level.var_2a973211);
        wait 2;
...
function function_db3e2ed5(phone) {
    ...
    if (isdefined(level.var_9d6e61f8)) {
        snd::function_db78159d(level.var_9d6e61f8, level.var_2a973211, 1.5);
    }
    if (isdefined(level.var_1e5c72de)) {
        snd::function_db78159d(level.var_1e5c72de, level.var_2a973211);
    }
...
function function_1a80eca8() {
    ...
    wait 2;
    radio snd::function_db78159d(0.5, 3);
    wait 12;
    snd::stop(radio, 4);
}
