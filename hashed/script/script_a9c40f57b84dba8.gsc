...
function function_70a657d8() {
    ...
    namespace_5b1144e::function_5ae4a10c(#"hash_2313390b260dd0bc", "sr_ee_hulk_wild_thing", undefined, undefined, #"hash_49a2dcb46e6d1d96");
...
function function_bbadd47c(localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwastimejump) {
    ...
    case 3:
        ...
        if (!isdefined(self.var_b892704e)) {
            ...
            self.var_b892704e = self playloopsound(#"hash_1a2a241912e15df7");
        }
...
function function_f23a642e(localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwastimejump) {
    ...
    if (bwastimejump) {
        ...
        var_c75c14fb.var_73f720d5 thread animation::play_siege(#"hash_7b620c1b52b80cda", undefined, 1, 1);
        util::playfxontag(fieldname, #"hash_54e03b0df8f82be2", var_c75c14fb.var_73f720d5, "tag_origin");
    } else if (isdefined(var_c75c14fb.var_73f720d5)) {
...
function function_5e51d561(localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwastimejump) {
    ...
    case 4:
        ...
        foreach (location in a_locations) {
            audio::playloopat(#"hash_6f54396f9343fc36", location);
    ...
    case 6:
        a_locations = array((-2429, -4277, 500), (-6407, -2881, 500));
        foreach (location in a_locations) {
            audio::stoploopat(#"hash_6f54396f9343fc36", location);
        ...
        case #"hash_46cb6387fd2006a7":
            ...
            case 2:
                ...
                if (!isdefined(var_b4488d57.var_e1cd0eb7)) {
                    ...
                    audio::playloopat(#"hash_6f54396f9343fc36", var_b4488d57.var_e1cd0eb7);
                }
                break;
            case 3:
                if (isdefined(var_b4488d57.var_2afde778)) {
                ...
                if (isdefined(var_b4488d57.var_e1cd0eb7)) {
                    ...
                    audio::stoploopat(#"hash_6f54396f9343fc36", var_b4488d57.var_e1cd0eb7);
...
function function_abac41c9(var_b4488d57, var_3e5ed63d) {
    ...
    mdl_origin = var_b4488d57.var_47e634f;
    while (!isdefined(mdl_origin)) {
        waitframe(1);
        mdl_origin = var_b4488d57.var_47e634f;
    }
...
function function_7da52bb6(localclientnum, var_a2fbae60) {
    ...
    var_a2fbae60.var_6aa3f2c3 animation::play_siege(#"hash_7215883c66396371", undefined, 1, 0);
    var_a2fbae60 show();
    wait(1);
