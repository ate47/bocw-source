...
// Namespace namespace_5cc6d100/namespace_13c9b452
// Params 0, eflags: 0x5
...
function private function_b0c8ef74(eventstruct) {
    ...
    if (!is_true(self.b_activated) && isdefined(self.instance.var_31919730)) {
        self.b_activated = 1;
        ...
        level scoreevents::doscoreeventcallback("scoreEventSR", {#location:self.instance.var_31919730.origin, #var_b0a57f8c:5000, #nearbyplayers:1, #scoreevent:"event_complete"});
...
function private function_5338581(instance) {
    instance.var_31919730 endon(#"death");
...
function private function_7914c7ef(var_85c920d0, *s_chest) {
    ...
    while (1) {
        ...
        if (isdefined(var_ff1022f3)) {
            ...
            foreach (player in a_players) {
                if (isdefined(player)) {
                    player val::function_e681e68e(#"hash_7f8d812db471e5ed");
                }
            }
            wait(var_89edfa);
        } else {
    ...
    foreach (ai in a_ai) {
        if (isalive(ai)) {
            if (ai.var_6f84b820 === #"normal") {
                ...
                } else if (ai.var_6f84b820 === #"hash_72d4f2ad2e333eb4") {
