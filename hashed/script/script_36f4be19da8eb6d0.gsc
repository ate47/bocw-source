...
function private function_70a657d8() {
    ...
    if (!isinarray(level.var_faabb06f, #"hash_5dd5741f21fd680d")) {
        level.var_faabb06f[level.var_faabb06f.size] = #"hash_5dd5741f21fd680d";
    }
    if (!isdefined(level.var_faabb06f)) {
        level.var_faabb06f = [];
    } else if (!isarray(level.var_faabb06f)) {
...
function function_18fbdeee() {
    ...
    while (1) {
        ...
        if (var_379c9ca1 < var_4745348a && !isdefined(self.crystal)) {
...
function function_d72b9d03(params) {
    ...
    } else if (function_7c292369(params.weapon)) {
        self.var_ebd66e27 = 1;
    ...
    } else if (function_f1c015e1(params.weapon)) {
    ...
    while (self throwbuttonpressed()) {
        ...
        foreach (trigger in var_6a77cda0) {
            if (function_bd61e5e5(trigger, view_pos, forward_view_angles)) {
                ...
                trigger notify(#"damage", {#var_98e101b0:1, #amount:function_a712364b(var_1c3abda3, trigger) * var_242262dc, #weapon:weapon, #attacker:self});
    ...
    while (gettime() < damageendtime) {
        ...
        foreach (target in all_targets) {
            if (isalive(target) && target getteam() == level.zombie_team || isinarray(var_b063467a, target)) {
                target dodamage(1500 * var_d3c8f6cd, target.origin, position, self, "none", "MOD_UNKNOWN", 0, getweapon(#"hash_6e0b27b854e591a3"));
