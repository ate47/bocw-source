...
function register(var_52c93aa0) {
    ...
    if (!isdefined(level.var_ae746e8f[#"hash_3ceffcd0b6394000"])) {
        level.var_ae746e8f[#"hash_3ceffcd0b6394000"] = [];
    }
    if (!isdefined(level.var_ae746e8f[#"hash_3ceffcd0b6394000"])) {
        level.var_ae746e8f[#"hash_3ceffcd0b6394000"] = [];
    } else if (!isarray(level.var_ae746e8f[#"hash_3ceffcd0b6394000"])) {
        level.var_ae746e8f[#"hash_3ceffcd0b6394000"] = array(level.var_ae746e8f[#"hash_3ceffcd0b6394000"]);
    }
    level.var_ae746e8f[#"hash_3ceffcd0b6394000"][level.var_ae746e8f[#"hash_3ceffcd0b6394000"].size] = elem;
}
