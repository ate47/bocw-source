...
function private autoexec __init__system__() {
    system::register(#"hash_6cff6e60e2fa224d", &function_70a657d8, &postinit, undefined, undefined);
}
...
function function_29307fae(struct) {
    ...
    foreach (point in spawn_points) {
        spawn_struct = point;
        var_16129dba = namespace_8b6a9d79::function_f3d93ee9(spawn_struct, #"p8_wz_ep_fishing_pole", 0);
        var_16129dba clientfield::set("set_compass_icon", 1);
        var_1dfa9e6 = namespace_8b6a9d79::function_f3d93ee9(spawn_struct, undefined);
        var_1dfa9e6 playloopsound(#"hash_30a2fa81c37f5aff");
        /#
            assert(isdefined(spawn_struct.var_fe2612fe[#"hash_a8d2c2c21149a79"]), "<unknown string>");
        #/
        var_c4b6fa2d = spawn_struct.var_fe2612fe[#"hash_a8d2c2c21149a79"];
        var_cf8192ca = namespace_8b6a9d79::function_f3d93ee9(var_c4b6fa2d[0], #"hash_dbe95bf7266e66b", 0);
        /#
            assert(isdefined(spawn_struct.var_fe2612fe[#"hash_61b2fec1f617bb75"]), "<unknown string>");
        #/
        ...
        var_cf8192ca.var_ccd7223.var_cf8192ca = var_cf8192ca.origin;
        var_cf8192ca hide();
...
function function_e126c567(eventstruct) {
    ...
    if (isdefined(self.var_cf8192ca) && isdefined(self.var_16129dba) && isdefined(self) && isdefined(self.var_9fadc93c) && isplayer(player)) {
        ...
        var_cf8192ca.origin.var_cf8192ca = var_9fadc93c.origin;
        ...
        var_cf8192ca.dropping_item.var_cf8192ca = 0;
...
function function_16e4e507(var_558f00ed, var_886a6495, trigger, var_da4747b7) {
            ...
            if (isdefined(var_886a6495)) {
                ...
                if (is_true(var_886a6495.var_3fa8a746) && float(var_219008d) / 1000 > 1) {
                    if (var_886a6495.dropping_item === 0) {
                        var_886a6495.dropping_item.var_886a6495 = 1;
                        var_886a6495 function_e8c63c15(self, var_da4747b7, trigger.var_ae5b8499);
                        var_886a6495 hide();
    ...
    if (isdefined(trigger)) {
        if (!isdefined(trigger.var_ae5b8499)) {
            trigger.var_ae5b8499.trigger = 0;
        }
        var_3f9d3194 = getdvarint(#"hash_2501edebf4b8b5d9", 0);
        if (!is_true(var_bca1290f) && !var_3f9d3194) {
            trigger.var_ae5b8499++;
        }
        if (trigger.var_ae5b8499 >= 3) {
            ...
            if (isdefined(var_558f00ed) && isdefined(var_886a6495)) {
                ...
                var_558f00ed function_cb48cddd();
                var_886a6495 function_cb48cddd();
            }
            ...
            if (isdefined(var_886a6495) && isdefined(trigger) && isdefined(var_558f00ed)) {
                trigger.isfishing.trigger = 0;
                var_886a6495.isfishing.var_886a6495 = 0;
                var_886a6495 notify(#"fishing_done");
                var_886a6495.origin.var_886a6495 = var_886a6495.var_ccd7223;
                var_886a6495 hide();
                var_558f00ed show();
...
function function_e8c63c15(player, var_da4747b7, index = 0) {
    if (isplayer(player)) {
        ...
        var_2858caa2 = {#angles:self.angles, #origin:self.origin};
        switch (index) {
        case 1:
        ...
        if (!var_8e313b1c) {
            dropitems = var_2858caa2 namespace_65181344::function_fd87c780(#"hash_421dc8edd3d4d053", 1, 0);
        }
        if (!isdefined(dropitems) || dropitems.size === 0 || var_8e313b1c) {
            ...
            foreach (dropitem in dropitems) {
                ...
                dropitem.var_a5626281.dropitem = 1;
...
function function_eaa298d9() {
    ...
    if (isdefined(var_3a1904d3) && isdefined(var_3a1904d3[#"point"])) {
        ...
        var_e5c73d65 = namespace_be0f9d50::function_fc585b51(var_9905e63e, undefined, #"hash_6290596be2341e21", 1);
        var_a6fe91fd = [];
        ...
        var_a6fe91fd[var_a6fe91fd.size] = var_e5c73d65;
        namespace_be0f9d50::function_55657fb4(undefined, var_e5c73d65, var_a6fe91fd);
    }
