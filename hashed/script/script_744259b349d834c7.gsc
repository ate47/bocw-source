...
function function_be4a6e08(target_player, score) {
    if (target_player flag::get(#"hash_60491982ef9b417f") && self.var_7418f498 !== target_player) {
        score = score + function_a3f6cdac(500);
    } else if ((!target_player flag::get(#"hash_60491982ef9b417f") || self.var_7418f498 === target_player) && distance2dsquared(self.origin, target_player.origin) < function_a3f6cdac(225)) {
        score = score - function_a3f6cdac(self.maxhealth * 2);
    }
    if (isdefined(level.var_632f9a2e[target_player getentitynumber()])) {
        ...
        score = score + function_a3f6cdac(300 * priority);
    }
    return score;
}
...
function private function_73156638(entity) {
    ...
    while (1) {
        ...
        if (var_4d21f369 === #"chase" && isplayer(entity.favoriteenemy) && !entity.favoriteenemy flag::get(#"hash_60491982ef9b417f")) {
            if (distancesquared(entity.origin, entity.favoriteenemy.origin) < function_a3f6cdac(500)) {
...
function private function_7d9fb4f4(params) {
    if (function_3c14ef44(self)) {
        ...
        if (isdefined(var_8378c252) && isdefined(params.vpoint) && distancesquared(var_8378c252, params.vpoint) < function_a3f6cdac(15)) {
            return 1;
        }
    }
    return 0;
...
function function_29c1ba76(*einflictor, eattacker, idamage, *idflags, smeansofdeath, weapon, *var_fd90b0bb, vpoint, *vdir, shitloc, *psoffsettime, *boneindex, *surfacetype) {
    ...
    return {#var_ebcff177:var_ebcff177, #weakpoint:weakpoint, #damage:vdir};
}
...
function private function_a3efd2ac(entity) {
    entity.var_5b358a38.entity = 0;
    entity.var_5015c6e8.entity = 0;
    entity.var_40994afa.entity = 0;
    entity.blockingpain.entity = 1;
}
...
function private function_fd74c2ff(entity) {
    ...
    entity.var_3ab5f48b.entity = gettime();
}
...
function function_c86ef1cd(entity) {
    ...
    if (isdefined(var_6f5b42c8)) {
        ...
        if (distancesquared(entity.origin, var_6f5b42c8.origin) < function_a3f6cdac(var_a77b530e)) {
            return 1;
        }
    }
    return 0;
...
function function_cc9102fc(entity) {
    /#
        entity.var_28a576a2.entity = gettime() + getdvarfloat(#"hash_7d6060c0af754b38", 0);
    #/
    entity.var_26dc9a8a.entity = [];
    var_bc1c3139 = function_a25a16fc(entity);
    var_24738af7 = 5 - var_bc1c3139.size;
    var_be5959b8 = 2000;
    if (isdefined(level.var_4206745e)) {
        entity.var_26dc9a8a.entity = array::get_all_closest(entity.origin, level.var_4206745e, var_bc1c3139, var_24738af7, 500);
    ...
    entity.var_9f171203.entity = gettime() + var_3d32e0f;
    entity.blockingpain.entity = 1;
}
...
function private function_690b6f24(entity) {
    if (isdefined(entity.var_26dc9a8a[0])) {
        var_c37b6517 = function_2981bd91(entity.var_26dc9a8a[0].origin - entity.origin);
        ...
        if (yaw_diff <= var_454b9186 && entity.var_4fbcec51 !== entity.var_26dc9a8a[0]) {
            ...
            entity.var_4fbcec51.entity = entity.var_26dc9a8a[0];
        }
    }
}
...
function private function_a95ee556(target) {
    ...
    while (isdefined(self) && isdefined(target) && gettime() < timeout && target flag::get(#"hash_335e103725141428")) {
        var_a592faf = getdvarfloat(#"hash_41aef1e31f496f99", 20);
        if (distancesquared(self.origin, target.origin + vectorscale((0, 0, 1), 50)) < function_a3f6cdac(var_a592faf)) {
            self delete();
        }
        waitframe(1);
    }
...
function function_78d5d69e(entity, *asmstatename) {
    ...
    if (gettime() > asmstatename.var_9f171203) {
        ...
        asmstatename.var_9f171203.asmstatename = gettime() + var_7a337533;
...
function function_e8a2d39a(entity, zombie) {
    /#
        if (distance2dsquared(entity.origin, zombie.origin) > function_a3f6cdac(500)) {
    ...
    while (1) {
        ...
        foreach (target in potential_targets) {
            ...
            if (isdefined(players) && isdefined(players[0])) {
                ...
                jumpcmp(distancesquared(closest_player.origin, target.origin) > function_a3f6cdac(200)) LOC_00000278;
            } else {
            LOC_00000278:
        ...
        for (var_10f063e1 = 0; var_10f063e1 < var_db920e6e.size; var_10f063e1++) {
            ...
            foreach (soa in var_db920e6e[var_10f063e1]) {
                if (isdefined(soa)) {
                    ...
                    soa.var_5b2fe31d.soa = players[var_10f063e1];
                    var_d74c0b86++;
                }
            }
        }
...
function private function_179244e9(entity) {
    var_bc1c3139 = function_a25a16fc(entity);
    if (5 - var_bc1c3139.size <= 0) {
        entity.var_4a8fb39d.entity = [];
        return;
    }
    var_e4b11b8a = 900;
    var_e4b11b8a = var_e4b11b8a - var_bc1c3139.size * 170;
    entity.var_4a8fb39d.entity = array::get_all_closest(entity.origin, level.var_4206745e, var_bc1c3139, undefined, var_e4b11b8a);
    /#
...
function private function_2ca0d658(entity) {
    ...
    for (i = 0; i < var_bc1c3139.size; i++) {
        var_cdb05658 = var_bc1c3139[i];
        var_cdb05658 flag::clear(#"hash_66428e102eda132b");
        if (isdefined(entity.favoriteenemy) && i <= var_bc1c3139.size / 2) {
            var_cdb05658.var_ff3cbd9e.var_cdb05658 = 1;
            if (i === 0) {
                var_cdb05658 flag::set(#"hash_66428e102eda132b");
                entity.var_6017b1f7 = var_cdb05658;
            }
        } else {
            var_cdb05658.var_ff3cbd9e.var_cdb05658 = 0;
        }
        var_cdb05658.var_bf2dba23 = i;
    }
}
...
function function_3d972f3(entity) {
    ...
    foreach (target in entity.var_4a8fb39d) {
        ...
        if (!isdefined(var_b4f61be8) || distance2dsquared(var_b4f61be8.origin, target.origin) > function_a3f6cdac(200)) {
...
function function_708afe1d(entity, state) {
    /#
        /#
            assert(isinarray([5:#"circle", 4:#"hash_110ee879f18b605f", 3:#"hash_685254f9ed0ce346", 2:#"hash_4ec3ec4f06b9498f", 1:#"chase", 0:#"hash_6192d8af630c6c07"], state), "<unknown string>");
        #/
    #/
...
function function_6dc728a2(entity, state, func) {
    if (!isdefined(entity.var_250ac321)) {
        entity.var_250ac321.entity = [];
    } else if (!isarray(entity.var_250ac321)) {
        entity.var_250ac321.entity = array(entity.var_250ac321);
    }
...
function function_82dc224a(entity, state, func) {
    if (!isdefined(entity.var_826cce6d)) {
        entity.var_826cce6d.entity = [];
    } else if (!isarray(entity.var_826cce6d)) {
        entity.var_826cce6d.entity = array(entity.var_826cce6d);
    }
...
function function_38cf7fb8(entity) {
    ...
    case #"chase":
        if (function_3c14ef44(entity)) {
            ...
            if (isdefined(entity.favoriteenemy) && entity cansee(entity.favoriteenemy)) {
                ...
                if (dist_sq < function_a3f6cdac(var_15f8df68)) {
                    new_move_speed = "locomotion_speed_walk";
                } else if (dist_sq < function_a3f6cdac(var_8b30afc5)) {
                    new_move_speed = "locomotion_speed_run";
                }
                ...
                var_9d4d90db = 0;
                if (dist_sq > function_a3f6cdac(500) && entity.var_5b2fe31d === entity.favoriteenemy) {
                    if (isdefined(level.var_632f9a2e[entity.favoriteenemy getentitynumber()][0])) {
                        ...
                        if (entity !== leader && distance2dsquared(entity.origin, leader.origin) < function_a3f6cdac(50)) {
                            var_9d4d90db = 1;
                            new_move_speed = "locomotion_speed_walk";
                        }
                    }
                ...
                if (var_bc1c3139.size > 1 && !var_9d4d90db) {
                    var_a949cfbb = 1;
                    foreach (var_cdb05658 in var_bc1c3139) {
                        if (isdefined(var_cdb05658) && vectordot(var_cdb05658.origin - entity.favoriteenemy.origin, entity.origin - entity.favoriteenemy.origin) > 0) {
                            var_ae33672a = math::closest_point_on_line(var_cdb05658.origin, entity.origin, entity.favoriteenemy.origin);
                            var_462633bf = distance2dsquared(var_cdb05658.origin, var_ae33672a);
                            if (var_462633bf < function_a3f6cdac(200)) {
                                var_a949cfbb = 0;
                                break;
                            }
                        }
    ...
    #/
    var_67328a14 = 1;
    if (!entity flag::get(#"hash_74881958905142d5")) {
        switch (var_4d21f369) {
        case #"chase":
            if (isdefined(entity.favoriteenemy)) {
...
function function_52ca7e05(entity) {
    ...
    if (var_4d21f369 === #"chase") {
        if (isdefined(entity.favoriteenemy) && distancesquared(entity.origin, entity.favoriteenemy.origin) < function_a3f6cdac(200) && entity cansee(entity.favoriteenemy)) {
            entity clearpath();
            return 0;
        }
    }
...
function function_f10f6b15(entity) {
    ...
    if (gettime() < entity.var_8196533 || isdefined(entity.var_78fdc8b4) && distance2dsquared(entity.var_78fdc8b4, entity.origin) < function_a3f6cdac(30)) {
    ...
    if (entity flag::get(#"hash_9f9406444a7e5b0")) {
        ...
        var_d7c0ff27 = entity.origin[2] - entity.var_5a0d79a4 - entity.favoriteenemy.origin[2];
        var_bbcca6fc = entity flag::get(#"hash_74881958905142d5") ? 75 : 50;
        if (isdefined(entity.var_48615dc2)) {
            var_bbcca6fc = [[ entity.var_48615dc2 ]](entity, var_bbcca6fc);
        }
        if (abs(var_d7c0ff27) > 250) {
            var_493731bd = 15;
        } else {
            var_493731bd = math::clamp(var_bbcca6fc - var_d7c0ff27, 15, var_d6d81c76);
        }
    }
    if (is_true(entity.var_5d8eb698)) {
        var_f990c5ac = entity getcentroid();
        entity.var_5d8eb698.entity = 0;
    } else {
        var_f990c5ac = entity geteye() + vectorscale((0, 0, 1), 5);
        entity.var_5d8eb698.entity = 1;
    }
    if (var_493731bd > 15 && function_d6eaf8b0(entity getvelocity()) > 0 && entity.var_5a0d79a4 > 10) {
        var_95f90063 = vectornormalize(entity getvelocity()) * 75;
        var_95f90063 = (var_95f90063[0], var_95f90063[1], 0);
        var_3396fda0 = bullettracepassed(var_f990c5ac, var_f990c5ac + var_95f90063, 0, entity);
        ...
        /#
            if (getdvarint(#"hash_20ead0e6e8e713d8", 0) > 0) {
                recordline(var_f990c5ac, var_f990c5ac + var_95f90063, var_3396fda0 ? (0, 1, 0) : (1, 0, 0));
            }
        #/
    }
    if (!isdefined(entity.var_c9738c9a)) {
        entity.var_c9738c9a.entity = 0;
    }
    if (var_493731bd > 15 && gettime() > entity.var_c9738c9a) {
        ...
        trace = bullettrace(var_f990c5ac, var_b18b5d80 + vectorscale((0, 0, 1), 70), 0, entity);
        ...
        if (!var_3396fda0) {
            ...
            entity.var_c9738c9a.entity = gettime() + int(0.5 * 1000);
            entity flag::set(#"hash_551edc835a4a0c30");
        } else {
            entity.var_c9738c9a.entity = gettime() + int(2 * 1000);
            entity flag::clear(#"hash_551edc835a4a0c30");
        }
        /#
            if (getdvarint(#"hash_20ead0e6e8e713d8", 0) > 0) {
                recordline(var_f990c5ac, var_b18b5d80 + vectorscale((0, 0, 1), 70), var_3396fda0 ? (0, 1, 0) : (1, 0, 0));
            }
        #/
    }
    entity.var_2e38a54d = var_493731bd;
...
function private function_73f51fce(*entity) {
    ...
    var_6c6317b9 = projected_point + forward_vec;
    var_53b2da60 = zombie_utility::function_d446de65(self, var_6c6317b9, 250);
    ...
    if (!isdefined(var_53b2da60) || var_317aba1e && !zm_utility::check_point_in_enabled_zone(var_53b2da60)) {
        var_6c6317b9 = var_6c6317b9 + forward_vec;
        var_53b2da60 = zombie_utility::function_d446de65(self, var_6c6317b9, 250);
    }
    if (!isdefined(var_53b2da60) || var_317aba1e && !zm_utility::check_point_in_enabled_zone(var_53b2da60)) {
        var_4a8a44e8 = anglestoright(self.angles) * 100;
        var_6c6317b9 = var_6c6317b9 + var_4a8a44e8;
        var_53b2da60 = zombie_utility::function_d446de65(self, var_6c6317b9, 250);
        if (!isdefined(var_53b2da60) || var_317aba1e && !zm_utility::check_point_in_enabled_zone(var_53b2da60)) {
            var_6c6317b9 = var_6c6317b9 - var_4a8a44e8 * 2;
            var_53b2da60 = zombie_utility::function_d446de65(self, var_6c6317b9, 250);
        }
    }
...
function function_ca5c24db(entity) {
    ...
    entity.var_293428fc.entity = entity.traversalendpos;
    if (isdefined(entity.traversemantlenode)) {
        entity.var_293428fc.entity = (entity.var_293428fc[0], entity.var_293428fc[1], max(entity.traversalendpos[2], entity.traversemantlenode.origin[2]));
    }
...
function function_5f116663(entity) {
    ...
    var_d7c0ff27 = math::clamp(entity.origin[2] - end_pos[2], 0, 200);
    var_d7c0ff27 = var_d7c0ff27 * 0.5;
    end_pos = (end_pos[0], end_pos[1], end_pos[2] + var_d7c0ff27);
    entity.var_d1669ee1.entity = {#start_angles:entity.angles, #var_62224b05:entity getvelocity(), #start_time:gettime(), #var_d7c0ff27:end_pos[2] - entity.origin[2], #var_1a655500:function_3a0a7a8(end_pos - entity.origin), #length:length(end_pos - entity.origin), #goal:end_pos, #start:entity.origin};
    entity.var_67faa700.entity = 1;
}
...
function function_69e1fc18(entity, *mocompanim, *mocompanimblendouttime, *mocompanimflag, *mocompduration) {
    ...
    mocompduration.var_d30b4aa3.mocompduration = 0;
}
...
function function_88023de5(entity, *mocompanim, *mocompanimblendouttime, *mocompanimflag, *mocompduration) {
    ...
    if (var_10160518.var_d7c0ff27 > 0) {
        percentage = function_cc279bde(percentage, 0, 1);
        new_origin = mocompduration.origin + vectornormalize(var_17075fc1) * var_6450293d;
        var_74d0dd30 = var_10160518.start[2] + var_10160518.var_d7c0ff27 * percentage;
        new_origin = (new_origin[0], new_origin[1], var_74d0dd30);
    } else if (lengthsquared(var_eb7e4cf7) <= function_a3f6cdac(var_10160518.var_1a655500)) {
        new_origin = mocompduration.origin + vectornormalize(var_17075fc1) * var_6450293d;
    ...
    mocompduration.var_d30b4aa3.mocompduration = (var_74d0dd30 - mocompduration.origin[2]) / 20;
    ...
    if (var_19eb3ee6 > speed && isdefined(mocompduration.favoriteenemy)) {
        ...
        new_angles = (0, function_2981bd91(to_enemy), 0);
...
function function_e4d60b47(entity) {
    if (isdefined(entity.var_d1669ee1) && distance2dsquared(entity.origin, entity.var_d1669ee1.goal) < function_a3f6cdac(15) && abs(entity.origin[2] - entity.var_d1669ee1.goal[2]) < 5) {
        return 1;
    }
    return 0;
}
...
function function_ca416ac3(entity) {
    ...
    if (var_4d21f369 === #"chase") {
        if (isdefined(entity.var_ea989fd2)) {
            if (distance2dsquared(entity.origin, entity.var_ea989fd2.var_827228db.origin) < function_a3f6cdac(30)) {
                return 1;
            }
        }
    }
...
function function_8b051aff(entity, *mocompanim, *mocompanimblendouttime, *mocompanimflag, *mocompduration) {
    mocompduration animmode("angle deltas noclip", 1);
    mocompduration.var_5b6bf2e7.mocompduration = 1;
}
...
function function_90db0e6d(entity, *mocompanim, *mocompanimblendouttime, *mocompanimflag, *mocompduration) {
    ...
    new_angles = (0, function_2981bd91(var_17075fc1), 0);
    mocompduration forceteleport(new_origin, new_angles, 0);
}
...
function function_d7a2a6d3(entity, *mocompanim, *mocompanimblendouttime, *mocompanimflag, *mocompduration) {
    mocompduration.var_5b6bf2e7.mocompduration = 0;
}
...
function private function_5b44f9c2(entity, asmstatename) {
    animationstatenetworkutility::requeststate(entity, asmstatename);
    if (!isdefined(entity.var_1389a0b3)) {
        entity.var_1389a0b3.entity = entity.var_ea989fd2;
    }
...
function private function_b2314b9(entity, *asmstatename) {
    ...
    if (distance2dsquared(asmstatename.origin, asmstatename.var_1389a0b3.var_b4a3c7c5.origin) < function_a3f6cdac(30)) {
...
function function_efa1ad6b(entity) {
    ...
    while (1) {
        ...
        if (zm_utility::function_21f4ac36() && !zm_utility::check_point_in_enabled_zone(entity.origin) && !entity flag::get(#"hash_74881958905142d5")) {
...
function private function_71cc3e18(entity) {
    ...
    if (isdefined(var_1f1f9cfa.goalpos)) {
        ...
        if (distance2dsquared(var_1f1f9cfa.goalpos, entity.origin) < function_a3f6cdac(var_9da7f6e5)) {
            return 0;
        }
    }
    return 1;
...
function private function_31a8422e(entity, asmstatename) {
    animationstatenetworkutility::requeststate(entity, asmstatename);
    entity.var_e63c4261.entity = gettime() + int(4 * 1000);
    entity flag::set(#"hash_74881958905142d5");
    ...
    entity.var_81d8adf.entity = gettime() + int(0.5 * 1000);
    entity.var_be4b6d94.entity = int(function_2981bd91(anglestoforward(entity.angles)));
    entity.blockingpain.entity = 1;
    return 5;
}
...
function private function_6965f1e3(entity, *asmstatename) {
    ...
    if (isdefined(asmstatename.favoriteenemy)) {
        var_8ebe7c9f = 200;
        if (distance2dsquared(asmstatename.origin, asmstatename.favoriteenemy.origin) < function_a3f6cdac(var_8ebe7c9f)) {
            return 4;
        }
    }
    var_1288d4ef = int(function_2981bd91(anglestoforward(asmstatename.angles)));
...
function private function_9769881(entity, *asmstatename) {
    asmstatename flag::clear(#"hash_74881958905142d5");
...
function function_ff6a04bc(entity) {
    ...
    entity.var_a6d2562d.entity = 1;
    entity.var_8cdffa65.entity = {#var_62224b05:entity getvelocity(), #dist:distance(entity.origin, var_79c8d3ac), #end_pos:var_79c8d3ac, #start_pos:entity.origin};
    return 1;
}
...
function private function_1a0791fc(entity, *asmstatename) {
    ...
    if (distance2dsquared(asmstatename.origin, var_79c8d3ac) < function_a3f6cdac(15)) {
        return 4;
    }
    return 5;
}
...
function private function_3e895403(entity, *asmstatename) {
    ...
    if (isdefined(asmstatename.var_8cdffa65)) {
        var_79c8d3ac = asmstatename.var_8cdffa65.end_pos;
        if (distance2dsquared(asmstatename.origin, var_79c8d3ac) < function_a3f6cdac(15)) {
            asmstatename.var_a6d2562d.asmstatename = 0;
        }
    }
    if (!isdefined(asmstatename.var_8cdffa65)) {
        asmstatename.var_a6d2562d.asmstatename = 0;
...
function function_f4e85274(entity, *mocompanim, *mocompanimblendouttime, *mocompanimflag, *mocompduration) {
    mocompduration animmode("angle deltas noclip", 1);
    mocompduration.var_5b6bf2e7.mocompduration = 1;
    mocompduration.var_c53ce8cb.mocompduration = 0;
    if (isdefined(mocompduration.var_8cdffa65)) {
        mocompduration.var_c53ce8cb.mocompduration = function_cd4d42c4(length(mocompduration.var_8cdffa65.var_62224b05));
    }
}
...
function function_3b5becd0(entity, *mocompanim, *mocompanimblendouttime, *mocompanimflag, *mocompduration) {
    ...
    sign = math::sign(var_2e49c72d - speed);
    if (sign >= 1) {
        speed = speed + 1.5;
    } else if (sign < 0) {
        speed = speed - 2;
...
function function_b046be53(entity) {
    ...
    var_1f1f9cfa = entity function_4794d6a3();
    if (entity flag::get(#"hash_7d6cd50c56c9ce7c") || isdefined(var_1f1f9cfa.goalpos) && distance2dsquared(entity.origin, var_1f1f9cfa.goalpos) < function_a3f6cdac(40)) {
        var_2cfb4597 = entity.origin - entity.favoriteenemy.origin;
        var_edd2d153 = function_2981bd91(var_2cfb4597);
        var_24af7a37 = 30;
        var_6f9adfe4 = [1:var_24af7a37 * -1, 0:var_24af7a37];
        var_5c85bc30 = [];
        var_bdca7c56 = 100;
        ...
        foreach (angle in var_6f9adfe4) {
            ...
            target_pos = entity.favoriteenemy.origin + var_dfa014f8 * var_bdca7c56;
...
function function_25517868(entity) {
    ...
    var_bd9572c6 = 0;
    if (!var_b859defb) {
        if (distancesquared(entity.origin, entity.favoriteenemy.origin) > function_a3f6cdac(225)) {
            var_131462f5 = 1;
        }
...
function private function_5d447a73() {
    ...
    if (var_4d21f369 === #"hash_110ee879f18b605f") {
        if (isdefined(self.var_d1669ee1)) {
            ...
            var_64e52c8e = int(function_2981bd91(to_goal));
...
function function_47f3f527(entity) {
    ...
    if (!entity cansee(entity.favoriteenemy)) {
        entity.var_fd7ccb7d.entity = gettime();
        return 0;
    }
    ...
    var_f2723316 = 200;
    if (isdefined(var_778aa7d8) && distancesquared(var_778aa7d8.origin, entity.favoriteenemy.origin) < function_a3f6cdac(var_f2723316)) {
    ...
    if (isdefined(var_c202a406[0])) {
        ...
        #/
        if (var_3396fda0) {
            entity.var_56877baf.entity = var_c202a406[0].origin;
...
function function_961c1fc0(entity) {
    ...
    entity.var_105f5842.entity = int(max(entity.health * 0.5, entity.health - entity.maxhealth * 0.1));
    entity.var_63a0699f.entity = {#var_d7c0ff27:var_615c3f7d[2] - entity.origin[2], #var_1a655500:function_3a0a7a8(var_615c3f7d - entity.origin), #length:length(var_615c3f7d - entity.origin), #goal:var_615c3f7d, #start:entity.origin};
    entity.var_67faa700.entity = 1;
}
...
function function_2a8799e1(entity, *mocompanim, *mocompanimblendouttime, *mocompanimflag, *mocompduration) {
    ...
    var_8d977686 = function_3a0a7a8(var_d15ca860);
    percentage = 1 - var_67662307 / var_6ceb29a9.length;
    var_84560a5f = 1 - var_8d977686 / var_6ceb29a9.var_1a655500;
    var_8ccce9cf = 1;
    if (percentage < 0.5) {
        var_8ccce9cf = 0.7 + function_cc279bde(percentage / 0.5, 1, 0) * 0.3;
    } else {
        var_8ccce9cf = max(1 - function_cc279bde((percentage - 0.5) / 0.5, 1, 0), 0.2);
    }
    ...
    if (var_67662307 > speed) {
        ...
        if (var_6ceb29a9.var_d7c0ff27 < var_6ceb29a9.var_1a655500) {
            var_afd96f54 = function_cc279bde(var_84560a5f, 1, 1);
        } else {
            var_afd96f54 = function_fed73db4(var_84560a5f, 2, 0, 1);
        }
        new_origin = (new_origin[0], new_origin[1], var_6ceb29a9.start[2] + var_6ceb29a9.var_d7c0ff27 * var_afd96f54);
    } else {
        new_origin = var_6ceb29a9.goal;
    }
    new_angles = mocompduration.angles;
    if (isdefined(mocompduration.favoriteenemy)) {
        new_angles = (0, function_2981bd91(mocompduration.favoriteenemy.origin - mocompduration.origin), 0);
    }
    mocompduration forceteleport(new_origin, new_angles, 0);
}
...
function function_ee1f25af(entity) {
    var_615c3f7d = function_60ddd10a(entity);
    if (distance2dsquared(entity.origin, var_615c3f7d) < function_a3f6cdac(15)) {
        return 1;
    }
    return 0;
}
...
function function_43413efd(entity) {
    ...
    entity.var_c5578297.entity = {#var_2a6a9eac:0, #var_c6194d4f:gettime() + int(5 * 1000), #var_3a668dd:gettime() + int(var_439b094d * 1000)};
}
...
function function_89dbf30f(entity) {
    ...
    if (isdefined(entity.favoriteenemy) && distancesquared(entity.origin, entity.favoriteenemy.origin) < function_a3f6cdac(200)) {
        return 1;
    }
...
function function_fe96f51d(entity) {
    ...
    entity.var_513787f6.entity = gettime();
    entity.var_cdc5412.entity = 1;
}
...
function function_e417cf33(entity) {
    ...
    if (isdefined(entity.favoriteenemy) && !entity cansee(entity.favoriteenemy)) {
        info.var_2a6a9eac.info = info.var_2a6a9eac + 1;
    }
}
...
function function_8096be0e(entity, *asmstatename) {
    ...
    if (isdefined(asmstatename.var_bcc78639[0]) && function_4fa84b3f(asmstatename, 1)) {
        ...
        if (isdefined(ai_spawned)) {
            ...
            asmstatename.var_71afd614.asmstatename = gettime() + int(2 * 1000);
            if (!isdefined(asmstatename.var_9dabebcd)) {
                asmstatename.var_9dabebcd.asmstatename = 0;
            }
...
function function_6b68419c(soa) {
    ...
    self.var_a1b40ce9 = 1;
    function_c33fb385(self, #"hash_1f50e1df5bdfdcf8");
...
function function_a4a6ada4(*s_params) {
    ...
    if (isalive(soa)) {
        if (isdefined(soa.var_f83eea5) && isdefined(soa.var_785a0384) && gettime() <= soa.var_f83eea5) {
            ...
            soa.var_f83eea5.soa = gettime() + 10000;
            soa.var_785a0384.soa = 1;
        }
    }
}
...
function function_d9fe2b0(zombie) {
    ...
    if (var_4d21f369 === #"hash_1f50e1df5bdfdcf8") {
        ...
        if (new_move_speed === "super_sprint") {
            ...
            if (distance2dsquared(zombie.origin, soa.origin) < function_a3f6cdac(100)) {
...
function function_dd116fa9(zombie, var_5f5dd627 = 0) {
    ...
    if (isdefined(var_1f1f9cfa.goalpos)) {
        ...
        var_ca94f78a = 150;
        if (isdefined(zombie.var_87c9386e) && distance2dsquared(zombie.var_87c9386e, var_962bde63) < function_a3f6cdac(var_ca94f78a)) {
            return zombie.var_87c9386e;
        } else {
            zombie.var_87c9386e = undefined;
        }
        var_f5b51915 = 150;
        if (distance2dsquared(zombie.origin, var_962bde63) < function_a3f6cdac(var_f5b51915)) {
            ...
            if (query.data.size > 0) {
                ...
                zombie.var_87c9386e.zombie = point.origin;
                return zombie.var_87c9386e;
            }
        }
        return var_962bde63;
...
function function_7d12a873(zombie, state, func) {
    if (!isdefined(zombie.var_e78db5d8)) {
        zombie.var_e78db5d8.zombie = [];
    } else if (!isarray(zombie.var_e78db5d8)) {
        zombie.var_e78db5d8.zombie = array(zombie.var_e78db5d8);
    }
...
function function_dfbc9dea(entity) {
    /#
        entity.var_22e5a90f.entity = gettime() + getdvarfloat(#"hash_19bf67ccf094da8b", 0);
    #/
    entity.blockingpain.entity = 1;
    if (isdefined(entity.favoriteenemy) && !isdefined(entity.attackable)) {
        entity.var_e3ce0a5f.entity = entity.favoriteenemy;
...
function function_4b5c56a5(entity) {
    ...
    if (!function_3c14ef44(entity)) {
        ...
        if (dist_sq < function_a3f6cdac(225) && var_913ff8ad && var_d91ee5f6 && var_4f24df4b && var_2a4acca4 && var_70fcb993 && var_be9a0d55) {
            entity.var_c8bed5f2.entity = 1;
        }
    } else {
        if (dist_sq > function_a3f6cdac(350)) {
            function_1b2f34c9(entity);
        }
        if (!var_4f24df4b) {
            function_1b2f34c9(entity);
        ...
        if (entity.var_b8114eb4 > 0.1 * entity.maxhealth) {
            function_1b2f34c9(entity);
            entity.var_c8489bd4.entity = gettime() + int(5 * 1000);
            if (!is_true(entity.var_5b6bf2e7)) {
                entity.var_5015c6e8.entity = 1;
            }
        }
...
function function_88f1c3bf(entity) {
    ...
    if (function_3c14ef44(entity) || !isdefined(target)) {
        entity.var_c8bed5f2.entity = 0;
        return;
    }
    entity.var_c8bed5f2.entity = 1;
    entity.var_7418f498 = target;
    entity thread function_a91b9ba0(entity, target);
    entity.var_b578c13b.entity = gettime() + int(6 * 1000);
    entity.var_b8114eb4.entity = 0;
    entity.var_c2e24cc8.entity = 0;
    entity.var_81e38bf6.entity = 0;
    ...
    while (function_3c14ef44(entity)) {
        ...
        var_790365b2 = var_790365b2 + entity.var_81e38bf6 * 0.9;
        entity.var_81e38bf6.entity = 0;
        ...
        entity.var_c2e24cc8.entity = entity.var_c2e24cc8 + var_790365b2;
        if (isplayer(entity.var_7418f498)) {
            damage = int(10);
        ...
        if (isdefined(entity.var_7418f498)) {
            attacker = entity;
            var_c2853de3 = entity.origin;
            if (isdefined(entity.var_443d78cc)) {
                attacker = entity.var_443d78cc;
                var_c2853de3 = entity.var_7418f498.origin;
            }
...
function function_ed9529fa() {
    /#
        ...
        add_debug_command("<unknown string>" + "<unknown string>" + "<unknown string>" + __index + "<unknown string>" + "<unknown string>" + "<unknown string>");
        __index++;
        __index = isdefined(__index) ? __index : 0;
        add_debug_command("<unknown string>" + "<unknown string>" + "<unknown string>" + __index + "<unknown string>" + "<unknown string>" + "<unknown string>");
        __index++;
...
function function_c221c3cc() {
    /#
        ...
        foreach (soa in soas) {
            soa.var_b1ee9658.soa = level.var_b1ee9658;
        }
...
function function_13f1306e() {
    /#
        ...
        soas = function_df254269();
        foreach (soa in soas) {
            soa.var_ed05cdb2.soa = level.var_ed05cdb2;
        }
    ...
    /#
        ...
        while (1) {
            ...
            if (isdefined(level.var_48137965)) {
                ...
                record3dtext("<unknown string>", level.var_48137965 + vectorscale((0, 0, 1), 15), (1, 0, 0));
            }
            soas = function_df254269();
            foreach (soa in soas) {
                recordcircle(soa.origin, 500, (1, 0, 0));
                zombies = isdefined(level.var_4206745e) ? level.var_4206745e : [];
                var_cdb05658 = function_a25a16fc(soa);
                var_3f16191b = get_all_closest(soa.origin, zombies, var_cdb05658, undefined, 500);
                ...
                if (isdefined(soa.var_4d56625b)) {
                    record3dtext("<unknown string>" + soa.var_4d56625b, soa.origin + vectorscale((0, 0, 1), 72), (0, 1, 0));
                }
            }
...
function function_7c39bab6() {
    /#
        ...
        foreach (soa in soas) {
            ...
            var_cdb05658 = function_a25a16fc(soa);
            var_3f16191b = get_all_closest(soa.origin, zombies, var_cdb05658, undefined, 500);
            foreach (target in var_3f16191b) {
        ...
        foreach (soa in function_df254269()) {
            if (isdefined(soa.favoriteenemy)) {
                if (!isdefined(soa.var_9634511)) {
                    soa.var_9634511.soa = beamlaunch(soa, soa.favoriteenemy, "<unknown string>", "<unknown string>", getweapon("<unknown string>"));
                } else {
...
function function_e970dd48() {
    /#
        iprintlnbold("<unknown string>");
        foreach (soa in function_df254269()) {
            soa.var_ad1a2a3c.soa = int(max((soa.var_ad1a2a3c + 1) % 4, 1));
...
function function_b4a17ed2() {
    /#
        ...
        foreach (soa in function_df254269()) {
            ...
            var_b1f9c3ce = function_6aee3a5b(soa, var_c1437145);
...
function function_4de3c0c() {
    /#
        ...
        if (!is_true(level.("<unknown string>"))) {
            level notify(#"hash_7bff198db7bad372" + "<unknown string>");
            return;
        }
    ...
    /#
        ...
        while (1) {
            foreach (soa in function_df254269()) {
                ...
                status = var_30b7a63c[#"path_prediction_status"];
                if (status == 2) {
                    var_e7bff847 = soa get(#"hash_5c35337a4e15867") ? "<unknown string>" : "<unknown string>";
                    record3dtext("<unknown string>" + var_e7bff847, soa.origin + vectorscale((0, 0, 1), 70), (0, 1, 0));
                    var_4487b2bf = soa getfinalpathpos();
                    recordline(soa.origin, var_4487b2bf, (0, 1, 0));
                } else {
                    var_e7bff847 = soa get(#"hash_5c35337a4e15867") ? "<unknown string>" : "<unknown string>";
                    record3dtext("<unknown string>" + var_e7bff847, soa.origin + vectorscale((0, 0, 1), 70), (1, 0, 0));
                }
            }
            waitframe(1);
        }
