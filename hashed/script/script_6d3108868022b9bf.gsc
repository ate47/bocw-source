...
function function_12624bb8(var_9e3df858, var_7b80750a) {
    ...
    /#
        ...
        init_dvar("Index", 0, &function_97c5cb9a);
...
function private function_97c5cb9a(params) {
    /#
        ...
        #/
        if (params.value) {
            var_cf1f3586 = [11:"<unknown string>", 10:"<unknown string>", 9:"<unknown string>", 8:"<unknown string>", 7:"<unknown string>", 6:"<unknown string>", 5:"<unknown string>", 4:"<unknown string>", 3:"<unknown string>", 2:"<unknown string>", 1:"<unknown string>", 0:"<unknown string>"];
            foreach (mission_name in var_cf1f3586) {
                if (is_true(function_2ee66e93(mission_name + "<unknown string>"))) {
                    function_6d003cb9(mission_name + "<unknown string>", 0);
                }
            }
...
function private function_fa4f5603(statemachine, var_9e3df858) {
    ...
    foreach (var_f2dfb976 in var_b6e3d0a.var_c8099c2) {
        if (var_f2dfb976.var_4c5c8430 == var_9e3df858) {
            foreach (var_1a8ef181 in var_f2dfb976.var_bd48fa38) {
                if (!isdefined(var_625dd793)) {
                    var_625dd793 = [];
                } else if (!isarray(var_625dd793)) {
                    var_625dd793 = array(var_625dd793);
                }
                var_625dd793[var_625dd793.size] = var_1a8ef181.var_3a61b479;
            }
            break;
        }
    }
    ...
    blackboard.var_7117f05e = [4:#"menu/heroic", 3:#"menu/veteran", 2:#"hash_5eb0fe85b0c234b0", 1:#"menu/regular", 0:#"menu/recruit"];
            ...
            if (isdefined(var_eeb11904.collectiblelist)) {
                ...
                foreach (index, item in collectibles) {
                    ...
                    if (collectible.var_4292acd3 === 1 && !var_be645ac2) {
                        ...
                        var_4f84589e = collectibles::function_1fe63475(var_eeb11904.var_8ca1d4a, index);
                        /#
                            if (level.var_5bd2109) {
                                var_4f84589e = 1;
                            }
                        #/
                        collectible.var_4f84589e = var_4f84589e;
                        if (var_4f84589e && (isdefined(collectible.var_5eeb1ad0) ? collectible.var_5eeb1ad0 : "") != "") {
                            /#
                        ...
                        if (!var_eeb11904.var_1ca68c21) {
                            if (var_4f84589e && collectibles::function_ee216b9e(var_eeb11904.var_8ca1d4a, collectible.var_2a51713)) {
...
// Size: 0xba
function private function_eaf23d80(var_300e5464) {
    /#
        assert(isdefined(var_300e5464));
    #/
    foreach (collectible in var_300e5464.var_dade7c7f) {
        if (is_true(collectible.var_4f84589e)) {
            return 1;
        }
    }
    return 0;
...
function private function_e768ae1e(var_d771858a, var_663c51cb, var_3cb3ede5) {
    ...
    if (isdefined(var_181973be)) {
        foreach (var_f1036742 in var_181973be) {
            if (isdefined(var_f1036742.var_4f84589e) && var_f1036742.var_4f84589e == 0) {
                continue;
            }
...
function private function_1e294fd9(var_625dd793, var_3cb3ede5) {
    foreach (mapname in var_625dd793) {
        var_300e5464 = var_3cb3ede5[mapname];
        var_4ff3b76c = getent(var_300e5464.var_4ff3b76c, "script_noteworthy");
        var_4ff3b76c show();
        var_f215acc = 1;
        if (function_8c91b796(var_300e5464)) {
            var_f215acc = 0;
        } else if (function_1447e257(var_300e5464)) {
            var_f215acc = 0;
        }
        if (var_f215acc) {
            if (savegame::function_ac15668a(mapname)) {
                var_4ff3b76c setmodel(var_300e5464.var_711c13dc);
            } else {
                var_4ff3b76c setmodel(var_300e5464.var_653c7d7d);
            }
        } else {
            var_4ff3b76c setmodel(var_300e5464.var_839276ad);
        }
    }
}
...
function private function_580e9a17(var_625dd793, var_3cb3ede5) {
    foreach (mapname in var_625dd793) {
        var_300e5464 = var_3cb3ede5[mapname];
        var_d65f7c8b = !is_true(var_300e5464.var_32a51de2) && !function_1447e257(var_300e5464) && !savegame::function_ac15668a(mapname);
        /#
        ...
        #/
        if (var_d65f7c8b) {
            function_a548b274(var_300e5464);
        } else {
            function_5fbd9a9c(var_300e5464);
        }
        var_29af538f = var_300e5464.var_1ca68c21;
        /#
            if (is_true(level.var_99e01934)) {
                var_29af538f = 1;
            }
        #/
        if (var_29af538f) {
            function_a40db718(var_300e5464);
        } else {
            function_50542db7(var_300e5464);
        }
    }
}
...
// Size: 0x9a
function private function_a548b274(var_300e5464) {
    if (isdefined(var_300e5464.var_8349c453)) {
        return;
    }
    /#
        assert(isdefined(var_300e5464.var_f8097243));
    #/
    var_d9200ec3 = struct::get(var_300e5464.var_f8097243);
    if (isdefined(var_d9200ec3)) {
        var_300e5464.var_8349c453 = spawn("script_origin", var_d9200ec3.origin);
    }
}
...
// Size: 0x34
function private function_5fbd9a9c(var_300e5464) {
    if (isdefined(var_300e5464.var_8349c453)) {
        var_300e5464.var_8349c453 delete();
    }
}
...
// Size: 0x9a
function private function_a40db718(var_300e5464) {
    if (isdefined(var_300e5464.var_1a7f654)) {
        return;
    }
    /#
        assert(isdefined(var_300e5464.var_212ee626));
    #/
    var_d9200ec3 = struct::get(var_300e5464.var_212ee626);
    if (isdefined(var_d9200ec3)) {
        var_300e5464.var_1a7f654 = spawn("script_origin", var_d9200ec3.origin);
    }
}
...
// Size: 0x34
function private function_50542db7(var_300e5464) {
    if (isdefined(var_300e5464.var_1a7f654)) {
        var_300e5464.var_1a7f654 delete();
    }
}
...
// Size: 0x46
function private function_1447e257(var_300e5464) {
    return is_true(var_300e5464.var_e4f432d9) && !savegame::function_ac15668a(var_300e5464.var_d7ba74ee);
}
...
// Size: 0x3e
function private function_8c91b796(var_300e5464) {
    return is_true(var_300e5464.var_32a51de2) && !function_eaf23d80(var_300e5464);
}
...
// Size: 0x288
function private function_e8e65a88(statemachine, var_c8cd02ad) {
    player = self;
    /#
        assert(isplayer(player));
    #/
    ...
    blackboard.var_481d0fb1 = [0:var_c8cd02ad];
    while (1) {
...
function private function_6d01a6c8(*params) {
    ...
    level.statemachine.blackboard.var_63754fbc util::function_cf42fd2f("tag_origin", (0, 0, 0), #"hash_400e97432023f9f3", 160, undefined, &function_b0a92909);
...
function private function_5501ae88() {
    ...
    if (!savegame::function_2ee66e93("ExamineEvidenceHintShown", 0)) {
        ...
        namespace_61e6d095::function_d3c3e5c3(#"hint_tutorial", [1:#"hash_af16b6b2e499098", 0:#"dialog_tree"]);
        savegame::function_6d003cb9("ExamineEvidenceHintShown", 1);
        waitframe(1);
...
function private function_587e1291(blackboard) {
    ...
    if (!savegame::function_2ee66e93("SideMissionUnlockedHintShown", 0)) {
        ...
        foreach (mapname in blackboard.var_625dd793) {
            var_300e5464 = blackboard.var_3cb3ede5[mapname];
            if (is_true(var_300e5464.var_32a51de2)) {
                var_e0e794c5 = 1;
                break;
            }
        }
        ...
        namespace_61e6d095::function_46df0bc7(#"hint_tutorial", 999);
        namespace_61e6d095::function_d3c3e5c3(#"hint_tutorial", [1:#"hash_af16b6b2e499098", 0:#"dialog_tree"]);
        savegame::function_6d003cb9("SideMissionUnlockedHintShown", 1);
        waitframe(1);
        player hint_tutorial::pause(undefined, undefined, 2, undefined, undefined, 1);
        wait(0.5);
    }
...
function private function_bdf71927(*params) {
    ...
    if (player function_305352b5()) {
        ...
        player function_5953bec0("cinematicmotion_static");
        ...
        var_96b6affa = {#var_531201f1:&function_4b717253, #var_be77841a:0, #complete_callback:&function_fb5a7ab1, #var_4d98c3ce:#"hash_6c7bb285599937ba", #var_de6f0004:0, #var_4ac77177:0};
        foreach (trigger in blackboard.var_3c3d8c0b) {
            trigger.var_f90e2591 = &function_e976f5d3;
            trigger.var_938b0e9b = &function_cab79d7e;
            var_300e5464 = blackboard.var_3cb3ede5[trigger.script_noteworthy];
            if (function_1447e257(var_300e5464)) {
                trigger.var_d9b5c896 = isdefined(var_300e5464.var_c4ac97e4) ? var_300e5464.var_c4ac97e4 : var_300e5464.var_bf26b910;
                trigger.var_94ca2a30 = isdefined(var_300e5464.var_bd8e2ffe) ? var_300e5464.var_bd8e2ffe : var_300e5464.var_2dd3e7b0;
            } else {
                trigger.var_d9b5c896 = var_300e5464.var_bf26b910;
                trigger.var_94ca2a30 = var_300e5464.var_2dd3e7b0;
            }
    ...
    player val::set(#"hash_c93076d66f8f7c0", "show_hud", 0);
...
function private function_d50da7b8(blackboard) {
    ...
    waitframe(1);
    player val::function_e681e68e(#"hash_5f70dbe5f8e16583");
}
...
function private function_22ec525a(blackboard) {
    ...
    player val::set(#"hash_c93076d66f8f7c0", "show_hud", 1);
    namespace_c8e236da::function_c27f93d5();
    ...
    if (isdefined(player.var_c9b94b07)) {
        player function_5953bec0(player.var_c9b94b07);
        player.var_c9b94b07 = undefined;
    } else {
        player function_c98cb594();
    }
    waitframe(1);
    player unlink();
    player playgestureviewmodel("dem_lowreadyup", undefined, undefined, 1);
    player val::function_e681e68e(#"hash_6f8f850d83573a8f");
...
function private function_5b9bb291(*params) {
    ...
    if (var_6f3b6154) {
        ...
        namespace_61e6d095::function_9ade1d9b(#"hash_3ccc1702bc979da8", "LevelName", isdefined(evidence.var_c4ac97e4) ? evidence.var_c4ac97e4 : evidence.var_bf26b910);
    ...
    var_8670e6a3 = savegame::function_6440b06b(#"persistent", blackboard.var_c5bde695);
    if (is_true(var_8670e6a3.complete) && isdefined(var_8670e6a3.var_8757a567)) {
        var_4a19e561 = blackboard.var_7117f05e[var_8670e6a3.var_8757a567];
    ...
    if (player function_305352b5()) {
        ...
        namespace_61e6d095::function_df0d7a85(#"hash_3ccc1702bc979da8", [0:#"interactive_map"]);
        ...
        if (isdefined(evidence.var_d832c7fb) && evidence.var_d832c7fb.size > 0 && !var_5c5bb311) {
            ...
            savegame::function_6d003cb9(blackboard.var_c5bde695 + "_intro_vo_played", 1);
        }
...
function private function_93dd1a56(var_ed4d2551) {
    ...
    foreach (vox in var_ed4d2551) {
        self namespace_a635adb1::radio(vox.vox);
...
function private function_c7ffe282(*params) {
    ...
    while (1) {
        ...
        } else if (option.var_70b35161 == 0) {
            /#
                assert(isdefined(blackboard.var_c5bde695));
            #/
            safehouse = savegame::function_8136eb5a();
            var_fd031e6 = blackboard.var_c5bde695;
            var_cc500e2b = function_2717b55f(var_fd031e6);
            savegame::function_6d003cb9("previous_safehouse", safehouse);
            var_a71d5880 = savegame::function_6440b06b(#"persistent", var_fd031e6);
            namespace_61e6d095::function_73c9a490(#"hash_3ccc1702bc979da8", 0);
            if (var_fd031e6 == "cp_nic_revolucion" && !is_true(var_a71d5880.complete)) {
                player thread globallogic_ui::function_4e49c51d(#"hash_53f4004442386d39", #"hash_4f8c4e1b714e2e90", 0, &function_1c9f3744, &function_5058b4e9, var_fd031e6);
            } else if (isdefined(var_cc500e2b) && is_true(var_cc500e2b.var_32a51de2)) {
                var_a71d5880 = savegame::function_6440b06b(#"persistent", var_fd031e6);
                if (is_true(var_a71d5880.complete)) {
                    function_9f6854a1(var_fd031e6);
                } else if (var_fd031e6 == "cp_sidemission_takedown") {
                    if (!is_true(player_decision::function_ee124ba3())) {
                        player thread globallogic_ui::function_4e49c51d(#"hash_7f4487a7da679130", #"hash_746b9b6a5211589d", 0, &function_9f6854a1, &function_5058b4e9, var_fd031e6);
                    } else {
                        function_9f6854a1(var_fd031e6);
                    }
                } else if (var_fd031e6 == "cp_sidemission_tundra") {
                    var_a24e9150 = savegame::function_2ee66e93(#"hash_470832ca3fa7ae83", []);
                    var_8f36ce4a = 0;
                    foreach (var_7253f96e in var_a24e9150) {
                        if (is_true(var_7253f96e.var_be6485f7)) {
                            var_8f36ce4a++;
                        }
                    }
                    if (var_8f36ce4a < 3) {
                        player thread globallogic_ui::function_4e49c51d(#"hash_1c8813eba3d3c667", #"hash_67bdd3726f291f0e", 1, undefined, &function_5058b4e9, var_fd031e6);
                    } else {
                        player thread globallogic_ui::function_4e49c51d(#"hash_1c8813eba3d3c667", #"hash_2db99449b922dd5c", 0, &function_9f6854a1, &function_5058b4e9, var_fd031e6);
                    }
                }
            } else {
                function_1c9f3744(var_fd031e6);
            }
        } else if (option.var_70b35161 == 3) {
            /#
                /#
...
// Size: 0x5c
function private function_1c9f3744(var_fd031e6) {
    player = getplayers()[0];
    player notify(#"hash_3ac28b014653cac6");
    skipto::function_1c2dfc20(var_fd031e6);
}
...
// Size: 0x1a4
function private function_9f6854a1(var_fd031e6) {
    ...
    safehouse = savegame::function_8136eb5a();
    if (player stats::get_stat(#"hash_1e7fdd28f2a28f78", var_fd031e6, #"hash_4f37204358803a0f") <= 0) {
        player stats::set_stat(#"hash_1e7fdd28f2a28f78", var_fd031e6, #"hash_4f37204358803a0f", getmaporder(safehouse) + 1);
    }
    skipto::function_1c2dfc20(var_fd031e6);
}
...
function private function_7dfbe539() {
    ...
    player namespace_a635adb1::function_9e580f95();
}
...
function private function_de709256(*params) {
    ...
    #/
    evidence = blackboard.var_3cb3ede5[blackboard.var_c5bde695];
    namespace_61e6d095::function_df0d7a85(#"hash_34f10865afcf9af7", [0:#"interactive_map"]);
...
function private function_35a396ee(*params) {
    ...
    while (1) {
        ...
        } else if (result.response == #"hash_79587d9fe84f7a23") {
            if (!var_fc34020f) {
...
// Size: 0x4c
function private function_54e62ef2(*var_ced72ebc, *newindex) {
    player = self;
    /#
        assert(isplayer(player));
    #/
...
function private function_e6734894(*params) {
    ...
    namespace_61e6d095::function_f2a9266(#"hash_afc09dfd34bcde0", var_625081d5, "Thumbnail", var_7fb2f6df.var_115998e3);
...
function private function_85113485() {
    ...
    #/
    player notify(#"hash_7a4583c1e3b9ee99", {#var_8a547b69:"evidence_board_evidence_floppy_callback_finished", #var_ea190649:blackboard.var_7fb2f6df});
}
...
function private function_dd090dfe(*params) {
    ...
    if (player function_a997529d()) {
        ...
        namespace_c8e236da::function_c27f93d5();
        waitframe(1);
    } else if (namespace_61e6d095::exists(#"hash_afc09dfd34bcde0")) {
        namespace_61e6d095::remove(#"hash_afc09dfd34bcde0");
    }
}
...
function private function_e2e9758c(*params) {
    ...
    if (player function_305352b5()) {
        ...
        foreach (index, collectible in evidence.var_dade7c7f) {
            ...
            namespace_61e6d095::function_f2a9266(#"hash_afc09dfd34bcde0", index, "IsUnlocked", collectible.var_4f84589e);
            var_335de244 = collectibles::function_ee216b9e(evidence.var_8ca1d4a, collectible.var_2a51713);
            namespace_61e6d095::function_f2a9266(#"hash_afc09dfd34bcde0", index, "IsNew", var_335de244);
        }
        if (function_1447e257(evidence)) {
            namespace_61e6d095::function_9ade1d9b(#"hash_afc09dfd34bcde0", "text", isdefined(evidence.var_c4ac97e4) ? evidence.var_c4ac97e4 : evidence.var_bf26b910);
        } else {
...
// Size: 0x384
function private function_9019d1f0(var_ced72ebc, newindex) {
    player = self;
    /#
        assert(isplayer(player));
    #/
    ...
    if (is_true(var_38d97d58.var_4f84589e) && collectibles::function_606a97af(var_38d97d58.callback)) {
    ...
    if (var_ced72ebc >= 0) {
        namespace_61e6d095::function_f2a9266(#"hash_afc09dfd34bcde0", var_ced72ebc, "IsNew", 0);
    }
    if (is_true(var_38d97d58.var_4f84589e)) {
...
function private function_aa81758f(var_520cb95d, isvisible) {
    /#
        assert(isdefined(var_520cb95d.var_4f84589e));
    #/
    if (var_520cb95d.var_4f84589e) {
