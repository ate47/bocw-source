...
// Size: 0xb4
function function_501002d8(var_c116fb71, fx_struct) {
    level endon(#"flg_ac130_done");
    while (true) {
        var_7b1b5529 = var_c116fb71 waittill(#"damage");
...
function function_e1201e79() {
    level endon(#"flg_ac130_done");
    var_c116fb71 = getent("ac130_player_killed_volume", "targetname");
    while (true) {
        var_7b1b5529 = var_c116fb71 waittill(#"damage");
...
function function_353a1ac4() {
    level endon(#"flg_ac130_done");
    var_c116fb71 = getent("ac130_player_shot_balloon_volume", "targetname");
    var_9d262a11 = (40, 40, -10);
    level thread function_b8f67d09(var_c116fb71.origin + var_9d262a11);
    while (true) {
        var_7b1b5529 = var_c116fb71 waittill(#"damage");
        if (var_7b1b5529.attacker === level.player) {
