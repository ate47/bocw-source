...
class class_7c3faeda : cluielem {
    ...
    function set_state(localclientnum, state_name) {
        ...
        } else if (#"hash_1c7fa28cf1485078" == state_name) {
            [[ self ]]->set_data(localclientnum, "_state", 1);
        } else if (#"hash_41af72ac3698f06f" == state_name) {
            [[ self ]]->set_data(localclientnum, "_state", 2);
        } else if (#"hash_5b1f56f3d27d25f0" == state_name) {
            [[ self ]]->set_data(localclientnum, "_state", 3);
        } else if (#"hash_249ee0339eddec66" == state_name) {
            [[ self ]]->set_data(localclientnum, "_state", 4);
        } else if (#"hash_55a524ad199904e9" == state_name) {
            [[ self ]]->set_data(localclientnum, "_state", 5);
        } else if (#"hash_37b2af92df0bfd42" == state_name) {
            [[ self ]]->set_data(localclientnum, "_state", 6);
        } else if (#"hash_30029804cf01e828" == state_name) {
            [[ self ]]->set_data(localclientnum, "_state", 7);
        } else if (#"hash_386af01523f194e5" == state_name) {
            [[ self ]]->set_data(localclientnum, "_state", 8);
        } else if (#"hash_c5a40437efffe76" == state_name) {
            [[ self ]]->set_data(localclientnum, "_state", 9);
        } else if (#"hash_88bd3835c23cdbc" == state_name) {
            [[ self ]]->set_data(localclientnum, "_state", 10);
        } else if (#"hash_55e75da288d110d4" == state_name) {
            [[ self ]]->set_data(localclientnum, "_state", 11);
        } else if (#"hash_3eb38ea38a92fe35" == state_name) {
            [[ self ]]->set_data(localclientnum, "_state", 12);
        } else if (#"hash_79efd6a9d00cac13" == state_name) {
