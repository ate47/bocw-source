...
function init() {
    ...
    clientfield::register("world", "setWildTOD", 1, 3, "int", &function_d20e2ef3, 0, 0);
    ...
    level.var_8cff5775.var_581c8f9a = [];
    foreach (var_46058269 in var_581c8f9a) {
        ...
        level.var_8cff5775.var_581c8f9a[level.var_8cff5775.var_581c8f9a.size] = var_f784a248;
    }
    function_32d5e898();
}
...
function function_32d5e898(localclientnum) {
    level.var_8cff5775.var_47dcd1f = undefined;
    level.var_8cff5775.var_f9d8fba5 = undefined;
    level.var_8cff5775.var_7c19cda1 = undefined;
    if (isdefined(level.var_8cff5775.var_e2a9584a)) {
        stopradiantexploder(localclientnum, level.var_8cff5775.var_e2a9584a);
        level.var_8cff5775.var_e2a9584a = undefined;
    }
}
...
function function_cb179d87(*localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwastimejump) {
    level.var_8cff5775.var_47dcd1f = undefined;
    foreach (var_46058269 in level.var_8cff5775.var_581c8f9a) {
        if (var_46058269.id == bwastimejump) {
            level.var_8cff5775.var_47dcd1f = var_46058269;
            return;
        }
    }
}
...
function function_68800b79(*localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwastimejump) {
    level.var_8cff5775.var_f9d8fba5 = bwastimejump + 1;
}
...
function function_d20e2ef3(localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwastimejump) {
    if (isdefined(level.var_8cff5775.var_e2a9584a)) {
        stopradiantexploder(fieldname, level.var_8cff5775.var_e2a9584a);
        level.var_8cff5775.var_e2a9584a = undefined;
    }
    if (!isdefined(level.var_8cff5775.var_47dcd1f)) {
        return;
    }
    level.var_8cff5775.var_7c19cda1 = "morning";
    switch (bwastimejump) {
    case 0:
        level.var_8cff5775.var_7c19cda1 = "morning";
        ...
        break;
    case 1:
        level.var_8cff5775.var_7c19cda1 = "noon";
        setworldfogactivebank(fieldname, 2);
        break;
    case 2:
        level.var_8cff5775.var_7c19cda1 = "dusk";
        setworldfogactivebank(fieldname, 4);
        break;
    case 3:
        level.var_8cff5775.var_7c19cda1 = "night";
    ...
    /#
        function_f5f0c0f8("<unknown string>" + level.var_8cff5775.var_47dcd1f.name + "<unknown string>" + level.var_8cff5775.var_7c19cda1);
    #/
    level.var_8cff5775.var_e2a9584a = "fxexp_" + level.var_8cff5775.var_47dcd1f.name + "_section_" + level.var_8cff5775.var_f9d8fba5 + "_" + level.var_8cff5775.var_7c19cda1;
    /#
        function_f5f0c0f8("<unknown string>" + level.var_8cff5775.var_e2a9584a + "<unknown string>" + fieldname);
    #/
    playradiantexploder(fieldname, level.var_8cff5775.var_e2a9584a);
}
