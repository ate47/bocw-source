...
#namespace namespace_a36c1b9c;

// Namespace namespace_a36c1b9c
// Method(s) 19 Total 26
class class_df106b1 : cluielem {

    // Namespace class_df106b1/namespace_a36c1b9c
    // Params 0, eflags: 0x8
    ...
    // Namespace namespace_df106b1/namespace_a36c1b9c
    // Params 1, eflags: 0x0
...
// Namespace namespace_a36c1b9c/namespace_a36c1b9c
// Params 4, eflags: 0x0
...
function register(xcallback, ycallback, heightcallback, fadeovertimecallback, alphacallback, redcallback, greencallback, bluecallback, var_f5852d69, horizontal_alignmentcallback, var_9194fd72, var_3d17213, var_766e2bbb) {
    ...
    if (!isdefined(level.var_ae746e8f[#"hash_5502671cf92712a9"])) {
        level.var_ae746e8f[#"hash_5502671cf92712a9"] = [];
    }
    if (!isdefined(level.var_ae746e8f[#"hash_5502671cf92712a9"])) {
        level.var_ae746e8f[#"hash_5502671cf92712a9"] = [];
    } else if (!isarray(level.var_ae746e8f[#"hash_5502671cf92712a9"])) {
        level.var_ae746e8f[#"hash_5502671cf92712a9"] = array(level.var_ae746e8f[#"hash_5502671cf92712a9"]);
    }
    level.var_ae746e8f[#"hash_5502671cf92712a9"][level.var_ae746e8f[#"hash_5502671cf92712a9"].size] = elem;
}
