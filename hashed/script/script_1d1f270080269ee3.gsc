...
#namespace namespace_5d49f2b;

// Namespace namespace_5d49f2b/namespace_329b9fe5
// Params 1, eflags: 0x0
...
function function_8279b9f2() {
    ...
    level.var_e3baf491 = util::spawn_anim_model("rus_phone_wall_01_anim");
    var_6b5c13c2 = [];
    var_6b5c13c2[#"hash_46c654596c31b1f2"] = level.var_e3baf491;
...
function function_25831409(a_ents) {
    guy = a_ents[#"hash_7efd5b42507d9720"];
    guy endon(#"death");
...
function function_c44b308e(a_ents) {
    guy = a_ents[#"hash_7efd5e42507d9c39"];
    guy endon(#"death");
    level endon(#"hash_619863a87e777fd1");
...
function function_65b9c362(a_ents) {
    guy = a_ents[#"hash_7efd5d42507d9a86"];
    guy endon(#"death");
    level endon(#"hash_619863a87e777fd1");
