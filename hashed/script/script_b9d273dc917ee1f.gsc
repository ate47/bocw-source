...
function private function_9b30a057() {
    ...
    foreach (var_19a3087c in var_ce9ccdf6) {
        ...
        } else if (var_19a3087c.mapname === level.script && function_46181f8c(var_19a3087c) && function_fe74d984(var_19a3087c)) {
            if (!isdefined(var_a2b0b0d1)) {
                var_a2b0b0d1 = [];
            } else if (!isarray(var_a2b0b0d1)) {
                var_a2b0b0d1 = array(var_a2b0b0d1);
...
function function_9799c283() {
    if (level flag::get(#"hash_7d519492b49fd308") && !is_true(self.var_d02cff4e)) {
                ...
                if (isarray(var_495fa1f8.var_de540b3a)) {
                    ...
                    foreach (var_6a51d7c1 in var_495fa1f8.var_de540b3a) {
                        if (isdefined(var_6a51d7c1.var_b09e2381) && self.name != var_495fa1f8.var_bdb97676.var_b09e2381) {
                            var_6a51d7c1 function_2ac7114f(self);
                            if (!isdefined(var_6a51d7c1.var_699c6bfb)) {
                                var_6a51d7c1.var_699c6bfb.var_6a51d7c1 = [];
                            } else if (!isarray(var_6a51d7c1.var_699c6bfb)) {
                                var_6a51d7c1.var_699c6bfb.var_6a51d7c1 = array(var_6a51d7c1.var_699c6bfb);
                            }
                    ...
                    var_495fa1f8.var_bdb97676.var_495fa1f8 = function_2ba45c94(var_495fa1f8.scriptbundlename, var_495fa1f8.origin, var_495fa1f8.angles, vectorscale((1, 1, 1), 64), undefined, undefined, self.name, 0);
                    if (!isdefined(var_495fa1f8.var_de540b3a)) {
                        var_495fa1f8.var_de540b3a.var_495fa1f8 = [];
                    } else if (!isarray(var_495fa1f8.var_de540b3a)) {
                        var_495fa1f8.var_de540b3a.var_495fa1f8 = array(var_495fa1f8.var_de540b3a);
                    }
                    ...
                    var_495fa1f8.var_bdb97676 function_2ac7114f(self);
                }
            } else if (is_true(var_495fa1f8.script_enable_on_start)) {
        ...
        foreach (var_db4d0036 in level.var_35aa6043) {
            ...
            if (self function_f0f36d47(var_db4d0036.var_d5fa8477) || isdefined(var_db4d0036.var_b09e2381) && self.name != var_db4d0036.var_b09e2381) {
                var_db4d0036 function_2ac7114f(self);
                if (!isdefined(var_db4d0036.var_699c6bfb)) {
                    var_db4d0036.var_699c6bfb.var_db4d0036 = [];
                } else if (!isarray(var_db4d0036.var_699c6bfb)) {
                    var_db4d0036.var_699c6bfb.var_db4d0036 = array(var_db4d0036.var_699c6bfb);
                }
...
function function_aa317cfe() {
    ...
    foreach (var_41c6d68b in var_80198f58) {
        if (!isdefined(var_41c6d68b.faction)) {
            var_41c6d68b.faction.var_41c6d68b = isdefined(var_41c6d68b.script_string) ? var_41c6d68b.script_string : "";
        }
        ...
        var_41c6d68b.var_bdb97676.var_41c6d68b = util::spawn_model(isdefined(var_41c6d68b.model) ? var_41c6d68b.model : var_bed5445b, var_41c6d68b.origin, var_41c6d68b.angles);
    ...
    if (isdefined(var_99bf2e73.scriptbundlename) && !isdefined(var_99bf2e73.var_bdb97676) && !function_1a594d26(var_d5fa8477)) {
            ...
            if (isdefined(point.var_a6762160)) {
                foreach (player in getplayers()) {
                    if (isdefined(player) && !player function_f0f36d47(var_d5fa8477)) {
                        var_99bf2e73.var_bdb97676.var_99bf2e73 = function_2ba45c94(var_d5fa8477, var_99bf2e73.origin, var_99bf2e73.angles, vectorscale((1, 1, 1), 64), undefined, undefined, player.name, 0);
                        if (!isdefined(var_99bf2e73.var_de540b3a)) {
                            var_99bf2e73.var_de540b3a.var_99bf2e73 = [];
                        } else if (!isarray(var_99bf2e73.var_de540b3a)) {
                            var_99bf2e73.var_de540b3a.var_99bf2e73 = array(var_99bf2e73.var_de540b3a);
                        }
                ...
                var_99bf2e73.var_bdb97676.var_99bf2e73 = util::spawn_model(s_bundle.model, var_99bf2e73.origin, var_99bf2e73.angles);
        ...
        foreach (player in getplayers()) {
            if (player function_f0f36d47(var_d5fa8477)) {
                var_99bf2e73.var_bdb97676 function_2ac7114f(player);
            }
        }
        var_99bf2e73.var_bdb97676.var_d86211f5 = 1;
...
function function_2ba45c94(var_d5fa8477, v_pos, v_ang = (0, 0, 0), var_cd038aea, var_d65061b2 = 0, b_play_fx = 0, var_b09e2381, var_7e1bf71f = 2) {
    ...
    if (isdefined(s_bundle.itemspawnentry)) {
        ...
        if (isdefined(point.var_a6762160)) {
            ...
            var_bdb97676.var_d5fa8477.var_bdb97676 = hash(var_d5fa8477);
            var_bdb97676.var_cbbbaf39.var_bdb97676 = 1;
            ...
            foreach (player in getplayers()) {
                if (player function_f0f36d47(var_d5fa8477) || isdefined(var_bdb97676.var_b09e2381) && player.name != var_bdb97676.var_b09e2381) {
                    var_bdb97676 function_2ac7114f(player);
                    if (!isdefined(var_bdb97676.var_699c6bfb)) {
                        var_bdb97676.var_699c6bfb.var_bdb97676 = [];
                    } else if (!isarray(var_bdb97676.var_699c6bfb)) {
                        var_bdb97676.var_699c6bfb.var_bdb97676 = array(var_bdb97676.var_699c6bfb);
                    }
        ...
        while (1) {
            ...
            foreach (player in getplayers()) {
                if (isdefined(self.var_b09e2381) && player.name == self.var_b09e2381 || !isdefined(self.var_b09e2381) && !player function_f0f36d47(self.var_d5fa8477)) {
                    v_offset = (player getentitynumber() + 1) * vectorscale((0, 0, -1), 5);
...
function private function_b0049c2a(params) {
    ...
    if (isplayer(self) && isdefined(item.var_d5fa8477) && !self function_f0f36d47(item.var_d5fa8477)) {
        self function_3ad8805e(item.var_d5fa8477, item);
    }
}
...
function private function_8176b2c7(e_player) {
    ...
    if (var_bdb97676.var_9be0526e === #"hash_20ea75a25d912949" && level flag::get(#"hash_5c4e5d3571f5e1f6")) {
        return 0;
    }
    if (isdefined(var_bdb97676.var_32edbef9)) {
        if (!isdefined(var_bdb97676.var_56c62073)) {
            var_bdb97676.var_56c62073.var_bdb97676 = [];
        }
    ...
    if (!isdefined(var_d5fa8477) || e_player function_f0f36d47(var_d5fa8477) || var_bdb97676.var_9be0526e === #"hash_20ea75a25d912949" && e_player.var_b21b857[var_bdb97676.faction] >= 1) {
        if (isdefined(var_d5fa8477) && is_true(level.var_eb704e15[var_d5fa8477][e_player.name])) {
            ...
            var_bdb97676 function_2ac7114f(e_player);
            return 0;
        }
        return 1;
    }
...
function private function_a78987b(e_player) {
    ...
    while (1) {
        ...
        e_player thread function_3ad8805e(var_d5fa8477, var_bdb97676);
    }
}
...
// Size: 0x5cc
function function_3ad8805e(var_d5fa8477, var_bdb97676, var_eac6151d, var_54c59ebe = 0) {
    ...
    self notify(#"hash_73cdf2e630b0bf6b");
    ...
    if (isdefined(var_bdb97676) && !is_true(var_bdb97676.var_71396476) && !is_true(var_71396476)) {
        if (function_1a594d26(var_d5fa8477) || isdefined(var_bdb97676.var_b09e2381) && isdefined(self.name) && var_bdb97676.var_b09e2381 == self.name) {
            ...
            var_bdb97676 function_2ac7114f(self);
        }
    }
}
...
function function_3a2dd570(e_player) {
    if (isplayer(e_player)) {
        if (!isplayer(self) && isdefined(self.var_9be0526e) && self.var_9be0526e != #"hash_20ea75a25d912949") {
            self function_2ac7114f(e_player);
        }
...
function function_3f3be625(var_d5fa8477, var_eac6151d) {
    ...
    if (isarray(var_eac6151d.var_7e1c3be1) && var_eac6151d.var_7e1c3be1.size && !is_true(var_1bdc121e)) {
        ...
        var_eac6151d.var_7e1c3be1.var_eac6151d = [];
    }
    s_bundle = getscriptbundle(var_d5fa8477);
    ...
    if (isarray(s_bundle.var_1ad142ee) && s_bundle.var_1ad142ee.size) {
        if (is_true(s_bundle.var_2a12d36)) {
            foreach (var_73a92203 in s_bundle.var_1ad142ee) {
                if (index == s_bundle.var_1ad142ee.size - 1) {
                    ...
                    var_eac6151d thread function_8a6749e9(var_73a92203.var_46bd7973, self, var_73a92203.var_f35c5951, undefined, undefined, var_1bdc121e);
                }
            }
        } else {
            foreach (var_73a92203 in s_bundle.var_1ad142ee) {
                var_eac6151d function_8a6749e9(var_73a92203.var_46bd7973, self, undefined, var_73a92203.var_f35c5951, var_73a92203.var_5d4b5964, var_1bdc121e);
            }
        }
        if (isdefined(var_eac6151d.script_flag_true) && !level flag::get(var_eac6151d.script_flag_true)) {
            ...
            if (isdefined(var_eac6151d) && isplayer(self)) {
                var_eac6151d function_2ac7114f(self);
            }
        }
    }
...
function function_2bcfd899(var_f84ece9f, player) {
    if (isdefined(level.var_fa1d4366)) {
        ...
        foreach (var_a36fa2c6 in var_71b26808.var_572513bb) {
            ...
            } else if (!function_1a594d26(var_a36fa2c6.var_cb9cd317) && function_43abed5a(var_a36fa2c6.var_cb9cd317)) {
                return var_a36fa2c6.var_cb9cd317;
            }
        }
    }
...
function private on_ai_killed(params) {
    if (isplayer(params.eattacker) && (self.var_6f84b820 === #"hash_72d4f2ad2e333eb4" || self.var_6f84b820 === #"special")) {
    ...
    if ((isdefined(level.var_fa1d4366) || (self.var_6f84b820 === #"special" || self.var_6f84b820 === #"hash_72d4f2ad2e333eb4") && isplayer(params.eattacker) && (level.var_df1d1235 >= 4 || math::cointoss(10))) && function_44fcc093(self.origin)) {
        var_44a24b57 = self.origin + vectorscale((0, 0, 1), 36);
        if (self.archetype === #"avogadro" && level.script === "zm_tungsten") {
            var_44a24b57 = var_44a24b57 + vectorscale((0, 0, 1), 16);
        }
...
function function_20c3dbfd(a_players, var_44a24b57, var_85225c01 = 0, var_7e1bf71f) {
    ...
    foreach (player in a_players) {
        ...
        if (isdefined(var_d5fa8477)) {
            ...
            var_bdb97676 = function_2ba45c94(var_d5fa8477, var_44a24b57, v_angles, vectorscale((1, 1, 1), 64), undefined, undefined, player.name, var_7e1bf71f);
            player.var_e2d764da++;
            if (isdefined(var_bdb97676.var_a6762160)) {
                var_bdb97676.var_a6762160.var_4cd830a = 1;
            }
            if (zm_utility::is_survival()) {
                player.var_cfc2f4bc.player = 1;
            }
        }
    }
}
...
function function_ded2880a() {
    /#
        init_dvar(#"hash_82bcb0445b8db9", "<unknown string>", &function_2ced1cf7);
        init_dvar(#"hash_10552bfd7317e7d1", "<unknown string>", &function_2ced1cf7);
        init_dvar(#"hash_4bb23fc5179a1812", "<unknown string>", &function_2ced1cf7);
        init_dvar(#"hash_6aad5d3866085387", "<unknown string>", &function_2ced1cf7);
        ...
        foreach (var_d5fa8477 in level.var_54f9341) {
            ...
            if (isdefined(s_bundle)) {
                if (isdefined(s_bundle.var_ad4ad686)) {
                    var_fd5d9570 = function_9e72a96(s_bundle.var_ad4ad686);
                } else {
                    var_fd5d9570 = "<unknown string>";
                }
                ...
                var_2b65c1ac = var_fd5d9570 + "<unknown string>" + str_type + "<unknown string>" + var_7e4f1bf + "<unknown string>" + var_d5fa8477;
            } else {
                var_2b65c1ac = var_d5fa8477;
            }
            add_debug_command("<unknown string>" + var_2b65c1ac + "<unknown string>" + var_d5fa8477 + "<unknown string>");
            add_debug_command("<unknown string>" + var_2b65c1ac + "<unknown string>" + var_d5fa8477 + "<unknown string>");
            add_debug_command("<unknown string>" + var_2b65c1ac + "<unknown string>" + var_d5fa8477 + "<unknown string>");
        }
    #/
...
function function_2ced1cf7(params) {
    /#
        ...
        case #"hash_82bcb0445b8db9":
            foreach (player in getplayers()) {
                player thread function_3ad8805e(params.value);
            }
            break;
        case #"hash_10552bfd7317e7d1":
            ...
            if (!isdefined(v_pos)) {
                var_a3d40366 = get_array("<unknown string>");
