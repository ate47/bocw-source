...
function function_2ce126c4() {
    ...
    if (is_true(getgametypesetting(#"hash_cd096e90260a26b"))) {
        ...
        foreach (zone in level.var_d4c0ef1a) {
            ...
            if (level.var_8de4d059 === #"hash_5543f175d93fb94d" && zone.script_index === 2) {
                arrayremovevalue(level.var_d4c0ef1a, zone);
            }
        }
        if (level.var_8de4d059 === #"hash_2459f519d45e8534") {
            var_2a924a32 = [3:(190, 1602, 138), 2:(741, -1534, 139), 1:(-623, -2237, 152), 0:(335, -2212, 150)];
            foreach (v_loc in var_2a924a32) {
                var_478072ca = util::spawn_model("tag_origin", v_loc, (0, 0, 0));
                var_478072ca.usecount.var_478072ca = 0;
        ...
        if (level.var_8de4d059 === #"hash_7b6185cd75172582") {
            ...
            spawncollision("collision_clip_wall_128x128x10", "collider", (7.25, -1219, 54.25), vectorscale((0, 1, 0), 53));
            spawncollision("collision_clip_wall_128x128x10", "collider", (-164.75, -1090, 54.25), vectorscale((0, 1, 0), 53));
        }
    }
    ...
    #/
    /#
        if (is_true(level.var_612d6a21) || get_game_type() === #"hash_75aa82b3ae89f54e") {
        ...
        while (1) {
            ...
            foreach (spawnpt in spawns) {
                ...
                if (is_true(spawnpt.used)) {
                    function_11a1e593(var_b3dbfd56 + vectorscale((0, 0, 1), 10), (1, 0, 0), 1);
                    function_11a1e593(var_b3dbfd56 + vectorscale((0, 0, 1), 40), (1, 0, 0), 1);
                    function_11a1e593(var_b3dbfd56 + vectorscale((0, 0, 1), 80), (1, 0, 0), 1);
                }
            }
            waitframe(1);
        }
...
function function_ec2b3302() {
    var_8314a02e = 0;
    if (level.var_9b7bd0e8 >= 3 || level.var_50c8366e > 9) {
        var_8314a02e = 5;
    } else {
...
function function_8b930ad1() {
    ...
    self.var_9a2f93bd = max(level.var_50c8366e, 1);
}
...
// Size: 0xec
function function_11a1e593(origin, color, duration) {
    /#
        r = 6;
        forward = (r, 0, 0);
        left = (0, r, 0);
...
function function_5954bef8() {
    rand = randomint(100);
    if (level.var_50c8366e < 9) {
        rand = rand + level.var_50c8366e * 2;
        if (rand < 70) {
            zombie_utility::set_zombie_run_cycle("walk");
        } else {
            zombie_utility::set_zombie_run_cycle("run");
        }
    } else if (level.var_50c8366e < 15) {
        rand = rand + (level.var_50c8366e - 9) * 2;
        if (rand < 70) {
        ...
        rand = rand + (level.var_50c8366e - 15) * 2;
        if (rand < 30) {
            zombie_utility::set_zombie_run_cycle("run");
        } else {
            zombie_utility::set_zombie_run_cycle("sprint");
...
function function_e75baa3f() {
    if (is_true(level.var_612d6a21) || util::get_game_type() === #"hash_75aa82b3ae89f54e") {
        ...
        level.var_51514f45 = level.var_51514f45 + level.var_e2fec446;
    ...
    foreach (ai in all_ai) {
        if (isdefined(ai.aitype)) {
            if (ai.aitype == var_9f7c58e6) {
                ...
                ai.var_173b6f35.ai = 1;
            } else if (ai.aitype == var_a0024591) {
...
function function_b33a5cf4(var_ba65b6cb) {
    ...
    if (isdefined(var_ba65b6cb) && isalive(var_ba65b6cb)) {
        level.var_361db66b = self function_cb711686();
        level.var_693d250e = 1;
        var_ba65b6cb.var_44505aa3.var_ba65b6cb = 1;
        return;
    } else {
        if (function_50cda95()) {
            self thread zm_powerups::specific_powerup_drop("free_perk", self.origin);
...
// Size: 0x1e4
function function_b293ea58(var_50c8366e) {
    /#
        if (!(is_true(level.var_612d6a21) || get_game_type() === #"hash_75aa82b3ae89f54e")) {
            level.var_df7b46d1.state = 1;
        }
        n_mod = (var_50c8366e + 1) % 3;
        switch (n_mod) {
        case 0:
        ...
        level.var_9b7bd0e8 = int(floor((var_50c8366e + 0.9) / 3));
        level.var_bc2071f = 100;
        level clear("<unknown string>");
        level set("<unknown string>");
        level.var_50c8366e = var_50c8366e;
        level.var_3e67b08d = set_zombie_var(#"zombie_spawn_delay", [[ level.func_get_zombie_spawn_delay ]](level.var_50c8366e + 1));
    #/
}
    ...
    while (1) {
        ...
        /#
            if (is_true(level.var_2b37d0dd)) {
                debug2dtext((670, 160, 0), "<unknown string>" + level.var_50c8366e, (1, 1, 1), 1, (0, 0, 0), 0.5, 2.8, 1);
...
function give_match_bonus(*data) {
    ...
    foreach (player in players) {
        ...
        var_900d44db = zm::function_d3113f01(level.var_50c8366e);
        if (!isdefined(player.var_1096b5c0)) {
            player.var_1096b5c0.player = 0;
        }
        var_370ac26d = player.var_1096b5c0;
        var_370ac26d = var_370ac26d + player function_ac940a26();
...
function private function_13f485ad() {
    var_370ac26d = zm::function_d3113f01(level.var_50c8366e).var_bd588afd;
    ...
    foreach (player in getplayers()) {
        ...
        player.var_1096b5c0.player = player.var_1096b5c0 - var_370ac26d;
        ...
        player.var_1096b5c0.player = player.var_1096b5c0 + player function_ac940a26();
        player.var_a160c21d.player = 0;
    }
}
...
function function_7f501c21() {
    ...
    level.var_3e67b08d = zombie_utility::set_zombie_var(#"zombie_spawn_delay", [[ level.func_get_zombie_spawn_delay ]](level.var_50c8366e + 1));
}
...
function spawn_zombie(outer_radius, inner_radius, duration, var_d894caa2, var_8c4dd20c) {
    ...
    if (isdefined(var_3c69a222)) {
        ...
        for (i = 0; i < var_3c69a222.size; i++) {
            ...
            if (!isdefined(tacpoint.var_356cbbd9)) {
                ...
                #/
                tacpoint.var_356cbbd9.tacpoint = function_334be69a(tacpoint);
            }
            /#
                if (is_true(level.var_58c95941)) {
            ...
            var_3acd7553 = 0;
            if (is_true(tacpoint.var_9415f2bd)) {
                current_time = gettime();
                if (current_time < tacpoint.var_9415f2bd + 10000) {
                    var_3acd7553 = 1;
                }
            }
            ...
            tacpoint.var_9415f2bd = undefined;
        ...
        for (i = 0; i < var_3c69a222.size; i++) {
            ...
            /#
                color = (0, 1, 0);
                if (is_true(level.var_bc79322a)) {
                    function_11a1e593(tacpoint.origin, color, duration);
                    if (is_true(tacpoint.var_9415f2bd)) {
    ...
    if (isdefined(var_d23463ac)) {
        ...
        #/
        var_d23463ac.var_9415f2bd.var_d23463ac = gettime();
        ...
        ai = spawnactor(var_b434916b, var_d23463ac.origin + vectorscale((0, 0, 1), 10), var_61187803);
        if (isdefined(ai)) {
            if (isdefined(var_8c4dd20c)) {
                if (!isdefined(level.var_a5ab9bfb)) {
                    level.var_a5ab9bfb = [];
            ...
            if (isdefined(ai)) {
                ...
                if (ai.archetype === #"zombie_dog") {
                    ai.zombie_move_speed.ai = #"run";
                }
                if (var_d894caa2 === 1) {
                    ai.var_d894caa2.ai = 1;
                }
            }
        }
    }
...
function function_6d6a276c(var_da0b6672) {
    while (1) {
        ...
        /#
            function_11a1e593(var_b3dbfd56 + vectorscale((0, 0, 1), 10), (1, 0, 0), 1);
            function_11a1e593(var_b3dbfd56 + vectorscale((0, 0, 1), 20), (0, 1, 0), 1);
            function_11a1e593(var_b3dbfd56 + vectorscale((0, 0, 1), 30), (0, 0, 1), 1);
        #/
        waitframe(1);
    }
}
    ...
    while (1) {
        ...
        case 2:
            ...
            if (var_531130b2 > var_bf58cac7 * var_bf58cac7) {
                self.origin = self.origin + var_e4547143 * 20 * (isdefined(level.var_51514f45) ? level.var_51514f45 : 1);
            }
            ...
            if (is_true(getgametypesetting(#"hash_3846b38f23c3d539"))) {
                ...
                if (isdefined(level.var_db2a4bc9) && is_true(level.var_75302c0e)) {
                    ...
                    if (var_189f09c7 > level.var_679cf74b) {
                        ...
                        self.origin = self.origin + var_882aca32 * 10 * (isdefined(level.var_51514f45) ? level.var_51514f45 : 1);
                    ...
                    } else if (distancesquared(level.var_a7bd1c53, self.origin) < function_a3f6cdac(24)) {
                        if (level.var_cd1e3b1f === 0 || level.var_cd1e3b1f === 1) {
                            if (is_true(level.var_612d6a21) || util::get_game_type() === #"hash_75aa82b3ae89f54e") {
                                level.var_df7b46d1.state = 3;
                            } else if (is_true(level.var_e35c191f) || util::get_game_type() === #"hash_125fc0c0065c7dea") {
                    ...
                    self.origin = self.origin + var_e4547143 * 10 * (isdefined(level.var_51514f45) ? level.var_51514f45 : 1);
                    if (distancesquared(level.var_a7bd1c53, self.origin) < function_a3f6cdac(16)) {
                        if (level.var_cd1e3b1f === 0 || level.var_cd1e3b1f === 1) {
                            if (is_true(level.var_612d6a21) || util::get_game_type() === #"hash_75aa82b3ae89f54e") {
                                level.var_df7b46d1.state = 3;
                            } else if (is_true(level.var_e35c191f) || util::get_game_type() === #"hash_125fc0c0065c7dea") {
                ...
                if (isdefined(level.var_a7bd1c53)) {
                    ...
                    if (isdefined(var_655e0ae3) && isdefined(var_39061289)) {
                        ...
                        if (!isdefined(level.var_db2a4bc9) || !isdefined(level.var_db2a4bc9.pathpoints) || level.var_db2a4bc9.pathpoints.size == 0) {
                            /#
                                recordsphere(var_39061289, 8, vectorscale((1, 1, 1), 0.1), "<unknown string>");
                                println("<unknown string>");
                            #/
                            ...
                            level.var_f637e029 = [1:level.var_db2a4bc9.pathpoints.size, 0:var_18341e4e];
                        }
                    } else {
                        if (!isdefined(level.var_cd1e3b1f)) {
                            level.var_cd1e3b1f = 1;
    ...
    while (1) {
        if (isdefined(level.var_aa36d14e)) {
            if (level flag::get(#"hash_2c0ce601824acdf5")) {
                ...
                level.circle_radius = level.circle_radius + var_871232e;
                ...
                if (level flag::get(#"hash_5acfa080039ea445") || level flag::get("cranked_pause")) {
                    goto LOC_0000042e;
                }
                var_b31cd2f8 = level.var_aa36d14e * float(function_60d95f53()) / 1000;
                level.circle_radius = level.circle_radius - var_b31cd2f8;
                if (level.circle_radius < var_bcce0e25) {
                    level.circle_radius = var_bcce0e25;
                } else if (level.circle_radius > var_569d5e56) {
                    level.circle_radius = var_569d5e56;
        ...
        if (isdefined(level.deathcircle.var_5c54ab33)) {
            ...
            /#
                if (is_true(level.var_2d41db66) || get_game_type() === #"hash_5aa4949e75ab9d9c") {
...
function function_81c192d() {
    ...
    if (isdefined(var_37246f9a)) {
        ...
        for (i = 0; i < var_37246f9a.size; i++) {
            ...
            if (is_true(var_20955b70)) {
                ...
                var_a7c3e3da = abs(var_e43ed783 - var_61c5710d);
                ...
                if (dotproduct > 0.8) {
                    ...
                    var_a7c3e3da = abs(var_e43ed783 - var_d8441ed6);
                    if (var_a7c3e3da < var_96b60b86) {
                        var_96b60b86 = var_a7c3e3da;
    ...
    if (is_true(level.var_2d41db66) || util::get_game_type() === #"hash_5aa4949e75ab9d9c") {
        ...
        level.var_df7b46d1.var_48fcd26a.var_7e2d3fc6 linkto(level.var_df7b46d1.var_48fcd26a, "tag_origin", vectorscale((0, 0, -1), 8), (0, 0, 0));
        ...
        if (level.var_df7b46d1.state === 3 || level.var_df7b46d1.state === 1) {
            if (var_7ae0f9f6 === 1) {
                if (level.var_df7b46d1.state === 3) {
                    ...
                    var_5328c5b2 = var_5328c5b2 * -1;
                    var_71484728 = var_71484728 * -1;
                    var_66924182 = var_66924182 * -1;
                    var_fe23b0e8 = (var_3aad51c8 * var_5328c5b2, var_c473d11c * var_71484728, var_d114ee3c * var_66924182);
                    var_7ae0f9f6 = 0;
                }
            }
            ...
            if (level.var_df7b46d1.state === 3) {
                ...
                speed = dist / function_a3f6cdac(16);
                var_e2341364 = 6;
            }
            ...
            if (level.var_df7b46d1.state === 3) {
                self.origin = self.origin + (var_591f5a95[0], var_591f5a95[1], 0) * 20 * (isdefined(level.var_51514f45) ? level.var_51514f45 : 1);
                ...
                if (dist < function_a3f6cdac(var_e2341364)) {
                    var_7ae0f9f6 = 1;
                }
            }
        } else {
                ...
                if (is_true(level.var_2b37d0dd)) {
                    ...
                    if (isdefined(level.var_771d8317)) {
                        if (var_188f8bf > level.var_771d8317) {
                            print3d(var_2d5745a8.origin + vectorscale((0, 0, 1), 300), "<unknown string>", var_3045d5d6, 1, 2, duration, 1);
                        }
                    }
                    if (is_true(var_2d5745a8.is_active)) {
                        for (i = 0; i < 20; i++) {
                            function_11a1e593(var_2d5745a8.origin + (0, 0, i * 10), var_457e9ab8, duration);
                        }
                    } else {
                        for (i = 0; i < 10; i++) {
                            function_11a1e593(var_2d5745a8.origin + (0, 0, i * 10), color, duration);
                        }
                    }
                }
            }
...
function setup_zones() {
    ...
    for (i = 0; i < level.var_d4c0ef1a.size; i++) {
        ...
        if (nodes.size == 0) {
            ...
            zone.objectiveanchor.zone = function_eb82ad56(nodes[random_index].origin);
...
function function_f19e31a2() {
    ...
    while (1) {
        ...
        /#
            debug2dtext((1000, 700, 0), "<unknown string>", (1, 1, 1), 1, (0, 0, 0), 0.5, 2.8, 200);
        #/
        zm_sq::function_53d0d99(#"hash_641e9c4d20df5950");
        /#
            println("<unknown string>" + level.var_9cf0f18d.origin);
        #/
        if (is_true(level.var_612d6a21) || util::get_game_type() === #"hash_75aa82b3ae89f54e" || is_true(level.var_e35c191f) || util::get_game_type() === #"hash_125fc0c0065c7dea") {
        ...
        var_67e68858 = vectorscale((0, 0, 1), 36);
...
function function_310986be() {
    if (is_true(getgametypesetting(#"hash_3846b38f23c3d539"))) {
        ...
        if (isdefined(level.var_15c1545d)) {
            level.var_15c1545d.var_26891b81 = 0;
        }
        ...
        if (!isdefined(var_2f31324d.objectiveanchor)) {
            var_2f31324d.objectiveanchor.var_2f31324d = function_eb82ad56(var_2f31324d.origin);
            if (is_true(level.var_612d6a21) || util::get_game_type() === #"hash_75aa82b3ae89f54e") {
        ...
        if (level.var_cd1e3b1f === 1) {
            ...
            if (var_b50dfc6a > 4896) {
                if (level.var_1eba154a.size > 1) {
                    ...
                    if (is_true(var_7a3b2fd5[0].var_26891b81) && var_7a3b2fd5.size > 1) {
                        var_9a582a58 = 1;
                    } else {
                        var_9a582a58 = 0;
                    }
                    ...
                    if (is_true(var_24f1be34[0].var_26891b81) && var_24f1be34.size > 1) {
        ...
        level.var_15c1545d.var_26891b81 = 1;
    ...
    if (level.var_8de4d059 === #"hash_3be2e434853eda53" && level.var_15c1545d.script_index === 4) {
        var_aec0cd16 = 128;
        var_95273e9b = 100;
    } else {
        var_aec0cd16 = 64;
...
function function_69e5b9b() {
    ...
    level.var_3e67b08d = isdefined(zombie_utility::function_d2dfacfd(#"zombie_spawn_delay")) ? zombie_utility::function_d2dfacfd(#"zombie_spawn_delay") : zombie_utility::function_d2dfacfd(#"hash_7d5a25e2463f7fc5");
...
function zmbaivox_playdeath() {
    ...
    if (isdefined(self)) {
        ...
        } else if (is_true(self.head_gibbed)) {
...
function function_a2f55e89(var_511659b1 = 0) {
    ...
    } else if (level.var_50c8366e >= 16) {
        var_9c1ed9ea = "energy_high";
    } else if (level.var_50c8366e >= 6) {
...
function function_eb82ad56(v_origin) {
    if (is_true(level.var_612d6a21) || util::get_game_type() === #"hash_75aa82b3ae89f54e") {
        var_6cc0acda = util::spawn_model("tag_origin", level.var_df7b46d1.origin - vectorscale((0, 0, 1), 68));
