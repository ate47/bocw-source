...
// Size: 0x2a
function function_7ef3c789(*var_248cbbcf) {
...
function server_attach_interact() {
    ...
    var_ea0d336b = util::spawn_model(#"tag_origin", level.player.origin, level.player.angles);
    while (!isdefined(var_ea0d336b)) {
        waitframe(1);
    }
    level.player playerlinktodelta(var_ea0d336b, "tag_origin", 1, 95, 95, 45, 45);
    var_ea0d336b moveto(var_ef3d9775.origin, 0.5);
    var_ea0d336b rotateto(var_ef3d9775.angles, 0.5);
    wait 0.5;
    var_ea0d336b delete();
    waitframe(1);
    waitframe(1);
...
function function_ce966826(*s_params) {
    ...
    var_ea0d336b = util::spawn_model(#"tag_origin", player_pos - v_forward, var_cac40761);
    var_121c5e14 = getent("vault_lift", "targetname");
    var_ea0d336b linkto(var_121c5e14);
    for (i = 0; i < 3; i++) {
        waitframe(1);
        self camerasetposition(var_ea0d336b);
    }
}
