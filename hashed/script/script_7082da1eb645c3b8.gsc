...
function function_cc475eed(*str_objective) {
    ...
    level thread namespace_fc3e8cb::function_1bf51572(1);
}
...
function function_c73d21cc() {
    ...
    level.woods val::set(#"hash_4870dc732e219aa0", "ignoreall", 1);
    level.woods val::set(#"hash_4870dc732e219aa0", "ignoreme", 1);
    ...
    level.woods unlink();
    level.woods val::set(#"hash_4870dc732e219aa0", "ignoreall", 0);
    level.woods val::set(#"hash_4870dc732e219aa0", "ignoreme", 0);
...
function function_ea2e6360() {
    ...
    var_8c309123[#"hash_7a96910b42269a41"] = getent("terminal_hint_postcard", "targetname");
    var_8c309123[#"hash_7a96910b42269a41"].offset = (0, 0, 5);
    var_8c309123[#"hash_7f103ad7b65ca1dc"] = getent("terminal_hint_poster", "targetname");
    var_8c309123[#"hash_7f103ad7b65ca1dc"].offset = (5, 0, 10);
    ...
    var_8c309123[#"hash_7a96910b42269a41"] util::create_cursor_hint("tag_origin", var_8c309123[#"hash_7a96910b42269a41"].offset, #"hash_2d2c88f338114b60", 100, undefined, &hint_use, undefined, 100, 40, 0, 0, undefined, &function_add2e8e8);
    var_8c309123[#"hash_7f103ad7b65ca1dc"] util::create_cursor_hint("tag_origin", var_8c309123[#"hash_7f103ad7b65ca1dc"].offset, #"hash_4e1a9c0154d891fd", 200, undefined, &hint_use, undefined, 200, 15, 0, 0, undefined, &function_add2e8e8);
...
function function_3005c939() {
    ...
    level.woods notify(#"hash_1e2b0acff337104a");
    level.woods clearforcedgoal();
