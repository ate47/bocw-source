...
function function_93407046(a_ents) {
    level.var_374a5477 = a_ents[#"hash_ffe3772a371cfe9"];
...
function bar_dialogue_enter() {
    ...
    level thread namespace_5ceacc03::function_b21fcb00();
    ...
    var_30762b3e dialog_tree::run(level.var_374a5477, level.var_e8ddef56);
    if (!player gamepadusedlast()) {
...
function bar_dialogue_choice_01() {
    ...
    waitframe(1);
    level.var_374a5477 flag::wait_till_clear(#"scriptedanim");
...
function function_2bf10776() {
    ...
    level.var_1a913976 thread dialog_tree::run(level.var_374a5477, level.var_e8ddef56);
    if (!player gamepadusedlast()) {
        player setviewclamp(20, 20, 20, 20, 0, 0, 1);
    }
}
...
function function_f752e215() {
    ...
    if (!level flag::get("bar_dialog_choice_01_finished") || !level flag::get("bar_dialog_choice_02_finished") || !level flag::get("learned_about_alley_stasi_field_house")) {
        ...
        level.var_30762b3e thread dialog_tree::run(level.var_374a5477, level.var_e8ddef56);
        if (!player gamepadusedlast()) {
            player setviewclamp(20, 20, 20, 20, 0, 0, 1);
        }
    }
...
function bar_dialogue_exit() {
    ...
    level thread namespace_5ceacc03::function_6c4ab3c5();
...
function function_3d51da22(a_ents) {
    e_car = a_ents[#"hash_35619990e87bc4d0"];
    ...
    thread namespace_5ceacc03::function_4eaebd1d();
}
