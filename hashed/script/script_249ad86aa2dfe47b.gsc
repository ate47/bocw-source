...
function function_1384307e(a_allies, a_enemies) {
    ...
    var_5e907852 = arraycombine(a_enemies, a_allies);
    array::thread_all(var_5e907852, &function_182d1f98);
}
...
function function_ca41480a(var_a6be88da, shotname) {
    ...
    if (shotname == "kill_player_right") {
        thread namespace_b6fe1dbe::function_c5f9169e();
        level scene::play("waterfall_kill_player_right", var_4e5d86e6);
    } else {
        thread namespace_b6fe1dbe::function_2bc53872();
    ...
    thread namespace_b6fe1dbe::function_cb1427da();
...
function function_641aa2d6() {
    ...
    thread namespace_b6fe1dbe::function_419076f6();
    wait 0.65;
...
function function_4a15681b() {
    thread namespace_b6fe1dbe::function_535d59f8();
    wait 0.3;
