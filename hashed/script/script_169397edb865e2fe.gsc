...
function function_32c773b8() {
    level endon(#"hash_407214143f24a93f");
    level.player endon(#"death");
...
// Size: 0x158
function function_318c053c(var_d72d658c, ai_group, vol_fallback, var_368e1d98) {
    level endon(#"death");
    var_423ae9b8 = getaiarray(var_d72d658c, "targetname");
