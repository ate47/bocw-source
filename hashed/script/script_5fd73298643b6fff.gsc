        ...
        foreach (var_4f9502db in var_877c5889) {
            if (control_point.script_int === var_4f9502db.script_int) {
                ...
                if (!isdefined(control_point.var_94cc32a1)) {
                    control_point.var_94cc32a1.control_point = [];
                } else if (!isarray(control_point.var_94cc32a1)) {
                    control_point.var_94cc32a1.control_point = array(control_point.var_94cc32a1);
                }
...
function function_ba9d5cad(mdl_support_machine, var_32f76af8) {
    ...
    mdl_support_machine.var_bec42bc3.mdl_support_machine = util::spawn_model(#"tag_origin", mdl_support_machine.origin, mdl_support_machine.angles);
    if (isdefined(mdl_support_machine.target)) {
        var_3910afa0 = struct::get(mdl_support_machine.target);
        mdl_support_machine.var_f44c98f6.mdl_support_machine = var_3910afa0.origin;
    }
    ...
    if (var_f070c3ca) {
        ...
        if (!is_true(mdl_support_machine.is_active)) {
            ...
            if (isdefined(slots) && slots.size > 0) {
                ...
                mdl_support_machine.is_active.mdl_support_machine = 1;
                mdl_support_machine.var_b79a8ac7.mdl_support_machine = {#slots:slots, #var_f019ea1a:1024};
        ...
        zm_sq::function_53d0d99(#"hash_5ebd88b995539e35");
        zm_sq::function_53d0d99(#"hash_8602209567f541c", mdl_support_machine);
        zm_sq::function_53d0d99(#"hash_3e7926c5aefe4406", mdl_support_machine);
        mdl_support_machine.is_active.mdl_support_machine = 0;
    ...
    foreach (var_32f76af8 in level.var_cc43b632) {
        if (var_32f76af8.script_int == self.script_int) {
            if (!isdefined(var_32f76af8.var_2c666f3f)) {
                var_32f76af8.var_2c666f3f.var_32f76af8 = [];
            } else if (!isarray(var_32f76af8.var_2c666f3f)) {
                var_32f76af8.var_2c666f3f.var_32f76af8 = array(var_32f76af8.var_2c666f3f);
            }
...
function function_a1728f1d(var_f57c3dea) {
    ...
    var_f57c3dea.var_58d1b08a.var_f57c3dea = arraycopy(var_f57c3dea.var_2eb61c8a);
    if (var_f57c3dea.var_58d1b08a.size > 0) {
        var_f57c3dea flag::set(#"hash_3b82fec1d3d5a8fb");
    }
    /#
        if (getdvarint(#"hash_90aec9f47685abc", 0) >= 2) {
            if (!var_f57c3dea get(#"hash_3b82fec1d3d5a8fb")) {
                level set(#"hash_5663e189d68932fc");
            }
...
function function_8903caa4(s_goal) {
    ...
    s_goal.var_9c19b6ff.s_goal = arraycopy(s_goal.var_6cc15b58);
    ...
    if (isdefined(var_794c9d5f)) {
        foreach (var_32f76af8 in var_6a8fe7bc) {
            if (var_32f76af8.script_int === var_794c9d5f) {
                var_32f76af8.var_269ad176.var_32f76af8 = 2;
...
function function_d08cba34(var_32f76af8) {
    ...
    var_32f76af8.var_2b239c6f.var_32f76af8 = 0;
    ...
    zm_sq::function_53d0d99(#"hash_2b663a5dd7beb565");
    foreach (e_player in getplayers()) {
    ...
    if (!is_true(var_32f76af8.var_e0885545)) {
        ...
        var_32f76af8.var_e0885545.var_32f76af8 = 1;
    }
    ...
    level thread namespace_f3a74bbc::start_timer(45);
    ...
    var_32f76af8.var_c36f1cec.var_32f76af8 = function_29ee49d2(var_32f76af8.var_94cc32a1, n_round, n_players);
    ...
    zm_sq::function_53d0d99(#"hash_589c4a67b38e079d");
...
function function_dbbcf07e(var_32f76af8 = level.var_c1369554) {
    ...
    zm_sq::function_53d0d99(#"hash_86f91ca1e18f21f");
        ...
        foreach (s_reward in a_s_rewards) {
            if (isdefined(s_reward.reward)) {
                if (!isdefined(s_reward.v_drop)) {
                    s_reward.v_drop.s_reward = getclosestpointonnavmesh(s_reward.origin, 128);
                }
                if (isdefined(s_reward.v_drop)) {
...
function function_3de96b64(var_32f76af8, b_open = 1) {
    ...
    foreach (var_f57c3dea in var_c36f1cec) {
        if (b_open) {
            var_f57c3dea.var_35a3a0b0.var_f57c3dea = util::spawn_model(#"tag_origin", var_f57c3dea.origin, var_f57c3dea.angles);
...
function function_5e2a6358(var_afa8e919, n_players, var_2a69785e, var_1a6bb917 = #"normal") {
    ...
    if (var_1a6bb917 == #"hash_be2e962be17d10e") {
...
function function_de620e56(var_32f76af8, n_round, n_players, var_2a69785e = 0) {
    ...
    var_57d164d9 = 0;
    var_8e58e88c = #"hash_be2e962be17d10e";
        ...
        if (var_8bdc5b97.size <= 0) {
            ...
            if (var_faa6c24 < var_a77c8ab2 && (var_2a69785e || level.var_98232a38 >= 1 || n_round >= 20)) {
                if (math::cointoss(75) || var_57d164d9 >= 2) {
                    var_57d164d9 = 0;
                    var_faa6c24++;
                    if (var_8e58e88c == #"hash_be2e962be17d10e") {
                        var_1a6bb917 = #"hash_6ab8026afeceaf8b";
                        var_8e58e88c = #"hash_6ab8026afeceaf8b";
                    } else {
                        var_1a6bb917 = #"hash_be2e962be17d10e";
                        var_8e58e88c = #"hash_be2e962be17d10e";
                    }
                } else {
                    var_57d164d9++;
            ...
            foreach (var_f57c3dea in var_7464cd64) {
...
function function_a7d1da85(var_f57c3dea, n_round, var_d1d2d9e2 = 0) {
    ...
    if (!var_d1d2d9e2) {
        ...
        ai_zombie.var_12745932.ai_zombie = 1;
        ai_zombie.health.ai_zombie = 50;
    }
...
function function_22918b17(var_f57c3dea) {
    ...
    var_7e46a1cf.var_126d7bef.var_7e46a1cf = 1;
    var_7e46a1cf.ignore_round_spawn_failsafe.var_7e46a1cf = 1;
    var_7e46a1cf.b_ignore_cleanup.var_7e46a1cf = 1;
    var_7e46a1cf.no_powerups.var_7e46a1cf = 1;
    s_spawn struct::delete();
    return var_7e46a1cf;
}
...
function function_cb795a64(var_f57c3dea) {
    ...
    level.zombie_total = int(max(0, level.zombie_total - 1 - 4));
    ai_mimic.var_126d7bef.ai_mimic = 1;
    ai_mimic.ignore_round_spawn_failsafe.ai_mimic = 1;
    ai_mimic.b_ignore_cleanup.ai_mimic = 1;
...
function function_9177bff0(v_goal, n_dist) {
    self endon(#"death", #"hash_1105b1fbcce65662");
    while (distancesquared(self.origin, v_goal) >= function_a3f6cdac(n_dist)) {
        waitframe(1);
    }
    return 1;
}
...
function function_44361a8f(control_point, var_e1c95338, var_ab56660c) {
    ...
    var_4ebe6ac0 = 0;
    b_force_spawn = 0;
    for (i = 0; i < (getplayers().size < var_cc47d58b.size ? var_cc47d58b.size : getplayers().size); i++) {
        spawn_pos = array::random(var_cc47d58b);
        spawn_pos.tag_fx.spawn_pos = spawn_pos util::spawn_model("tag_origin", spawn_pos.origin, spawn_pos.angles);
    ...
    while (var_a77909d4 < var_ab56660c && var_5fa4c84a.size) {
        ...
        if (isdefined(var_868cb618)) {
            var_9e2396e0 = spawnactor(var_868cb618, var_5fa4c84a[i].origin, var_5fa4c84a[i].angles, "assault_ai" + control_point.script_int, 1);
        }
        if (isdefined(var_9e2396e0)) {
            if (var_868cb618 !== #"hash_7a8b592728eec95d" || var_868cb618 !== #"hash_4f87aa2a203d37d0") {
                var_9e2396e0.var_c9b11cb3.var_9e2396e0 = #"hash_5d96e8e3ed203968";
                var_9e2396e0 thread namespace_85745671::function_2089690e();
            }
            ...
            var_9e2396e0 pathmode("move allowed");
            var_9e2396e0.completed_emerging_into_playable_area.var_9e2396e0 = 1;
            var_9e2396e0.zombie_think_done.var_9e2396e0 = 1;
            var_9e2396e0.zombie_move_speed.var_9e2396e0 = "sprint";
            var_a77909d4++;
            b_force_spawn = 0;
            ...
            level.var_2ae05b05[level.var_2ae05b05.size] = var_9e2396e0;
            var_9e2396e0 thread namespace_f7b3ed9::function_bf606a73();
            var_9e2396e0 callback::on_death(&function_ea727237);
        ...
        if (waitresult.amount > 0 && isplayer(waitresult.attacker) && waitresult.mod !== "MOD_AAT") {
            ...
            if (level.var_b72d51a8 <= 0) {
                ...
                if (!is_true(self.is_dead)) {
                    self.is_dead = 1;
                    if (isdefined(self.var_77dcb00d)) {
                        foreach (var_d0d0dc3b in self.var_77dcb00d) {
                            if (zm_utility::is_player_valid(var_d0d0dc3b.player, 0, 1)) {
                                ...
                                scoreevents::processscoreevent("hulking_summoner_kia_zm", var_d0d0dc3b.player, self, var_d0d0dc3b.weapon);
                            }
                        }
                    }
                }
...
function private function_e0a71864(var_ce68958a) {
    level endon(#"hash_2815bf32fb443bc3", #"hash_a88cb65d3952bc4");
    var_ce68958a.script_int.var_ce68958a = int(var_ce68958a.script_int);
...
function private function_b8f5e813(*einflictor, eattacker, idamage, *idflags, *smeansofdeath, weapon, *var_fd90b0bb, vpoint, *vdir, *shitloc, *psoffsettime, *iboneindex, *imodelindex) {
    ...
    self.var_1c0ce945 = 0;
    if (distsq <= function_a3f6cdac(64) && level flag::get(#"hash_16edadbaf047de80")) {
...
function function_eed94aa6(index) {
    /#
        if (level get(#"hash_7752d012501cd222")) {
            return;
        }
        level notify(#"hash_4d8079f4972e08d");
        level thread function_36ba4b03(index);
        if (!level get("<unknown string>" + index)) {
            turn_power_on_and_open_doors(index);
        }
    #/
}
...
function function_db20f3c1(var_f57c3dea) {
    /#
        while (1) {
            color = (0, 1, 0);
            if (level get(#"hash_5663e189d68932fc")) {
                color = (1, 0, 0);
            }
            if (var_f57c3dea get(#"hash_3b82fec1d3d5a8fb")) {
...
function function_73a35d2a(s_goal) {
    /#
        while (1) {
            if (!s_goal get(#"hash_60a48a427f6cbf61")) {
...
function function_999d2162() {
    /#
        ...
        a_str_shots = [17:"<unknown string>", 16:"<unknown string>", 15:"<unknown string>", 14:"<unknown string>", 13:"<unknown string>", 12:"<unknown string>", 11:"<unknown string>", 10:"<unknown string>", 9:"<unknown string>", 8:"<unknown string>", 7:"<unknown string>", 6:"<unknown string>", 5:"<unknown string>", 4:"<unknown string>", 3:"<unknown string>", 2:"<unknown string>", 1:"<unknown string>", 0:"<unknown string>"];
        foreach (str_scene in a_str_scenes) {
            foreach (str_shot in a_str_shots) {
                add_scene_func(str_scene, &function_f239fa6c, str_shot);
                add_scene_func(str_scene, &function_a28211b6, str_shot);
            }
        }
        a_str_shots = [4:"<unknown string>", 3:"<unknown string>", 2:"<unknown string>", 1:"<unknown string>", 0:"<unknown string>"];
        foreach (str_scene in a_str_scenes) {
            foreach (str_shot in a_str_shots) {
                add_scene_func(str_scene, &function_fb4fd407, str_shot);
            }
        }
    #/
}
