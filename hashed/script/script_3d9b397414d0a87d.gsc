...
function on_player_spawned()
{
    ...
    esports_event = { #player:self.name, #var_34d28e72:function_f8d53445(), #origin_x:player_position[ 0 ], #origin_y:player_position[ 1 ], #origin_z:player_position[ 2 ], #var_231262ec:player_angles[ 0 ], #var_c91e5a:player_angles[ 1 ], #var_e88b9d9:player_angles[ 2 ] };
...
function on_player_killed( data )
{
    ...
    victim_info = { #name:victim.name, #team:victim.var_b2ca7b2b, #origin_x:var_48dd40c2[ 0 ], #origin_y:var_48dd40c2[ 1 ], #origin_z:var_48dd40c2[ 2 ], #var_231262ec:victimangles[ 0 ], #var_c91e5a:victimangles[ 1 ], #var_e88b9d9:victimangles[ 2 ], #weapon:victimweapon.name, #weapon_attachments:function_8d2c5f27( victimweapon.attachments ) };
...
function function_48541d37( zones )
{
    ...
    for (zone_index = 0; zone_index < zones.size; zone_index++) {
        ...
        objective_info = { #obj_name:"point_" + zone_index + 1, #origin_x:origin[ 0 ], #origin_y:origin[ 1 ], #origin_z:origin[ 2 ] };
...
{
    var_e87e5141 = function_48541d37( level.zones );
    control_info = { #var_4d3ce32d:game.lives[ #"allies" ], #var_beae0a65:game.lives[ #"axis" ] };
