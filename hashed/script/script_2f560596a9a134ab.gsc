...
function function_123bcbcf() {
    ...
    case 1:
        ...
        a_str_rewards = array(#"carpenter", #"double_points", #"extra_life", #"weapon", #"equipment", #"hash_568103fb62eae412", #"hash_305523fec8a0505d");
        ...
        break;
    case 2:
        a_str_rewards = array(#"weapon", #"full_ammo", #"fire_sale", #"hash_568103fb62eae412", #"hash_305523fec8a0505d", #"equipment");
    ...
    case 4:
        ...
        a_str_rewards = array(#"weapon", #"free_perk", #"extra_life", #"hash_1eca2dde13903d98");
        ...
        if (!isdefined(var_4e8c90d2) || var_4e8c90d2 == level.weaponnone || self hasweapon(var_4e8c90d2) || !var_8e1fc3ea) {
            arrayremovevalue(a_str_rewards, #"hash_1eca2dde13903d98");
        }
        str_reward = function_56c888ce(a_str_rewards);
        switch (str_reward) {
        case #"weapon":
...
function function_d36fb590(var_aa4f9213, var_6c9485fc, *var_b7e0faf0 = 3) {
    ...
    if (var_24a867e4 === #"hash_3de8f6cb1e738702") {
    ...
    var_4d0b3b87.hint.var_4d0b3b87 = level.zombie_powerups[var_6c9485fc].hint;
    b_give_reward = self function_dcda5d87(var_4d0b3b87, 1, 1, 0);
    if (is_true(b_give_reward)) {
        if (var_6c9485fc == "self_revive") {
            ...
            var_4d0b3b87 [[ level._custom_powerups[var_6c9485fc].grab_powerup ]](self);
...
function function_a8243f37() {
    level.var_433de94b = [];
    level.var_433de94b[level.var_433de94b.size] = #"hash_5243375728e388f6";
    level.var_433de94b[level.var_433de94b.size] = #"hash_42f6b5f6dd85875f";
    level.var_2e1a7563 = 0;
    level.var_30641602 = [];
    level.var_30641602[level.var_30641602.size] = #"hash_6f8ae26433fba2cf";
    level.var_30641602[level.var_30641602.size] = #"hash_5bf4dc6dcf1d2340";
    level.var_8e5c4768 = 0;
    level.var_fc2d4a2 = [];
    level.var_fc2d4a2[level.var_fc2d4a2.size] = #"hash_5b3e3aae603f948e";
    level.var_fc2d4a2[level.var_fc2d4a2.size] = #"hash_51114f6fd577519b";
    level.var_fc2d4a2[level.var_fc2d4a2.size] = #"hash_6251778e2d3b9a64";
    level.var_e3d39f70 = 0;
    level.var_24b50714 = [];
    level.var_24b50714[level.var_24b50714.size] = #"hash_2580580083c87b0d";
    level.var_24b50714[level.var_24b50714.size] = #"hash_485d0c5e33d67e78";
    level.var_24b50714[level.var_24b50714.size] = #"hash_3b0e54f5881972d3";
    level.var_24b50714[level.var_24b50714.size] = #"hash_70f8f2d92031f544";
    level.var_24b50714[level.var_24b50714.size] = #"hash_696069d98ed3f228";
    level.var_de18c954 = 0;
    level.var_592fbce6 = [];
    level.var_592fbce6[#"knife_loadout"] = {#x:3};
    level.var_592fbce6[#"hash_6f8ae26433fba2cf"] = {#x:-9};
    level.var_592fbce6[#"hash_5bf4dc6dcf1d2340"] = {#x:0};
    level.var_592fbce6[#"hash_5b3e3aae603f948e"] = {#x:-6};
    level.var_592fbce6[#"hash_51114f6fd577519b"] = {#x:-7};
    level.var_592fbce6[#"hash_6251778e2d3b9a64"] = {#x:-2};
    level.var_592fbce6[#"hash_2580580083c87b0d"] = {#x:-5};
    level.var_592fbce6[#"hash_485d0c5e33d67e78"] = {#x:-9};
    level.var_592fbce6[#"hash_3b0e54f5881972d3"] = {#x:5};
    level.var_592fbce6[#"hash_70f8f2d92031f544"] = {#x:-9};
    level.var_592fbce6[#"hash_696069d98ed3f228"] = {#x:-6};
    level.var_592fbce6[#"hash_3fa91d1674123e09"] = {#x:0};
    level.var_592fbce6[#"satchel_charge_t9_item_sr"] = {#angles:vectorscale((-1, 0, 0), 90), #z:-1};
    ...
    level.var_592fbce6[#"item_survival_scorestreak_bow"] = {#n_scale:0.5, #x:-5};
    level.var_592fbce6[#"item_survival_scorestreak_ultimate_turret"] = {#n_scale:0.8, #z:-12};
    level.var_592fbce6[#"item_survival_scorestreak_chopper_gunner"] = {#b_rotate:0};
    level.var_592fbce6[#"item_survival_scorestreak_remote_missile"] = {#b_rotate:0, #x:13};
}
...
// Size: 0x414
function function_11be5095(var_7ed75e97, var_6c9485fc = 3, b_upgraded = 0, var_5876e0e2) {
    if (var_6c9485fc) {
...
function function_61ae9102(var_7ed75e97 = 0) {
    ...
    return {#var_fafb77dd:var_fafb77dd, #var_74ca2ca1:var_74ca2ca1};
}
...
// Size: 0x6c4
function function_c2e444e6(str_type = #"hash_305523fec8a0505d", n_amount, var_b492d948, var_6c9485fc = 3, var_10ad9538 = 1) {
    self endon(#"death");
    if (var_6c9485fc) {
        self thread function_29e6dc49(0, var_6c9485fc);
    }
    var_8b84b3ce = self.var_642ed51a.var_f693bf0b.origin;
    v_spawn_angles = self.var_642ed51a.var_f693bf0b.angles;
    if (str_type === #"hash_305523fec8a0505d") {
        str_model = #"hash_8b8c98dda08574e";
        if (var_10ad9538) {
        ...
        if (isdefined(var_b492d948)) {
            str_model = #"hash_1f82e1c70fdc8f38";
            if (var_10ad9538) {
    ...
    if (var_10ad9538) {
        ...
        if (var_4d0b3b87 clientfield::is_registered("perk_death_perception_item_marked_for_rob")) {
            var_4d0b3b87 clientfield::set("perk_death_perception_item_marked_for_rob", 1);
        }
    ...
    self.var_642ed51a.var_f92a5f81 = var_4d0b3b87;
    var_4d0b3b87 playsound(#"zmb_powerup_resource_large_spawn");
...
function private function_83132977(str_item_name) {
    ...
    var_814059b6.weapon.var_814059b6 = var_89230090.weapon;
    var_814059b6.str_model.var_814059b6 = var_89230090.model;
    var_814059b6.n_scale.var_814059b6 = var_89230090.modelscale;
    var_814059b6.str_fx.var_814059b6 = var_89230090.worldfx[0].worldfx;
    var_814059b6.rarity.var_814059b6 = var_89230090.rarity;
    return var_814059b6;
}
...
function function_56c888ce(a_str_rewards) {
    ...
    /#
        var_fda84fc2 = getdvarstring(#"hash_41027d60a1cf70b4", "<unknown string>");
        if (var_fda84fc2 != "<unknown string>") {
...
function function_445c5623(var_aa4f9213, var_8b84b3ce, var_a9009a19) {
    ...
    var_4d0b3b87 playsound(#"hash_e3e5f7c83015171");
    var_4d0b3b87 playloopsound(#"hash_2adfa98b79668366");
    var_4d0b3b87.hint.var_4d0b3b87 = level.zombie_powerups[var_aa4f9213].hint;
    n_tries = 0;
    while (1) {
    ...
    var_cef149e8 = var_4d0b3b87 zm_utility::fake_physicslaunch(v_loc + vectorscale((0, 0, 1), 25), n_power);
    wait(var_cef149e8);
    e_player = level function_c45635c7(var_4d0b3b87, 1, 1, 0);
    if (isplayer(e_player)) {
        if (var_aa4f9213 == "self_revive") {
            e_player zm_laststand::function_3a00302e();
        } else {
            var_4d0b3b87 [[ level._custom_powerups[var_aa4f9213].grab_powerup ]](e_player);
...
// Size: 0x2d0
function function_c45635c7(var_4d0b3b87, b_rotate, var_b9b24, var_d1bb6924 = 1) {
...
// Size: 0x256
function function_dcda5d87(var_4d0b3b87, b_rotate = 1, var_b9b24 = 1, var_d1bb6924 = 1) {
