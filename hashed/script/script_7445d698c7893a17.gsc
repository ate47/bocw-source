...
function function_9384b521() {
    ...
    aat::register("ammomod_brainrot", 0.15, 0, 55, 5, 1, &result, "t7_hud_zm_aat_turned", "wpn_aat_turned_plr", &function_6f735de0, #"hash_16b5c37d8feae38c", &function_effed72f, #"hash_284e1e340e2541f0");
    aat::register("ammomod_brainrot_1", 0.15, 0, 55, 5, 1, &result, "t7_hud_zm_aat_turned", "wpn_aat_turned_plr", &function_6f735de0, #"hash_16b5c37d8feae38c", &function_effed72f, #"hash_284e1e340e2541f0");
    aat::register("ammomod_brainrot_2", 0.15, 0, 55, 5, 1, &result, "t7_hud_zm_aat_turned", "wpn_aat_turned_plr", &function_6f735de0, #"hash_16b5c37d8feae38c", &function_effed72f, #"hash_284e1e340e2541f0");
    aat::register("ammomod_brainrot_3", 0.15, 0, 55, 5, 1, &result, "t7_hud_zm_aat_turned", "wpn_aat_turned_plr", &function_6f735de0, #"hash_16b5c37d8feae38c", &function_effed72f, #"hash_284e1e340e2541f0");
    aat::register("ammomod_brainrot_4", 0.15, 0, 55, 5, 1, &result, "t7_hud_zm_aat_turned", "wpn_aat_turned_plr", &function_6f735de0, #"hash_16b5c37d8feae38c", &function_effed72f, #"hash_284e1e340e2541f0");
    aat::register("ammomod_brainrot_5", 0.15, 0, 55, 5, 1, &result, "t7_hud_zm_aat_turned", "wpn_aat_turned_plr", &function_6f735de0, #"hash_16b5c37d8feae38c", &function_effed72f, #"hash_284e1e340e2541f0");
...
function private function_76ade8b5(aat_name = "ammomod_brainrot") {
    ...
    case #"hash_defdefdefdefdef0":
        return 0;
        break;
    case #"hash_3202c5fd5a389be7":
        return 1;
        break;
    case #"hash_3202c6fd5a389d9a":
        return 2;
        break;
    case #"hash_3202c7fd5a389f4d":
        return 3;
        break;
    case #"hash_3202c0fd5a389368":
        return 4;
        break;
    case #"hash_3202c1fd5a38951b":
        return 5;
        break;
    }
    return 0;
...
function result(*death, attacker, *mod, weapon, var_fd90b0bb, vpoint, *shitloc, *boneindex = self.origin) {
    ...
    if (self.var_6f84b820 === #"hash_72d4f2ad2e333eb4" || self.var_6f84b820 === #"boss") {
        return;
    }
...
function function_c81ac3e5(attacker, weapon, var_fd90b0bb, tier) {
    if (self.var_6f84b820 === #"hash_72d4f2ad2e333eb4" || self.var_6f84b820 === #"boss" || self.var_6f84b820 === #"inanimate") {
        return;
    }
...
function function_f7f8a2cc(attacker, weapon) {
    ...
    for (i = 0; i < a_ai_zombies.size; i++) {
        ...
        if (is_true(level.aat[#"hash_7958a864777a5c5b"].immune_result_indirect[a_ai_zombies[i].archetype])) {
            continue;
        }
...
function function_6f735de0() {
    if (is_true(level.aat[#"hash_7958a864777a5c5b"].immune_result_direct[self.archetype])) {
        return 0;
    }
    ...
    for (i = 0; i < a_ai_zombies.size; i++) {
        ...
        if (tier >= 5) {
            if (var_5bb9cba5 < var_a374f6da) {
                if (isdefined(a_ai_zombies[i].var_6f84b820) && a_ai_zombies[i].var_6f84b820 != #"hash_72d4f2ad2e333eb4") {
