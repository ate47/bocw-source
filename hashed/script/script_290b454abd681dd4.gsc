...
function function_241c95b4() {
    ...
    var_ec619483 = snd::play("veh_evac_chopper_jetwhine_lp", level.var_740fba59);
    snd::function_f4f3a2a(var_ec619483, level.var_740fba59);
}
...
function function_c0f7776d() {
    level waittill(#"hash_2e260b81a2435ae");
