...
function function_b9596ad1() {
    var_d1a24548 = spawner::simple_spawn_single("lockpick_scene_enemy_door", &function_87f353f6, #"hash_6fe09c24c5673b5f");
    ...
    var_d1a24548 aiutility::setprimaryweapon(w_pistol);
    var_d1a24548 shared::placeweaponon(w_pistol, "right");
    var_d1a24548 setmodel(#"hash_3d381ff9516fc2e6");
    var_d1a24548 val::set(#"hash_70f48a440e25a27c", "magic_bullet_shield", 1);
    var_12baf921 = spawner::simple_spawn_single("lockpick_scene_enemy_desk", &function_87f353f6, #"hash_717c7aaf26f94daa");
...
function function_4f4f437b() {
    ...
    level.var_eea5b22[#"hash_5432c3ecf05eb8ea"] = level.player.var_4d448bdb;
}
...
function private function_6fac81f3(*params) {
    ...
    var_2586eb45 = getweapon(#"hash_5453c9b880261bcb");
...
// Size: 0xac
function function_a6b8513a(*str_objective, *var_50cc0d4f, *var_aa1a6455, *player) {
