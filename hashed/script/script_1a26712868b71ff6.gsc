...
function function_79868b3b(b_skipped) {
    ...
    level.var_75a7d6.var_1ec89ecd[#"hash_536592566e7d862d"] = 0;
    ...
    level.var_75a7d6.var_815eeaa4[#"hash_9f6bc1960ff4912"] = [];
    level.var_75a7d6.var_815eeaa4[#"hash_3d92e2c7bea1eee2"] = [];
    ...
    foreach (struct in struct::get_array(level.var_75a7d6.target)) {
        if (isdefined(struct.var_fdd68e6f)) {
            ...
            case #"spawn":
                var_9893d55e = [7:#"abom", 6:#"hash_3d92e2c7bea1eee2", 5:#"hash_be2e962be17d10e", 4:#"hash_9f6bc1960ff4912", 3:#"hash_643d498546885532", 2:#"tempest", 1:#"tormentor", 0:#"zombie"];
                if (isstring(struct.var_4c92b2ac)) {
                    var_d7cf1504 = strtok(struct.var_4c92b2ac, ", ");
            ...
            case #"hash_415e056a9db2491e":
                ...
                if (isvehicle(var_1280faf3)) {
                    zm_sq::function_266d66eb(#"hash_380134b80e0ab939", var_1280faf3, 0, undefined, #"hash_73530baa63d7ec9c", undefined, &function_ab16ea40);
                }
                        ...
                        if (isdefined(var_539fda25.var_fdd68e6f)) {
                            ...
                            case #"hash_5644b3f69f4e3ee5":
                                if (!isdefined(var_d2ee34ea.var_255e01f1)) {
                                    var_d2ee34ea.var_255e01f1.var_d2ee34ea = [];
                                } else if (!isarray(var_d2ee34ea.var_255e01f1)) {
                                    var_d2ee34ea.var_255e01f1.var_d2ee34ea = array(var_d2ee34ea.var_255e01f1);
                                }
    ...
    zm_sq::function_266d66eb(#"hash_1c8b4e14ac690a43", level.var_75a7d6.var_c20e460e.var_2644aca3, 0, #"hash_90d41432e6bd428", #"hash_5ad2dea4c296de59", undefined, &function_a4650866);
    function_4ba59ffe();
...
function function_ec198408(b_skipped, *var_19e802fa) {
    ...
    zm_sq::function_53d0d99(#"hash_73530baa63d7ec9c");
    zm_sq::function_53d0d99(#"hash_5ad2dea4c296de59");
    ...
    if (isarray(level.var_75a7d6.var_e890a8bc)) {
        foreach (var_ce34262e in level.var_75a7d6.var_e890a8bc) {
            if (isdefined(var_ce34262e)) {
                var_ce34262e function_cb48cddd();
            }
        }
    }
    function_968e2ead();
...
function function_dbf9c70d() {
    ...
    var_eda0bf20 = getent("vol_end_fight_forced", "targetname");
    if (isdefined(var_eda0bf20)) {
        if (level.var_75a7d6 flag::get(#"intermission") && isarray(level.var_75a7d6.var_62b6205d) && !self istouching(var_eda0bf20)) {
...
function function_85f68dd4() {
    ...
    wait(2);
    level thread function_45d56560();
    wait(5);
...
function function_7ed3f4dd(var_a07ea3db) {
    ...
    var_ce34262e.health.var_ce34262e = 1;
    var_a8c53cf5 = 0;
        ...
        if (isplayer(e_attacker) || var_9b676843) {
            ...
            if (!var_982513ee) {
                if (!var_a8c53cf5) {
                    ...
                    function_73f95a0c();
                    var_fd8ded06.health.var_fd8ded06 = int(max(var_fd8ded06.health - 25, 0));
            ...
            if (isplayer(e_player)) {
                if (!var_982513ee) {
                    ...
                    if (!var_a8c53cf5) {
                        ...
                        if (var_51de3a6c) {
                            var_a8c53cf5 = 1;
                            var_ce34262e.var_426947c4.var_ce34262e = 1;
...
function function_a617da35(var_fd8ded06) {
    ...
    level endon(#"end_game");
    level.var_75a7d6 endon(#"defeated");
    var_fd8ded06 notify(#"hash_3c35bdf3228f507a");
    var_fd8ded06 endon(#"hash_3c35bdf3228f507a", #"destroyed");
    wait(2);
    ...
    while (var_fd8ded06.health < var_fd8ded06.maxhealth) {
        ...
        var_fd8ded06.health.var_fd8ded06 = var_fd8ded06.health + var_e852d8c3;
        function_73f95a0c();
        waitframe(1);
    }
}
...
function function_29c5c96a(var_a07ea3db) {
    ...
    case #"right":
        ...
        var_f0d1671b = #"hash_536592566e7d862d";
        level.var_75a7d6.var_a17b2556 clientfield::set("" + #"hash_399e2afd773621df", 1);
        level.var_75a7d6.var_b9f89aa6 clientfield::set("" + #"hash_399e2afd773621df", 1);
        level thread function_a39582f9(1);
        break;
...
function function_4a0ebe24(var_a07ea3db) {
    ...
    if (var_a07ea3db == #"hash_565d5e19da6fb336") {
        ...
        while (1) {
            ...
            var_2738d349 = var_2738d349 + v_right * var_d7015271;
            var_2738d349 = var_2738d349 + v_up * var_5b6e1d07;
...
function function_60c68651() {
    ...
    foreach (str_id in [13:#"hash_1b714dba19ea3e0f", 12:#"hash_1b88d2ba19fdfeef", 11:#"hash_1b81e1ba19f7f9be", 10:#"hash_2543c53a17547f61", 9:#"hash_7a617db243a2fb6f", 8:#"hash_3c3b7fabf09654bf", 7:#"hash_6c4553137f1098ec", 6:#"hash_68fef8aec4a2ac38", 5:#"hash_34751c9f81d0e94f", 4:#"hash_3ae5c3c2322b1c03", 3:#"eyes", 2:#"mine", 1:#"hash_536592566e7d862d", 0:#"ground"]) {
        switch (str_id) {
        case #"ground":
...
function function_f83c329c(str_id, var_2adc0309 = 0, n_delay = 0.5, var_591caa3e, var_127a2393 = 1, var_a78cf3d4 = 0) {
    ...
    if (!var_a78cf3d4 && level.var_75a7d6 flag::get(#"hash_3201bcb3cc3b7209")) {
        return;
    }
...
function function_fee3db9(str_shot, var_a78cf3d4 = 0) {
    ...
    if (!var_a78cf3d4 && level.var_75a7d6 flag::get_any([1:#"hash_4e953b3843bae375", 0:#"hash_3201bcb3cc3b7209"])) {
        return;
    }
    level endon(#"end_game");
...
function function_3d5eabf(str_shot) {
    ...
    var_abe648f0 = {#n_duration:4, #var_efc4d374:0.4, #n_start:0, #radius:9999, #origin:level.var_75a7d6.s_boss.origin};
...
function function_c618b503(e_player) {
    ...
    e_player val::function_e681e68e(#"hash_135155741ee551dc");
...
function function_4346157c(var_9161d39c = #"", b_play_vo = 1) {
    ...
    if (level.var_75a7d6.var_9d7dfc4c === #"hash_3d123fac1908cd30" || level.var_75a7d6 flag::get(#"hash_48bc8345fad29b74") && (var_9161d39c != #"hash_536592566e7d862d" || level.var_75a7d6.var_1ec89ecd[#"hash_536592566e7d862d"] + 1 <= 1)) {
        if (!isdefined(var_acd1a5c4)) {
            var_acd1a5c4 = [];
        } else if (!isarray(var_acd1a5c4)) {
            var_acd1a5c4 = array(var_acd1a5c4);
        }
        var_acd1a5c4[var_acd1a5c4.size] = #"hash_536592566e7d862d";
    }
        ...
        if (isdefined(level.var_75a7d6.var_9d7dfc4c)) {
            ...
            case #"hash_35eefe12894036fd":
                if (isinarray(var_acd1a5c4, #"hash_3bffc6cd547d8d78") || isinarray(var_acd1a5c4, #"hash_3b99decd5427030e")) {
                    var_b5714783 = random(var_2cb97f5a);
                }
                break;
            ...
            case #"hash_3d123fac1908cd30":
                if (isinarray(var_acd1a5c4, #"hash_536592566e7d862d")) {
                    var_b5714783 = #"hash_536592566e7d862d";
                }
                break;
...
function function_eadf62a1() {
    ...
    return {#var_abef106b:var_abef106b, #var_2cb97f5a:var_2cb97f5a};
}
...
function function_360256d0(str_side, b_play_vo = 1) {
    ...
    if (b_play_vo) {
        level thread function_f83c329c(#"ground", 1, 0.5, {#n_time:30, #str_id:#"hash_7522c865a93cc31"});
    }
                ...
                foreach (var_8487602c in [1:var_8631b9c0, 0:var_8efdecd9]) {
                    ...
                    if (isvec(v_navmesh)) {
                        if (!isdefined(var_943c7562.a_v_points)) {
                            var_943c7562.a_v_points.var_943c7562 = [];
                        } else if (!isarray(var_943c7562.a_v_points)) {
                            var_943c7562.a_v_points.var_943c7562 = array(var_943c7562.a_v_points);
                        }
...
function function_ecf643d2(b_play_vo = 1) {
    ...
    if (b_play_vo) {
        var_591caa3e = {#n_time:30, #str_id:#"hash_7522c865a93cc31"};
        if (!level.var_75a7d6 flag::get(#"hash_222fadd3d299cd5f")) {
            level.var_75a7d6 flag::set(#"hash_222fadd3d299cd5f");
            var_591caa3e = undefined;
        }
        level thread function_f83c329c(#"hash_536592566e7d862d", 1, 0.5, var_591caa3e);
    }
    ...
    level thread function_4346157c(#"hash_536592566e7d862d");
}
...
function function_e788990d() {
    ...
    foreach (e_player in getplayers()) {
        ...
        e_player val::function_e681e68e(#"hash_1875c2a7206c5167");
    }
}
...
function function_775a15ec() {
    ...
    self val::function_e681e68e(#"hash_1875c2a7206c5167");
    var_855b4886 = 0;
    var_61c960ef = 0;
    while (1) {
        var_17f4a48e = 0;
        ...
        foreach (var_4e1bd1ba in level.var_75a7d6.var_1aa34baf) {
            if (isdefined(var_4e1bd1ba) && var_4e1bd1ba flag::get_any([1:#"hash_6b60ff3b039d7e7e", 0:#"hash_2a8f13a829d42a07"])) {
                ...
                if (var_4e1bd1ba flag::get(#"hash_2a8f13a829d42a07") && !var_17f4a48e && n_dist <= function_a3f6cdac(250)) {
                    var_17f4a48e = 1;
                }
                if (var_4e1bd1ba flag::get(#"hash_6b60ff3b039d7e7e") && !var_67c43623 && n_dist <= function_a3f6cdac(250)) {
                    var_67c43623 = 1;
                }
...
function function_15e00116(s_spawn) {
    ...
    while (1) {
        var_8c50f796.var_7e2d3fc6.var_8c50f796 = spawncollision(#"hash_54ae3ca6346eae5f", "", var_8c50f796.origin + vectorscale((0, 0, 1), 130), var_8c50f796.angles);
...
function function_91fec1bb(var_8c50f796) {
    ...
    var_7e2d3fc6 val::set(#"hash_41adc0ca9daf6e9d", "allowdeath", 0);
    var_7e2d3fc6 val::set(#"hash_41adc0ca9daf6e9d", "takedamage", 1);
    var_7e2d3fc6.health.var_7e2d3fc6 = 1;
...
function function_31a8910(var_8c50f796, var_f46abcf1 = 1) {
    ...
    if (isdefined(var_8c50f796.var_7e2d3fc6)) {
        var_8c50f796.var_7e2d3fc6 function_cb48cddd();
    }
    ...
    if (n_players > 0) {
        if (n_players <= 1) {
            ...
            foreach (var_bb8c6cc9 in a_e_players) {
                if (distance2dsquared(level.var_75a7d6.s_boss.origin, var_bb8c6cc9.origin) >= function_a3f6cdac(1024) && level.var_75a7d6.s_boss math::get_dot_forward(var_bb8c6cc9.origin, 1) >= 0.6) {
                    var_b500b370 = [];
        ...
        if (isdefined(e_target) && distance2dsquared(level.var_75a7d6.s_boss.origin, e_target.origin) >= function_a3f6cdac(1024) && level.var_75a7d6.s_boss math::get_dot_forward(e_target.origin, 1) >= 0.6) {
            return e_target;
        }
    }
}
...
function function_a25101c(e_target) {
    ...
    while (1) {
        if (isvec(e_target.origin)) {
            ...
            if (isvec(v_navmesh) && distance2dsquared(level.var_75a7d6.s_boss.origin, e_target.origin) >= function_a3f6cdac(1024) && level.var_75a7d6.s_boss math::get_dot_forward(v_navmesh, 1) >= 0.6) {
...
function function_260cd6e6(var_b63f9f4f, var_586de175) {
    ...
    var_97a7fa13.origin.var_97a7fa13 = var_b63f9f4f.origin;
    var_30d513af.origin.var_30d513af = var_586de175.origin;
    while (1) {
...
function function_bb7202a2() {
    ...
    foreach (struct in struct::get_array(level.var_75a7d6.target)) {
        if (struct.var_fdd68e6f === #"float" && struct.script_int === 0) {
            ...
            level.var_75a7d6.var_c20e460e.var_2644aca3 clientfield::set("" + #"hash_9ef13a567692f32", 1);
            function_9965670d();
            a_ents[#"hash_5ad2dea4c296de59"] = level.var_75a7d6.var_c20e460e.var_2644aca3;
...
function function_7c6aaab3(var_bad95e69 = 1, var_58a45754 = 0) {
    a_s_safe = [1:level.var_75a7d6.var_c20e460e.var_529d63dd[4], 0:level.var_75a7d6.var_c20e460e.var_529d63dd[1]];
...
function function_91b8984b(v_dest, v_angles, var_135e3159, var_2dba142c = 0, n_speed = 300, var_bad95e69 = 1, var_58a45754 = 1) {
    ...
    a_ents[#"hash_5ad2dea4c296de59"] = var_2644aca3;
...
function function_1f80b24d() {
    ...
    while (1) {
        var_2644aca3 = level.var_75a7d6.var_c20e460e.var_2644aca3;
        if (level.var_75a7d6.var_c20e460e flag::get(#"hash_f6fa640d2850acd") && isdefined(var_2644aca3) && distance2dsquared(self.origin, var_2644aca3.origin) <= function_a3f6cdac(256)) {
            self flag::clear(#"hash_21fe92f29511661c");
...
function function_90051ca0() {
    ...
    foreach (var_98bf27a1 in var_e9abcfcb) {
        if (!var_98bf27a1 flag::get(#"charged") && function_8a1f5c87(var_98bf27a1.var_e35c2428.origin)) {
            return var_98bf27a1;
        }
    }
...
function function_1c6d2370() {
    ...
    var_e35c2428 = var_98bf27a1.var_e35c2428;
    ...
    a_ents[#"hash_5ad2dea4c296de59"] = level.var_75a7d6.var_2644aca3;
...
function function_bc175096(var_98bf27a1) {
    ...
    if (isspawner(var_5d0628dc)) {
        while (1) {
            var_98bf27a1.var_1280faf3.var_98bf27a1 = var_5d0628dc spawnfromspawner(undefined, 1, 1, 1);
    ...
    var_1280faf3.health.var_1280faf3 = 1;
    foreach (struct in struct::get_array(var_98bf27a1.target)) {
        if (struct.var_fdd68e6f === #"charge") {
            var_98bf27a1.var_e35c2428.var_98bf27a1 = util::spawn_model(#"tag_origin", struct.origin, struct.angles);
            var_98bf27a1.var_e35c2428 linkto(var_1280faf3, "tag_flash");
            break;
        }
    }
}
...
function function_733c1a3f(s_params) {
    ...
    if (isplayer(e_player)) {
        e_player.var_f22c83f5.e_player = 1;
    }
...
function function_bc6c4c25(s_params) {
    ...
    e_player = s_params.player;
    if (isplayer(e_player)) {
        e_player val::function_e681e68e(#"hash_41e0ea13e56b1f40");
        e_player.var_f22c83f5 = undefined;
    }
}
...
function function_57858b58(var_98bf27a1) {
    ...
    var_abe648f0 = {#n_duration:2, #var_efc4d374:0.3, #n_start:0, #radius:1024, #origin:var_1280faf3.origin};
    level thread function_a7978694(var_abe648f0);
    ...
    var_abe648f0 = {#n_start:0.4, #radius:1024, #origin:var_1280faf3.origin};
    level thread function_a7978694(var_abe648f0);
    ...
    var_abe648f0 = {#var_2d65be8d:1, #n_duration:1, #var_efc4d374:0, #n_start:0.4, #radius:1024, #origin:var_1280faf3.origin};
    level thread function_a7978694(var_abe648f0);
    level thread function_2bc1ab1(var_1280faf3.origin);
    wait(1);
    var_3ef4b5cf = var_1280faf3 getseatoccupant(0);
    ...
    while (1) {
        ...
        if (!isdefined(var_b700f817)) {
            ...
            if (isarray(a_trace)) {
                ...
                if (isdefined(var_fd92bc1) && var_fd92bc1 flag::get(#"hash_7808b840308266e0")) {
                    var_b700f817 = var_fd92bc1;
                }
            }
        }
        if (isdefined(var_b700f817) && !var_b700f817 flag::get(#"hash_33a505d2b0b5be40")) {
            var_b700f817 dodamage(9999, var_deda81c2, var_1280faf3, var_1280faf3, "none", "MOD_UNKNOWN", 0, getweapon(#"hash_44b6ac9de3d37ee1"));
            var_b700f817 flag::set(#"hash_33a505d2b0b5be40");
...
function function_ea336b90(var_ce34262e) {
    wait(0.1);
    if (isdefined(var_ce34262e)) {
        var_ce34262e flag::clear(#"hash_33a505d2b0b5be40");
    }
}
...
function function_e8799ac6(v_center, n_radius = 512) {
    ...
    foreach (var_ccea7dbf in var_17c7dbe6) {
        if (isalive(var_ccea7dbf) && !is_true(var_ccea7dbf.var_c71090dd)) {
            ...
            var_ccea7dbf.var_c71090dd.var_ccea7dbf = 1;
                ...
                if (isdefined(str_ai) && isdefined(s_spawn)) {
                    ...
                    if (isdefined(ai_spawned)) {
                        ...
                        if (str_ai == #"zombie") {
                            ...
                            if (str_ai == #"hash_3d92e2c7bea1eee2" || str_ai == #"abom") {
...
function function_544d0383(var_41ca011b = 0) {
    ...
    if (level.var_75a7d6.var_cd0c8367.size < var_b849ca6e) {
            ...
            if (math::cointoss(5)) {
                ...
                if (!isdefined(str_flag) || !level.var_75a7d6 flag::get(str_flag)) {
                    ...
                    if (isdefined(var_c663e5dc) && getaiarchetypearray(#"abom").size < var_c663e5dc) {
                        ...
                        if (isstruct(s_spawn)) {
                            return {#s_spawn:s_spawn, #str_ai:#"abom"};
                        }
                    }
                }
            }
            if (math::cointoss(5)) {
                ...
                if (!isdefined(str_flag) || !level.var_75a7d6 flag::get(str_flag)) {
                    ...
                    if (isdefined(var_5211199d) && getaiarchetypearray(#"hash_3d92e2c7bea1eee2").size < var_5211199d) {
                        s_spawn = get_spawn(#"hash_3d92e2c7bea1eee2", var_41ca011b);
                        if (isstruct(s_spawn)) {
        ...
        if (math::cointoss(5)) {
            ...
            if (!isdefined(str_flag) || !level.var_75a7d6 flag::get(str_flag)) {
                ...
                if (isdefined(var_cd1a1fde) && getaiarchetypearray(#"hash_9f6bc1960ff4912").size < var_cd1a1fde) {
                    s_spawn = get_spawn(#"hash_9f6bc1960ff4912", var_41ca011b);
                    if (isstruct(s_spawn)) {
        ...
        if (math::cointoss(5)) {
            var_591caa3e = function_a831c582(#"hash_be2e962be17d10e");
            str_flag = var_591caa3e.str_flag;
            if (!isdefined(str_flag) || !level.var_75a7d6 flag::get(str_flag)) {
                switch (n_players) {
                case 1:
                ...
                if (isdefined(var_aa963e5b) && getaiarchetypearray(#"hash_be2e962be17d10e").size < var_aa963e5b) {
                    s_spawn = get_spawn(#"hash_be2e962be17d10e", var_41ca011b);
                    if (isstruct(s_spawn)) {
                        return {#s_spawn:s_spawn, #str_ai:#"hash_be2e962be17d10e"};
                    }
                }
            }
        }
...
function function_c835e3c4(*einflictor, *eattacker, *idamage, *smeansofdeath, *weapon, *var_fd90b0bb, *vdir, *shitloc, *psoffsettime, *deathanimduration) {
    ...
    var_c84f9a30 = [5:#"hash_59dbe8f72baaa2a3", 4:#"hash_59dbe7f72baaa0f0", 3:#"hash_59dbeef72baaacd5", 2:#"hash_59dbedf72baaab22", 1:#"hash_59dbecf72baaa96f", 0:#"hash_38c08136902fd553"];
...
function function_c69bc55b(e_player) {
    ...
    e_player val::function_e681e68e(#"hash_48aef5b4fba4687c");
    if (e_player function_495bdc7b(#"hash_114ba314a93a4562")) {
...
function function_26a3bcef(var_d2ee34ea) {
    ...
    while (1) {
        ...
        var_3128fb28 = util::spawn_model(#"hash_e4acd0d27d95fd0", var_d2ee34ea.origin + vectorscale((0, 0, 1), 4096), var_d2ee34ea.angles);
        ...
        level thread function_d426b29d(var_d2ee34ea, var_3128fb28, b_first);
        if (!isstruct(var_d2ee34ea.s_next)) {
            break;
        }
        n_wait = 1;
...
// Size: 0x2b4
function function_d426b29d(var_d2ee34ea, var_3128fb28, b_first = 0) {
    if (!(isdefined(var_d2ee34ea) && isdefined(var_3128fb28))) {
        return;
    }
    level endon(#"end_game");
    ...
    var_3128fb28 moveto(var_d2ee34ea.origin, 1);
...
function function_14a35d6f() {
    /#
        ...
        var_a347ab1 = get_array(#"hash_5c9e57cec1f8655b");
...
function devgui_setup() {
    /#
        add_debug_command("end_fight_stand_clip_le");
        add_debug_command("zmbLastStand");
...
function function_6361fb61(str_cmd) {
    /#
        ...
        case #"hash_2a7935567fe375b4":
            if (level get(#"hash_2145c074d359b87d")) {
