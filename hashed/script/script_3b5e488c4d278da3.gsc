        ...
        foreach (var_97ba446e in var_3e0f6c4b) {
            ...
            if (isdefined(zone)) {
                ...
                if (!isdefined(zone.var_6284d1b2)) {
                    zone.var_6284d1b2.zone = [];
                }
                if (!isdefined(zone.var_6284d1b2)) {
                    zone.var_6284d1b2.zone = [];
                } else if (!isarray(zone.var_6284d1b2)) {
                    zone.var_6284d1b2.zone = array(zone.var_6284d1b2);
                }
        ...
        foreach (s_snowball_pile in a_s_snowball_piles) {
            ...
            if (isdefined(zone)) {
                ...
                if (!isdefined(zone.var_45d884e6)) {
                    zone.var_45d884e6.zone = [];
                }
                if (!isdefined(zone.var_45d884e6)) {
                    zone.var_45d884e6.zone = [];
                } else if (!isarray(zone.var_45d884e6)) {
                    zone.var_45d884e6.zone = array(zone.var_45d884e6);
                }
...
function function_a05df3a7() {
    ...
    foreach (location in var_2c4241da) {
        var_ea5e3cde = spawn("script_model", location.origin);
        var_ea5e3cde.angles.var_ea5e3cde = location.angles;
        var_ea5e3cde setmodel("p9_zm_silver_foliage_tree_christmas_full");
        var_ea5e3cde solid();
        var_ea5e3cde disconnectpaths();
    }
}
    ...
    foreach (zone in level.var_76dd228a) {
        ...
        if (isdefined(zone.var_4acb65df)) {
            ...
            if (zone.var_6cff21f5 < 3) {
                ...
                var_e779ff3c = 0;
                var_9043cfe5 = getplayers(undefined, zone.var_45d884e6[index].origin, 910);
                players = getplayers();
                foreach (player in players) {
    ...
    foreach (zone in level.var_77143112) {
        ...
        if (isdefined(zone.var_a5015123)) {
            ...
            if (zone.var_e600b8df < 2) {
                ...
                var_e779ff3c = 0;
                var_9043cfe5 = getplayers(undefined, zone.var_6284d1b2[index].origin, 910);
                players = getplayers();
                foreach (player in players) {
                ...
                if (is_true(zone.var_b5490369) || var_e779ff3c === 0 && var_9043cfe5.size === 0 && (!isdefined(zone.var_6284d1b2[index].var_9ae54d14) || zone.var_6284d1b2[index].var_9ae54d14 < gettime() - 30000)) {
                    zone.var_6284d1b2[index] function_4d68903d(zone);
                    arrayremoveindex(zone.var_6284d1b2, index);
                }
            }
        }
        zone.var_b5490369.zone = 0;
    }
}
...
function private function_608b90b4() {
    ...
    while (1) {
        ...
        if (!is_true(e_player.var_61fca2c3)) {
            e_player.var_61fca2c3.e_player = 1;
        }
        if (self.var_e95e6830 <= 0) {
            ...
            if (!isinarray(self.zone.var_45d884e6, self.var_381ff592)) {
                self.zone.var_45d884e6[self.zone.var_45d884e6.size] = self.var_381ff592;
            }
...
function function_79ef6b93(snowball_pile) {
    ...
    if (isdefined(item)) {
        ...
        if (snowball_pile.var_8438fd5c === 1) {
            snowball_pile.var_8438fd5c.snowball_pile = 0;
            playfx("maps/ltm/fx9_winter_snowball_pile_pickup", self.origin);
        ...
        snowball_pile.var_e95e6830.snowball_pile = snowball_pile.var_e95e6830 - var_ff2621e6;
    }
}
...
function function_f5527ca2(zone) {
    ...
    snowball_pile.targetname.snowball_pile = "snowball_pile";
    snowball_pile.angles.snowball_pile = self.angles;
    snowball_pile setmodel("p8_wz_snowball_pile");
    snowball_pile.var_381ff592.snowball_pile = self;
    snowball_pile.zone = zone;
    snowball_pile.zone.var_6cff21f5++;
    snowball_pile.var_8438fd5c.snowball_pile = 1;
    ...
    if (!isdefined(zone.var_4acb65df)) {
        ...
        zone.var_4acb65df.zone = array(zone.var_4acb65df);
    }
...
function function_4d68903d(zone) {
    ...
    var_ba10d455 = util::spawn_model("p9_nt6x_win_snowman", self.origin, self.angles);
    var_ba10d455.takedamage.var_ba10d455 = 1;
    var_ba10d455.health.var_ba10d455 = 100;
    var_ba10d455.var_493b77d4.var_ba10d455 = 1;
    var_ba10d455.var_defc3cee.var_ba10d455 = 1;
    var_ba10d455.var_381ff592.var_ba10d455 = self;
    var_ba10d455.zone = zone;
    var_ba10d455.zone.var_e600b8df++;
    var_ba10d455.spawn_time.var_ba10d455 = gettime();
    var_ba10d455.var_5d6eb0f1.var_ba10d455 = 1;
    var_ba10d455.var_6748b2d2.var_ba10d455 = #"hash_52c65a6a82b13cfd";
    var_ba10d455 disconnectpaths();
    var_ba10d455 solid();
    var_ba10d455 setcandamage(1);
    self.var_38409c6 = "snowman";
    self.var_ba10d455 = var_ba10d455;
    function_1eaaceab(zone.var_a5015123);
    if (!isdefined(zone.var_a5015123)) {
        zone.var_a5015123.zone = [];
    } else if (!isarray(zone.var_a5015123)) {
        zone.var_a5015123.zone = array(zone.var_a5015123);
    }
    if (!isinarray(zone.var_a5015123, var_ba10d455)) {
        zone.var_a5015123[zone.var_a5015123.size] = var_ba10d455;
    }
    var_ba10d455 thread function_dc8f034(self.var_ba10d455);
    var_c416888f = randomint(100);
    if (var_c416888f < 100) {
        var_ba10d455 thread function_36043197();
    }
}
                ...
                if (self.spawn_time < gettime() - var_47b592ad) {
                    ...
                    if (isdefined(self.var_bd710417[player getentitynumber()])) {
                        if (self.var_bd710417[player getentitynumber()] === 0) {
                            ...
                            self.var_9d1762d6 = 1;
                            self.var_381ff592 thread function_87490b97(self.zone);
                            self.var_381ff592.var_9ae54d14 = gettime();
...
function function_87490b97(zone) {
    ...
    self function_a9114898(self.var_ba10d455.origin, self.var_ba10d455.angles);
    if (!isdefined(zone.var_6284d1b2)) {
        zone.var_6284d1b2.zone = [];
    } else if (!isarray(zone.var_6284d1b2)) {
        zone.var_6284d1b2.zone = array(zone.var_6284d1b2);
...
// Size: 0x1da
function function_dc8f034(*var_ba10d455) {
    self endon(#"death");
    while (1) {
        ...
        if (self.health <= 0) {
            self.var_381ff592 function_a9114898(self.origin, self.angles);
            ...
            if (!isinarray(self.zone.var_6284d1b2, self.var_381ff592)) {
                self.zone.var_6284d1b2[self.zone.var_6284d1b2.size] = self.var_381ff592;
            }
            self.var_381ff592.var_9ae54d14 = gettime();
            self function_856d0105();
            return;
...
function function_83cb84d3(var_20287981, var_3798631c, var_b9012667, var_63942b62, var_6ff6be61) {
    ...
    var_7580ce3e.origin.var_7580ce3e = self.origin;
    var_7580ce3e.angles.var_7580ce3e = self.angles;
    var_7580ce3e.var_738dfc81.var_7580ce3e = 1;
...
function on_ai_damaged(params) {
    if (params.weapon.name === #"snowball" && !(self.var_6f84b820 === #"hash_72d4f2ad2e333eb4")) {
        ...
        if (params.eattacker zm_powerups::is_insta_kill_active()) {
            ...
            self thread namespace_2315676d::function_f00409f3(params.eattacker, undefined, params.weapon, 0, 3);
        }
    }
}
