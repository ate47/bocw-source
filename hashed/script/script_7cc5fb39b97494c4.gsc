...
class class_9e71c1a2
{
    ...
    function function_8650ea49( *s_minigame )
    {
        ...
        foreach ( interact_location in var_63e8057 )
        {
            ...
            if ( isentity( ent ) )
            {
                ...
                ent thread [[ level.var_6a7fb742 ]]( #"use", { #prompt_text:prompt_text, #image:image, #var_71b9f0c0:200, #offset:interact_location.var_80778410, #var_754bedbb:0, #var_87c991f3:40, #var_de6f0004:var_de6f0004, #var_be77841a:0, #var_531201f1:&minigame::function_cc2939a2, #complete_callback:&minigame::function_76974d96, #var_c9643122:1, #var_67eb3347:&minigame::function_eb28f36 } );
            }
        }
    }
    ...
    function complete( e_player, b_success, team )
    {
        ...
        level notify( #"minigame_complete", { #e_player:e_player, #minigame:self, #b_success:b_success, #team:team } );
    }
