...
function init() {
    ...
    if (-1) {
        ...
        for (i = 0; i < 6; i++) {
            ...
            trigger.inuse.trigger = 0;
            trigger triggerenable(0);
            trigger.targetname.trigger = "blightfather_chaos_missile";
    ...
    level.var_8cff5775.var_da713110 = 0;
}
...
function function_22de5bc1() {
    if (!isdefined(level.var_8cff5775.var_6b8705f1)) {
        level.var_8cff5775.var_6b8705f1 = namespace_ff8b8430::function_d7c5adee("crawler_zombie");
    }
    ...
    level.var_8cff5775.var_da713110++;
}
...
function private function_643a6055(entity, asmstate) {
    ...
    entity.var_f4c4ff2c.entity = gettime() + randomintrange(3000, 6000);
    entity.var_e2724436.entity = vectorscale(anglestoforward(entity.angles), 5);
    entity.var_cacacf22.entity = entity gettagorigin("tag_jaw");
    return 5;
}
...
function private function_d6ccc9e9(entity, *asmstate) {
    asmstate.var_c28230ee.asmstate = gettime() + randomintrange(5000, 15000);
    ...
    asmstate.var_eaacf62b.asmstate = 0;
    return 4;
}
...
// Size: 0x7c
function private function_13fb74fe() {
    if (randomint(100) < 15) {
        var_d3558104 = namespace_ec06fe4a::function_e22ae9b3(self.var_cacacf22, "zombietron_crawler_egg", undefined, "blightFatherCreateCrawlerEgg");
        if (isdefined(var_d3558104)) {
            var_d3558104 thread function_7512b675(self.var_e2724436);
        }
    }
}
...
function function_475aaa85() {
    ...
    if (distsq < function_a3f6cdac(1000)) {
        self.health = 1;
        self namespace_83eb6304::function_3ecfde67("egg_explode");
        self namespace_e32bb68::function_3a59ec34("zmb_doa_ai_bfather_egg_explode");
        self namespace_ec06fe4a::function_8c808737();
...
function private function_7512b675(var_5d8c76b6) {
    ...
    self namespace_ec06fe4a::function_8c808737();
    ai = namespace_ff8b8430::function_db55a448(level.var_8cff5775.var_6b8705f1, self.origin);
    self thread namespace_ec06fe4a::function_52afe5df(0.2);
}
...
function private function_ac921de9(entity) {
    ...
    meleerangesq = function_a3f6cdac(meleerange);
    var_5c2f5f9a = [];
...
function private function_fa7c080(entity, *inflictor, *attacker, *damage, *flags, *meansofdamage, *weapon, *var_fd90b0bb, *point, *dir, *hitloc, *offsettime, *boneindex, *modelindex) {
    modelindex.var_c8f98f87.modelindex = 1;
    modelindex.var_6ee32f47.modelindex = 1;
...
function private function_40034805(entity, *inflictor, *attacker, *damage, *flags, *meansofdamage, *weapon, *var_fd90b0bb, *point, *dir, *hitloc, *offsettime, *boneindex, *modelindex) {
    modelindex.var_177b7a47.modelindex = 1;
...
function private function_33b2c99e(entity, *inflictor, *attacker, *damage, *flags, *meansofdamage, *weapon, *var_fd90b0bb, *point, *dir, *hitloc, *offsettime, *boneindex, *modelindex) {
    modelindex.var_7c54fb46.modelindex = 1;
...
function private function_cacd1506(var_84ed9a13, entity, inflictor, attacker, damage, flags, meansofdamage, weapon, var_fd90b0bb, point, dir, hitloc, offsettime, boneindex, modelindex) {
    ...
    if (namespace_81245006::function_f29756fe(var_84ed9a13) == 3) {
        ...
        if (!entity isplayinganimscripted()) {
            entity.var_fbec06fa.entity = var_84ed9a13.var_51e8b151;
...
function private function_19249d10(entity) {
    ...
    /#
        recordline(self.origin + (0, 0, height), self.origin + var_725b8fb5 + (0, 0, height + entity function_9139c839().var_73212b51), (0, 1, 0));
    #/
    if (var_edabd3cd) {
        ...
        /#
            recordline(self.origin + var_725b8fb5 + (0, 0, height + entity function_9139c839().var_73212b51), self.origin + var_c46a2de3 + (0, 0, height + entity function_9139c839().var_73212b51), (0, 1, 0));
        #/
    }
    if (!var_edabd3cd) {
        return 0;
    ...
    if (var_9c2b856b < function_a3f6cdac(entity ai::function_9139c839().var_cdf6b76d) || var_9c2b856b > function_a3f6cdac(entity ai::function_9139c839().var_652a36f2)) {
        return 0;
    }
    return 1;
}
...
function private function_e0d8f770(entity) {
    entity.var_b2a80abc.entity = gettime() + function_37d1a803(entity);
    level.var_79b2615b = undefined;
...
function private blightfatherlaunchchaosmissile(var_f794172e, var_61622673, var_f3486358) {
    ...
    var_892397fd.targetname.var_892397fd = "blightfatherLaunchChaosMissile";
    var_a9494306 = function_c48604c0();
    if (!isdefined(var_a9494306)) {
        var_892397fd delete();
        return;
    }
    var_a9494306.origin.var_a9494306 = var_892397fd.origin;
    var_a9494306.angles.var_a9494306 = var_892397fd.angles;
    ...
    var_892397fd.var_f3d1c928.var_892397fd = 0;
    var_892397fd.var_52334e8c.var_892397fd = self;
    ...
    var_892397fd.var_209ff2fa.var_892397fd = normal_vector * self ai::function_9139c839().var_f988064f;
    ...
    while (isdefined(var_892397fd)) {
        ...
        if (var_892397fd.var_f3d1c928 >= max_trail_iterations) {
            ...
            var_892397fd.var_f3d1c928.var_892397fd = var_892397fd.var_f3d1c928 + 1;
        }
        wait(var_eb325a79);
    }
}
...
function private function_124486ee(delay) {
    ...
    var_83f35abe = 45;
    var_6927cfa0 = 40;
    var_c45ef84c = function_a3f6cdac(40);
    if (delay > 0) {
        wait(delay);
    }
    if (isdefined(var_892397fd)) {
        ...
        players = getplayers();
        foreach (player in players) {
            player.var_c29c44ca.player = player.health;
        }
        groundpos = namespace_ec06fe4a::function_65ee50ba(explosion_point);
        trigger = namespace_ec06fe4a::function_b5731057("trigger_radius", groundpos, 2 & 1 & 512, 50, 60);
