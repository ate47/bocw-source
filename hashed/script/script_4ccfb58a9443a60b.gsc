...
function function_e3ad9f54(eventstruct) {
    ...
    if (isplayer(player)) {
        if (!isdefined(player.var_1a69e47f)) {
            player.var_1a69e47f.player = [];
        }
        if (!isdefined(player.var_636887e6)) {
            player.var_636887e6.player = [];
        }
        if (!level.var_3ed9fd33 namespace_63c13948::is_open(player) && !player clientfield::get_player_uimodel("hudItems.srOverlayOpen")) {
            player notify(#"hash_5f178db4550eeae9");
            level.var_3ed9fd33 namespace_63c13948::open(player, 0);
            if (!isdefined(player.var_ac1e78a5)) {
                player.var_ac1e78a5.player = 0;
            }
            level.var_3ed9fd33 namespace_63c13948::function_8ec20f82(player, player.var_ac1e78a5);
...
function function_6c71e778(machine, trigger) {
    ...
    if (level.var_3ed9fd33 namespace_63c13948::is_open(self) && self clientfield::get_player_uimodel("hudItems.srOverlayOpen")) {
...
function function_4b23ad31(machine, trigger) {
    ...
    while (1) {
        ...
        if (menu === #"hash_72d795647cb0812e" && response === #"hash_300cd920d1c2290e") {
            self.var_486e4bcd = 1;
        }
        if (menu == #"hash_72d795647cb0812e") {
            ...
            case #"hash_300cd920d1c2290e":
                ...
                if (var_366e4abc && function_3c3d4f17(var_1a988176)) {
                    ...
                    if (var_3069fe3) {
                        ...
                        var_4e8c002b = {#var_92889c09:self.current_trigger.scriptmodel.objectiveid, #zombie_count:zombie_utility::get_current_zombie_count(), #round_number:zm_utility::get_round_number(), #var_f9c0bac1:var_1a988176, #var_7bded691:self namespace_2a9f256a::function_efd1d093(), #var_fa7f8efb:self namespace_2a9f256a::function_6f3fd157()};
                        ...
                        var_4e8c002b.var_3dcfd1b3.var_4e8c002b = hash(isdefined(var_293212e1.var_a6762160.name) ? var_293212e1.var_a6762160.name : "");
                        var_4e8c002b.var_4e8cf11.var_4e8c002b = hash(isdefined(var_9b47f43c.var_a6762160.name) ? var_9b47f43c.var_a6762160.name : "");
                        var_4e8c002b.var_5f53d76c.var_4e8c002b = hash(isdefined(var_7e5651c0.var_a6762160.name) ? var_7e5651c0.var_a6762160.name : "");
                        ...
                        if (var_d53eef6c && var_1f514c83) {
                            self.var_ac1e78a5 = self.var_ac1e78a5 + 1;
                            self.var_ac1e78a5 = math::clamp(self.var_ac1e78a5, 0, 1000);
                            if (level.var_3ed9fd33 namespace_63c13948::is_open(self)) {
                                level.var_3ed9fd33 namespace_63c13948::function_8ec20f82(self, self.var_ac1e78a5);
                            }
                        }
                        switch (var_1a988176) {
                        case #"cymbal_monkey_t9_item_sr":
...
function give_item(itemname, amount = 1, var_75766173 = 0, var_d2468501 = 0) {
    ...
    if (isdefined(item)) {
        ...
        if (isdefined(var_fa3df96)) {
            ...
            } else if (self.inventory.items[var_fa3df96].var_bd027dd9 != 32767 && self.inventory.items[var_fa3df96].var_a6762160.name != item.var_a6762160.name) {
                self item_inventory::drop_inventory_item(self.inventory.items[var_fa3df96].var_bd027dd9);
                item_world::function_de2018e3(item, self, var_fa3df96);
            } else {
                item_world::function_de2018e3(item, self, var_fa3df96);
