...
#namespace namespace_b652cc2;

// Namespace namespace_b652cc2/namespace_b652cc2
// Params 1, eflags: 0x0
...
function function_2c200d72(*var_c79d614f) {
    ...
    thread namespace_b6fe1dbe::function_fa41ffd9();
    wait 2;
...
function function_9bea58bf() {
    ...
    wait 3;
    thread namespace_b6fe1dbe::function_b263738a();
}
...
function function_a8e922fd() {
    ...
    if (var_4caaf0f5.size - 1 > 0 && a_e_enemies.size <= 10) {
        ...
        var_982e50da = spawner::simple_spawn(var_a881a891, &function_4dab8b6d);
        ai::waittill_dead(var_982e50da);
    }
}
...
function function_6b6ab2a9(*params) {
    ...
    if (var_7639372f <= 0.25 && !level.var_9d4a1f15) {
        ...
        var_aa6c68b9 = util::spawn_model("tag_origin", s_teleport.origin, s_teleport.angles);
        level.player setorigin(var_aa6c68b9.origin);
        level.player playerlinktodelta(var_aa6c68b9, "tag_origin", 0, 0, 0, 0, 0);
        thread namespace_b6fe1dbe::function_60fe7ae0();
        level notify(#"hash_6382d54ccc430b03");
        wait 7;
