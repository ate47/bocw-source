...
function private function_70a657d8() {
    entry = spawnstruct();
    entry.weapon_name.entry = #"hash_f223cacb02788e3";
    entry.item_name.entry = #"hash_703910d4007ce2b7";
...
function function_36bda67f(watcher) {
    watcher.onspawn.watcher = &function_c50ebe3c;
    watcher.onspawnretrievetriggers.watcher = &function_20c470db;
    watcher.ondamage.watcher = &function_20c470db;
    watcher.deleteonplayerspawn.watcher = 0;
    watcher.altdetonate.watcher = 1;
    watcher.var_e7ebbd38.watcher = &function_2ba36cfa;
}
...
function function_fee6bda() {
    ...
    if (isdefined(self.var_646dca28)) {
        ...
        self.var_dac47117 thread scene::play(#"hash_784b53e0aaf6208d", "shake", self.var_dac47117);
    } else {
...
function function_62d26159(var_86cccd7b, player) {
    ...
    var_86cccd7b.b_ignore_cleanup.var_86cccd7b = 1;
    var_86cccd7b.is_inert.var_86cccd7b = 1;
    var_86cccd7b.is_locked.var_86cccd7b = 1;
    self.var_dac47117 thread scene::play(#"hash_784b53e0aaf6208d", "open", self.var_dac47117);
    wait(0.5);
    ...
    self.var_dac47117 thread scene::play(#"hash_784b53e0aaf6208d", "close", self.var_dac47117);
    ...
    if (isalive(var_86cccd7b)) {
        if (var_86cccd7b.health <= var_86cccd7b.maxhealth * (isdefined(var_86cccd7b.var_d9558be1) ? 0.15 : 0.25)) {
            ...
            var_86cccd7b.is_locked.var_86cccd7b = 0;
            var_86cccd7b.var_943dace9.var_86cccd7b = 1;
            self.var_dac47117 function_652b9314(1);
        ...
        if (result._notify == #"timeout") {
            ...
            if (var_28dbb034) {
                ...
                if (isdefined(var_dac47117)) {
                    var_dac47117 thread scene::play(#"hash_784b53e0aaf6208d", "open", var_dac47117);
                    var_1967ad3.broken.var_1967ad3 = 1;
                    wait(0.2);
                    if (isdefined(var_dac47117)) {
...
// Size: 0x124
function function_8fc5d602(var_7961a37e, var_52dbcd71) {
    ...
    if (isplayer(entity)) {
        level zm_vo::function_d6f8bbd9(var_52dbcd71, undefined, entity);
    } else {
        var_a5a8e724 = util::spawn_model(#"tag_origin", entity.origin, entity.angles);
        var_a5a8e724 zm_vo::function_d6f8bbd9(var_52dbcd71);
...
// Size: 0x14
function function_20c470db(*watcher, *player) {
