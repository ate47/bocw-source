            ...
            if (isdefined(ent.var_5744d1ac)) {
                ...
                case #"hash_7b703ac05ec3488a":
                    if (!isdefined(s_loc.var_ae9d791b)) {
                        s_loc.var_ae9d791b.s_loc = [];
                    } else if (!isarray(s_loc.var_ae9d791b)) {
                        s_loc.var_ae9d791b.s_loc = array(s_loc.var_ae9d791b);
                    }
                ...
                case #"float":
                    ...
                    foreach (var_3c91d8e7 in struct::get_array(struct.target)) {
                        if (isdefined(var_3c91d8e7.var_5744d1ac)) {
                            ...
                            case #"hash_4906da0a2f3e31d2":
                                if (!isdefined(struct.var_4ad75699)) {
                                    struct.var_4ad75699.struct = [];
                                } else if (!isarray(struct.var_4ad75699)) {
                                    struct.var_4ad75699.struct = array(struct.var_4ad75699);
                                }
...
function function_ec198408(b_skipped, *var_19e802fa) {
    ...
    zm_sq::function_53d0d99(#"hash_52c256f0a6c54223");
    ...
    if (!var_19e802fa) {
        ...
        var_e9e88745 = var_75a7d6.var_e9e88745;
        if (isdefined(var_e9e88745)) {
            var_e9e88745 clientfield::set("" + #"hash_4a7733d2f4b25e81", 0);
            var_e9e88745 notsolid();
            var_e9e88745 thread util::delayed_delete(1);
        }
        ...
        if (isdefined(var_b39864d6)) {
            ...
            zm_sq::function_53d0d99(#"hash_135e0bc539d7b383");
        }
        foreach (e_player in getplayers()) {
        ...
        if (isdefined(level.var_56e22cfa)) {
            if (!level flag::get(#"hash_504c8d65e27d0216")) {
                if (level.var_56e22cfa haspart("J_Wrist_LE", "c_t9_zmb_dlc4_battle_klaus_body")) {
                    level.var_56e22cfa showpart("J_Wrist_LE", "c_t9_zmb_dlc4_battle_klaus_body", 1);
                }
                if (level.var_56e22cfa haspart("J_Wrist_RI", "c_t9_zmb_dlc4_battle_klaus_body")) {
                    level.var_56e22cfa showpart("J_Wrist_RI", "c_t9_zmb_dlc4_battle_klaus_body", 1);
                }
            }
            level.var_56e22cfa clientfield::set("" + #"hash_703543ca871a0f75", 1);
        }
        ...
        a_ents[#"hash_5efbc4a59aaed545"] = level.var_56e22cfa;
        ...
        foreach (e_player in getplayers()) {
            ...
            e_player val::function_e681e68e(#"mid_igc");
        ...
        if (isdefined(level.var_56e22cfa) && level.var_56e22cfa.aitype != "spawner_zm_mannequin_ally") {
            aitype = level.var_56e22cfa.aitype;
        } else {
            aitype = "spawner_zm_mannequin_ally_upgraded";
        }
        level.var_56e22cfa = spawnactor(aitype, var_f2b1e478.origin, var_f2b1e478.angles);
...
function function_4477afe1() {
    ...
    var_539110f3 = struct::get(#"hash_141a894a8dc8873e");
...
function function_f73d1f26() {
    var_59c76bb5 = getent("mdl_conversion_machine", "targetname");
    if (isdefined(var_59c76bb5)) {
        var_59c76bb5 setmodel(#"hash_3f4d9e901bbb54b6");
    }
}
...
function function_3eca6bba(var_75a7d6) {
    ...
    wait(2);
    var_3608d414 = [4:#"hash_47de9a985959c315", 3:#"hash_47de97985959bdfc", 2:#"hash_47de98985959bfaf", 1:#"hash_47de95985959ba96", 0:#"hash_47de96985959bc49"];
...
function function_1a3e352c() {
    var_a83358f8 = level.var_56e22cfa;
    if (isdefined(var_a83358f8)) {
        var_a83358f8 endon(#"death");
        var_a83358f8.var_c0d80964.var_a83358f8 = 1;
...
function function_4c4f2d71() {
    var_59c76bb5 = getent("mdl_conversion_machine", "targetname");
    if (isdefined(var_59c76bb5)) {
        var_59c76bb5 endon(#"death");
        level waittill(#"hash_1549bc53a986e991");
        var_59c76bb5 clientfield::set("" + #"hash_765ec7ef8a874f2a", 1);
        level waittill(#"hash_960fb3637aa5630");
        var_59c76bb5 clientfield::set("" + #"hash_765ec7ef8a874f2a", 0);
    }
}
...
function function_79ae7b73() {
    ...
    level flag::clear(#"hash_547cc154153f60ee");
    level flag::clear(#"hash_654f0dad2c9d1d19");
    ...
    level clientfield::set("" + #"hash_228f0acdd4255cb", 0);
    var_75a7d6 = level.var_75a7d6;
    b_teleporting = function_14a35d6f(var_75a7d6, #"hash_126596191dc1ebb4");
    function_ff441bfb(var_75a7d6, #"hash_126596191dc1ebb4");
    level thread namespace_99d0d95e::function_8f85d169(1);
    var_75a7d6.var_2a940370.var_75a7d6 = 0;
    ...
    playfx(#"hash_2c43a6476d6c84c4", s_portal.origin + vectorscale((0, 0, 1), 32), anglestoforward(s_portal.angles), anglestoup(s_portal.angles));
    var_75a7d6.var_fa2af647.var_75a7d6 = util::spawn_model(#"tag_origin", s_portal.origin, s_portal.angles);
    var_fa2af647 = var_75a7d6.var_fa2af647;
    ...
    wait(3);
    var_75a7d6.var_7b123964.var_75a7d6 = level.var_ea32773;
    ...
    var_75a7d6.var_419e6251.var_75a7d6 = level.overrideplayerdamage;
    level.overrideplayerdamage = &function_86c6df86;
    var_75a7d6.str_loc.var_75a7d6 = #"hash_126596191dc1ebb4";
    var_75a7d6.var_1213d07.var_75a7d6 = level.var_11350584;
    ...
    var_75a7d6.var_6359299f.var_75a7d6 = [];
    var_75a7d6.var_b53352fa.var_75a7d6 = 0;
    var_75a7d6.var_25a3af6b.var_75a7d6 = [2:#"hash_2d3075d74e2da3a8", 1:#"hash_56100f3e34a790d", 0:#"hash_24f8b14e0d7981e2"];
    var_75a7d6.s_boss.var_75a7d6 = function_2954a39(var_75a7d6, #"hash_126596191dc1ebb4", 1);
    s_boss = var_75a7d6.s_boss;
    var_75a7d6.var_b39864d6.var_75a7d6 = util::spawn_model(#"hash_381fb9506ce008a0");
    var_b39864d6 = var_75a7d6.var_b39864d6;
    var_b39864d6 clientfield::set("" + #"hash_45d9cedaf4fb4aa2", 1);
    var_add9efd6 = struct::get(#"hash_44cafed41be284f0");
    var_75a7d6.var_a12bf98c.var_75a7d6 = util::spawn_model(#"hash_6a28b95c39dcf74b", var_add9efd6.origin, var_add9efd6.angles);
    var_a12bf98c = var_75a7d6.var_a12bf98c;
    var_75a7d6 flag::set(#"spawned");
    var_75a7d6.var_b6ef5059.var_75a7d6 = [];
    ...
    var_75a7d6.var_8d31700f.var_75a7d6 = function_5f36e356(800000, 1920000);
    var_75a7d6.var_3f956940.var_75a7d6 = var_75a7d6.var_8d31700f;
    var_75a7d6.n_threshold.var_75a7d6 = var_75a7d6.var_8d31700f;
    var_75a7d6.var_4fb7caaf.var_75a7d6 = int(var_75a7d6.var_8d31700f * 0.2);
    var_75a7d6.var_1847f53d.var_75a7d6 = var_75a7d6.n_threshold - var_75a7d6.var_4fb7caaf;
    var_75a7d6.var_f65dc5e1.var_75a7d6 = int(var_75a7d6.var_8d31700f * 0.5);
    var_75a7d6.var_fa625236.var_75a7d6 = int(var_75a7d6.var_8d31700f * 0.1);
    var_75a7d6.var_63b86490.var_75a7d6 = int(var_75a7d6.var_8d31700f * 0.05);
    level thread function_223f7204(var_75a7d6, var_b39864d6);
    var_75a7d6.var_200c676a.var_75a7d6 = function_5f36e356(40000, 96000);
    var_75a7d6.var_9428def3.var_75a7d6 = var_75a7d6.var_200c676a;
...
function function_235a6cd4(var_75a7d6, mdl_portal, s_dest) {
    ...
    mdl_portal.origin.mdl_portal = s_dest.origin;
    mdl_portal.angles.mdl_portal = s_dest.angles;
...
function function_876d602(a_ents) {
    ...
    if (isdefined(var_75a7d6)) {
        ...
        var_fa2af647 = var_75a7d6.var_fa2af647;
        if (isdefined(var_fa2af647)) {
            playfx(#"hash_2c43a6476d6c84c4", var_fa2af647.origin + vectorscale((0, 0, 1), 32), anglestoforward(var_fa2af647.angles), anglestoup(var_fa2af647.angles));
            var_fa2af647 playsound(#"hash_1412afc9788c5421");
        }
        foreach (str_step in [6:#"hash_3da94299c6d33cd5", 5:#"hash_3da94199c6d33b22", 4:#"hash_3da94099c6d3396f", 3:#"hash_3da93f99c6d337bc", 2:#"hash_3da93e99c6d33609", 1:#"hash_3da93d99c6d33456", 0:#"hash_3da93c99c6d332a3"]) {
            var_e236b5ff = a_ents[str_step];
            if (isdefined(var_e236b5ff)) {
                if (!isdefined(var_75a7d6.var_b6ef5059)) {
                    var_75a7d6.var_b6ef5059.var_75a7d6 = [];
                } else if (!isarray(var_75a7d6.var_b6ef5059)) {
                    var_75a7d6.var_b6ef5059.var_75a7d6 = array(var_75a7d6.var_b6ef5059);
                }
...
function function_c0c7140f(var_75a7d6) {
    ...
    wait(0.5);
    namespace_8d91c4fb::function_d137d6a0(#"hash_6a3c2b16f9b14049", #"hash_1d28a188911484ab", #"hash_1630afbf9f79a2e5");
    ...
    for (i = 0; i < 32; i++) {
        ...
        if (isdefined(var_134535fe)) {
            ...
            if (!isdefined(var_75a7d6.var_6359299f)) {
                ...
                var_75a7d6.var_6359299f.var_75a7d6 = array(var_75a7d6.var_6359299f);
            }
...
function function_60c68651(var_75a7d6) {
    var_75a7d6.var_a6d734ec.var_75a7d6 = [];
    foreach (str_id in [13:#"no", 12:#"roar", 11:#"hash_2c9a605d551123cd", 10:#"hash_164a6d2643fa2f83", 9:#"throw", 8:#"hash_24551df13b726bce", 7:#"damage_light", 6:#"new_stage", 5:#"hash_2584844a05345ca6", 4:#"hash_60af5025b12d8632", 3:#"hash_9754b045afe5254", 2:#"hash_477a7859bae6c69c", 1:#"hash_6a3f96f46648766d", 0:#"hash_30bec6b02a79ef59"]) {
        switch (str_id) {
        case #"hash_9754b045afe5254":
            var_3608d414 = [4:#"hash_51ad58339f77c6a9", 3:#"hash_51ad57339f77c4f6", 2:#"hash_51ad5a339f77ca0f", 1:#"hash_51ad59339f77c85c", 0:#"hash_51ad5c339f77cd75"];
            break;
        case #"hash_6a3f96f46648766d":
            var_3608d414 = [4:#"hash_3c8efe4226211e76", 3:#"hash_3c8eff4226212029", 2:#"hash_3c8f0042262121dc", 1:#"hash_3c8f01422621238f", 0:#"hash_3c8f024226212542"];
            break;
        case #"hash_477a7859bae6c69c":
            var_3608d414 = [4:#"hash_73b5f49f0074235f", 3:#"hash_73b5f39f007421ac", 2:#"hash_73b5f29f00741ff9", 1:#"hash_73b5f19f00741e46", 0:#"hash_73b5f09f00741c93"];
            break;
        case #"hash_30bec6b02a79ef59":
            var_3608d414 = [4:#"hash_16cb9df9b1bbb678", 3:#"hash_16cb9ef9b1bbb82b", 2:#"hash_16cba3f9b1bbc0aa", 1:#"hash_16cba4f9b1bbc25d", 0:#"hash_16cba1f9b1bbbd44"];
            break;
        case #"hash_60af5025b12d8632":
            var_3608d414 = [4:#"hash_e6c58f563e121c3", 3:#"hash_e6c57f563e12010", 2:#"hash_e6c5ef563e12bf5", 1:#"hash_e6c5df563e12a42", 0:#"hash_e6c5cf563e1288f"];
            break;
        case #"hash_2584844a05345ca6":
            var_3608d414 = [4:#"hash_1477c1d7a16ffb41", 3:#"hash_1477c0d7a16ff98e", 2:#"hash_1477c3d7a16ffea7", 1:#"hash_1477c2d7a16ffcf4", 0:#"hash_1477c5d7a170020d"];
            break;
        case #"new_stage":
            var_3608d414 = [4:#"hash_84464d980b6120f", 3:#"hash_84463d980b6105c", 2:#"hash_84462d980b60ea9", 1:#"hash_84461d980b60cf6", 0:#"hash_84460d980b60b43"];
            break;
        case #"damage_light":
            var_3608d414 = [4:#"hash_6b2131d79f25f657", 3:#"hash_6b212ed79f25f13e", 2:#"hash_6b212fd79f25f2f1", 1:#"hash_6b212cd79f25edd8", 0:#"hash_6b212dd79f25ef8b"];
            break;
        case #"hash_24551df13b726bce":
            var_3608d414 = [4:#"hash_d0bd740a4220d1d", 3:#"hash_d0bd040a4220138", 2:#"hash_d0bd140a42202eb", 1:#"hash_d0bd240a422049e", 0:#"hash_d0bd340a4220651"];
            break;
        case #"throw":
            var_3608d414 = [4:#"hash_1bdb873d4502387f", 3:#"hash_1bdb843d45023366", 2:#"hash_1bdb853d45023519", 1:#"hash_1bdb823d45023000", 0:#"hash_1bdb833d450231b3"];
            break;
        case #"hash_164a6d2643fa2f83":
            var_3608d414 = [4:#"hash_2aea1dac94d0094c", 3:#"hash_2aea1cac94d00799", 2:#"hash_2aea1bac94d005e6", 1:#"hash_2aea1aac94d00433", 0:#"hash_2aea19ac94d00280"];
            break;
        case #"hash_2c9a605d551123cd":
            var_3608d414 = [4:#"hash_45357f5ef4a7fbe5", 3:#"hash_4535785ef4a7f000", 2:#"hash_4535795ef4a7f1b3", 1:#"hash_45357a5ef4a7f366", 0:#"hash_45357b5ef4a7f519"];
            break;
        case #"roar":
            var_3608d414 = [4:#"hash_33fe468db4887539", 3:#"hash_33fe478db48876ec", 2:#"hash_33fe488db488789f", 1:#"hash_33fe498db4887a52", 0:#"hash_33fe4a8db4887c05"];
            break;
        case #"no":
            var_3608d414 = [4:#"hash_70a5f053859a4df0", 3:#"hash_70a5f753859a59d5", 2:#"hash_70a5f653859a5822", 1:#"hash_70a5f553859a566f", 0:#"hash_70a5f453859a54bc"];
            break;
        }
        if (isdefined(var_3608d414)) {
            var_75a7d6.var_3608d414[str_id][#"all"] = array::randomize(var_3608d414);
            var_75a7d6.var_3608d414[str_id][#"remaining"] = arraycopy(var_75a7d6.var_3608d414[str_id][#"all"]);
        }
    }
}
...
function function_f83c329c(var_75a7d6, str_id, var_a78cf3d4 = 1, n_delay = 0.5, a_e_players, var_591caa3e) {
    if (!(isdefined(str_id) && isdefined(var_75a7d6) && isdefined(var_75a7d6.var_3608d414[str_id]))) {
        return;
    }
    level endon(#"end_game");
    var_75a7d6 endon(#"defeated");
    ...
    if (!var_a78cf3d4 && var_75a7d6 flag::get(#"hash_3201bcb3cc3b7209")) {
        return;
    }
    if (var_75a7d6.var_3608d414[str_id][#"remaining"].size <= 0) {
        var_75a7d6.var_3608d414[str_id][#"remaining"] = arraycopy(var_75a7d6.var_3608d414[str_id][#"all"]);
    }
    str_vo = var_75a7d6.var_3608d414[str_id][#"remaining"][0];
    arrayremoveindex(var_75a7d6.var_3608d414[str_id][#"remaining"], 0);
    ...
    if (var_a78cf3d4) {
        var_75a7d6 flag::increment(#"hash_3201bcb3cc3b7209");
        ...
        var_75a7d6 flag::decrement(#"hash_3201bcb3cc3b7209");
    } else {
        var_b39864d6 = var_75a7d6.var_b39864d6;
        if (isdefined(var_b39864d6)) {
...
function function_e5dc0d0d(var_75a7d6) {
    if (!isdefined(var_75a7d6) || var_75a7d6 flag::get_any([2:#"teleport", 1:#"transition", 0:#"defeated"])) {
        return;
    }
    level endon(#"end_game");
...
function function_223f7204(var_75a7d6, var_b39864d6) {
    ...
    var_b39864d6.health.var_b39864d6 = 1;
    var_b39864d6.var_95ee6823.var_b39864d6 = 0.3;
    var_b39864d6.var_4165b2d7.var_b39864d6 = 1;
    while (1) {
        s_waitresult = undefined;
        ...
        if (var_75a7d6 flag::get(#"shield_down") && isplayer(e_attacker)) {
            ...
            var_db2a8c7a = 1;
            if (var_75a7d6 flag::get_any([2:#"teleport", 1:#"transition", 0:#"hash_30bec6b02a79ef59"])) {
                var_db2a8c7a = 4;
                damage = 0;
            } else {
            ...
            if (!var_75a7d6 flag::get(#"hash_1700094a6a007214") && var_d4fd9284 <= var_75a7d6.var_f65dc5e1) {
                ...
                var_75a7d6.var_3f956940.var_75a7d6 = var_75a7d6.var_f65dc5e1;
                ...
                var_75a7d6.var_3f956940.var_75a7d6 = var_75a7d6.var_1847f53d;
                var_75a7d6.n_threshold.var_75a7d6 = var_75a7d6.var_1847f53d;
                var_75a7d6.var_1847f53d.var_75a7d6 = var_75a7d6.n_threshold - var_75a7d6.var_4fb7caaf;
            } else {
                var_75a7d6.var_3f956940.var_75a7d6 = var_75a7d6.var_3f956940 - damage;
            ...
            if (damage > 0) {
                ...
                level thread function_f83c329c(var_75a7d6, str_vo, 0, 0, undefined, {#n_time:randomfloatrange(6, 9), #str_id:#"damage"});
            }
...
function function_ab3592be(var_75a7d6, var_b39864d6) {
    ...
    var_b39864d6 endon(#"death");
    while (1) {
        var_75a7d6.var_e9e88745.var_75a7d6 = spawncollision(#"hash_3f6fd9083ac4ae62", "mdl_showdown_block", var_b39864d6.origin + (0, 0, 28), var_b39864d6.angles);
        if (isdefined(var_75a7d6.var_e9e88745)) {
            break;
        }
        waitframe(1);
    }
    var_e9e88745 = var_75a7d6.var_e9e88745;
    var_e9e88745 clientfield::set("" + #"hash_4a7733d2f4b25e81", 1);
    var_e9e88745 setteam(level.zombie_team);
    var_e9e88745 val::set(#"hash_367879f79a1812c9", "allowdeath", 0);
    var_e9e88745 val::set(#"hash_367879f79a1812c9", "takedamage", 1);
    var_e9e88745.health.var_e9e88745 = 1;
    var_e9e88745.var_95ee6823.var_e9e88745 = 0.3;
    var_e9e88745.var_4165b2d7.var_e9e88745 = 1;
    while (1) {
        while (1) {
            s_waitresult = undefined;
            s_waitresult = var_e9e88745 waittill(#"damage");
            e_attacker = s_waitresult.attacker;
            if (isplayer(e_attacker)) {
                ...
                var_75a7d6.var_9428def3.var_75a7d6 = var_75a7d6.var_9428def3 - damage;
                var_5f752cb0 = var_75a7d6.var_9428def3 <= 0;
                function_f3ac29fc(var_75a7d6);
                level thread hud::function_c9800094(e_attacker, vpoint, damage, var_db2a8c7a);
                if (var_5f752cb0) {
                    var_e9e88745.var_426947c4.var_e9e88745 = 1;
                } else {
                    var_e9e88745.var_426947c4 = undefined;
                }
                if (damage > 0) {
                    var_fe886504 = "armor";
                    if (var_5f752cb0) {
                    ...
                    e_attacker thread damagefeedback::update(meansofdeath, e_attacker, var_fe886504, weapon, var_e9e88745, psoffsettime, shitloc, var_5f752cb0, 2048, 0);
                }
...
function function_de8ce8ee(var_75a7d6) {
    if (!var_75a7d6 flag::get_any([1:#"teleport", 0:#"transition"])) {
        var_e9e88745 = var_75a7d6.var_e9e88745;
        if (isdefined(var_e9e88745)) {
            var_e9e88745 playsound(#"hash_39abfdd8403c8edd");
        }
        function_1798a522(var_75a7d6);
        var_75a7d6 flag::increment(#"hash_1e2734204ab845a2");
        var_75a7d6 flag::wait_till_any_timeout(10, [1:#"teleport", 0:#"transition"]);
        var_75a7d6 flag::decrement(#"hash_1e2734204ab845a2");
        if (!var_75a7d6 flag::get_any([1:#"teleport", 0:#"transition"])) {
...
function function_1798a522(var_75a7d6 = level.var_75a7d6, var_5749d3fa = 1) {
    if (!isdefined(var_75a7d6) || var_75a7d6 flag::get_any([1:#"teleport", 0:#"transition"])) {
        return;
    }
...
function function_38e49607(var_75a7d6 = level.var_75a7d6, var_352159a3 = 0) {
    if (!isdefined(var_75a7d6) || !var_75a7d6 flag::get(#"shield_down") || var_75a7d6 flag::get_any([2:#"defeated", 1:#"teleport", 0:#"transition"])) {
        return;
    }
...
function function_ff441bfb(var_75a7d6, str_loc) {
    ...
    foreach (s_fx in function_edac342b(s_loc)) {
        s_fx.mdl_fx.s_fx = util::spawn_model(#"tag_origin", s_fx.origin, s_fx.angles);
        n_cf = 1;
...
function function_9551a49a(var_75a7d6) {
    ...
    var_de56fc3d = arraycopy(isdefined(level.var_4b97f99c) ? level.var_4b97f99c : []);
    ...
    foreach (var_74edb1d5 in var_307e1fc6) {
        ...
        if (isdefined(t_trigger)) {
            t_trigger.origin.t_trigger = t_trigger.origin - (0, 0, 5000);
        }
    }
}
...
function function_544d0383(var_75a7d6) {
    ...
    if (math::cointoss(5)) {
        var_591caa3e = function_a831c582(#"hash_3d92e2c7bea1eee2");
        str_flag = var_591caa3e.str_flag;
        if (!isdefined(str_flag) || !var_75a7d6 flag::get(str_flag)) {
            ...
            if (isdefined(var_5211199d) && getaiarchetypearray(#"hash_3d92e2c7bea1eee2").size < var_5211199d) {
                s_spawn = zm_platinum::function_65c98960(0);
                if (isstruct(s_spawn)) {
                    return {#s_spawn:s_spawn, #str_ai:#"hash_3d92e2c7bea1eee2"};
                }
            }
        }
    }
    ...
    if (math::cointoss(5)) {
        var_591caa3e = function_a831c582(#"hash_9f6bc1960ff4912");
        str_flag = var_591caa3e.str_flag;
        if (!isdefined(str_flag) || !var_75a7d6 flag::get(str_flag)) {
            switch (n_players) {
            case 1:
            ...
            if (isdefined(var_cd1a1fde) && getaiarchetypearray(#"hash_9f6bc1960ff4912").size < var_cd1a1fde) {
                s_spawn = zm_platinum::function_d9f5ec34(0);
                if (isstruct(s_spawn)) {
                    return {#s_spawn:s_spawn, #str_ai:#"hash_9f6bc1960ff4912"};
                }
            }
        }
    }
...
function function_73ef29bf(var_75a7d6, var_9161d39c = #"", var_b6ada9ed = 0) {
    ...
    if (var_75a7d6 flag::get_any([2:#"defeated", 1:#"teleport", 0:#"transition"])) {
        return;
    }
    n_wait = 6;
    if (var_b6ada9ed) {
    ...
    if (var_75a7d6 flag::get(#"hash_53f03da53102f4ff") && !var_75a7d6 flag::get_any([1:#"shield_down", 0:#"hash_39316cd070ab8069"]) && math::cointoss(100) && var_75a7d6.var_3f956940 <= var_75a7d6.n_threshold - var_75a7d6.var_63b86490) {
...
function function_b2871ce6(var_75a7d6) {
    ...
    mdl_fx = util::spawn_model(#"tag_origin", var_b39864d6.origin - vectorscale((0, 0, 1), 8), var_b39864d6.angles);
    ...
    var_6976f577.origin.var_6976f577 = var_3d2df074.origin;
    var_6976f577.angles.var_6976f577 = var_3d2df074.angles;
    wait(2);
    var_6976f577 delete();
    ...
    if (var_9207bb3a > 0) {
        playfx(#"hash_2c43a6476d6c84c4", mdl_fx.origin, anglestoforward(mdl_fx.angles), anglestoup(mdl_fx.angles));
    ...
    mdl_fx.origin.mdl_fx = var_3d2df074.origin;
    mdl_fx.angles.mdl_fx = var_3d2df074.angles;
...
function function_14a35d6f(var_75a7d6, str_loc, b_play_vo = 1) {
    ...
    if (isdefined(vol_arena)) {
        ...
        if (var_a347ab1.size > 0) {
            ...
            if (b_teleporting) {
                if (b_play_vo) {
                    level thread function_f83c329c(var_75a7d6, #"hash_2584844a05345ca6", 1, undefined, var_f6671a7d);
                }
                ...
                foreach (e_player in function_a1ef346b()) {
                    ...
                    if (e_player isonladder() || !e_player istouching(vol_arena)) {
                        ...
                        level thread function_54a46b15(e_player, vol_arena, var_5f1812e0);
                    }
                }
                if (b_teleporting) {
                    return 1;
...
// Size: 0xf4
function function_54a46b15(e_player, vol_arena, var_5f1812e0) {
    level endon(#"end_game");
    if (!isalive(e_player)) {
        return;
    }
    e_player endon(#"death");
    while (e_player function_e128a831() || e_player function_b4813488()) {
        waitframe(1);
    }
    if (e_player isonladder() || !e_player istouching(vol_arena)) {
...
function function_761d8ea1(var_75a7d6, var_a12bf98c, b_enable = 1) {
    ...
    if (b_enable) {
        if (!isdefined(var_a12bf98c.var_1440b452)) {
            var_a12bf98c.var_1440b452.var_a12bf98c = util::spawn_model(#"tag_origin", var_a12bf98c.origin + vectorscale((0, 0, 1), 40), var_a12bf98c.angles);
            if (isdefined(var_a12bf98c.var_1440b452)) {
                var_a12bf98c.var_1440b452 clientfield::set("" + #"hash_41ba39a474a3503f", 1);
            }
        }
    } else if (isdefined(var_a12bf98c.var_1440b452)) {
...
function function_a094b1fc(var_75a7d6) {
    ...
    var_4c2ab3d4 = [8:{#var_6ab5a6dc:"vacuum_9", #str_idle:"idle_9"}, 7:{#var_6ab5a6dc:"vacuum_8", #str_idle:"idle_8"}, 6:{#var_6ab5a6dc:"vacuum_7", #str_idle:"idle_7"}, 5:{#var_6ab5a6dc:"vacuum_6", #str_idle:"idle_6"}, 4:{#var_6ab5a6dc:"vacuum_5", #str_idle:"idle_5"}, 3:{#var_6ab5a6dc:"vacuum_4", #str_idle:"idle_4"}, 2:{#var_6ab5a6dc:"vacuum_3", #str_idle:"idle_3"}, 1:{#var_6ab5a6dc:"vacuum_2", #str_idle:"idle_2"}, 0:{#var_6ab5a6dc:"vacuum_1", #str_idle:"idle_1"}];
    ...
    while (var_748cf9be.size > 0) {
        ...
        if (isalive(var_756c01dd)) {
            ...
            if (isalive(var_756c01dd) && s_waitresult._notify == #"timeout") {
                ...
                var_756c01dd function_cb48cddd();
                if (isdefined(var_75a7d6.n_threshold) && isdefined(var_75a7d6.var_3f956940) && isdefined(var_75a7d6.var_fa625236)) {
                    var_75a7d6.var_3f956940.var_75a7d6 = int(min(var_75a7d6.n_threshold, var_75a7d6.var_3f956940 + var_75a7d6.var_fa625236));
                    function_73f95a0c(var_75a7d6);
                }
...
function function_cbdf02c2(ai_zombie, s_spawn, s_rise, var_fdc796b6) {
    ...
    ai_zombie.start_inert.ai_zombie = 1;
    ai_zombie.ignore_find_flesh.ai_zombie = 1;
    ...
    ai_zombie.var_98f1f37c.ai_zombie = 1;
    ai_zombie callback::function_d8abfc3d(#"death", &function_14251f2b);
    ai_zombie.var_99c4ce87.ai_zombie = {#var_6ab5a6dc:var_fdc796b6.var_6ab5a6dc, #str_idle:var_fdc796b6.str_idle, #s_rise:s_rise, #s_spawn:s_spawn};
    ai_zombie.var_836ab086.ai_zombie = util::spawn_model(#"tag_origin", s_rise.origin, s_rise.angles);
...
function function_8b73a6d3(a_ents) {
    ...
    if (isalive(var_51bad3e3) && isdefined(s_rise) && isdefined(var_86cfd484) && isdefined(s_spawn)) {
        ...
        playfx(#"hash_7cba1293ce9b2890", s_rise.origin);
        ...
        var_86cfd484.origin.var_86cfd484 = s_spawn.origin;
        var_86cfd484.angles.var_86cfd484 = s_spawn.angles;
    }
}
...
function function_975a5a48(var_75a7d6) {
    ...
    a_e_players = [];
    foreach (e_player in function_a1ef346b()) {
        if (zm_utility::is_player_valid(e_player) && !is_true(e_player.ignoreme) && distance2dsquared(e_player.origin, var_b39864d6.origin) <= function_a3f6cdac(1500)) {
    ...
    var_e9e88745 = var_75a7d6.var_e9e88745;
    var_11384e2c = var_b39864d6.origin + vectorscale((0, 0, 1), 128);
    if (n_players <= 1) {
        e_player = a_e_players[0];
        if (!isplayer(e_player) || !bullettracepassed(var_11384e2c, e_player.origin + (0, 0, 16), 0, var_e9e88745, var_b39864d6)) {
            return 0;
        }
        e_target = e_player;
    } else {
...
function function_5e042438(var_75a7d6, e_target) {
    ...
    var_1979248a = var_b39864d6.origin;
    a_s_spawns = [];
    var_75a7d6.var_c6454bbe.var_75a7d6 = [];
    v_center = var_1979248a + vectorscale((0, 0, 1), 128);
...
function function_9da5eeca(var_75a7d6, n_spawn, e_target, v_center) {
    ...
    if (isvec(v_target) && distance2dsquared(v_target, v_center) <= function_a3f6cdac(1500)) {
        while (1) {
            ...
            if (!var_8af6101c && isvec(e_target.origin) && distance2dsquared(e_target.origin, v_center) <= function_a3f6cdac(1500)) {
                v_target = e_target.origin;
            }
            ...
            if (!isdefined(var_9a08bf56)) {
                ...
                if (!isdefined(var_75a7d6.var_c6454bbe)) {
                    ...
                    var_75a7d6.var_c6454bbe.var_75a7d6 = array(var_75a7d6.var_c6454bbe);
                }
