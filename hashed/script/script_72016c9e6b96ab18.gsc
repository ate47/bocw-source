...
#namespace namespace_d5fbaef7;

// Namespace namespace_d5fbaef7/namespace_d5fbaef7
// Params 0, eflags: 0x5
// Checksum 0x5c1d9d88, Offset: 0x128
// Size: 0x3c
function private autoexec __init__system__() {
    system::register(#"hash_290b1befc23e1166", &function_70a657d8, undefined, undefined, undefined);
}
...
function private function_70a657d8() {
    ...
    var_1f7a9822 = getscriptbundle(#"hash_290b1befc23e1166");
...
function private function_b8f86396(params) {
    /#
        ...
        } else if (params.name == "<unknown string>") {
    ...
    foreach (var_38b5d833 in level.var_e85d5a3f.var_e4f193a3) {
        if (var_b3903404 & var_38b5d833.var_ac9f703d) {
            if (is_true(var_38b5d833.var_e75fcf1a) && !player hasperk(var_38b5d833.perk_name)) {
                ...
                player.health.player = 125;
                player.maxhealth.player = 125;
            }
            /#
                println("<unknown string>" + var_38b5d833.var_9c480844 + "<unknown string>");
            #/
