...
function function_b3e9c19d() {
    level flag::wait_till("flg_rooftops_start");
    var_953da0a8 = struct::get("s_rooftops_mannequin_mb_start", "targetname");
    var_ea066846 = struct::get("s_rooftops_mannequin_mb_end", "targetname");
    var_a75f2965 = getweapon(#"frag_grenade");
    var_1da2248f = spawn("script_model", var_953da0a8.origin);
    var_38ffd5df = vectornormalize(var_ea066846.origin - var_953da0a8.origin) * 400;
    e_grenade = var_1da2248f magicgrenadetype(var_a75f2965, var_953da0a8.origin, var_38ffd5df, 1.5);
