...
function function_b441e79f() {
    ...
    self val::set(#"hash_7696c97ff3e54b52", "ignoreall", 1);
    while (true) {
...
function function_82b2bc5e() {
    ...
    var_5e907852[#"actor 2"] = var_7bacf73f[1];
    var_5e907852[#"actor 1"] thread function_c4edad62();
    var_5e907852[#"actor 2"] thread function_34c5b067();
    var_5e907852[#"actor 1"] val::set(#"door_kick", "takedamage", 0);
    var_5e907852[#"actor 2"] val::set(#"door_kick", "takedamage", 0);
    level thread scene::play("cctv_door_kick_scene", "targetname", var_5e907852);
    var_5e907852[#"actor 1"] waittill(#"hash_553184e6c2383c0d");
    doors::open("cctv_entrance_door_01", "targetname", var_5e907852[#"actor 1"]);
    var_5e907852[#"actor 1"] val::reset(#"door_kick", "takedamage");
    var_5e907852[#"actor 2"] val::reset(#"door_kick", "takedamage");
