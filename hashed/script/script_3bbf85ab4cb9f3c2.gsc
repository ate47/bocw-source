...
function function_143fa1b9() {
    ...
    self function_e5d9f30(playerdata.score, playerdata.kills, playerdata.deaths, playerdata.headshots, 0, playerdata.var_35a0b8bd, playerdata.var_f29581ce, playerdata.var_9f177532, playerdata.var_735f5996, level.doa.roundnumber, playerdata.var_37b8e421);
}
...
function function_9cbd5b89(var_5159caf4) {
    ...
    if ((self.doa.var_f240d1a5 & var_5159caf4) == 0) {
        ...
        /#
            ...
            function_f5f0c0f8("<unknown string>" + self.name + "<unknown string>" + num + "<unknown string>" + level.doa.var_4eb7c3f0);
            function_f5f0c0f8("<unknown string>");
        #/
    }
...
function function_bd2f140c() {
    ...
    if (isdefined(var_9a24b67c) && isdefined(self.doa)) {
        ...
        var_9a24b67c.var_99036de5 = self.doa.score.var_1397c196;
...
function function_21dc53ff() {
    ...
    if (isdefined(self.doa.var_c739e4eb) && self.doa.var_c739e4eb > 0) {
        self.doa.var_87c1cd32 = self.doa.var_87c1cd32 + 1;
    }
...
function function_4ac57fbe(*gameover) {
    ...
    if (!is_true(level.doa.var_a87ecf08)) {
        ...
        self stats::set_stat(#"hash_728e8b5a7105e67b", #"hash_559b3f103bb9341", self.doa.score.points);
        ...
        if (self function_4226df4b() == 0) {
            ...
            self stats::set_stat(#"hash_694e40bd2fe6dcf2", #"hash_559b3f103bb9341", self.doa.score.points);
        ...
        var_98285479 = var_98285479 + self.doa.score.var_96798a01;
        ...
        if (self function_4226df4b() && isdefined(idx)) {
            ...
            self stats::inc_stat(self.doa.var_bcfd90a5, idx, #"hash_673ff771efc1285d", self.doa.score.var_c31799a1);
    ...
    if (getdvarint(#"hash_73899531201aebda", 1) && getdvarint(#"hash_262e5087a510a8dc", 0)) {
        if (isdefined(self.doa.var_d362196a) && self.doa.var_d362196a > 0) {
            ...
            self.doa.var_3b5fa231 = self.doa.var_3b5fa231 + var_d362196a;
...
function function_d717ee7b() {
    self.doa.var_e46a9e57 = {#var_52df118f:0, #var_920f0053:0, #var_827195e5:0, #var_9a5b8400:#"", #var_3ff9fc8:#"", #var_e519217b:0, #keys:0, #lives:0, #var_4b01218:0, #var_4b3c11c6:gettime(), #total_points:0, #var_8f4c7e23:0, #var_dded67ba:0, #var_832beab2:0, #var_967bd40d:0, #var_89e0691d:self rank::getrankxp(), #round_number:0};
}
...
function function_ca0ffc09(var_87786b84, gameover, var_5262eeaf) {
    if (isdefined(self.doa.var_e46a9e57)) {
        if (var_87786b84 || gameover || var_5262eeaf) {
            ...
            self.doa.var_e46a9e57.var_3ff9fc8 = level.doa.var_39e3fa99.var_613b7253;
