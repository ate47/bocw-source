...
function main(*str_objective, *var_50cc0d4f) {
    ...
    level thread namespace_5ceacc03::function_3079e40b();
...
function function_e9812a44(a_ents, str_shot) {
    if (str_shot == "init") {
        ...
        var_72e9298e = util::spawn_model(#"ndy_cigarette_01", var_3064b024.origin);
        var_72e9298e linkto(var_3064b024, "j_prop_1", (0, 0, 0), (0, 0, 0));
        return;
    }
...
function function_e1e726bd(rig, var_81b1bc71, var_391b674) {
    var_5da36fd = getent(var_81b1bc71, "targetname");
    var_ff2ba721 = var_5da36fd getlinkedent();
    if (var_ff2ba721 !== rig) {
        var_5da36fd unlink();
    }
    var_5da36fd linkto(rig, "j_prop_1", (0, 0, 0), (0, 0, 0));
    var_e970e951 = undefined;
    if (isdefined(var_5da36fd.target)) {
        var_e970e951 = getent(var_5da36fd.target, "targetname");
    }
    if (isdefined(var_e970e951)) {
        var_e970e951 linkto(var_5da36fd);
    }
    var_5f89ea5f = getent(var_391b674, "targetname");
    var_ff2ba721 = var_5f89ea5f getlinkedent();
    if (var_ff2ba721 !== rig) {
        var_5f89ea5f unlink();
    }
    var_5f89ea5f linkto(rig, "j_prop_2", (0, 0, 0), (0, 0, 0));
    var_d21634ee = undefined;
    if (isdefined(var_5f89ea5f.target)) {
        var_d21634ee = getent(var_5f89ea5f.target, "targetname");
    }
    if (isdefined(var_d21634ee)) {
        var_d21634ee linkto(var_5f89ea5f);
    }
    return rig;
}
...
function function_adb5d442(a_ents) {
    ...
    if (isdefined(a_ents[#"hash_7412143299e82468"])) {
        level.var_efec11c3 = a_ents[#"hash_7412143299e82468"];
    }
}
...
function function_49848b62(a_ents) {
    ...
    if (isdefined(a_ents[#"hash_700317227822abe3"])) {
        a_ents[#"hash_700317227822abe3"] setmodel(#"hash_d8bd2d6d2845868");
        level.var_af402d52 = a_ents[#"hash_700317227822abe3"];
        a_ents[#"hash_700317227822abe3"].script_objective = "train";
    }
    if (isdefined(a_ents[#"hash_700318227822ad96"])) {
        a_ents[#"hash_700318227822ad96"] setmodel(#"hash_d8bd5d6d2845d81");
        a_ents[#"hash_700318227822ad96"].script_objective = "train";
    }
    if (isdefined(a_ents[#"hash_700319227822af49"])) {
        a_ents[#"hash_700319227822af49"] setmodel(#"hash_d8bd4d6d2845bce");
        a_ents[#"hash_700319227822af49"].script_objective = "train";
    }
    if (isdefined(a_ents[#"hash_70031a227822b0fc"])) {
        level.var_2f39ad47 = a_ents[#"hash_70031a227822b0fc"];
        a_ents[#"hash_70031a227822b0fc"] setmodel(#"hash_d8bd7d6d28460e7");
        a_ents[#"hash_70031a227822b0fc"].script_objective = "train";
    }
    ...
    if (isdefined(a_ents[#"hash_70031d227822b615"])) {
        level.var_53f3f6c7 = a_ents[#"hash_70031d227822b615"];
        a_ents[#"hash_70031d227822b615"] setmodel(#"hash_d8bd8d6d284629a");
        a_ents[#"hash_70031d227822b615"].script_objective = "train";
    }
    ...
    if (isdefined(a_ents[#"hash_70031f227822b97b"])) {
        level.var_1d8f09fe = a_ents[#"hash_70031f227822b97b"];
        a_ents[#"hash_70031f227822b97b"].script_objective = "train";
    }
