    ...
    if (isdefined(level.var_9b927bb4)) {
        ...
        if (isdefined(var_613ca383)) {
            if (!isdefined(var_613ca383.var_86f5f2a9)) {
                var_613ca383.var_86f5f2a9.var_613ca383 = 0;
            }
            if (var_613ca383.var_86f5f2a9 + 3000 < gettime()) {
                var_613ca383.var_86f5f2a9.var_613ca383 = gettime();
                var_613ca383.var_9e066a4d.var_613ca383 = var_613ca383.origin;
            }
...
function function_70f1d702() {
    ...
    foreach (player in players) {
        ...
        if (player isinvehicle()) {
            ...
            jumpiffalse(isdefined(vehicle.var_38800c0) && vehicle.var_38800c0 != 1) LOC_000001d4;
        } else if (player.lastspawntime < time) {
    ...
    while (1) {
        ...
        foreach (var_ab9478c7 in var_c1413cbd) {
            ...
            if (var_ab9478c7 isonground()) {
                ...
                if (trace[#"surfacetype"] == #"none") {
                ...
                } else if (distancesquared(var_ab9478c7.origin, trace[#"position"]) < var_e11beb90) {
                    level.var_a349ea8[var_ab9478c7 getentitynumber()] = undefined;
                } else {
                    ...
                    foreach (var_ba607277 in var_7ec01616) {
                        ...
                        if (var_ba607277.team != var_ab9478c7.team) {
                            ...
                            var_ba607277.var_7adbb832.var_ba607277 = gettime() + int(5 * 1000);
                        } else {
                            ...
                            var_ba607277.var_291cbaa3.var_ba607277 = gettime() + int(5 * 1000);
                        }
