...
#namespace namespace_625db0ff;

// Namespace namespace_625db0ff
// Method(s) 6 Total 13
class cdoa_overworld : cluielem {

    // Namespace cdoa_overworld/namespace_625db0ff
    // Params 0, eflags: 0x8
...
// Namespace namespace_625db0ff/namespace_625db0ff
// Params 0, eflags: 0x0
...
function register() {
    ...
    if (!isdefined(level.var_ae746e8f[#"hash_1abc2457e4af0a06"])) {
        level.var_ae746e8f[#"hash_1abc2457e4af0a06"] = [];
    }
    if (!isdefined(level.var_ae746e8f[#"hash_1abc2457e4af0a06"])) {
        level.var_ae746e8f[#"hash_1abc2457e4af0a06"] = [];
    } else if (!isarray(level.var_ae746e8f[#"hash_1abc2457e4af0a06"])) {
        level.var_ae746e8f[#"hash_1abc2457e4af0a06"] = array(level.var_ae746e8f[#"hash_1abc2457e4af0a06"]);
    }
    level.var_ae746e8f[#"hash_1abc2457e4af0a06"][level.var_ae746e8f[#"hash_1abc2457e4af0a06"].size] = elem;
}
