...
function function_5e62ed5c() {
    ...
    while (1) {
        ...
        var_7f729179 = level waittilltimeout(randomfloatrange(level.var_cf15d540, level.var_f535b5f0), #"hash_411b28075ee4555c", #"hash_448cb2a9e543af93");
...
function function_be6ec6c(var_2b43a4c4, var_30ff34e3 = 1) {
    if (!isdefined(var_2b43a4c4)) {
        level notify(#"hash_411b28075ee4555c", {#var_30ff34e3:var_30ff34e3});
    } else if (isplayer(var_2b43a4c4)) {
        level notify(#"hash_411b28075ee4555c", {#var_30ff34e3:var_30ff34e3, #player:var_2b43a4c4});
    } else if (isvec(var_2b43a4c4)) {
        level notify(#"hash_411b28075ee4555c", {#var_30ff34e3:var_30ff34e3, #location:var_2b43a4c4});
    }
}
                ...
                if (!(isdefined(v_target) && isdefined(v_spawn))) {
                    ...
                    LOC_000003fa:
                        ...
                        if (isdefined(ai_spawned)) {
                            ...
                            ai_spawned.var_9602c8b2.ai_spawned = &function_12db74f8;
        ...
        foreach (spawn in a_spawns) {
            if (getaicount() < getailimit()) {
                if (isdefined(spawn.var_90d0c0ff) && spawn.var_90d0c0ff == "anim_spawn_from_fireplace") {
                    ...
                    var_4bf95f4c.var_990b33df.var_4bf95f4c = isdefined(var_abb82760) ? var_abb82760 : var_4bf95f4c.var_990b33df;
                ...
                if (isdefined(ai)) {
                    if (isdefined(spawn.var_90d0c0ff) && spawn.var_90d0c0ff != " " && spawn.var_90d0c0ff != "") {
                        ai.var_c9b11cb3.ai = spawn.var_90d0c0ff;
                    } else {
                        ai.var_c9b11cb3.ai = "anim_spawn_from_ground";
                    }
    ...
    /#
        while (1) {
            if (getdvarint(#"hash_21e1866f0c677ab8", 0)) {
                ...
                level notify(#"hash_51e64b5183e4c028");
                run_all(getaiarray("<unknown string>", "<unknown string>"), &kill);
...
function function_10c88d2e() {
    /#
        ...
        if (isdefined(level.var_7d45d0d4.var_49978223)) {
            ...
            foreach (trigger in a_triggers) {
                if (trigger.destination === destination.targetname) {
                    a_spawns = get_array(trigger.target);
