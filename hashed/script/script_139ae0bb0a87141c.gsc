...
function function_34c06bfe(guy) {
    ...
    for (var_774cf4d0 = 0; var_774cf4d0 < nummembers; var_774cf4d0++) {
...
function function_91679cf9(var_9bd7a27, guy, var_844650da) {
    ...
    if (isdefined(vol)) {
        ...
        var_d04be568.var_35becac4 = vol istouching(var_844650da);
    }
    /#
...
function function_6944c509(var_9bd7a27, guy, lastknownpos, *lastknowntime) {
    ...
    if (isdefined(vol)) {
        var_d04be568.volume = vol;
        var_d04be568.var_35becac4 = vol istouching(lastknowntime);
    }
    var_d04be568.var_1e912fb5 = gettime();
    ...
    if (pod.members.size == 1) {
        ...
        for (var_774cf4d0 = 0; var_774cf4d0 < nummembers; var_774cf4d0++) {
            ...
            if (var_37f4db4d.stealth.var_abf79234 == 0 && distancesquared(var_37f4db4d.origin, self.origin) < 10000) {
                var_37f4db4d ai::look_at(self, undefined, undefined, 0.55);
            }
        }
    }
}
...
function function_4b33561d(pod, groupname, origin) {
    ...
    pod.var_5462c308 = arraycombine(var_c491acad, var_f5ea0eba);
}
...
function function_2e140491(guy, *volume) {
    ...
    foreach (member in pod.members) {
        ...
        data.angle = function_2981bd91(var_5c185af);
        dots[dots.size] = data;
        if (member == volume) {
    ...
    foreach (point in pod.var_5462c308) {
        ...
        if (function_53cf9571(point, pod, var_941fad23, var_f2e0ace0, distfromcenter, var_f64a59e)) {
            point.var_b26d6449 = gettime();
            return point.origin;
        }
    }
    ...
    var_bbfbe34b = smart_object::function_ab981ed(desiredpos, pod.volume, 512, var_9ea07d03);
    ...
    if (isdefined(pod.volume)) {
        searchpos = namespace_206491b4::function_19b8c555(pod.volume, volume.origin, desiredpos, pod.usedpoints, 12);
        if (isdefined(searchpos)) {
            function_172d6f0b(pod, searchpos);
            return searchpos;
        }
    } else if (volume.goalradius > 64 && isdefined(volume.var_ba41ef8)) {
        searchpos = namespace_206491b4::function_24d0d4f3(volume.var_ba41ef8, volume.goalradius, volume.origin, desiredpos, pod.usedpoints, 12);
        if (isdefined(searchpos)) {
            function_172d6f0b(pod, searchpos);
            return searchpos;
        }
...
// Size: 0xd6
function function_53cf9571(point, pod, var_941fad23, var_f2e0ace0, distfromcenter, var_f64a59e) {
...
function function_b3200aff(var_9bd7a27, e) {
    ...
    if (pod.members.size == 1) {
        nummembers = var_9bd7a27.members.size;
        for (var_774cf4d0 = 0; var_774cf4d0 < nummembers; var_774cf4d0++) {
...
function function_e6ae3581(guy, var_4af4ea3d) {
    ...
    if (isdefined(pod.volume)) {
        pod.var_35becac4 = pod.volume istouching(pod.origin);
    }
    return pod.origin;
}
...
function function_79baf7a9(delaytime, guy, target, targetpos) {
    ...
    foreach (var_9bd7a27 in level.stealth.var_9bd7a27.groups) {
        ...
        foreach (var_37f4db4d in var_760c584d) {
            ...
            if (!var_b288ad4a && distancesquared(var_37f4db4d.origin, guy.origin) < var_91239be5 && (!false || var_37f4db4d util::function_748809fc(guy))) {
                var_b288ad4a = 1;
                if (isdefined(target)) {
                    var_3f01ab8a = 1;
                }
...
function function_b728365a() {
    ...
    foreach (guy in self.members) {
        ...
        if (!isdefined(guy.enemy) && guy flag::exists("in_the_dark") && guy flag::get("in_the_dark") && curtime - guy.lastenemysighttime < var_31e68066) {
            return 0;
        }
    }
    return 1;
