...
class class_38f05ef0 {
    ...
    // Checksum 0x80f724d1, Offset: 0x2220
    // Size: 0x4
    ...
    function function_43e11510(var_386c1e5c) {
        self.var_3b17d6fc = var_386c1e5c;
    }
    ...
    function function_772950ea(onoff) {
        retval = self.var_edabd2d1;
        self.var_edabd2d1 = onoff;
        return retval;
    }
    ...
    // Size: 0x56
    function function_799a63cf(spawn, loop, var_8cb319d, consumed) {
        self.var_3d570e2e = spawn;
        self.var_f360c9a6 = loop;
        self.var_480dae1c = var_8cb319d;
    ...
    // Size: 0x142
    function init(var_49d95ac1, variant, var_44dbff18, rarity, scale, type, timeout, angles = vectorscale((0, 0, 1), 70), data = 0, entries = 1) {
...
class class_a08a1bec {
    ...
    // Namespace class_a08a1bec/namespace_dfc652ee
    // Params 0, eflags: 0xa linked
    // Checksum 0x80f724d1, Offset: 0x3238
    // Size: 0x4
    __constructor() {
    ...
    // Size: 0x16
    function getname() {
        return [[ self.var_ff66dbc5 ]]->getname();
    }
    ...
    // Size: 0x16
    function gettype() {
        return [[ self.var_ff66dbc5 ]]->gettype();
    }
    ...
    function init(itemdef, origin, angles = [[ itemdef ]]->getangles(), data = [[ itemdef ]]->getdata(), width = [[ itemdef ]]->getwidth(), height = [[ itemdef ]]->getheight(), scale = [[ itemdef ]]->getscale(), clientside = 1) {
        ...
        self.var_1c13332c = function_65ee50ba(origin) + vectorscale((0, 0, 1), 18);
        if (abs(self.var_1c13332c[2] - origin[2]) > 40) {
            self.var_1c13332c = (self.var_1c13332c[0], self.var_1c13332c[1], origin[2]);
        }
        self.var_12094064 = data;
        self.var_9453b0c1 = [[ self.var_ff66dbc5 ]]->function_63c67234();
        self.var_a116600e = namespace_ec06fe4a::function_e22ae9b3(self.var_1c13332c);
        if (!isdefined(self.var_a116600e)) {
            return 0;
        }
        self.var_a116600e.angles = angles;
        self.var_a116600e.pickup = self;
        self.var_a116600e.def = itemdef;
        model = [[ itemdef ]]->getname();
        self.var_a116600e.scale = scale;
        ...
        if (!clientside || [[ self.var_a116600e.def ]]->function_8fa82fe8() == 0 || is_true(self.var_a116600e.var_3aba9d31) || !1) {
            if (self.var_a116600e.type == 6) {
                model = getweaponworldmodel(getweapon(model));
            }
            self.var_a116600e setmodel(model);
        } else {
            self.var_a116600e setmodel("tag_origin");
            self.var_a116600e clientfield::set("pickupsettype", self.var_a116600e.type + ([[ self.var_a116600e.def ]]->function_a0da66ec() << 6));
            self.var_a116600e notsolid();
            self.var_a116600e.var_9ca559f5 = 1;
        }
        self.var_a116600e.script_noteworthy = "a_pickup_item";
        self.var_a116600e.targetname = "a_pickup_item";
        self.var_a116600e.radius = width;
        self.var_a116600e.height = height;
        self.var_a116600e.var_b20c0bc5 = [[ itemdef ]]->function_32b47cc3();
        self.var_a116600e thread [[ [[ self.var_ff66dbc5 ]]->function_1e4ba7d0() ]]();
        self.var_a116600e thread [[ self.var_9453b0c1 ]]();
        self.var_a116600e thread namespace_dfc652ee::function_f96b17e3(function_ed9402ec());
        self.var_a116600e.var_2f0b512f = level.var_8cff5775.var_3902985f;
        if (isdefined(level.var_8cff5775.var_a71b0305)) {
            [[ level.var_8cff5775.var_a71b0305 ]](self.var_a116600e);
        }
        level.var_8cff5775.var_cc831548[level.var_8cff5775.var_cc831548.size] = self.var_a116600e;
        return 1;
    }
    ...
    // Size: 0x16
    function function_e2564c16() {
        return [[ self.var_ff66dbc5 ]]->function_e2564c16();
    }
    ...
    // Size: 0x16
    function function_ed9402ec() {
        return [[ self.var_ff66dbc5 ]]->function_ed9402ec();
    }
...
function init() {
    /#
        assert(isdefined(level.var_8cff5775));
    #/
    ...
    level.var_8cff5775.pickups = spawnstruct();
    level.var_8cff5775.pickups.var_79d6391f = 0;
    level.var_8cff5775.var_271e8e25 = [];
    level.var_8cff5775.pickups.var_8b9e74df = [];
    level.var_8cff5775.var_f99feb1e = [];
    level.var_8cff5775.var_cc831548 = [];
    level.var_8cff5775.var_537a3e29 = [];
    level.var_8cff5775.pickups.var_d11c709 = [];
    level.var_8cff5775.pickups.var_a81bed69 = [];
    level.var_8cff5775.var_50a26b4f = 1;
    level.var_8cff5775.var_54c5c3e6 = undefined;
    namespace_c501aa2e::init();
    level.var_8cff5775.pickups.var_92a02b26 = getent("zombietron_siegebot_spawner", "targetname");
    level.var_8cff5775.pickups.var_f20eb59f = getent("zombietron_tank_spawner", "targetname");
    level.var_8cff5775.pickups.var_4480248f = getent("zombietron_hind_spawner", "targetname");
    level.var_8cff5775.pickups.var_ef3f4447 = getent("zombietron_sentry_spawner", "targetname");
    level.var_8cff5775.pickups.var_9eec57e8 = getent("zombietron_grenade_spawner", "targetname");
    function_8cf6a668(13, {#var_9f6d7ee9:"evt_doa_pickup_gem_consumed", #var_860ac8be:undefined, #var_2aa68449:"evt_doa_pickup_gem_lp", #var_d266c0d8:"evt_doa_pickup_gem_spawn"});
    function_8cf6a668(1, {#var_9f6d7ee9:"evt_doa_pickup_money_consumed", #var_860ac8be:undefined, #var_2aa68449:"evt_doa_pickup_money_lp", #var_d266c0d8:"evt_doa_pickup_money_spawn"});
    function_8cf6a668(6, {#var_9f6d7ee9:"evt_doa_pickup_weapon_consumed", #var_860ac8be:undefined, #var_2aa68449:undefined, #var_d266c0d8:"evt_doa_pickup_weapon_spawn"});
    function_8cf6a668(15, {#var_9f6d7ee9:"evt_doa_pickup_chicken_consumed", #var_860ac8be:"evt_doa_pickup_chicken_despawn", #var_2aa68449:"evt_doa_pickup_chicken_lp", #var_d266c0d8:"evt_doa_pickup_chicken_spawn"});
    function_8cf6a668(14, {#var_9f6d7ee9:"evt_doa_pickup_key_consumed", #var_860ac8be:"evt_doa_pickup_default_despawn", #var_2aa68449:"evt_doa_pickup_default_lp", #var_d266c0d8:"evt_doa_pickup_key_spawn"});
    function_8cf6a668(8, {#var_9f6d7ee9:"evt_doa_powerup_nuke_consumed", #var_860ac8be:"evt_doa_pickup_default_despawn", #var_2aa68449:"evt_doa_pickup_default_lp", #var_d266c0d8:"evt_doa_pickup_default_spawn"});
    function_8cf6a668(9, {#var_9f6d7ee9:"evt_doa_powerup_boost_consumed", #var_860ac8be:"evt_doa_pickup_default_despawn", #var_2aa68449:"evt_doa_pickup_default_lp", #var_d266c0d8:"evt_doa_pickup_default_spawn"});
    function_8cf6a668(17, {#var_9f6d7ee9:"evt_doa_pickup_barrel_consumed", #var_860ac8be:"evt_doa_pickup_default_despawn", #var_2aa68449:"evt_doa_pickup_default_lp", #var_d266c0d8:"evt_doa_pickup_barrel_spawn"});
    function_8cf6a668(24, {#var_9f6d7ee9:"evt_doa_pickup_boots_consumed", #var_860ac8be:"evt_doa_pickup_default_despawn", #var_2aa68449:"evt_doa_pickup_default_lp", #var_d266c0d8:"evt_doa_pickup_boots_spawn"});
    function_8cf6a668(18, {#var_9f6d7ee9:"evt_doa_pickup_boxers_consumed", #var_860ac8be:"evt_doa_pickup_default_despawn", #var_2aa68449:"evt_doa_pickup_default_lp", #var_d266c0d8:"evt_doa_pickup_boxers_spawn"});
    function_8cf6a668(25, {#var_9f6d7ee9:"evt_doa_pickup_clock_consumed", #var_860ac8be:"evt_doa_pickup_default_despawn", #var_2aa68449:"evt_doa_pickup_default_lp", #var_d266c0d8:"evt_doa_pickup_clock_spawn"});
    function_8cf6a668(26, {#var_9f6d7ee9:"evt_doa_pickup_default_consumed", #var_860ac8be:"evt_doa_pickup_default_despawn", #var_2aa68449:"evt_doa_pickup_default_lp", #var_d266c0d8:"evt_doa_pickup_coatofarms_spawn"});
    function_8cf6a668(16, {#var_9f6d7ee9:"evt_doa_pickup_extralife_consumed", #var_860ac8be:"evt_doa_pickup_default_despawn", #var_2aa68449:"evt_doa_pickup_default_lp", #var_d266c0d8:"evt_doa_pickup_extralife_spawn"});
    function_8cf6a668(3, {#var_9f6d7ee9:"evt_doa_pickup_firstperson_consumed", #var_860ac8be:"evt_doa_pickup_default_despawn", #var_2aa68449:"evt_doa_pickup_default_lp", #var_d266c0d8:"evt_doa_pickup_firstperson_spawn"});
    function_8cf6a668(11, {#var_9f6d7ee9:undefined, #var_860ac8be:"evt_doa_pickup_default_despawn", #var_2aa68449:undefined, #var_d266c0d8:"evt_doa_pickup_giftbox_spawn"});
    function_8cf6a668(31, {#var_9f6d7ee9:"evt_doa_pickup_magichat_consumed", #var_860ac8be:"evt_doa_pickup_default_despawn", #var_2aa68449:"evt_doa_pickup_default_lp", #var_d266c0d8:"evt_doa_pickup_magichat_spawn"});
    function_8cf6a668(10, {#var_9f6d7ee9:"evt_doa_pickup_healthpotion_consumed", #var_860ac8be:"evt_doa_pickup_default_despawn", #var_2aa68449:"evt_doa_pickup_default_lp", #var_d266c0d8:"evt_doa_pickup_healthpotion_spawn"});
    function_8cf6a668(23, {#var_9f6d7ee9:"evt_doa_pickup_magnet_consumed", #var_860ac8be:"evt_doa_pickup_default_despawn", #var_2aa68449:"evt_doa_pickup_default_lp", #var_d266c0d8:"evt_doa_pickup_magnet_spawn"});
    function_8cf6a668(27, {#var_9f6d7ee9:"evt_doa_pickup_monkeybomb_consumed", #var_860ac8be:"evt_doa_pickup_default_despawn", #var_2aa68449:"evt_doa_pickup_default_lp", #var_d266c0d8:"evt_doa_pickup_monkeybomb_spawn"});
    function_8cf6a668(19, {#var_9f6d7ee9:"evt_doa_pickup_sawblade_consumed", #var_860ac8be:"evt_doa_pickup_default_despawn", #var_2aa68449:"evt_doa_pickup_default_lp", #var_d266c0d8:"evt_doa_pickup_sawblade_spawn"});
    function_8cf6a668(22, {#var_9f6d7ee9:"evt_doa_pickup_sentry_consumed", #var_860ac8be:"evt_doa_pickup_default_despawn", #var_2aa68449:"evt_doa_pickup_default_lp", #var_d266c0d8:"evt_doa_pickup_sentry_spawn"});
    function_8cf6a668(45, {#var_9f6d7ee9:"evt_doa_pickup_sentry_consumed", #var_860ac8be:"evt_doa_pickup_default_despawn", #var_2aa68449:"evt_doa_pickup_default_lp", #var_d266c0d8:"evt_doa_pickup_sentry_spawn"});
    function_8cf6a668(34, {#var_9f6d7ee9:"evt_doa_pickup_skeleton_consumed", #var_860ac8be:"evt_doa_pickup_default_despawn", #var_2aa68449:"evt_doa_pickup_default_lp", #var_d266c0d8:"evt_doa_pickup_skeleton_spawn"});
    function_8cf6a668(30, {#var_9f6d7ee9:"evt_doa_pickup_sprinkler_consumed", #var_860ac8be:"evt_doa_pickup_default_despawn", #var_2aa68449:"evt_doa_pickup_default_lp", #var_d266c0d8:"evt_doa_pickup_sprinkler_spawn"});
    function_8cf6a668(28, {#var_9f6d7ee9:"evt_doa_pickup_teddybear_consumed", #var_860ac8be:"evt_doa_pickup_default_despawn", #var_2aa68449:"evt_doa_pickup_default_lp", #var_d266c0d8:"evt_doa_pickup_teddybear_spawn"});
    function_8cf6a668(29, {#var_9f6d7ee9:"evt_doa_pickup_teslaball_consumed", #var_860ac8be:"evt_doa_pickup_default_despawn", #var_2aa68449:"evt_doa_pickup_default_lp", #var_d266c0d8:"evt_doa_pickup_teslaball_spawn"});
    function_8cf6a668(21, {#var_9f6d7ee9:"evt_doa_pickup_umbrella_consumed", #var_860ac8be:"evt_doa_pickup_default_despawn", #var_2aa68449:"evt_doa_pickup_default_lp", #var_d266c0d8:"evt_doa_pickup_umbrella_spawn"});
    function_8cf6a668(4, {#var_9f6d7ee9:"evt_doa_pickup_mech_consumed", #var_860ac8be:"evt_doa_pickup_default_despawn", #var_2aa68449:"evt_doa_pickup_default_lp", #var_d266c0d8:"evt_doa_pickup_mech_spawn"});
    function_8cf6a668(5, {#var_9f6d7ee9:"evt_doa_pickup_tank_consumed", #var_860ac8be:"evt_doa_pickup_default_despawn", #var_2aa68449:"evt_doa_pickup_default_lp", #var_d266c0d8:"evt_doa_pickup_tank_spawn"});
    function_8cf6a668(40, {#var_9f6d7ee9:"evt_doa_pickup_hind_consumed", #var_860ac8be:"evt_doa_pickup_default_despawn", #var_2aa68449:"evt_doa_pickup_default_lp", #var_d266c0d8:"evt_doa_pickup_hind_spawn"});
    function_8cf6a668(44, {#var_9f6d7ee9:"evt_doa_pickup_arcade_consumed", #var_860ac8be:"evt_doa_pickup_default_despawn", #var_2aa68449:"evt_doa_pickup_default_lp", #var_d266c0d8:"evt_doa_pickup_arcade_spawn"});
    function_8cf6a668(43, {#var_9f6d7ee9:"evt_doa_pickup_vortex_consumed", #var_860ac8be:"evt_doa_pickup_default_despawn", #var_2aa68449:"evt_doa_pickup_default_lp", #var_d266c0d8:"evt_doa_pickup_vortex_spawn"});
    function_51ab3213();
    namespace_4ff32993::init();
    namespace_5d515bd5::init();
    level.var_8cff5775.var_9a6327ee = function_6265bde4("zombietron_beryl");
    level.var_8cff5775.var_4b113826 = function_6265bde4("zombietron_ruby");
}
...
function function_8cf6a668(type, var_a63abfbe) {
    items = [];
    foreach (def in level.var_8cff5775.pickups.var_8b9e74df) {
        if ([[ def ]]->gettype() == type) {
            items[items.size] = def;
        }
    }
    foreach (itemdef in items) {
        [[ itemdef ]]->function_799a63cf(var_a63abfbe.var_d266c0d8, var_a63abfbe.var_2aa68449, var_a63abfbe.var_860ac8be, var_a63abfbe.var_9f6d7ee9);
    }
}
...
// Size: 0x84a
function function_c1018360(var_49d95ac1, type, variant, rarity, modelscale, angles = vectorscale((0, 0, 1), 70), data, entries = 1) {
    /#
    ...
    [[ var_4d842336 ]]->init(var_49d95ac1, variant, &function_2ebebd0c, rarity, modelscale, type, timeout, angles, data, entries);
    level.var_8cff5775.pickups.var_8b9e74df[level.var_8cff5775.pickups.var_8b9e74df.size] = var_4d842336;
    [[ var_4d842336 ]]->function_c1403591(&function_c8046d59);
    switch (type) {
    case 6:
    ...
    case 13:
        ...
        level.var_8cff5775.pickups.var_a81bed69[level.var_8cff5775.pickups.var_a81bed69.size] = var_4d842336;
        break;
    case 1:
        level.var_8cff5775.pickups.var_d11c709[level.var_8cff5775.pickups.var_d11c709.size] = var_4d842336;
        break;
    case 14:
        ...
        break;
    case 15:
        [[ var_4d842336 ]]->function_c1403591(&namespace_4ff32993::function_3abd7937);
        [[ var_4d842336 ]]->function_ea0e8d6d(0);
        break;
    case 32:
    case 33:
...
function function_51ab3213() {
    level.var_8cff5775.pickups.var_8f94e67 = [];
    level.var_8cff5775.pickups.var_8f94e67[0] = [];
    level.var_8cff5775.pickups.var_8f94e67[1] = [];
    level.var_8cff5775.pickups.var_8f94e67[2] = [];
    level.var_8cff5775.pickups.var_8f94e67[3] = [];
    level.var_8cff5775.pickups.var_8f94e67[4] = [];
    level.var_8cff5775.pickups.var_2a93b19 = [];
    level.var_8cff5775.pickups.var_2a93b19[0] = [];
    level.var_8cff5775.pickups.var_2a93b19[1] = [];
    level.var_8cff5775.pickups.var_2a93b19[2] = [];
    level.var_8cff5775.pickups.var_2a93b19[3] = [];
    level.var_8cff5775.pickups.var_2a93b19[4] = [];
    level.var_8cff5775.pickups.var_3031eb5c = [];
    foreach (item in level.var_8cff5775.pickups.var_8b9e74df) {
        ...
        while (entries) {
            entries--;
            if ([[ item ]]->gettype() == 6) {
                if (!isdefined(level.var_8cff5775.pickups.var_3031eb5c)) {
                    level.var_8cff5775.pickups.var_3031eb5c = [];
                } else if (!isarray(level.var_8cff5775.pickups.var_3031eb5c)) {
                    level.var_8cff5775.pickups.var_3031eb5c = array(level.var_8cff5775.pickups.var_3031eb5c);
                }
                level.var_8cff5775.pickups.var_3031eb5c[level.var_8cff5775.pickups.var_3031eb5c.size] = item;
            } else if ([[ item ]]->gettype() == 1 || [[ item ]]->gettype() == 13) {
                if (!isdefined(level.var_8cff5775.pickups.var_2a93b19[[[ item ]]->function_e2564c16()])) {
                    level.var_8cff5775.pickups.var_2a93b19[[[ item ]]->function_e2564c16()] = [];
                } else if (!isarray(level.var_8cff5775.pickups.var_2a93b19[[[ item ]]->function_e2564c16()])) {
                    level.var_8cff5775.pickups.var_2a93b19[[[ item ]]->function_e2564c16()] = array(level.var_8cff5775.pickups.var_2a93b19[[[ item ]]->function_e2564c16()]);
                }
                level.var_8cff5775.pickups.var_2a93b19[[[ item ]]->function_e2564c16()][level.var_8cff5775.pickups.var_2a93b19[[[ item ]]->function_e2564c16()].size] = item;
            } else {
                if (!isdefined(level.var_8cff5775.pickups.var_8f94e67[[[ item ]]->function_e2564c16()])) {
                    level.var_8cff5775.pickups.var_8f94e67[[[ item ]]->function_e2564c16()] = [];
                } else if (!isarray(level.var_8cff5775.pickups.var_8f94e67[[[ item ]]->function_e2564c16()])) {
                    level.var_8cff5775.pickups.var_8f94e67[[[ item ]]->function_e2564c16()] = array(level.var_8cff5775.pickups.var_8f94e67[[[ item ]]->function_e2564c16()]);
                }
                level.var_8cff5775.pickups.var_8f94e67[[[ item ]]->function_e2564c16()][level.var_8cff5775.pickups.var_8f94e67[[[ item ]]->function_e2564c16()].size] = item;
            }
        }
    }
}
...
function function_f9ae7957() {
    ...
    if (type == 13) {
        ...
        case #"hash_21b4f4cf6aa27cf3":
            ...
            return "glow_white";
        case #"hash_5aab02d44ded3021":
            self.var_4212fdee = "gem_trail_red";
            return "glow_red";
        case #"hash_5614b46553fbdc47":
...
// Size: 0x3cc
function itemspawn(var_4d842336, origin, angles, data, forced = 0, glow, width, height, owner, var_29130f0e, clientside = 1) {
    if (!namespace_ec06fe4a::function_a8975c67()) {
        return;
    }
    type = [[ var_4d842336 ]]->gettype();
    if (type == 46 && is_true(level.var_8cff5775.var_318aa67a)) {
        type = 10;
        var_4d842336 = function_2c9923d7(type);
    }
    if (isdefined(level.var_8cff5775.var_d5fbd3)) {
        if ([[ level.var_8cff5775.var_d5fbd3 ]](var_4d842336, origin) == 0) {
            return;
        }
    }
    ...
    if (function_4821dfcf(type)) {
        level.var_8cff5775.var_4b491c02 = gettime() + 300000;
    }
    ...
    model.var_6863e853 = glow;
    if (isdefined(model.var_6863e853)) {
        model namespace_83eb6304::function_3ecfde67(model.var_6863e853);
    }
    ...
    if (isdefined(owner)) {
        ...
        model thread function_7e4e4b8a(owner, var_29130f0e);
    }
    ...
    if (!forced) {
        [[ var_4d842336 ]]->function_371cc878();
        [[ var_4d842336 ]]->function_755a46e6();
    }
    if (type == 39) {
        model clientfield::set("set_icon", 9);
    }
    level notify(#"hash_6b1b7f8f320c0d3b", {#type:type, #pickup:model});
    return model;
}
...
// Size: 0x14c
function function_83aea294(origin, numitems = 10, radius = 256, var_4d842336, data, forced) {
    radius = int(radius);
    while (numitems) {
        ...
        var_2acffa66 = [[ var_4d842336 ]]->function_a8f2b5de();
        if (isdefined(var_2acffa66)) {
            [[ var_2acffa66 ]](var_4d842336, spot, data, forced);
        } else {
...
// Size: 0x124
function function_d06cbfe8(origin, numitems = 10, radius = 256, var_3aba9d31 = 0, var_4d842336, forced = 0, scale) {
    radius = int(radius);
    while (numitems) {
        spawner::global_spawn_throttle();
        spot = origin + (randomintrange(radius * -1, radius), randomintrange(radius * -1, radius), 0);
        function_b8f6a8cd(var_4d842336, spot, var_3aba9d31, forced, scale);
        numitems--;
    }
}
...
// Size: 0x1ea
function function_b8f6a8cd(var_4d842336 = function_57160cba(13), origin, var_3aba9d31 = 0, forced, scale, angles) {
    data = (var_3aba9d31 ? 1 : 0) << 16;
    if (!isdefined(scale)) {
        var_aa21ed6 = randomint(100);
        if (var_aa21ed6 < 90) {
            scale = randomfloatrange(1, 2);
        } else if (var_aa21ed6 < 96) {
...
function function_57160cba(type = 0) {
    /#
        assert(level.var_8cff5775.pickups.var_8b9e74df.size);
    #/
    if (type == 6) {
        return level.var_8cff5775.pickups.var_3031eb5c[randomint(level.var_8cff5775.pickups.var_3031eb5c.size)];
    }
    if (type == 13) {
        return level.var_8cff5775.pickups.var_a81bed69[randomint(level.var_8cff5775.pickups.var_a81bed69.size)];
    }
    if (type == 1 || type == 2) {
        roll = randomint(100);
        if (type == 2) {
        ...
        itemtype = 0;
        if (roll < 50 && level.var_8cff5775.pickups.var_2a93b19[1].size) {
            itemtype = 1;
        }
        if (roll < 23 && level.var_8cff5775.pickups.var_2a93b19[2].size) {
            itemtype = 2;
        }
        if (roll < 5 && level.var_8cff5775.pickups.var_2a93b19[3].size) {
            itemtype = 3;
        }
        if (roll < 1 && level.var_8cff5775.pickups.var_2a93b19[4].size) {
            itemtype = 4;
        }
        return level.var_8cff5775.pickups.var_2a93b19[itemtype][randomint(level.var_8cff5775.pickups.var_2a93b19[itemtype].size)];
    }
    if (type == 0) {
        roll = randomint(100);
        itemtype = 0;
        if (roll < 1 && level.var_8cff5775.pickups.var_8f94e67[4].size) {
            itemtype = 4;
        } else if (roll < 5 && level.var_8cff5775.pickups.var_8f94e67[3].size) {
            itemtype = 3;
        } else if (roll < 23 && level.var_8cff5775.pickups.var_8f94e67[2].size) {
            itemtype = 2;
        } else if (roll < 50 && level.var_8cff5775.pickups.var_8f94e67[1].size) {
            itemtype = 1;
        }
        var_c2433b2a = [];
        foreach (item in level.var_8cff5775.pickups.var_8f94e67[itemtype]) {
        ...
        return level.var_8cff5775.pickups.var_8f94e67[itemtype][randomint(level.var_8cff5775.pickups.var_8f94e67[itemtype].size)];
    }
...
function function_ae609287(var_4d842336, origin) {
    ...
    if ([[ var_4d842336 ]]->function_2c127eb5() > level.var_8cff5775.roundnumber) {
        return 0;
    }
    ...
    type = [[ var_4d842336 ]]->gettype();
    if (type == 10 && level.var_8cff5775.var_358fbdc8 != 4) {
        return 0;
    }
    ...
    if (type == 42) {
        ...
        foreach (player in getplayers()) {
            if (is_true(player.var_8cff5775.var_deaabc77)) {
                return 0;
            }
        }
    }
    if (type == 44) {
        ...
        if (level.var_8cff5775.roundnumber === 64 || level.var_8cff5775.roundnumber === 65) {
            return 0;
        }
    ...
    if (function_4821dfcf(type)) {
        ...
        if (level.var_8cff5775.var_4b491c02 > gettime()) {
            return 0;
        }
    }
    if (type == 39 && !isdefined(level.var_8cff5775.var_182fb75a)) {
        return 0;
    }
    if (isdefined(origin)) {
...
function function_5bcfaaa1(type, player) {
    ...
    if (type == 8) {
        return (player.var_8cff5775.score.bombs < player namespace_eccff4fb::function_4091beb5());
    }
    if (type == 14) {
        return (player.var_8cff5775.score.keys < player namespace_eccff4fb::function_9d6bf0a9());
    }
    if (type == 9) {
        return (player.var_8cff5775.score.boosts < player namespace_eccff4fb::function_fd3d9ee0());
    }
    if (type == 16) {
        return 1;
    }
    if (isdefined(player.var_8cff5775.vehicle) || is_true(player.usingvehicle)) {
        return 0;
    }
    if (type == 39 && !isdefined(level.var_8cff5775.var_182fb75a)) {
        return 0;
    }
    if (type == 46 && player.var_8cff5775.var_ccd8393c > 0) {
        return 0;
    }
    if (type == 41 && is_true(player.var_8cff5775.var_82fb5d17)) {
        return 0;
    }
    if (type == 34) {
...
function function_f759a457() {
    return level.var_8cff5775.var_50a26b4f;
}
...
function function_2ebebd0c() {
    ...
    while (1) {
        ...
        if (isplayer(player)) {
            ...
            if (!isdefined(player.var_8cff5775) || !isdefined(player.var_8cff5775.score)) {
                continue;
            }
        ...
        self.pickedup = 1;
        arrayremovevalue(level.var_8cff5775.var_cc831548, self);
        ...
        if (isai(player)) {
            ...
            if (isdefined(self.var_6863e853)) {
                self thread namespace_83eb6304::turnofffx(self.var_6863e853);
            }
            util::wait_network_frame();
        ...
        if (isdefined(level.var_8cff5775.var_d5e9e183)) {
            level [[ level.var_8cff5775.var_d5e9e183 ]](player, self, type);
        } else {
            switch (type) {
            case 1:
            case 13:
                ...
                break;
            case 6:
                player namespace_6e90e490::function_55775bbc(3);
            ...
            case 4:
                ...
                player namespace_6e90e490::function_55775bbc(2);
            ...
            case 40:
                ...
                break;
            case 8:
                if (isdefined(player.var_8cff5775.score)) {
                    if (player.var_8cff5775.score.bombs < player namespace_eccff4fb::function_4091beb5()) {
                        if (!isdefined(self.var_54dddc17) && player namespace_1c2a96f9::function_8a19ece() && level.var_8cff5775.var_6c58d51 > 0) {
                            players = namespace_7f5aeb59::function_23e1f90f();
                            foreach (guy in players) {
                                if (guy.var_8cff5775.score.bombs < guy namespace_eccff4fb::function_4091beb5()) {
                                    guy thread namespace_6e90e490::function_47e11416(4);
                                    guy.var_8cff5775.score.bombs++;
                            ...
                            player.var_8cff5775.score.bombs++;
                        }
            ...
            case 9:
                if (isdefined(player.var_8cff5775.score)) {
                    if (player.var_8cff5775.score.boosts < player namespace_eccff4fb::function_fd3d9ee0()) {
                        player.var_8cff5775.score.boosts++;
            ...
            case 14:
                if (isdefined(player.var_8cff5775.score)) {
                    if (player.var_8cff5775.score.keys < player namespace_eccff4fb::function_9d6bf0a9()) {
            ...
            case 16:
                ...
                if (isdefined(self.var_54dddc17)) {
                    ...
                    if (player.var_8cff5775.score.lives < player namespace_eccff4fb::function_77cbfb85()) {
                        player.var_8cff5775.score.lives++;
                    ...
                    players = namespace_7f5aeb59::function_23e1f90f();
                    foreach (guy in players) {
                        if (guy.var_8cff5775.score.lives < guy namespace_eccff4fb::function_77cbfb85()) {
                            guy thread namespace_6e90e490::function_47e11416(4);
                            guy.var_8cff5775.score.lives++;
            ...
            case 17:
                ...
                player thread namespace_bf41daf8::function_52e9d773();
                break;
            case 18:
            ...
            case 19:
                ...
                player thread namespace_52ba5a8a::function_a8f1c887();
                break;
            case 20:
            ...
            case 25:
                ...
                level thread namespace_e7f07a2a::function_c167f80(player, self.origin);
                break;
            case 26:
            ...
            case 37:
                ...
                break;
            case 39:
                level notify(#"hash_256fe407ad94d83f", {#pickup:self});
                self notify(#"hash_256fe407ad94d83f");
                foreach (player in getplayers()) {
            ...
            case 41:
                ...
                player.var_8cff5775.var_82fb5d17 = 1;
                player namespace_6e90e490::function_55775bbc(5);
                break;
            case 43:
...
function function_d936944a() {
    time = gettime();
    if (self.var_8cff5775.var_6b4163f1 > time) {
        return;
    }
    if (!is_true(self.var_8cff5775.var_c026f7c9)) {
        self.var_8cff5775.var_6b4163f1 = time + 250;
    } else {
        self.var_8cff5775.var_6b4163f1 = time;
    }
    if (level.var_8cff5775.var_cc831548.size) {
        arrayremovevalue(level.var_8cff5775.var_cc831548, undefined, 0);
        self.var_8cff5775.var_ad888d1f = arraysortclosest(level.var_8cff5775.var_cc831548, self.origin, 16, 0, 1024);
    } else {
...
function function_cbae9ca3() {
    if (self.var_8cff5775.var_ad888d1f.size == 0) {
        return;
    }
    playerx = self.origin[0];
    playery = self.origin[1];
    playerz = self.origin[2];
    if (isdefined(self.var_8cff5775.vehicle) && isdefined(self.var_8cff5775.var_baad518e)) {
        playerz = self.var_8cff5775.var_baad518e[2];
    }
    var_8adf26a4 = 72;
    var_a592dbab = 25;
    ...
    foreach (pickup in self.var_8cff5775.var_ad888d1f) {
        if (!isdefined(pickup)) {
            continue;
        }
        if (0) {
...
function function_594c2e4e() {
    ...
    self notify(#"hash_7f9371cb3ad42bb3");
}
...
function function_a12517b() {
    self endon(#"death");
    self waittill(#"hash_7f9371cb3ad42bb3");
...
// Size: 0x12e
function function_c8046d59() {
    self endon(#"death", #"hash_7f9371cb3ad42bb3");
    if (is_true(self.var_9ca559f5)) {
        util::wait_network_frame();
    ...
    if (isdefined(self)) {
        if (!isdefined(var_a3046af4)) {
            if (isdefined(player) && isplayer(player)) {
                ...
                y = 3000;
                z = 1000;
                if (is_true(level.var_8cff5775.var_ecff3871)) {
                    x = 0 - x;
                    y = 0 - y;
                }
...
function function_401a53c4(player) {
    ...
    if (isdefined(self)) {
        if (isdefined(player)) {
            ...
            var_a3046af4 = var_a3046af4 + offset;
        } else {
            var_a3046af4 = self.origin + vectorscale((0, 0, 1), 3000);
        }
...
function function_2cfd5616(var_35526169) {
    if (isdefined(self.var_3aba9d31) && self.var_3aba9d31 == 0) {
        self thread function_c8046d59();
        return;
    }
...
function function_f96b17e3(timetowait) {
    ...
    wait(randomint(5));
    /#
        if (is_true(level.var_8cff5775.var_dcb11150)) {
            return;
        }
    #/
    if (is_true(self.var_9ca559f5)) {
...
function function_18372b20() {
    function_19fa261e();
    foreach (var_956de39f in level.var_8cff5775.var_537a3e29) {
    ...
    function_b950ecde();
    level.var_8cff5775.var_537a3e29 = [];
    level.var_8cff5775.var_4b491c02 = 0;
}
...
function function_2735024b() {
    ...
    while (amount) {
        if (isdefined(level.var_8cff5775.var_39e3fa99)) {
            spot = [[ level.var_8cff5775.var_39e3fa99 ]]->function_70fb5745().origin;
...
function function_32370b0d(timeout = 120) {
    ...
    self.var_8cff5775.var_d320bb5d = timeleft - 15000;
    if (isdefined(self.var_8cff5775.var_ad639ebd)) {
        return;
    }
    self.var_8cff5775.var_ad639ebd = namespace_ec06fe4a::function_e22ae9b3(self.origin, "tag_origin", self.angles, "player lanternOrg");
    if (isdefined(self.var_8cff5775.var_ad639ebd)) {
        self.var_8cff5775.var_ad639ebd thread namespace_ec06fe4a::function_d55f042c(self, "lantern_terminated");
    }
    self.var_8cff5775.var_ad639ebd linkto(self);
    self endon(#"lantern_terminated", #"disconnect");
    self.var_8cff5775.var_ad639ebd namespace_83eb6304::turnofffx("lantern_fade");
    self.var_8cff5775.var_ad639ebd namespace_83eb6304::function_3ecfde67("lantern");
    while (gettime() < self.var_8cff5775.var_d320bb5d && !is_true(self.laststand)) {
        wait(1);
    }
    if (!is_true(self.laststand)) {
        self namespace_83eb6304::function_3ecfde67("lantern_fade");
    }
    self.var_8cff5775.var_ad639ebd namespace_83eb6304::turnofffx("lantern");
    self.var_8cff5775.var_ad639ebd delete();
    self.var_8cff5775.var_ad639ebd = undefined;
}
