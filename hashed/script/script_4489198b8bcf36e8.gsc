...
function private function_23828655(entity) {
    ...
    var_ddb9ff3 = entity lastknownpos(entity.enemy);
    throw_dist = distance2dsquared(entity.origin, var_ddb9ff3);
    var_50ef4b12 = self function_27cfa452();
    if (!var_50ef4b12) {
        if (!self canshootenemy(300)) {
            self.var_c12e0cea = gettime();
            tacpoints = tacticalquery("juggernaut_grenade_tacquery", var_ddb9ff3, entity.origin);
            if (isdefined(tacpoints) && tacpoints.size > 0) {
                var_ddb9ff3 = tacpoints[0].origin;
                throw_dist = distance2dsquared(entity.origin, var_ddb9ff3);
            } else {
                return false;
            }
    ...
    arm_offset = function_5852aae6(entity, var_ddb9ff3);
    entity.var_38754eac = var_ddb9ff3;
    throw_vel = entity canthrowgrenadepos(arm_offset, var_ddb9ff3);
